...
DEFAULT_SRC_EN = (
    REPO_ROOT.parent / "Heat" / "Summary" / "Heat transfer" / "EN-Heat-Transfer-Summary-Poster.png"
)
DEFAULT_SRC_ZH = (
    REPO_ROOT.parent / "Heat" / "Summary" / "Heat transfer" / "ZH-Heat-Transfer-Summary-Poster.png"
)
...
def main() -> int:
    args = parse_args()
    posters = {
        "heat-transfer-en.webp": args.src_en,
        "heat-transfer-zhHant.webp": args.src_zh,
    }
