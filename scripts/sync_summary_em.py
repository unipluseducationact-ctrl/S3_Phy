#!/usr/bin/env python3
"""Sync EM waves bilingual summary posters into public/summary/."""
...
DEFAULT_SRC_DIR = REPO_ROOT.parent / "Optics" / "Summary" / "EM waves"
POSTER_FILES = {
    "em-en.webp": "EM Waves Summary Poster (English) - v2.png",
    "em-zhHant.webp": "電磁波 總結海報（繁體中文）- v2.png",
}
