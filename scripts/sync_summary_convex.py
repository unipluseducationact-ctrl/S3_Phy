#!/usr/bin/env python3
"""Sync Convex lens bilingual summary posters into public/summary/."""
...
SRC_DIR = Path(r"C:\Users\UniplusUser02\Desktop\PHYS\S3\Optics\Summary\Convex lens")
POSTERS = {
    "convex-en.webp": SRC_DIR / "EN-Convex-Lens-Summary-Poster-v4.png",
    "convex-zhHant.webp": SRC_DIR / "ZH-Convex-Lens-Summary-Poster-v2.png",
}
