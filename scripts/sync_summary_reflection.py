#!/usr/bin/env python3
"""Sync Reflection bilingual summary posters into public/summary/."""
...
DEFAULT_SRC_DIR = REPO_ROOT.parent / "Optics" / "Summary" / "Reflection"
POSTER_FILES = {
    "reflection-en.webp": "EN-Reflection-Summary-Poster-v11.png",
    "reflection-zhHant.webp": "ZH-Reflection-Summary-Poster-v11.png",
}
...
def main() -> int:
    ...
    legacy = OUT_DIR / "reflection.webp"
    if legacy.is_file():
        legacy.unlink()
