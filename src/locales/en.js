...
export const en = {
  ...
  'worksheets.countLabel': 'Number of questions (1–50)',
  'worksheets.topics': 'Topics',
  'worksheets.generate': 'Generate questions',
  'worksheets.printPractice': 'Print / Save as PDF',
  'worksheets.printAnswers': 'Print answer key',
  'worksheets.empty': 'Generate questions first.',
  ...
  'worksheets.exportWordQuestions': 'Word — Questions',
  ...
  'worksheets.settingsTitle': 'Worksheet settings',
  'worksheets.bankTitle': 'Question bank (current filters)',
  'worksheets.bankAvailable': 'Available to generate',
  'worksheets.bankByTopic': 'By topic',
  'worksheets.bankNone': 'Select at least one topic.',
  'worksheets.exportTitle': 'Export',
  'worksheets.exportHint': 'Word: .doc for Microsoft Word. Use Print → Save as PDF for a PDF copy.',
  'worksheets.progressNone': 'No session yet',
  'worksheets.progressPrefix': 'Completed',
  'worksheets.hideSettings': 'Hide settings',
  'worksheets.showSettings': 'Show settings',
