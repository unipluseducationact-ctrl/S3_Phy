...
export const en = {
  ...
  'topic.positionDisplacement': 'Position and displacement',
  'topic.speedVelocity': 'Speed and velocity',
  'topic.acceleration': 'Acceleration',
  'topic.forceMotion': 'Force and motion',
  'notes.card.positionDisplacement': 'Ch.2.1 Position & displacement',
  'notes.card.speedVelocity': 'Ch.2.2 Speed & velocity',
  'notes.card.acceleration': 'Ch.2.3 Acceleration',
  'notes.card.forceMotion': 'Ch.2.4 Force & motion',
  'summary.item.positionDisplacement': 'Position & displacement',
  'summary.item.speedVelocity': 'Speed & velocity',
  'summary.item.acceleration': 'Acceleration',
  'summary.item.forceMotion': 'Force & motion',
