...
export const en = {
  ...
  'topic.mirage': 'Mirage (hot / cold air TIR)',
  ...
  'tools.mirage.title': 'Mirage — TIR in hot & cold air',
  ...
  'strand.gas.desc': 'Gas laws and the kinetic theory of gases.',
  ...
  'notes.card.gasLaws': 'Ch.5.1 Gases',
  'notes.card.kineticTheory': 'Ch.5.2 Kinetic theory of gases',
  'notes.card.gasPressure': 'Ch.5.3 Gas pressure & molecular motion',
  'summary.item.gasLaws': 'Gases',
  ...
  'topic.forceI': 'Force I',
  'topic.forceII': 'Force II',
  'topic.forceIII': 'Force III',
  ...
  'notes.card.positionMovement': 'Ch.1 Position & movement',
  'notes.card.equationOfMotion': 'Ch.2 Equations of motion',
  'notes.card.verticalMotion': 'Ch.3 Vertical motion',
  'notes.card.motionGraph': 'Ch.4 Motion graphs',
  'notes.card.forceI': 'Ch.5 Force I',
  'notes.card.forceII': 'Ch.6 Force II',
  'notes.card.forceIII': 'Ch.7 Force III',
  'notes.card.moment': 'Ch.8 Moment of a force',
  'notes.card.workEnergyPower': 'Ch.9 Work, energy & power',
  'notes.card.momentum': 'Ch.10 Momentum',
  'notes.card.projectileMotion': 'Ch.11 Projectile motion',
  'notes.card.circularMotion': 'Ch.12 Circular motion',
  'notes.card.gravitationalForce': 'Ch.13 Gravitation',
  ...
  'summary.item.forceI': 'Force I',
  'summary.item.forceII': 'Force II',
  'summary.item.forceIII': 'Force III',
  ...
  'summary.item.gravitationalForce': 'Gravitation',
