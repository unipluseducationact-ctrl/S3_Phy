...
export const zhHant = {
  ...
  'topic.positionDisplacement': '位置和移動',
  'topic.speedVelocity': '速率和速度',
  'topic.acceleration': '加速度',
  'topic.forceMotion': '力與運動',
  'notes.card.positionDisplacement': 'Ch.2.1 位置和移動',
  'notes.card.speedVelocity': 'Ch.2.2 速率和速度',
  'notes.card.acceleration': 'Ch.2.3 加速度',
  'notes.card.forceMotion': 'Ch.2.4 力與運動',
  'summary.item.positionDisplacement': '位置和移動',
  'summary.item.speedVelocity': '速率和速度',
  'summary.item.acceleration': '加速度',
  'summary.item.forceMotion': '力與運動',
