...
export const zhHant = {
  ...
  'strand.refraction.title': '\u6298\u5c04',
  'strand.refraction.desc': '\u5149\u7684\u6298\u5c04\u3001\u53f8\u4e43\u8033\u5b9a\u5f8b\u3001\u81e8\u754c\u89d2\u8207\u5168\u5167\u53cd\u5c04\u3002',
  'strand.refraction.subtitle': '\u6298\u5c04 \u2014 \u53f8\u4e43\u8033\u5b9a\u5f8b\u8207\u5168\u5167\u53cd\u5c04',
  ...
  'tools.mirage.title': '\u6d77\u5e02\u8718\u6a13 \u2014 \u71b1\uff0f\u51b7\u7a7a\u6c23\u5168\u5167\u53cd\u5c04',
  ...
  'tools.waveDiffraction.title': '\u6ce2\u7684\u885d\u5c04 \u2014 \u7e2b\u5bec\u8207\u6ce2\u9577',
  ...
  'tools.refraction.angleI': '\u5165\u5c04\u89d4 \u03b8\u2081\uff08\u00b0\uff09',
  'tools.refraction.angleR': '\u6298\u5c04\u89d4 \u03b8\u2082\uff08\u00b0\uff09',
  ...
  'tools.refraction.tirNote': '\u5168\u5167\u53cd\u5c04 \u2014 \u6c92\u6709\u6298\u5c04\u5149\u7dda\uff08\u03b8\u2081 > \u03b8c\uff09\u3002',
  ...
  'strand.gas.desc': '氣體定律與氣體分子運動論。',
  'strand.gas.subtitle': '氣體與分子運動論 — 氣體定律與分子動能',
  'gas.section.empty': '氣體單元內容即將推出。',
  'topic.gasLaws': '氣體',
  'topic.kineticTheory': '氣體分子運動論',
  'topic.gasPressure': '氣體壓強與分子運動',
  'notes.card.gasLaws': 'Ch.5.1 氣體',
  'notes.card.kineticTheory': 'Ch.5.2 氣體分子運動論',
  'notes.card.gasPressure': 'Ch.5.3 氣體壓強與分子運動',
  'summary.item.gasLaws': '氣體',
  'summary.item.kineticTheory': '氣體分子運動論',
  'summary.item.gasPressure': '氣體壓強與分子運動',
  ...
  'notes.card.positionMovement': 'Ch.1 位置和移動',
  'notes.card.equationOfMotion': 'Ch.2 運動方程',
  'notes.card.verticalMotion': 'Ch.3 鉛直運動',
  'notes.card.motionGraph': 'Ch.4 運動圖像',
  'notes.card.forceI': 'Ch.5 力 I',
  'notes.card.forceII': 'Ch.6 力 II',
  'notes.card.forceIII': 'Ch.7 力 III',
  'notes.card.moment': 'Ch.8 力矩',
  'notes.card.workEnergyPower': 'Ch.9 功、能量和功率',
  'notes.card.momentum': 'Ch.10 動量',
  'notes.card.projectileMotion': 'Ch.11 拋體運動',
  'notes.card.circularMotion': 'Ch.12 圓周運動',
  'notes.card.gravitationalForce': 'Ch.13 萬有引力',
  ...
  'summary.item.forceI': '力 I',
  'summary.item.forceII': '力 II',
  'summary.item.forceIII': '力 III',
  ...
  'topic.waveProperties': '波動特性',
  'topic.stationaryWave': '駐波',
  'topic.lightWave': '光波',
  'topic.soundWave': '聲波',
  'notes.card.waveMotion': 'Ch.3.1 波動運動',
  'notes.card.waveProperties': 'Ch.3.2 波動特性',
  'notes.card.stationaryWave': 'Ch.3.3 駐波',
  'notes.card.lightWave': 'Ch.3.4 光波',
  'notes.card.soundWave': 'Ch.3.5 聲波',
  'summary.item.waveMotion': '波動運動',
  'summary.item.waveProperties': '波動特性',
  'summary.item.stationaryWave': '駐波',
  'summary.item.lightWave': '光波',
  'summary.item.soundWave': '聲波',
