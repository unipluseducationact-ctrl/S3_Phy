...
const UI = {
  en: {
    appSubtitle: "S3 Optics · Light · English / 繁體中文 UI",
    ...
    revBandFair: "Mixed performance: re-read your Light notes for weaker topics, then regenerate.",
    revBandLow:
  ...
  zh: {
    ...
    revBandFair: "表现参差：请重温光学（光）笔记后再生成题目。",
    revBandLow: "多个概念仍需巩固。请先温习平面镜反射、折射、與全内反射。",
  ...
  "zh-Hant": {
    ...
    revBandFair: "表現參差：請重溫光學（光）筆記後再產生題目。",
    revBandLow: "多個概念仍需鞏固。請先溫習反射、折射與司乃耳定律、全內反射。",
