...
const EXPORT_Q_STYLE =
  "page-break-inside:avoid;break-inside:avoid-page;mso-page-break-inside:avoid;margin-bottom:1rem";
const EXPORT_FIG_STYLE = "page-break-inside:avoid;break-inside:avoid-page;margin:0.75rem 0";
const EXPORT_HEAD_STYLE =
  "<style>.export-q{page-break-inside:avoid;break-inside:avoid-page;mso-page-break-inside:avoid;margin-bottom:1rem}.export-q h2{margin-top:0}.export-fig img{max-width:100%;height:auto;display:block}</style>";
