...
`;function De(){if(document.getElementById(me))return;const n=document.createElement("style");n.id=me,n.textContent=Pe,document.head.appendChild(n)}function Qe(n){De();const a=document.createElement("div");a.className="rml",a.innerHTML=`
  ...
  `;const o=n.querySelector("[data-main]"),x=n.querySelector("[data-nav]"),w=n.querySelector("[data-lang]"),z=n.querySelector("[data-strand-back]");let Q=t;function $(_){Q=_,x.innerHTML=Ve.map(L=>`<button type="button" class="${_===L?"active":""}" data-sec="${L}">${s(Ge[L])}</button>`).join(""),x.querySelectorAll("button").forEach(L=>{L.addEventListener("click",()=>i(L.getAttribute("data-sec")))})}function C(){w.innerHTML=`
    ...
    <section class="panel panel--worksheets">
      ...
      ${X}
    </div>`}function q(){o.items.length&&(Q.innerHTML=o.items.map((h,p)=>g(h,p,o.tab)).join(""),E())}function E(){o.tab==="practice"&&Q.querySelectorAll("[data-ws-choice]").forEach(h=>{h.addEventListener("change",()=>{const p=Number(h.getAttribute("data-ws-q"));if(o.resolved[p])return;const v=Number(h.getAttribute("data-ws-choice")),u=o.items[p][O()]||o.items[p].en;o.userAnswers[p]=v,v===u.a?o.resolved[p]=!0:(o.wrongAttempts[p]=(o.wrongAttempts[p]||0)+1,o.wrongAttempts[p]>=2&&(o.resolved[p]=!0)),j(),P()&&R(),q()})})}function R(){const h=o.items.length;let p=0,v=0;const u={};o.items.forEach((k,b)=>{const H=k[O()]||k.en;if(o.userAnswers[b]===H.a)p+=1,(o.wrongAttempts[b]||0)===0&&(v+=1);else if(o.resolved[b]){const V=k.section||k.topic;u[V]=(u[V]||0)+1}});const S=h?Math.round(p/h*100):0;let f=t("worksheets.revisionFair");S>=90?f=t("worksheets.revisionExcellent"):S>=70?f=t("worksheets.revisionGood"):S<50&&(f=t("worksheets.revisionLow"));const M=Object.entries(u).sort((k,b)=>b[1]-k[1]).map(([k,b])=>`<li>${K(k)} (${b})</li>`).join("");L.innerHTML=`
...
${v}</body></html>`}function d(h){const p=l(h),v=new Blob(["\uFEFF",p],{type:"application/msword"}),u=document.createElement("a");u.href=URL.createObjectURL(v),u.download=h?"worksheet-answers.doc":"worksheet.doc",u.click(),URL.revokeObjectURL(u.href)}x.addEventListener("click",()=>{const h=Number(n.querySelector("[data-ws-count]").value),p=[...n.querySelectorAll("[data-ws-topic]")].filter(S=>S.checked).map(S=>S.getAttribute("data-ws-topic")),v=Ye(a,p,c.topicFilter),u=fe(v).slice(0,Math.min(h,v.length||1));o.items=u.length?u:fe(a).slice(0,Math.min(h,a.length)),G(),o.tab="practice",o.dateStr="",w.hidden=!1,z.hidden=!0,C==null||C.querySelectorAll("[data-ws-tab]").forEach(S=>{S.classList.toggle("active",S.getAttribute("data-ws-tab")==="practice")}),I&&(I.hidden=!1),A&&(A.hidden=!1),F&&(F.hidden=!0),W.textContent="",$==null||$.classList.add("practice-mode"),q()}),C==null||C.addEventListener("click",h=>{const p=h.target.closest("[data-ws-tab]");!p||!o.items.length||B(p.getAttribute("data-ws-tab"))}),D==null||D.addEventListener("click",()=>{o.dateStr?(o.dateStr="",W.textContent=""):(o.dateStr=Xe(),W.textContent=`${t("worksheets.date")}: ${o.dateStr}`),F&&(F.hidden=!o.dateStr,F.textContent=o.dateStr?`${t("worksheets.date")}: ${o.dateStr}`:"")}),(m=n.querySelector("[data-ws-word-p]"))==null||m.addEventListener("click",()=>d(!1)),(e=n.querySelector("[data-ws-word-a]"))==null||e.addEventListener("click",()=>d(!0)),(r=n.querySelector("[data-ws-print-p]"))==null||r.addEventListener("click",()=>{B("practice"),$==null||$.classList.add("ws-print-blank");const h=()=>$==null?void 0:$.classList.remove("ws-print-blank");window.addEventListener("afterprint",h,{once:!0}),window.print()}),(y=n.querySelector("[data-ws-print-a]"))==null||y.addEventListener("click",()=>{B("answer"),window.print()})}const Ue=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Ke={rotatingMirror:n=>Qe(n),refractionTir:n=>Oe(n),lens:(n,a)=>je(n,{defaultKind:a}),rgbMixer:n=>Be(n),em:n=>Ne(n)};function Ze(n){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[n]||n)}function re(){return J()==="zh-Hant"?"zhHant":"en"}async function Re(n,a){const t=`./${n}/${a}`;try{return(await fetch(t,{method:"HEAD"})).ok}catch{return!1}}async function Je(n){return Re("notes",n)}function et(n){let a="topics",t="rotatingMirror",i="convex",c=0,o="all",x=!1,w=null,z={main:null};function Q(){z.main&&(a==="topics"?z.main.innerHTML=C():a==="notes"?z.main.innerHTML=N():a==="tools"?z.main.innerHTML=L():a==="worksheets"?z.main.innerHTML=_e(s):a==="flashcards"?z.main.innerHTML=D():a==="summary"&&(z.main.innerHTML=g()),a==="notes"&&_(),a==="tools"&&A(),a==="worksheets"&&Me(n,Te,s,re),a==="flashcards"&&B(),a==="summary"&&q())}function $(){w==null||w.destroy(),w=Ce(n,{subtitleKey:"strand.optics.subtitle",activeSection:a,onSection:l=>{a=l,w.updateSection(a),Q()},onLang:()=>$()}),z.main=w.main,w.updateSection(a),Q()}function C(){const l=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      ...
      </section>`}function I(l){const d=l.target.closest("[data-go-tool]");if(!d)return;a="tools",t=d.getAttribute("data-go-tool");const m=d.getAttribute("data-lens-kind");(m==="convex"||m==="concave")&&(i=m),w.updateSection(a),Q()}function N(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
