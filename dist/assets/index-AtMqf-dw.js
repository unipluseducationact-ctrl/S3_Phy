...
`;function dt(){if(document.getElementById(Ie))return;const t=document.createElement("style");t.id=Ie,t.textContent=ct,document.head.appendChild(t)}function ut(t){dt();const i=document.createElement("div");i.className="rml",i.innerHTML=`
  ...
  `;const l=i.querySelector(".rml-canvas"),r=l.getContext("2d"),u=i.querySelector("[data-rml-rot]"),a=i.querySelector("[data-rml-inc]"),n=i.querySelector('[data-rml-disp="rot"]'),T=i.querySelector('[data-rml-disp="inc"]'),z=i.querySelector('[data-rml-val="i"]'),te=i.querySelector('[data-rml-val="r"]'),W=i.querySelector('[data-rml-val="shift"]'),L=350,P=380,K=300,q="#22d3ee",R="bold 17px system-ui, sans-serif";let F=0,O=-140,ae=!0,U=!0,G=!0,B=!0;function V(p){return p*Math.PI/180}function X(p,d,c,h,A,x=2,H=!1){r.beginPath(),r.lineWidth=x,r.strokeStyle=A,r.setLineDash(H?[6,6]:[]);const v=p+Math.cos(V(c))*h,g=d+Math.sin(V(c))*h;return r.moveTo(p,d),r.lineTo(v,g),r.stroke(),r.setLineDash([]),{x:v,y:g}}function Z(p,d,c,h,A,x=14){const H=c-p,v=h-d,g=Math.hypot(H,v);if(g<1e-6)return;const D=H/g,C=v/g,Q=c-D*x,$=h-C*x,ce=.45*x;r.beginPath(),r.fillStyle=A,r.moveTo(c,h),r.lineTo(Q-C*ce,$+D*ce),r.lineTo(Q+C*ce,$-D*ce),r.closePath(),r.fill()}function Y(p,d,c,h,A,x=25){r.beginPath(),r.strokeStyle=h,r.lineWidth=2;const H=Math.min(p,d),v=Math.max(p,d);if(r.arc(L,P,c,V(H),V(v),!1),r.stroke(),A){const g=(H+v)/2,D=L+Math.cos(V(g))*(c+x),C=P+Math.sin(V(g))*(c+x);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillStyle=h,r.fillText(A,D,C),r.restore()}}function ne(p,d,c,h,A){r.clearRect(0,0,l.width,l.height),r.beginPath(),r.setLineDash([10,6]),r.strokeStyle="rgba(255, 204, 0, 0.45)",r.lineWidth=3,r.lineCap="round",r.moveTo(L-200,P),r.lineTo(L+200,P),r.stroke(),r.setLineDash([]),r.lineCap="butt";const x=L+Math.cos(V(p))*K,H=P+Math.sin(V(p))*K;r.beginPath(),r.lineWidth=3,r.strokeStyle="#fff",r.moveTo(x,H),r.lineTo(L,P),r.stroke();const v=(x+L)*.5,g=(H+P)*.5,D=Math.hypot(L-x,P-H)||1,C=(L-x)/D,Q=(P-H)/D;if(Z(v-C*28,g-Q*28,v,g,"#fff",16),r.save(),r.font=R,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#fff",r.fillText(t("tools.rotatingMirror.canvas.incident"),x,H-12),r.restore(),ae){const $=X(L,P,-90,K-60,"#00e676",1,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(t("tools.rotatingMirror.canvas.n"),$.x+6,$.y-4),r.restore()}if(U){const $=X(L,P,h,K,"#00e676",2,!1);Z(L,P,$.x,$.y,"#00e676",16),r.save(),r.font=R,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(t("tools.rotatingMirror.canvas.originalReflected"),$.x,$.y-14),r.restore()}r.save(),r.translate(L,P),r.rotate(V(F)),r.beginPath(),r.lineWidth=6,r.strokeStyle="#ffcc00",r.lineCap="round",r.moveTo(-200,0),r.lineTo(200,0),r.stroke(),r.beginPath(),r.lineWidth=1,r.strokeStyle="#666";for(let $=-190;$<200;$+=15)r.moveTo($,0),r.lineTo($-5,8);if(r.stroke(),r.restore(),G){const $=X(L,P,d,K-40,q,2,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle=q,r.fillText(t("tools.rotatingMirror.canvas.nPrime"),$.x+6,$.y-4),r.restore()}if(B){const $=X(L,P,c,K,q,4);Z(L,P,$.x,$.y,q,16),Math.abs(F)>.5&&(r.save(),r.font=R,r.textAlign="center",r.textBaseline="bottom",r.fillStyle=q,r.fillText(t("tools.rotatingMirror.canvas.newReflected"),$.x,$.y-14),r.restore())}if(G&&Y(p,d,100,"#ffcc00",`i=${A.toFixed(0)}°`,25),G&&B&&Y(d,c,100,q,`r=${A.toFixed(0)}°`,25),ae&&G&&Math.abs(F)>.5&&Y(-90,d,50,"#ffcc00",`θ=${Math.abs(F)}°`,20),U&&B&&Math.abs(F)>.5){const $=c-h;Y(h,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${$.toFixed(0)}°`,40)}}function m(){F=parseFloat(u.value),O=parseFloat(a.value);const p=F>0?"+":"";n.textContent=`${p}${F}°`,T.textContent=`${O}°`;const d=-90,c=Math.abs(O-d),h=d+c,A=-90+F,x=Math.abs(O-A),H=A+x,v=H-h;z.textContent=`${x.toFixed(1)}°`,te.textContent=`${x.toFixed(1)}°`;const g=v>0?"+":"";W.textContent=`${g}${v.toFixed(1)}°`,ne(O,A,H,h,x)}return i.querySelectorAll("[data-rml-toggle]").forEach(p=>{p.addEventListener("click",()=>{const d=p.getAttribute("data-rml-toggle");d==="orig-norm"&&(ae=!ae),d==="orig-ray"&&(U=!U),d==="new-norm"&&(G=!G),d==="new-ray"&&(B=!B),p.classList.toggle("active"),m()})}),i.querySelector("[data-rml-reset]").addEventListener("click",()=>{u.value="0",m()}),u.addEventListener("input",m),a.addEventListener("input",m),m(),i}function pt(t){const i=document.createElement("div");i.className="tool-tir-escape";const l=document.createElement("iframe"),r="./",u=r.endsWith("/")?r:`${r}/`;return l.src=`${u}tir-escape/index.html?embed=1`,l.title=t("tools.refractionTir.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin",i.appendChild(l),i}function ht(t,i={}){const l=i.defaultKind==="concave"?"concave":"convex",r="tools.lens.title",u=document.createElement("div");u.className="tool-lens-simulator";const a=document.createElement("iframe"),n="./",T=n.endsWith("/")?n:`${n}/`;return a.src=`${T}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(l)}`,a.title=t(r),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",u.appendChild(a),u}function mt(t){const i=document.createElement("div");i.className="tool-em-spectrum";const l=document.createElement("iframe"),r="./",u=r.endsWith("/")?r:`${r}/`;function a(){return`${u}em-spectrum/index.html?lang=${encodeURIComponent(xe())}`}l.src=a(),l.title=t("tools.em.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var T;try{(T=l.contentWindow)==null||T.postMessage({type:"s3phy:lang",lang:xe()},"*")}catch{l.src=a()}};return window.addEventListener("s3phy:lang",n),i._emLabCleanup=()=>window.removeEventListener("s3phy:lang",n),i.appendChild(l),i}function ft(t){const i=document.createElement("div");i.className="rgb-mixer",i.innerHTML=`
  ...
  `;const a=t.querySelector("[data-main]"),n=t.querySelector("[data-nav]"),T=t.querySelector("[data-lang]"),z=t.querySelector("[data-strand-back]");let te=l;function W(q){te=q,n.innerHTML=gt.map(R=>`<button type="button" class="${q===R?"active":""}" data-sec="${R}">${s(bt[R])}</button>`).join(""),n.querySelectorAll("button").forEach(R=>{R.addEventListener("click",()=>r(R.getAttribute("data-sec")))})}function L(){T.innerHTML=`
    ...
    <section class="panel panel--worksheets">
      ...
      <div class="q-header"><h4>Q${$} ${ce}</h4>${qe?'<span class="result-icon">✓</span>':he?'<span class="result-icon">✗</span>':""}</div>
      <p>${ye(C.q)}</p>
      <ol class="choice-list choice-list--radio">${de}</ol>
      ${be}
    </div>`}function ne(){a.items.length&&(te.innerHTML=a.items.map((v,g)=>Y(v,g,a.tab)).join(""),m())}function m(){a.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(v=>{v.addEventListener("change",()=>{const g=Number(v.getAttribute("data-ws-q"));if(a.resolved[g])return;const D=Number(v.getAttribute("data-ws-choice")),C=a.items[g][G()]||a.items[g].en;a.userAnswers[g]=D,D===C.a?a.resolved[g]=!0:(a.wrongAttempts[g]=(a.wrongAttempts[g]||0)+1,a.wrongAttempts[g]>=2&&(a.resolved[g]=!0)),X(),V()&&p(),ne()})})}function p(){const v=a.items.length;let g=0,D=0;const C={};a.items.forEach((oe,se)=>{const pe=oe[G()]||oe.en;if(a.userAnswers[se]===pe.a)g+=1,(a.wrongAttempts[se]||0)===0&&(D+=1);else if(a.resolved[se]){const he=oe.section||oe.topic;C[he]=(C[he]||0)+1}});const Q=v?Math.round(g/v*100):0;let $=l("worksheets.revisionFair");Q>=90?$=l("worksheets.revisionExcellent"):Q>=70?$=l("worksheets.revisionGood"):Q<50&&($=l("worksheets.revisionLow"));const ce=Object.entries(C).sort((oe,se)=>se[1]-oe[1]).map(([oe,se])=>`<li>${ye(oe)} (${se})</li>`).join("");R.innerHTML=`
      <h4>${l("worksheets.sessionSummary")}</h4>
      <p>${l("worksheets.score")}: <strong>${g}/${v}</strong> (${Q}%)</p>
      <p>${l("worksheets.firstTry")}: <strong>${D}/${v}</strong></p>
      <p>${l("worksheets.revisionSuggestions")}: ${$}</p>
      ${ce?`<p>${l("worksheets.weakSections")}:</p><ul>${ce}</ul>`:""}`,R.hidden=!1}function d(v){const g=G(),D=a.items.map((C,Q)=>{const $=C[g]||C.en,ce=$.choices.map((se,pe)=>`${$e[pe]}. ${se}`).join("<br/>"),oe=v?`<p><b>${l("worksheets.answer")}:</b> ${$e[$.a]}<br/><i>${$.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${$.q}<br/>${ce}${oe}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${D}</body></html>`}function c(v){const g=d(v),D=new Blob(["\uFEFF",g],{type:"application/msword"}),C=document.createElement("a");C.href=URL.createObjectURL(D),C.download=v?"worksheet-answers.doc":"worksheet.doc",C.click(),URL.revokeObjectURL(C.href)}n.addEventListener("click",()=>{const v=Number(t.querySelector("[data-ws-count]").value),g=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),D=vt(i,g,u.topicFilter),C=We(D).slice(0,Math.min(v,D.length||1));a.items=C.length?C:We(i).slice(0,Math.min(v,i.length)),B(),a.tab="practice",a.dateStr="",T.hidden=!1,z.hidden=!0,L==null||L.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),P&&(P.hidden=!1),F&&(F.hidden=!1),O&&(O.hidden=!0),U.textContent="",W==null||W.classList.add("practice-mode"),ne()}),L==null||L.addEventListener("click",v=>{const g=v.target.closest("[data-ws-tab]");!g||!a.items.length||Z(g.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{a.dateStr?(a.dateStr="",U.textContent=""):(a.dateStr=yt(),U.textContent=`${l("worksheets.date")}: ${a.dateStr}`),O&&(O.hidden=!a.dateStr,O.textContent=a.dateStr?`${l("worksheets.date")}: ${a.dateStr}`:"")}),(h=t.querySelector("[data-ws-word-p]"))==null||h.addEventListener("click",()=>c(!1)),(A=t.querySelector("[data-ws-word-a]"))==null||A.addEventListener("click",()=>c(!0)),(x=t.querySelector("[data-ws-print-p]"))==null||x.addEventListener("click",()=>{Z("practice"),W==null||W.classList.add("ws-print-blank");const v=()=>W==null?void 0:W.classList.remove("ws-print-blank");window.addEventListener("afterprint",v,{once:!0}),window.print()}),(H=t.querySelector("[data-ws-print-a]"))==null||H.addEventListener("click",()=>{Z("answer"),window.print()})}const wt=["rotatingMirror","refractionTir","lens","rgbMixer","em"],xt={rotatingMirror:t=>ut(t),refractionTir:t=>pt(t),lens:(t,i)=>ht(t,{defaultKind:i}),rgbMixer:t=>ft(t),em:t=>mt(t)};function qt(t){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Re(){return xe()==="zh-Hant"?"zhHant":"en"}async function Je(t,i){const l=`./${t}/${i}`;try{return(await fetch(l,{method:"HEAD"})).ok}catch{return!1}}async function St(t){return Je("notes",t)}function kt(t){let i="topics",l="rotatingMirror",r="convex",u=0,a="all",n=!1,T=null,z={main:null};function te(){z.main&&(i==="topics"?z.main.innerHTML=L():i==="notes"?z.main.innerHTML=K():i==="tools"?z.main.innerHTML=R():i==="worksheets"?z.main.innerHTML=Xe(s):i==="flashcards"?z.main.innerHTML=ae():i==="summary"&&(z.main.innerHTML=Y()),i==="notes"&&q(),i==="tools"&&F(),i==="worksheets"&&Ze(t,Ye,s,Re),i==="flashcards"&&Z(),i==="summary"&&ne())}function W(){T==null||T.destroy(),T=Ke(t,{subtitleKey:"strand.optics.subtitle",activeSection:i,onSection:d=>{i=d,T.updateSection(i),te()},onLang:()=>W()}),z.main=T.main,T.updateSection(i),te()}function L(){const d=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      ...
      </section>`}function P(d){const c=d.target.closest("[data-go-tool]");if(!c)return;i="tools",l=c.getAttribute("data-go-tool");const h=c.getAttribute("data-lens-kind");(h==="convex"||h==="concave")&&(r=h),T.updateSection(i),te()}function K(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
...
`;function Ct(){if(document.getElementById(Pe))return;const t=document.createElement("style");t.id=Pe,t.textContent=Tt,document.head.appendChild(t)}function ze(t,i={}){Ct();const l=i.type||"liquid";let r=t("tools.thermometerLab.title"),u=t("tools.thermometerLab.subtitle");i.type==="liquid"?(r=t("tools.thermometerLab.liquid.title"),u=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="resistance"?(r=t("tools.thermometerLab.resistance.title"),u=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="thermistor"&&(r=t("tools.thermometerLab.thermistor.title"),u=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
  ...
  `;const n={liquidType:"mercury",thermometerType:l,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0},T=460,z=340,te=80,W=800,L=560;function P(){const e={left:80,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:W-e.left-e.right,gh:L-e.top-e.bottom,tickFont:`bold ${Math.round(W*.024)}px Arial`,axisFont:`bold ${Math.round(W*.026)}px Arial`,dotR:7,yLabelX:e.left-48,xLabelY:L-e.bottom+32}}function K(){let o=100;const f=Math.max(n.bathTemp,n.thermometerTemp,100);f>120&&(o=150),f>145&&(o=200);const b=o<=100?20:25;return{minT:0,maxT:o,tickStep:b}}function q(e,o,f,b,w){return b+(e-o)/(f-o)*w}function R(e,o,f,b,w){return b+w-(e-o)/(f-o)*w}function F(e,o,f,b,w,E){const{gx:y,gy:S,gw:M,gh:_,tickFont:I,axisFont:j,yLabelX:J,xLabelY:k}=o;e.strokeStyle="#4b5563",e.lineWidth=2,e.beginPath(),e.moveTo(y,S),e.lineTo(y,S+_),e.lineTo(y+M,S+_),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.8,e.fillStyle="#e4e4e7",e.font=I,e.textAlign="right",e.textBaseline="middle";for(const ee of E){const N=R(ee.value,ee.min,ee.max,S,_);e.beginPath(),e.moveTo(y,N),e.lineTo(y+M,N),e.stroke(),e.fillText(ee.label,y-12,N)}e.textAlign="center",e.textBaseline="top";for(let ee=f;ee<=b+.01;ee+=w){const N=q(ee,f,b,y,M);e.beginPath(),e.moveTo(N,S),e.lineTo(N,S+_),e.stroke(),e.fillText(`${Math.round(ee)}`,N,S+_+10)}return{gx:y,gy:S,gw:M,gh:_,axisFont:j,yLabelX:J,xLabelY:k}}function O(e,o){const f=o-e,b=f<=8?1:f<=14?2:5,w=[],E=Math.ceil(e/b)*b;for(let y=E;y<=o+.001;y+=b)w.push({value:y,label:y%1===0?`${y.toFixed(0)}`:`${y.toFixed(1)}`,min:e,max:o});return w}function ae(){const{maxT:e}=K(),o=U(0),f=U(e),b=f-o,w=Math.max(1,b*.1),E=Math.max(0,Math.round((o-w)*10)/10),y=Math.round((f+w)*10)/10;return{minL:E,maxL:y}}function U(e){return n.liquidL0+(n.liquidL100-n.liquidL0)/100*e}function G(){const{maxT:e}=K(),o=B(0),f=B(e),b=f-o,w=Math.max(.2,b*.1),E=Math.max(0,o-w),y=f+w,S=b<=2?.5:b<=4?1:2,M=[],_=Math.ceil(E/S)*S;for(let I=_;I<=y+.001;I+=S)M.push({value:I,label:I.toFixed(1),min:E,max:y});return{minR:E,maxR:y,ticks:M}}function B(e){return n.resistanceR0+(n.resistanceR100-n.resistanceR0)/100*e}function V(e){const{maxT:o}=e;let f=n.thermistorR25;for(let y=0;y<=o;y+=5){const S=y+273.15,M=n.thermistorR25*Math.exp(n.thermistorBeta*(1/S-1/298.15));f=Math.max(f,M)}f=Math.ceil(f*1.08*10)/10;const b=0,w=f<=12?2:4,E=[];for(let y=0;y<=f+.001;y+=w)E.push({value:y,label:y.toFixed(0),min:b,max:f});return{minR:b,maxR:f,ticks:E}}const X=a.querySelector("#tl-thermometerCanvas"),Z=X.getContext("2d"),Y=a.querySelector("#tl-graphCanvas"),ne=Y.getContext("2d"),m=window.devicePixelRatio||1;X.width=T*m,X.height=z*m,Z.scale(m,m),Y.width=W*m,Y.height=L*m,ne.scale(m,m);function p(){n.iceCubes=[];for(let e=0;e<4;e++)n.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:10+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});n.bubbles=[];for(let e=0;e<15;e++)n.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3,speedY:.6+Math.random()*1.2,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});n.heatWaves=[];for(let e=0;e<6;e++)n.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:12+Math.random()*15,speedY:.4+Math.random()*.5,opacity:.1+Math.random()*.25})}const d=200,c=11;function h(){const e=Math.pow(n.bulbVolume/d,.3333333333333333);return c*e}function A(){if(n.thermometerType==="resistance"||n.thermometerType==="thermistor")return .35;const e=n.liquidType==="mercury"?1:8,o=.2+n.wallThickness*1.5,f=.4+n.bulbVolume*.003,b=1.35-n.capillaryBore*.45;return Math.max(.1,o*f*b*e*.15)}function x(e){n.bathTemp<=8&&n.iceCubes.forEach(o=>{o.x+=o.speedX,o.y+=o.speedY,(o.x<65||o.x>175)&&(o.speedX*=-1),(o.y<195||o.y>210)&&(o.speedY*=-1)}),n.bathTemp>35&&n.heatWaves.forEach(o=>{o.y-=o.speedY*(1+n.bathTemp/100),o.y<185&&(o.y=265,o.x=65+Math.random()*110)}),n.bathTemp>=80&&n.bubbles.forEach(o=>{o.y-=o.speedY*(1+(n.bathTemp-80)/40),o.phase+=o.wobbleSpeed,o.x+=Math.sin(o.phase)*.2,o.y<185&&(o.y=260+Math.random()*10,o.x=60+Math.random()*120)})}function H(e){let y=59,S=130,M=246;if(n.bathTemp<25){const k=n.bathTemp/25;y=Math.round(180-k*121),S=Math.round(210-k*80),M=Math.round(250-k*4)}else{const k=Math.min(1,(n.bathTemp-25)/125);y=Math.round(59+k*180),S=Math.round(130-k*100),M=Math.round(246-k*190)}if(n.bathTemp>40){const k=Math.min(1,(n.bathTemp-40)/100),ee=Date.now()*.02;e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-20,284);for(let N=-20;N<=20;N+=8){const re=k*(10+Math.sin(N*.3+ee)*4);e.lineTo(55+130/2+N,284-re)}e.lineTo(55+130/2+20,284),e.closePath(),e.fill()}e.strokeStyle="#9ca3af",e.lineWidth=2,e.fillStyle="#1f1f23",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const _=e.createLinearGradient(55,190,55,280);_.addColorStop(0,`rgba(${y}, ${S}, ${M}, 0.3)`),_.addColorStop(1,`rgba(${y}, ${S}, ${M}, 0.6)`),e.fillStyle=_,e.beginPath(),e.moveTo(55,190);const I=n.bathTemp>=80?1.5:.4,j=n.bathTemp>=80?.08:.03,J=Date.now()*j;for(let k=55;k<=185;k+=5){const ee=190+Math.sin(k*.15+J)*I;e.lineTo(k,ee)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),n.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.4,(n.bathTemp-35)/120)})`,e.lineWidth=1,n.heatWaves.forEach(k=>{e.beginPath(),e.moveTo(k.x,k.y),e.quadraticCurveTo(k.x+Math.sin(k.y*.06)*4,k.y-k.length/2,k.x,k.y-k.length),e.stroke()})),n.bathTemp<=8&&(e.fillStyle="rgba(255, 255, 255, 0.6)",e.strokeStyle="rgba(147, 197, 253, 0.8)",e.lineWidth=.8,n.iceCubes.forEach(k=>{e.save(),e.translate(k.x,k.y),e.rotate(k.angle),e.beginPath(),e.roundRect(-k.size/2,-k.size/2,k.size,k.size,2),e.fill(),e.stroke(),e.restore()})),n.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.5)",e.strokeStyle="rgba(255, 255, 255, 0.7)",e.lineWidth=.5,n.bubbles.forEach(k=>{e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill(),e.stroke()})),e.strokeStyle="#4b5563",e.lineWidth=3,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke()}function v(e){const b=h(),w=250+Math.max(0,b-c)*.35,E=w-b-1,y=8+n.wallThickness*8,S=120-y/2,M=120+y/2,_=e.createLinearGradient(S,20,M,20);_.addColorStop(0,"rgba(209, 213, 219, 0.85)"),_.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),_.addColorStop(.5,"rgba(243, 244, 246, 0.2)"),_.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),_.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=_,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(S,E),e.lineTo(S,25),e.arcTo(S,20,S+5,20,5),e.arcTo(M,20,M,25,5),e.lineTo(M,E),e.closePath(),e.fill(),e.stroke();const I=e.createRadialGradient(120-b*.2,w-b*.2,b*.1,120,w,b);I.addColorStop(0,"rgba(255, 255, 255, 0.7)"),I.addColorStop(1,"rgba(156, 163, 175, 0.3)"),e.fillStyle=I,e.strokeStyle="#6b7280",e.lineWidth=.8+n.wallThickness*.6,e.beginPath(),e.arc(120,w,b+.5+n.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const j=Math.min(y*.72,.6+n.capillaryBore*4.5);e.fillStyle="#111827",e.fillRect(120-j/2,28,j,E-20-8);const J=n.liquidType==="mercury",k=J?"#9ca3af":"#ef4444",ee=J?"#f3f4f6":"#fecaca",N=210,re=220,me=(N-40)/re,fe=N-Math.min(re,n.thermometerTemp)*me;e.fillStyle=k,e.fillRect(120-j/2,fe,j,E-fe),e.fillStyle=ee,e.fillRect(120-j/6,fe,j/3,E-fe);const le=b*.9,ie=e.createRadialGradient(120-le*.2,w-le*.2,le*.1,120,w,le);J?(ie.addColorStop(0,"#f3f4f6"),ie.addColorStop(.3,"#d1d5db"),ie.addColorStop(.8,"#9ca3af"),ie.addColorStop(1,"#4b5563")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,w,le,0,Math.PI*2),e.fill(),e.font="bold 7px Arial",e.fillStyle="#9ca3af",e.textAlign="center",e.textBaseline="top",e.fillText(`Vb = ${n.bulbVolume} mm³`,120,w+b+5),e.strokeStyle="#4b5563",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ue=0;ue<=200;ue+=50){const ge=N-ue*me;e.beginPath(),e.moveTo(S,ge),e.lineTo(S+4,ge),e.stroke(),e.fillText(`${ue}°C`,S-22,ge+2.5)}}function g(e){const y=e.createLinearGradient(116,20,124,20);y.addColorStop(0,"#9ca3af"),y.addColorStop(.3,"#f3f4f6"),y.addColorStop(.7,"#d1d5db"),y.addColorStop(1,"#6b7280"),e.fillStyle=y,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(116,20,8,225,[0,0,3,3]),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,M=40,_=135,I=90;e.fillStyle="#1e1b4b",e.strokeStyle="#4f46e5",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,M,_,I,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,M+12,_-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(n.currentResistance.toFixed(2)+" Ω",S+_-16,M+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,M+21)}function D(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const w=20,E=225,y=10,S=120-y/2,M=e.createLinearGradient(S,w,S+y,w);M.addColorStop(0,"rgba(229, 231, 235, 0.4)"),M.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),M.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),M.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=M,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(S,w,y,E-w,[0,0,2,2]),e.fill(),e.stroke();const _=6,I=e.createRadialGradient(120-_*.2,245-_*.2,_*.1,120,245,_);I.addColorStop(0,"#4b5563"),I.addColorStop(.7,"#1f2937"),I.addColorStop(1,"#111827"),e.fillStyle=I,e.strokeStyle="#030712",e.lineWidth=1,e.beginPath(),e.arc(120,245,_,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const j=245,J=40,k=135,ee=90;e.fillStyle="#111827",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(j,J,k,ee,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(j+10,J+12,k-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(n.currentThermistorR.toFixed(2)+" kΩ",j+k-16,J+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",j+14,J+21)}function C(e){const o=P(),{minL:f,maxL:b}=ae(),{minT:w,maxT:E,tickStep:y}=K(),S=O(f,b),M=F(e,o,w,E,y,S),{gx:_,gy:I,gw:j,gh:J,axisFont:k,yLabelX:ee,xLabelY:N,dotR:re}={...o,...M};e.save(),e.translate(ee,I+J/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=k,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",_+j/2,N);const ve=E,me=q(0,w,E,_,j),fe=R(U(0),f,b,I,J),le=q(ve,w,E,_,j),ie=R(U(ve),f,b,I,J);e.strokeStyle="#ef4444",e.lineWidth=2,e.beginPath(),e.moveTo(me,fe),e.lineTo(le,ie),e.stroke();const ue=n.thermometerTemp,ge=n.currentLength;if(ue>=w&&ue<=E){const we=q(ue,w,E,_,j),Ee=R(ge,f,b,I,J);e.fillStyle="#ef4444",e.beginPath(),e.arc(we,Ee,re,0,Math.PI*2),e.fill()}}function Q(e){const o=P(),{minR:f,maxR:b,ticks:w}=G(),E=K(),y=F(e,o,E.minT,E.maxT,E.tickStep,w),{gx:S,gy:M,gw:_,gh:I,axisFont:j,yLabelX:J,xLabelY:k,dotR:ee}={...o,...y};e.save(),e.translate(J,M+I/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",S+_/2,k);const{minT:N,maxT:re}=E,ve=re,me=q(0,N,re,S,_),fe=R(B(0),f,b,M,I),le=q(ve,N,re,S,_),ie=R(B(ve),f,b,M,I);e.strokeStyle="#4f46e5",e.lineWidth=2,e.beginPath(),e.moveTo(me,fe),e.lineTo(le,ie),e.stroke();const ue=n.thermometerTemp,ge=n.currentResistance;if(ue>=N&&ue<=re){const we=q(ue,N,re,S,_),Ee=R(ge,f,b,M,I);e.fillStyle="#4f46e5",e.beginPath(),e.arc(we,Ee,ee,0,Math.PI*2),e.fill()}}function $(e){const o=P(),f=K(),{minR:b,maxR:w,ticks:E}=V(f),y=F(e,o,f.minT,f.maxT,f.tickStep,E),{gx:S,gy:M,gw:_,gh:I,axisFont:j,yLabelX:J,xLabelY:k,dotR:ee}={...o,...y},{minT:N,maxT:re}=f;e.save(),e.translate(J,M+I/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",S+_/2,k),e.strokeStyle="#10b981",e.lineWidth=2,e.beginPath();let ve=!1;for(let le=N;le<=re;le+=2){const ie=le+273.15,ue=n.thermistorR25*Math.exp(n.thermistorBeta*(1/ie-1/298.15)),ge=q(le,N,re,S,_),we=R(Math.min(w,ue),b,w,M,I);we>=M&&we<=M+I&&(ve?e.lineTo(ge,we):(e.moveTo(ge,we),ve=!0))}e.stroke();const me=n.thermometerTemp,fe=n.currentThermistorR;if(me>=N&&me<=re){const le=q(me,N,re,S,_),ie=R(Math.min(w,fe),b,w,M,I);e.fillStyle="#10b981",e.beginPath(),e.arc(le,ie,ee,0,Math.PI*2),e.fill()}}function ce(){Z.clearRect(0,0,T,z),ne.clearRect(0,0,W,L),Z.save(),Z.translate(te,0),H(Z),n.thermometerType==="liquid"?v(Z):n.thermometerType==="resistance"?g(Z):D(Z),Z.restore(),n.thermometerType==="liquid"?C(ne):n.thermometerType==="resistance"?Q(ne):$(ne)}function oe(e){a.querySelector("#tl-bath-temp-display").innerHTML=n.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=n.bathTemp.toFixed(1)+" °C";const o=a.querySelector("#tl-bath-state");n.bathTemp<=0?o.textContent="Melting Ice Bath":n.bathTemp>=100?o.textContent="Boiling Water/Steam":n.bathTemp===150?o.textContent="Hot Cooking Oil":o.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const f=a.querySelector("#tl-alcohol-boiling-warning");if(n.thermometerType==="liquid"&&n.liquidType==="alcohol"&&n.bathTemp>=78?f.style.display="block":f.style.display="none",n.thermometerType==="liquid")a.querySelector("#tl-live-liquid-lt").textContent=n.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-sub-num").textContent=`${n.currentLength.toFixed(2)} - ${n.liquidL0.toFixed(1)}`,a.querySelector("#tl-live-liquid-sub-den").textContent=`${n.liquidL100.toFixed(1)} - ${n.liquidL0.toFixed(1)}`,a.querySelector("#tl-live-liquid-ans").textContent=n.thermometerTemp.toFixed(1)+"°C";else if(n.thermometerType==="resistance")a.querySelector("#tl-live-resistance-rt").textContent=n.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-sub-num").textContent=`${n.currentResistance.toFixed(2)} - ${n.resistanceR0.toFixed(1)}`,a.querySelector("#tl-live-resistance-sub-den").textContent=`${n.resistanceR100.toFixed(1)} - ${n.resistanceR0.toFixed(1)}`,a.querySelector("#tl-live-resistance-ans").textContent=n.thermometerTemp.toFixed(1)+"°C";else{a.querySelector("#tl-live-thermistor-rt").textContent=n.currentThermistorR.toFixed(2)+" kΩ";const b=n.thermometerTemp+273.15;a.querySelector("#tl-live-thermistor-calc-tk").textContent=b.toFixed(2),a.querySelector("#tl-live-thermistor-ans").textContent=n.thermometerTemp.toFixed(1)+"°C"}}let se=null;function pe(e){n.lastTimestamp||(n.lastTimestamp=e);const o=(e-n.lastTimestamp)/1e3;n.lastTimestamp=e;const f=Math.min(o,.1),b=A(),w=f/b*(n.bathTemp-n.thermometerTemp);n.thermometerTemp+=w,n.currentLength=n.liquidL0+(n.liquidL100-n.liquidL0)/100*n.thermometerTemp,n.currentResistance=n.resistanceR0+(n.resistanceR100-n.resistanceR0)/100*n.thermometerTemp;const E=n.thermometerTemp+273.15;n.currentThermistorR=n.thermistorR25*Math.exp(n.thermistorBeta*(1/E-1/298.15)),x(),ce(),oe(b),se=requestAnimationFrame(pe)}function qe(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),o=parseFloat(a.querySelector("#tl-input-faulty-cu").value),f=Number.isFinite(e)?e:-1.5,b=Number.isFinite(o)?o:105,w=b-f;return{cf:f,cu:b,interval:w}}function he(e){const o=Math.round(e*100)/100;return o>=0?o.toFixed(1):`(${o.toFixed(1)})`}function be(){const{cf:e,cu:o,interval:f}=qe(),b=a.querySelector("#tl-val-faulty-interval"),w=a.querySelector("#tl-faulty-error-a"),E=a.querySelector("#tl-faulty-error-b"),y=a.querySelector("#tl-ans-q10a"),S=a.querySelector("#tl-ans-q10b"),M=Math.abs(f)<.01;if(b.textContent=f.toFixed(1)+" °C",M){w.hidden=!1,w.textContent="C_u must differ from C_f (interval cannot be zero).",E.hidden=!1,E.textContent=w.textContent,y.textContent="—",S.textContent="—";return}w.hidden=!0,E.hidden=!0;const _=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,I=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,j=(_-e)/f*100,J=I/100*f+e;a.querySelector("#tl-faulty-sub-num-a").textContent=`${_.toFixed(1)} − ${he(e)}`,a.querySelector("#tl-faulty-sub-den-a").textContent=`${o.toFixed(1)} − ${he(e)}`,a.querySelector("#tl-faulty-sub-num-b").textContent=`${I.toFixed(1)} × ${f.toFixed(1)}`,a.querySelector("#tl-faulty-sub-cf-b").textContent=`+ ${he(e)}`,y.textContent=j.toFixed(1)+" °C",S.textContent=J.toFixed(2)+" °C"}function Me(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,o=(e-n.resistanceR0)/(n.resistanceR100-n.resistanceR0)*100;a.querySelector("#tl-formula-q11-rsub").textContent=e.toFixed(1),a.querySelector("#tl-ans-q11").textContent=o.toFixed(1)+" °C"}function de(){be(),Me()}function Se(e,o){a.querySelector("#"+e).addEventListener("click",()=>{n.bathTemp=o,a.querySelector("#tl-bath-temp-slider").value=o,de()})}function ke(){a.querySelectorAll(".tl-tab-btn").forEach(o=>{o.addEventListener("click",()=>{a.querySelectorAll(".tl-tab-btn").forEach(b=>b.classList.remove("active")),a.querySelectorAll(".tl-tab-content").forEach(b=>b.classList.remove("active")),o.classList.add("active");const f=o.getAttribute("data-tl-tab");a.querySelector("#tl-tab-"+f).classList.add("active"),n.thermometerType=f,de()})}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",o=>{n.bathTemp=parseFloat(o.target.value),de()}),Se("tl-btn-preset-ice",0),Se("tl-btn-preset-room",25),Se("tl-btn-preset-steam",100),Se("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{n.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",de()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{n.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",de()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",o=>{n.bulbVolume=parseFloat(o.target.value),a.querySelector("#tl-val-bulb-vol").textContent=n.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",o=>{n.wallThickness=parseFloat(o.target.value),a.querySelector("#tl-val-wall-thickness").textContent=n.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-capillary-bore").addEventListener("input",o=>{n.capillaryBore=parseFloat(o.target.value),a.querySelector("#tl-val-capillary-bore").textContent=n.capillaryBore.toFixed(2)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",o=>{n.liquidL0=parseFloat(o.target.value),a.querySelector("#tl-val-liquid-l0").textContent=n.liquidL0.toFixed(1)+" cm",de()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",o=>{n.liquidL100=parseFloat(o.target.value),a.querySelector("#tl-val-liquid-l100").textContent=n.liquidL100.toFixed(1)+" cm",de()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",o=>{n.resistanceR0=parseFloat(o.target.value),a.querySelector("#tl-val-resistance-r0").textContent=n.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=n.resistanceR0.toFixed(1)+" Ω",de()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",o=>{n.resistanceR100=parseFloat(o.target.value),a.querySelector("#tl-val-resistance-r100").textContent=n.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=n.resistanceR100.toFixed(1)+" Ω",de()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",o=>{n.thermistorR25=parseFloat(o.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=n.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=n.thermistorR25.toFixed(1)+" kΩ",de()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",o=>{n.thermistorBeta=parseFloat(o.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=n.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=n.thermistorBeta+" K",de()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active")}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active")}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",be),a.querySelector("#tl-input-faulty-cu").addEventListener("input",be),a.querySelector("#tl-input-q10a-cm").addEventListener("input",be),a.querySelector("#tl-input-q10b-t").addEventListener("input",be),a.querySelector("#tl-input-q11-r").addEventListener("input",Me)}if(i.type){const e=a.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return a.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===l?e.classList.add("active"):e.classList.remove("active")}),a.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===l?e.classList.add("active"):e.classList.remove("active")}),p(),ke(),de(),se=requestAnimationFrame(pe),a._thermometerLabCleanup=()=>{se&&cancelAnimationFrame(se)},a}const Te=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],Fe=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],_t=[["thermometer","topic.thermometer"]],De=["liquid","resistance","thermistor"],Mt={liquid:t=>ze(t,{type:"liquid"}),resistance:t=>ze(t,{type:"resistance"}),thermistor:t=>ze(t,{type:"thermistor"})};function Rt(t){return s({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title"}[t]||t)}function He(){return xe()==="zh-Hant"?"zhHant":"en"}async function Ht(t,i){const l=`./${t}/${i}`;try{return(await fetch(l,{method:"HEAD"})).ok}catch{return!1}}async function Oe(t){return Ht("notes",t)}function Lt(t){let i="topics",l="liquid",r=0,u="all",a=!1,n=null,T={main:null},z=null;function te(){if(T.main){if(i==="topics"?T.main.innerHTML=L():i==="notes"?T.main.innerHTML=K():i==="tools"?T.main.innerHTML=R():i==="worksheets"?T.main.innerHTML=Xe(s,{topics:_t,paperTitleKey:"worksheets.paperTitleHeat"}):i==="flashcards"?T.main.innerHTML=ae():i==="summary"&&(T.main.innerHTML=X()),i==="notes"&&q(),i==="tools"&&F(),i==="worksheets"){const m=Ye.filter(p=>Fe.includes(p.topic));Ze(t,m,s,He,{topicFilter:(p,d)=>d.includes("thermometer")?Fe.includes(p.topic):d.includes(p.topic)})}i==="flashcards"&&V(),i==="summary"&&Z()}}function W(){n==null||n.destroy(),n=Ke(t,{subtitleKey:"strand.heat.subtitle",activeSection:i,onSection:m=>{i==="tools"&&m!=="tools"&&z!=null&&z._thermometerLabCleanup&&(z._thermometerLabCleanup(),z=null),i=m,n.updateSection(i),te()},onLang:()=>W()}),T.main=n.main,n.updateSection(i),te()}function L(){return`
      ...
      </section>`}async function q(){const m=He();for(const p of Te){const d=t.querySelector(`[data-note-card="${p.id}"]`);if(!d)continue;const c=d.querySelector("[data-note-body]"),h=m==="zhHant"?p.fileZh:p.fileEn,A=await Oe(h),x=`./notes/${h}`;A?c.innerHTML=`
