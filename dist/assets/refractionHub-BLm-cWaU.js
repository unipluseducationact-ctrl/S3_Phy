const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./opticsLightLensWorksheet-BXnIjaW6.js","./index-B31cp28G.js","./index-D16P_DNl.css","./refractionLab-GUS8fdAq.js","./createLabIframe-DgsK3lE1.js","./tirEscapeLab-6kizOOWH.js","./mirageLab-Dx20fB2R.js"])))=>i.map(i=>d[i]);
import{t as n,_ as f,g as P}from"./index-B31cp28G.js";import{l as V,m as j,c as z,s as T,h as Z,a as W}from"./hubShell-BdmW6qjF.js";import{r as Y,h as U}from"./toolsShell-C-Th6Ujm.js";import{m as q,b as x}from"./flashcardDeck-C63thpgN.js";const _=["refraction","refractionTir","mirage"],g="s3phy.refraction.tool",F=["lightLens"],G="20260627-em-v2",E=[{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"}],k=[{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"}],S={lightLens:()=>f(()=>import("./opticsLightLensWorksheet-BXnIjaW6.js"),__vite__mapDeps([0,1,2]),import.meta.url).then(e=>e.createOpticsLightLensWorksheet)},B={refraction:()=>f(()=>import("./refractionLab-GUS8fdAq.js"),__vite__mapDeps([3,4,1,2]),import.meta.url).then(e=>e.createRefractionLab),refractionTir:()=>f(()=>import("./tirEscapeLab-6kizOOWH.js"),__vite__mapDeps([5,4,1,2]),import.meta.url).then(e=>e.createTirEscapeLab),mirage:()=>f(()=>import("./mirageLab-Dx20fB2R.js"),__vite__mapDeps([6,4,1,2]),import.meta.url).then(e=>e.createMirageLab)};function O(e){return n({refraction:"tools.refraction.title",refractionTir:"tools.refractionTir.title",mirage:"tools.mirage.title"}[e]||e)}function J(e){return n({lightLens:"worksheets.opticsLightLensTitle"}[e]||e)}function nt(e){let i=sessionStorage.getItem("s3phy.refraction.section")||"topics",d=V(g,_,"refraction"),p="lightLens",a=null,c={main:null},h=null,l=null,r=null;const w=[{value:"refractionTir",labelKey:"flashcards.deck.refractionTir"}];function v(){z(h),h=null}async function R(t){t.innerHTML="",v();const o=B[d];if(!o)return;const s=(await o())(n);h=s,t.appendChild(s)}async function $(t){if(!t)return;r==null||r(),r=null,t.innerHTML="";const o=S[p];if(!o)return;const s=(await o())(n);t.appendChild(s),r=s._opticsLightLensWorksheetCleanup||null}function A(){const t=F.map(o=>`<button type="button" data-worksheet="${o}" class="${p===o?"active":""}">${J(o)}</button>`).join("");return`
