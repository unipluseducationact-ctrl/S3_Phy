...
import{t as n,_ as r}from"./index-BA6P-BC5.js";import{m as S}from"./hubShell-B8vEe4v5.js";import{l as O,s as w,r as R,h as $,a as A,c as M}from"./toolsShell-yAniuhfv.js";const m="s3phy.waves.tool",h=[{id:"waveMotion",titleKey:"topic.waveMotion",fileEn:"wave-motion-en.pdf",fileZh:"wave-motion-zhHant.pdf",tool:"waveMotion"},{id:"waveProperties",titleKey:"topic.waveProperties",fileEn:"wave-properties-en.pdf",fileZh:"wave-properties-zhHant.pdf",tool:"waveInterference"},{id:"stationaryWave",titleKey:"topic.stationaryWave",fileEn:"stationary-wave-en.pdf",fileZh:"stationary-wave-zhHant.pdf"},{id:"lightWave",titleKey:"topic.lightWave",fileEn:"light-wave-en.pdf",fileZh:"light-wave-zhHant.pdf",tool:"thinFilmInterference"},{id:"soundWave",titleKey:"topic.soundWave",fileEn:"sound-wave-en.pdf",fileZh:"sound-wave-zhHant.pdf",tool:"ultrasoundReflection"}],_=["waveMotion","longitudinalWave","waveInterference","thinFilmInterference","diffractionGratingCompare","spectralOverlap","ultrasoundReflection","soundRefractionShadow"],W={waveMotion:()=>r(()=>import("./waveMotionLab-DpFR5IyP.js"),__vite__mapDeps([0,1,2,3]),import.meta.url).then(e=>e.createWaveMotionLab),longitudinalWave:()=>r(()=>import("./longitudinalWaveLab-bJDodIq_.js"),__vite__mapDeps([4,1,2,3]),import.meta.url).then(e=>e.createLongitudinalWaveLab),waveInterference:()=>r(()=>import("./waveInterferenceLab-CX7m0d6d.js"),__vite__mapDeps([5,1,2,3]),import.meta.url).then(e=>e.createWaveInterferenceLab),thinFilmInterference:()=>r(()=>import("./thinFilmInterferenceLab-CoMbu1dP.js"),__vite__mapDeps([6,1,2,3]),import.meta.url).then(e=>e.createThinFilmInterferenceLab),diffractionGratingCompare:()=>r(()=>import("./diffractionGratingCompareLab-OaY0gNyS.js"),__vite__mapDeps([7,1,2,3]),import.meta.url).then(e=>e.createDiffractionGratingCompareLab),spectralOverlap:()=>r(()=>import("./spectralOverlapLab-FxOCHehW.js"),__vite__mapDeps([8,1,2,3]),import.meta.url).then(e=>e.createSpectralOverlapLab),ultrasoundReflection:()=>r(()=>import("./ultrasoundReflectionLab-Cv7XQaTF.js"),__vite__mapDeps([9,1,2,3]),import.meta.url).then(e=>e.createUltrasoundReflectionLab),soundRefractionShadow:()=>r(()=>import("./soundRefractionShadowLab-0xpNp1Qv.js"),__vite__mapDeps([10,1,2,3]),import.meta.url).then(e=>e.createSoundRefractionShadowLab)};function b(e){return n({waveMotion:"tools.waveMotion.title",longitudinalWave:"tools.longitudinalWave.title",waveInterference:"tools.waveInterference.title",thinFilmInterference:"tools.thinFilmInterference.title",diffractionGratingCompare:"tools.diffractionGratingCompare.title",spectralOverlap:"tools.spectralOverlap.title",ultrasoundReflection:"tools.ultrasoundReflection.title",soundRefractionShadow:"tools.soundRefractionShadow.title"}[e]||e)}function C(e){let i=sessionStorage.getItem("s3phy.waves.section")||"topics",l=O(m,_,"waveMotion"),o=null,s={main:null},u=null;function v(){M(u),u=null}async function L(t){t.innerHTML="",v();const a=W[l];if(!a)return;const d=(await a())(n);u=d,t.appendChild(d)}function c(){s.main&&(i==="topics"?s.main.innerHTML=E():i==="notes"?(s.main.innerHTML=I(),T()):i==="tools"?(s.main.innerHTML=R({toolOrder:_,toolId:l,getLabel:b,t:n}),$(e,{getLabel:b,t:n,getActiveToolId:()=>l,onSelectTool:t=>{l=t,w(m,l)},mountTool:t=>{L(t)}})):s.main.innerHTML=`
    ...
    `}function I(){return`
      ...
      </section>`}async function T(){const t=h.map(a=>({key:a.id,fileEn:a.fileEn,fileZh:a.fileZh}));await A(e,t)}function g(t){const a=t.target.closest("[data-go-tool]");if(a){const d=a.getAttribute("data-go-tool");_.includes(d)&&(l=d,w(m,l)),i="tools",sessionStorage.setItem("s3phy.waves.section","tools"),o.updateSection(i),c();return}const p=t.target.closest("[data-go-section]");(p==null?void 0:p.getAttribute("data-go-section"))==="notes"&&(i="notes",sessionStorage.setItem("s3phy.waves.section","notes"),o.updateSection(i),c())}return e.addEventListener("click",g),window.addEventListener("s3phy:lang",f),y(),()=>{e.removeEventListener("click",g),window.removeEventListener("s3phy:lang",f),v(),o==null||o.destroy()}}export{C as mountWavesHub};
