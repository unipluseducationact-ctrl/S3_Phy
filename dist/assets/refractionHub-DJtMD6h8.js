const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./opticsLightLensWorksheet-CB3lSqNX.js","./index-CnmWc1Ee.js","./index-D16P_DNl.css","./refractionLab-r89Bu9Br.js","./createLabIframe-q0_OAt04.js","./tirEscapeLab-RGuigEt8.js"])))=>i.map(i=>d[i]);
import{t as e,_ as v,g as D}from"./index-CnmWc1Ee.js";import{c as N,h as K,a as P}from"./hubHelpers-DcliJE8G.js";import{m as j}from"./hubShell-D8V8wCpd.js";import{r as z,m as V,h as Z,b as W}from"./flashcardDeck-DMDXL9ub.js";const U=["refraction","refractionTir"],Y=["lightLens"],q="20260627-em-v2",g=[{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"}],T=[{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"}],k={lightLens:()=>v(()=>import("./opticsLightLensWorksheet-CB3lSqNX.js"),__vite__mapDeps([0,1,2]),import.meta.url).then(i=>i.createOpticsLightLensWorksheet)},x={refraction:()=>v(()=>import("./refractionLab-r89Bu9Br.js"),__vite__mapDeps([3,4,1,2]),import.meta.url).then(i=>i.createRefractionLab),refractionTir:()=>v(()=>import("./tirEscapeLab-RGuigEt8.js"),__vite__mapDeps([5,4,1,2]),import.meta.url).then(i=>i.createTirEscapeLab)};function S(i){return e({refraction:"tools.refraction.title",refractionTir:"tools.refractionTir.title"}[i]||i)}function F(i){return e({lightLens:"worksheets.opticsLightLensTitle"}[i]||i)}function X(i){let n=sessionStorage.getItem("s3phy.refraction.section")||"topics",u="refraction",f="lightLens",a=null,c={main:null},m=null,l=null,r=null;const _=[{value:"refractionTir",labelKey:"flashcards.deck.refractionTir"}];function h(){N(m),m=null}async function E(t){t.innerHTML="",h();const o=x[u];if(!o)return;const s=(await o())(e);m=s,t.appendChild(s)}async function w(t){if(!t)return;r==null||r(),r=null,t.innerHTML="";const o=k[f];if(!o)return;const s=(await o())(e);t.appendChild(s),r=s._opticsLightLensWorksheetCleanup||null}function O(){const t=Y.map(o=>`<button type="button" data-worksheet="${o}" class="${f===o?"active":""}">${F(o)}</button>`).join("");return`
      ...
      </section>`}async function C(){await P(i,T,{version:q})}const b=y,L=t=>A(t);return window.addEventListener("s3phy:lang",b),i.addEventListener("click",L),$(),()=>{window.removeEventListener("s3phy:lang",b),i.removeEventListener("click",L),l==null||l(),r==null||r(),h(),a==null||a.destroy()}}export{X as mountRefractionHub};
