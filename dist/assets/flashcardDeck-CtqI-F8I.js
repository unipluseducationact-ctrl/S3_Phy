import{t as l,g as R,s as W,_ as G}from"./index-BpqiJbZv.js";function O(){return R()==="zh-Hant"?"zhHant":"en"}async function M(t,n){const r=`./${t}/${n}`;try{return(await fetch(r,{method:"HEAD"})).ok}catch{return!1}}async function K(t){return M("notes",t)}function Z(t){return`${String(t).split("#")[0]}#view=FitH&toolbar=0&navpanes=0&scrollbar=0`}function D(t,n,r){const i=Z(n);return`
  ...
  `;const a=t.querySelector("[data-main]"),c=t.querySelector("[data-nav]"),e=t.querySelector("[data-lang]"),p=t.querySelector("[data-strand-back]");let f=r;function y(u){f=u,c.innerHTML=j.map(h=>`<button type="button" class="${u===h?"active":""}" data-sec="${h}">${l(V[h])}</button>`).join(""),c.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>i(h.getAttribute("data-sec")))})}function v(){e.innerHTML=`
