(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))i(d);new MutationObserver(d=>{for(const n of d)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(d){const n={};return d.integrity&&(n.integrity=d.integrity),d.referrerPolicy&&(n.referrerPolicy=d.referrerPolicy),d.crossOrigin==="use-credentials"?n.credentials="include":d.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(d){if(d.ep)return;d.ep=!0;const n=o(d);fetch(d.href,n)}})();const Fe={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Flip cards to revise key terms. Reflection uses picture cards from your flashcard set.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.shuffle":"Shuffle","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF). Preview below or open in a new tab to download.","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.specificHeat.title":"Specific Heat Capacity Lab","tools.thermalMixing.title":"Thermal Mixing Lab","tools.changeOfState.title":"Change of State Lab","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","tools.thermometerLab.liquid.title":"Liquid-in-Glass Thermometer","tools.thermometerLab.liquid.subtitle":"Explore the effects of bulb volume, capillary bore, and liquid type on sensitivity and response time.","tools.thermometerLab.resistance.title":"Platinum Resistance Thermometer","tools.thermometerLab.resistance.subtitle":"Investigate how platinum resistance varies linearly with temperature and solve calibration problems.","tools.thermometerLab.thermistor.title":"NTC Thermistor","tools.thermometerLab.thermistor.subtitle":"Study the non-linear resistance-temperature relationship of NTC thermistors and live beta calculations.","tools.thermometerLab.labels.show":"Show Structure Labels","tools.thermometerLab.labels.hide":"Hide Structure Labels","tools.thermometerLab.labels.thinWall":"Thin glass wall (fast heat transfer)","tools.thermometerLab.labels.largeBulb":"Large bulb (contains more liquid, increases sensitivity)","tools.thermometerLab.labels.narrowBore":"Narrow capillary bore (liquid rises higher, increases sensitivity)","tools.thermometerLab.labels.meniscus":"Meniscus (reading point)","tools.thermometerLab.labels.platinumCoil":"Platinum coil (resistance increases linearly with temp)","tools.thermometerLab.labels.metalSheath":"Metal sheath (protects & conducts heat quickly)","tools.thermometerLab.labels.semiconductorBead":"Semiconductor bead (resistance decreases exponentially with temp)","tools.thermometerLab.labels.leads":"Connecting leads","tools.thermometerLab.faulty.dualScale":"Dual-Scale Comparison Diagram","tools.thermometerLab.faulty.trueScale":"True Scale (°C)","tools.thermometerLab.faulty.faultyScale":"Faulty Scale (°C)","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},ct={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"翻卡複習重要詞彙。反射課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.shuffle":"洗牌","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF）。可於下方預覽，或新分頁開啟下載。","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","tools.thermometerLab.title":"溫度計與校準實驗室","tools.specificHeat.title":"比熱容量實驗室","tools.thermalMixing.title":"熱混合實驗室","tools.changeOfState.title":"物態變化實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","tools.thermometerLab.liquid.title":"液體玻璃溫度計","tools.thermometerLab.liquid.subtitle":"探索玻璃泡容積、毛細管內外徑和液體種類對靉敏度及反應時間的影響。","tools.thermometerLab.resistance.title":"鈐電阻溫度計","tools.thermometerLab.resistance.subtitle":"研究鈐電阻如何隨溫度呈線性變化，並解決溫度校準問題。","tools.thermometerLab.thermistor.title":"NTC 熱敏電阻溫度計","tools.thermometerLab.thermistor.subtitle":"學習負溫度係數（NTC）熱敏電阻的非線性電阻-溫度關係，並進行實時 Beta 計算。","tools.thermometerLab.labels.show":"顯示結構標註","tools.thermometerLab.labels.hide":"隱藏結構標註","tools.thermometerLab.labels.thinWall":"薄玻璃壁 (快速傳熱)","tools.thermometerLab.labels.largeBulb":"大玻璃泡 (容納更多液體，提高靉敏度)","tools.thermometerLab.labels.narrowBore":"細毛細管 (液柱升得更高，提高靉敏度)","tools.thermometerLab.labels.meniscus":"彎月面 (讀數位置)","tools.thermometerLab.labels.platinumCoil":"鈐絲線圈 (電阻隨溫度線性增加)","tools.thermometerLab.labels.metalSheath":"金屬保護套 (保護並快速導熱)","tools.thermometerLab.labels.semiconductorBead":"半導體小珠 (電阻隨溫度指數級減少)","tools.thermometerLab.labels.leads":"連接導線","tools.thermometerLab.faulty.dualScale":"雙刻度對比示意圖","tools.thermometerLab.faulty.trueScale":"標準溫標 (°C)","tools.thermometerLab.faulty.faultyScale":"偏差溫標 (°C)","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},Ke="s3phy.lang",Xe={en:Fe,"zh-Hant":ct};let Ie="en";function dt(){try{const t=localStorage.getItem(Ke);if(t==="zh-Hant"||t==="en")return t}catch{}return"en"}function ut(){Ie=dt()}function Ze(t){if(Xe[t]){Ie=t;try{localStorage.setItem(Ke,t)}catch{}document.documentElement.lang=t==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function fe(){return Ie}function l(t){const r=Xe[Ie]||Fe;return Object.prototype.hasOwnProperty.call(r,t)?r[t]:Object.prototype.hasOwnProperty.call(Fe,t)?Fe[t]:t}const ft=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function pt(t){function r(){t.innerHTML=`
    ...
    `;const i=t.querySelector("[data-lang]");i.innerHTML=`
      <button type="button" data-set-lang="en" class="${fe()==="en"?"active":""}">${l("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${fe()==="zh-Hant"?"active":""}">${l("lang.zhHant")}</button>
...
`;function gt(){if(document.getElementById(Ge))return;const t=document.createElement("style");t.id=Ge,t.textContent=ht,document.head.appendChild(t)}function bt(t){gt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
  ...
  `;const o=r.querySelector(".rml-canvas"),i=o.getContext("2d"),d=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),S=r.querySelector('[data-rml-disp="inc"]'),F=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,O=380,Z=300,_="#22d3ee",z="bold 17px system-ui, sans-serif";let I=0,j=-140,ae=!0,X=!0,U=!0,V=!0;function Y(h){return h*Math.PI/180}function J(h,u,c,g,A,L=2,H=!1){i.beginPath(),i.lineWidth=L,i.strokeStyle=A,i.setLineDash(H?[6,6]:[]);const y=h+Math.cos(Y(c))*g,x=u+Math.sin(Y(c))*g;return i.moveTo(h,u),i.lineTo(y,x),i.stroke(),i.setLineDash([]),{x:y,y:x}}function ee(h,u,c,g,A,L=14){const H=c-h,y=g-u,x=Math.hypot(H,y);if(x<1e-6)return;const G=H/x,R=y/x,Q=c-G*L,E=g-R*L,ce=.45*L;i.beginPath(),i.fillStyle=A,i.moveTo(c,g),i.lineTo(Q-R*ce,E+G*ce),i.lineTo(Q+R*ce,E-G*ce),i.closePath(),i.fill()}function K(h,u,c,g,A,L=25){i.beginPath(),i.strokeStyle=g,i.lineWidth=2;const H=Math.min(h,u),y=Math.max(h,u);if(i.arc($,O,c,Y(H),Y(y),!1),i.stroke(),A){const x=(H+y)/2,G=$+Math.cos(Y(x))*(c+L),R=O+Math.sin(Y(x))*(c+L);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=g,i.fillText(A,G,R),i.restore()}}function ne(h,u,c,g,A){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,O),i.lineTo($+200,O),i.stroke(),i.setLineDash([]),i.lineCap="butt";const L=$+Math.cos(Y(h))*Z,H=O+Math.sin(Y(h))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(L,H),i.lineTo($,O),i.stroke();const y=(L+$)*.5,x=(H+O)*.5,G=Math.hypot($-L,O-H)||1,R=($-L)/G,Q=(O-H)/G;if(ee(y-R*28,x-Q*28,y,x,"#fff",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),L,H-12),i.restore(),ae){const E=J($,O,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),E.x+6,E.y-4),i.restore()}if(X){const E=J($,O,g,Z,"#00e676",2,!1);ee($,O,E.x,E.y,"#00e676",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),E.x,E.y-14),i.restore()}i.save(),i.translate($,O),i.rotate(Y(I)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let E=-190;E<200;E+=15)i.moveTo(E,0),i.lineTo(E-5,8);if(i.stroke(),i.restore(),U){const E=J($,O,u,Z-40,_,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=_,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),E.x+6,E.y-4),i.restore()}if(V){const E=J($,O,c,Z,_,4);ee($,O,E.x,E.y,_,16),Math.abs(I)>.5&&(i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=_,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),E.x,E.y-14),i.restore())}if(U&&K(h,u,100,"#ffcc00",`i=${A.toFixed(0)}°`,25),U&&V&&K(u,c,100,_,`r=${A.toFixed(0)}°`,25),ae&&U&&Math.abs(I)>.5&&K(-90,u,50,"#ffcc00",`θ=${Math.abs(I)}°`,20),X&&V&&Math.abs(I)>.5){const E=c-g;K(g,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${E.toFixed(0)}°`,40)}}function v(){I=parseFloat(d.value),j=parseFloat(n.value);const h=I>0?"+":"";a.textContent=`${h}${I}°`,S.textContent=`${j}°`;const u=-90,c=Math.abs(j-u),g=u+c,A=-90+I,L=Math.abs(j-A),H=A+L,y=H-g;F.textContent=`${L.toFixed(1)}°`,te.textContent=`${L.toFixed(1)}°`;const x=y>0?"+":"";P.textContent=`${x}${y.toFixed(1)}°`,ne(j,A,H,g,L)}return r.querySelectorAll("[data-rml-toggle]").forEach(h=>{h.addEventListener("click",()=>{const u=h.getAttribute("data-rml-toggle");u==="orig-norm"&&(ae=!ae),u==="orig-ray"&&(X=!X),u==="new-norm"&&(U=!U),u==="new-ray"&&(V=!V),h.classList.toggle("active"),v()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{d.value="0",v()}),d.addEventListener("input",v),n.addEventListener("input",v),v(),r}function vt(t){const r=document.createElement("div");r.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;return o.src=`${d}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(o),r}function yt(t,r={}){const o=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",d=document.createElement("div");d.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",S=a.endsWith("/")?a:`${a}/`;return n.src=`${S}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",d.appendChild(n),d}function wt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;function n(){return`${d}em-spectrum/index.html?lang=${encodeURIComponent(fe())}`}o.src=n(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var S;try{(S=o.contentWindow)==null||S.postMessage({type:"s3phy:lang",lang:fe()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function xt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const o=r.querySelector("[data-r]"),i=r.querySelector("[data-g]"),d=r.querySelector("[data-b]"),n=r.querySelector(".rgb-mixer-canvas"),a=r.querySelector(".rgb-mixer-stage"),S=n.getContext("2d");function F(_){return _.toString(16).padStart(2,"0")}function te(_,z,I){const j=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),X=j/2,U=ae/2,V=Math.min(j,ae)*.34,Y=V*.5,J=Math.sqrt(3)/2;S.clearRect(0,0,j,ae),S.fillStyle="#000",S.fillRect(0,0,j,ae);const ee=[{x:X,y:U-Y,rgb:[255,0,0],val:_},{x:X-Y*J,y:U+Y*.5,rgb:[0,255,0],val:z},{x:X+Y*J,y:U+Y*.5,rgb:[0,0,255],val:I}];S.globalCompositeOperation="lighter",ee.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[v,h,u]=K.rgb,c=S.createRadialGradient(K.x,K.y,0,K.x,K.y,V);c.addColorStop(0,`rgba(${v},${h},${u},${ne})`),c.addColorStop(.65,`rgba(${v},${h},${u},${ne})`),c.addColorStop(.85,`rgba(${v},${h},${u},${ne*.5})`),c.addColorStop(1,`rgba(${v},${h},${u},0)`),S.fillStyle=c,S.beginPath(),S.arc(K.x,K.y,V,0,Math.PI*2),S.fill()}),S.globalCompositeOperation="source-over"}function P(){const _=a.getBoundingClientRect(),z=Math.max(200,Math.min(_.width-8,_.height-8,720)),I=window.devicePixelRatio||1;n.width=z*I,n.height=z*I,n.style.width=`${z}px`,n.style.height=`${z}px`,S.setTransform(I,0,0,I,0,0),te(+o.value,+i.value,+d.value)}function $(){const _=+o.value,z=+i.value,I=+d.value,j=`rgb(${_}, ${z}, ${I})`,ae=`#${F(_)}${F(z)}${F(I)}`;r.querySelector("[data-r-val]").textContent=_,r.querySelector("[data-g-val]").textContent=z,r.querySelector("[data-b-val]").textContent=I,r.querySelector("[data-r-bar]").style.width=`${_/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${z/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${I/255*100}%`,o.style.setProperty("--fill",`${_/255*100}%`),i.style.setProperty("--fill",`${z/255*100}%`),d.style.setProperty("--fill",`${I/255*100}%`);const X=r.querySelector("[data-swatch]");X.style.backgroundColor=j,X.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${j}`),r.querySelector("[data-rgb-text]").textContent=j,r.querySelector("[data-hex-text]").textContent=ae,te(_,z,I)}function O(_,z,I){o.value=_,i.value=z,d.value=I,$()}return[o,i,d].forEach(_=>_.addEventListener("input",$)),r.querySelectorAll(".rgb-presets button").forEach(_=>{_.addEventListener("click",()=>{O(+_.dataset.r,+_.dataset.g,+_.dataset.b)})}),new ResizeObserver(()=>P()).observe(a),requestAnimationFrame(()=>{P(),$()}),r}const qt=["topics","notes","tools","worksheets","flashcards","summary"],St={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function tt(t,{subtitleKey:r,activeSection:o,onSection:i,onLang:d}){t.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),S=t.querySelector("[data-lang]"),F=t.querySelector("[data-strand-back]");let te=o;function P(_){te=_,a.innerHTML=qt.map(z=>`<button type="button" class="${_===z?"active":""}" data-sec="${z}">${l(St[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>i(z.getAttribute("data-sec")))})}function $(){S.innerHTML=`
    ...
    <section class="panel panel--worksheets">
      ...
      ${ce?`<p>${o("worksheets.weakSections")}:</p><ul>${ce}</ul>`:""}`,z.hidden=!1}function u(y){const x=U(),G=n.items.map((R,Q)=>{const E=R[x]||R.en,ce=E.choices.map((pe,be)=>`${We[be]}. ${pe}`).join("<br/>"),se=y?`<p><b>${o("worksheets.answer")}:</b> ${We[E.a]}<br/><i>${E.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${E.q}<br/>${ce}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${G}</body></html>`}function c(y){const x=u(y),G=new Blob(["\uFEFF",x],{type:"application/msword"}),R=document.createElement("a");R.href=URL.createObjectURL(G),R.download=y?"worksheet-answers.doc":"worksheet.doc",R.click(),URL.revokeObjectURL(R.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),x=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),G=Tt(r,x,d.topicFilter),R=Be(G).slice(0,Math.min(y,G.length||1));n.items=R.length?R:Be(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",S.hidden=!1,F.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),I&&(I.hidden=!1),j&&(j.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const x=y.target.closest("[data-ws-tab]");!x||!n.items.length||ee(x.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=kt(),X.textContent=`${o("worksheets.date")}: ${n.dateStr}`),j&&(j.hidden=!n.dateStr,j.textContent=n.dateStr?`${o("worksheets.date")}: ${n.dateStr}`:"")}),(g=t.querySelector("[data-ws-word-p]"))==null||g.addEventListener("click",()=>c(!1)),(A=t.querySelector("[data-ws-word-a]"))==null||A.addEventListener("click",()=>c(!0)),(L=t.querySelector("[data-ws-print-p]"))==null||L.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(H=t.querySelector("[data-ws-print-a]"))==null||H.addEventListener("click",()=>{ee("answer"),window.print()})}const Ct=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Mt={rotatingMirror:t=>bt(t),refractionTir:t=>vt(t),lens:(t,r)=>yt(t,{defaultKind:r}),rgbMixer:t=>xt(t),em:t=>wt(t)};function _t(t){return l({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return fe()==="zh-Hant"?"zhHant":"en"}async function it(t,r){const o=`./${t}/${r}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function Lt(t){return it("notes",t)}function Rt(t){let r="topics",o="rotatingMirror",i="convex",d=0,n="all",a=!1,S=null,F={main:null};function te(){F.main&&(r==="topics"?F.main.innerHTML=$():r==="notes"?F.main.innerHTML=Z():r==="tools"?F.main.innerHTML=z():r==="worksheets"?F.main.innerHTML=at(l):r==="flashcards"?F.main.innerHTML=ae():r==="summary"&&(F.main.innerHTML=K()),r==="notes"&&_(),r==="tools"&&I(),r==="worksheets"&&nt(t,Je,l,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){S==null||S.destroy(),S=tt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:u=>{r=u,S.updateSection(r),te()},onLang:()=>P()}),F.main=S.main,S.updateSection(r),te()}function $(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([c,g])=>{const A=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,L=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${l(g)}</h3>
              <button class="btn primary" type="button" data-go-tool="${A}"${L?` data-lens-kind="${L}"`:""}>${l("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function O(u){const c=u.target.closest("[data-go-tool]");if(!c)return;r="tools",o=c.getAttribute("data-go-tool");const g=c.getAttribute("data-lens-kind");(g==="convex"||g==="concave")&&(i=g),S.updateSection(r),te()}function Z(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
      ...
      </section>`}async function _(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Ae();for(const g of u){const A=t.querySelector(`[data-note-card="${g.key}"]`);if(!A)continue;const L=A.querySelector("[data-note-body]"),H=c==="zhHant"?g.fileZh:g.fileEn,y=await Lt(H),x=`./notes/${H}`;y?L.innerHTML=`
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ct.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${_t(u)}</button>`).join("")}
          </div>
      ...
      <section class="panel">
        ...
        <div class="grid cols-2" data-summary-grid>
          ...
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:L.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const v=()=>P(),h=u=>O(u);return window.addEventListener("s3phy:lang",v),t.addEventListener("click",h),P(),()=>{window.removeEventListener("s3phy:lang",v),t.removeEventListener("click",h),S==null||S.destroy()}}const je="s3phy-thermometer-lab-css",zt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Ht(){if(document.getElementById(je))return;const t=document.createElement("style");t.id=je,t.textContent=zt,document.head.appendChild(t)}function Pe(t,r={}){Ht();const o=r.type||"liquid";let i=t("tools.thermometerLab.title"),d=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),d=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),d=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),d=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},S=460,F=340,te=80,P=800,$=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let s=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(s=150),p>145&&(s=200);const m=s<=100?20:25;return{minT:0,maxT:s,tickStep:m}}function _(e,s,p,m,f){return m+(e-s)/(p-s)*f}function z(e,s,p,m,f){return m+f-(e-s)/(p-s)*f}function I(e,s,p,m,f,k){const{gx:b,gy:w,gw:T,gh:C,tickFont:M,axisFont:W,yLabelX:N,xLabelY:q}=s;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of k){const B=z(D.value,D.min,D.max,w,C);e.beginPath(),e.moveTo(b,B),e.lineTo(b+T,B),e.stroke()}for(let D=p;D<=m+.01;D+=f){const B=_(D,p,m,b,T);e.beginPath(),e.moveTo(B,w),e.lineTo(B,w+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(b,w),e.lineTo(b,w+C),e.lineTo(b+T,w+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=M,e.textAlign="right",e.textBaseline="middle";for(const D of k){const B=z(D.value,D.min,D.max,w,C);e.fillText(D.label,b-15,B)}e.textAlign="center",e.textBaseline="top";for(let D=p;D<=m+.01;D+=f){const B=_(D,p,m,b,T);e.fillText(`${Math.round(D)}`,B,w+C+10)}return{gx:b,gy:w,gw:T,gh:C,axisFont:W,yLabelX:N,xLabelY:q}}function j(e,s){const p=s-e,m=p<=8?1:p<=14?2:5,f=[],k=Math.ceil(e/m)*m;for(let b=k;b<=s+.001;b+=m)f.push({value:b,label:b%1===0?`${b.toFixed(0)}`:`${b.toFixed(1)}`,min:e,max:s});return f}function ae(){const{maxT:e}=Z(),s=X(0),p=X(e),m=p-s,f=Math.max(1,m*.1),k=Math.max(0,Math.round((s-f)*10)/10),b=Math.round((p+f)*10)/10;return{minL:k,maxL:b}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),s=V(0),p=V(e),m=p-s,f=Math.max(.2,m*.1),k=Math.max(0,s-f),b=p+f,w=m<=2?.5:m<=4?1:2,T=[],C=Math.ceil(k/w)*w;for(let M=C;M<=b+.001;M+=w)T.push({value:M,label:M.toFixed(1),min:k,max:b});return{minR:k,maxR:b,ticks:T}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:s}=e;let p=a.thermistorR25;for(let b=0;b<=s;b+=5){const w=b+273.15,T=a.thermistorR25*Math.exp(a.thermistorBeta*(1/w-1/298.15));p=Math.max(p,T)}p=Math.ceil(p*1.08*10)/10;const m=0,f=p<=12?2:4,k=[];for(let b=0;b<=p+.001;b+=f)k.push({value:b,label:b.toFixed(0),min:m,max:p});return{minR:m,maxR:p,ticks:k}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),v=window.devicePixelRatio||1;J.width=S*v,J.height=F*v,ee.scale(v,v),K.width=P*v,K.height=$*v,ne.scale(v,v);function h(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const u=200,c=11;function g(){const e=Math.pow(a.bulbVolume/u,.3333333333333333);return c*e}function A(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,s=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,m=1.35-a.capillaryBore*.45;return Math.max(.1,s*p*m*e*.15)}function L(e){a.bathTemp<=8&&a.iceCubes.forEach(s=>{s.x+=s.speedX,s.y+=s.speedY,(s.x<65||s.x>175)&&(s.speedX*=-1),(s.y<195||s.y>210)&&(s.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(s=>{s.y-=s.speedY*(1+a.bathTemp/100),s.y<185&&(s.y=265,s.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(s=>{s.y-=s.speedY*(1+(a.bathTemp-80)/40),s.phase+=s.wobbleSpeed,s.x+=Math.sin(s.phase)*.3,s.y<185&&(s.y=260+Math.random()*10,s.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(s=>{s.x+=s.vx,s.y+=s.vy,s.alpha-=.005,(s.alpha<=0||s.y<130)&&(s.x=60+Math.random()*120,s.y=175+Math.random()*5,s.alpha=.2+Math.random()*.4)})}function H(e){let b=59,w=130,T=246;if(a.bathTemp<25){const q=a.bathTemp/25;b=Math.round(180-q*121),w=Math.round(210-q*80),T=Math.round(250-q*4)}else{const q=Math.min(1,(a.bathTemp-25)/125);b=Math.round(59+q*180),w=Math.round(130-q*100),T=Math.round(246-q*190)}if(a.bathTemp>40){const q=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let B=-25;B<=25;B+=6){const ie=q*(12+Math.sin(B*.4+D)*5);e.lineTo(55+130/2+B,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${b}, ${w}, ${T}, 0.25)`),C.addColorStop(1,`rgba(${b}, ${w}, ${T}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const M=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let q=55;q<=185;q+=5){const D=190+Math.sin(q*.15+N)*M;e.lineTo(q,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,s,p,m,f,k,b="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(s,p),e.lineTo(m,f),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(s,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const T=e.measureText(k).width+10,C=16,M=b==="left"?m:m-T,W=f-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(M,W,T,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(k,M+T/2,W+C/2+.5)}function x(e){const m=g(),f=250+Math.max(0,m-c)*.35,k=f-m-1,b=10+a.wallThickness*8,w=120-b/2,T=120+b/2,C=e.createLinearGradient(w,20,T,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,k),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(T,20,T,25,5),e.lineTo(T,k),e.closePath(),e.fill(),e.stroke();const M=e.createRadialGradient(120-m*.2,f-m*.2,m*.1,120,f,m);M.addColorStop(0,"rgba(255, 255, 255, 0.8)"),M.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=M,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,f,m+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(b*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,k-20-8);const N=a.liquidType==="mercury",q=N?"#a1a1aa":"#ef4444",D=N?"#f4f4f5":"#fee2e2",B=210,ie=220,ge=(B-40)/ie,ue=B-Math.min(ie,a.thermometerTemp)*ge;e.fillStyle=q,e.fillRect(120-W/2,ue,W,k-ue),e.beginPath(),e.ellipse(120,ue,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-W/6,ue,W/3,k-ue);const oe=m*.9,re=e.createRadialGradient(120-oe*.2,f-oe*.2,oe*.1,120,f,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,f,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const me=B-le*ge;e.beginPath(),e.moveTo(w,me),e.lineTo(w+4,me),e.stroke(),e.fillText(`${le}°C`,w-22,me+2.5)}a.showLabels&&(y(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,ue,230,ue-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,f,230,f+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function G(e){const b=e.createLinearGradient(115,20,125,20);b.addColorStop(0,"#71717a"),b.addColorStop(.3,"#f4f4f5"),b.addColorStop(.7,"#d4d4d8"),b.addColorStop(1,"#3f3f46"),e.fillStyle=b,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let N=0;N<8;N++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const T=245,C=40,M=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(T,C,M,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(T+10,C+12,M-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",T+M-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",T+14,C+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function R(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const f=20,k=225,b=12,w=120-b/2,T=e.createLinearGradient(w,f,w+b,f);T.addColorStop(0,"rgba(229, 231, 235, 0.4)"),T.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),T.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),T.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=T,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,f,b,k-f,[0,0,3,3]),e.fill(),e.stroke();const C=7,M=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);M.addColorStop(0,"#6b7280"),M.addColorStop(.7,"#1f2937"),M.addColorStop(1,"#09090b"),e.fillStyle=M,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,q=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,q,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,q-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+q-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,s,p,m,f,k,b,w,T){const{gx:C,gy:M,gw:W,gh:N}=s;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,m),e.lineTo(p,M+N),e.stroke(),e.beginPath(),e.moveTo(p,m),e.lineTo(C,m),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${f.toFixed(1)}${b}`,D=e.measureText(q).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(p-D/2,M+N+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,p,M+N+4),e.textAlign="right",e.textBaseline="middle";const B=`${k.toFixed(2)} ${w}`,ie=e.measureText(B).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(C-ie-2,m-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(B,C-7,m)}function E(e){const s=O(),{minL:p,maxL:m}=ae(),{minT:f,maxT:k,tickStep:b}=Z(),w=j(p,m),T=I(e,s,f,k,b,w),{gx:C,gy:M,gw:W,gh:N,axisFont:q,yLabelX:D,xLabelY:B,dotR:ie}={...s,...T};e.save(),e.translate(D,M+N/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+W/2,B);const we=k,ge=_(0,f,k,C,W),ue=z(X(0),p,m,M,N),oe=_(we,f,k,C,W),re=z(X(we),p,m,M,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(ge,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,me=a.currentLength;if(le>=f&&le<=k){const ve=_(le,f,k,C,W),Ce=z(me,p,m,M,N);Q(e,s,ve,Ce,le,me,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ce(e){const s=O(),{minR:p,maxR:m,ticks:f}=U(),k=Z(),b=I(e,s,k.minT,k.maxT,k.tickStep,f),{gx:w,gy:T,gw:C,gh:M,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...s,...b};e.save(),e.translate(N,T+M/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,q);const{minT:B,maxT:ie}=k,we=ie,ge=_(0,B,ie,w,C),ue=z(V(0),p,m,T,M),oe=_(we,B,ie,w,C),re=z(V(we),p,m,T,M);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(ge,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,me=a.currentResistance;if(le>=B&&le<=ie){const ve=_(le,B,ie,w,C),Ce=z(me,p,m,T,M);Q(e,s,ve,Ce,le,me,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const s=O(),p=Z(),{minR:m,maxR:f,ticks:k}=Y(p),b=I(e,s,p.minT,p.maxT,p.tickStep,k),{gx:w,gy:T,gw:C,gh:M,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...s,...b},{minT:B,maxT:ie}=p;e.save(),e.translate(N,T+M/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=B;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),me=_(oe,B,ie,w,C),ve=z(Math.min(f,le),m,f,T,M);ve>=T&&ve<=T+M&&(we?e.lineTo(me,ve):(e.moveTo(me,ve),we=!0))}e.stroke();const ge=a.thermometerTemp,ue=a.currentThermistorR;if(ge>=B&&ge<=ie){const oe=_(ge,B,ie,w,C),re=z(Math.min(f,ue),m,f,T,M);Q(e,s,oe,re,ge,ue,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function pe(){ee.clearRect(0,0,S,F),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),H(ee),a.thermometerType==="liquid"?x(ee):a.thermometerType==="resistance"?G(ee):R(ee),ee.restore(),a.thermometerType==="liquid"?E(ne):a.thermometerType==="resistance"?ce(ne):se(ne)}function be(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
    ...
    `}function qe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const s=n.querySelector("#tl-bath-state");a.bathTemp<=0?s.textContent="Melting Ice Bath":a.bathTemp>=100?s.textContent="Boiling Water/Steam":a.bathTemp===150?s.textContent="Hot Cooking Oil":s.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",be()}let Se=null;function Re(e){a.lastTimestamp||(a.lastTimestamp=e);const s=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(s,.1),m=A(),f=p/m*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=f,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const k=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/k-1/298.15)),L(),pe(),qe(m),Se=requestAnimationFrame(Re)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),s=parseFloat(n.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,m=Number.isFinite(s)?s:105,f=m-p;return{cf:p,cu:m,interval:f}}function He(e){const s=Math.round(e*100)/100;return s>=0?s.toFixed(1):`(${s.toFixed(1)})`}function he(){const{cf:e,cu:s,interval:p}=ze(),m=n.querySelector("#tl-val-faulty-interval"),f=n.querySelector("#tl-faulty-error-a"),k=n.querySelector("#tl-faulty-error-b"),b=Math.abs(p)<.01;m.textContent=p.toFixed(1)+" °C";const w=n.querySelector("#tl-svg-formula-faulty-a"),T=n.querySelector("#tl-svg-formula-faulty-b");if(b){f.hidden=!1,f.textContent="C_u must differ from C_f (interval cannot be zero).",k.hidden=!1,k.textContent=f.textContent,w&&(w.innerHTML=""),T&&(T.innerHTML="");return}f.hidden=!0,k.hidden=!0;const C=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,M=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(C-e)/p*100,N=M/100*p+e;w&&(w.innerHTML=`
      ...
      `)}function de(){he(),ye(),ke(),Oe()}function $e(e,s){n.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=s,n.querySelector("#tl-bath-temp-slider").value=s,de()})}function lt(){n.querySelectorAll(".tl-tab-btn").forEach(f=>{f.addEventListener("click",()=>{n.querySelectorAll(".tl-tab-btn").forEach(b=>b.classList.remove("active")),n.querySelectorAll(".tl-tab-content").forEach(b=>b.classList.remove("active")),f.classList.add("active");const k=f.getAttribute("data-tl-tab");n.querySelector("#tl-tab-"+k).classList.add("active"),a.thermometerType=k,de()})}),n.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{a.showLabels=!a.showLabels,n.querySelector("#tl-lbl-toggle-labels").textContent=a.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),n.querySelector("#tl-bath-temp-slider").addEventListener("input",f=>{a.bathTemp=parseFloat(f.target.value),de()}),$e("tl-btn-preset-ice",0),$e("tl-btn-preset-room",25),$e("tl-btn-preset-steam",100),$e("tl-btn-preset-oil",150),n.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",n.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",n.querySelector("#tl-card-alcohol").className="tl-seg-btn",de()}),n.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",n.querySelector("#tl-card-mercury").className="tl-seg-btn",n.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",de()}),n.querySelector("#tl-slider-bulb-vol").addEventListener("input",f=>{a.bulbVolume=parseFloat(f.target.value),n.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),n.querySelector("#tl-slider-wall-thick").addEventListener("input",f=>{a.wallThickness=parseFloat(f.target.value),n.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),n.querySelector("#tl-slider-capillary-bore").addEventListener("input",f=>{a.capillaryBore=parseFloat(f.target.value),n.querySelector("#tl-val-capillary-bore").textContent=a.capillaryBore.toFixed(2)+" mm"}),n.querySelector("#tl-slider-liquid-l0").addEventListener("input",f=>{a.liquidL0=parseFloat(f.target.value),n.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-liquid-l100").addEventListener("input",f=>{a.liquidL100=parseFloat(f.target.value),n.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-resistance-r0").addEventListener("input",f=>{a.resistanceR0=parseFloat(f.target.value),n.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-resistance-r100").addEventListener("input",f=>{a.resistanceR100=parseFloat(f.target.value),n.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-thermistor-r25").addEventListener("input",f=>{a.thermistorR25=parseFloat(f.target.value),n.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",n.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",de()}),n.querySelector("#tl-slider-thermistor-beta").addEventListener("input",f=>{a.thermistorBeta=parseFloat(f.target.value),n.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",n.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",de()}),n.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.add("active"),n.querySelector("#tl-btn-solve-q10b").classList.remove("active"),n.querySelector("#tl-pane-q10a").classList.add("active"),n.querySelector("#tl-pane-q10b").classList.remove("active"),he()}),n.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.remove("active"),n.querySelector("#tl-btn-solve-q10b").classList.add("active"),n.querySelector("#tl-pane-q10a").classList.remove("active"),n.querySelector("#tl-pane-q10b").classList.add("active"),he()}),n.querySelector("#tl-input-faulty-cf").addEventListener("input",he),n.querySelector("#tl-input-faulty-cu").addEventListener("input",he),n.querySelector("#tl-input-q10a-cm").addEventListener("input",he),n.querySelector("#tl-input-q10b-t").addEventListener("input",he),n.querySelector("#tl-input-q11-r").addEventListener("input",ye);const p=n.querySelector("#tl-input-t-to-l");p&&p.addEventListener("input",de);const m=n.querySelector("#tl-input-t-to-r");m&&m.addEventListener("input",de)}if(r.type){const e=n.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return n.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===o?e.classList.add("active"):e.classList.remove("active")}),n.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===o?e.classList.add("active"):e.classList.remove("active")}),h(),lt(),de(),Se=requestAnimationFrame(Re),n._thermometerLabCleanup=()=>{Se&&cancelAnimationFrame(Se)},n}function $t(t){const r=document.createElement("div");r.className="tool-specific-heat";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:i+"/";function n(){return d+"specific-heat/index.html?lang="+encodeURIComponent(fe())}o.src=n(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var S;try{(S=o.contentWindow)==null||S.postMessage({type:"s3phy:lang",lang:fe()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function At(t){const r=document.createElement("div");r.className="tool-thermal-mixing";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:i+"/";function n(){return d+"thermal-mixing/index.html?lang="+encodeURIComponent(fe())}o.src=n(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var S;try{(S=o.contentWindow)==null||S.postMessage({type:"s3phy:lang",lang:fe()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function Et(t){const r=document.createElement("div");r.className="tool-change-of-state";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:i+"/";function n(){return d+"change-of-state/index.html?lang="+encodeURIComponent(fe())}o.src=n(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var S;try{(S=o.contentWindow)==null||S.postMessage({type:"s3phy:lang",lang:fe()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}const Me=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],De=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],Ft=[["thermometer","topic.thermometer"]],Qe=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState"],It={liquid:t=>Pe(t,{type:"liquid"}),resistance:t=>Pe(t,{type:"resistance"}),thermistor:t=>Pe(t,{type:"thermistor"}),specificHeat:t=>$t(t),thermalMixing:t=>At(t),changeOfState:t=>Et(t)};function Wt(t){return l({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title"}[t]||t)}function Ee(){return fe()==="zh-Hant"?"zhHant":"en"}async function Pt(t,r){const o=`./${t}/${r}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function Ne(t){return Pt("notes",t)}function Dt(t){let r="topics",o="liquid",i=0,d="all",n=!1,a=null,S={main:null},F=null;function te(){if(S.main){if(r==="topics"?S.main.innerHTML=$():r==="notes"?S.main.innerHTML=Z():r==="tools"?S.main.innerHTML=z():r==="worksheets"?S.main.innerHTML=at(l,{topics:Ft,paperTitleKey:"worksheets.paperTitleHeat"}):r==="flashcards"?S.main.innerHTML=ae():r==="summary"&&(S.main.innerHTML=J()),r==="notes"&&_(),r==="tools"&&I(),r==="worksheets"){const v=Je.filter(h=>De.includes(h.topic));nt(t,v,l,Ee,{topicFilter:(h,u)=>u.includes("thermometer")?De.includes(h.topic):u.includes(h.topic)})}r==="flashcards"&&Y(),r==="summary"&&ee()}}function P(){a==null||a.destroy(),a=tt(t,{subtitleKey:"strand.heat.subtitle",activeSection:r,onSection:v=>{r==="tools"&&v!=="tools"&&F!=null&&F._thermometerLabCleanup&&(F._thermometerLabCleanup(),F=null),r=v,a.updateSection(r),te()},onLang:()=>P()}),S.main=a.main,a.updateSection(r),te()}function $(){return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
      ...
      </section>`}async function _(){const v=Ee();for(const h of Me){const u=t.querySelector(`[data-note-card="${h.id}"]`);if(!u)continue;const c=u.querySelector("[data-note-body]"),g=v==="zhHant"?h.fileZh:h.fileEn,A=await Ne(g),L=`./notes/${g}`;A?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${h.id}`)}" src="${L}"></iframe>
          <p style="margin-top:8px"><a href="${L}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:c.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function z(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Qe.map(v=>`<button type="button" data-tool="${v}" class="${o===v?"active":""}">${Wt(v)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function I(){const v=t.querySelector("[data-tool-list]"),h=t.querySelector("[data-tool-stage]");!v||!h||(v.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{o=u.getAttribute("data-tool"),v.querySelectorAll("button").forEach(c=>c.classList.toggle("active",c.getAttribute("data-tool")===o)),j(h)})}),j(h))}function j(v){v.innerHTML="",F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup();const h=It[o];h&&(F=h(l),v.appendChild(F))}function ae(){return`
      <section class="panel">
        <h2>${l("flashcards.title")}</h2>
        <p class="lead">${l("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}async function ee(){const v=Ee();for(const h of Me){const u=t.querySelector(`[data-summary-card="${h.id}"]`);if(!u)continue;const c=u.querySelector("[data-summary-body]"),g=v==="zhHant"?h.fileZh:h.fileEn,A=await Ne(g),L=`./notes/${g}`;A?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${h.id}`)}" src="${L}"></iframe>
          <p style="margin-top:8px"><a href="${L}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const K=()=>P(),ne=v=>O(v);return window.addEventListener("s3phy:lang",K),t.addEventListener("click",ne),P(),()=>{window.removeEventListener("s3phy:lang",K),t.removeEventListener("click",ne),F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup(),a==null||a.destroy()}}const Ve={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};ut();const Ye="s3phy_splash_seen",rt={optics:Rt,heat:Dt};let _e=null,Le=null;function Ot(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(rt,r)?r:null}function Gt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function ot(t){_e==null||_e(),_e=null,Le==null||Le(),Le=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&Gt(),Le=pt(r);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}_e=rt[t](r)??null}function st(){ot(Ot())}function Bt(){return"./images/uniplus-logo.png"}function jt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Bt()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Qt(t,r){const o=[...Ve.en,...Ve.zhHant],i=()=>{if(!t.parentElement)return;const d=document.createElement("div");d.className="splash-danmaku-item",d.textContent=o[Math.floor(Math.random()*o.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,S=Math.random()*12+10;d.style.top=`${n}%`,d.style.fontSize=`${a}rem`,d.style.animationDuration=`${S}s`,r.appendChild(d),d.addEventListener("animationend",()=>d.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let d=0;d<4;d+=1)window.setTimeout(i,d*1e3)}function Nt(t){const r=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),o&&Qt(t,o)},1600)}function Ue(){st()}function Vt(){let t=!1;try{t=sessionStorage.getItem(Ye)==="1"}catch{}if(t){Ue();return}const r=jt();document.body.insertBefore(r,document.body.firstChild),Nt(r);const o=r.querySelector("#splashStart"),i=()=>{r.remove(),Ue()};o.addEventListener("click",()=>{try{sessionStorage.setItem(Ye,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",st);window.addEventListener("s3phy:strand",t=>{ot(t.detail??null)});Vt();
