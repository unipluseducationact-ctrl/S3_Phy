(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const u of document.querySelectorAll('link[rel="modulepreload"]'))r(u);new MutationObserver(u=>{for(const n of u)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function l(u){const n={};return u.integrity&&(n.integrity=u.integrity),u.referrerPolicy&&(n.referrerPolicy=u.referrerPolicy),u.crossOrigin==="use-credentials"?n.credentials="include":u.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(u){if(u.ep)return;u.ep=!0;const n=l(u);fetch(u.href,n)}})();const Le={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Flip cards to revise key terms. Reflection uses picture cards from your flashcard set.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.shuffle":"Shuffle","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF). Preview below or open in a new tab to download.","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","tools.thermometerLab.liquid.title":"Liquid-in-Glass Thermometer","tools.thermometerLab.liquid.subtitle":"Explore the effects of bulb volume, capillary bore, and liquid type on sensitivity and response time.","tools.thermometerLab.resistance.title":"Platinum Resistance Thermometer","tools.thermometerLab.resistance.subtitle":"Investigate how platinum resistance varies linearly with temperature and solve calibration problems.","tools.thermometerLab.thermistor.title":"NTC Thermistor","tools.thermometerLab.thermistor.subtitle":"Study the non-linear resistance-temperature relationship of NTC thermistors and live beta calculations.","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},nt={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"翻卡複習重要詞彙。反射課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.shuffle":"洗牌","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF）。可於下方預覽，或新分頁開啟下載。","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","tools.thermometerLab.title":"溫度計與校準實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","tools.thermometerLab.liquid.title":"液體玻璃溫度計","tools.thermometerLab.liquid.subtitle":"探索玻璃泡容積、毛細管內外徑和液體種類對靉敏度及反應時間的影響。","tools.thermometerLab.resistance.title":"鈐電阻溫度計","tools.thermometerLab.resistance.subtitle":"研究鈐電阻如何隨溫度呈線性變化，並解決溫度校準問題。","tools.thermometerLab.thermistor.title":"NTC 熱敏電阻溫度計","tools.thermometerLab.thermistor.subtitle":"學習負溫度係數（NTC）熱敏電阻的非線性電阻-溫度關係，並進行實時 Beta 計算。","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},Be="s3phy.lang",Ve={en:Le,"zh-Hant":nt};let Ae="en";function rt(){try{const t=localStorage.getItem(Be);if(t==="zh-Hant"||t==="en")return t}catch{}return"en"}function it(){Ae=rt()}function Ge(t){if(Ve[t]){Ae=t;try{localStorage.setItem(Be,t)}catch{}document.documentElement.lang=t==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function xe(){return Ae}function s(t){const i=Ve[Ae]||Le;return Object.prototype.hasOwnProperty.call(i,t)?i[t]:Object.prototype.hasOwnProperty.call(Le,t)?Le[t]:t}const ot=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function st(t){function i(){t.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${ot.map(({id:u,titleKey:n,descKey:a})=>`
            <div class="card">
              <h3>${s(n)}</h3>
              <p>${s(a)}</p>
...
`;function dt(){if(document.getElementById(Ie))return;const t=document.createElement("style");t.id=Ie,t.textContent=ct,document.head.appendChild(t)}function ut(t){dt();const i=document.createElement("div");i.className="rml",i.innerHTML=`
  ...
  `;const l=i.querySelector(".rml-canvas"),r=l.getContext("2d"),u=i.querySelector("[data-rml-rot]"),n=i.querySelector("[data-rml-inc]"),a=i.querySelector('[data-rml-disp="rot"]'),T=i.querySelector('[data-rml-disp="inc"]'),$=i.querySelector('[data-rml-val="i"]'),J=i.querySelector('[data-rml-val="r"]'),I=i.querySelector('[data-rml-val="shift"]'),H=350,W=380,te=300,x="#22d3ee",_="bold 17px system-ui, sans-serif";let z=0,O=-140,ae=!0,ee=!0,V=!0,Y=!0;function B(p){return p*Math.PI/180}function U(p,d,c,h,L,y=2,M=!1){r.beginPath(),r.lineWidth=y,r.strokeStyle=L,r.setLineDash(M?[6,6]:[]);const v=p+Math.cos(B(c))*h,g=d+Math.sin(B(c))*h;return r.moveTo(p,d),r.lineTo(v,g),r.stroke(),r.setLineDash([]),{x:v,y:g}}function K(p,d,c,h,L,y=14){const M=c-p,v=h-d,g=Math.hypot(M,v);if(g<1e-6)return;const P=M/g,C=v/g,Q=c-P*y,E=h-C*y,ce=.45*y;r.beginPath(),r.fillStyle=L,r.moveTo(c,h),r.lineTo(Q-C*ce,E+P*ce),r.lineTo(Q+C*ce,E-P*ce),r.closePath(),r.fill()}function G(p,d,c,h,L,y=25){r.beginPath(),r.strokeStyle=h,r.lineWidth=2;const M=Math.min(p,d),v=Math.max(p,d);if(r.arc(H,W,c,B(M),B(v),!1),r.stroke(),L){const g=(M+v)/2,P=H+Math.cos(B(g))*(c+y),C=W+Math.sin(B(g))*(c+y);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillStyle=h,r.fillText(L,P,C),r.restore()}}function ne(p,d,c,h,L){r.clearRect(0,0,l.width,l.height),r.beginPath(),r.setLineDash([10,6]),r.strokeStyle="rgba(255, 204, 0, 0.45)",r.lineWidth=3,r.lineCap="round",r.moveTo(H-200,W),r.lineTo(H+200,W),r.stroke(),r.setLineDash([]),r.lineCap="butt";const y=H+Math.cos(B(p))*te,M=W+Math.sin(B(p))*te;r.beginPath(),r.lineWidth=3,r.strokeStyle="#fff",r.moveTo(y,M),r.lineTo(H,W),r.stroke();const v=(y+H)*.5,g=(M+W)*.5,P=Math.hypot(H-y,W-M)||1,C=(H-y)/P,Q=(W-M)/P;if(K(v-C*28,g-Q*28,v,g,"#fff",16),r.save(),r.font=_,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#fff",r.fillText(t("tools.rotatingMirror.canvas.incident"),y,M-12),r.restore(),ae){const E=U(H,W,-90,te-60,"#00e676",1,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(t("tools.rotatingMirror.canvas.n"),E.x+6,E.y-4),r.restore()}if(ee){const E=U(H,W,h,te,"#00e676",2,!1);K(H,W,E.x,E.y,"#00e676",16),r.save(),r.font=_,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(t("tools.rotatingMirror.canvas.originalReflected"),E.x,E.y-14),r.restore()}r.save(),r.translate(H,W),r.rotate(B(z)),r.beginPath(),r.lineWidth=6,r.strokeStyle="#ffcc00",r.lineCap="round",r.moveTo(-200,0),r.lineTo(200,0),r.stroke(),r.beginPath(),r.lineWidth=1,r.strokeStyle="#666";for(let E=-190;E<200;E+=15)r.moveTo(E,0),r.lineTo(E-5,8);if(r.stroke(),r.restore(),V){const E=U(H,W,d,te-40,x,2,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle=x,r.fillText(t("tools.rotatingMirror.canvas.nPrime"),E.x+6,E.y-4),r.restore()}if(Y){const E=U(H,W,c,te,x,4);K(H,W,E.x,E.y,x,16),Math.abs(z)>.5&&(r.save(),r.font=_,r.textAlign="center",r.textBaseline="bottom",r.fillStyle=x,r.fillText(t("tools.rotatingMirror.canvas.newReflected"),E.x,E.y-14),r.restore())}if(V&&G(p,d,100,"#ffcc00",`i=${L.toFixed(0)}°`,25),V&&Y&&G(d,c,100,x,`r=${L.toFixed(0)}°`,25),ae&&V&&Math.abs(z)>.5&&G(-90,d,50,"#ffcc00",`θ=${Math.abs(z)}°`,20),ee&&Y&&Math.abs(z)>.5){const E=c-h;G(h,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${E.toFixed(0)}°`,40)}}function m(){z=parseFloat(u.value),O=parseFloat(n.value);const p=z>0?"+":"";a.textContent=`${p}${z}°`,T.textContent=`${O}°`;const d=-90,c=Math.abs(O-d),h=d+c,L=-90+z,y=Math.abs(O-L),M=L+y,v=M-h;$.textContent=`${y.toFixed(1)}°`,J.textContent=`${y.toFixed(1)}°`;const g=v>0?"+":"";I.textContent=`${g}${v.toFixed(1)}°`,ne(O,L,M,h,y)}return i.querySelectorAll("[data-rml-toggle]").forEach(p=>{p.addEventListener("click",()=>{const d=p.getAttribute("data-rml-toggle");d==="orig-norm"&&(ae=!ae),d==="orig-ray"&&(ee=!ee),d==="new-norm"&&(V=!V),d==="new-ray"&&(Y=!Y),p.classList.toggle("active"),m()})}),i.querySelector("[data-rml-reset]").addEventListener("click",()=>{u.value="0",m()}),u.addEventListener("input",m),n.addEventListener("input",m),m(),i}function pt(t){const i=document.createElement("div");i.className="tool-tir-escape";const l=document.createElement("iframe"),r="./",u=r.endsWith("/")?r:`${r}/`;return l.src=`${u}tir-escape/index.html?embed=1`,l.title=t("tools.refractionTir.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin",i.appendChild(l),i}function ht(t,i={}){const l=i.defaultKind==="concave"?"concave":"convex",r="tools.lens.title",u=document.createElement("div");u.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",T=a.endsWith("/")?a:`${a}/`;return n.src=`${T}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(l)}`,n.title=t(r),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",u.appendChild(n),u}function mt(t){const i=document.createElement("div");i.className="tool-em-spectrum";const l=document.createElement("iframe"),r="./",u=r.endsWith("/")?r:`${r}/`;function n(){return`${u}em-spectrum/index.html?lang=${encodeURIComponent(xe())}`}l.src=n(),l.title=t("tools.em.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var T;try{(T=l.contentWindow)==null||T.postMessage({type:"s3phy:lang",lang:xe()},"*")}catch{l.src=n()}};return window.addEventListener("s3phy:lang",a),i._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(l),i}function ft(t){const i=document.createElement("div");i.className="rgb-mixer",i.innerHTML=`
  ...
  `;const l=i.querySelector("[data-r]"),r=i.querySelector("[data-g]"),u=i.querySelector("[data-b]"),n=i.querySelector(".rgb-mixer-canvas"),a=i.querySelector(".rgb-mixer-stage"),T=n.getContext("2d");function $(x){return x.toString(16).padStart(2,"0")}function J(x,_,z){const O=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),ee=O/2,V=ae/2,Y=Math.min(O,ae)*.34,B=Y*.5,U=Math.sqrt(3)/2;T.clearRect(0,0,O,ae),T.fillStyle="#000",T.fillRect(0,0,O,ae);const K=[{x:ee,y:V-B,rgb:[255,0,0],val:x},{x:ee-B*U,y:V+B*.5,rgb:[0,255,0],val:_},{x:ee+B*U,y:V+B*.5,rgb:[0,0,255],val:z}];T.globalCompositeOperation="lighter",K.forEach(G=>{if(G.val<=0)return;const ne=G.val/255,[m,p,d]=G.rgb,c=T.createRadialGradient(G.x,G.y,0,G.x,G.y,Y);c.addColorStop(0,`rgba(${m},${p},${d},${ne})`),c.addColorStop(.65,`rgba(${m},${p},${d},${ne})`),c.addColorStop(.85,`rgba(${m},${p},${d},${ne*.5})`),c.addColorStop(1,`rgba(${m},${p},${d},0)`),T.fillStyle=c,T.beginPath(),T.arc(G.x,G.y,Y,0,Math.PI*2),T.fill()}),T.globalCompositeOperation="source-over"}function I(){const x=a.getBoundingClientRect(),_=Math.max(200,Math.min(x.width-8,x.height-8,720)),z=window.devicePixelRatio||1;n.width=_*z,n.height=_*z,n.style.width=`${_}px`,n.style.height=`${_}px`,T.setTransform(z,0,0,z,0,0),J(+l.value,+r.value,+u.value)}function H(){const x=+l.value,_=+r.value,z=+u.value,O=`rgb(${x}, ${_}, ${z})`,ae=`#${$(x)}${$(_)}${$(z)}`;i.querySelector("[data-r-val]").textContent=x,i.querySelector("[data-g-val]").textContent=_,i.querySelector("[data-b-val]").textContent=z,i.querySelector("[data-r-bar]").style.width=`${x/255*100}%`,i.querySelector("[data-g-bar]").style.width=`${_/255*100}%`,i.querySelector("[data-b-bar]").style.width=`${z/255*100}%`,l.style.setProperty("--fill",`${x/255*100}%`),r.style.setProperty("--fill",`${_/255*100}%`),u.style.setProperty("--fill",`${z/255*100}%`);const ee=i.querySelector("[data-swatch]");ee.style.backgroundColor=O,ee.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${O}`),i.querySelector("[data-rgb-text]").textContent=O,i.querySelector("[data-hex-text]").textContent=ae,J(x,_,z)}function W(x,_,z){l.value=x,r.value=_,u.value=z,H()}return[l,r,u].forEach(x=>x.addEventListener("input",H)),i.querySelectorAll(".rgb-presets button").forEach(x=>{x.addEventListener("click",()=>{W(+x.dataset.r,+x.dataset.g,+x.dataset.b)})}),new ResizeObserver(()=>I()).observe(a),requestAnimationFrame(()=>{I(),H()}),i}const gt=["topics","notes","tools","worksheets","flashcards","summary"],bt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function Ke(t,{subtitleKey:i,activeSection:l,onSection:r,onLang:u}){t.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),T=t.querySelector("[data-lang]"),$=t.querySelector("[data-strand-back]");let J=l;function I(x){J=x,a.innerHTML=gt.map(_=>`<button type="button" class="${x===_?"active":""}" data-sec="${_}">${s(bt[_])}</button>`).join(""),a.querySelectorAll("button").forEach(_=>{_.addEventListener("click",()=>r(_.getAttribute("data-sec")))})}function H(){T.innerHTML=`
    ...
    <section class="panel panel--worksheets">
      ...
      <div class="ws-controls no-print">
        ...
        <div class="grid cols-2" data-ws-topics>
          ${l.map(([u,n])=>`<label class="card ws-topic-card">
    ...
    </section>`}function Ze(t,i,l,r,u={}){var h,L,y,M;const n={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),T=t.querySelector("[data-ws-preview-area]"),$=t.querySelector("[data-ws-out]"),J=t.querySelector("[data-ws-body]"),I=t.querySelector("[data-ws-paper]"),H=t.querySelector("[data-ws-tabs]"),W=t.querySelector("[data-ws-practice-actions]"),te=t.querySelector("[data-ws-score]"),x=t.querySelector("[data-ws-score-val]"),_=t.querySelector("[data-ws-summary]"),z=t.querySelector("[data-ws-date-row]"),O=t.querySelector("[data-ws-date-print]"),ae=t.querySelector("[data-ws-date-today]"),ee=t.querySelector("[data-ws-date-label]");if(!a||!J)return;function V(){return r()}function Y(){n.userAnswers={},n.wrongAttempts={},n.resolved={},te.hidden=!0,_.hidden=!0}function B(){return n.items.length>0&&n.items.every((v,g)=>n.resolved[g])}function U(){let v=0;n.items.forEach((P,C)=>{if(!n.resolved[C])return;const Q=P[V()]||P.en;n.userAnswers[C]===Q.a&&(v+=1)}),Object.keys(n.resolved).length>0&&(x.textContent=`${v}/${n.items.length}`,te.hidden=!1)}function K(v){n.tab=v,H==null||H.querySelectorAll("[data-ws-tab]").forEach(g=>{g.classList.toggle("active",g.getAttribute("data-ws-tab")===v)}),W&&(W.hidden=v!=="practice"),z&&(z.hidden=v!=="practice"),O&&(O.hidden=!n.dateStr,O.textContent=n.dateStr?`${l("worksheets.date")}: ${n.dateStr}`:""),I==null||I.classList.toggle("practice-mode",v==="practice"),ne()}function G(v,g,P){const C=v[V()]||v.en,Q=$e,E=g+1,ce=v.section?`<span class="q-section">${ye(v.section)}</span>`:"";if(P==="answer"){const ke=C.choices.map((e,o)=>`<li class="${o===C.a?"choice-correct":""}"><strong>${Q[o]}.</strong> ${ye(e)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${E} ${ce}</h4>
        <p>${ye(C.q)}</p>
        <ol class="choice-list">${ke}</ol>
        <p class="q-exp"><strong>${l("worksheets.answer")}:</strong> ${Q[C.a]}</p>
        <p class="q-exp"><em>${ye(C.exp)}</em></p>
      </div>`}const oe=n.userAnswers[g],se=n.wrongAttempts[g]||0,pe=n.resolved[g],qe=pe&&oe===C.a,he=pe&&oe!==C.a;let be="";se===1&&!pe?be=`<p class="q-hint"><strong>${l("worksheets.hint")}:</strong> ${ye(C.hint||C.exp)}</p>`:he&&(be=`<p class="q-exp"><strong>${l("worksheets.answer")}:</strong> ${Q[C.a]}</p>
        <p class="q-exp q-summary"><em>${ye(C.exp)}</em></p>`);const Me=qe?"correct":he?"incorrect":"",de=C.choices.map((ke,e)=>`<li>
          <label class="choice-radio">
            ...
            <strong>${Q[e]}.</strong> ${ye(ke)}
          </label>
        </li>`).join("");return`<div class="question-row ${Me}" data-ws-row="${g}">
      <div class="q-header"><h4>Q${E} ${ce}</h4>${qe?'<span class="result-icon">✓</span>':he?'<span class="result-icon">✗</span>':""}</div>
      <p>${ye(C.q)}</p>
      <ol class="choice-list choice-list--radio">${de}</ol>
      ${be}
    </div>`}function ne(){n.items.length&&(J.innerHTML=n.items.map((v,g)=>G(v,g,n.tab)).join(""),m())}function m(){n.tab==="practice"&&J.querySelectorAll("[data-ws-choice]").forEach(v=>{v.addEventListener("change",()=>{const g=Number(v.getAttribute("data-ws-q"));if(n.resolved[g])return;const P=Number(v.getAttribute("data-ws-choice")),C=n.items[g][V()]||n.items[g].en;n.userAnswers[g]=P,P===C.a?n.resolved[g]=!0:(n.wrongAttempts[g]=(n.wrongAttempts[g]||0)+1,n.wrongAttempts[g]>=2&&(n.resolved[g]=!0)),U(),B()&&p(),ne()})})}function p(){const v=n.items.length;let g=0,P=0;const C={};n.items.forEach((oe,se)=>{const pe=oe[V()]||oe.en;if(n.userAnswers[se]===pe.a)g+=1,(n.wrongAttempts[se]||0)===0&&(P+=1);else if(n.resolved[se]){const he=oe.section||oe.topic;C[he]=(C[he]||0)+1}});const Q=v?Math.round(g/v*100):0;let E=l("worksheets.revisionFair");Q>=90?E=l("worksheets.revisionExcellent"):Q>=70?E=l("worksheets.revisionGood"):Q<50&&(E=l("worksheets.revisionLow"));const ce=Object.entries(C).sort((oe,se)=>se[1]-oe[1]).map(([oe,se])=>`<li>${ye(oe)} (${se})</li>`).join("");_.innerHTML=`
      <h4>${l("worksheets.sessionSummary")}</h4>
      <p>${l("worksheets.score")}: <strong>${g}/${v}</strong> (${Q}%)</p>
      <p>${l("worksheets.firstTry")}: <strong>${P}/${v}</strong></p>
      <p>${l("worksheets.revisionSuggestions")}: ${E}</p>
      ${ce?`<p>${l("worksheets.weakSections")}:</p><ul>${ce}</ul>`:""}`,_.hidden=!1}function d(v){const g=V(),P=n.items.map((C,Q)=>{const E=C[g]||C.en,ce=E.choices.map((se,pe)=>`${$e[pe]}. ${se}`).join("<br/>"),oe=v?`<p><b>${l("worksheets.answer")}:</b> ${$e[E.a]}<br/><i>${E.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${E.q}<br/>${ce}${oe}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${l("worksheets.paperTitle")}</title></head>
<body><h2>${l("worksheets.paperTitle")}</h2>
${n.dateStr&&!v?`<p>${l("worksheets.date")}: ${n.dateStr}</p>`:""}
${P}</body></html>`}function c(v){const g=d(v),P=new Blob(["\uFEFF",g],{type:"application/msword"}),C=document.createElement("a");C.href=URL.createObjectURL(P),C.download=v?"worksheet-answers.doc":"worksheet.doc",C.click(),URL.revokeObjectURL(C.href)}a.addEventListener("click",()=>{const v=Number(t.querySelector("[data-ws-count]").value),g=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),P=vt(i,g,u.topicFilter),C=We(P).slice(0,Math.min(v,P.length||1));n.items=C.length?C:We(i).slice(0,Math.min(v,i.length)),Y(),n.tab="practice",n.dateStr="",T.hidden=!1,$.hidden=!0,H==null||H.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),W&&(W.hidden=!1),z&&(z.hidden=!1),O&&(O.hidden=!0),ee.textContent="",I==null||I.classList.add("practice-mode"),ne()}),H==null||H.addEventListener("click",v=>{const g=v.target.closest("[data-ws-tab]");!g||!n.items.length||K(g.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",ee.textContent=""):(n.dateStr=yt(),ee.textContent=`${l("worksheets.date")}: ${n.dateStr}`),O&&(O.hidden=!n.dateStr,O.textContent=n.dateStr?`${l("worksheets.date")}: ${n.dateStr}`:"")}),(h=t.querySelector("[data-ws-word-p]"))==null||h.addEventListener("click",()=>c(!1)),(L=t.querySelector("[data-ws-word-a]"))==null||L.addEventListener("click",()=>c(!0)),(y=t.querySelector("[data-ws-print-p]"))==null||y.addEventListener("click",()=>{K("practice"),I==null||I.classList.add("ws-print-blank");const v=()=>I==null?void 0:I.classList.remove("ws-print-blank");window.addEventListener("afterprint",v,{once:!0}),window.print()}),(M=t.querySelector("[data-ws-print-a]"))==null||M.addEventListener("click",()=>{K("answer"),window.print()})}const wt=["rotatingMirror","refractionTir","lens","rgbMixer","em"],xt={rotatingMirror:t=>ut(t),refractionTir:t=>pt(t),lens:(t,i)=>ht(t,{defaultKind:i}),rgbMixer:t=>ft(t),em:t=>mt(t)};function qt(t){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Re(){return xe()==="zh-Hant"?"zhHant":"en"}async function Je(t,i){const l=`./${t}/${i}`;try{return(await fetch(l,{method:"HEAD"})).ok}catch{return!1}}async function St(t){return Je("notes",t)}function kt(t){let i="topics",l="rotatingMirror",r="convex",u=0,n="all",a=!1,T=null,$={main:null};function J(){$.main&&(i==="topics"?$.main.innerHTML=H():i==="notes"?$.main.innerHTML=te():i==="tools"?$.main.innerHTML=_():i==="worksheets"?$.main.innerHTML=Xe(s):i==="flashcards"?$.main.innerHTML=ae():i==="summary"&&($.main.innerHTML=G()),i==="notes"&&x(),i==="tools"&&z(),i==="worksheets"&&Ze(t,Ye,s,Re),i==="flashcards"&&K(),i==="summary"&&ne())}function I(){T==null||T.destroy(),T=Ke(t,{subtitleKey:"strand.optics.subtitle",activeSection:i,onSection:d=>{i=d,T.updateSection(i),J()},onLang:()=>I()}),$.main=T.main,T.updateSection(i),J()}function H(){const d=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${d.map(([c,h])=>{const L=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,y=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${s(h)}</h3>
              <button class="btn primary" type="button" data-go-tool="${L}"${y?` data-lens-kind="${y}"`:""}>${s("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function W(d){const c=d.target.closest("[data-go-tool]");if(!c)return;i="tools",l=c.getAttribute("data-go-tool");const h=c.getAttribute("data-lens-kind");(h==="convex"||h==="concave")&&(r=h),T.updateSection(i),J()}function te(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
      ...
      </section>`}async function x(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Re();for(const h of d){const L=t.querySelector(`[data-note-card="${h.key}"]`);if(!L)continue;const y=L.querySelector("[data-note-body]"),M=c==="zhHant"?h.fileZh:h.fileEn,v=await St(M),g=`./notes/${M}`;v?y.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${h.key}`)}" src="${g}"></iframe>
          <p style="margin-top:8px"><a href="${g}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:y.innerHTML=`<p class="lead">${s("notes.missing")}</p>
          <p><a class="btn" href="./notes/README.txt" target="_blank" rel="noopener">README</a></p>`}}function _(){return`
      ...
      </section>`}function ee(d){return!!(d!=null&&d.front)}function V(d){return`./${String(d).replace(/^\.\//,"")}`}function Y(){return Ue.slice()}function B(){const d=lt.slice(),c=Y(),h=n==="rotatingMirror"?"reflection":n;if(h==="all")return[...d,...c];if(h==="reflection")return d;if(h==="convex"||h==="concave"){const y=c.filter(M=>M.topic==="convex"||M.topic==="concave");return y.length?y:c}if(h==="refractionTir"){const y=c.filter(M=>M.topic==="refraction"||M.topic==="tir");return y.length?y:c}const L=c.filter(y=>y.topic===h);return L.length?L:c}function U(){const d=B(),c=t.querySelector("[data-flash-progress]");if(!d.length){u=0;const P=t.querySelector("[data-flash-front]"),C=t.querySelector("[data-flip-card]");P&&(P.textContent=""),C&&C.classList.remove("flashcard-surface--image"),c&&(c.hidden=!0,c.textContent="");return}u=Math.max(0,Math.min(u,d.length-1));const h=d[u],L=t.querySelector("[data-flash-front]"),y=t.querySelector("[data-flip-card]"),M=t.querySelector("[data-flash-label]");if(!L||!y)return;if(c&&(c.hidden=!1,c.textContent=s("flashcards.progress").replace("{current}",String(u+1)).replace("{total}",String(d.length))),ee(h)){const P=h.back&&h.back!==h.front;y.classList.add("flashcard-surface--image"),M&&(P?(M.hidden=!1,M.textContent=s(a?"flashcards.answer":"flashcards.question")):M.hidden=!0);const C=a&&h.back?h.back:h.front,Q=h.alt||h.title||"";L.innerHTML=`<img src="${V(C)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}y.classList.remove("flashcard-surface--image");const v=Re(),g=h[v]||h.en;M&&(M.hidden=!1,M.textContent=s(a?"flashcards.answer":"flashcards.question")),L.textContent=a?g.a:g.q}function K(){n==="rotatingMirror"&&(n="reflection");const d=t.querySelector("[data-flash-deck]");d.value=n,d.addEventListener("change",()=>{n=d.value,u=0,a=!1,U()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,U()}),t.querySelector("[data-flash-flip]").addEventListener("click",c=>{c.stopPropagation(),a=!a,U()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const c=B();u=(u-1+c.length)%c.length,a=!1,U()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const c=B();u=(u+1)%c.length,a=!1,U()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const c=B();u=Math.floor(Math.random()*c.length),a=!1,U()}),U()}function G(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
      ...
      </section>`}async function ne(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],c=Re();for(const h of d){const L=t.querySelector(`[data-summary-card="${h.key}"]`);if(!L)continue;const y=L.querySelector("[data-summary-body]"),M=c==="zhHant"?h.fileZh:h.fileEn,v=await Je("summary-pdfs",M),g=`./summary-pdfs/${M}`;v?y.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${h.key}`)}" src="${g}"></iframe>
          <p style="margin-top:8px"><a href="${g}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:y.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const m=()=>I(),p=d=>W(d);return window.addEventListener("s3phy:lang",m),t.addEventListener("click",p),I(),()=>{window.removeEventListener("s3phy:lang",m),t.removeEventListener("click",p),T==null||T.destroy()}}const Pe="s3phy-thermometer-lab-css",Tt=`
.tl-wrap {
  --tl-bg: #0d0d10;
  --tl-panel: #18181b;
  --tl-border: #27272a;
...
`;function Ct(){if(document.getElementById(Pe))return;const t=document.createElement("style");t.id=Pe,t.textContent=Tt,document.head.appendChild(t)}function ze(t,i={}){Ct();const l=i.type||"liquid";let r=t("tools.thermometerLab.title"),u=t("tools.thermometerLab.subtitle");i.type==="liquid"?(r=t("tools.thermometerLab.liquid.title"),u=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="resistance"?(r=t("tools.thermometerLab.resistance.title"),u=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="thermistor"&&(r=t("tools.thermometerLab.thermistor.title"),u=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
    <div class="tl-head">
  ...
  `;const a={liquidType:"mercury",thermometerType:l,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0},T=460,$=340,J=80,I=680,H=480;function W(){const e={left:80,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:I-e.left-e.right,gh:H-e.top-e.bottom,tickFont:`bold ${Math.round(I*.024)}px Arial`,axisFont:`bold ${Math.round(I*.026)}px Arial`,dotR:7,yLabelX:e.left-48,xLabelY:H-e.bottom+32}}function te(){let o=100;const f=Math.max(a.bathTemp,a.thermometerTemp,100);f>120&&(o=150),f>145&&(o=200);const b=o<=100?20:25;return{minT:0,maxT:o,tickStep:b}}function x(e,o,f,b,q){return b+(e-o)/(f-o)*q}function _(e,o,f,b,q){return b+q-(e-o)/(f-o)*q}function z(e,o,f,b,q,F){const{gx:w,gy:S,gw:A,gh:R,tickFont:D,axisFont:j,yLabelX:X,xLabelY:k}=o;e.strokeStyle="#4b5563",e.lineWidth=2,e.beginPath(),e.moveTo(w,S),e.lineTo(w,S+R),e.lineTo(w+A,S+R),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.8,e.fillStyle="#e4e4e7",e.font=D,e.textAlign="right",e.textBaseline="middle";for(const Z of F){const N=_(Z.value,Z.min,Z.max,S,R);e.beginPath(),e.moveTo(w,N),e.lineTo(w+A,N),e.stroke(),e.fillText(Z.label,w-12,N)}e.textAlign="center",e.textBaseline="top";for(let Z=f;Z<=b+.01;Z+=q){const N=x(Z,f,b,w,A);e.beginPath(),e.moveTo(N,S),e.lineTo(N,S+R),e.stroke(),e.fillText(`${Math.round(Z)}`,N,S+R+10)}return{gx:w,gy:S,gw:A,gh:R,axisFont:j,yLabelX:X,xLabelY:k}}function O(e,o){const f=o-e,b=f<=8?1:f<=14?2:5,q=[],F=Math.ceil(e/b)*b;for(let w=F;w<=o+.001;w+=b)q.push({value:w,label:w%1===0?`${w.toFixed(0)}`:`${w.toFixed(1)}`,min:e,max:o});return q}function ae(){const e=Math.max(.5,a.liquidL100-a.liquidL0),o=Math.max(1,e*.15),f=Math.max(0,Math.round((a.liquidL0-o)*10)/10),b=Math.round((a.liquidL100+o)*10)/10;return{minL:f,maxL:b}}function ee(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function V(){const e=Math.max(.1,a.resistanceR100-a.resistanceR0),o=Math.max(.2,e*.15),f=Math.max(0,a.resistanceR0-o),b=a.resistanceR100+o,q=e<=2?.5:e<=4?1:2,F=[],w=Math.ceil(f/q)*q;for(let S=w;S<=b+.001;S+=q)F.push({value:S,label:S.toFixed(1),min:f,max:b});return{minR:f,maxR:b,ticks:F}}function Y(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function B(e){const{maxT:o}=e;let f=a.thermistorR25;for(let w=0;w<=o;w+=5){const S=w+273.15,A=a.thermistorR25*Math.exp(a.thermistorBeta*(1/S-1/298.15));f=Math.max(f,A)}f=Math.ceil(f*1.08*10)/10;const b=0,q=f<=12?2:4,F=[];for(let w=0;w<=f+.001;w+=q)F.push({value:w,label:w.toFixed(0),min:b,max:f});return{minR:b,maxR:f,ticks:F}}const U=n.querySelector("#tl-thermometerCanvas"),K=U.getContext("2d"),G=n.querySelector("#tl-graphCanvas"),ne=G.getContext("2d"),m=window.devicePixelRatio||1;U.width=T*m,U.height=$*m,K.scale(m,m),G.width=I*m,G.height=H*m,ne.scale(m,m);function p(){a.iceCubes=[];for(let e=0;e<4;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:10+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<15;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3,speedY:.6+Math.random()*1.2,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<6;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:12+Math.random()*15,speedY:.4+Math.random()*.5,opacity:.1+Math.random()*.25})}const d=200,c=11;function h(){const e=Math.pow(a.bulbVolume/d,.3333333333333333);return c*e}function L(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,o=.2+a.wallThickness*1.5,f=.4+a.bulbVolume*.003,b=1.35-a.capillaryBore*.45;return Math.max(.1,o*f*b*e*.15)}function y(e){a.bathTemp<=8&&a.iceCubes.forEach(o=>{o.x+=o.speedX,o.y+=o.speedY,(o.x<65||o.x>175)&&(o.speedX*=-1),(o.y<195||o.y>210)&&(o.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(o=>{o.y-=o.speedY*(1+a.bathTemp/100),o.y<185&&(o.y=265,o.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(o=>{o.y-=o.speedY*(1+(a.bathTemp-80)/40),o.phase+=o.wobbleSpeed,o.x+=Math.sin(o.phase)*.2,o.y<185&&(o.y=260+Math.random()*10,o.x=60+Math.random()*120)})}function M(e){let w=59,S=130,A=246;if(a.bathTemp<25){const k=a.bathTemp/25;w=Math.round(180-k*121),S=Math.round(210-k*80),A=Math.round(250-k*4)}else{const k=Math.min(1,(a.bathTemp-25)/125);w=Math.round(59+k*180),S=Math.round(130-k*100),A=Math.round(246-k*190)}if(a.bathTemp>40){const k=Math.min(1,(a.bathTemp-40)/100),Z=Date.now()*.02;e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-20,284);for(let N=-20;N<=20;N+=8){const re=k*(10+Math.sin(N*.3+Z)*4);e.lineTo(55+130/2+N,284-re)}e.lineTo(55+130/2+20,284),e.closePath(),e.fill()}e.strokeStyle="#9ca3af",e.lineWidth=2,e.fillStyle="#1f1f23",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const R=e.createLinearGradient(55,190,55,280);R.addColorStop(0,`rgba(${w}, ${S}, ${A}, 0.3)`),R.addColorStop(1,`rgba(${w}, ${S}, ${A}, 0.6)`),e.fillStyle=R,e.beginPath(),e.moveTo(55,190);const D=a.bathTemp>=80?1.5:.4,j=a.bathTemp>=80?.08:.03,X=Date.now()*j;for(let k=55;k<=185;k+=5){const Z=190+Math.sin(k*.15+X)*D;e.lineTo(k,Z)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.4,(a.bathTemp-35)/120)})`,e.lineWidth=1,a.heatWaves.forEach(k=>{e.beginPath(),e.moveTo(k.x,k.y),e.quadraticCurveTo(k.x+Math.sin(k.y*.06)*4,k.y-k.length/2,k.x,k.y-k.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(255, 255, 255, 0.6)",e.strokeStyle="rgba(147, 197, 253, 0.8)",e.lineWidth=.8,a.iceCubes.forEach(k=>{e.save(),e.translate(k.x,k.y),e.rotate(k.angle),e.beginPath(),e.roundRect(-k.size/2,-k.size/2,k.size,k.size,2),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.5)",e.strokeStyle="rgba(255, 255, 255, 0.7)",e.lineWidth=.5,a.bubbles.forEach(k=>{e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill(),e.stroke()})),e.strokeStyle="#4b5563",e.lineWidth=3,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke()}function v(e){const b=h(),q=250+Math.max(0,b-c)*.35,F=q-b-1,w=8+a.wallThickness*8,S=120-w/2,A=120+w/2,R=e.createLinearGradient(S,20,A,20);R.addColorStop(0,"rgba(209, 213, 219, 0.85)"),R.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),R.addColorStop(.5,"rgba(243, 244, 246, 0.2)"),R.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),R.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=R,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(S,F),e.lineTo(S,25),e.arcTo(S,20,S+5,20,5),e.arcTo(A,20,A,25,5),e.lineTo(A,F),e.closePath(),e.fill(),e.stroke();const D=e.createRadialGradient(120-b*.2,q-b*.2,b*.1,120,q,b);D.addColorStop(0,"rgba(255, 255, 255, 0.7)"),D.addColorStop(1,"rgba(156, 163, 175, 0.3)"),e.fillStyle=D,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,q,b+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const j=Math.min(w*.72,.6+a.capillaryBore*4.5);e.fillStyle="#111827",e.fillRect(120-j/2,28,j,F-20-8);const X=a.liquidType==="mercury",k=X?"#9ca3af":"#ef4444",Z=X?"#f3f4f6":"#fecaca",N=210,re=220,me=(N-40)/re,fe=N-Math.min(re,a.thermometerTemp)*me;e.fillStyle=k,e.fillRect(120-j/2,fe,j,F-fe),e.fillStyle=Z,e.fillRect(120-j/6,fe,j/3,F-fe);const le=b*.9,ie=e.createRadialGradient(120-le*.2,q-le*.2,le*.1,120,q,le);X?(ie.addColorStop(0,"#f3f4f6"),ie.addColorStop(.3,"#d1d5db"),ie.addColorStop(.8,"#9ca3af"),ie.addColorStop(1,"#4b5563")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,q,le,0,Math.PI*2),e.fill(),e.font="bold 7px Arial",e.fillStyle="#9ca3af",e.textAlign="center",e.textBaseline="top",e.fillText(`Vb = ${a.bulbVolume} mm³`,120,q+b+5),e.strokeStyle="#4b5563",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ue=0;ue<=200;ue+=50){const ge=N-ue*me;e.beginPath(),e.moveTo(S,ge),e.lineTo(S+4,ge),e.stroke(),e.fillText(`${ue}°C`,S-22,ge+2.5)}}function g(e){const w=e.createLinearGradient(116,20,124,20);w.addColorStop(0,"#9ca3af"),w.addColorStop(.3,"#f3f4f6"),w.addColorStop(.7,"#d1d5db"),w.addColorStop(1,"#6b7280"),e.fillStyle=w,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(116,20,8,225,[0,0,3,3]),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,A=40,R=135,D=90;e.fillStyle="#1e1b4b",e.strokeStyle="#4f46e5",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,A,R,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,A+12,R-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",S+R-16,A+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,A+21)}function P(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const q=20,F=225,w=10,S=120-w/2,A=e.createLinearGradient(S,q,S+w,q);A.addColorStop(0,"rgba(229, 231, 235, 0.4)"),A.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),A.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),A.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=A,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(S,q,w,F-q,[0,0,2,2]),e.fill(),e.stroke();const R=6,D=e.createRadialGradient(120-R*.2,245-R*.2,R*.1,120,245,R);D.addColorStop(0,"#4b5563"),D.addColorStop(.7,"#1f2937"),D.addColorStop(1,"#111827"),e.fillStyle=D,e.strokeStyle="#030712",e.lineWidth=1,e.beginPath(),e.arc(120,245,R,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const j=245,X=40,k=135,Z=90;e.fillStyle="#111827",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(j,X,k,Z,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(j+10,X+12,k-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",j+k-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",j+14,X+21)}function C(e){const o=W(),{minL:f,maxL:b}=ae(),{minT:q,maxT:F,tickStep:w}=te(),S=O(f,b),A=z(e,o,q,F,w,S),{gx:R,gy:D,gw:j,gh:X,axisFont:k,yLabelX:Z,xLabelY:N,dotR:re}={...o,...A};e.save(),e.translate(Z,D+X/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=k,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",R+j/2,N);const ve=Math.min(F,100),me=x(0,q,F,R,j),fe=_(ee(0),f,b,D,X),le=x(ve,q,F,R,j),ie=_(ee(ve),f,b,D,X);e.strokeStyle="#ef4444",e.lineWidth=2,e.beginPath(),e.moveTo(me,fe),e.lineTo(le,ie),e.stroke();const ue=a.thermometerTemp,ge=a.currentLength;if(ue>=q&&ue<=F){const we=x(ue,q,F,R,j),Ee=_(ge,f,b,D,X);e.fillStyle="#ef4444",e.beginPath(),e.arc(we,Ee,re,0,Math.PI*2),e.fill()}}function Q(e){const o=W(),{minR:f,maxR:b,ticks:q}=V(),F=te(),w=z(e,o,F.minT,F.maxT,F.tickStep,q),{gx:S,gy:A,gw:R,gh:D,axisFont:j,yLabelX:X,xLabelY:k,dotR:Z}={...o,...w};e.save(),e.translate(X,A+D/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",S+R/2,k);const{minT:N,maxT:re}=F,ve=Math.min(re,100),me=x(0,N,re,S,R),fe=_(Y(0),f,b,A,D),le=x(ve,N,re,S,R),ie=_(Y(ve),f,b,A,D);e.strokeStyle="#4f46e5",e.lineWidth=2,e.beginPath(),e.moveTo(me,fe),e.lineTo(le,ie),e.stroke();const ue=a.thermometerTemp,ge=a.currentResistance;if(ue>=N&&ue<=re){const we=x(ue,N,re,S,R),Ee=_(ge,f,b,A,D);e.fillStyle="#4f46e5",e.beginPath(),e.arc(we,Ee,Z,0,Math.PI*2),e.fill()}}function E(e){const o=W(),f=te(),{minR:b,maxR:q,ticks:F}=B(f),w=z(e,o,f.minT,f.maxT,f.tickStep,F),{gx:S,gy:A,gw:R,gh:D,axisFont:j,yLabelX:X,xLabelY:k,dotR:Z}={...o,...w},{minT:N,maxT:re}=f;e.save(),e.translate(X,A+D/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",S+R/2,k),e.strokeStyle="#10b981",e.lineWidth=2,e.beginPath();let ve=!1;for(let le=N;le<=re;le+=2){const ie=le+273.15,ue=a.thermistorR25*Math.exp(a.thermistorBeta*(1/ie-1/298.15)),ge=x(le,N,re,S,R),we=_(Math.min(q,ue),b,q,A,D);we>=A&&we<=A+D&&(ve?e.lineTo(ge,we):(e.moveTo(ge,we),ve=!0))}e.stroke();const me=a.thermometerTemp,fe=a.currentThermistorR;if(me>=N&&me<=re){const le=x(me,N,re,S,R),ie=_(Math.min(q,fe),b,q,A,D);e.fillStyle="#10b981",e.beginPath(),e.arc(le,ie,Z,0,Math.PI*2),e.fill()}}function ce(){K.clearRect(0,0,T,$),ne.clearRect(0,0,I,H),K.save(),K.translate(J,0),M(K),a.thermometerType==="liquid"?v(K):a.thermometerType==="resistance"?g(K):P(K),K.restore(),a.thermometerType==="liquid"?C(ne):a.thermometerType==="resistance"?Q(ne):E(ne)}function oe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const o=n.querySelector("#tl-bath-state");a.bathTemp<=0?o.textContent="Melting Ice Bath":a.bathTemp>=100?o.textContent="Boiling Water/Steam":a.bathTemp===150?o.textContent="Hot Cooking Oil":o.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const f=n.querySelector("#tl-alcohol-boiling-warning");if(a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?f.style.display="block":f.style.display="none",a.thermometerType==="liquid")n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-sub-num").textContent=`${a.currentLength.toFixed(2)} - ${a.liquidL0.toFixed(1)}`,n.querySelector("#tl-live-liquid-sub-den").textContent=`${a.liquidL100.toFixed(1)} - ${a.liquidL0.toFixed(1)}`,n.querySelector("#tl-live-liquid-ans").textContent=a.thermometerTemp.toFixed(1)+"°C";else if(a.thermometerType==="resistance")n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-sub-num").textContent=`${a.currentResistance.toFixed(2)} - ${a.resistanceR0.toFixed(1)}`,n.querySelector("#tl-live-resistance-sub-den").textContent=`${a.resistanceR100.toFixed(1)} - ${a.resistanceR0.toFixed(1)}`,n.querySelector("#tl-live-resistance-ans").textContent=a.thermometerTemp.toFixed(1)+"°C";else{n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ";const b=a.thermometerTemp+273.15;n.querySelector("#tl-live-thermistor-calc-tk").textContent=b.toFixed(2),n.querySelector("#tl-live-thermistor-ans").textContent=a.thermometerTemp.toFixed(1)+"°C"}}let se=null;function pe(e){a.lastTimestamp||(a.lastTimestamp=e);const o=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const f=Math.min(o,.1),b=L(),q=f/b*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=q,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const F=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/F-1/298.15)),y(),ce(),oe(b),se=requestAnimationFrame(pe)}function qe(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),o=parseFloat(n.querySelector("#tl-input-faulty-cu").value),f=Number.isFinite(e)?e:-1.5,b=Number.isFinite(o)?o:105,q=b-f;return{cf:f,cu:b,interval:q}}function he(e){const o=Math.round(e*100)/100;return o>=0?o.toFixed(1):`(${o.toFixed(1)})`}function be(){const{cf:e,cu:o,interval:f}=qe(),b=n.querySelector("#tl-val-faulty-interval"),q=n.querySelector("#tl-faulty-error-a"),F=n.querySelector("#tl-faulty-error-b"),w=n.querySelector("#tl-ans-q10a"),S=n.querySelector("#tl-ans-q10b"),A=Math.abs(f)<.01;if(b.textContent=f.toFixed(1)+" °C",A){q.hidden=!1,q.textContent="C_u must differ from C_f (interval cannot be zero).",F.hidden=!1,F.textContent=q.textContent,w.textContent="—",S.textContent="—";return}q.hidden=!0,F.hidden=!0;const R=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,D=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,j=(R-e)/f*100,X=D/100*f+e;n.querySelector("#tl-faulty-sub-num-a").textContent=`${R.toFixed(1)} − ${he(e)}`,n.querySelector("#tl-faulty-sub-den-a").textContent=`${o.toFixed(1)} − ${he(e)}`,n.querySelector("#tl-faulty-sub-num-b").textContent=`${D.toFixed(1)} × ${f.toFixed(1)}`,n.querySelector("#tl-faulty-sub-cf-b").textContent=`+ ${he(e)}`,w.textContent=j.toFixed(1)+" °C",S.textContent=X.toFixed(2)+" °C"}function Me(){const e=parseFloat(n.querySelector("#tl-input-q11-r").value)||0,o=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100;n.querySelector("#tl-formula-q11-rsub").textContent=e.toFixed(1),n.querySelector("#tl-ans-q11").textContent=o.toFixed(1)+" °C"}function de(){be(),Me()}function Se(e,o){n.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=o,n.querySelector("#tl-bath-temp-slider").value=o,de()})}function ke(){n.querySelectorAll(".tl-tab-btn").forEach(o=>{o.addEventListener("click",()=>{n.querySelectorAll(".tl-tab-btn").forEach(b=>b.classList.remove("active")),n.querySelectorAll(".tl-tab-content").forEach(b=>b.classList.remove("active")),o.classList.add("active");const f=o.getAttribute("data-tl-tab");n.querySelector("#tl-tab-"+f).classList.add("active"),a.thermometerType=f,de()})}),n.querySelector("#tl-bath-temp-slider").addEventListener("input",o=>{a.bathTemp=parseFloat(o.target.value),de()}),Se("tl-btn-preset-ice",0),Se("tl-btn-preset-room",25),Se("tl-btn-preset-steam",100),Se("tl-btn-preset-oil",150),n.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",n.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",n.querySelector("#tl-card-alcohol").className="tl-seg-btn",de()}),n.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",n.querySelector("#tl-card-mercury").className="tl-seg-btn",n.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",de()}),n.querySelector("#tl-slider-bulb-vol").addEventListener("input",o=>{a.bulbVolume=parseFloat(o.target.value),n.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),n.querySelector("#tl-slider-wall-thick").addEventListener("input",o=>{a.wallThickness=parseFloat(o.target.value),n.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),n.querySelector("#tl-slider-capillary-bore").addEventListener("input",o=>{a.capillaryBore=parseFloat(o.target.value),n.querySelector("#tl-val-capillary-bore").textContent=a.capillaryBore.toFixed(2)+" mm"}),n.querySelector("#tl-slider-liquid-l0").addEventListener("input",o=>{a.liquidL0=parseFloat(o.target.value),n.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-liquid-l100").addEventListener("input",o=>{a.liquidL100=parseFloat(o.target.value),n.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-resistance-r0").addEventListener("input",o=>{a.resistanceR0=parseFloat(o.target.value),n.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-resistance-r100").addEventListener("input",o=>{a.resistanceR100=parseFloat(o.target.value),n.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-thermistor-r25").addEventListener("input",o=>{a.thermistorR25=parseFloat(o.target.value),n.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",n.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",de()}),n.querySelector("#tl-slider-thermistor-beta").addEventListener("input",o=>{a.thermistorBeta=parseFloat(o.target.value),n.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",n.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",de()}),n.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.add("active"),n.querySelector("#tl-btn-solve-q10b").classList.remove("active"),n.querySelector("#tl-pane-q10a").classList.add("active"),n.querySelector("#tl-pane-q10b").classList.remove("active")}),n.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.remove("active"),n.querySelector("#tl-btn-solve-q10b").classList.add("active"),n.querySelector("#tl-pane-q10a").classList.remove("active"),n.querySelector("#tl-pane-q10b").classList.add("active")}),n.querySelector("#tl-input-faulty-cf").addEventListener("input",be),n.querySelector("#tl-input-faulty-cu").addEventListener("input",be),n.querySelector("#tl-input-q10a-cm").addEventListener("input",be),n.querySelector("#tl-input-q10b-t").addEventListener("input",be),n.querySelector("#tl-input-q11-r").addEventListener("input",Me)}if(i.type){const e=n.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return n.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===l?e.classList.add("active"):e.classList.remove("active")}),n.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===l?e.classList.add("active"):e.classList.remove("active")}),p(),ke(),de(),se=requestAnimationFrame(pe),n._thermometerLabCleanup=()=>{se&&cancelAnimationFrame(se)},n}const Te=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],Fe=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],_t=[["thermometer","topic.thermometer"]],De=["liquid","resistance","thermistor"],Mt={liquid:t=>ze(t,{type:"liquid"}),resistance:t=>ze(t,{type:"resistance"}),thermistor:t=>ze(t,{type:"thermistor"})};function Rt(t){return s({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title"}[t]||t)}function He(){return xe()==="zh-Hant"?"zhHant":"en"}async function Ht(t,i){const l=`./${t}/${i}`;try{return(await fetch(l,{method:"HEAD"})).ok}catch{return!1}}async function Oe(t){return Ht("notes",t)}function Lt(t){let i="topics",l="liquid",r=0,u="all",n=!1,a=null,T={main:null},$=null;function J(){if(T.main){if(i==="topics"?T.main.innerHTML=H():i==="notes"?T.main.innerHTML=te():i==="tools"?T.main.innerHTML=_():i==="worksheets"?T.main.innerHTML=Xe(s,{topics:_t,paperTitleKey:"worksheets.paperTitleHeat"}):i==="flashcards"?T.main.innerHTML=ae():i==="summary"&&(T.main.innerHTML=U()),i==="notes"&&x(),i==="tools"&&z(),i==="worksheets"){const m=Ye.filter(p=>Fe.includes(p.topic));Ze(t,m,s,He,{topicFilter:(p,d)=>d.includes("thermometer")?Fe.includes(p.topic):d.includes(p.topic)})}i==="flashcards"&&B(),i==="summary"&&K()}}function I(){a==null||a.destroy(),a=Ke(t,{subtitleKey:"strand.heat.subtitle",activeSection:i,onSection:m=>{i==="tools"&&m!=="tools"&&$!=null&&$._thermometerLabCleanup&&($._thermometerLabCleanup(),$=null),i=m,a.updateSection(i),J()},onLang:()=>I()}),T.main=a.main,a.updateSection(i),J()}function H(){return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Te.map(m=>{const p=m.tool?`<button class="btn primary" type="button" data-go-tool="${m.tool}">${s("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${s("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${s(m.titleKey)}</h3>
              ${p}
            </div>`}).join("")}
        </div>
      </section>`}function W(m){const p=m.target.closest("[data-go-tool]");if(p){const c=p.getAttribute("data-go-tool");De.includes(c)?l=c:l="liquid",i="tools",a.updateSection(i),J();return}const d=m.target.closest("[data-go-section]");(d==null?void 0:d.getAttribute("data-go-section"))==="notes"&&(i="notes",a.updateSection(i),J())}function te(){return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
      ...
      </section>`}async function x(){const m=He();for(const p of Te){const d=t.querySelector(`[data-note-card="${p.id}"]`);if(!d)continue;const c=d.querySelector("[data-note-body]"),h=m==="zhHant"?p.fileZh:p.fileEn,L=await Oe(h),y=`./notes/${h}`;L?c.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${p.id}`)}" src="${y}"></iframe>
          <p style="margin-top:8px"><a href="${y}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:c.innerHTML=`<p class="lead">${s("notes.missing")}</p>`}}function _(){return`
      <section class="panel panel--tools">
        <h2>${s("tools.title")}</h2>
        <p class="lead">${s("tools.pick")}</p>
        <div class="tools-layout">
      ...
      </section>`}function ee(){return Ue.filter(m=>Fe.includes(m.topic))}function V(){const m=ee();return u==="all"||u==="thermometry"?m:m.filter(p=>p.topic===u)}function Y(){const m=V(),p=t.querySelector("[data-flash-progress]");if(!m.length){r=0;const M=t.querySelector("[data-flash-front]");M&&(M.textContent=""),p&&(p.hidden=!0,p.textContent="");return}r=Math.max(0,Math.min(r,m.length-1));const d=m[r],c=t.querySelector("[data-flash-front]"),h=t.querySelector("[data-flash-label]");if(!c)return;p&&(p.hidden=!1,p.textContent=s("flashcards.progress").replace("{current}",String(r+1)).replace("{total}",String(m.length)));const L=He(),y=d[L]||d.en;h&&(h.hidden=!1,h.textContent=s(n?"flashcards.answer":"flashcards.question")),c.textContent=n?y.a:y.q}function B(){const m=t.querySelector("[data-flash-deck]");m.value=u,m.addEventListener("change",()=>{u=m.value,r=0,n=!1,Y()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{n=!n,Y()}),t.querySelector("[data-flash-flip]").addEventListener("click",p=>{p.stopPropagation(),n=!n,Y()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const p=V();r=(r-1+p.length)%p.length,n=!1,Y()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const p=V();r=(r+1)%p.length,n=!1,Y()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const p=V();r=Math.floor(Math.random()*p.length),n=!1,Y()}),Y()}function U(){return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
      ...
      </section>`}async function K(){const m=He();for(const p of Te){const d=t.querySelector(`[data-summary-card="${p.id}"]`);if(!d)continue;const c=d.querySelector("[data-summary-body]"),h=m==="zhHant"?p.fileZh:p.fileEn,L=await Oe(h),y=`./notes/${h}`;L?c.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${p.id}`)}" src="${y}"></iframe>
          <p style="margin-top:8px"><a href="${y}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const G=()=>I(),ne=m=>W(m);return window.addEventListener("s3phy:lang",G),t.addEventListener("click",ne),I(),()=>{window.removeEventListener("s3phy:lang",G),t.removeEventListener("click",ne),$!=null&&$._thermometerLabCleanup&&$._thermometerLabCleanup(),a==null||a.destroy()}}const Qe={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};it();const je="s3phy_splash_seen",et={optics:kt,heat:Lt};let Ce=null,_e=null;function At(){const t=location.hash.match(/^#\/(\w+)/),i=t==null?void 0:t[1];return i&&Object.prototype.hasOwnProperty.call(et,i)?i:null}function Et(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function tt(t){Ce==null||Ce(),Ce=null,_e==null||_e(),_e=null;const i=document.getElementById("app");if(!i)return;if(i.innerHTML="",!t){location.hash&&Et(),_e=st(i);return}const l=`#/${t}`;if(location.hash!==l){location.hash=l;return}Ce=et[t](i)??null}function at(){tt(At())}function $t(){return"./images/uniplus-logo.png"}function zt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${$t()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Ft(t,i){const l=[...Qe.en,...Qe.zhHant],r=()=>{if(!t.parentElement)return;const u=document.createElement("div");u.className="splash-danmaku-item",u.textContent=l[Math.floor(Math.random()*l.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,T=Math.random()*12+10;u.style.top=`${n}%`,u.style.fontSize=`${a}rem`,u.style.animationDuration=`${T}s`,i.appendChild(u),u.addEventListener("animationend",()=>u.remove()),window.setTimeout(r,1500+Math.random()*1e3)};for(let u=0;u<4;u+=1)window.setTimeout(r,u*1e3)}function It(t){const i=t.querySelector("#splashLogoWrap"),l=t.querySelector("#splashDanmaku"),r=t.querySelector("#splashStartWrap");window.setTimeout(()=>i==null?void 0:i.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{l==null||l.classList.add("splash-danmaku--visible"),r==null||r.classList.add("splash-start-wrap--in"),l&&Ft(t,l)},1600)}function Ne(){at()}function Wt(){let t=!1;try{t=sessionStorage.getItem(je)==="1"}catch{}if(t){Ne();return}const i=zt();document.body.insertBefore(i,document.body.firstChild),It(i);const l=i.querySelector("#splashStart"),r=()=>{i.remove(),Ne()};l.addEventListener("click",()=>{try{sessionStorage.setItem(je,"1")}catch{}i.classList.add("splash--hide"),i.addEventListener("transitionend",r,{once:!0}),window.setTimeout(r,480)})}window.addEventListener("hashchange",at);window.addEventListener("s3phy:strand",t=>{tt(t.detail??null)});Wt();
