import{t as n}from"./index-BWdbpOdx.js";import{m}from"./hubShell-BixfOxW9.js";import{h}from"./hubHelpers-KSaSxI7H.js";const c=[{id:"waveMotion",titleKey:"topic.waveMotion",fileEn:"wave-motion-en.pdf",fileZh:"wave-motion-zhHant.pdf"},{id:"waveProperties",titleKey:"topic.waveProperties",fileEn:"wave-properties-en.pdf",fileZh:"wave-properties-zhHant.pdf"},{id:"stationaryWave",titleKey:"topic.stationaryWave"},{id:"lightWave",titleKey:"topic.lightWave"},{id:"soundWave",titleKey:"topic.soundWave"}];function $(s){let t="topics",e=null,a={main:null};function d(){a.main&&(t==="topics"?a.main.innerHTML=v():t==="notes"?a.main.innerHTML=u():a.main.innerHTML=`
    ...
    `}function u(){return`
      ...
      </section>`}async function f(){const i=c.map(o=>({key:o.id,fileEn:o.fileEn,fileZh:o.fileZh}));await h(s,i)}s.addEventListener("click",r);function r(i){const o=i.target.closest("[data-go-section]");(o==null?void 0:o.getAttribute("data-go-section"))==="notes"&&(t="notes",e.updateSection(t),d())}return p(),()=>{s.removeEventListener("click",r),e==null||e.destroy()}}export{$ as mountWavesHub};
