...
`;function gt(){if(document.getElementById(Ge))return;const t=document.createElement("style");t.id=Ge,t.textContent=mt,document.head.appendChild(t)}function bt(t){gt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
    <div class="rml-head">
  ...
  `;const c=r.querySelector(".rml-canvas"),i=c.getContext("2d"),f=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),L=r.querySelector('[data-rml-disp="inc"]'),F=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,O=380,Z=300,C="#22d3ee",z="bold 17px system-ui, sans-serif";let I=0,j=-140,ae=!0,X=!0,U=!0,V=!0;function Y(h){return h*Math.PI/180}function J(h,u,d,m,A,M=2,H=!1){i.beginPath(),i.lineWidth=M,i.strokeStyle=A,i.setLineDash(H?[6,6]:[]);const y=h+Math.cos(Y(d))*m,w=u+Math.sin(Y(d))*m;return i.moveTo(h,u),i.lineTo(y,w),i.stroke(),i.setLineDash([]),{x:y,y:w}}function ee(h,u,d,m,A,M=14){const H=d-h,y=m-u,w=Math.hypot(H,y);if(w<1e-6)return;const G=H/w,R=y/w,Q=d-G*M,E=m-R*M,ce=.45*M;i.beginPath(),i.fillStyle=A,i.moveTo(d,m),i.lineTo(Q-R*ce,E+G*ce),i.lineTo(Q+R*ce,E-G*ce),i.closePath(),i.fill()}function K(h,u,d,m,A,M=25){i.beginPath(),i.strokeStyle=m,i.lineWidth=2;const H=Math.min(h,u),y=Math.max(h,u);if(i.arc($,O,d,Y(H),Y(y),!1),i.stroke(),A){const w=(H+y)/2,G=$+Math.cos(Y(w))*(d+M),R=O+Math.sin(Y(w))*(d+M);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=m,i.fillText(A,G,R),i.restore()}}function ne(h,u,d,m,A){i.clearRect(0,0,c.width,c.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,O),i.lineTo($+200,O),i.stroke(),i.setLineDash([]),i.lineCap="butt";const M=$+Math.cos(Y(h))*Z,H=O+Math.sin(Y(h))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(M,H),i.lineTo($,O),i.stroke();const y=(M+$)*.5,w=(H+O)*.5,G=Math.hypot($-M,O-H)||1,R=($-M)/G,Q=(O-H)/G;if(ee(y-R*28,w-Q*28,y,w,"#fff",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),M,H-12),i.restore(),ae){const E=J($,O,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),E.x+6,E.y-4),i.restore()}if(X){const E=J($,O,m,Z,"#00e676",2,!1);ee($,O,E.x,E.y,"#00e676",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),E.x,E.y-14),i.restore()}i.save(),i.translate($,O),i.rotate(Y(I)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let E=-190;E<200;E+=15)i.moveTo(E,0),i.lineTo(E-5,8);if(i.stroke(),i.restore(),U){const E=J($,O,u,Z-40,C,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=C,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),E.x+6,E.y-4),i.restore()}if(V){const E=J($,O,d,Z,C,4);ee($,O,E.x,E.y,C,16),Math.abs(I)>.5&&(i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=C,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),E.x,E.y-14),i.restore())}if(U&&K(h,u,100,"#ffcc00",`i=${A.toFixed(0)}°`,25),U&&V&&K(u,d,100,C,`r=${A.toFixed(0)}°`,25),ae&&U&&Math.abs(I)>.5&&K(-90,u,50,"#ffcc00",`θ=${Math.abs(I)}°`,20),X&&V&&Math.abs(I)>.5){const E=d-m;K(m,d,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${E.toFixed(0)}°`,40)}}function g(){I=parseFloat(f.value),j=parseFloat(n.value);const h=I>0?"+":"";a.textContent=`${h}${I}°`,L.textContent=`${j}°`;const u=-90,d=Math.abs(j-u),m=u+d,A=-90+I,M=Math.abs(j-A),H=A+M,y=H-m;F.textContent=`${M.toFixed(1)}°`,te.textContent=`${M.toFixed(1)}°`;const w=y>0?"+":"";P.textContent=`${w}${y.toFixed(1)}°`,ne(j,A,H,m,M)}return r.querySelectorAll("[data-rml-toggle]").forEach(h=>{h.addEventListener("click",()=>{const u=h.getAttribute("data-rml-toggle");u==="orig-norm"&&(ae=!ae),u==="orig-ray"&&(X=!X),u==="new-norm"&&(U=!U),u==="new-ray"&&(V=!V),h.classList.toggle("active"),g()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{f.value="0",g()}),f.addEventListener("input",g),n.addEventListener("input",g),g(),r}function vt(t){const r=document.createElement("div");r.className="tool-tir-escape";const c=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;return c.src=`${f}tir-escape/index.html?embed=1`,c.title=t("tools.refractionTir.title"),c.setAttribute("loading","lazy"),c.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(c),r}function yt(t,r={}){const c=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",f=document.createElement("div");f.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",L=a.endsWith("/")?a:`${a}/`;return n.src=`${L}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(c)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",f.appendChild(n),f}function wt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const c=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;function n(){return`${f}em-spectrum/index.html?lang=${encodeURIComponent(Se())}`}c.src=n(),c.title=t("tools.em.title"),c.setAttribute("loading","lazy"),c.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var L;try{(L=c.contentWindow)==null||L.postMessage({type:"s3phy:lang",lang:Se()},"*")}catch{c.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(c),r}function xt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),L=t.querySelector("[data-lang]"),F=t.querySelector("[data-strand-back]");let te=c;function P(C){te=C,a.innerHTML=qt.map(z=>`<button type="button" class="${C===z?"active":""}" data-sec="${z}">${l(St[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>i(z.getAttribute("data-sec")))})}function $(){L.innerHTML=`
    ...
    <section class="panel panel--worksheets">
      ...
      <div class="worksheet-output" data-ws-out><p class="lead">${t("worksheets.empty")}</p></div>
        ...
        <p class="q-exp q-summary"><em>${we(R.exp)}</em></p>`);const Re=ke?"correct":xe?"incorrect":"",ze=R.choices.map((he,ve)=>`<li>
...
${G}</body></html>`}function d(y){const w=u(y),G=new Blob(["\uFEFF",w],{type:"application/msword"}),R=document.createElement("a");R.href=URL.createObjectURL(G),R.download=y?"worksheet-answers.doc":"worksheet.doc",R.click(),URL.revokeObjectURL(R.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),w=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),G=kt(r,w,f.topicFilter),R=Be(G).slice(0,Math.min(y,G.length||1));n.items=R.length?R:Be(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",L.hidden=!1,F.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),I&&(I.hidden=!1),j&&(j.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const w=y.target.closest("[data-ws-tab]");!w||!n.items.length||ee(w.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=Tt(),X.textContent=`${c("worksheets.date")}: ${n.dateStr}`),j&&(j.hidden=!n.dateStr,j.textContent=n.dateStr?`${c("worksheets.date")}: ${n.dateStr}`:"")}),(m=t.querySelector("[data-ws-word-p]"))==null||m.addEventListener("click",()=>d(!1)),(A=t.querySelector("[data-ws-word-a]"))==null||A.addEventListener("click",()=>d(!0)),(M=t.querySelector("[data-ws-print-p]"))==null||M.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(H=t.querySelector("[data-ws-print-a]"))==null||H.addEventListener("click",()=>{ee("answer"),window.print()})}const Ct=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Mt={rotatingMirror:t=>bt(t),refractionTir:t=>vt(t),lens:(t,r)=>yt(t,{defaultKind:r}),rgbMixer:t=>xt(t),em:t=>wt(t)};function _t(t){return l({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return Se()==="zh-Hant"?"zhHant":"en"}async function it(t,r){const c=`./${t}/${r}`;try{return(await fetch(c,{method:"HEAD"})).ok}catch{return!1}}async function Lt(t){return it("notes",t)}function Rt(t){let r="topics",c="rotatingMirror",i="convex",f=0,n="all",a=!1,L=null,F={main:null};function te(){F.main&&(r==="topics"?F.main.innerHTML=$():r==="notes"?F.main.innerHTML=Z():r==="tools"?F.main.innerHTML=z():r==="worksheets"?F.main.innerHTML=at(l):r==="flashcards"?F.main.innerHTML=ae():r==="summary"&&(F.main.innerHTML=K()),r==="notes"&&C(),r==="tools"&&I(),r==="worksheets"&&nt(t,Je,l,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){L==null||L.destroy(),L=tt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:u=>{r=u,L.updateSection(r),te()},onLang:()=>P()}),F.main=L.main,L.updateSection(r),te()}function $(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      ...
      </section>`}async function C(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],d=Ae();for(const m of u){const A=t.querySelector(`[data-note-card="${m.key}"]`);if(!A)continue;const M=A.querySelector("[data-note-body]"),H=d==="zhHant"?m.fileZh:m.fileEn,y=await Lt(H),w=`./notes/${H}`;y?M.innerHTML=`
      ...
      </section>`}function I(){const u=t.querySelector("[data-tool-list]"),d=t.querySelector("[data-tool-stage]");!u||!d||(u.querySelectorAll("button").forEach(m=>{m.addEventListener("click",()=>{c=m.getAttribute("data-tool"),u.querySelectorAll("button").forEach(A=>A.classList.toggle("active",A.getAttribute("data-tool")===c)),j(d)})}),j(d))}function j(u){u.innerHTML="";const d=Mt[c];if(!d)return;const m=c==="lens"?d(l,i):d(l);u.appendChild(m)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(u){return!!(u!=null&&u.front)}function U(u){return`./${String(u).replace(/^\.\//,"")}`}function V(){return et.slice()}function Y(){const u=ht.slice(),d=V(),m=n==="rotatingMirror"?"reflection":n;if(m==="all")return[...u,...d];if(m==="reflection")return u;if(m==="convex"||m==="concave"){const M=d.filter(H=>H.topic==="convex"||H.topic==="concave");return M.length?M:d}if(m==="refractionTir"){const M=d.filter(H=>H.topic==="refraction"||H.topic==="tir");return M.length?M:d}const A=d.filter(M=>M.topic===m);return A.length?A:d}function J(){const u=Y(),d=t.querySelector("[data-flash-progress]");if(!u.length){f=0;const G=t.querySelector("[data-flash-front]"),R=t.querySelector("[data-flip-card]");G&&(G.textContent=""),R&&R.classList.remove("flashcard-surface--image"),d&&(d.hidden=!0,d.textContent="");return}f=Math.max(0,Math.min(f,u.length-1));const m=u[f],A=t.querySelector("[data-flash-front]"),M=t.querySelector("[data-flip-card]"),H=t.querySelector("[data-flash-label]");if(!A||!M)return;if(d&&(d.hidden=!1,d.textContent=l("flashcards.progress").replace("{current}",String(f+1)).replace("{total}",String(u.length))),X(m)){const G=m.back&&m.back!==m.front;M.classList.add("flashcard-surface--image"),H&&(G?(H.hidden=!1,H.textContent=l(a?"flashcards.answer":"flashcards.question")):H.hidden=!0);const R=a&&m.back?m.back:m.front,Q=m.alt||m.title||"";A.innerHTML=`<img src="${U(R)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}M.classList.remove("flashcard-surface--image");const y=Ae(),w=m[y]||m.en;H&&(H.hidden=!1,H.textContent=l(a?"flashcards.answer":"flashcards.question")),A.textContent=a?w.a:w.q}function ee(){n==="rotatingMirror"&&(n="reflection");const u=t.querySelector("[data-flash-deck]");u.value=n,u.addEventListener("change",()=>{n=u.value,f=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",d=>{d.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const d=Y();f=(f-1+d.length)%d.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const d=Y();f=(f+1)%d.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const d=Y();f=Math.floor(Math.random()*d.length),a=!1,J()}),J()}function K(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
      ...
      </section>`}async function ne(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],d=Ae();for(const m of u){const A=t.querySelector(`[data-summary-card="${m.key}"]`);if(!A)continue;const M=A.querySelector("[data-summary-body]"),H=d==="zhHant"?m.fileZh:m.fileEn,y=await it("summary-pdfs",H),w=`./summary-pdfs/${H}`;y?M.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${m.key}`)}" src="${w}"></iframe>
          <p style="margin-top:8px"><a href="${w}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:M.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const g=()=>P(),h=u=>O(u);return window.addEventListener("s3phy:lang",g),t.addEventListener("click",h),P(),()=>{window.removeEventListener("s3phy:lang",g),t.removeEventListener("click",h),L==null||L.destroy()}}const je="s3phy-thermometer-lab-css",zt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Ht(){if(document.getElementById(je))return;const t=document.createElement("style");t.id=je,t.textContent=zt,document.head.appendChild(t)}function Pe(t,r={}){Ht();const c=r.type||"liquid";let i=t("tools.thermometerLab.title"),f=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),f=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),f=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),f=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:c,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},L=460,F=340,te=80,P=800,$=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let o=100;const s=Math.max(a.bathTemp,a.thermometerTemp,100);s>120&&(o=150),s>145&&(o=200);const p=o<=100?20:25;return{minT:0,maxT:o,tickStep:p}}function C(e,o,s,p,v){return p+(e-o)/(s-o)*v}function z(e,o,s,p,v){return p+v-(e-o)/(s-o)*v}function I(e,o,s,p,v,_){const{gx:b,gy:x,gw:S,gh:k,tickFont:T,axisFont:W,yLabelX:N,xLabelY:q}=o;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of _){const B=z(D.value,D.min,D.max,x,k);e.beginPath(),e.moveTo(b,B),e.lineTo(b+S,B),e.stroke()}for(let D=s;D<=p+.01;D+=v){const B=C(D,s,p,b,S);e.beginPath(),e.moveTo(B,x),e.lineTo(B,x+k),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(b,x),e.lineTo(b,x+k),e.lineTo(b+S,x+k),e.stroke(),e.fillStyle="#e4e4e7",e.font=T,e.textAlign="right",e.textBaseline="middle";for(const D of _){const B=z(D.value,D.min,D.max,x,k);e.fillText(D.label,b-15,B)}e.textAlign="center",e.textBaseline="top";for(let D=s;D<=p+.01;D+=v){const B=C(D,s,p,b,S);e.fillText(`${Math.round(D)}`,B,x+k+10)}return{gx:b,gy:x,gw:S,gh:k,axisFont:W,yLabelX:N,xLabelY:q}}function j(e,o){const s=o-e,p=s<=8?1:s<=14?2:5,v=[],_=Math.ceil(e/p)*p;for(let b=_;b<=o+.001;b+=p)v.push({value:b,label:b%1===0?`${b.toFixed(0)}`:`${b.toFixed(1)}`,min:e,max:o});return v}function ae(){const{maxT:e}=Z(),o=X(0),s=X(e),p=s-o,v=Math.max(1,p*.1),_=Math.max(0,Math.round((o-v)*10)/10),b=Math.round((s+v)*10)/10;return{minL:_,maxL:b}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),o=V(0),s=V(e),p=s-o,v=Math.max(.2,p*.1),_=Math.max(0,o-v),b=s+v,x=p<=2?.5:p<=4?1:2,S=[],k=Math.ceil(_/x)*x;for(let T=k;T<=b+.001;T+=x)S.push({value:T,label:T.toFixed(1),min:_,max:b});return{minR:_,maxR:b,ticks:S}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:o}=e;let s=a.thermistorR25;for(let b=0;b<=o;b+=5){const x=b+273.15,S=a.thermistorR25*Math.exp(a.thermistorBeta*(1/x-1/298.15));s=Math.max(s,S)}s=Math.ceil(s*1.08*10)/10;const p=0,v=s<=12?2:4,_=[];for(let b=0;b<=s+.001;b+=v)_.push({value:b,label:b.toFixed(0),min:p,max:s});return{minR:p,maxR:s,ticks:_}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),g=window.devicePixelRatio||1;J.width=L*g,J.height=F*g,ee.scale(g,g),K.width=P*g,K.height=$*g,ne.scale(g,g);function h(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const u=200,d=11;function m(){const e=Math.pow(a.bulbVolume/u,.3333333333333333);return d*e}function A(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,o=.2+a.wallThickness*1.5,s=.4+a.bulbVolume*.003,p=1.35-a.capillaryBore*.45;return Math.max(.1,o*s*p*e*.15)}function M(e){a.bathTemp<=8&&a.iceCubes.forEach(o=>{o.x+=o.speedX,o.y+=o.speedY,(o.x<65||o.x>175)&&(o.speedX*=-1),(o.y<195||o.y>210)&&(o.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(o=>{o.y-=o.speedY*(1+a.bathTemp/100),o.y<185&&(o.y=265,o.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(o=>{o.y-=o.speedY*(1+(a.bathTemp-80)/40),o.phase+=o.wobbleSpeed,o.x+=Math.sin(o.phase)*.3,o.y<185&&(o.y=260+Math.random()*10,o.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(o=>{o.x+=o.vx,o.y+=o.vy,o.alpha-=.005,(o.alpha<=0||o.y<130)&&(o.x=60+Math.random()*120,o.y=175+Math.random()*5,o.alpha=.2+Math.random()*.4)})}function H(e){let b=59,x=130,S=246;if(a.bathTemp<25){const q=a.bathTemp/25;b=Math.round(180-q*121),x=Math.round(210-q*80),S=Math.round(250-q*4)}else{const q=Math.min(1,(a.bathTemp-25)/125);b=Math.round(59+q*180),x=Math.round(130-q*100),S=Math.round(246-q*190)}if(a.bathTemp>40){const q=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let B=-25;B<=25;B+=6){const ie=q*(12+Math.sin(B*.4+D)*5);e.lineTo(55+130/2+B,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const k=e.createLinearGradient(55,190,55,280);k.addColorStop(0,`rgba(${b}, ${x}, ${S}, 0.25)`),k.addColorStop(1,`rgba(${b}, ${x}, ${S}, 0.55)`),e.fillStyle=k,e.beginPath(),e.moveTo(55,190);const T=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let q=55;q<=185;q+=5){const D=190+Math.sin(q*.15+N)*T;e.lineTo(q,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,o,s,p,v,_,b="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(o,s),e.lineTo(p,v),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(o,s,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const S=e.measureText(_).width+10,k=16,T=b==="left"?p:p-S,W=v-k/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(T,W,S,k,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(_,T+S/2,W+k/2+.5)}function w(e){const p=m(),v=250+Math.max(0,p-d)*.35,_=v-p-1,b=10+a.wallThickness*8,x=120-b/2,S=120+b/2,k=e.createLinearGradient(x,20,S,20);k.addColorStop(0,"rgba(209, 213, 219, 0.85)"),k.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),k.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),k.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),k.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(x,_),e.lineTo(x,25),e.arcTo(x,20,x+5,20,5),e.arcTo(S,20,S,25,5),e.lineTo(S,_),e.closePath(),e.fill(),e.stroke();const T=e.createRadialGradient(120-p*.2,v-p*.2,p*.1,120,v,p);T.addColorStop(0,"rgba(255, 255, 255, 0.8)"),T.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=T,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,v,p+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(b*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,_-20-8);const N=a.liquidType==="mercury",q=N?"#a1a1aa":"#ef4444",D=N?"#f4f4f5":"#fee2e2",B=210,ie=220,me=(B-40)/ie,ue=B-Math.min(ie,a.thermometerTemp)*me;e.fillStyle=q,e.fillRect(120-W/2,ue,W,_-ue),e.beginPath(),e.ellipse(120,ue,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-W/6,ue,W/3,_-ue);const oe=p*.9,re=e.createRadialGradient(120-oe*.2,v-oe*.2,oe*.1,120,v,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,v,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const pe=B-le*me;e.beginPath(),e.moveTo(x,pe),e.lineTo(x+4,pe),e.stroke(),e.fillText(`${le}°C`,x-22,pe+2.5)}a.showLabels&&(y(e,x+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,ue,230,ue-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,v,230,v+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function G(e){const b=e.createLinearGradient(115,20,125,20);b.addColorStop(0,"#71717a"),b.addColorStop(.3,"#f4f4f5"),b.addColorStop(.7,"#d4d4d8"),b.addColorStop(1,"#3f3f46"),e.fillStyle=b,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let x=205;e.moveTo(118,x);for(let N=0;N<8;N++)x+=4,e.lineTo(122,x),x+=4,e.lineTo(118,x);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,k=40,T=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,k,T,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,k+12,T-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",S+T-16,k+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,k+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function R(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const v=20,_=225,b=12,x=120-b/2,S=e.createLinearGradient(x,v,x+b,v);S.addColorStop(0,"rgba(229, 231, 235, 0.4)"),S.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),S.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),S.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=S,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(x,v,b,_-v,[0,0,3,3]),e.fill(),e.stroke();const k=7,T=e.createRadialGradient(120-k*.2,245-k*.2,k*.1,120,245,k);T.addColorStop(0,"#6b7280"),T.addColorStop(.7,"#1f2937"),T.addColorStop(1,"#09090b"),e.fillStyle=T,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,k,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,q=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,q,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,q-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+q-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,o,s,p,v,_,b,x,S){const{gx:k,gy:T,gw:W,gh:N}=o;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(s,p),e.lineTo(s,T+N),e.stroke(),e.beginPath(),e.moveTo(s,p),e.lineTo(k,p),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${v.toFixed(1)}${b}`,D=e.measureText(q).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(s-D/2,T+N+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,s,T+N+4),e.textAlign="right",e.textBaseline="middle";const B=`${_.toFixed(2)} ${x}`,ie=e.measureText(B).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(k-ie-2,p-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(B,k-7,p)}function E(e){const o=O(),{minL:s,maxL:p}=ae(),{minT:v,maxT:_,tickStep:b}=Z(),x=j(s,p),S=I(e,o,v,_,b,x),{gx:k,gy:T,gw:W,gh:N,axisFont:q,yLabelX:D,xLabelY:B,dotR:ie}={...o,...S};e.save(),e.translate(D,T+N/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",k+W/2,B);const ye=_,me=C(0,v,_,k,W),ue=z(X(0),s,p,T,N),oe=C(ye,v,_,k,W),re=z(X(ye),s,p,T,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(me,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentLength;if(le>=v&&le<=_){const be=C(le,v,_,k,W),Ce=z(pe,s,p,T,N);Q(e,o,be,Ce,le,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(be,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ce(e){const o=O(),{minR:s,maxR:p,ticks:v}=U(),_=Z(),b=I(e,o,_.minT,_.maxT,_.tickStep,v),{gx:x,gy:S,gw:k,gh:T,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...b};e.save(),e.translate(N,S+T/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+k/2,q);const{minT:B,maxT:ie}=_,ye=ie,me=C(0,B,ie,x,k),ue=z(V(0),s,p,S,T),oe=C(ye,B,ie,x,k),re=z(V(ye),s,p,S,T);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(me,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentResistance;if(le>=B&&le<=ie){const be=C(le,B,ie,x,k),Ce=z(pe,s,p,S,T);Q(e,o,be,Ce,le,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(be,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const o=O(),s=Z(),{minR:p,maxR:v,ticks:_}=Y(s),b=I(e,o,s.minT,s.maxT,s.tickStep,_),{gx:x,gy:S,gw:k,gh:T,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...b},{minT:B,maxT:ie}=s;e.save(),e.translate(N,S+T/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+k/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let ye=!1;for(let oe=B;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),pe=C(oe,B,ie,x,k),be=z(Math.min(v,le),p,v,S,T);be>=S&&be<=S+T&&(ye?e.lineTo(pe,be):(e.moveTo(pe,be),ye=!0))}e.stroke();const me=a.thermometerTemp,ue=a.currentThermistorR;if(me>=B&&me<=ie){const oe=C(me,B,ie,x,k),re=z(Math.min(v,ue),p,v,S,T);Q(e,o,oe,re,me,ue,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function fe(){ee.clearRect(0,0,L,F),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),H(ee),a.thermometerType==="liquid"?w(ee):a.thermometerType==="resistance"?G(ee):R(ee),ee.restore(),a.thermometerType==="liquid"?E(ne):a.thermometerType==="resistance"?ce(ne):se(ne)}function ge(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
    ...
    `}function xe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const o=n.querySelector("#tl-bath-state");a.bathTemp<=0?o.textContent="Melting Ice Bath":a.bathTemp>=100?o.textContent="Boiling Water/Steam":a.bathTemp===150?o.textContent="Hot Cooking Oil":o.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const s=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?s.style.display="block":s.style.display="none",a.thermometerType==="liquid"?n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm":a.thermometerType==="resistance"?n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω":n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let qe=null;function Re(e){a.lastTimestamp||(a.lastTimestamp=e);const o=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const s=Math.min(o,.1),p=A(),v=s/p*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=v,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const _=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/_-1/298.15)),M(),fe(),xe(p),qe=requestAnimationFrame(Re)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),o=parseFloat(n.querySelector("#tl-input-faulty-cu").value),s=Number.isFinite(e)?e:-1.5,p=Number.isFinite(o)?o:105,v=p-s;return{cf:s,cu:p,interval:v}}function He(e){const o=Math.round(e*100)/100;return o>=0?o.toFixed(1):`(${o.toFixed(1)})`}function he(){const{cf:e,cu:o,interval:s}=ze(),p=n.querySelector("#tl-val-faulty-interval"),v=n.querySelector("#tl-faulty-error-a"),_=n.querySelector("#tl-faulty-error-b"),b=Math.abs(s)<.01;p.textContent=s.toFixed(1)+" °C";const x=n.querySelector("#tl-svg-formula-faulty-a"),S=n.querySelector("#tl-svg-formula-faulty-b");if(b){v.hidden=!1,v.textContent="C_u must differ from C_f (interval cannot be zero).",_.hidden=!1,_.textContent=v.textContent,x&&(x.innerHTML=""),S&&(S.innerHTML="");return}v.hidden=!0,_.hidden=!0;const k=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(k-e)/s*100,N=T/100*s+e;x&&(x.innerHTML=`
      ...
      `)}function Te(){const e=parseFloat(n.querySelector("#tl-input-t-to-l").value)||0,o=(a.liquidL100-a.liquidL0)/100,s=a.liquidL0+o*e,p=n.querySelector("#tl-svg-formula-t-to-l");p&&(p.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
      ...
      `)}function Oe(){const e=parseFloat(n.querySelector("#tl-input-t-to-r").value)||0,o=(a.resistanceR100-a.resistanceR0)/100,s=a.resistanceR0+o*e,p=n.querySelector("#tl-svg-formula-t-to-r");p&&(p.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
      ...
      </section>`}async function C(){const g=Ee();for(const h of Me){const u=t.querySelector(`[data-note-card="${h.id}"]`);if(!u)continue;const d=u.querySelector("[data-note-body]"),m=g==="zhHant"?h.fileZh:h.fileEn,A=await Ne(m),M=`./notes/${m}`;A?d.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${h.id}`)}" src="${M}"></iframe>
      ...
      </section>`}function I(){const g=t.querySelector("[data-tool-list]"),h=t.querySelector("[data-tool-stage]");!g||!h||(g.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{c=u.getAttribute("data-tool"),g.querySelectorAll("button").forEach(d=>d.classList.toggle("active",d.getAttribute("data-tool")===c)),j(h)})}),j(h))}function j(g){g.innerHTML="",F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup();const h=At[c];h&&(F=h(l),g.appendChild(F))}function ae(){return`
      <section class="panel">
        <h2>${l("flashcards.title")}</h2>
        <p class="lead">${l("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}async function ee(){const g=Ee();for(const h of Me){const u=t.querySelector(`[data-summary-card="${h.id}"]`);if(!u)continue;const d=u.querySelector("[data-summary-body]"),m=g==="zhHant"?h.fileZh:h.fileEn,A=await Ne(m),M=`./notes/${m}`;A?d.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${h.id}`)}" src="${M}"></iframe>
  ...
  `,t}function Gt(t,r){const c=[...Ve.en,...Ve.zhHant],i=()=>{if(!t.parentElement)return;const f=document.createElement("div");f.className="splash-danmaku-item",f.textContent=c[Math.floor(Math.random()*c.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,L=Math.random()*12+10;f.style.top=`${n}%`,f.style.fontSize=`${a}rem`,f.style.animationDuration=`${L}s`,r.appendChild(f),f.addEventListener("animationend",()=>f.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let f=0;f<4;f+=1)window.setTimeout(i,f*1e3)}function Bt(t){const r=t.querySelector("#splashLogoWrap"),c=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{c==null||c.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),c&&Gt(t,c)},1600)}function Ue(){st()}function jt(){let t=!1;try{t=sessionStorage.getItem(Ye)==="1"}catch{}if(t){Ue();return}const r=Ot();document.body.insertBefore(r,document.body.firstChild),Bt(r);const c=r.querySelector("#splashStart"),i=()=>{r.remove(),Ue()};c.addEventListener("click",()=>{try{sessionStorage.setItem(Ye,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",st);window.addEventListener("s3phy:strand",t=>{ot(t.detail??null)});jt();
