...
`;function Ct(){if(document.getElementById(Ke))return;const t=document.createElement("style");t.id=Ke,t.textContent=Tt,document.head.appendChild(t)}function Lt(t){Ct();const i=document.createElement("div");i.className="rml",i.innerHTML=`
  ...
  `;const s=i.querySelector(".rml-canvas"),n=s.getContext("2d"),u=i.querySelector("[data-rml-rot]"),r=i.querySelector("[data-rml-inc]"),a=i.querySelector('[data-rml-disp="rot"]'),w=i.querySelector('[data-rml-disp="inc"]'),E=i.querySelector('[data-rml-val="i"]'),J=i.querySelector('[data-rml-val="r"]'),W=i.querySelector('[data-rml-val="shift"]'),z=350,O=380,X=300,R="#22d3ee",H="bold 17px system-ui, sans-serif";let A=0,B=-140,te=!0,Y=!0,ee=!0,ae=!0;function N(P){return P*Math.PI/180}function V(P,l,o,f,x,M=2,F=!1){n.beginPath(),n.lineWidth=M,n.strokeStyle=x,n.setLineDash(F?[6,6]:[]);const b=P+Math.cos(N(o))*f,g=l+Math.sin(N(o))*f;return n.moveTo(P,l),n.lineTo(b,g),n.stroke(),n.setLineDash([]),{x:b,y:g}}function Z(P,l,o,f,x,M=14){const F=o-P,b=f-l,g=Math.hypot(F,b);if(g<1e-6)return;const _=F/g,L=b/g,G=o-_*M,$=f-L*M,de=.45*M;n.beginPath(),n.fillStyle=x,n.moveTo(o,f),n.lineTo(G-L*de,$+_*de),n.lineTo(G+L*de,$-_*de),n.closePath(),n.fill()}function K(P,l,o,f,x,M=25){n.beginPath(),n.strokeStyle=f,n.lineWidth=2;const F=Math.min(P,l),b=Math.max(P,l);if(n.arc(z,O,o,N(F),N(b),!1),n.stroke(),x){const g=(F+b)/2,_=z+Math.cos(N(g))*(o+M),L=O+Math.sin(N(g))*(o+M);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="center",n.textBaseline="middle",n.fillStyle=f,n.fillText(x,_,L),n.restore()}}function ne(P,l,o,f,x){n.clearRect(0,0,s.width,s.height),n.beginPath(),n.setLineDash([10,6]),n.strokeStyle="rgba(255, 204, 0, 0.45)",n.lineWidth=3,n.lineCap="round",n.moveTo(z-200,O),n.lineTo(z+200,O),n.stroke(),n.setLineDash([]),n.lineCap="butt";const M=z+Math.cos(N(P))*X,F=O+Math.sin(N(P))*X;n.beginPath(),n.lineWidth=3,n.strokeStyle="#fff",n.moveTo(M,F),n.lineTo(z,O),n.stroke();const b=(M+z)*.5,g=(F+O)*.5,_=Math.hypot(z-M,O-F)||1,L=(z-M)/_,G=(O-F)/_;if(Z(b-L*28,g-G*28,b,g,"#fff",16),n.save(),n.font=H,n.textAlign="center",n.textBaseline="bottom",n.fillStyle="#fff",n.fillText(t("tools.rotatingMirror.canvas.incident"),M,F-12),n.restore(),te){const $=V(z,O,-90,X-60,"#00e676",1,!0);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="left",n.textBaseline="bottom",n.fillStyle="#00e676",n.fillText(t("tools.rotatingMirror.canvas.n"),$.x+6,$.y-4),n.restore()}if(Y){const $=V(z,O,f,X,"#00e676",2,!1);Z(z,O,$.x,$.y,"#00e676",16),n.save(),n.font=H,n.textAlign="center",n.textBaseline="bottom",n.fillStyle="#00e676",n.fillText(t("tools.rotatingMirror.canvas.originalReflected"),$.x,$.y-14),n.restore()}n.save(),n.translate(z,O),n.rotate(N(A)),n.beginPath(),n.lineWidth=6,n.strokeStyle="#ffcc00",n.lineCap="round",n.moveTo(-200,0),n.lineTo(200,0),n.stroke(),n.beginPath(),n.lineWidth=1,n.strokeStyle="#666";for(let $=-190;$<200;$+=15)n.moveTo($,0),n.lineTo($-5,8);if(n.stroke(),n.restore(),ee){const $=V(z,O,l,X-40,R,2,!0);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="left",n.textBaseline="bottom",n.fillStyle=R,n.fillText(t("tools.rotatingMirror.canvas.nPrime"),$.x+6,$.y-4),n.restore()}if(ae){const $=V(z,O,o,X,R,4);Z(z,O,$.x,$.y,R,16),Math.abs(A)>.5&&(n.save(),n.font=H,n.textAlign="center",n.textBaseline="bottom",n.fillStyle=R,n.fillText(t("tools.rotatingMirror.canvas.newReflected"),$.x,$.y-14),n.restore())}if(ee&&K(P,l,100,"#ffcc00",`i=${x.toFixed(0)}°`,25),ee&&ae&&K(l,o,100,R,`r=${x.toFixed(0)}°`,25),te&&ee&&Math.abs(A)>.5&&K(-90,l,50,"#ffcc00",`θ=${Math.abs(A)}°`,20),Y&&ae&&Math.abs(A)>.5){const $=o-f;K(f,o,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${$.toFixed(0)}°`,40)}}function U(){A=parseFloat(u.value),B=parseFloat(r.value);const P=A>0?"+":"";a.textContent=`${P}${A}°`,w.textContent=`${B}°`;const l=-90,o=Math.abs(B-l),f=l+o,x=-90+A,M=Math.abs(B-x),F=x+M,b=F-f;E.textContent=`${M.toFixed(1)}°`,J.textContent=`${M.toFixed(1)}°`;const g=b>0?"+":"";W.textContent=`${g}${b.toFixed(1)}°`,ne(B,x,F,f,M)}return i.querySelectorAll("[data-rml-toggle]").forEach(P=>{P.addEventListener("click",()=>{const l=P.getAttribute("data-rml-toggle");l==="orig-norm"&&(te=!te),l==="orig-ray"&&(Y=!Y),l==="new-norm"&&(ee=!ee),l==="new-ray"&&(ae=!ae),P.classList.toggle("active"),U()})}),i.querySelector("[data-rml-reset]").addEventListener("click",()=>{u.value="0",U()}),u.addEventListener("input",U),r.addEventListener("input",U),U(),i}function Mt(t){const i=document.createElement("div");i.className="tool-tir-escape";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:`${n}/`;return s.src=`${u}tir-escape/index.html?embed=1`,s.title=t("tools.refractionTir.title"),s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin",i.appendChild(s),i}function Rt(t,i={}){const s=i.defaultKind==="concave"?"concave":"convex",n="tools.lens.title",u=document.createElement("div");u.className="tool-lens-simulator";const r=document.createElement("iframe"),a="./",w=a.endsWith("/")?a:`${a}/`;return r.src=`${w}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(s)}`,r.title=t(n),r.setAttribute("loading","lazy"),r.referrerPolicy="strict-origin-when-cross-origin",u.appendChild(r),u}function _t(t){const i=document.createElement("div");i.className="tool-em-spectrum";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:`${n}/`;function r(){return`${u}em-spectrum/index.html?lang=${encodeURIComponent(ce())}`}s.src=r(),s.title=t("tools.em.title"),s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=s.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{s.src=r()}};return window.addEventListener("s3phy:lang",a),i._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(s),i}function Ft(t){const i=document.createElement("div");i.className="rgb-mixer",i.innerHTML=`
  ...
  `;const s=i.querySelector("[data-r]"),n=i.querySelector("[data-g]"),u=i.querySelector("[data-b]"),r=i.querySelector(".rgb-mixer-canvas"),a=i.querySelector(".rgb-mixer-stage"),w=r.getContext("2d");function E(R){return R.toString(16).padStart(2,"0")}function J(R,H,A){const B=r.width/(window.devicePixelRatio||1),te=r.height/(window.devicePixelRatio||1),Y=B/2,ee=te/2,ae=Math.min(B,te)*.34,N=ae*.5,V=Math.sqrt(3)/2;w.clearRect(0,0,B,te),w.fillStyle="#000",w.fillRect(0,0,B,te);const Z=[{x:Y,y:ee-N,rgb:[255,0,0],val:R},{x:Y-N*V,y:ee+N*.5,rgb:[0,255,0],val:H},{x:Y+N*V,y:ee+N*.5,rgb:[0,0,255],val:A}];w.globalCompositeOperation="lighter",Z.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[U,P,l]=K.rgb,o=w.createRadialGradient(K.x,K.y,0,K.x,K.y,ae);o.addColorStop(0,`rgba(${U},${P},${l},${ne})`),o.addColorStop(.65,`rgba(${U},${P},${l},${ne})`),o.addColorStop(.85,`rgba(${U},${P},${l},${ne*.5})`),o.addColorStop(1,`rgba(${U},${P},${l},0)`),w.fillStyle=o,w.beginPath(),w.arc(K.x,K.y,ae,0,Math.PI*2),w.fill()}),w.globalCompositeOperation="source-over"}function W(){const R=a.getBoundingClientRect(),H=Math.max(200,Math.min(R.width-8,R.height-8,720)),A=window.devicePixelRatio||1;r.width=H*A,r.height=H*A,r.style.width=`${H}px`,r.style.height=`${H}px`,w.setTransform(A,0,0,A,0,0),J(+s.value,+n.value,+u.value)}function z(){const R=+s.value,H=+n.value,A=+u.value,B=`rgb(${R}, ${H}, ${A})`,te=`#${E(R)}${E(H)}${E(A)}`;i.querySelector("[data-r-val]").textContent=R,i.querySelector("[data-g-val]").textContent=H,i.querySelector("[data-b-val]").textContent=A,i.querySelector("[data-r-bar]").style.width=`${R/255*100}%`,i.querySelector("[data-g-bar]").style.width=`${H/255*100}%`,i.querySelector("[data-b-bar]").style.width=`${A/255*100}%`,s.style.setProperty("--fill",`${R/255*100}%`),n.style.setProperty("--fill",`${H/255*100}%`),u.style.setProperty("--fill",`${A/255*100}%`);const Y=i.querySelector("[data-swatch]");Y.style.backgroundColor=B,Y.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${B}`),i.querySelector("[data-rgb-text]").textContent=B,i.querySelector("[data-hex-text]").textContent=te,J(R,H,A)}function O(R,H,A){s.value=R,n.value=H,u.value=A,z()}return[s,n,u].forEach(R=>R.addEventListener("input",z)),i.querySelectorAll(".rgb-presets button").forEach(R=>{R.addEventListener("click",()=>{O(+R.dataset.r,+R.dataset.g,+R.dataset.b)})}),new ResizeObserver(()=>W()).observe(a),requestAnimationFrame(()=>{W(),z()}),i}const Ht=["topics","notes","tools","worksheets","flashcards","summary"],zt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function ht(t,{subtitleKey:i,activeSection:s,onSection:n,onLang:u}){t.innerHTML=`
    <header class="site-header">
      <div class="site-header__brand">
        ...
        <div class="brand-text-block">
          <h1 class="site-title">${c("app.title")}</h1>
          <p class="site-subtitle" data-hub-subtitle>${c(i)}</p>
        </div>
      </div>
      <div class="site-header__actions">
  ...
  `;const r=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),w=t.querySelector("[data-lang]"),E=t.querySelector("[data-strand-back]");let J=s;function W(R){J=R,a.innerHTML=Ht.map(H=>`<button type="button" class="${R===H?"active":""}" data-sec="${H}">${c(zt[H])}</button>`).join(""),a.querySelectorAll("button").forEach(H=>{H.addEventListener("click",()=>n(H.getAttribute("data-sec")))})}function z(){w.innerHTML=`
    ...
    <section class="panel panel--worksheets">
    ...
    </section>`}function mt(t,i,s,n,u={}){var f,x,M,F;const r={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),w=t.querySelector("[data-ws-preview-area]"),E=t.querySelector("[data-ws-out]"),J=t.querySelector("[data-ws-body]"),W=t.querySelector("[data-ws-paper]"),z=t.querySelector("[data-ws-tabs]"),O=t.querySelector("[data-ws-practice-actions]"),X=t.querySelector("[data-ws-score]"),R=t.querySelector("[data-ws-score-val]"),H=t.querySelector("[data-ws-summary]"),A=t.querySelector("[data-ws-date-row]"),B=t.querySelector("[data-ws-date-print]"),te=t.querySelector("[data-ws-date-today]"),Y=t.querySelector("[data-ws-date-label]");if(!a||!J)return;function ee(){return n()}function ae(){r.userAnswers={},r.wrongAttempts={},r.resolved={},X.hidden=!0,H.hidden=!0}function N(){return r.items.length>0&&r.items.every((b,g)=>r.resolved[g])}function V(){let b=0;r.items.forEach((_,L)=>{if(!r.resolved[L])return;const G=_[ee()]||_.en;r.userAnswers[L]===G.a&&(b+=1)}),Object.keys(r.resolved).length>0&&(R.textContent=`${b}/${r.items.length}`,X.hidden=!1)}function Z(b){r.tab=b,z==null||z.querySelectorAll("[data-ws-tab]").forEach(g=>{g.classList.toggle("active",g.getAttribute("data-ws-tab")===b)}),O&&(O.hidden=b!=="practice"),A&&(A.hidden=b!=="practice"),B&&(B.hidden=!r.dateStr,B.textContent=r.dateStr?`${s("worksheets.date")}: ${r.dateStr}`:""),W==null||W.classList.toggle("practice-mode",b==="practice"),ne()}function K(b,g,_){const L=b[ee()]||b.en,G=Pe,$=g+1,de=b.section?`<span class="q-section">${xe(b.section)}</span>`:"";if(_==="answer"){const me=L.choices.map((ye,Te)=>`<li class="${Te===L.a?"choice-correct":""}"><strong>${G[Te]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${$} ${de}</h4>
        <p>${xe(L.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${s("worksheets.answer")}:</strong> ${G[L.a]}</p>
        <p class="q-exp"><em>${xe(L.exp)}</em></p>
      </div>`}const se=r.userAnswers[g],he=r.wrongAttempts[g]||0,ge=r.resolved[g],Se=ge&&se===L.a,ke=ge&&se!==L.a;let qe="";he===1&&!ge?qe=`<p class="q-hint"><strong>${s("worksheets.hint")}:</strong> ${xe(L.hint||L.exp)}</p>`:ke&&(qe=`<p class="q-exp"><strong>${s("worksheets.answer")}:</strong> ${G[L.a]}</p>
        <p class="q-exp q-summary"><em>${xe(L.exp)}</em></p>`);const Fe=Se?"correct":ke?"incorrect":"",He=L.choices.map((me,ye)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${g}" value="${ye}" data-ws-q="${g}" data-ws-choice="${ye}"${se===ye?" checked":""}${ge?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${G[ye]}.</strong> ${xe(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${Fe}" data-ws-row="${g}">
      ...
      ${qe}
    </div>`}function ne(){r.items.length&&(J.innerHTML=r.items.map((b,g)=>K(b,g,r.tab)).join(""),U())}function U(){r.tab==="practice"&&J.querySelectorAll("[data-ws-choice]").forEach(b=>{b.addEventListener("change",()=>{const g=Number(b.getAttribute("data-ws-q"));if(r.resolved[g])return;const _=Number(b.getAttribute("data-ws-choice")),L=r.items[g][ee()]||r.items[g].en;r.userAnswers[g]=_,_===L.a?r.resolved[g]=!0:(r.wrongAttempts[g]=(r.wrongAttempts[g]||0)+1,r.wrongAttempts[g]>=2&&(r.resolved[g]=!0)),V(),N()&&P(),ne()})})}function P(){const b=r.items.length;let g=0,_=0;const L={};r.items.forEach((se,he)=>{const ge=se[ee()]||se.en;if(r.userAnswers[he]===ge.a)g+=1,(r.wrongAttempts[he]||0)===0&&(_+=1);else if(r.resolved[he]){const ke=se.section||se.topic;L[ke]=(L[ke]||0)+1}});const G=b?Math.round(g/b*100):0;let $=s("worksheets.revisionFair");G>=90?$=s("worksheets.revisionExcellent"):G>=70?$=s("worksheets.revisionGood"):G<50&&($=s("worksheets.revisionLow"));const de=Object.entries(L).sort((se,he)=>he[1]-se[1]).map(([se,he])=>`<li>${xe(se)} (${he})</li>`).join("");H.innerHTML=`
      <h4>${s("worksheets.sessionSummary")}</h4>
      <p>${s("worksheets.score")}: <strong>${g}/${b}</strong> (${G}%)</p>
      <p>${s("worksheets.firstTry")}: <strong>${_}/${b}</strong></p>
      <p>${s("worksheets.revisionSuggestions")}: ${$}</p>
      ${de?`<p>${s("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,H.hidden=!1}function l(b){const g=ee(),_=r.items.map((L,G)=>{const $=L[g]||L.en,de=$.choices.map((he,ge)=>`${Pe[ge]}. ${he}`).join("<br/>"),se=b?`<p><b>${s("worksheets.answer")}:</b> ${Pe[$.a]}<br/><i>${$.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${G+1}.</b> ${$.q}<br/>${de}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${_}</body></html>`}function o(b){const g=l(b),_=new Blob(["\uFEFF",g],{type:"application/msword"}),L=document.createElement("a");L.href=URL.createObjectURL(_),L.download=b?"worksheet-answers.doc":"worksheet.doc",L.click(),URL.revokeObjectURL(L.href)}a.addEventListener("click",()=>{const b=Number(t.querySelector("[data-ws-count]").value),g=[...t.querySelectorAll("[data-ws-topic]")].filter(G=>G.checked).map(G=>G.getAttribute("data-ws-topic")),_=$t(i,g,u.topicFilter),L=Xe(_).slice(0,Math.min(b,_.length||1));r.items=L.length?L:Xe(i).slice(0,Math.min(b,i.length)),ae(),r.tab="practice",r.dateStr="",w.hidden=!1,E.hidden=!0,z==null||z.querySelectorAll("[data-ws-tab]").forEach(G=>{G.classList.toggle("active",G.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),A&&(A.hidden=!1),B&&(B.hidden=!0),Y.textContent="",W==null||W.classList.add("practice-mode"),ne()}),z==null||z.addEventListener("click",b=>{const g=b.target.closest("[data-ws-tab]");!g||!r.items.length||Z(g.getAttribute("data-ws-tab"))}),te==null||te.addEventListener("click",()=>{r.dateStr?(r.dateStr="",Y.textContent=""):(r.dateStr=Et(),Y.textContent=`${s("worksheets.date")}: ${r.dateStr}`),B&&(B.hidden=!r.dateStr,B.textContent=r.dateStr?`${s("worksheets.date")}: ${r.dateStr}`:"")}),(f=t.querySelector("[data-ws-word-p]"))==null||f.addEventListener("click",()=>o(!1)),(x=t.querySelector("[data-ws-word-a]"))==null||x.addEventListener("click",()=>o(!0)),(M=t.querySelector("[data-ws-print-p]"))==null||M.addEventListener("click",()=>{Z("practice"),W==null||W.classList.add("ws-print-blank");const b=()=>W==null?void 0:W.classList.remove("ws-print-blank");window.addEventListener("afterprint",b,{once:!0}),window.print()}),(F=t.querySelector("[data-ws-print-a]"))==null||F.addEventListener("click",()=>{Z("answer"),window.print()})}const At=["rotatingMirror","refractionTir","lens","rgbMixer","em"],It={rotatingMirror:t=>Lt(t),refractionTir:t=>Mt(t),lens:(t,i)=>Rt(t,{defaultKind:i}),rgbMixer:t=>Ft(t),em:t=>_t(t)};function Wt(t){return c({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ee(){return ce()==="zh-Hant"?"zhHant":"en"}async function Ge(t,i){const s=`./${t}/${i}`;try{return(await fetch(s,{method:"HEAD"})).ok}catch{return!1}}async function Pt(t){return Ge("notes",t)}function Dt(t){let i="topics",s="rotatingMirror",n="convex",u=0,r="all",a=!1,w=null,E={main:null};function J(){E.main&&(i==="topics"?E.main.innerHTML=z():i==="notes"?E.main.innerHTML=X():i==="tools"?E.main.innerHTML=H():i==="worksheets"?E.main.innerHTML=pt(c):i==="flashcards"?E.main.innerHTML=te():i==="summary"&&(E.main.innerHTML=K()),i==="notes"&&R(),i==="tools"&&A(),i==="worksheets"&&mt(t,ut,c,Ee),i==="flashcards"&&Z(),i==="summary"&&ne())}function W(){w==null||w.destroy(),w=ht(t,{subtitleKey:"strand.optics.subtitle",activeSection:i,onSection:l=>{i=l,w.updateSection(i),J()},onLang:()=>W()}),E.main=w.main,w.updateSection(i),J()}function z(){const l=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${c("topics.title")}</h2>
        <p class="lead">${c("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${l.map(([o,f])=>{const x=o==="convex"||o==="concave"?"lens":o==="refraction"||o==="tir"?"refractionTir":o==="em"?"em":o,M=o==="convex"?"convex":o==="concave"?"concave":"";return`
            <div class="card">
              <h3>${c(f)}</h3>
              <button class="btn primary" type="button" data-go-tool="${x}"${M?` data-lens-kind="${M}"`:""}>${c("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      ...
      <section class="panel">
        ...
        <div class="grid cols-2" data-notes-grid>
          ${l.map(o=>{const f=c(`notes.card.${o.key}`);return`
            <div class="card" data-note-card="${o.key}">
              <h3>${f}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function R(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],o=Ee();for(const f of l){const x=t.querySelector(`[data-note-card="${f.key}"]`);if(!x)continue;const M=x.querySelector("[data-note-body]"),F=o==="zhHant"?f.fileZh:f.fileEn,b=await Pt(F),g=`./notes/${F}`;b?M.innerHTML=`
          <iframe class="notes-grid" title="${c(`notes.card.${f.key}`)}" src="${g}"></iframe>
          <p style="margin-top:8px"><a href="${g}" target="_blank" rel="noopener">${c("notes.openPdf")}</a></p>`:M.innerHTML=`<p class="lead">${c("notes.missing")}</p>
      ...
      <section class="panel">
        ...
        <div class="control" style="margin-bottom:10px">
          ...
          <select data-flash-deck>
            <option value="all">${c("flashcards.all")}</option>
            <option value="reflection">${c("topic.reflection")}</option>
            <option value="refractionTir">${c("flashcards.deck.refractionTir")}</option>
            <option value="convex">${c("topic.convex")}</option>
            <option value="concave">${c("topic.concave")}</option>
            <option value="em">${c("topic.em")}</option>
          </select>
        </div>
        <div class="flashcard-box">
          <div class="flashcard-surface" data-flip-card>
            <div class="label" data-flash-label>${c("flashcards.question")}</div>
...
`;function Gt(){if(document.getElementById(at))return;const t=document.createElement("style");t.id=at,t.textContent=Ot,document.head.appendChild(t)}function De(t,i={}){Gt();const s=i.type||"liquid";let n=t("tools.thermometerLab.title"),u=t("tools.thermometerLab.subtitle");i.type==="liquid"?(n=t("tools.thermometerLab.liquid.title"),u=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="resistance"?(n=t("tools.thermometerLab.resistance.title"),u=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="thermistor"&&(n=t("tools.thermometerLab.thermistor.title"),u=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const r=document.createElement("div");r.className="tl-wrap",r.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:s,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},w=460,E=340,J=80,W=800,z=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:W-e.left-e.right,gh:z-e.top-e.bottom,tickFont:`bold ${Math.round(W*.024)}px Arial`,axisFont:`bold ${Math.round(W*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:z-e.bottom+32}}function X(){let d=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(d=150),p>145&&(d=200);const m=d<=100?20:25;return{minT:0,maxT:d,tickStep:m}}function R(e,d,p,m,h){return m+(e-d)/(p-d)*h}function H(e,d,p,m,h){return m+h-(e-d)/(p-d)*h}function A(e,d,p,m,h,S){const{gx:v,gy:y,gw:q,gh:T,tickFont:C,axisFont:I,yLabelX:Q,xLabelY:k}=d;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of S){const j=H(D.value,D.min,D.max,y,T);e.beginPath(),e.moveTo(v,j),e.lineTo(v+q,j),e.stroke()}for(let D=p;D<=m+.01;D+=h){const j=R(D,p,m,v,q);e.beginPath(),e.moveTo(j,y),e.lineTo(j,y+T),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(v,y),e.lineTo(v,y+T),e.lineTo(v+q,y+T),e.stroke(),e.fillStyle="#e4e4e7",e.font=C,e.textAlign="right",e.textBaseline="middle";for(const D of S){const j=H(D.value,D.min,D.max,y,T);e.fillText(D.label,v-15,j)}e.textAlign="center",e.textBaseline="top";for(let D=p;D<=m+.01;D+=h){const j=R(D,p,m,v,q);e.fillText(`${Math.round(D)}`,j,y+T+10)}return{gx:v,gy:y,gw:q,gh:T,axisFont:I,yLabelX:Q,xLabelY:k}}function B(e,d){const p=d-e,m=p<=8?1:p<=14?2:5,h=[],S=Math.ceil(e/m)*m;for(let v=S;v<=d+.001;v+=m)h.push({value:v,label:v%1===0?`${v.toFixed(0)}`:`${v.toFixed(1)}`,min:e,max:d});return h}function te(){const{maxT:e}=X(),d=Y(0),p=Y(e),m=p-d,h=Math.max(1,m*.1),S=Math.max(0,Math.round((d-h)*10)/10),v=Math.round((p+h)*10)/10;return{minL:S,maxL:v}}function Y(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function ee(){const{maxT:e}=X(),d=ae(0),p=ae(e),m=p-d,h=Math.max(.2,m*.1),S=Math.max(0,d-h),v=p+h,y=m<=2?.5:m<=4?1:2,q=[],T=Math.ceil(S/y)*y;for(let C=T;C<=v+.001;C+=y)q.push({value:C,label:C.toFixed(1),min:S,max:v});return{minR:S,maxR:v,ticks:q}}function ae(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function N(e){const{maxT:d}=e;let p=a.thermistorR25;for(let v=0;v<=d;v+=5){const y=v+273.15,q=a.thermistorR25*Math.exp(a.thermistorBeta*(1/y-1/298.15));p=Math.max(p,q)}p=Math.ceil(p*1.08*10)/10;const m=0,h=p<=12?2:4,S=[];for(let v=0;v<=p+.001;v+=h)S.push({value:v,label:v.toFixed(0),min:m,max:p});return{minR:m,maxR:p,ticks:S}}const V=r.querySelector("#tl-thermometerCanvas"),Z=V.getContext("2d"),K=r.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),U=window.devicePixelRatio||1;V.width=w*U,V.height=E*U,Z.scale(U,U),K.width=W*U,K.height=z*U,ne.scale(U,U);function P(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const l=200,o=11;function f(){const e=Math.pow(a.bulbVolume/l,.3333333333333333);return o*e}function x(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,d=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,m=1.35-a.capillaryBore*.45;return Math.max(.1,d*p*m*e*.15)}function M(e){a.bathTemp<=8&&a.iceCubes.forEach(d=>{d.x+=d.speedX,d.y+=d.speedY,(d.x<65||d.x>175)&&(d.speedX*=-1),(d.y<195||d.y>210)&&(d.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(d=>{d.y-=d.speedY*(1+a.bathTemp/100),d.y<185&&(d.y=265,d.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(d=>{d.y-=d.speedY*(1+(a.bathTemp-80)/40),d.phase+=d.wobbleSpeed,d.x+=Math.sin(d.phase)*.3,d.y<185&&(d.y=260+Math.random()*10,d.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(d=>{d.x+=d.vx,d.y+=d.vy,d.alpha-=.005,(d.alpha<=0||d.y<130)&&(d.x=60+Math.random()*120,d.y=175+Math.random()*5,d.alpha=.2+Math.random()*.4)})}function F(e){let v=59,y=130,q=246;if(a.bathTemp<25){const k=a.bathTemp/25;v=Math.round(180-k*121),y=Math.round(210-k*80),q=Math.round(250-k*4)}else{const k=Math.min(1,(a.bathTemp-25)/125);v=Math.round(59+k*180),y=Math.round(130-k*100),q=Math.round(246-k*190)}if(a.bathTemp>40){const k=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${k*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let j=-25;j<=25;j+=6){const re=k*(12+Math.sin(j*.4+D)*5);e.lineTo(55+130/2+j,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const T=e.createLinearGradient(55,190,55,280);T.addColorStop(0,`rgba(${v}, ${y}, ${q}, 0.25)`),T.addColorStop(1,`rgba(${v}, ${y}, ${q}, 0.55)`),e.fillStyle=T,e.beginPath(),e.moveTo(55,190);const C=a.bathTemp>=80?2:.5,I=a.bathTemp>=80?.09:.03,Q=Date.now()*I;for(let k=55;k<=185;k+=5){const D=190+Math.sin(k*.15+Q)*C;e.lineTo(k,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(k=>{e.beginPath(),e.moveTo(k.x,k.y),e.quadraticCurveTo(k.x+Math.sin(k.y*.06)*5,k.y-k.length/2,k.x,k.y-k.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(k=>{e.save(),e.translate(k.x,k.y),e.rotate(k.angle),e.beginPath(),e.roundRect(-k.size/2,-k.size/2,k.size,k.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(k=>{e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(k=>{e.fillStyle=`rgba(255, 255, 255, ${k.alpha})`,e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function b(e,d,p,m,h,S,v="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(d,p),e.lineTo(m,h),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(d,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const q=e.measureText(S).width+10,T=16,C=v==="left"?m:m-q,I=h-T/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(C,I,q,T,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(S,C+q/2,I+T/2+.5)}function g(e){const m=f(),h=250+Math.max(0,m-o)*.35,S=h-m-1,v=10+a.wallThickness*8,y=120-v/2,q=120+v/2,T=e.createLinearGradient(y,20,q,20);T.addColorStop(0,"rgba(209, 213, 219, 0.85)"),T.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),T.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),T.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),T.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=T,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(y,S),e.lineTo(y,25),e.arcTo(y,20,y+5,20,5),e.arcTo(q,20,q,25,5),e.lineTo(q,S),e.closePath(),e.fill(),e.stroke();const C=e.createRadialGradient(120-m*.2,h-m*.2,m*.1,120,h,m);C.addColorStop(0,"rgba(255, 255, 255, 0.8)"),C.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=C,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,h,m+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const I=Math.min(v*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-I/2,28,I,S-20-8);const Q=a.liquidType==="mercury",k=Q?"#a1a1aa":"#ef4444",D=Q?"#f4f4f5":"#fee2e2",j=210,re=220,be=(j-40)/re,fe=j-Math.min(re,a.thermometerTemp)*be;e.fillStyle=k,e.fillRect(120-I/2,fe,I,S-fe),e.beginPath(),e.ellipse(120,fe,I/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-I/6,fe,I/3,S-fe);const oe=m*.9,ie=e.createRadialGradient(120-oe*.2,h-oe*.2,oe*.1,120,h,oe);Q?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,h,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const pe=j-le*be;e.beginPath(),e.moveTo(y,pe),e.lineTo(y+4,pe),e.stroke(),e.fillText(`${le}°C`,y-22,pe+2.5)}a.showLabels&&(b(e,y+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),b(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),b(e,120-I/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),b(e,120,h,230,h+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function _(e){const v=e.createLinearGradient(115,20,125,20);v.addColorStop(0,"#71717a"),v.addColorStop(.3,"#f4f4f5"),v.addColorStop(.7,"#d4d4d8"),v.addColorStop(1,"#3f3f46"),e.fillStyle=v,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let y=205;e.moveTo(118,y);for(let Q=0;Q<8;Q++)y+=4,e.lineTo(122,y),y+=4,e.lineTo(118,y);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const q=245,T=40,C=135,I=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(q,T,C,I,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(q+10,T+12,C-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",q+C-16,T+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",q+14,T+21),a.showLabels&&(b(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),b(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function L(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const h=20,S=225,v=12,y=120-v/2,q=e.createLinearGradient(y,h,y+v,h);q.addColorStop(0,"rgba(229, 231, 235, 0.4)"),q.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),q.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),q.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=q,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(y,h,v,S-h,[0,0,3,3]),e.fill(),e.stroke();const T=7,C=e.createRadialGradient(120-T*.2,245-T*.2,T*.1,120,245,T);C.addColorStop(0,"#6b7280"),C.addColorStop(.7,"#1f2937"),C.addColorStop(1,"#09090b"),e.fillStyle=C,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,T,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const I=245,Q=40,k=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(I,Q,k,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(I+10,Q+12,k-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",I+k-16,Q+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",I+14,Q+21),a.showLabels&&(b(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),b(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function G(e,d,p,m,h,S,v,y,q){const{gx:T,gy:C,gw:I,gh:Q}=d;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,m),e.lineTo(p,C+Q),e.stroke(),e.beginPath(),e.moveTo(p,m),e.lineTo(T,m),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const k=`${h.toFixed(1)}${v}`,D=e.measureText(k).width+10;e.fillStyle=q,e.beginPath(),e.roundRect(p-D/2,C+Q+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(k,p,C+Q+4),e.textAlign="right",e.textBaseline="middle";const j=`${S.toFixed(2)} ${y}`,re=e.measureText(j).width+10;e.fillStyle=q,e.beginPath(),e.roundRect(T-re-2,m-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(j,T-7,m)}function $(e){const d=O(),{minL:p,maxL:m}=te(),{minT:h,maxT:S,tickStep:v}=X(),y=B(p,m),q=A(e,d,h,S,v,y),{gx:T,gy:C,gw:I,gh:Q,axisFont:k,yLabelX:D,xLabelY:j,dotR:re}={...d,...q};e.save(),e.translate(D,C+Q/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=k,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",T+I/2,j);const we=S,be=R(0,h,S,T,I),fe=H(Y(0),p,m,C,Q),oe=R(we,h,S,T,I),ie=H(Y(we),p,m,C,Q);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,pe=a.currentLength;if(le>=h&&le<=S){const ve=R(le,h,S,T,I),Ce=H(pe,p,m,C,Q);G(e,d,ve,Ce,le,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const d=O(),{minR:p,maxR:m,ticks:h}=ee(),S=X(),v=A(e,d,S.minT,S.maxT,S.tickStep,h),{gx:y,gy:q,gw:T,gh:C,axisFont:I,yLabelX:Q,xLabelY:k,dotR:D}={...d,...v};e.save(),e.translate(Q,q+C/2),e.rotate(-Math.PI/2),e.font=I,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=I,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+T/2,k);const{minT:j,maxT:re}=S,we=re,be=R(0,j,re,y,T),fe=H(ae(0),p,m,q,C),oe=R(we,j,re,y,T),ie=H(ae(we),p,m,q,C);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,pe=a.currentResistance;if(le>=j&&le<=re){const ve=R(le,j,re,y,T),Ce=H(pe,p,m,q,C);G(e,d,ve,Ce,le,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const d=O(),p=X(),{minR:m,maxR:h,ticks:S}=N(p),v=A(e,d,p.minT,p.maxT,p.tickStep,S),{gx:y,gy:q,gw:T,gh:C,axisFont:I,yLabelX:Q,xLabelY:k,dotR:D}={...d,...v},{minT:j,maxT:re}=p;e.save(),e.translate(Q,q+C/2),e.rotate(-Math.PI/2),e.font=I,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=I,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+T/2,k),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=j;oe<=re;oe+=1){const ie=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/ie-1/298.15)),pe=R(oe,j,re,y,T),ve=H(Math.min(h,le),m,h,q,C);ve>=q&&ve<=q+C&&(we?e.lineTo(pe,ve):(e.moveTo(pe,ve),we=!0))}e.stroke();const be=a.thermometerTemp,fe=a.currentThermistorR;if(be>=j&&be<=re){const oe=R(be,j,re,y,T),ie=H(Math.min(h,fe),m,h,q,C);G(e,d,oe,ie,be,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,ie,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function he(){Z.clearRect(0,0,w,E),ne.clearRect(0,0,W,z),Z.save(),Z.translate(J,0),F(Z),a.thermometerType==="liquid"?g(Z):a.thermometerType==="resistance"?_(Z):L(Z),Z.restore(),a.thermometerType==="liquid"?$(ne):a.thermometerType==="resistance"?de(ne):se(ne)}function ge(){const e=r.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const d=r.querySelector("#tl-svg-formula-liquid-sub");if(d){const v=a.liquidL100-a.liquidL0,y=a.currentLength-a.liquidL0;d.innerHTML=`
      ...
      `);const m=r.querySelector("#tl-svg-formula-resistance-sub");if(m){const v=a.resistanceR100-a.resistanceR0,y=a.currentResistance-a.resistanceR0;m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `}const h=r.querySelector("#tl-svg-formula-thermistor");h&&(h.innerHTML=`
      ...
      `);const S=r.querySelector("#tl-svg-formula-thermistor-sub");if(S){const v=a.thermometerTemp+273.15;S.innerHTML=`
      ...
      `}}function Se(){const e=r.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:d,cu:p,interval:m}=He(),h=parseFloat(r.querySelector("#tl-input-q10a-cm").value)||0,S=parseFloat(r.querySelector("#tl-input-q10b-t").value)||0,v=r.querySelector("#tl-pane-q10a").classList.contains("active"),y=v?(h-d)/m*100:S,q=v?h:S/100*m+d,C=(I=>130-I/100*80)(y);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Current Point -->
          <text x="65" y="${C+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${y.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${C+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${q.toFixed(1)}°C</text>
    ...
    `}function ke(e){r.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",r.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const d=r.querySelector("#tl-bath-state");a.bathTemp<=0?d.textContent="Melting Ice Bath":a.bathTemp>=100?d.textContent="Boiling Water/Steam":a.bathTemp===150?d.textContent="Hot Cooking Oil":d.textContent="Liquid Water",r.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=r.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(r.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",r.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(r.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",r.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):r.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let qe=null;function Fe(e){a.lastTimestamp||(a.lastTimestamp=e);const d=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(d,.1),m=x(),h=p/m*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=h,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const S=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/S-1/298.15)),M(),he(),ke(m),qe=requestAnimationFrame(Fe)}function He(){const e=parseFloat(r.querySelector("#tl-input-faulty-cf").value),d=parseFloat(r.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,m=Number.isFinite(d)?d:105,h=m-p;return{cf:p,cu:m,interval:h}}function ze(e){const d=Math.round(e*100)/100;return d>=0?d.toFixed(1):`(${d.toFixed(1)})`}function me(){const{cf:e,cu:d,interval:p}=He(),m=r.querySelector("#tl-val-faulty-interval"),h=r.querySelector("#tl-faulty-error-a"),S=r.querySelector("#tl-faulty-error-b"),v=Math.abs(p)<.01;m.textContent=p.toFixed(1)+" °C";const y=r.querySelector("#tl-svg-formula-faulty-a"),q=r.querySelector("#tl-svg-formula-faulty-b");if(v){h.hidden=!1,h.textContent="C_u must differ from C_f (interval cannot be zero).",S.hidden=!1,S.textContent=h.textContent,y&&(y.innerHTML=""),q&&(q.innerHTML="");return}h.hidden=!0,S.hidden=!0;const T=parseFloat(r.querySelector("#tl-input-q10a-cm").value)||0,C=parseFloat(r.querySelector("#tl-input-q10b-t").value)||0,I=(T-e)/p*100,Q=C/100*p+e;y&&(y.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${T.toFixed(1)} - ${ze(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${d.toFixed(1)} - ${ze(e)}</text>
      ...
      `),Se()}function ye(){const e=parseFloat(r.querySelector("#tl-input-q11-r").value)||0,d=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100,p=r.querySelector("#tl-svg-formula-resistance-solver");p&&(p.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function Te(){const e=a.thermometerTemp,d=a.liquidL100-a.liquidL0,p=a.liquidL0+d/100*e,m=r.querySelector("#tl-svg-formula-t-to-l");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${a.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${d.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function je(){const e=a.thermometerTemp,d=a.resistanceR100-a.resistanceR0,p=a.resistanceR0+d/100*e,m=r.querySelector("#tl-svg-formula-t-to-r");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">R<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${a.resistanceR0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${d.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} Ω</tspan>
          </text>
        </svg>
      `)}function ue(){me(),ye(),Te(),je()}function $e(e,d){r.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=d,r.querySelector("#tl-bath-temp-slider").value=d,ue()})}function yt(){r.querySelectorAll(".tl-tab-btn").forEach(h=>{h.addEventListener("click",()=>{r.querySelectorAll(".tl-tab-btn").forEach(v=>v.classList.remove("active")),r.querySelectorAll(".tl-tab-content").forEach(v=>v.classList.remove("active")),h.classList.add("active");const S=h.getAttribute("data-tl-tab");r.querySelector("#tl-tab-"+S).classList.add("active"),a.thermometerType=S,ue()})}),r.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{a.showLabels=!a.showLabels,r.querySelector("#tl-lbl-toggle-labels").textContent=a.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),r.querySelector("#tl-bath-temp-slider").addEventListener("input",h=>{a.bathTemp=parseFloat(h.target.value),ue()}),$e("tl-btn-preset-ice",0),$e("tl-btn-preset-room",25),$e("tl-btn-preset-steam",100),$e("tl-btn-preset-oil",150),r.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",r.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",r.querySelector("#tl-card-alcohol").className="tl-seg-btn",ue()}),r.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",r.querySelector("#tl-card-mercury").className="tl-seg-btn",r.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",ue()}),r.querySelector("#tl-slider-bulb-vol").addEventListener("input",h=>{a.bulbVolume=parseFloat(h.target.value),r.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),r.querySelector("#tl-slider-wall-thick").addEventListener("input",h=>{a.wallThickness=parseFloat(h.target.value),r.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),r.querySelector("#tl-slider-capillary-bore").addEventListener("input",h=>{a.capillaryBore=parseFloat(h.target.value),r.querySelector("#tl-val-capillary-bore").textContent=a.capillaryBore.toFixed(2)+" mm"}),r.querySelector("#tl-slider-liquid-l0").addEventListener("input",h=>{a.liquidL0=parseFloat(h.target.value),r.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",ue()}),r.querySelector("#tl-slider-liquid-l100").addEventListener("input",h=>{a.liquidL100=parseFloat(h.target.value),r.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",ue()}),r.querySelector("#tl-slider-resistance-r0").addEventListener("input",h=>{a.resistanceR0=parseFloat(h.target.value),r.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",r.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",ue()}),r.querySelector("#tl-slider-resistance-r100").addEventListener("input",h=>{a.resistanceR100=parseFloat(h.target.value),r.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",r.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",ue()}),r.querySelector("#tl-slider-thermistor-r25").addEventListener("input",h=>{a.thermistorR25=parseFloat(h.target.value),r.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",r.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",ue()}),r.querySelector("#tl-slider-thermistor-beta").addEventListener("input",h=>{a.thermistorBeta=parseFloat(h.target.value),r.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",r.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",ue()}),r.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{r.querySelector("#tl-btn-solve-q10a").classList.add("active"),r.querySelector("#tl-btn-solve-q10b").classList.remove("active"),r.querySelector("#tl-pane-q10a").classList.add("active"),r.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),r.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{r.querySelector("#tl-btn-solve-q10a").classList.remove("active"),r.querySelector("#tl-btn-solve-q10b").classList.add("active"),r.querySelector("#tl-pane-q10a").classList.remove("active"),r.querySelector("#tl-pane-q10b").classList.add("active"),me()}),r.querySelector("#tl-input-faulty-cf").addEventListener("input",me),r.querySelector("#tl-input-faulty-cu").addEventListener("input",me),r.querySelector("#tl-input-q10a-cm").addEventListener("input",me),r.querySelector("#tl-input-q10b-t").addEventListener("input",me),r.querySelector("#tl-input-q11-r").addEventListener("input",ye);const p=r.querySelector("#tl-input-t-to-l");p&&p.addEventListener("input",ue);const m=r.querySelector("#tl-input-t-to-r");m&&m.addEventListener("input",ue)}if(i.type){const e=r.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return r.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===s?e.classList.add("active"):e.classList.remove("active")}),r.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===s?e.classList.add("active"):e.classList.remove("active")}),P(),yt(),ue(),qe=requestAnimationFrame(Fe),r._thermometerLabCleanup=()=>{qe&&cancelAnimationFrame(qe)},r}function jt(t){const i=document.createElement("div");i.className="tool-specific-heat";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"specific-heat/index.html?lang="+encodeURIComponent(ce())}s.src=r(),s.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=s.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{s.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(s),i}function Bt(t){const i=document.createElement("div");i.className="tool-thermal-mixing";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"thermal-mixing/index.html?lang="+encodeURIComponent(ce())}s.src=r(),s.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=s.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{s.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(s),i}function Qt(t){const i=document.createElement("div");i.className="tool-change-of-state";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"change-of-state/index.html?lang="+encodeURIComponent(ce())}s.src=r(),s.title=t("tools.changeOfState.title")||"Change of State Lab",s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=s.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{s.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(s),i}function Nt(t){const i=document.createElement("div");i.className="tool-heat-transfer";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(ce())}s.src=r(),s.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=s.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{s.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(s),i}const Le=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],Oe=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],Vt=[["thermometer","topic.thermometer"]],rt=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],Ut={liquid:t=>De(t,{type:"liquid"}),resistance:t=>De(t,{type:"resistance"}),thermistor:t=>De(t,{type:"thermistor"}),specificHeat:t=>jt(t),thermalMixing:t=>Bt(t),changeOfState:t=>Qt(t),heatTransfer:t=>Nt(t)};function Yt(t){return c({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function Ae(){return ce()==="zh-Hant"?"zhHant":"en"}async function _e(t,i){const s=`./${t}/${i}`;try{return(await fetch(s,{method:"HEAD"})).ok}catch{return!1}}async function nt(t){return _e("notes",t)}function Kt(t){let i="topics",s="liquid",n=0,u="all",r=!1,a=null,w={main:null},E=null;function J(){if(w.main){if(i==="topics"?w.main.innerHTML=z():i==="notes"?w.main.innerHTML=X():i==="tools"?w.main.innerHTML=H():i==="worksheets"?w.main.innerHTML=pt(c,{topics:Vt,paperTitleKey:"worksheets.paperTitleHeat"}):i==="flashcards"?w.main.innerHTML=te():i==="summary"&&(w.main.innerHTML=K()),i==="notes"&&R(),i==="tools"&&A(),i==="worksheets"){const l=ut.filter(o=>Oe.includes(o.topic));mt(t,l,c,Ae,{topicFilter:(o,f)=>f.includes("thermometer")?Oe.includes(o.topic):f.includes(o.topic)})}i==="flashcards"&&Z(),i==="summary"&&ne()}}function W(){a==null||a.destroy(),a=ht(t,{subtitleKey:"strand.heat.subtitle",activeSection:i,onSection:l=>{i==="tools"&&l!=="tools"&&E!=null&&E._thermometerLabCleanup&&(E._thermometerLabCleanup(),E=null),i=l,a.updateSection(i),J()},onLang:()=>W()}),w.main=a.main,a.updateSection(i),J()}function z(){return`
      <section class="panel panel--topic-hub">
        <h2>${c("topics.title")}</h2>
        <p class="lead">${c("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Le.map(l=>{const o=l.tool?`<button class="btn primary" type="button" data-go-tool="${l.tool}">${c("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${c("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${c(l.titleKey)}</h3>
              ${o}
            </div>`}).join("")}
        </div>
      </section>`}function O(l){const o=l.target.closest("[data-go-tool]");if(o){const x=o.getAttribute("data-go-tool");rt.includes(x)?s=x:s="liquid",i="tools",a.updateSection(i),J();return}const f=l.target.closest("[data-go-section]");(f==null?void 0:f.getAttribute("data-go-section"))==="notes"&&(i="notes",a.updateSection(i),J())}function X(){return`
      <section class="panel">
        <h2>${c("notes.title")}</h2>
        <p class="lead">${c("notes.intro")}</p>
        <p class="lead">${c("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${Le.map(l=>`
            <div class="card" data-note-card="${l.id}">
              <h3>${c(`notes.card.${l.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function R(){const l=Ae();for(const o of Le){const f=t.querySelector(`[data-note-card="${o.id}"]`);if(!f)continue;const x=f.querySelector("[data-note-body]"),M=l==="zhHant"?o.fileZh:o.fileEn,F=await nt(M),b=`./notes/${M}`;F?x.innerHTML=`
          <iframe class="notes-grid" title="${c(`notes.card.${o.id}`)}" src="${b}"></iframe>
          <p style="margin-top:8px"><a href="${b}" target="_blank" rel="noopener">${c("notes.openPdf")}</a></p>`:x.innerHTML=`<p class="lead">${c("notes.missing")}</p>`}}function H(){return`
      <section class="panel panel--tools">
        <h2>${c("tools.title")}</h2>
        <p class="lead">${c("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${rt.map(l=>`<button type="button" data-tool="${l}" class="${s===l?"active":""}">${Yt(l)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function A(){const l=t.querySelector("[data-tool-list]"),o=t.querySelector("[data-tool-stage]");!l||!o||(l.querySelectorAll("button").forEach(f=>{f.addEventListener("click",()=>{s=f.getAttribute("data-tool"),l.querySelectorAll("button").forEach(x=>x.classList.toggle("active",x.getAttribute("data-tool")===s)),B(o)})}),B(o))}function B(l){l.innerHTML="",E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup();const o=Ut[s];o&&(E=o(c),l.appendChild(E))}function te(){return`
      <section class="panel">
        <h2>${c("flashcards.title")}</h2>
        <p class="lead">${c("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
          ...
          <select data-flash-deck>
            <option value="all">${c("flashcards.all")}</option>
            <option value="thermometry">${c("flashcards.deck.thermometry")}</option>
            <option value="heatInternalEnergy">${c("flashcards.deck.heatInternalEnergy")}</option>
            <option value="changeOfState">${c("flashcards.deck.changeOfState")}</option>
            <option value="heatTransfer">${c("flashcards.deck.heatTransfer")}</option>
          </select>
        </div>
        <div class="flashcard-box">
          <div class="flashcard-surface" data-flip-card>
      ...
      </section>`}function Y(){return ft.filter(l=>Oe.includes(l.topic))}function ee(l){return!!(l!=null&&l.front)}function ae(l){return`./${String(l).replace(/^\.\//,"")}`}function N(){if(u==="all")return[...Ze,...Je,...et,...tt];if(u==="thermometry")return Ze.slice();if(u==="heatInternalEnergy")return Je.slice();if(u==="changeOfState")return et.slice();if(u==="heatTransfer")return tt.slice();const l=Y().filter(o=>o.topic===u);return l.length?l:Y()}function V(){const l=N(),o=t.querySelector("[data-flash-progress]");if(!l.length){n=0;const _=t.querySelector("[data-flash-front]"),L=t.querySelector("[data-flip-card]");_&&(_.textContent=""),L&&L.classList.remove("flashcard-surface--image"),o&&(o.hidden=!0,o.textContent="");return}n=Math.max(0,Math.min(n,l.length-1));const f=l[n],x=t.querySelector("[data-flash-front]"),M=t.querySelector("[data-flip-card]"),F=t.querySelector("[data-flash-label]");if(!x||!M)return;if(o&&(o.hidden=!1,o.textContent=c("flashcards.progress").replace("{current}",String(n+1)).replace("{total}",String(l.length))),ee(f)){const _=f.back&&f.back!==f.front;M.classList.add("flashcard-surface--image"),F&&(_?(F.hidden=!1,F.textContent=c(r?"flashcards.answer":"flashcards.question")):F.hidden=!0);const L=r&&f.back?f.back:f.front,G=f.alt||f.title||"";x.innerHTML=`<img src="${ae(L)}" alt="${G.replace(/"/g,"&quot;")}" loading="lazy" />`;return}M.classList.remove("flashcard-surface--image");const b=Ae(),g=f[b]||f.en;F&&(F.hidden=!1,F.textContent=c(r?"flashcards.answer":"flashcards.question")),x.textContent=r?g.a:g.q}function Z(){const l=t.querySelector("[data-flash-deck]");l.value=u,l.addEventListener("change",()=>{u=l.value,n=0,r=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{r=!r,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",o=>{o.stopPropagation(),r=!r,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const o=N();n=(n-1+o.length)%o.length,r=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const o=N();n=(n+1)%o.length,r=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const o=N();n=Math.floor(Math.random()*o.length),r=!1,V()}),V()}function K(){return`
      <section class="panel">
        <h2>${c("summary.title")}</h2>
        <p class="lead">${c("summary.intro")}</p>
        <p class="lead">${c("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${Le.map(l=>`
            <div class="card" data-summary-card="${l.id}">
              <h3>${c(`summary.item.${l.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function ne(){const l=Ae();for(const o of Le){const f=t.querySelector(`[data-summary-card="${o.id}"]`);if(!f)continue;const x=f.querySelector("[data-summary-body]");if(o.id==="thermometer"){const g=await _e("summary","thermometer.webp"),_="./summary/thermometer.webp";g?x.innerHTML=`
          <img class="summary-thumb" src="${_}" alt="${c("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(o.id==="heatInternalEnergy"){const g=await _e("summary","heat-internal-energy.webp"),_="./summary/heat-internal-energy.webp";g?x.innerHTML=`
          <img class="summary-thumb" src="${_}" alt="${c("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(o.id==="changeOfState"){const g=await _e("summary","change-of-state.webp"),_="./summary/change-of-state.webp";g?x.innerHTML=`
          <img class="summary-thumb" src="${_}" alt="${c("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(o.id==="heatTransfer"){const g=await _e("summary","heat-transfer.webp"),_="./summary/heat-transfer.webp";g?x.innerHTML=`
          <img class="summary-thumb" src="${_}" alt="${c("summary.item.heatTransfer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}const M=l==="zhHant"?o.fileZh:o.fileEn,F=await nt(M),b=`./notes/${M}`;F?x.innerHTML=`
          <iframe class="notes-grid" title="${c(`summary.item.${o.id}`)}" src="${b}"></iframe>
          <p style="margin-top:8px"><a href="${b}" target="_blank" rel="noopener">${c("summary.download")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`}}const U=()=>W(),P=l=>O(l);return window.addEventListener("s3phy:lang",U),t.addEventListener("click",P),W(),()=>{window.removeEventListener("s3phy:lang",U),t.removeEventListener("click",P),E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup(),a==null||a.destroy()}}const it={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};kt();const ot="s3phy_splash_seen",bt={optics:Dt,heat:Kt};let Me=null,Re=null;function Xt(){const t=location.hash.match(/^#\/(\w+)/),i=t==null?void 0:t[1];return i&&Object.prototype.hasOwnProperty.call(bt,i)?i:null}function Zt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function gt(t){Me==null||Me(),Me=null,Re==null||Re(),Re=null;const i=document.getElementById("app");if(!i)return;if(i.innerHTML="",!t){location.hash&&Zt(),Re=St(i);return}const s=`#/${t}`;if(location.hash!==s){location.hash=s;return}Me=bt[t](i)??null}function vt(){gt(Xt())}function Jt(){return"./images/uniplus-logo.png"}function ea(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
