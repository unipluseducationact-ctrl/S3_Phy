const wt="s3phy-thermometer-lab-css";const Yt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Tt(){if(document.getElementById(wt))return;const c=document.createElement("style");c.id=wt,c.textContent=Yt,document.head.appendChild(c)}function St(c){const V={x:12,y:12},K=200,{container:H,panel:a,toggleBtn:e,dragHandle:W,dragSurface:et,storageKey:M,onLayoutChange:J,breakpoint:lt=1024,collapsedClass:C="controls-collapsed",floatingClass:w="controls-floating"}=c,k=et||W;if(!H||!a||!e)return null;let q=sessionStorage.getItem(M)!=="false",x=(()=>{try{const z=localStorage.getItem(M+":pos");if(!z)return{...V};const S=JSON.parse(z);if(typeof S.x=="number"&&typeof S.y=="number")return S}catch{}return{...V}})(),T=null,$=null;const P=()=>window.innerWidth>=lt,N=(z,S)=>{const it=H.getBoundingClientRect(),nt=a.getBoundingClientRect(),st=Math.max(0,it.width-nt.width),ct=Math.max(0,it.height-nt.height);return{x:Math.min(Math.max(0,z),st),y:Math.min(Math.max(0,S),ct)}},_=()=>{a.style.left=x.x+"px",a.style.top=x.y+"px",a.style.right="auto",a.style.bottom="auto"},L=()=>{typeof J=="function"&&(clearTimeout($),$=setTimeout(J,K))},j=()=>{e.setAttribute("aria-expanded",q?"false":"true"),c.getToggleTitle&&(e.title=c.getToggleTitle(q));const z=e.querySelector("[data-float-chevron]");z&&(z.textContent=q?"v":"^")},X=()=>{P()&&(x=N(x.x,x.y),_())},at=z=>{q=z,a.classList.toggle(C,q),sessionStorage.setItem(M,q?"true":"false"),j(),L(),requestAnimationFrame(X),setTimeout(X,260)},rt=()=>{H.classList.add(w),a.classList.add("lab-controls-float"),x=N(x.x,x.y),_(),W&&(W.style.display="")},O=()=>{H.classList.remove(w),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",W&&(W.style.display="none")},Z=()=>{P()?(rt(),x=N(x.x,x.y),_()):O(),L()};if(a.classList.toggle(C,q),j(),Z(),e.addEventListener("click",z=>{z.stopPropagation(),at(!q)}),k){k.addEventListener("pointerdown",S=>{P()&&(e.contains(S.target)||(S.preventDefault(),T={pointerId:S.pointerId,startX:S.clientX,startY:S.clientY,originX:x.x,originY:x.y},k.setPointerCapture(S.pointerId),k.classList.add("is-dragging")))}),k.addEventListener("pointermove",S=>{!T||T.pointerId!==S.pointerId||(x=N(T.originX+S.clientX-T.startX,T.originY+S.clientY-T.startY),_())});const z=S=>{if(!(!T||T.pointerId!==S.pointerId)){k.releasePointerCapture(S.pointerId),k.classList.remove("is-dragging");try{localStorage.setItem(M+":pos",JSON.stringify(x))}catch{}T=null,L()}};k.addEventListener("pointerup",z),k.addEventListener("pointercancel",z)}return window.addEventListener("resize",Z),{setCollapsed:at,refreshMode:Z,isCollapsed:()=>q}}function Nt(c,g={}){Tt();const V=g.type||"liquid";let K=c("tools.thermometerLab.title"),H=c("tools.thermometerLab.subtitle");g.type==="liquid"?(K=c("tools.thermometerLab.liquid.title"),H=c("tools.thermometerLab.liquid.subtitle")||c("tools.thermometerLab.subtitle")):g.type==="resistance"?(K=c("tools.thermometerLab.resistance.title"),H=c("tools.thermometerLab.resistance.subtitle")||c("tools.thermometerLab.subtitle")):g.type==="thermistor"&&(K=c("tools.thermometerLab.thermistor.title"),H=c("tools.thermometerLab.thermistor.subtitle")||c("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
  ...
  `;const e={liquidType:"mercury",thermometerType:V,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},W={xs:11,sm:14,md:17,lg:18,sub:10};function et(t,l,o,n){let i=Math.min(o,Math.max(l,t));return n>0&&(i=Math.round(i/n)*n,i=Math.min(o,Math.max(l,parseFloat(i.toFixed(10))))),i}function M(t,l,{min:o,max:n,step:i,decimals:f,onUpdate:s}){function d(p){const u=Number.isFinite(p)?p:o,r=et(u,o,n,i);t.value=r,l.value=r.toFixed(f),s(r)}t.addEventListener("input",()=>d(parseFloat(t.value))),l.addEventListener("change",()=>d(parseFloat(l.value))),l.addEventListener("blur",()=>d(parseFloat(l.value)))}const J=460,lt=340,C=40,w=640,k=420;function q(){const t={left:110,top:48,right:30,bottom:65};return{gx:t.left,gy:t.top,gw:w-t.left-t.right,gh:k-t.top-t.bottom,tickFont:`bold ${Math.round(w*.024)}px Arial`,axisFont:`bold ${Math.round(w*.026)}px Arial`,dotR:8,yLabelX:t.left-75,xLabelY:k-t.bottom+32}}function x(){return{minT:0,maxT:200,tickStep:25}}function T(t,l,o,n,i){return n+(t-l)/(o-l)*i}function $(t,l,o,n,i){return n+i-(t-l)/(o-l)*i}function P(t,l,o,n,i,f,s=null){const{gx:d,gy:p,gw:u,gh:r,tickFont:b,axisFont:y,yLabelX:m,xLabelY:F}=l;t.strokeStyle="#1e1e24",t.lineWidth=1;for(const h of f){const v=$(h.value,h.min,h.max,p,r);t.beginPath(),t.moveTo(d,v),t.lineTo(d+u,v),t.stroke()}for(let h=o;h<=n+.01;h+=i){const v=T(h,o,n,d,u);t.beginPath(),t.moveTo(v,p),t.lineTo(v,p+r),t.stroke()}t.strokeStyle="#4b5563",t.lineWidth=2.5,t.beginPath(),t.moveTo(d,p),t.lineTo(d,p+r),t.lineTo(d+u,p+r),t.stroke(),t.fillStyle="#e4e4e7",t.font=b,t.textAlign="right",t.textBaseline="middle";for(const h of f){const v=$(h.value,h.min,h.max,p,r);t.fillText(h.label,d-15,v)}t.textAlign="center",t.textBaseline="top";for(let h=o;h<=n+.01;h+=i){if(s!=null&&Math.abs(h-s)<.25)continue;const v=T(h,o,n,d,u);t.fillText(`${Math.round(h)}`,v,p+r+10)}return{gx:d,gy:p,gw:u,gh:r,axisFont:y,yLabelX:m,xLabelY:F}}function N(t,l){const o=l-t,n=o<=8?1:o<=14?2:5,i=[],f=Math.ceil(t/n)*n;for(let s=f;s<=l+.001;s+=n)i.push({value:s,label:s%1===0?`${s.toFixed(0)}`:`${s.toFixed(1)}`,min:t,max:l});return i}function _(){const{maxT:t}=x(),l=L(0),o=L(t),n=o-l,i=Math.max(1,n*.1),f=Math.max(0,Math.round((l-i)*10)/10),s=Math.round((o+i)*10)/10;return{minL:f,maxL:s}}function L(t){return e.liquidL0+(e.liquidL100-e.liquidL0)/100*t}function j(){const{maxT:t}=x(),l=X(0),o=X(t),n=o-l,i=Math.max(.2,n*.1),f=Math.max(0,l-i),s=o+i,d=n<=2?.5:n<=4?1:2,p=[],u=Math.ceil(f/d)*d;for(let r=u;r<=s+.001;r+=d)p.push({value:r,label:r.toFixed(1),min:f,max:s});return{minR:f,maxR:s,ticks:p}}function X(t){return e.resistanceR0+(e.resistanceR100-e.resistanceR0)/100*t}function at(t){const{maxT:l}=t;let o=e.thermistorR25;for(let s=0;s<=l;s+=5){const d=s+273.15,p=e.thermistorR25*Math.exp(e.thermistorBeta*(1/d-1/298.15));o=Math.max(o,p)}o=Math.ceil(o*1.08*10)/10;const n=0,i=o<=12?2:4,f=[];for(let s=0;s<=o+.001;s+=i)f.push({value:s,label:s.toFixed(0),min:n,max:o});return{minR:n,maxR:o,ticks:f}}const rt=a.querySelector("#tl-thermometerCanvas"),O=rt.getContext("2d"),Z=a.querySelector("#tl-graphCanvas"),z=Z.getContext("2d"),S=window.devicePixelRatio||1;rt.width=J*S,rt.height=lt*S,O.scale(S,S),Z.width=w*S,Z.height=k*S,z.scale(S,S);function it(){e.iceCubes=[];for(let t=0;t<5;t++)e.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});e.bubbles=[];for(let t=0;t<20;t++)e.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});e.heatWaves=[];for(let t=0;t<8;t++)e.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});e.steamParticles=[];for(let t=0;t<12;t++)e.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const nt=200,st=11;function ct(){const t=Math.pow(e.bulbVolume/nt,.3333333333333333);return st*t}function kt(){if(e.thermometerType==="resistance"||e.thermometerType==="thermistor")return .35;const t=e.liquidType==="mercury"?1:8,l=.2+e.wallThickness*1.5,o=.4+e.bulbVolume*.003,n=1.35-e.capillaryBore*.45;return Math.max(.1,l*o*n*t*.15)}function Ct(t){e.bathTemp<=8&&e.iceCubes.forEach(l=>{l.x+=l.speedX,l.y+=l.speedY,(l.x<65||l.x>175)&&(l.speedX*=-1),(l.y<195||l.y>210)&&(l.speedY*=-1)}),e.bathTemp>35&&e.heatWaves.forEach(l=>{l.y-=l.speedY*(1+e.bathTemp/100),l.y<185&&(l.y=265,l.x=65+Math.random()*110)}),e.bathTemp>=80&&e.bubbles.forEach(l=>{l.y-=l.speedY*(1+(e.bathTemp-80)/40),l.phase+=l.wobbleSpeed,l.x+=Math.sin(l.phase)*.3,l.y<185&&(l.y=260+Math.random()*10,l.x=60+Math.random()*120)}),e.bathTemp>=95&&e.steamParticles.forEach(l=>{l.x+=l.vx,l.y+=l.vy,l.alpha-=.005,(l.alpha<=0||l.y<130)&&(l.x=60+Math.random()*120,l.y=175+Math.random()*5,l.alpha=.2+Math.random()*.4)})}function Lt(t){let s=59,d=130,p=246;if(e.bathTemp<25){const m=e.bathTemp/25;s=Math.round(180-m*121),d=Math.round(210-m*80),p=Math.round(250-m*4)}else{const m=Math.min(1,(e.bathTemp-25)/125);s=Math.round(59+m*180),d=Math.round(130-m*100),p=Math.round(246-m*190)}if(e.bathTemp>40){const m=Math.min(1,(e.bathTemp-40)/100),F=Date.now()*.02;t.fillStyle=`rgba(239, 68, 68, ${m*.25})`,t.beginPath(),t.roundRect(45,284,150,10,4),t.fill(),t.fillStyle="rgba(249, 115, 22, 0.85)",t.beginPath(),t.moveTo(55+130/2-25,284);for(let h=-25;h<=25;h+=6){const v=m*(12+Math.sin(h*.4+F)*5);t.lineTo(55+130/2+h,284-v)}t.lineTo(55+130/2+25,284),t.closePath(),t.fill()}t.strokeStyle="#4b5563",t.lineWidth=2,t.fillStyle="#121214",t.beginPath(),t.roundRect(55,180,130,100,[0,0,10,10]),t.fill();const u=t.createLinearGradient(55,190,55,280);u.addColorStop(0,`rgba(${s}, ${d}, ${p}, 0.25)`),u.addColorStop(1,`rgba(${s}, ${d}, ${p}, 0.55)`),t.fillStyle=u,t.beginPath(),t.moveTo(55,190);const r=e.bathTemp>=80?2:.5,b=e.bathTemp>=80?.09:.03,y=Date.now()*b;for(let m=55;m<=185;m+=5){const F=190+Math.sin(m*.15+y)*r;t.lineTo(m,F)}t.lineTo(185,280),t.lineTo(55,280),t.closePath(),t.fill(),e.bathTemp>35&&(t.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(e.bathTemp-35)/120)})`,t.lineWidth=1.2,e.heatWaves.forEach(m=>{t.beginPath(),t.moveTo(m.x,m.y),t.quadraticCurveTo(m.x+Math.sin(m.y*.06)*5,m.y-m.length/2,m.x,m.y-m.length),t.stroke()})),e.bathTemp<=8&&(t.fillStyle="rgba(224, 242, 254, 0.55)",t.strokeStyle="rgba(186, 230, 253, 0.8)",t.lineWidth=1,e.iceCubes.forEach(m=>{t.save(),t.translate(m.x,m.y),t.rotate(m.angle),t.beginPath(),t.roundRect(-m.size/2,-m.size/2,m.size,m.size,3),t.fill(),t.stroke(),t.restore()})),e.bathTemp>=80&&(t.fillStyle="rgba(255, 255, 255, 0.4)",t.strokeStyle="rgba(255, 255, 255, 0.65)",t.lineWidth=.6,e.bubbles.forEach(m=>{t.beginPath(),t.arc(m.x,m.y,m.r,0,Math.PI*2),t.fill(),t.stroke()})),e.bathTemp>=95&&e.steamParticles.forEach(m=>{t.fillStyle=`rgba(255, 255, 255, ${m.alpha})`,t.beginPath(),t.arc(m.x,m.y,m.r,0,Math.PI*2),t.fill()}),t.strokeStyle="#9ca3af",t.lineWidth=3.5,t.beginPath(),t.moveTo(54,180),t.lineTo(54,272),t.arcTo(54,281,65,281,8),t.lineTo(175,281),t.arcTo(186,281,186,272,8),t.lineTo(186,180),t.stroke(),t.strokeStyle="rgba(255, 255, 255, 0.4)",t.lineWidth=1.5,t.beginPath(),t.moveTo(59,190),t.lineTo(59,270),t.stroke()}function Q(t,l,o,n,i,f,s="left"){if(!e.showLabels)return;t.strokeStyle="rgba(6, 182, 212, 0.7)",t.lineWidth=1,t.setLineDash([3,3]),t.beginPath(),t.moveTo(l,o),t.lineTo(n,i),t.stroke(),t.setLineDash([]),t.fillStyle="#06b6d4",t.beginPath(),t.arc(l,o,3,0,Math.PI*2),t.fill(),t.font="bold 9px system-ui, sans-serif";const p=t.measureText(f).width+10,u=16,r=s==="left"?n:n-p,b=i-u/2;t.fillStyle="rgba(21, 21, 24, 0.9)",t.strokeStyle="#06b6d4",t.lineWidth=1,t.beginPath(),t.roundRect(r,b,p,u,4),t.fill(),t.stroke(),t.fillStyle="#f4f4f5",t.textAlign="center",t.textBaseline="middle",t.fillText(f,r+p/2,b+u/2+.5)}function qt(t){const n=ct(),i=250+Math.max(0,n-st)*.35,f=i-n-1,s=10+e.wallThickness*8,d=120-s/2,p=120+s/2,u=t.createLinearGradient(d,20,p,20);u.addColorStop(0,"rgba(209, 213, 219, 0.85)"),u.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),u.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),u.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),u.addColorStop(1,"rgba(156, 163, 175, 0.9)"),t.fillStyle=u,t.strokeStyle="rgba(156, 163, 175, 0.8)",t.lineWidth=1,t.beginPath(),t.moveTo(d,f),t.lineTo(d,25),t.arcTo(d,20,d+5,20,5),t.arcTo(p,20,p,25,5),t.lineTo(p,f),t.closePath(),t.fill(),t.stroke();const r=t.createRadialGradient(120-n*.2,i-n*.2,n*.1,120,i,n);r.addColorStop(0,"rgba(255, 255, 255, 0.8)"),r.addColorStop(1,"rgba(156, 163, 175, 0.35)"),t.fillStyle=r,t.strokeStyle="#6b7280",t.lineWidth=.8+e.wallThickness*.6,t.beginPath(),t.arc(120,i,n+.5+e.wallThickness*.5,0,Math.PI*2),t.fill(),t.stroke();const b=Math.min(s*.72,.8+e.capillaryBore*4.5);t.fillStyle="#0a0a0c",t.fillRect(120-b/2,28,b,f-20-8);const y=e.liquidType==="mercury",m=y?"#a1a1aa":"#ef4444",F=y?"#f4f4f5":"#fee2e2",h=210,v=220,I=(h-40)/v,G=h-Math.min(v,e.thermometerTemp)*I;t.fillStyle=m,t.fillRect(120-b/2,G,b,f-G),t.beginPath(),t.ellipse(120,G,b/2,1.5,0,0,Math.PI*2),t.fill(),t.fillStyle=F,t.fillRect(120-b/6,G,b/3,f-G);const E=n*.9,R=t.createRadialGradient(120-E*.2,i-E*.2,E*.1,120,i,E);y?(R.addColorStop(0,"#f4f4f5"),R.addColorStop(.3,"#d4d4d8"),R.addColorStop(.8,"#71717a"),R.addColorStop(1,"#3f3f46")):(R.addColorStop(0,"#fee2e2"),R.addColorStop(.2,"#fca5a5"),R.addColorStop(.7,"#ef4444"),R.addColorStop(1,"#991b1b")),t.fillStyle=R,t.beginPath(),t.arc(120,i,E,0,Math.PI*2),t.fill(),t.strokeStyle="rgba(161, 161, 170, 0.6)",t.lineWidth=.5,t.font="6.5px Arial",t.fillStyle="#a1a1aa",t.textAlign="right",t.textBaseline="middle";for(let B=0;B<=200;B+=50){const Y=h-B*I;t.beginPath(),t.moveTo(d,Y),t.lineTo(d+4,Y),t.stroke(),t.fillText(`${B}°C`,d-22,Y+2.5)}e.showLabels&&(Q(t,d+1,80,10,50,c("tools.thermometerLab.labels.thinWall"),"left"),Q(t,120,G,230,G-15,c("tools.thermometerLab.labels.meniscus"),"left"),Q(t,120-b/2,130,10,130,c("tools.thermometerLab.labels.narrowBore"),"left"),Q(t,120,i,230,i+15,c("tools.thermometerLab.labels.largeBulb"),"left"))}function $t(t){const s=t.createLinearGradient(115,20,125,20);s.addColorStop(0,"#71717a"),s.addColorStop(.3,"#f4f4f5"),s.addColorStop(.7,"#d4d4d8"),s.addColorStop(1,"#3f3f46"),t.fillStyle=s,t.strokeStyle="#4b5563",t.lineWidth=1,t.beginPath(),t.roundRect(115,20,10,225,[0,0,4,4]),t.fill(),t.stroke(),t.fillStyle="rgba(21, 21, 24, 0.8)",t.fillRect(117,200,6,40),t.strokeStyle="#e2e8f0",t.lineWidth=1.2,t.beginPath();let d=205;t.moveTo(118,d);for(let y=0;y<8;y++)d+=4,t.lineTo(122,d),d+=4,t.lineTo(118,d);t.stroke(),t.lineWidth=1.5,t.strokeStyle="#ef4444",t.beginPath(),t.moveTo(118,20),t.bezierCurveTo(110,5,200,30,245,60),t.stroke(),t.strokeStyle="#111827",t.beginPath(),t.moveTo(122,20),t.bezierCurveTo(130,8,210,45,245,75),t.stroke();const p=245,u=40,r=135,b=90;t.fillStyle="#18181b",t.strokeStyle="#6366f1",t.lineWidth=2.5,t.beginPath(),t.roundRect(p,u,r,b,10),t.fill(),t.stroke(),t.fillStyle="#022c22",t.beginPath(),t.roundRect(p+10,u+12,r-20,34,4),t.fill(),t.font='bold 17px "Courier New"',t.fillStyle="#10b981",t.textAlign="right",t.fillText(e.currentResistance.toFixed(2)+" Ω",p+r-16,u+34),t.font="6px Arial",t.fillStyle="#a7f3d0",t.textAlign="left",t.fillText("PLATINUM RTD METER",p+14,u+21),e.showLabels&&(Q(t,116,100,10,70,c("tools.thermometerLab.labels.metalSheath"),"left"),Q(t,120,225,230,205,c("tools.thermometerLab.labels.platinumCoil"),"left"))}function zt(t){t.strokeStyle="#111827",t.lineWidth=1.2,t.beginPath(),t.moveTo(118,20),t.lineTo(118,245),t.stroke(),t.beginPath(),t.moveTo(122,20),t.lineTo(122,245),t.stroke();const i=20,f=225,s=12,d=120-s/2,p=t.createLinearGradient(d,i,d+s,i);p.addColorStop(0,"rgba(229, 231, 235, 0.4)"),p.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),p.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),p.addColorStop(1,"rgba(209, 213, 219, 0.6)"),t.fillStyle=p,t.strokeStyle="rgba(156, 163, 175, 0.6)",t.lineWidth=.8,t.beginPath(),t.roundRect(d,i,s,f-i,[0,0,3,3]),t.fill(),t.stroke();const u=7,r=t.createRadialGradient(120-u*.2,245-u*.2,u*.1,120,245,u);r.addColorStop(0,"#6b7280"),r.addColorStop(.7,"#1f2937"),r.addColorStop(1,"#09090b"),t.fillStyle=r,t.strokeStyle="#030712",t.lineWidth=1.2,t.beginPath(),t.arc(120,245,u,0,Math.PI*2),t.fill(),t.stroke(),t.lineWidth=1.5,t.strokeStyle="#ef4444",t.beginPath(),t.moveTo(118,20),t.bezierCurveTo(110,5,200,30,245,60),t.stroke(),t.strokeStyle="#111827",t.beginPath(),t.moveTo(122,20),t.bezierCurveTo(130,8,210,45,245,75),t.stroke();const b=245,y=40,m=135,F=90;t.fillStyle="#18181b",t.strokeStyle="#10b981",t.lineWidth=2.5,t.beginPath(),t.roundRect(b,y,m,F,10),t.fill(),t.stroke(),t.fillStyle="#022c22",t.beginPath(),t.roundRect(b+10,y+12,m-20,34,4),t.fill(),t.font='bold 17px "Courier New"',t.fillStyle="#34d399",t.textAlign="right",t.fillText(e.currentThermistorR.toFixed(2)+" kΩ",b+m-16,y+34),t.font="5px Arial",t.fillStyle="#a7f3d0",t.textAlign="left",t.fillText(c("tools.thermometerLab.thermistor.meterLabelLine1"),b+14,y+52),t.fillText(c("tools.thermometerLab.thermistor.meterLabelLine2"),b+14,y+59),e.showLabels&&(Q(t,118,120,10,90,c("tools.thermometerLab.labels.leads"),"left"),Q(t,120,245,230,225,c("tools.thermometerLab.labels.semiconductorBead"),"left"))}function ft(t,l,o,n,i,f,s,d,p){const{gx:u,gy:r,gw:b,gh:y,tickFont:m}=l;t.strokeStyle="rgba(255, 255, 255, 0.2)",t.lineWidth=1,t.setLineDash([4,4]),t.beginPath(),t.moveTo(o,n),t.lineTo(o,r+y),t.stroke(),t.beginPath(),t.moveTo(o,n),t.lineTo(u,n),t.stroke(),t.setLineDash([]);const F=r+y+10;t.font=m,t.textAlign="center",t.textBaseline="top";const h=`${i.toFixed(1)}${s}`,v=t.measureText(h).width+10,D=18;t.fillStyle=p,t.beginPath(),t.roundRect(o-v/2,F-2,v,D,3),t.fill(),t.fillStyle="#000",t.fillText(h,o,F),t.textAlign="right",t.textBaseline="middle";const I=`${f.toFixed(2)} ${d}`,G=t.measureText(I).width+10;t.fillStyle=p,t.beginPath(),t.roundRect(u-G-2,n-7,G,15,3),t.fill(),t.fillStyle="#000",t.fillText(I,u-7,n)}function Ft(t){const l=q(),{minL:o,maxL:n}=_(),{minT:i,maxT:f,tickStep:s}=x(),d=N(o,n),p=P(t,l,i,f,s,d,e.thermometerTemp),{gx:u,gy:r,gw:b,gh:y,axisFont:m,yLabelX:F,xLabelY:h,dotR:v}={...l,...p};t.save(),t.translate(F,r+y/2),t.rotate(-Math.PI/2),t.font=m,t.fillStyle="#e4e4e7",t.fillText("Length of liquid column / cm",0,0),t.restore(),t.font=m,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",u+b/2,h);const D=f,I=T(0,i,f,u,b),G=$(L(0),o,n,r,y),E=T(D,i,f,u,b),R=$(L(D),o,n,r,y);t.strokeStyle="#ef4444",t.lineWidth=3,t.beginPath(),t.moveTo(I,G),t.lineTo(E,R),t.stroke();const B=e.thermometerTemp,Y=e.currentLength;if(B>=i&&B<=f){const U=T(B,i,f,u,b),ot=$(Y,o,n,r,y);ft(t,l,U,ot,B,Y,"°C","cm","#ef4444"),t.shadowColor="#ef4444",t.shadowBlur=10,t.fillStyle="#ef4444",t.beginPath(),t.arc(U,ot,v,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function Rt(t){const l=q(),{minR:o,maxR:n,ticks:i}=j(),f=x(),s=P(t,l,f.minT,f.maxT,f.tickStep,i,e.thermometerTemp),{gx:d,gy:p,gw:u,gh:r,axisFont:b,yLabelX:y,xLabelY:m,dotR:F}={...l,...s};t.save(),t.translate(y,p+r/2),t.rotate(-Math.PI/2),t.font=b,t.fillStyle="#e4e4e7",t.fillText("Resistance of platinum / Ω",0,0),t.restore(),t.font=b,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",d+u/2,m);const{minT:h,maxT:v}=f,D=v,I=T(0,h,v,d,u),G=$(X(0),o,n,p,r),E=T(D,h,v,d,u),R=$(X(D),o,n,p,r);t.strokeStyle="#6366f1",t.lineWidth=3,t.beginPath(),t.moveTo(I,G),t.lineTo(E,R),t.stroke();const B=e.thermometerTemp,Y=e.currentResistance;if(B>=h&&B<=v){const U=T(B,h,v,d,u),ot=$(Y,o,n,p,r);ft(t,l,U,ot,B,Y,"°C","Ω","#6366f1"),t.shadowColor="#6366f1",t.shadowBlur=10,t.fillStyle="#6366f1",t.beginPath(),t.arc(U,ot,F,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function Mt(t){const l=q(),o=x(),{minR:n,maxR:i,ticks:f}=at(o),s=P(t,l,o.minT,o.maxT,o.tickStep,f,e.thermometerTemp),{gx:d,gy:p,gw:u,gh:r,axisFont:b,yLabelX:y,xLabelY:m,dotR:F}={...l,...s},{minT:h,maxT:v}=o;t.save(),t.translate(y,p+r/2),t.rotate(-Math.PI/2),t.font=b,t.fillStyle="#e4e4e7",t.fillText("Resistance of thermistor / kΩ",0,0),t.restore(),t.font=b,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",d+u/2,m),t.strokeStyle="#10b981",t.lineWidth=3,t.beginPath();let D=!1;for(let E=h;E<=v;E+=1){const R=E+273.15,B=e.thermistorR25*Math.exp(e.thermistorBeta*(1/R-1/298.15)),Y=T(E,h,v,d,u),U=$(Math.min(i,B),n,i,p,r);U>=p&&U<=p+r&&(D?t.lineTo(Y,U):(t.moveTo(Y,U),D=!0))}t.stroke();const I=e.thermometerTemp,G=e.currentThermistorR;if(I>=h&&I<=v){const E=T(I,h,v,d,u),R=$(Math.min(i,G),n,i,p,r);ft(t,l,E,R,I,G,"°C","kΩ","#10b981"),t.shadowColor="#10b981",t.shadowBlur=10,t.fillStyle="#10b981",t.beginPath(),t.arc(E,R,F,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function mt(){O.clearRect(0,0,J,lt),z.clearRect(0,0,w,k),O.save(),O.translate(C,0),Lt(O),e.thermometerType==="liquid"?qt(O):e.thermometerType==="resistance"?$t(O):zt(O),O.restore(),e.thermometerType==="liquid"?Ft(z):e.thermometerType==="resistance"?Rt(z):Mt(z)}function Pt(){const{sm:t,md:l,lg:o,xs:n,sub:i}=W,f=a.querySelector("#tl-svg-formula-liquid");f&&(f.innerHTML=`
        <svg height="50" width="240" style="background:transparent; overflow:visible;">
          ...
          <text x="55" y="18" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">L<tspan dy="2" font-size="${i}">100</tspan><tspan dy="-2"> - L</tspan><tspan dy="2" font-size="${i}">0</tspan><tspan dy="-2"></tspan></text>
          ...
          <text x="175" y="18" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">L<tspan dy="2" font-size="${i}">T</tspan><tspan dy="-2"> - L</tspan><tspan dy="2" font-size="${i}">0</tspan><tspan dy="-2"></tspan></text>
      ...
      `}const d=a.querySelector("#tl-svg-formula-resistance");d&&(d.innerHTML=`
        <svg height="50" width="240" style="background:transparent; overflow:visible;">
          <line x1="10" y1="26" x2="100" y2="26" stroke="#fff" stroke-width="1.5" />
          <text x="55" y="18" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">R<tspan dy="2" font-size="${i}">100</tspan><tspan dy="-2"> - R</tspan><tspan dy="2" font-size="${i}">0</tspan><tspan dy="-2"></tspan></text>
          <text x="55" y="41" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">100 - 0</text>
          
          <text x="110" y="31" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${l}">=</text>
          
          <line x1="130" y1="26" x2="220" y2="26" stroke="#fff" stroke-width="1.5" />
          <text x="175" y="18" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">R<tspan dy="2" font-size="${i}">T</tspan><tspan dy="-2"> - R</tspan><tspan dy="2" font-size="${i}">0</tspan><tspan dy="-2"></tspan></text>
          <text x="175" y="41" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">T - 0</text>
        </svg>
      ...
      `}}function Gt(){const t=a.querySelector("#tl-faulty-svg-container");if(!t)return;const{cf:l,cu:o,interval:n}=ht(),i=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,f=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,s=a.querySelector("#tl-pane-q10a").classList.contains("active"),d=s?(i-l)/n*100:f,p=s?i:f/100*n+l,r=(b=>130-b/100*80)(d);t.innerHTML=`
    ...
    `}function Et(t){a.querySelector("#tl-bath-temp-display").innerHTML=e.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=e.bathTemp.toFixed(1)+" °C";const l=a.querySelector("#tl-bath-state");e.bathTemp<=0?l.textContent="Melting Ice Bath":e.bathTemp>=100?l.textContent="Boiling Water/Steam":e.bathTemp===150?l.textContent="Hot Cooking Oil":l.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=t.toFixed(2)+" s";const o=a.querySelector("#tl-alcohol-boiling-warning");e.thermometerType==="liquid"&&e.liquidType==="alcohol"&&e.bathTemp>=78?o.style.display="block":o.style.display="none",e.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=e.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=e.thermometerTemp.toFixed(1)+"°C"):e.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=e.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=e.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=e.currentThermistorR.toFixed(2)+" kΩ",Pt()}let dt=null;function bt(t){e.lastTimestamp||(e.lastTimestamp=t);const l=(t-e.lastTimestamp)/1e3;e.lastTimestamp=t;const o=Math.min(l,.1),n=kt(),i=o/n*(e.bathTemp-e.thermometerTemp);e.thermometerTemp+=i,e.currentLength=e.liquidL0+(e.liquidL100-e.liquidL0)/100*e.thermometerTemp,e.currentResistance=e.resistanceR0+(e.resistanceR100-e.resistanceR0)/100*e.thermometerTemp;const f=e.thermometerTemp+273.15;e.currentThermistorR=e.thermistorR25*Math.exp(e.thermistorBeta*(1/f-1/298.15)),Ct(),mt(),Et(n),dt=requestAnimationFrame(bt)}function ht(){const t=parseFloat(a.querySelector("#tl-input-faulty-cf").value),l=parseFloat(a.querySelector("#tl-input-faulty-cu").value),o=Number.isFinite(t)?t:-1.5,n=Number.isFinite(l)?l:105,i=n-o;return{cf:o,cu:n,interval:i}}function ut(t){const l=Math.round(t*100)/100;return l>=0?l.toFixed(1):`(${l.toFixed(1)})`}function tt(){if(!a.querySelector("#tl-input-faulty-cf"))return;const{cf:t,cu:l,interval:o}=ht(),n=a.querySelector("#tl-val-faulty-interval"),i=a.querySelector("#tl-faulty-error-a"),f=a.querySelector("#tl-faulty-error-b"),s=Math.abs(o)<.01;n.textContent=o.toFixed(1)+" °C";const d=a.querySelector("#tl-svg-formula-faulty-a"),p=a.querySelector("#tl-svg-formula-faulty-b");if(s){i.hidden=!1,i.textContent="C_u must differ from C_f (interval cannot be zero).",f.hidden=!1,f.textContent=i.textContent,d&&(d.innerHTML=""),p&&(p.innerHTML="");return}i.hidden=!0,f.hidden=!0;const u=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,r=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,b=(u-t)/o*100,y=r/100*o+t;d&&(d.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `),Gt()}function Bt(){const{sm:t,md:l,sub:o}=W,n=e.thermometerTemp,i=e.liquidL100-e.liquidL0,f=e.liquidL0+i/100*n,s=a.querySelector("#tl-svg-formula-t-to-l");s&&(s.innerHTML=`
        <svg height="90" width="340" style="background:transparent; overflow:visible;">
          <line x1="10" y1="30" x2="100" y2="30" stroke="#fff" stroke-width="1.2" />
          <text x="55" y="21" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">${e.liquidL100.toFixed(1)} - ${e.liquidL0.toFixed(1)}</text>
          <text x="55" y="43" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">100 - 0</text>
          ...
          <text x="10" y="73" fill="#fff" font-family="Cambria, Georgia, serif" font-size="${t}">L<tspan dy="2" font-size="${o}">T</tspan><tspan dy="-2"> = ${e.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${i.toFixed(1)} / 100)</tspan> &times; ${n.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${f.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function At(){const{sm:t,md:l,sub:o}=W,n=e.thermometerTemp,i=e.resistanceR100-e.resistanceR0,f=e.resistanceR0+i/100*n,s=a.querySelector("#tl-svg-formula-t-to-r");s&&(s.innerHTML=`
        <svg height="90" width="340" style="background:transparent; overflow:visible;">
          <line x1="10" y1="30" x2="100" y2="30" stroke="#fff" stroke-width="1.2" />
          <text x="55" y="21" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">${e.resistanceR100.toFixed(1)} - ${e.resistanceR0.toFixed(1)}</text>
          <text x="55" y="43" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">100 - 0</text>
  ...
  `;function V(C){const w=Math.round(C*100)/100;return w>=0?w.toFixed(1):`(${w.toFixed(1)})`}function K(){const C=parseFloat(g.querySelector("#fsc-input-faulty-cf").value),w=parseFloat(g.querySelector("#fsc-input-faulty-cu").value),k=Number.isFinite(C)?C:-1.5,q=Number.isFinite(w)?w:105,x=q-k;return{cf:k,cu:q,interval:x}}function H(){const C=g.querySelector("#fsc-faulty-svg-container");if(!C)return;const{cf:w,cu:k,interval:q}=K(),x=parseFloat(g.querySelector("#fsc-input-q10a-cm").value)||0,T=parseFloat(g.querySelector("#fsc-input-q10b-t").value)||0,$=g.querySelector("#fsc-input-pane-q10a").classList.contains("active"),P=$?(x-w)/q*100:T,N=$?x:T/100*q+w,_=j=>130-j/100*80,L=Number.isFinite(P)?_(P):130;C.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        <g transform="translate(0, 0)">
          <rect x="80" y="25" width="12" height="115" rx="6" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
          <circle cx="86" cy="144" r="10" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
    ...
    `}function a(C){const w=C==="a";g.querySelector("#fsc-btn-solve-q10a").classList.toggle("active",w),g.querySelector("#fsc-btn-solve-q10b").classList.toggle("active",!w),g.querySelector("#fsc-input-pane-q10a").classList.toggle("active",w),g.querySelector("#fsc-input-pane-q10b").classList.toggle("active",!w),g.querySelector("#fsc-pane-q10a").classList.toggle("active",w),g.querySelector("#fsc-pane-q10b").classList.toggle("active",!w),e()}function e(){const{cf:C,cu:w,interval:k}=K(),q=g.querySelector("#fsc-val-faulty-interval"),x=g.querySelector("#fsc-faulty-error-a"),T=g.querySelector("#fsc-faulty-error-b"),$=g.querySelector("#fsc-svg-formula-faulty-a"),P=g.querySelector("#fsc-svg-formula-faulty-b"),N=Math.abs(k)<.01,_=c("tools.faultyCalibration.invalidInterval");if(q.textContent=k.toFixed(1)+" °C",N){x.hidden=!1,x.textContent=_,T.hidden=!1,T.textContent=_,$&&($.innerHTML=""),P&&(P.innerHTML=""),H();return}x.hidden=!0,T.hidden=!0;const L=parseFloat(g.querySelector("#fsc-input-q10a-cm").value)||0,j=parseFloat(g.querySelector("#fsc-input-q10b-t").value)||0,X=(L-C)/k*100,at=j/100*k+C;$&&($.innerHTML=`
      ...
      `),H()}g.querySelector("#fsc-btn-solve-q10a").addEventListener("click",()=>a("a")),g.querySelector("#fsc-btn-solve-q10b").addEventListener("click",()=>a("b")),g.querySelector("#fsc-input-faulty-cf").addEventListener("input",e),g.querySelector("#fsc-input-faulty-cu").addEventListener("input",e),g.querySelector("#fsc-input-q10a-cm").addEventListener("input",e),g.querySelector("#fsc-input-q10b-t").addEventListener("input",e);const W=g.querySelector(".tl-dash--faulty"),et=g.querySelector(".tl-controls"),M=g.querySelector("#fsc-controls-toggle"),J=g.querySelector("#fsc-controls-drag"),lt=g.querySelector(".tl-controls-float-bar");return W&&et&&M&&St({container:W,panel:et,toggleBtn:M,dragHandle:J,dragSurface:lt,storageKey:"s3phy-faulty-calibration",breakpoint:1024,getToggleTitle:C=>c(C?"tools.floatingControls.showParams":"tools.floatingControls.hideParams")}),e(),g._thermometerLabCleanup=()=>{},g}export{_t as createFaultyScaleCalibrationLab,Nt as createThermometerLab};
