(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function i(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=i(s);fetch(s.href,a)}})();const $e={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.hideLabList":"Hide lab list","tools.showLabList":"Show lab list","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.countLabel":"Number of questions (1–50)","worksheets.topics":"Topics","worksheets.generate":"Generate questions","worksheets.printPractice":"Print / Save as PDF","worksheets.printAnswers":"Print answer key","worksheets.empty":"Generate questions first.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.exportWordQuestions":"Word — Questions","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","worksheets.settingsTitle":"Worksheet settings","worksheets.bankTitle":"Question bank (current filters)","worksheets.bankAvailable":"Available to generate","worksheets.bankByTopic":"By topic","worksheets.bankNone":"Select at least one topic.","worksheets.exportTitle":"Export","worksheets.exportHint":"Word: .doc for Microsoft Word. Use Print → Save as PDF for a PDF copy.","worksheets.progressNone":"No session yet","worksheets.progressPrefix":"Completed","worksheets.hideSettings":"Hide settings","worksheets.showSettings":"Show settings","worksheets.hintEmpty":"Generate questions to see topic hints here.","worksheets.practiceTitle":"On-screen practice","worksheets.practiceHint":"First wrong: hint only. Second wrong: model answer.","worksheets.checkAnswer":"Check answer","worksheets.correct":"Correct.","worksheets.modelAnswer":"Model answer","flashcards.title":"Flashcards","flashcards.intro":"Study with spaced repetition — cards you find harder appear more often in later rounds. Picture decks for reflection, refraction, TIR, EM waves, and lenses.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","flashcards.mode.sequence":"Sequence","flashcards.mode.random":"Random","flashcards.again":"Again","flashcards.gotIt":"Got it","flashcards.round":"Round {round} · {total} cards","flashcards.flipFirst":"Tap the card, press Space, or Flip to reveal the answer first.","flashcards.hint.rated":"← Again · Got it →  (or keys 1 / 2)","flashcards.summary.title":"Round {round} complete","flashcards.summary.stats":"{total} cards studied · Again {again} · Got it {gotIt} · Next {neutral}","flashcards.summary.keep":"{count} to keep practising","flashcards.summary.confident":"{count} confident","flashcards.summary.nextRound":"Next round","flashcards.summary.restart":"Restart session","flashcards.summary.complete":"Session complete","flashcards.summary.completeStats":"Great work — you have finished all scheduled copies.","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF or image). Preview below or open in a new tab.","summary.viewImage":"Open full image","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","flashcards.deck.heatInternalEnergy":"Heat and internal energy","flashcards.deck.changeOfState":"Change of state","flashcards.deck.heatTransfer":"Heat transfer","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.specificHeat.title":"Specific Heat Capacity Lab","tools.thermalMixing.title":"Thermal Mixing Lab","tools.changeOfState.title":"Change of State Lab","tools.heatTransfer.title":"Heat Transfer Laboratory","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","tools.thermometerLab.liquid.title":"Liquid-in-Glass Thermometer","tools.thermometerLab.liquid.subtitle":"Explore the effects of bulb volume, capillary bore, and liquid type on sensitivity and response time.","tools.thermometerLab.resistance.title":"Platinum Resistance Thermometer","tools.thermometerLab.resistance.subtitle":"Investigate how platinum resistance varies linearly with temperature and solve calibration problems.","tools.thermometerLab.thermistor.title":"NTC Thermistor","tools.thermometerLab.thermistor.subtitle":"Study the non-linear resistance-temperature relationship of NTC thermistors and live beta calculations.","tools.thermometerLab.labels.show":"Show Structure Labels","tools.thermometerLab.labels.hide":"Hide Structure Labels","tools.thermometerLab.labels.thinWall":"Thin glass wall (fast heat transfer)","tools.thermometerLab.labels.largeBulb":"Large bulb (contains more liquid, increases sensitivity)","tools.thermometerLab.labels.narrowBore":"Narrow capillary bore (liquid rises higher, increases sensitivity)","tools.thermometerLab.labels.meniscus":"Meniscus (reading point)","tools.thermometerLab.labels.platinumCoil":"Platinum coil (resistance increases linearly with temp)","tools.thermometerLab.labels.metalSheath":"Metal sheath (protects & conducts heat quickly)","tools.thermometerLab.labels.semiconductorBead":"Semiconductor bead (resistance decreases exponentially with temp)","tools.thermometerLab.labels.leads":"Connecting leads","tools.thermometerLab.faulty.dualScale":"Dual-Scale Comparison Diagram","tools.thermometerLab.faulty.trueScale":"True Scale (°C)","tools.thermometerLab.faulty.faultyScale":"Faulty Scale (°C)","tools.thermometerLab.paramSettings":"Parameter settings","tools.floatingControls.dragHint":"Drag to move","tools.floatingControls.showParams":"Show parameters","tools.floatingControls.hideParams":"Hide parameters","tools.thermometerLab.faultySolver":"Faulty thermometer solver","tools.thermometerLab.resistanceSolver":"Resistance-to-temperature solver","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},It={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.hideLabList":"收合實驗列表","tools.showLabList":"顯示實驗列表","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.countLabel":"題數（1–50）","worksheets.topics":"課題","worksheets.generate":"產生題目","worksheets.printPractice":"列印／儲存 PDF","worksheets.printAnswers":"列印答案","worksheets.empty":"請先按「產生題目」。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.exportWordQuestions":"Word — 試題","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","worksheets.settingsTitle":"工作紙設定","worksheets.bankTitle":"題庫（依現有篩選）","worksheets.bankAvailable":"可產生題數","worksheets.bankByTopic":"按課題","worksheets.bankNone":"請至少選擇一個課題。","worksheets.exportTitle":"匯出","worksheets.exportHint":"Word：下載 .doc 以 Word 開啟。PDF 請用「列印」→「儲存 PDF」。","worksheets.progressNone":"尚未產生題目","worksheets.progressPrefix":"已完成","worksheets.hideSettings":"隱藏設定","worksheets.showSettings":"顯示設定","worksheets.hintEmpty":"產生題目後可在此看到提示。","worksheets.practiceTitle":"互動練習","worksheets.practiceHint":"第一次答錯只顯示提示；第二次答錯顯示參考答案。","worksheets.checkAnswer":"檢查答案","worksheets.correct":"正確。","worksheets.modelAnswer":"參考答案","flashcards.title":"閃卡","flashcards.intro":"使用間隔重複習—難記的卡片在下一輪會更頻繁出現。反射、折射、全內反射、電磁波、凸透鏡與凹透鏡課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","flashcards.mode.sequence":"順序","flashcards.mode.random":"隨機","flashcards.again":"再來","flashcards.gotIt":"懂了","flashcards.round":"第 {round} 輪 · {total} 張卡","flashcards.flipFirst":"請先點擊卡片、按空白鍵或翻面查看答案。","flashcards.hint.rated":"← 再來 · 懂了 →（或按 1 / 2）","flashcards.summary.title":"第 {round} 輪完成","flashcards.summary.stats":"共 {total} 張 · 再來 {again} · 懂了 {gotIt} · 下一張 {neutral}","flashcards.summary.keep":"{count} 張需繼續練習","flashcards.summary.confident":"{count} 張已掌握","flashcards.summary.nextRound":"下一輪","flashcards.summary.restart":"重新開始","flashcards.summary.complete":"練習完成","flashcards.summary.completeStats":"很好！你已完成所有排程的卡片。","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF 或圖片）。可於下方預覽，或新分頁開啟。","summary.viewImage":"開啟完整圖片","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","flashcards.deck.heatInternalEnergy":"熱與內能","flashcards.deck.changeOfState":"物態變化","flashcards.deck.heatTransfer":"熱傳入","tools.thermometerLab.title":"溫度計與校準實驗室","tools.specificHeat.title":"比熱容量實驗室","tools.thermalMixing.title":"熱混合實驗室","tools.changeOfState.title":"物態變化實驗室","tools.heatTransfer.title":"熱的轉移實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","tools.thermometerLab.liquid.title":"液體玻璃溫度計","tools.thermometerLab.liquid.subtitle":"探索玻璃泡容積、毛細管內外徑和液體種類對靉敏度及反應時間的影響。","tools.thermometerLab.resistance.title":"鈐電阻溫度計","tools.thermometerLab.resistance.subtitle":"研究鈐電阻如何隨溫度呈線性變化，並解決溫度校準問題。","tools.thermometerLab.thermistor.title":"NTC 熱敏電阻溫度計","tools.thermometerLab.thermistor.subtitle":"學習負溫度係數（NTC）熱敏電阻的非線性電阻-溫度關係，並進行實時 Beta 計算。","tools.thermometerLab.labels.show":"顯示結構標註","tools.thermometerLab.labels.hide":"隱藏結構標註","tools.thermometerLab.labels.thinWall":"薄玻璃壁 (快速傳熱)","tools.thermometerLab.labels.largeBulb":"大玻璃泡 (容納更多液體，提高靉敏度)","tools.thermometerLab.labels.narrowBore":"細毛細管 (液柱升得更高，提高靉敏度)","tools.thermometerLab.labels.meniscus":"彎月面 (讀數位置)","tools.thermometerLab.labels.platinumCoil":"鈐絲線圈 (電阻隨溫度線性增加)","tools.thermometerLab.labels.metalSheath":"金屬保護套 (保護並快速導熱)","tools.thermometerLab.labels.semiconductorBead":"半導體小珠 (電阻隨溫度指數級減少)","tools.thermometerLab.labels.leads":"連接導線","tools.thermometerLab.faulty.dualScale":"雙刻度對比示意圖","tools.thermometerLab.faulty.trueScale":"標準溫標 (°C)","tools.thermometerLab.faulty.faultyScale":"偏差溫標 (°C)","tools.thermometerLab.paramSettings":"參數設定","tools.floatingControls.dragHint":"拖曳以移動","tools.floatingControls.showParams":"顯示參數","tools.floatingControls.hideParams":"隱藏參數","tools.thermometerLab.faultySolver":"故障溫度計求解器","tools.thermometerLab.resistanceSolver":"電阻求溫度求解器","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},yt="s3phy.lang",wt={en:$e,"zh-Hant":It};let Ie="en";function Pt(){try{const t=localStorage.getItem(yt);if(t==="zh-Hant"||t==="en")return t}catch{}return"en"}function Wt(){Ie=Pt()}function xt(t){if(wt[t]){Ie=t;try{localStorage.setItem(yt,t)}catch{}document.documentElement.lang=t==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function de(){return Ie}function d(t){const r=wt[Ie]||$e;return Object.prototype.hasOwnProperty.call(r,t)?r[t]:Object.prototype.hasOwnProperty.call($e,t)?$e[t]:t}const Dt=.78;function We(){const t=document.documentElement,r=window.innerWidth,i=Math.max(window.innerHeight,1),o=r/i;let s=1;if(r<=1360?s=.88:r<=1500&&(s=.94),r>1700&&o>1.7){const a=Math.min(.07,(o-1.7)*.09),n=Math.min(.05,(r-1700)/1800*.05);s-=a+n}i<=700&&(s=Math.min(s,.82)),s=Math.max(Dt,Math.min(1,s)),t.style.setProperty("--hub-scale",s.toFixed(3))}function Ot(){return We(),window.addEventListener("resize",We),()=>window.removeEventListener("resize",We)}const Gt=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function Bt(t){function r(){t.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${Gt.map(({id:s,titleKey:a,descKey:n})=>`
            <div class="card">
              <h3>${d(a)}</h3>
              <p>${d(n)}</p>
    ...
    `;const o=t.querySelector("[data-lang]");o.innerHTML=`
...
`;function Nt(){if(document.getElementById(Ue))return;const t=document.createElement("style");t.id=Ue,t.textContent=jt,document.head.appendChild(t)}function Qt(t){Nt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
    <div class="rml-head">
  ...
  `;const i=r.querySelector(".rml-canvas"),o=i.getContext("2d"),s=r.querySelector("[data-rml-rot]"),a=r.querySelector("[data-rml-inc]"),n=r.querySelector('[data-rml-disp="rot"]'),l=r.querySelector('[data-rml-disp="inc"]'),P=r.querySelector('[data-rml-val="i"]'),E=r.querySelector('[data-rml-val="r"]'),A=r.querySelector('[data-rml-val="shift"]'),I=350,C=380,W=300,p="#22d3ee",q="bold 17px system-ui, sans-serif";let $=0,v=-140,g=!0,u=!0,m=!0,w=!0;function x(N){return N*Math.PI/180}function T(N,B,Y,ne,le,te=2,re=!1){o.beginPath(),o.lineWidth=te,o.strokeStyle=le,o.setLineDash(re?[6,6]:[]);const ee=N+Math.cos(x(Y))*ne,ie=B+Math.sin(x(Y))*ne;return o.moveTo(N,B),o.lineTo(ee,ie),o.stroke(),o.setLineDash([]),{x:ee,y:ie}}function G(N,B,Y,ne,le,te=14){const re=Y-N,ee=ne-B,ie=Math.hypot(re,ee);if(ie<1e-6)return;const be=re/ie,z=ee/ie,L=Y-be*te,S=ne-z*te,O=.45*te;o.beginPath(),o.fillStyle=le,o.moveTo(Y,ne),o.lineTo(L-z*O,S+be*O),o.lineTo(L+z*O,S-be*O),o.closePath(),o.fill()}function Q(N,B,Y,ne,le,te=25){o.beginPath(),o.strokeStyle=ne,o.lineWidth=2;const re=Math.min(N,B),ee=Math.max(N,B);if(o.arc(I,C,Y,x(re),x(ee),!1),o.stroke(),le){const ie=(re+ee)/2,be=I+Math.cos(x(ie))*(Y+te),z=C+Math.sin(x(ie))*(Y+te);o.save(),o.font="bold 14px system-ui, sans-serif",o.textAlign="center",o.textBaseline="middle",o.fillStyle=ne,o.fillText(le,be,z),o.restore()}}function V(N,B,Y,ne,le){o.clearRect(0,0,i.width,i.height),o.beginPath(),o.setLineDash([10,6]),o.strokeStyle="rgba(255, 204, 0, 0.45)",o.lineWidth=3,o.lineCap="round",o.moveTo(I-200,C),o.lineTo(I+200,C),o.stroke(),o.setLineDash([]),o.lineCap="butt";const te=I+Math.cos(x(N))*W,re=C+Math.sin(x(N))*W;o.beginPath(),o.lineWidth=3,o.strokeStyle="#fff",o.moveTo(te,re),o.lineTo(I,C),o.stroke();const ee=(te+I)*.5,ie=(re+C)*.5,be=Math.hypot(I-te,C-re)||1,z=(I-te)/be,L=(C-re)/be;if(G(ee-z*28,ie-L*28,ee,ie,"#fff",16),o.save(),o.font=q,o.textAlign="center",o.textBaseline="bottom",o.fillStyle="#fff",o.fillText(t("tools.rotatingMirror.canvas.incident"),te,re-12),o.restore(),g){const S=T(I,C,-90,W-60,"#00e676",1,!0);o.save(),o.font="bold 14px system-ui, sans-serif",o.textAlign="left",o.textBaseline="bottom",o.fillStyle="#00e676",o.fillText(t("tools.rotatingMirror.canvas.n"),S.x+6,S.y-4),o.restore()}if(u){const S=T(I,C,ne,W,"#00e676",2,!1);G(I,C,S.x,S.y,"#00e676",16),o.save(),o.font=q,o.textAlign="center",o.textBaseline="bottom",o.fillStyle="#00e676",o.fillText(t("tools.rotatingMirror.canvas.originalReflected"),S.x,S.y-14),o.restore()}o.save(),o.translate(I,C),o.rotate(x($)),o.beginPath(),o.lineWidth=6,o.strokeStyle="#ffcc00",o.lineCap="round",o.moveTo(-200,0),o.lineTo(200,0),o.stroke(),o.beginPath(),o.lineWidth=1,o.strokeStyle="#666";for(let S=-190;S<200;S+=15)o.moveTo(S,0),o.lineTo(S-5,8);if(o.stroke(),o.restore(),m){const S=T(I,C,B,W-40,p,2,!0);o.save(),o.font="bold 14px system-ui, sans-serif",o.textAlign="left",o.textBaseline="bottom",o.fillStyle=p,o.fillText(t("tools.rotatingMirror.canvas.nPrime"),S.x+6,S.y-4),o.restore()}if(w){const S=T(I,C,Y,W,p,4);G(I,C,S.x,S.y,p,16),Math.abs($)>.5&&(o.save(),o.font=q,o.textAlign="center",o.textBaseline="bottom",o.fillStyle=p,o.fillText(t("tools.rotatingMirror.canvas.newReflected"),S.x,S.y-14),o.restore())}if(m&&Q(N,B,100,"#ffcc00",`i=${le.toFixed(0)}°`,25),m&&w&&Q(B,Y,100,p,`r=${le.toFixed(0)}°`,25),g&&m&&Math.abs($)>.5&&Q(-90,B,50,"#ffcc00",`θ=${Math.abs($)}°`,20),u&&w&&Math.abs($)>.5){const S=Y-ne;Q(ne,Y,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${S.toFixed(0)}°`,40)}}function D(){$=parseFloat(s.value),v=parseFloat(a.value);const N=$>0?"+":"";n.textContent=`${N}${$}°`,l.textContent=`${v}°`;const B=-90,Y=Math.abs(v-B),ne=B+Y,le=-90+$,te=Math.abs(v-le),re=le+te,ee=re-ne;P.textContent=`${te.toFixed(1)}°`,E.textContent=`${te.toFixed(1)}°`;const ie=ee>0?"+":"";A.textContent=`${ie}${ee.toFixed(1)}°`,V(v,le,re,ne,te)}return r.querySelectorAll("[data-rml-toggle]").forEach(N=>{N.addEventListener("click",()=>{const B=N.getAttribute("data-rml-toggle");B==="orig-norm"&&(g=!g),B==="orig-ray"&&(u=!u),B==="new-norm"&&(m=!m),B==="new-ray"&&(w=!w),N.classList.toggle("active"),D()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",D()}),s.addEventListener("input",D),a.addEventListener("input",D),D(),r}function Vt(t){const r=document.createElement("div");r.className="tool-tir-escape";const i=document.createElement("iframe"),o="./",s=o.endsWith("/")?o:`${o}/`;return i.src=`${s}tir-escape/index.html?embed=1`,i.title=t("tools.refractionTir.title"),i.setAttribute("loading","lazy"),i.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(i),r}function Kt(t,r={}){const i=r.defaultKind==="concave"?"concave":"convex",o="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),n="./",l=n.endsWith("/")?n:`${n}/`;return a.src=`${l}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(i)}&v=2`,a.title=t(o),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function Ut(t){const r=document.createElement("div");r.className="tool-em-spectrum";const i=document.createElement("iframe"),o="./",s=o.endsWith("/")?o:`${o}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(de())}`}i.src=a(),i.title=t("tools.em.title"),i.setAttribute("loading","lazy"),i.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=i.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{i.src=a()}};return window.addEventListener("s3phy:lang",n),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(i),r}function Yt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const i=r.querySelector("[data-r]"),o=r.querySelector("[data-g]"),s=r.querySelector("[data-b]"),a=r.querySelector(".rgb-mixer-canvas"),n=r.querySelector(".rgb-mixer-stage"),l=a.getContext("2d");function P(p){return p.toString(16).padStart(2,"0")}function E(p,q,$){const v=a.width/(window.devicePixelRatio||1),g=a.height/(window.devicePixelRatio||1),u=v/2,m=g/2,w=Math.min(v,g)*.34,x=w*.5,T=Math.sqrt(3)/2;l.clearRect(0,0,v,g),l.fillStyle="#000",l.fillRect(0,0,v,g);const G=[{x:u,y:m-x,rgb:[255,0,0],val:p},{x:u-x*T,y:m+x*.5,rgb:[0,255,0],val:q},{x:u+x*T,y:m+x*.5,rgb:[0,0,255],val:$}];l.globalCompositeOperation="lighter",G.forEach(Q=>{if(Q.val<=0)return;const V=Q.val/255,[D,N,B]=Q.rgb,Y=l.createRadialGradient(Q.x,Q.y,0,Q.x,Q.y,w);Y.addColorStop(0,`rgba(${D},${N},${B},${V})`),Y.addColorStop(.65,`rgba(${D},${N},${B},${V})`),Y.addColorStop(.85,`rgba(${D},${N},${B},${V*.5})`),Y.addColorStop(1,`rgba(${D},${N},${B},0)`),l.fillStyle=Y,l.beginPath(),l.arc(Q.x,Q.y,w,0,Math.PI*2),l.fill()}),l.globalCompositeOperation="source-over"}function A(){const p=n.getBoundingClientRect(),q=Math.max(200,Math.min(p.width-8,p.height-8,720)),$=window.devicePixelRatio||1;a.width=q*$,a.height=q*$,a.style.width=`${q}px`,a.style.height=`${q}px`,l.setTransform($,0,0,$,0,0),E(+i.value,+o.value,+s.value)}function I(){const p=+i.value,q=+o.value,$=+s.value,v=`rgb(${p}, ${q}, ${$})`,g=`#${P(p)}${P(q)}${P($)}`;r.querySelector("[data-r-val]").textContent=p,r.querySelector("[data-g-val]").textContent=q,r.querySelector("[data-b-val]").textContent=$,r.querySelector("[data-r-bar]").style.width=`${p/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${q/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${$/255*100}%`,i.style.setProperty("--fill",`${p/255*100}%`),o.style.setProperty("--fill",`${q/255*100}%`),s.style.setProperty("--fill",`${$/255*100}%`);const u=r.querySelector("[data-swatch]");u.style.backgroundColor=v,u.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${v}`),r.querySelector("[data-rgb-text]").textContent=v,r.querySelector("[data-hex-text]").textContent=g,E(p,q,$)}function C(p,q,$){i.value=p,o.value=q,s.value=$,I()}return[i,o,s].forEach(p=>p.addEventListener("input",I)),r.querySelectorAll(".rgb-presets button").forEach(p=>{p.addEventListener("click",()=>{C(+p.dataset.r,+p.dataset.g,+p.dataset.b)})}),new ResizeObserver(()=>A()).observe(n),requestAnimationFrame(()=>{A(),I()}),r}const Xt=["topics","notes","tools","worksheets","flashcards","summary"],Zt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function St(t,{subtitleKey:r,activeSection:i,onSection:o,onLang:s}){t.innerHTML=`
    <header class="site-header">
      <div class="site-header__brand">
        ...
        <div class="brand-text-block">
          <h1 class="site-title">${d("app.title")}</h1>
          <p class="site-subtitle" data-hub-subtitle>${d(r)}</p>
        </div>
      </div>
      <div class="site-header__actions">
  ...
  `;const a=t.querySelector("[data-main]"),n=t.querySelector("[data-nav]"),l=t.querySelector("[data-lang]"),P=t.querySelector("[data-strand-back]");let E=i;function A(p){E=p,n.innerHTML=Xt.map(q=>`<button type="button" class="${p===q?"active":""}" data-sec="${q}">${d(Zt[q])}</button>`).join(""),n.querySelectorAll("button").forEach(q=>{q.addEventListener("click",()=>o(q.getAttribute("data-sec")))})}function I(){l.innerHTML=`
      <button type="button" data-set-lang="en" class="${de()==="en"?"active":""}">${d("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${de()==="zh-Hant"?"active":""}">${d("lang.zhHant")}</button>
    `,l.querySelectorAll("button").forEach(p=>{p.addEventListener("click",()=>{xt(p.getAttribute("data-set-lang")),s()})})}function C(){t.querySelector("[data-hub-subtitle]").textContent=d(r),P.textContent=d("strand.back"),t.querySelector("[data-hub-footer]").textContent=d("footer.conventions"),t.querySelector(".site-title").textContent=d("app.title")}const W=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return P.addEventListener("click",W),A(i),I(),{main:a,updateSection(p){A(p)},refreshLabels(){C(),A(E),I()},destroy(){P.removeEventListener("click",W)}}}const Ye="s3phy:tool-picker-collapsed",Jt=820;function qt({toolOrder:t,toolId:r,getLabel:i,t:o}){const s=t.map(a=>`<button type="button" data-tool="${a}" class="${r===a?"active":""}">${i(a)}</button>`).join("");return`
      <section class="panel panel--tools" data-tools-panel>
        <div class="tools-panel-head">
          <div class="tools-panel-head__text">
            <h2>${o("tools.title")}</h2>
            <p class="tools-active-lab" data-tool-active-label hidden>${i(r)}</p>
          </div>
      ...
      </section>`}function Tt(t,{getLabel:r,t:i,onSelectTool:o,mountTool:s,getActiveToolId:a}){const n=t.querySelector("[data-tools-panel]"),l=t.querySelector("[data-tool-picker]"),P=t.querySelector("[data-tool-list]"),E=t.querySelector("[data-tool-stage]"),A=t.querySelector("[data-tool-picker-toggle]"),I=t.querySelector("[data-tool-picker-toggle-label]"),C=t.querySelector("[data-tool-picker-chevron]"),W=t.querySelector("[data-tool-active-label]");if(!n||!l||!P||!E||!A)return;let p=sessionStorage.getItem(Ye)==="true";const q=()=>{W&&(W.textContent=r(a()))},$=()=>{A.setAttribute("aria-expanded",p?"false":"true"),I&&(I.textContent=i(p?"tools.showLabList":"tools.hideLabList")),C&&(C.textContent=p?"▼":"▲"),W&&(W.hidden=!p)},v=g=>{p=g,n.classList.toggle("is-picker-collapsed",p),sessionStorage.setItem(Ye,p?"true":"false"),$()};n.classList.toggle("is-picker-collapsed",p),q(),$(),A.addEventListener("click",()=>{v(!p)}),P.querySelectorAll("button").forEach(g=>{g.addEventListener("click",()=>{const u=g.getAttribute("data-tool");u&&(o(u),P.querySelectorAll("button").forEach(m=>{m.classList.toggle("active",m.getAttribute("data-tool")===u)}),q(),s(E),window.innerWidth<=Jt&&v(!0))})}),s(E)}const Te=["A","B","C","D"];function Xe(t){const r=t.slice();for(let i=r.length-1;i>0;i-=1){const o=Math.floor(Math.random()*(i+1));[r[i],r[o]]=[r[o],r[i]]}return r}function Ze(t,r,i){return t.filter(o=>{if(i)return i(o,r);const s=o.topic;return!!(r.includes(s)||r.includes("rotatingMirror")&&s==="reflection"||r.includes("refraction")&&s==="refraction"||r.includes("tir")&&s==="tir"||s==="convex"&&r.includes("convex")||s==="concave"&&r.includes("concave"))})}function Z(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ct(t,r={}){const i=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      ...
      <div class="ws-layout" id="ws-layout">
        <aside class="ws-settings-panel no-print" id="ws-settings-panel">
          ...
          <div class="ws-topic-checks" data-ws-topics>
            ${i.map(([o,s])=>`<label class="ws-check-card">
    ...
    </section>`}function zt(t,r,i,o,s={}){var te,re,ee,ie,be;const a={items:[],userAnswers:{},wrongAttempts:{},resolved:{},pending:{}},n=t.querySelector("#ws-layout");t.querySelector("#ws-settings-panel");const l=t.querySelector("#ws-bank-summary"),P=t.querySelector("[data-ws-gen]"),E=t.querySelector("[data-ws-body]"),A=t.querySelector("[data-ws-progress-text]"),I=t.querySelector("[data-ws-progress-bar]"),C=t.querySelector("[data-ws-summary]"),W=t.querySelector("[data-ws-summary-btn]"),p=t.querySelector("[data-ws-toggle-settings]"),q=t.querySelector("[data-ws-toggle-label]"),$=t.querySelector("[data-ws-toggle-icon]"),v=t.querySelector("[data-ws-strand-label]"),g=t.querySelector("[data-ws-print-sheet]");if(!P||!E)return;v&&s.paperTitleKey?v.textContent=i(s.paperTitleKey).toUpperCase():v&&(v.textContent=i("worksheets.paperTitle").toUpperCase());function u(){return o()}function m(){return[...t.querySelectorAll("[data-ws-topic]")].filter(z=>z.checked).map(z=>z.getAttribute("data-ws-topic"))}function w(z){var O,J;const L=t.querySelector(`[data-ws-topic="${z}"]`),S=(O=L==null?void 0:L.closest(".ws-check-card"))==null?void 0:O.querySelector("span");return((J=S==null?void 0:S.textContent)==null?void 0:J.trim())||z}function x(){if(!l)return;const z=m();if(!z.length){l.innerHTML=`<p class="ws-bank-title">${Z(i("worksheets.bankTitle"))}</p>
        <p class="ws-bank-muted">${Z(i("worksheets.bankNone"))}</p>`;return}const L=Ze(r,z,s.topicFilter),S=z.map(O=>{const J=L.filter(ae=>s.topicFilter?s.topicFilter(ae,[O]):O==="rotatingMirror"?ae.topic==="reflection":O==="refraction"?ae.topic==="refraction":ae.topic===O).length;return`<li><span>${Z(w(O))}</span><strong>${J}</strong></li>`}).join("");l.innerHTML=`
      <p class="ws-bank-title">${Z(i("worksheets.bankTitle"))}</p>
      <p class="ws-bank-muted">${Z(i("worksheets.bankAvailable"))}</p>
      <p class="ws-bank-count">${L.length}</p>
      <p class="ws-bank-muted ws-bank-by-topic">${Z(i("worksheets.bankByTopic"))}</p>
      <ul class="ws-bank-list">${S}</ul>`}function T(){if(!a.items.length){A&&(A.textContent=i("worksheets.progressNone")),I&&(I.style.width="0%");return}const z=a.items.filter((L,S)=>a.resolved[S]).length;A&&(A.textContent=`${i("worksheets.progressPrefix")} ${z} / ${a.items.length}`),I&&(I.style.width=`${z/a.items.length*100}%`)}function G(){a.userAnswers={},a.wrongAttempts={},a.resolved={},a.pending={},C&&(C.hidden=!0,C.innerHTML="")}function Q(){return a.items.length>0&&a.items.every((z,L)=>a.resolved[L])}function V(z,L){const S=z[u()]||z.en,O=L+1,J={selected:a.pending[L]??a.userAnswers[L],wrong:a.wrongAttempts[L]||0,solved:a.resolved[L]},ae=z.section?Z(z.section):Z(z.topic||""),we=S.choices.map((Ce,xe)=>{const ze=Te[xe],Se=J.selected===xe,Ee=J.solved&&xe===S.a,Le=["ws-option-btn"];Se&&!J.solved&&Le.push("ws-option-btn--selected"),Ee&&Le.push("ws-option-btn--correct");const Pe=J.solved?" disabled":"";return`<button type="button" class="${Le.join(" ")}" data-ws-option="${xe}" data-ws-q="${L}"${Pe}>
        ...
        <strong>${Z(i("worksheets.hint"))}:</strong> ${Z(S.hint||S.exp)}
      </div>`:J.solved&&J.selected!==S.a?se=`<div class="ws-feedback ws-feedback--model" role="status">
        <strong>${Z(i("worksheets.modelAnswer"))}:</strong> ${Z(Te[S.a])}
        <span class="ws-feedback-exp">${Z(S.exp)}</span>
      </div>`:J.solved&&J.selected===S.a&&(se=`<div class="ws-feedback ws-feedback--correct" role="status">${Z(i("worksheets.correct"))}</div>`);const he=J.solved?" disabled":"";return`<article class="ws-q-block ${J.solved?J.selected===S.a?"ws-q-block--correct":"ws-q-block--incorrect":""}" data-ws-block="${L}">
      <div class="ws-q-meta">Q${O} · ${ae.toUpperCase()} · MCQ</div>
      <p class="ws-q-stem">${Z(S.q)}</p>
      <div class="ws-options">${we}</div>
      <button type="button" class="ws-check-btn" data-ws-check="${L}"${he}>${Z(i("worksheets.checkAnswer"))}</button>
      ${se}
    </article>`}function D(){if(!a.items.length){E.className="ws-quiz-area ws-quiz-empty",E.innerHTML=`<p>${Z(i("worksheets.empty"))}</p>`;return}E.className="ws-quiz-area",E.innerHTML=a.items.map((z,L)=>V(z,L)).join(""),E.querySelectorAll("[data-ws-option]").forEach(z=>{z.addEventListener("click",()=>{const L=Number(z.getAttribute("data-ws-q"));if(a.resolved[L])return;const S=Number(z.getAttribute("data-ws-option"));a.pending[L]=S,E.querySelectorAll(`[data-ws-q="${L}"][data-ws-option]`).forEach(O=>{O.classList.toggle("ws-option-btn--selected",Number(O.getAttribute("data-ws-option"))===S)})})}),E.querySelectorAll("[data-ws-check]").forEach(z=>{z.addEventListener("click",()=>{const L=Number(z.getAttribute("data-ws-check"));if(a.resolved[L])return;const S=a.pending[L];if(S===void 0)return;const O=a.items[L][u()]||a.items[L].en;a.userAnswers[L]=S,S===O.a?a.resolved[L]=!0:(a.wrongAttempts[L]=(a.wrongAttempts[L]||0)+1,a.wrongAttempts[L]>=2&&(a.resolved[L]=!0)),T(),Q()&&N(),D()})})}function N(){const z=a.items.length;let L=0,S=0;const O={};a.items.forEach((se,he)=>{const ve=se[u()]||se.en;if(a.userAnswers[he]===ve.a)L+=1,(a.wrongAttempts[he]||0)===0&&(S+=1);else if(a.resolved[he]){const xe=se.section||se.topic;O[xe]=(O[xe]||0)+1}});const J=z?Math.round(L/z*100):0;let ae=i("worksheets.revisionFair");J>=90?ae=i("worksheets.revisionExcellent"):J>=70?ae=i("worksheets.revisionGood"):J<50&&(ae=i("worksheets.revisionLow"));const we=Object.entries(O).sort((se,he)=>he[1]-se[1]).map(([se,he])=>`<li>${Z(se)} (${he})</li>`).join("");C.innerHTML=`
      <h4>${Z(i("worksheets.sessionSummary"))}</h4>
      <p>${Z(i("worksheets.score"))}: <strong>${L}/${z}</strong> (${J}%)</p>
      <p>${Z(i("worksheets.firstTry"))}: <strong>${S}/${z}</strong></p>
      <p>${Z(i("worksheets.revisionSuggestions"))}: ${Z(ae)}</p>
      ${we?`<p>${Z(i("worksheets.weakSections"))}:</p><ul>${we}</ul>`:""}`,C.hidden=!1}function B(z){const L=s.paperTitleKey?i(s.paperTitleKey):i("worksheets.paperTitle"),S=a.items.map((O,J)=>{const ae=O[u()]||O.en,we=ae.choices.map((he,ve)=>`<li>${Te[ve]}. ${Z(he)}</li>`).join(""),se=z?`<p><strong>${Z(i("worksheets.answer"))}:</strong> ${Te[ae.a]}<br/><em>${Z(ae.exp)}</em></p>`:"";return`<div class="ws-print-q"><strong>Q${J+1}.</strong> ${Z(ae.q)}<ol>${we}</ol>${se}</div>`}).join("");return`<h2>${Z(L)}</h2>${S}`}function Y(z){const L=s.paperTitleKey?i(s.paperTitleKey):i("worksheets.paperTitle"),S=a.items.map((O,J)=>{const ae=O[u()]||O.en,we=ae.choices.map((he,ve)=>`${Te[ve]}. ${he}`).join("<br/>"),se=z?`<p><b>${i("worksheets.answer")}:</b> ${Te[ae.a]}<br/><i>${ae.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${J+1}.</b> ${ae.q}<br/>${we}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${L}</title></head>
<body><h2>${L}</h2>${S}</body></html>`}function ne(z){if(!a.items.length)return;const L=Y(z),S=new Blob(["\uFEFF",L],{type:"application/msword"}),O=document.createElement("a");O.href=URL.createObjectURL(S),O.download=z?"worksheet-answers.doc":"worksheet.doc",O.click(),URL.revokeObjectURL(O.href)}function le(z){if(!a.items.length||!g)return;g.hidden=!1,g.innerHTML=B(z);const L=()=>{g.hidden=!0,g.innerHTML="",document.body.classList.remove("ws-printing")};document.body.classList.add("ws-printing"),window.addEventListener("afterprint",L,{once:!0}),window.print()}P.addEventListener("click",()=>{const z=Math.min(50,Math.max(1,Number(t.querySelector("[data-ws-count]").value)||10)),L=m();if(!L.length)return;const S=Ze(r,L,s.topicFilter),O=Xe(S).slice(0,Math.min(z,S.length||1));a.items=O.length?O:Xe(r).slice(0,Math.min(z,r.length)),G(),T(),D()}),(te=t.querySelector("[data-ws-topics]"))==null||te.addEventListener("change",x),p==null||p.addEventListener("click",()=>{const z=n==null?void 0:n.classList.toggle("ws-layout--collapsed");q&&(q.textContent=i(z?"worksheets.showSettings":"worksheets.hideSettings")),$&&($.textContent=z?"›":"‹"),p.setAttribute("aria-expanded",z?"false":"true")}),W==null||W.addEventListener("click",()=>{if(a.items.length){if(!C.hidden&&C.innerHTML){C.hidden=!0;return}N()}}),(re=t.querySelector("[data-ws-word-p]"))==null||re.addEventListener("click",()=>ne(!1)),(ee=t.querySelector("[data-ws-word-a]"))==null||ee.addEventListener("click",()=>ne(!0)),(ie=t.querySelector("[data-ws-print-p]"))==null||ie.addEventListener("click",()=>le(!1)),(be=t.querySelector("[data-ws-print-a]"))==null||be.addEventListener("click",()=>le(!0)),x()}const ea=1.7,ta=.7,De=1,aa=.1,na=3;function ra(t){const r=Math.floor(t),i=t-r;return r+(Math.random()<i?1:0)}function Je(t){for(let r=t.length-1;r>0;r-=1){const i=Math.floor(Math.random()*(r+1));[t[r],t[i]]=[t[i],t[r]]}return t}function oa(t){const r=new Map(t.map(a=>[a.id,a.copies])),i=[];let o=null;const s=t.reduce((a,n)=>a+n.copies,0);for(let a=0;a<s;a+=1){let n=[...r.entries()].filter(([E,A])=>A>0&&E!==o);n.length===0&&(n=[...r.entries()].filter(([,E])=>E>0)),n.sort((E,A)=>A[1]-E[1]);const[l,P]=n[0];i.push(l),r.set(l,P-1),o=l}return i}function ia(t){const r=[];return t.forEach(({id:i,copies:o})=>{for(let s=0;s<o;s+=1)r.push(i)}),r}function sa(t){let r="sequence",i=1,o=[],s=[],a=0,n=!1,l=!1,P=!1;const E=new Map;function A(){return t()}function I(){return new Map(A().map(w=>[w.id,w]))}function C(){E.clear(),A().forEach(w=>{E.set(w.id,{nextRate:De,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function W(){const w=A();return i===1?w.map(x=>({id:x.id,copies:1})):w.map(x=>{var T;return{id:x.id,copies:ra(((T=E.get(x.id))==null?void 0:T.nextRate)??De)}}).filter(x=>x.copies>0)}function p(w){if(w.length===0)return[];if(i===1){const x=w.map(T=>T.id);return r==="random"?Je([...x]):[...x].sort((T,G)=>T-G)}return r==="random"?Je(ia(w)):oa(w)}function q(){if(l=!1,P=!1,o=W(),o.reduce((x,T)=>x+T.copies,0)===0){P=!0,l=!0,s=[],a=0;return}A().forEach(x=>{const T=E.get(x.id);T&&(T.roundAgain=0,T.roundGotIt=0,T.roundNeutral=0)}),s=p(o),a=0,n=!1}function $(){i=1,C(),q()}function v(){return s[a]??null}function g(){const w=v();return w==null?null:I().get(w)??null}function u(w){const x=v();if(x==null)return;const T=E.get(x);T&&(w==="again"?(T.nextRate=ea,T.totalGotIt=0,T.roundAgain+=1):w==="gotit"?(T.totalGotIt+=1,T.roundGotIt+=1,T.nextRate=T.totalGotIt>=na?aa:ta):w==="neutral"&&(T.roundNeutral+=1,T.nextRate=De))}function m(){return n=!1,a<s.length-1?(a+=1,!1):(l=!0,!0)}return $(),{getMode:()=>r,setMode(w){r!==w&&(r=w,s=p(o),a=0,n=!1)},resetSession:$,getRoundNumber:()=>i,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>n,flip(){n=!n},unflip(){n=!1},currentCard:g,prev(){return a>0?(a-=1,n=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,n=!1,!0):!1},rateAgain(){return n?(u("again"),m()):!1},rateGotIt(){return n?(u("gotit"),m()):!1},rateNeutral(){return n?(u("neutral"),m()):!1},isSummary:()=>l,isSessionComplete:()=>P,getRoundStats(){let w=0,x=0,T=0;return E.forEach(G=>{w+=G.roundAgain,x+=G.roundGotIt,T+=G.roundNeutral}),{again:w,gotIt:x,neutral:T}},nextRound(){i+=1,q()},restart(){$()}}}function Lt(t,{deckOptions:r,buildDeck:i,initialDeck:o="all"}){let s=o,a=null,n=null;t.innerHTML=`
    <section class="panel panel--flashcards">
      ...
      <div class="flash-study-controls no-print">
        <div class="control">
          ...
          <select data-fc-deck>
            ${r.map(v=>`<option value="${v.value}">${v.label}</option>`).join("")}
          </select>
        </div>
...
`;function Sa(){if(document.getElementById(ut))return;const t=document.createElement("style");t.id=ut,t.textContent=ka,document.head.appendChild(t)}function qa(t){const i={x:12,y:12},o=200,{container:s,panel:a,toggleBtn:n,dragHandle:l,storageKey:P,onLayoutChange:E,breakpoint:A=1024,collapsedClass:I="controls-collapsed",floatingClass:C="controls-floating"}=t;if(!s||!a||!n)return null;let W=sessionStorage.getItem(P)!=="false",p=(()=>{try{const V=localStorage.getItem(P+":pos");if(!V)return{...i};const D=JSON.parse(V);if(typeof D.x=="number"&&typeof D.y=="number")return D}catch{}return{...i}})(),q=null,$=null;const v=()=>window.innerWidth>=A,g=(V,D)=>{const N=s.getBoundingClientRect(),B=a.getBoundingClientRect(),Y=Math.max(0,N.width-B.width),ne=Math.max(0,N.height-B.height);return{x:Math.min(Math.max(0,V),Y),y:Math.min(Math.max(0,D),ne)}},u=()=>{a.style.left=p.x+"px",a.style.top=p.y+"px",a.style.right="auto",a.style.bottom="auto"},m=()=>{typeof E=="function"&&(clearTimeout($),$=setTimeout(E,o))},w=()=>{n.setAttribute("aria-expanded",W?"false":"true"),t.getToggleTitle&&(n.title=t.getToggleTitle(W));const V=n.querySelector("[data-float-chevron]");V&&(V.textContent=W?"v":"^")},x=V=>{W=V,a.classList.toggle(I,W),sessionStorage.setItem(P,W?"true":"false"),w(),m()},T=()=>{s.classList.add(C),a.classList.add("lab-controls-float"),p=g(p.x,p.y),u(),l&&(l.style.display="")},G=()=>{s.classList.remove(C),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",l&&(l.style.display="none")},Q=()=>{v()?(T(),p=g(p.x,p.y),u()):G(),m()};if(a.classList.toggle(I,W),w(),Q(),n.addEventListener("click",V=>{V.stopPropagation(),x(!W)}),l){l.addEventListener("pointerdown",D=>{v()&&(D.preventDefault(),q={pointerId:D.pointerId,startX:D.clientX,startY:D.clientY,originX:p.x,originY:p.y},l.setPointerCapture(D.pointerId),l.classList.add("is-dragging"))}),l.addEventListener("pointermove",D=>{!q||q.pointerId!==D.pointerId||(p=g(q.originX+D.clientX-q.startX,q.originY+D.clientY-q.startY),u())});const V=D=>{if(!(!q||q.pointerId!==D.pointerId)){l.releasePointerCapture(D.pointerId),l.classList.remove("is-dragging");try{localStorage.setItem(P+":pos",JSON.stringify(p))}catch{}q=null,m()}};l.addEventListener("pointerup",V),l.addEventListener("pointercancel",V)}return window.addEventListener("resize",Q),{setCollapsed:x,refreshMode:Q,isCollapsed:()=>W}}function Ge(t,r={}){Sa();const i=r.type||"liquid";let o=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");r.type==="liquid"?(o=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(o=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(o=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
      <h2 class="tl-title">${o}</h2>
  ...
  `;const n={liquidType:"mercury",thermometerType:i,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},l=460,P=340,E=80,A=800,I=560;function C(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:A-e.left-e.right,gh:I-e.top-e.bottom,tickFont:`bold ${Math.round(A*.024)}px Arial`,axisFont:`bold ${Math.round(A*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:I-e.bottom+32}}function W(){let c=100;const h=Math.max(n.bathTemp,n.thermometerTemp,100);h>120&&(c=150),h>145&&(c=200);const b=c<=100?20:25;return{minT:0,maxT:c,tickStep:b}}function p(e,c,h,b,f){return b+(e-c)/(h-c)*f}function q(e,c,h,b,f){return b+f-(e-c)/(h-c)*f}function $(e,c,h,b,f,F){const{gx:y,gy:k,gw:M,gh:H,tickFont:_,axisFont:j,yLabelX:X,xLabelY:R}=c;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const K of F){const U=q(K.value,K.min,K.max,k,H);e.beginPath(),e.moveTo(y,U),e.lineTo(y+M,U),e.stroke()}for(let K=h;K<=b+.01;K+=f){const U=p(K,h,b,y,M);e.beginPath(),e.moveTo(U,k),e.lineTo(U,k+H),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(y,k),e.lineTo(y,k+H),e.lineTo(y+M,k+H),e.stroke(),e.fillStyle="#e4e4e7",e.font=_,e.textAlign="right",e.textBaseline="middle";for(const K of F){const U=q(K.value,K.min,K.max,k,H);e.fillText(K.label,y-15,U)}e.textAlign="center",e.textBaseline="top";for(let K=h;K<=b+.01;K+=f){const U=p(K,h,b,y,M);e.fillText(`${Math.round(K)}`,U,k+H+10)}return{gx:y,gy:k,gw:M,gh:H,axisFont:j,yLabelX:X,xLabelY:R}}function v(e,c){const h=c-e,b=h<=8?1:h<=14?2:5,f=[],F=Math.ceil(e/b)*b;for(let y=F;y<=c+.001;y+=b)f.push({value:y,label:y%1===0?`${y.toFixed(0)}`:`${y.toFixed(1)}`,min:e,max:c});return f}function g(){const{maxT:e}=W(),c=u(0),h=u(e),b=h-c,f=Math.max(1,b*.1),F=Math.max(0,Math.round((c-f)*10)/10),y=Math.round((h+f)*10)/10;return{minL:F,maxL:y}}function u(e){return n.liquidL0+(n.liquidL100-n.liquidL0)/100*e}function m(){const{maxT:e}=W(),c=w(0),h=w(e),b=h-c,f=Math.max(.2,b*.1),F=Math.max(0,c-f),y=h+f,k=b<=2?.5:b<=4?1:2,M=[],H=Math.ceil(F/k)*k;for(let _=H;_<=y+.001;_+=k)M.push({value:_,label:_.toFixed(1),min:F,max:y});return{minR:F,maxR:y,ticks:M}}function w(e){return n.resistanceR0+(n.resistanceR100-n.resistanceR0)/100*e}function x(e){const{maxT:c}=e;let h=n.thermistorR25;for(let y=0;y<=c;y+=5){const k=y+273.15,M=n.thermistorR25*Math.exp(n.thermistorBeta*(1/k-1/298.15));h=Math.max(h,M)}h=Math.ceil(h*1.08*10)/10;const b=0,f=h<=12?2:4,F=[];for(let y=0;y<=h+.001;y+=f)F.push({value:y,label:y.toFixed(0),min:b,max:h});return{minR:b,maxR:h,ticks:F}}const T=a.querySelector("#tl-thermometerCanvas"),G=T.getContext("2d"),Q=a.querySelector("#tl-graphCanvas"),V=Q.getContext("2d"),D=window.devicePixelRatio||1;T.width=l*D,T.height=P*D,G.scale(D,D),Q.width=A*D,Q.height=I*D,V.scale(D,D);function N(){n.iceCubes=[];for(let e=0;e<5;e++)n.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});n.bubbles=[];for(let e=0;e<20;e++)n.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});n.heatWaves=[];for(let e=0;e<8;e++)n.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});n.steamParticles=[];for(let e=0;e<12;e++)n.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const B=200,Y=11;function ne(){const e=Math.pow(n.bulbVolume/B,.3333333333333333);return Y*e}function le(){if(n.thermometerType==="resistance"||n.thermometerType==="thermistor")return .35;const e=n.liquidType==="mercury"?1:8,c=.2+n.wallThickness*1.5,h=.4+n.bulbVolume*.003,b=1.35-n.capillaryBore*.45;return Math.max(.1,c*h*b*e*.15)}function te(e){n.bathTemp<=8&&n.iceCubes.forEach(c=>{c.x+=c.speedX,c.y+=c.speedY,(c.x<65||c.x>175)&&(c.speedX*=-1),(c.y<195||c.y>210)&&(c.speedY*=-1)}),n.bathTemp>35&&n.heatWaves.forEach(c=>{c.y-=c.speedY*(1+n.bathTemp/100),c.y<185&&(c.y=265,c.x=65+Math.random()*110)}),n.bathTemp>=80&&n.bubbles.forEach(c=>{c.y-=c.speedY*(1+(n.bathTemp-80)/40),c.phase+=c.wobbleSpeed,c.x+=Math.sin(c.phase)*.3,c.y<185&&(c.y=260+Math.random()*10,c.x=60+Math.random()*120)}),n.bathTemp>=95&&n.steamParticles.forEach(c=>{c.x+=c.vx,c.y+=c.vy,c.alpha-=.005,(c.alpha<=0||c.y<130)&&(c.x=60+Math.random()*120,c.y=175+Math.random()*5,c.alpha=.2+Math.random()*.4)})}function re(e){let y=59,k=130,M=246;if(n.bathTemp<25){const R=n.bathTemp/25;y=Math.round(180-R*121),k=Math.round(210-R*80),M=Math.round(250-R*4)}else{const R=Math.min(1,(n.bathTemp-25)/125);y=Math.round(59+R*180),k=Math.round(130-R*100),M=Math.round(246-R*190)}if(n.bathTemp>40){const R=Math.min(1,(n.bathTemp-40)/100),K=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${R*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let U=-25;U<=25;U+=6){const oe=R*(12+Math.sin(U*.4+K)*5);e.lineTo(55+130/2+U,284-oe)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const H=e.createLinearGradient(55,190,55,280);H.addColorStop(0,`rgba(${y}, ${k}, ${M}, 0.25)`),H.addColorStop(1,`rgba(${y}, ${k}, ${M}, 0.55)`),e.fillStyle=H,e.beginPath(),e.moveTo(55,190);const _=n.bathTemp>=80?2:.5,j=n.bathTemp>=80?.09:.03,X=Date.now()*j;for(let R=55;R<=185;R+=5){const K=190+Math.sin(R*.15+X)*_;e.lineTo(R,K)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),n.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(n.bathTemp-35)/120)})`,e.lineWidth=1.2,n.heatWaves.forEach(R=>{e.beginPath(),e.moveTo(R.x,R.y),e.quadraticCurveTo(R.x+Math.sin(R.y*.06)*5,R.y-R.length/2,R.x,R.y-R.length),e.stroke()})),n.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,n.iceCubes.forEach(R=>{e.save(),e.translate(R.x,R.y),e.rotate(R.angle),e.beginPath(),e.roundRect(-R.size/2,-R.size/2,R.size,R.size,3),e.fill(),e.stroke(),e.restore()})),n.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,n.bubbles.forEach(R=>{e.beginPath(),e.arc(R.x,R.y,R.r,0,Math.PI*2),e.fill(),e.stroke()})),n.bathTemp>=95&&n.steamParticles.forEach(R=>{e.fillStyle=`rgba(255, 255, 255, ${R.alpha})`,e.beginPath(),e.arc(R.x,R.y,R.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function ee(e,c,h,b,f,F,y="left"){if(!n.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(c,h),e.lineTo(b,f),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(c,h,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const M=e.measureText(F).width+10,H=16,_=y==="left"?b:b-M,j=f-H/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(_,j,M,H,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(F,_+M/2,j+H/2+.5)}function ie(e){const b=ne(),f=250+Math.max(0,b-Y)*.35,F=f-b-1,y=10+n.wallThickness*8,k=120-y/2,M=120+y/2,H=e.createLinearGradient(k,20,M,20);H.addColorStop(0,"rgba(209, 213, 219, 0.85)"),H.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),H.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),H.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),H.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=H,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(k,F),e.lineTo(k,25),e.arcTo(k,20,k+5,20,5),e.arcTo(M,20,M,25,5),e.lineTo(M,F),e.closePath(),e.fill(),e.stroke();const _=e.createRadialGradient(120-b*.2,f-b*.2,b*.1,120,f,b);_.addColorStop(0,"rgba(255, 255, 255, 0.8)"),_.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=_,e.strokeStyle="#6b7280",e.lineWidth=.8+n.wallThickness*.6,e.beginPath(),e.arc(120,f,b+.5+n.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const j=Math.min(y*.72,.8+n.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-j/2,28,j,F-20-8);const X=n.liquidType==="mercury",R=X?"#a1a1aa":"#ef4444",K=X?"#f4f4f5":"#fee2e2",U=210,oe=220,ye=(U-40)/oe,me=U-Math.min(oe,n.thermometerTemp)*ye;e.fillStyle=R,e.fillRect(120-j/2,me,j,F-me),e.beginPath(),e.ellipse(120,me,j/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=K,e.fillRect(120-j/6,me,j/3,F-me);const ue=b*.9,ce=e.createRadialGradient(120-ue*.2,f-ue*.2,ue*.1,120,f,ue);X?(ce.addColorStop(0,"#f4f4f5"),ce.addColorStop(.3,"#d4d4d8"),ce.addColorStop(.8,"#71717a"),ce.addColorStop(1,"#3f3f46")):(ce.addColorStop(0,"#fee2e2"),ce.addColorStop(.2,"#fca5a5"),ce.addColorStop(.7,"#ef4444"),ce.addColorStop(1,"#991b1b")),e.fillStyle=ce,e.beginPath(),e.arc(120,f,ue,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let fe=0;fe<=200;fe+=50){const ge=U-fe*ye;e.beginPath(),e.moveTo(k,ge),e.lineTo(k+4,ge),e.stroke(),e.fillText(`${fe}°C`,k-22,ge+2.5)}n.showLabels&&(ee(e,k+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),ee(e,120,me,230,me-15,t("tools.thermometerLab.labels.meniscus"),"left"),ee(e,120-j/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),ee(e,120,f,230,f+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function be(e){const y=e.createLinearGradient(115,20,125,20);y.addColorStop(0,"#71717a"),y.addColorStop(.3,"#f4f4f5"),y.addColorStop(.7,"#d4d4d8"),y.addColorStop(1,"#3f3f46"),e.fillStyle=y,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let k=205;e.moveTo(118,k);for(let X=0;X<8;X++)k+=4,e.lineTo(122,k),k+=4,e.lineTo(118,k);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const M=245,H=40,_=135,j=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(M,H,_,j,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(M+10,H+12,_-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(n.currentResistance.toFixed(2)+" Ω",M+_-16,H+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",M+14,H+21),n.showLabels&&(ee(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),ee(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function z(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const f=20,F=225,y=12,k=120-y/2,M=e.createLinearGradient(k,f,k+y,f);M.addColorStop(0,"rgba(229, 231, 235, 0.4)"),M.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),M.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),M.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=M,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(k,f,y,F-f,[0,0,3,3]),e.fill(),e.stroke();const H=7,_=e.createRadialGradient(120-H*.2,245-H*.2,H*.1,120,245,H);_.addColorStop(0,"#6b7280"),_.addColorStop(.7,"#1f2937"),_.addColorStop(1,"#09090b"),e.fillStyle=_,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,H,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const j=245,X=40,R=135,K=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(j,X,R,K,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(j+10,X+12,R-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(n.currentThermistorR.toFixed(2)+" kΩ",j+R-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",j+14,X+21),n.showLabels&&(ee(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),ee(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function L(e,c,h,b,f,F,y,k,M){const{gx:H,gy:_,gw:j,gh:X}=c;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(h,b),e.lineTo(h,_+X),e.stroke(),e.beginPath(),e.moveTo(h,b),e.lineTo(H,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const R=`${f.toFixed(1)}${y}`,K=e.measureText(R).width+10;e.fillStyle=M,e.beginPath(),e.roundRect(h-K/2,_+X+2,K,15,3),e.fill(),e.fillStyle="#000",e.fillText(R,h,_+X+4),e.textAlign="right",e.textBaseline="middle";const U=`${F.toFixed(2)} ${k}`,oe=e.measureText(U).width+10;e.fillStyle=M,e.beginPath(),e.roundRect(H-oe-2,b-7,oe,15,3),e.fill(),e.fillStyle="#000",e.fillText(U,H-7,b)}function S(e){const c=C(),{minL:h,maxL:b}=g(),{minT:f,maxT:F,tickStep:y}=W(),k=v(h,b),M=$(e,c,f,F,y,k),{gx:H,gy:_,gw:j,gh:X,axisFont:R,yLabelX:K,xLabelY:U,dotR:oe}={...c,...M};e.save(),e.translate(K,_+X/2),e.rotate(-Math.PI/2),e.font=R,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=R,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",H+j/2,U);const qe=F,ye=p(0,f,F,H,j),me=q(u(0),h,b,_,X),ue=p(qe,f,F,H,j),ce=q(u(qe),h,b,_,X);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(ye,me),e.lineTo(ue,ce),e.stroke();const fe=n.thermometerTemp,ge=n.currentLength;if(fe>=f&&fe<=F){const ke=p(fe,f,F,H,j),Re=q(ge,h,b,_,X);L(e,c,ke,Re,fe,ge,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ke,Re,oe,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function O(e){const c=C(),{minR:h,maxR:b,ticks:f}=m(),F=W(),y=$(e,c,F.minT,F.maxT,F.tickStep,f),{gx:k,gy:M,gw:H,gh:_,axisFont:j,yLabelX:X,xLabelY:R,dotR:K}={...c,...y};e.save(),e.translate(X,M+_/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",k+H/2,R);const{minT:U,maxT:oe}=F,qe=oe,ye=p(0,U,oe,k,H),me=q(w(0),h,b,M,_),ue=p(qe,U,oe,k,H),ce=q(w(qe),h,b,M,_);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(ye,me),e.lineTo(ue,ce),e.stroke();const fe=n.thermometerTemp,ge=n.currentResistance;if(fe>=U&&fe<=oe){const ke=p(fe,U,oe,k,H),Re=q(ge,h,b,M,_);L(e,c,ke,Re,fe,ge,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ke,Re,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function J(e){const c=C(),h=W(),{minR:b,maxR:f,ticks:F}=x(h),y=$(e,c,h.minT,h.maxT,h.tickStep,F),{gx:k,gy:M,gw:H,gh:_,axisFont:j,yLabelX:X,xLabelY:R,dotR:K}={...c,...y},{minT:U,maxT:oe}=h;e.save(),e.translate(X,M+_/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",k+H/2,R),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let qe=!1;for(let ue=U;ue<=oe;ue+=1){const ce=ue+273.15,fe=n.thermistorR25*Math.exp(n.thermistorBeta*(1/ce-1/298.15)),ge=p(ue,U,oe,k,H),ke=q(Math.min(f,fe),b,f,M,_);ke>=M&&ke<=M+_&&(qe?e.lineTo(ge,ke):(e.moveTo(ge,ke),qe=!0))}e.stroke();const ye=n.thermometerTemp,me=n.currentThermistorR;if(ye>=U&&ye<=oe){const ue=p(ye,U,oe,k,H),ce=q(Math.min(f,me),b,f,M,_);L(e,c,ue,ce,ye,me,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(ue,ce,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ae(){G.clearRect(0,0,l,P),V.clearRect(0,0,A,I),G.save(),G.translate(E,0),re(G),n.thermometerType==="liquid"?ie(G):n.thermometerType==="resistance"?be(G):z(G),G.restore(),n.thermometerType==="liquid"?S(V):n.thermometerType==="resistance"?O(V):J(V)}function we(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const c=a.querySelector("#tl-svg-formula-liquid-sub");if(c){const y=n.liquidL100-n.liquidL0,k=n.currentLength-n.liquidL0;c.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          ...
          <text x="55" y="38" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${n.liquidL100.toFixed(1)} - ${n.liquidL0.toFixed(1)}</text>
          ...
          <text x="175" y="38" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">${n.currentLength.toFixed(2)} - ${n.liquidL0.toFixed(1)}</text>
          ...
          <text x="160" y="72" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">${k.toFixed(2)} &times; 100</text>
          <text x="160" y="94" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${y.toFixed(1)}</text>
          
          <text x="215" y="85" fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" font-size="15" class="tl-final-ans">&rArr; T = ${n.thermometerTemp.toFixed(1)}°C</text>
        </svg>
      `}const h=a.querySelector("#tl-svg-formula-resistance");h&&(h.innerHTML=`
        <svg height="55" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="31" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">Slope Equation:</text>
          <line x1="120" y1="26" x2="210" y2="26" stroke="#fff" stroke-width="1.5" />
      ...
      `);const b=a.querySelector("#tl-svg-formula-resistance-sub");if(b){const y=n.resistanceR100-n.resistanceR0,k=n.currentResistance-n.resistanceR0;b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          <text x="55" y="38" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${n.resistanceR100.toFixed(1)} - ${n.resistanceR0.toFixed(1)}</text>
          <text x="55" y="60" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">100 - 0</text>
          
          <text x="110" y="52" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">=</text>
          
          <line x1="130" y1="47" x2="220" y2="47" stroke="#fff" stroke-width="1.2" />
          <text x="175" y="38" fill="#6366f1" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">${n.currentResistance.toFixed(2)} - ${n.resistanceR0.toFixed(1)}</text>
          <text x="175" y="60" fill="#fff" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">T - 0</text>

          <!-- Step 2: Simplify Ratio -->
          <text x="10" y="85" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 2: Solve for T</text>
          <line x1="120" y1="80" x2="200" y2="80" stroke="#fff" stroke-width="1.2" />
          <text x="160" y="72" fill="#6366f1" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">${k.toFixed(2)} &times; 100</text>
          <text x="160" y="94" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${y.toFixed(1)}</text>
          
          <text x="215" y="85" fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" font-size="15" class="tl-final-ans">&rArr; T = ${n.thermometerTemp.toFixed(1)}°C</text>
        </svg>
      `}const f=a.querySelector("#tl-svg-formula-thermistor");f&&(f.innerHTML=`
      ...
      `);const F=a.querySelector("#tl-svg-formula-thermistor-sub");if(F){const y=n.thermometerTemp+273.15;F.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            ...
            <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${n.thermometerTemp.toFixed(1)}°C</tspan>
          </text>
        </svg>
      `}}function se(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:c,cu:h,interval:b}=xe(),f=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,F=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,y=a.querySelector("#tl-pane-q10a").classList.contains("active"),k=y?(f-c)/b*100:F,M=y?f:F/100*b+c,_=(j=>130-j/100*80)(k);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Current Point -->
          <text x="65" y="${_+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${k.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="53" fill="#ef4444" font-size="10" font-weight="bold" text-anchor="start">C<tspan dy="3" font-size="7">u</tspan><tspan dy="-3"> = ${h.toFixed(1)}°C</tspan></text>
    ...
    `}function he(e){a.querySelector("#tl-bath-temp-display").innerHTML=n.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=n.bathTemp.toFixed(1)+" °C";const c=a.querySelector("#tl-bath-state");n.bathTemp<=0?c.textContent="Melting Ice Bath":n.bathTemp>=100?c.textContent="Boiling Water/Steam":n.bathTemp===150?c.textContent="Hot Cooking Oil":c.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const h=a.querySelector("#tl-alcohol-boiling-warning");n.thermometerType==="liquid"&&n.liquidType==="alcohol"&&n.bathTemp>=78?h.style.display="block":h.style.display="none",n.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=n.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=n.thermometerTemp.toFixed(1)+"°C"):n.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=n.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=n.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=n.currentThermistorR.toFixed(2)+" kΩ",we()}let ve=null;function Ce(e){n.lastTimestamp||(n.lastTimestamp=e);const c=(e-n.lastTimestamp)/1e3;n.lastTimestamp=e;const h=Math.min(c,.1),b=le(),f=h/b*(n.bathTemp-n.thermometerTemp);n.thermometerTemp+=f,n.currentLength=n.liquidL0+(n.liquidL100-n.liquidL0)/100*n.thermometerTemp,n.currentResistance=n.resistanceR0+(n.resistanceR100-n.resistanceR0)/100*n.thermometerTemp;const F=n.thermometerTemp+273.15;n.currentThermistorR=n.thermistorR25*Math.exp(n.thermistorBeta*(1/F-1/298.15)),te(),ae(),he(b),ve=requestAnimationFrame(Ce)}function xe(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),c=parseFloat(a.querySelector("#tl-input-faulty-cu").value),h=Number.isFinite(e)?e:-1.5,b=Number.isFinite(c)?c:105,f=b-h;return{cf:h,cu:b,interval:f}}function ze(e){const c=Math.round(e*100)/100;return c>=0?c.toFixed(1):`(${c.toFixed(1)})`}function Se(){const{cf:e,cu:c,interval:h}=xe(),b=a.querySelector("#tl-val-faulty-interval"),f=a.querySelector("#tl-faulty-error-a"),F=a.querySelector("#tl-faulty-error-b"),y=Math.abs(h)<.01;b.textContent=h.toFixed(1)+" °C";const k=a.querySelector("#tl-svg-formula-faulty-a"),M=a.querySelector("#tl-svg-formula-faulty-b");if(y){f.hidden=!1,f.textContent="C_u must differ from C_f (interval cannot be zero).",F.hidden=!1,F.textContent=f.textContent,k&&(k.innerHTML=""),M&&(M.innerHTML="");return}f.hidden=!0,F.hidden=!0;const H=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,_=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,j=(H-e)/h*100,X=_/100*h+e;k&&(k.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="170" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            &times; 100 = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${j.toFixed(1)}°C</tspan>
          </text>
        </svg>
      `),M&&(M.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${_.toFixed(1)} &times; ${h.toFixed(1)}</text>
      ...
      `),se()}function Ee(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,c=(e-n.resistanceR0)/(n.resistanceR100-n.resistanceR0)*100,h=a.querySelector("#tl-svg-formula-resistance-solver");h&&(h.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">&theta; =</text>
          <line x1="40" y1="21" x2="160" y2="21" stroke="#fff" stroke-width="1.5" />
          <text x="100" y="15" fill="#6366f1" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="13" text-anchor="middle">${e.toFixed(1)} - ${n.resistanceR0.toFixed(1)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="13" text-anchor="middle">${n.resistanceR100.toFixed(1)} - ${n.resistanceR0.toFixed(1)}</text>
          <text x="170" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            &times; 100 = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${c.toFixed(1)}°C</tspan>
          </text>
        </svg>
      `)}function Le(){const e=n.thermometerTemp,c=n.liquidL100-n.liquidL0,h=n.liquidL0+c/100*e,b=a.querySelector("#tl-svg-formula-t-to-l");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <line x1="130" y1="47" x2="220" y2="47" stroke="#fff" stroke-width="1.2" />
          <text x="175" y="38" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> - ${n.liquidL0.toFixed(1)}</tspan></text>
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${n.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${c.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${h.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function Pe(){const e=n.thermometerTemp,c=n.resistanceR100-n.resistanceR0,h=n.resistanceR0+c/100*e,b=a.querySelector("#tl-svg-formula-t-to-r");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <line x1="130" y1="47" x2="220" y2="47" stroke="#fff" stroke-width="1.2" />
          <text x="175" y="38" fill="#6366f1" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">R<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> - ${n.resistanceR0.toFixed(1)}</tspan></text>
          <text x="175" y="60" fill="#fff" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${e.toFixed(1)} - 0</text>
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">R<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${n.resistanceR0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${c.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${h.toFixed(2)} Ω</tspan>
          </text>
        </svg>
      `)}function pe(){Se(),Ee(),Le(),Pe()}function Fe(e,c){a.querySelector("#"+e).addEventListener("click",()=>{n.bathTemp=c,a.querySelector("#tl-bath-temp-slider").value=c,pe()})}function Ne(e){a.querySelectorAll(".tl-tab-btn").forEach(c=>{c.classList.toggle("active",c.getAttribute("data-tl-tab")===e)}),a.querySelectorAll(".tl-tab-content").forEach(c=>{c.classList.toggle("active",c.id==="tl-tab-"+e)}),a.querySelectorAll(".tl-live-tab").forEach(c=>{c.classList.toggle("active",c.id==="tl-live-"+e)}),n.thermometerType=e}function At(){a.querySelectorAll(".tl-tab-btn").forEach(f=>{f.addEventListener("click",()=>{Ne(f.getAttribute("data-tl-tab")),pe()})}),a.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{n.showLabels=!n.showLabels,a.querySelector("#tl-lbl-toggle-labels").textContent=n.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",f=>{n.bathTemp=parseFloat(f.target.value),pe()}),Fe("tl-btn-preset-ice",0),Fe("tl-btn-preset-room",25),Fe("tl-btn-preset-steam",100),Fe("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{n.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",pe()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{n.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",pe()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",f=>{n.bulbVolume=parseFloat(f.target.value),a.querySelector("#tl-val-bulb-vol").textContent=n.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",f=>{n.wallThickness=parseFloat(f.target.value),a.querySelector("#tl-val-wall-thickness").textContent=n.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-capillary-bore").addEventListener("input",f=>{n.capillaryBore=parseFloat(f.target.value),a.querySelector("#tl-val-capillary-bore").textContent=n.capillaryBore.toFixed(2)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",f=>{n.liquidL0=parseFloat(f.target.value),a.querySelector("#tl-val-liquid-l0").textContent=n.liquidL0.toFixed(1)+" cm",pe()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",f=>{n.liquidL100=parseFloat(f.target.value),a.querySelector("#tl-val-liquid-l100").textContent=n.liquidL100.toFixed(1)+" cm",pe()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",f=>{n.resistanceR0=parseFloat(f.target.value),a.querySelector("#tl-val-resistance-r0").textContent=n.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=n.resistanceR0.toFixed(1)+" Ω",pe()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",f=>{n.resistanceR100=parseFloat(f.target.value),a.querySelector("#tl-val-resistance-r100").textContent=n.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=n.resistanceR100.toFixed(1)+" Ω",pe()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",f=>{n.thermistorR25=parseFloat(f.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=n.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=n.thermistorR25.toFixed(1)+" kΩ",pe()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",f=>{n.thermistorBeta=parseFloat(f.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=n.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=n.thermistorBeta+" K",pe()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active"),Se()}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active"),Se()}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",Se),a.querySelector("#tl-input-faulty-cu").addEventListener("input",Se),a.querySelector("#tl-input-q10a-cm").addEventListener("input",Se),a.querySelector("#tl-input-q10b-t").addEventListener("input",Se),a.querySelector("#tl-input-q11-r").addEventListener("input",Ee);const h=a.querySelector("#tl-input-t-to-l");h&&h.addEventListener("input",pe);const b=a.querySelector("#tl-input-t-to-r");b&&b.addEventListener("input",pe)}if(r.type){const e=a.querySelector(".tl-tabs-container");e&&(e.style.display="none")}Ne(i),N(),At(),pe();const Qe=a.querySelector(".tl-dash"),Ve=a.querySelector(".tl-controls"),Ke=a.querySelector("#tl-controls-toggle"),$t=a.querySelector("#tl-controls-drag");return Qe&&Ve&&Ke&&qa({container:Qe,panel:Ve,toggleBtn:Ke,dragHandle:$t,storageKey:`s3phy-thermo-${i}`,breakpoint:xa,getToggleTitle:e=>t(e?"tools.floatingControls.showParams":"tools.floatingControls.hideParams"),onLayoutChange:()=>ae()}),ve=requestAnimationFrame(Ce),a._thermometerLabCleanup=()=>{ve&&cancelAnimationFrame(ve)},a}function Ta(t){const r=document.createElement("div");r.className="tool-specific-heat";const i=document.createElement("iframe"),o="./",s=o.endsWith("/")?o:o+"/";function a(){return s+"specific-heat/index.html?lang="+encodeURIComponent(de())}i.src=a(),i.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",i.setAttribute("loading","lazy"),i.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=i.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{i.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(i),r}function Ca(t){const r=document.createElement("div");r.className="tool-thermal-mixing";const i=document.createElement("iframe"),o="./",s=o.endsWith("/")?o:o+"/";function a(){return s+"thermal-mixing/index.html?lang="+encodeURIComponent(de())}i.src=a(),i.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",i.setAttribute("loading","lazy"),i.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=i.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{i.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(i),r}function za(t){const r=document.createElement("div");r.className="tool-change-of-state";const i=document.createElement("iframe"),o="./",s=o.endsWith("/")?o:o+"/";function a(){return s+"change-of-state/index.html?lang="+encodeURIComponent(de())}i.src=a(),i.title=t("tools.changeOfState.title")||"Change of State Lab",i.setAttribute("loading","lazy"),i.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=i.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{i.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(i),r}function La(t){const r=document.createElement("div");r.className="tool-heat-transfer";const i=document.createElement("iframe"),o="./",s=o.endsWith("/")?o:o+"/";function a(){return s+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(de())}i.src=a(),i.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",i.setAttribute("loading","lazy"),i.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=i.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{i.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(i),r}const Me=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],ft=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],Ra=[["thermometer","topic.thermometer"]],ht=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],Ma={liquid:t=>Ge(t,{type:"liquid"}),resistance:t=>Ge(t,{type:"resistance"}),thermistor:t=>Ge(t,{type:"thermistor"}),specificHeat:t=>Ta(t),thermalMixing:t=>Ca(t),changeOfState:t=>za(t),heatTransfer:t=>La(t)};function pt(t){return d({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function Be(){return de()==="zh-Hant"?"zhHant":"en"}async function Ht(t,r){const i=`./${t}/${r}`;try{return(await fetch(i,{method:"HEAD"})).ok}catch{return!1}}async function mt(t){return Ht("notes",t)}function Ha(t){let r="topics",i="liquid",o=null,s={main:null},a=null,n=null;const l=[{value:"all",labelKey:"flashcards.all"},{value:"thermometry",labelKey:"flashcards.deck.thermometry"},{value:"heatInternalEnergy",labelKey:"flashcards.deck.heatInternalEnergy"},{value:"changeOfState",labelKey:"flashcards.deck.changeOfState"},{value:"heatTransfer",labelKey:"flashcards.deck.heatTransfer"}];function P(){if(s.main){if(n==null||n(),n=null,r==="topics"?s.main.innerHTML=A():r==="notes"?s.main.innerHTML=C():r==="tools"?s.main.innerHTML=qt({toolOrder:ht,toolId:i,getLabel:pt,t:d}):r==="worksheets"?s.main.innerHTML=Ct(d,{topics:Ra}):r==="flashcards"?n=Lt(s.main,{deckOptions:l.map(u=>({value:u.value,label:d(u.labelKey)})),buildDeck:u=>ma(u,de())}):r==="summary"&&(s.main.innerHTML=p()),r==="notes"&&W(),r==="tools"&&Tt(t,{getLabel:pt,t:d,getActiveToolId:()=>i,onSelectTool:u=>{i=u},mountTool:u=>{u.innerHTML="",a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup();const m=Ma[i];m&&(a=m(d),u.appendChild(a))}}),r==="worksheets"){const u=kt.filter(m=>ft.includes(m.topic));zt(t,u,d,Be,{topicFilter:(m,w)=>w.includes("thermometer")?ft.includes(m.topic):w.includes(m.topic)})}r==="summary"&&$()}}function E(){o==null||o.destroy(),o=St(t,{subtitleKey:"strand.heat.subtitle",activeSection:r,onSection:u=>{r==="tools"&&u!=="tools"&&a!=null&&a._thermometerLabCleanup&&(a._thermometerLabCleanup(),a=null),r=u,o.updateSection(r),P()},onLang:()=>E()}),s.main=o.main,o.updateSection(r),P()}function A(){return`
      <section class="panel panel--topic-hub">
        <h2>${d("topics.title")}</h2>
        <p class="lead">${d("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Me.map(u=>{const m=u.tool?`<button class="btn primary" type="button" data-go-tool="${u.tool}">${d("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${d("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${d(u.titleKey)}</h3>
              ${m}
            </div>`}).join("")}
        </div>
      </section>`}function I(u){const m=u.target.closest("[data-go-tool]");if(m){const x=m.getAttribute("data-go-tool");ht.includes(x)?i=x:i="liquid",r="tools",o.updateSection(r),P();return}const w=u.target.closest("[data-go-section]");(w==null?void 0:w.getAttribute("data-go-section"))==="notes"&&(r="notes",o.updateSection(r),P())}function C(){return`
      <section class="panel">
        <h2>${d("notes.title")}</h2>
        <p class="lead">${d("notes.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
      ...
      </section>`}async function W(){const u=Be();for(const m of Me){const w=t.querySelector(`[data-note-card="${m.id}"]`);if(!w)continue;const x=w.querySelector("[data-note-body]"),T=u==="zhHant"?m.fileZh:m.fileEn,G=await mt(T),Q=`./notes/${T}`;G?x.innerHTML=`
          <iframe class="notes-grid" title="${d(`notes.card.${m.id}`)}" src="${Q}"></iframe>
          <p style="margin-top:8px"><a href="${Q}" target="_blank" rel="noopener">${d("notes.openPdf")}</a></p>`:x.innerHTML=`<p class="lead">${d("notes.missing")}</p>`}}function p(){return`
      <section class="panel">
        <h2>${d("summary.title")}</h2>
        <p class="lead">${d("summary.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
      ...
      </section>`}const q={thermometer:"thermometer",heatInternalEnergy:"heat-internal-energy",changeOfState:"change-of-state",heatTransfer:"heat-transfer"};async function $(){const u=Be();for(const m of Me){const w=t.querySelector(`[data-summary-card="${m.id}"]`);if(!w)continue;const x=w.querySelector("[data-summary-body]"),T=q[m.id];if(T){const D=u==="zhHant"?`${T}-zhHant.webp`:`${T}-en.webp`,N=await Ht("summary",D),B=`./summary/${D}`;N?x.innerHTML=`
          <img class="summary-thumb" src="${B}" alt="${d(`summary.item.${m.id}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${B}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}const G=u==="zhHant"?m.fileZh:m.fileEn,Q=await mt(G),V=`./notes/${G}`;Q?x.innerHTML=`
          <iframe class="notes-grid" title="${d(`summary.item.${m.id}`)}" src="${V}"></iframe>
          <p style="margin-top:8px"><a href="${V}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:x.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const v=()=>E(),g=u=>I(u);return window.addEventListener("s3phy:lang",v),t.addEventListener("click",g),E(),()=>{window.removeEventListener("s3phy:lang",v),t.removeEventListener("click",g),n==null||n(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),o==null||o.destroy()}}const bt={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Wt();Ot();const gt="s3phy_splash_seen",_t={optics:wa,heat:Ha};let He=null,_e=null;function _a(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(_t,r)?r:null}function Ea(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function Et(t){He==null||He(),He=null,_e==null||_e(),_e=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&Ea(),_e=Bt(r);return}const i=`#/${t}`;if(location.hash!==i){location.hash=i;return}He=_t[t](r)??null}function Ft(){Et(_a())}function Fa(){return"./images/uniplus-logo.png"}function Aa(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
  ...
  `,t}function $a(t,r){const i=[...bt.en,...bt.zhHant],o=()=>{if(!t.parentElement)return;const s=document.createElement("div");s.className="splash-danmaku-item",s.textContent=i[Math.floor(Math.random()*i.length)];const a=Math.random()*85+5,n=Math.random()*.8+.9,l=Math.random()*12+10;s.style.top=`${a}%`,s.style.fontSize=`${n}rem`,s.style.animationDuration=`${l}s`,r.appendChild(s),s.addEventListener("animationend",()=>s.remove()),window.setTimeout(o,1500+Math.random()*1e3)};for(let s=0;s<4;s+=1)window.setTimeout(o,s*1e3)}function Ia(t){const r=t.querySelector("#splashLogoWrap"),i=t.querySelector("#splashDanmaku"),o=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{i==null||i.classList.add("splash-danmaku--visible"),o==null||o.classList.add("splash-start-wrap--in"),i&&$a(t,i)},1600)}function vt(){Ft()}function Pa(){let t=!1;try{t=sessionStorage.getItem(gt)==="1"}catch{}if(t){vt();return}const r=Aa();document.body.insertBefore(r,document.body.firstChild),Ia(r);const i=r.querySelector("#splashStart"),o=()=>{r.remove(),vt()};i.addEventListener("click",()=>{try{sessionStorage.setItem(gt,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",o,{once:!0}),window.setTimeout(o,480)})}window.addEventListener("hashchange",Ft);window.addEventListener("s3phy:strand",t=>{Et(t.detail??null)});Pa();
