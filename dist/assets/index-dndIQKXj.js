(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))i(c);new MutationObserver(c=>{for(const o of c)if(o.type==="childList")for(const q of o.addedNodes)q.tagName==="LINK"&&q.rel==="modulepreload"&&i(q)}).observe(document,{childList:!0,subtree:!0});function a(c){const o={};return c.integrity&&(o.integrity=c.integrity),c.referrerPolicy&&(o.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?o.credentials="include":c.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(c){if(c.ep)return;c.ep=!0;const o=a(c);fetch(c.href,o)}})();const ce={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Flip cards to revise key terms. Reflection uses picture cards from your flashcard set.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.shuffle":"Shuffle","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF). Preview below or open in a new tab to download.","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},$e={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"翻卡複習重要詞彙。反射課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.shuffle":"洗牌","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF）。可於下方預覽，或新分頁開啟下載。","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","tools.thermometerLab.title":"溫度計與校準實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},xe="s3phy.lang",qe={en:ce,"zh-Hant":$e};let de="en";function ze(){try{const n=localStorage.getItem(xe);if(n==="zh-Hant"||n==="en")return n}catch{}return"en"}function Fe(){de=ze()}function Se(n){if(qe[n]){de=n;try{localStorage.setItem(xe,n)}catch{}document.documentElement.lang=n==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function ee(){return de}function s(n){const t=qe[de]||ce;return Object.prototype.hasOwnProperty.call(t,n)?t[n]:Object.prototype.hasOwnProperty.call(ce,n)?ce[n]:n}const Ie=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function We(n){function t(){n.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${Ie.map(({id:c,titleKey:o,descKey:q})=>`
            <div class="card">
              <h3>${s(o)}</h3>
              <p>${s(q)}</p>
...
`;function Oe(){if(document.getElementById(me))return;const n=document.createElement("style");n.id=me,n.textContent=De,document.head.appendChild(n)}function Qe(n){Oe();const t=document.createElement("div");t.className="rml",t.innerHTML=`
    <div class="rml-head">
  ...
  `;const a=t.querySelector(".rml-canvas"),i=a.getContext("2d"),c=t.querySelector("[data-rml-rot]"),o=t.querySelector("[data-rml-inc]"),q=t.querySelector('[data-rml-disp="rot"]'),y=t.querySelector('[data-rml-disp="inc"]'),F=t.querySelector('[data-rml-val="i"]'),Q=t.querySelector('[data-rml-val="r"]'),z=t.querySelector('[data-rml-val="shift"]'),k=350,I=380,B=300,_="#22d3ee",E="bold 17px system-ui, sans-serif";let L=0,W=-140,O=!0,P=!0,j=!0,G=!0;function D(M){return M*Math.PI/180}function N(M,d,l,p,R,e=2,r=!1){i.beginPath(),i.lineWidth=e,i.strokeStyle=R,i.setLineDash(r?[6,6]:[]);const u=M+Math.cos(D(l))*p,h=d+Math.sin(D(l))*p;return i.moveTo(M,d),i.lineTo(u,h),i.stroke(),i.setLineDash([]),{x:u,y:h}}function V(M,d,l,p,R,e=14){const r=l-M,u=p-d,h=Math.hypot(r,u);if(h<1e-6)return;const x=r/h,m=u/h,f=l-x*e,g=p-m*e,H=.45*e;i.beginPath(),i.fillStyle=R,i.moveTo(l,p),i.lineTo(f-m*H,g+x*H),i.lineTo(f+m*H,g-x*H),i.closePath(),i.fill()}function b(M,d,l,p,R,e=25){i.beginPath(),i.strokeStyle=p,i.lineWidth=2;const r=Math.min(M,d),u=Math.max(M,d);if(i.arc(k,I,l,D(r),D(u),!1),i.stroke(),R){const h=(r+u)/2,x=k+Math.cos(D(h))*(l+e),m=I+Math.sin(D(h))*(l+e);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=p,i.fillText(R,x,m),i.restore()}}function S(M,d,l,p,R){i.clearRect(0,0,a.width,a.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(k-200,I),i.lineTo(k+200,I),i.stroke(),i.setLineDash([]),i.lineCap="butt";const e=k+Math.cos(D(M))*B,r=I+Math.sin(D(M))*B;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(e,r),i.lineTo(k,I),i.stroke();const u=(e+k)*.5,h=(r+I)*.5,x=Math.hypot(k-e,I-r)||1,m=(k-e)/x,f=(I-r)/x;if(V(u-m*28,h-f*28,u,h,"#fff",16),i.save(),i.font=E,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(n("tools.rotatingMirror.canvas.incident"),e,r-12),i.restore(),O){const g=N(k,I,-90,B-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(n("tools.rotatingMirror.canvas.n"),g.x+6,g.y-4),i.restore()}if(P){const g=N(k,I,p,B,"#00e676",2,!1);V(k,I,g.x,g.y,"#00e676",16),i.save(),i.font=E,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(n("tools.rotatingMirror.canvas.originalReflected"),g.x,g.y-14),i.restore()}i.save(),i.translate(k,I),i.rotate(D(L)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let g=-190;g<200;g+=15)i.moveTo(g,0),i.lineTo(g-5,8);if(i.stroke(),i.restore(),j){const g=N(k,I,d,B-40,_,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=_,i.fillText(n("tools.rotatingMirror.canvas.nPrime"),g.x+6,g.y-4),i.restore()}if(G){const g=N(k,I,l,B,_,4);V(k,I,g.x,g.y,_,16),Math.abs(L)>.5&&(i.save(),i.font=E,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=_,i.fillText(n("tools.rotatingMirror.canvas.newReflected"),g.x,g.y-14),i.restore())}if(j&&b(M,d,100,"#ffcc00",`i=${R.toFixed(0)}°`,25),j&&G&&b(d,l,100,_,`r=${R.toFixed(0)}°`,25),O&&j&&Math.abs(L)>.5&&b(-90,d,50,"#ffcc00",`θ=${Math.abs(L)}°`,20),P&&G&&Math.abs(L)>.5){const g=l-p;b(p,l,260,"#ff5252",`${n("tools.rotatingMirror.canvas.shift")}=${g.toFixed(0)}°`,40)}}function $(){L=parseFloat(c.value),W=parseFloat(o.value);const M=L>0?"+":"";q.textContent=`${M}${L}°`,y.textContent=`${W}°`;const d=-90,l=Math.abs(W-d),p=d+l,R=-90+L,e=Math.abs(W-R),r=R+e,u=r-p;F.textContent=`${e.toFixed(1)}°`,Q.textContent=`${e.toFixed(1)}°`;const h=u>0?"+":"";z.textContent=`${h}${u.toFixed(1)}°`,S(W,R,r,p,e)}return t.querySelectorAll("[data-rml-toggle]").forEach(M=>{M.addEventListener("click",()=>{const d=M.getAttribute("data-rml-toggle");d==="orig-norm"&&(O=!O),d==="orig-ray"&&(P=!P),d==="new-norm"&&(j=!j),d==="new-ray"&&(G=!G),M.classList.toggle("active"),$()})}),t.querySelector("[data-rml-reset]").addEventListener("click",()=>{c.value="0",$()}),c.addEventListener("input",$),o.addEventListener("input",$),$(),t}function je(n){const t=document.createElement("div");t.className="tool-tir-escape";const a=document.createElement("iframe"),i="./",c=i.endsWith("/")?i:`${i}/`;return a.src=`${c}tir-escape/index.html?embed=1`,a.title=n("tools.refractionTir.title"),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",t.appendChild(a),t}function Ne(n,t={}){const a=t.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",c=document.createElement("div");c.className="tool-lens-simulator";const o=document.createElement("iframe"),q="./",y=q.endsWith("/")?q:`${q}/`;return o.src=`${y}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(a)}`,o.title=n(i),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",c.appendChild(o),c}function Be(n){const t=document.createElement("div");t.className="tool-em-spectrum";const a=document.createElement("iframe"),i="./",c=i.endsWith("/")?i:`${i}/`;function o(){return`${c}em-spectrum/index.html?lang=${encodeURIComponent(ee())}`}a.src=o(),a.title=n("tools.em.title"),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin";const q=()=>{var y;try{(y=a.contentWindow)==null||y.postMessage({type:"s3phy:lang",lang:ee()},"*")}catch{a.src=o()}};return window.addEventListener("s3phy:lang",q),t._emLabCleanup=()=>window.removeEventListener("s3phy:lang",q),t.appendChild(a),t}function Ve(n){const t=document.createElement("div");t.className="rgb-mixer",t.innerHTML=`
  ...
  `;const a=t.querySelector("[data-r]"),i=t.querySelector("[data-g]"),c=t.querySelector("[data-b]"),o=t.querySelector(".rgb-mixer-canvas"),q=t.querySelector(".rgb-mixer-stage"),y=o.getContext("2d");function F(_){return _.toString(16).padStart(2,"0")}function Q(_,E,L){const W=o.width/(window.devicePixelRatio||1),O=o.height/(window.devicePixelRatio||1),P=W/2,j=O/2,G=Math.min(W,O)*.34,D=G*.5,N=Math.sqrt(3)/2;y.clearRect(0,0,W,O),y.fillStyle="#000",y.fillRect(0,0,W,O);const V=[{x:P,y:j-D,rgb:[255,0,0],val:_},{x:P-D*N,y:j+D*.5,rgb:[0,255,0],val:E},{x:P+D*N,y:j+D*.5,rgb:[0,0,255],val:L}];y.globalCompositeOperation="lighter",V.forEach(b=>{if(b.val<=0)return;const S=b.val/255,[$,M,d]=b.rgb,l=y.createRadialGradient(b.x,b.y,0,b.x,b.y,G);l.addColorStop(0,`rgba(${$},${M},${d},${S})`),l.addColorStop(.65,`rgba(${$},${M},${d},${S})`),l.addColorStop(.85,`rgba(${$},${M},${d},${S*.5})`),l.addColorStop(1,`rgba(${$},${M},${d},0)`),y.fillStyle=l,y.beginPath(),y.arc(b.x,b.y,G,0,Math.PI*2),y.fill()}),y.globalCompositeOperation="source-over"}function z(){const _=q.getBoundingClientRect(),E=Math.max(200,Math.min(_.width-8,_.height-8,720)),L=window.devicePixelRatio||1;o.width=E*L,o.height=E*L,o.style.width=`${E}px`,o.style.height=`${E}px`,y.setTransform(L,0,0,L,0,0),Q(+a.value,+i.value,+c.value)}function k(){const _=+a.value,E=+i.value,L=+c.value,W=`rgb(${_}, ${E}, ${L})`,O=`#${F(_)}${F(E)}${F(L)}`;t.querySelector("[data-r-val]").textContent=_,t.querySelector("[data-g-val]").textContent=E,t.querySelector("[data-b-val]").textContent=L,t.querySelector("[data-r-bar]").style.width=`${_/255*100}%`,t.querySelector("[data-g-bar]").style.width=`${E/255*100}%`,t.querySelector("[data-b-bar]").style.width=`${L/255*100}%`,a.style.setProperty("--fill",`${_/255*100}%`),i.style.setProperty("--fill",`${E/255*100}%`),c.style.setProperty("--fill",`${L/255*100}%`);const P=t.querySelector("[data-swatch]");P.style.backgroundColor=W,P.setAttribute("aria-label",`${n("tools.rgbMixer.preview")}: ${W}`),t.querySelector("[data-rgb-text]").textContent=W,t.querySelector("[data-hex-text]").textContent=O,Q(_,E,L)}function I(_,E,L){a.value=_,i.value=E,c.value=L,k()}return[a,i,c].forEach(_=>_.addEventListener("input",k)),t.querySelectorAll(".rgb-presets button").forEach(_=>{_.addEventListener("click",()=>{I(+_.dataset.r,+_.dataset.g,+_.dataset.b)})}),new ResizeObserver(()=>z()).observe(q),requestAnimationFrame(()=>{z(),k()}),t}const Ge=["topics","notes","tools","worksheets","flashcards","summary"],Ye={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function ke(n,{subtitleKey:t,activeSection:a,onSection:i,onLang:c}){n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-main]"),q=n.querySelector("[data-nav]"),y=n.querySelector("[data-lang]"),F=n.querySelector("[data-strand-back]");let Q=a;function z(_){Q=_,q.innerHTML=Ge.map(E=>`<button type="button" class="${_===E?"active":""}" data-sec="${E}">${s(Ye[E])}</button>`).join(""),q.querySelectorAll("button").forEach(E=>{E.addEventListener("click",()=>i(E.getAttribute("data-sec")))})}function k(){y.innerHTML=`
      <button type="button" data-set-lang="en" class="${ee()==="en"?"active":""}">${s("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${ee()==="zh-Hant"?"active":""}">${s("lang.zhHant")}</button>
    `,y.querySelectorAll("button").forEach(_=>{_.addEventListener("click",()=>{Se(_.getAttribute("data-set-lang")),c()})})}function I(){n.querySelector("[data-hub-subtitle]").textContent=s(t),F.textContent=s("strand.back"),n.querySelector("[data-hub-footer]").textContent=s("footer.conventions"),n.querySelector(".site-title").textContent=s("app.title")}const B=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return F.addEventListener("click",B),z(a),k(),{main:o,updateSection(_){z(_)},refreshLabels(){I(),z(Q),k()},destroy(){F.removeEventListener("click",B)}}}const he=["A","B","C","D"];function fe(n){const t=n.slice();for(let a=t.length-1;a>0;a-=1){const i=Math.floor(Math.random()*(a+1));[t[a],t[i]]=[t[i],t[a]]}return t}function Xe(n,t,a){return n.filter(i=>{if(a)return a(i,t);const c=i.topic;return!!(t.includes(c)||t.includes("rotatingMirror")&&c==="reflection"||t.includes("refraction")&&c==="refraction"||t.includes("tir")&&c==="tir"||c==="convex"&&t.includes("convex")||c==="concave"&&t.includes("concave"))})}function Ke(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function J(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function _e(n,t={}){const a=t.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=t.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="ws-controls no-print">
        ...
        <div class="grid cols-2" data-ws-topics>
          ${a.map(([c,o])=>`<label class="card ws-topic-card">
    ...
    </section>`}function Me(n,t,a,i,c={}){var p,R,e,r;const o={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},q=n.querySelector("[data-ws-gen]"),y=n.querySelector("[data-ws-preview-area]"),F=n.querySelector("[data-ws-out]"),Q=n.querySelector("[data-ws-body]"),z=n.querySelector("[data-ws-paper]"),k=n.querySelector("[data-ws-tabs]"),I=n.querySelector("[data-ws-practice-actions]"),B=n.querySelector("[data-ws-score]"),_=n.querySelector("[data-ws-score-val]"),E=n.querySelector("[data-ws-summary]"),L=n.querySelector("[data-ws-date-row]"),W=n.querySelector("[data-ws-date-print]"),O=n.querySelector("[data-ws-date-today]"),P=n.querySelector("[data-ws-date-label]");if(!q||!Q)return;function j(){return i()}function G(){o.userAnswers={},o.wrongAttempts={},o.resolved={},B.hidden=!0,E.hidden=!0}function D(){return o.items.length>0&&o.items.every((u,h)=>o.resolved[h])}function N(){let u=0;o.items.forEach((x,m)=>{if(!o.resolved[m])return;const f=x[j()]||x.en;o.userAnswers[m]===f.a&&(u+=1)}),Object.keys(o.resolved).length>0&&(_.textContent=`${u}/${o.items.length}`,B.hidden=!1)}function V(u){o.tab=u,k==null||k.querySelectorAll("[data-ws-tab]").forEach(h=>{h.classList.toggle("active",h.getAttribute("data-ws-tab")===u)}),I&&(I.hidden=u!=="practice"),L&&(L.hidden=u!=="practice"),W&&(W.hidden=!o.dateStr,W.textContent=o.dateStr?`${a("worksheets.date")}: ${o.dateStr}`:""),z==null||z.classList.toggle("practice-mode",u==="practice"),S()}function b(u,h,x){const m=u[j()]||u.en,f=he,g=h+1,H=u.section?`<span class="q-section">${J(u.section)}</span>`:"";if(x==="answer"){const ae=m.choices.map((X,Z)=>`<li class="${Z===m.a?"choice-correct":""}"><strong>${f[Z]}.</strong> ${J(X)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${g} ${H}</h4>
        <p>${J(m.q)}</p>
        <ol class="choice-list">${ae}</ol>
        <p class="q-exp"><strong>${a("worksheets.answer")}:</strong> ${f[m.a]}</p>
        <p class="q-exp"><em>${J(m.exp)}</em></p>
      </div>`}const C=o.userAnswers[h],T=o.wrongAttempts[h]||0,v=o.resolved[h],A=v&&C===m.a,w=v&&C!==m.a;let Y="";T===1&&!v?Y=`<p class="q-hint"><strong>${a("worksheets.hint")}:</strong> ${J(m.hint||m.exp)}</p>`:w&&(Y=`<p class="q-exp"><strong>${a("worksheets.answer")}:</strong> ${f[m.a]}</p>
        <p class="q-exp q-summary"><em>${J(m.exp)}</em></p>`);const K=A?"correct":w?"incorrect":"",te=m.choices.map((ae,X)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${h}" value="${X}" data-ws-q="${h}" data-ws-choice="${X}"${C===X?" checked":""}${v?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${f[X]}.</strong> ${J(ae)}
          </label>
        </li>`).join("");return`<div class="question-row ${K}" data-ws-row="${h}">
      <div class="q-header"><h4>Q${g} ${H}</h4>${A?'<span class="result-icon">✓</span>':w?'<span class="result-icon">✗</span>':""}</div>
      <p>${J(m.q)}</p>
      <ol class="choice-list choice-list--radio">${te}</ol>
      ${Y}
    </div>`}function S(){o.items.length&&(Q.innerHTML=o.items.map((u,h)=>b(u,h,o.tab)).join(""),$())}function $(){o.tab==="practice"&&Q.querySelectorAll("[data-ws-choice]").forEach(u=>{u.addEventListener("change",()=>{const h=Number(u.getAttribute("data-ws-q"));if(o.resolved[h])return;const x=Number(u.getAttribute("data-ws-choice")),m=o.items[h][j()]||o.items[h].en;o.userAnswers[h]=x,x===m.a?o.resolved[h]=!0:(o.wrongAttempts[h]=(o.wrongAttempts[h]||0)+1,o.wrongAttempts[h]>=2&&(o.resolved[h]=!0)),N(),D()&&M(),S()})})}function M(){const u=o.items.length;let h=0,x=0;const m={};o.items.forEach((C,T)=>{const v=C[j()]||C.en;if(o.userAnswers[T]===v.a)h+=1,(o.wrongAttempts[T]||0)===0&&(x+=1);else if(o.resolved[T]){const w=C.section||C.topic;m[w]=(m[w]||0)+1}});const f=u?Math.round(h/u*100):0;let g=a("worksheets.revisionFair");f>=90?g=a("worksheets.revisionExcellent"):f>=70?g=a("worksheets.revisionGood"):f<50&&(g=a("worksheets.revisionLow"));const H=Object.entries(m).sort((C,T)=>T[1]-C[1]).map(([C,T])=>`<li>${J(C)} (${T})</li>`).join("");E.innerHTML=`
      <h4>${a("worksheets.sessionSummary")}</h4>
      <p>${a("worksheets.score")}: <strong>${h}/${u}</strong> (${f}%)</p>
      <p>${a("worksheets.firstTry")}: <strong>${x}/${u}</strong></p>
      <p>${a("worksheets.revisionSuggestions")}: ${g}</p>
      ${H?`<p>${a("worksheets.weakSections")}:</p><ul>${H}</ul>`:""}`,E.hidden=!1}function d(u){const h=j(),x=o.items.map((m,f)=>{const g=m[h]||m.en,H=g.choices.map((T,v)=>`${he[v]}. ${T}`).join("<br/>"),C=u?`<p><b>${a("worksheets.answer")}:</b> ${he[g.a]}<br/><i>${g.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${f+1}.</b> ${g.q}<br/>${H}${C}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${a("worksheets.paperTitle")}</title></head>
<body><h2>${a("worksheets.paperTitle")}</h2>
${o.dateStr&&!u?`<p>${a("worksheets.date")}: ${o.dateStr}</p>`:""}
${x}</body></html>`}function l(u){const h=d(u),x=new Blob(["\uFEFF",h],{type:"application/msword"}),m=document.createElement("a");m.href=URL.createObjectURL(x),m.download=u?"worksheet-answers.doc":"worksheet.doc",m.click(),URL.revokeObjectURL(m.href)}q.addEventListener("click",()=>{const u=Number(n.querySelector("[data-ws-count]").value),h=[...n.querySelectorAll("[data-ws-topic]")].filter(f=>f.checked).map(f=>f.getAttribute("data-ws-topic")),x=Xe(t,h,c.topicFilter),m=fe(x).slice(0,Math.min(u,x.length||1));o.items=m.length?m:fe(t).slice(0,Math.min(u,t.length)),G(),o.tab="practice",o.dateStr="",y.hidden=!1,F.hidden=!0,k==null||k.querySelectorAll("[data-ws-tab]").forEach(f=>{f.classList.toggle("active",f.getAttribute("data-ws-tab")==="practice")}),I&&(I.hidden=!1),L&&(L.hidden=!1),W&&(W.hidden=!0),P.textContent="",z==null||z.classList.add("practice-mode"),S()}),k==null||k.addEventListener("click",u=>{const h=u.target.closest("[data-ws-tab]");!h||!o.items.length||V(h.getAttribute("data-ws-tab"))}),O==null||O.addEventListener("click",()=>{o.dateStr?(o.dateStr="",P.textContent=""):(o.dateStr=Ke(),P.textContent=`${a("worksheets.date")}: ${o.dateStr}`),W&&(W.hidden=!o.dateStr,W.textContent=o.dateStr?`${a("worksheets.date")}: ${o.dateStr}`:"")}),(p=n.querySelector("[data-ws-word-p]"))==null||p.addEventListener("click",()=>l(!1)),(R=n.querySelector("[data-ws-word-a]"))==null||R.addEventListener("click",()=>l(!0)),(e=n.querySelector("[data-ws-print-p]"))==null||e.addEventListener("click",()=>{V("practice"),z==null||z.classList.add("ws-print-blank");const u=()=>z==null?void 0:z.classList.remove("ws-print-blank");window.addEventListener("afterprint",u,{once:!0}),window.print()}),(r=n.querySelector("[data-ws-print-a]"))==null||r.addEventListener("click",()=>{V("answer"),window.print()})}const Ue=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Ze={rotatingMirror:n=>Qe(n),refractionTir:n=>je(n),lens:(n,t)=>Ne(n,{defaultKind:t}),rgbMixer:n=>Ve(n),em:n=>Be(n)};function Je(n){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[n]||n)}function se(){return ee()==="zh-Hant"?"zhHant":"en"}async function Re(n,t){const a=`./${n}/${t}`;try{return(await fetch(a,{method:"HEAD"})).ok}catch{return!1}}async function et(n){return Re("notes",n)}function tt(n){let t="topics",a="rotatingMirror",i="convex",c=0,o="all",q=!1,y=null,F={main:null};function Q(){F.main&&(t==="topics"?F.main.innerHTML=k():t==="notes"?F.main.innerHTML=B():t==="tools"?F.main.innerHTML=E():t==="worksheets"?F.main.innerHTML=_e(s):t==="flashcards"?F.main.innerHTML=O():t==="summary"&&(F.main.innerHTML=b()),t==="notes"&&_(),t==="tools"&&L(),t==="worksheets"&&Me(n,Ce,s,se),t==="flashcards"&&V(),t==="summary"&&S())}function z(){y==null||y.destroy(),y=ke(n,{subtitleKey:"strand.optics.subtitle",activeSection:t,onSection:d=>{t=d,y.updateSection(t),Q()},onLang:()=>z()}),F.main=y.main,y.updateSection(t),Q()}function k(){const d=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${d.map(([l,p])=>{const R=l==="convex"||l==="concave"?"lens":l==="refraction"||l==="tir"?"refractionTir":l==="em"?"em":l,e=l==="convex"?"convex":l==="concave"?"concave":"";return`
            <div class="card">
              <h3>${s(p)}</h3>
              <button class="btn primary" type="button" data-go-tool="${R}"${e?` data-lens-kind="${e}"`:""}>${s("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function I(d){const l=d.target.closest("[data-go-tool]");if(!l)return;t="tools",a=l.getAttribute("data-go-tool");const p=l.getAttribute("data-lens-kind");(p==="convex"||p==="concave")&&(i=p),y.updateSection(t),Q()}function B(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${d.map(l=>{const p=s(`notes.card.${l.key}`);return`
            <div class="card" data-note-card="${l.key}">
              <h3>${p}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function _(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],l=se();for(const p of d){const R=n.querySelector(`[data-note-card="${p.key}"]`);if(!R)continue;const e=R.querySelector("[data-note-body]"),r=l==="zhHant"?p.fileZh:p.fileEn,u=await et(r),h=`./notes/${r}`;u?e.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${p.key}`)}" src="${h}"></iframe>
          <p style="margin-top:8px"><a href="${h}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:e.innerHTML=`<p class="lead">${s("notes.missing")}</p>
          <p><a class="btn" href="./notes/README.txt" target="_blank" rel="noopener">README</a></p>`}}function E(){return`
      <section class="panel panel--tools">
        <h2>${s("tools.title")}</h2>
        <p class="lead">${s("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ue.map(d=>`<button type="button" data-tool="${d}" class="${a===d?"active":""}">${Je(d)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function L(){const d=n.querySelector("[data-tool-list]"),l=n.querySelector("[data-tool-stage]");!d||!l||(d.querySelectorAll("button").forEach(p=>{p.addEventListener("click",()=>{a=p.getAttribute("data-tool"),d.querySelectorAll("button").forEach(R=>R.classList.toggle("active",R.getAttribute("data-tool")===a)),W(l)})}),W(l))}function W(d){d.innerHTML="";const l=Ze[a];if(!l)return;const p=a==="lens"?l(s,i):l(s);d.appendChild(p)}function O(){return`
      <section class="panel">
      ...
      </section>`}function P(d){return!!(d!=null&&d.front)}function j(d){return`./${String(d).replace(/^\.\//,"")}`}function G(){return Te.slice()}function D(){const d=Pe.slice(),l=G(),p=o==="rotatingMirror"?"reflection":o;if(p==="all")return[...d,...l];if(p==="reflection")return d;if(p==="convex"||p==="concave"){const e=l.filter(r=>r.topic==="convex"||r.topic==="concave");return e.length?e:l}if(p==="refractionTir"){const e=l.filter(r=>r.topic==="refraction"||r.topic==="tir");return e.length?e:l}const R=l.filter(e=>e.topic===p);return R.length?R:l}function N(){const d=D(),l=n.querySelector("[data-flash-progress]");if(!d.length){c=0;const x=n.querySelector("[data-flash-front]"),m=n.querySelector("[data-flip-card]");x&&(x.textContent=""),m&&m.classList.remove("flashcard-surface--image"),l&&(l.hidden=!0,l.textContent="");return}c=Math.max(0,Math.min(c,d.length-1));const p=d[c],R=n.querySelector("[data-flash-front]"),e=n.querySelector("[data-flip-card]"),r=n.querySelector("[data-flash-label]");if(!R||!e)return;if(l&&(l.hidden=!1,l.textContent=s("flashcards.progress").replace("{current}",String(c+1)).replace("{total}",String(d.length))),P(p)){const x=p.back&&p.back!==p.front;e.classList.add("flashcard-surface--image"),r&&(x?(r.hidden=!1,r.textContent=s(q?"flashcards.answer":"flashcards.question")):r.hidden=!0);const m=q&&p.back?p.back:p.front,f=p.alt||p.title||"";R.innerHTML=`<img src="${j(m)}" alt="${f.replace(/"/g,"&quot;")}" loading="lazy" />`;return}e.classList.remove("flashcard-surface--image");const u=se(),h=p[u]||p.en;r&&(r.hidden=!1,r.textContent=s(q?"flashcards.answer":"flashcards.question")),R.textContent=q?h.a:h.q}function V(){o==="rotatingMirror"&&(o="reflection");const d=n.querySelector("[data-flash-deck]");d.value=o,d.addEventListener("change",()=>{o=d.value,c=0,q=!1,N()}),n.querySelector("[data-flip-card]").addEventListener("click",()=>{q=!q,N()}),n.querySelector("[data-flash-flip]").addEventListener("click",l=>{l.stopPropagation(),q=!q,N()}),n.querySelector("[data-flash-prev]").addEventListener("click",()=>{const l=D();c=(c-1+l.length)%l.length,q=!1,N()}),n.querySelector("[data-flash-next]").addEventListener("click",()=>{const l=D();c=(c+1)%l.length,q=!1,N()}),n.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const l=D();c=Math.floor(Math.random()*l.length),q=!1,N()}),N()}function b(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${d.map(l=>{const p=s(`summary.item.${l.key}`);return`
            <div class="card" data-summary-card="${l.key}">
              <h3>${p}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function S(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],l=se();for(const p of d){const R=n.querySelector(`[data-summary-card="${p.key}"]`);if(!R)continue;const e=R.querySelector("[data-summary-body]"),r=l==="zhHant"?p.fileZh:p.fileEn,u=await Re("summary-pdfs",r),h=`./summary-pdfs/${r}`;u?e.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${p.key}`)}" src="${h}"></iframe>
          <p style="margin-top:8px"><a href="${h}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:e.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const $=()=>z(),M=d=>I(d);return window.addEventListener("s3phy:lang",$),n.addEventListener("click",M),z(),()=>{window.removeEventListener("s3phy:lang",$),n.removeEventListener("click",M),y==null||y.destroy()}}const ge="s3phy-thermometer-lab-css",at=`
.tl-wrap {
  --tl-bg: #0d0d10;
  --tl-panel: #18181b;
  --tl-border: #27272a;
...
`;function nt(){if(document.getElementById(ge))return;const n=document.createElement("style");n.id=ge,n.textContent=at,document.head.appendChild(n)}function it(n){nt();const t=document.createElement("div");t.className="tl-wrap",t.innerHTML=`
    <div class="tl-head">
  ...
  `;const a={liquidType:"mercury",thermometerType:"liquid",bulbVolume:200,wallThickness:.5,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0},i=460,c=300,o=460,q=300,y=t.querySelector("#tl-thermometerCanvas"),F=y.getContext("2d"),Q=t.querySelector("#tl-graphCanvas"),z=Q.getContext("2d"),k=window.devicePixelRatio||1;y.width=i*k,y.height=c*k,F.scale(k,k),Q.width=o*k,Q.height=q*k,z.scale(k,k);function I(){a.iceCubes=[];for(let e=0;e<4;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:10+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<15;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3,speedY:.6+Math.random()*1.2,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<6;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:12+Math.random()*15,speedY:.4+Math.random()*.5,opacity:.1+Math.random()*.25})}function B(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,r=.2+a.wallThickness*1.5,u=.4+a.bulbVolume*.003;return Math.max(.1,r*u*e*.15)}function _(e){a.bathTemp<=8&&a.iceCubes.forEach(r=>{r.x+=r.speedX,r.y+=r.speedY,(r.x<65||r.x>175)&&(r.speedX*=-1),(r.y<195||r.y>210)&&(r.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(r=>{r.y-=r.speedY*(1+a.bathTemp/100),r.y<185&&(r.y=265,r.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(r=>{r.y-=r.speedY*(1+(a.bathTemp-80)/40),r.phase+=r.wobbleSpeed,r.x+=Math.sin(r.phase)*.2,r.y<185&&(r.y=260+Math.random()*10,r.x=60+Math.random()*120)})}function E(e){let f=59,g=130,H=246;if(a.bathTemp<25){const w=a.bathTemp/25;f=Math.round(180-w*121),g=Math.round(210-w*80),H=Math.round(250-w*4)}else{const w=Math.min(1,(a.bathTemp-25)/125);f=Math.round(59+w*180),g=Math.round(130-w*100),H=Math.round(246-w*190)}if(a.bathTemp>40){const w=Math.min(1,(a.bathTemp-40)/100),Y=Date.now()*.02;e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-20,284);for(let K=-20;K<=20;K+=8){const te=w*(10+Math.sin(K*.3+Y)*4);e.lineTo(55+130/2+K,284-te)}e.lineTo(55+130/2+20,284),e.closePath(),e.fill()}e.strokeStyle="#9ca3af",e.lineWidth=2,e.fillStyle="#1f1f23",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${f}, ${g}, ${H}, 0.3)`),C.addColorStop(1,`rgba(${f}, ${g}, ${H}, 0.6)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const T=a.bathTemp>=80?1.5:.4,v=a.bathTemp>=80?.08:.03,A=Date.now()*v;for(let w=55;w<=185;w+=5){const Y=190+Math.sin(w*.15+A)*T;e.lineTo(w,Y)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.4,(a.bathTemp-35)/120)})`,e.lineWidth=1,a.heatWaves.forEach(w=>{e.beginPath(),e.moveTo(w.x,w.y),e.quadraticCurveTo(w.x+Math.sin(w.y*.06)*4,w.y-w.length/2,w.x,w.y-w.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(255, 255, 255, 0.6)",e.strokeStyle="rgba(147, 197, 253, 0.8)",e.lineWidth=.8,a.iceCubes.forEach(w=>{e.save(),e.translate(w.x,w.y),e.rotate(w.angle),e.beginPath(),e.roundRect(-w.size/2,-w.size/2,w.size,w.size,2),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.5)",e.strokeStyle="rgba(255, 255, 255, 0.7)",e.lineWidth=.5,a.bubbles.forEach(w=>{e.beginPath(),e.arc(w.x,w.y,w.r,0,Math.PI*2),e.fill(),e.stroke()})),e.strokeStyle="#4b5563",e.lineWidth=3,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke()}function L(e){const C=e.createLinearGradient(114,20,126,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.2)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(114,230),e.lineTo(114,25),e.arcTo(114,20,119,20,5),e.arcTo(126,20,126,25,5),e.lineTo(126,230),e.closePath(),e.fill(),e.stroke();const T=e.createRadialGradient(120-11*.2,250-11*.2,11*.1,120,250,11);T.addColorStop(0,"rgba(255, 255, 255, 0.7)"),T.addColorStop(1,"rgba(156, 163, 175, 0.3)"),e.fillStyle=T,e.strokeStyle="#6b7280",e.lineWidth=1.2,e.beginPath(),e.arc(120,250,12,0,Math.PI*2),e.fill(),e.stroke();const v=1.5;e.fillStyle="#111827",e.fillRect(120-v/2,28,v,202);const A=a.liquidType==="mercury",w=A?"#9ca3af":"#ef4444",Y=A?"#f3f4f6":"#fecaca",K=210,te=220,ae=(K-40)/te,X=K-Math.min(te,a.thermometerTemp)*ae;e.fillStyle=w,e.fillRect(120-v/2,X,v,230-X),e.fillStyle=Y,e.fillRect(120-v/6,X,v/3,230-X);const Z=11*.9,U=e.createRadialGradient(120-Z*.2,250-Z*.2,Z*.1,120,250,Z);A?(U.addColorStop(0,"#f3f4f6"),U.addColorStop(.3,"#d1d5db"),U.addColorStop(.8,"#9ca3af"),U.addColorStop(1,"#4b5563")):(U.addColorStop(0,"#fee2e2"),U.addColorStop(.2,"#fca5a5"),U.addColorStop(.7,"#ef4444"),U.addColorStop(1,"#991b1b")),e.fillStyle=U,e.beginPath(),e.arc(120,250,Z,0,Math.PI*2),e.fill(),e.strokeStyle="#4b5563",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa";for(let oe=0;oe<=200;oe+=50){const ue=K-oe*ae;e.beginPath(),e.moveTo(114,ue),e.lineTo(118,ue),e.stroke(),e.fillText(`${oe}°C`,92,ue+2.5)}}function W(e){const f=e.createLinearGradient(116,20,124,20);f.addColorStop(0,"#9ca3af"),f.addColorStop(.3,"#f3f4f6"),f.addColorStop(.7,"#d1d5db"),f.addColorStop(1,"#6b7280"),e.fillStyle=f,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(116,20,8,225,[0,0,3,3]),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const g=245,H=40,C=135,T=90;e.fillStyle="#1e1b4b",e.strokeStyle="#4f46e5",e.lineWidth=2.5,e.beginPath(),e.roundRect(g,H,C,T,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(g+10,H+12,C-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",g+C-16,H+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",g+14,H+21)}function O(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const x=20,m=225,f=10,g=120-f/2,H=e.createLinearGradient(g,x,g+f,x);H.addColorStop(0,"rgba(229, 231, 235, 0.4)"),H.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),H.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),H.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=H,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(g,x,f,m-x,[0,0,2,2]),e.fill(),e.stroke();const C=6,T=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);T.addColorStop(0,"#4b5563"),T.addColorStop(.7,"#1f2937"),T.addColorStop(1,"#111827"),e.fillStyle=T,e.strokeStyle="#030712",e.lineWidth=1,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const v=245,A=40,w=135,Y=90;e.fillStyle="#111827",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(v,A,w,Y,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(v+10,A+12,w-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",v+w-16,A+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",v+14,A+21)}function P(e){e.strokeStyle="#4b5563",e.lineWidth=1.2,e.beginPath(),e.moveTo(50,30),e.lineTo(50,260),e.lineTo(430,260),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.5,e.fillStyle="#a1a1aa",e.font="7px Arial",e.textAlign="right",e.textBaseline="middle";const m=25,f=200;for(let v=0;v<=m;v+=5){const A=260-v/m*230;e.beginPath(),e.moveTo(50,A),e.lineTo(430,A),e.stroke(),e.fillText(`${v.toFixed(1)}`,44,A)}e.textAlign="center",e.textBaseline="top";for(let v=0;v<=f;v+=40){const A=50+v/f*380;e.beginPath(),e.moveTo(A,30),e.lineTo(A,260),e.stroke(),e.fillText(`${v}`,A,264)}e.save(),e.translate(24,30+230/2),e.rotate(-Math.PI/2),e.font="bold 8px Arial",e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font="bold 8px Arial",e.fillText("temperature / °C",50+380/2,274);const g=260-a.liquidL0/m*230,H=260-(a.liquidL0+(a.liquidL100-a.liquidL0)/100*f)/m*230;e.strokeStyle="#ef4444",e.lineWidth=1.8,e.beginPath(),e.moveTo(50,g),e.lineTo(430,H),e.stroke();const C=a.thermometerTemp,T=a.currentLength;if(C>=0&&C<=f){const v=50+C/f*380,A=260-T/m*230;e.fillStyle="#ef4444",e.beginPath(),e.arc(v,A,4,0,Math.PI*2),e.fill()}}function j(e){e.strokeStyle="#4b5563",e.lineWidth=1.2,e.beginPath(),e.moveTo(50,30),e.lineTo(50,260),e.lineTo(430,260),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.5,e.fillStyle="#a1a1aa",e.font="7px Arial",e.textAlign="right",e.textBaseline="middle";const m=10,f=200;for(let v=0;v<=m;v+=2){const A=260-v/m*230;e.beginPath(),e.moveTo(50,A),e.lineTo(430,A),e.stroke(),e.fillText(`${v.toFixed(1)}`,44,A)}e.textAlign="center",e.textBaseline="top";for(let v=0;v<=f;v+=40){const A=50+v/f*380;e.beginPath(),e.moveTo(A,30),e.lineTo(A,260),e.stroke(),e.fillText(`${v}`,A,264)}e.save(),e.translate(24,30+230/2),e.rotate(-Math.PI/2),e.font="bold 8px Arial",e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font="bold 8px Arial",e.fillText("temperature / °C",50+380/2,274);const g=260-a.resistanceR0/m*230,H=260-(a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*f)/m*230;e.strokeStyle="#4f46e5",e.lineWidth=1.8,e.beginPath(),e.moveTo(50,g),e.lineTo(430,H),e.stroke();const C=a.thermometerTemp,T=a.currentResistance;if(C>=0&&C<=f){const v=50+C/f*380,A=260-T/m*230;e.fillStyle="#4f46e5",e.beginPath(),e.arc(v,A,4,0,Math.PI*2),e.fill()}}function G(e){e.strokeStyle="#4b5563",e.lineWidth=1.2,e.beginPath(),e.moveTo(50,30),e.lineTo(50,260),e.lineTo(430,260),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.5,e.fillStyle="#a1a1aa",e.font="7px Arial",e.textAlign="right",e.textBaseline="middle";const m=20,f=200;for(let T=0;T<=m;T+=4){const v=260-T/m*230;e.beginPath(),e.moveTo(50,v),e.lineTo(430,v),e.stroke(),e.fillText(`${T.toFixed(1)}`,44,v)}e.textAlign="center",e.textBaseline="top";for(let T=0;T<=f;T+=40){const v=50+T/f*380;e.beginPath(),e.moveTo(v,30),e.lineTo(v,260),e.stroke(),e.fillText(`${T}`,v,264)}e.save(),e.translate(24,30+230/2),e.rotate(-Math.PI/2),e.font="bold 8px Arial",e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font="bold 8px Arial",e.fillText("temperature / °C",50+380/2,274),e.strokeStyle="#10b981",e.lineWidth=1.8,e.beginPath();let g=!1;for(let T=0;T<=f;T+=2){const v=T+273.15,A=a.thermistorR25*Math.exp(a.thermistorBeta*(1/v-1/298.15)),w=50+T/f*380,Y=260-Math.min(m,A)/m*230;Y>=30&&Y<=260&&(g?e.lineTo(w,Y):(e.moveTo(w,Y),g=!0))}e.stroke();const H=a.thermometerTemp,C=a.currentThermistorR;if(H>=0&&H<=f){const T=50+H/f*380,v=260-Math.min(m,C)/m*230;e.fillStyle="#10b981",e.beginPath(),e.arc(T,v,4,0,Math.PI*2),e.fill()}}function D(){F.clearRect(0,0,i,c),z.clearRect(0,0,o,q),E(F),a.thermometerType==="liquid"?(L(F),P(z)):a.thermometerType==="resistance"?(W(F),j(z)):(O(F),G(z))}function N(e){t.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",t.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const r=t.querySelector("#tl-bath-state");a.bathTemp<=0?r.textContent="Melting Ice Bath":a.bathTemp>=100?r.textContent="Boiling Water/Steam":a.bathTemp===150?r.textContent="Hot Cooking Oil":r.textContent="Liquid Water",t.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const u=t.querySelector("#tl-alcohol-boiling-warning");if(a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?u.style.display="block":u.style.display="none",a.thermometerType==="liquid")t.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",t.querySelector("#tl-live-liquid-sub-num").textContent=`${a.currentLength.toFixed(2)} - ${a.liquidL0.toFixed(1)}`,t.querySelector("#tl-live-liquid-sub-den").textContent=`${a.liquidL100.toFixed(1)} - ${a.liquidL0.toFixed(1)}`,t.querySelector("#tl-live-liquid-ans").textContent=a.thermometerTemp.toFixed(1)+"°C";else if(a.thermometerType==="resistance")t.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",t.querySelector("#tl-live-resistance-sub-num").textContent=`${a.currentResistance.toFixed(2)} - ${a.resistanceR0.toFixed(1)}`,t.querySelector("#tl-live-resistance-sub-den").textContent=`${a.resistanceR100.toFixed(1)} - ${a.resistanceR0.toFixed(1)}`,t.querySelector("#tl-live-resistance-ans").textContent=a.thermometerTemp.toFixed(1)+"°C";else{t.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ";const h=a.thermometerTemp+273.15;t.querySelector("#tl-live-thermistor-calc-tk").textContent=h.toFixed(2),t.querySelector("#tl-live-thermistor-ans").textContent=a.thermometerTemp.toFixed(1)+"°C"}}let V=null;function b(e){a.lastTimestamp||(a.lastTimestamp=e);const r=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const u=Math.min(r,.1),h=B(),x=u/h*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=x,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const m=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/m-1/298.15)),_(),D(),N(h),V=requestAnimationFrame(b)}function S(){const e=parseFloat(t.querySelector("#tl-input-faulty-cf").value),r=parseFloat(t.querySelector("#tl-input-faulty-cu").value),u=Number.isFinite(e)?e:-1.5,h=Number.isFinite(r)?r:105,x=h-u;return{cf:u,cu:h,interval:x}}function $(e){const r=Math.round(e*100)/100;return r>=0?r.toFixed(1):`(${r.toFixed(1)})`}function M(){const{cf:e,cu:r,interval:u}=S(),h=t.querySelector("#tl-val-faulty-interval"),x=t.querySelector("#tl-faulty-error-a"),m=t.querySelector("#tl-faulty-error-b"),f=t.querySelector("#tl-ans-q10a"),g=t.querySelector("#tl-ans-q10b"),H=Math.abs(u)<.01;if(h.textContent=u.toFixed(1)+" °C",H){x.hidden=!1,x.textContent="C_u must differ from C_f (interval cannot be zero).",m.hidden=!1,m.textContent=x.textContent,f.textContent="—",g.textContent="—";return}x.hidden=!0,m.hidden=!0;const C=parseFloat(t.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(t.querySelector("#tl-input-q10b-t").value)||0,v=(C-e)/u*100,A=T/100*u+e;t.querySelector("#tl-faulty-sub-num-a").textContent=`${C.toFixed(1)} − ${$(e)}`,t.querySelector("#tl-faulty-sub-den-a").textContent=`${r.toFixed(1)} − ${$(e)}`,t.querySelector("#tl-faulty-sub-num-b").textContent=`${T.toFixed(1)} × ${u.toFixed(1)}`,t.querySelector("#tl-faulty-sub-cf-b").textContent=`+ ${$(e)}`,f.textContent=v.toFixed(1)+" °C",g.textContent=A.toFixed(2)+" °C"}function d(){const e=parseFloat(t.querySelector("#tl-input-q11-r").value)||0,r=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100;t.querySelector("#tl-formula-q11-rsub").textContent=e.toFixed(1),t.querySelector("#tl-ans-q11").textContent=r.toFixed(1)+" °C"}function l(){M(),d()}function p(e,r){t.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=r,t.querySelector("#tl-bath-temp-slider").value=r,l()})}function R(){t.querySelectorAll(".tl-tab-btn").forEach(r=>{r.addEventListener("click",()=>{t.querySelectorAll(".tl-tab-btn").forEach(h=>h.classList.remove("active")),t.querySelectorAll(".tl-tab-content").forEach(h=>h.classList.remove("active")),r.classList.add("active");const u=r.getAttribute("data-tl-tab");t.querySelector("#tl-tab-"+u).classList.add("active"),a.thermometerType=u,l()})}),t.querySelector("#tl-bath-temp-slider").addEventListener("input",r=>{a.bathTemp=parseFloat(r.target.value),l()}),p("tl-btn-preset-ice",0),p("tl-btn-preset-room",25),p("tl-btn-preset-steam",100),p("tl-btn-preset-oil",150),t.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",t.querySelector("#tl-card-mercury").className="tl-radio-card active-mercury",t.querySelector("#tl-card-alcohol").className="tl-radio-card",l()}),t.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",t.querySelector("#tl-card-mercury").className="tl-radio-card",t.querySelector("#tl-card-alcohol").className="tl-radio-card active-alcohol",l()}),t.querySelector("#tl-slider-bulb-vol").addEventListener("input",r=>{a.bulbVolume=parseFloat(r.target.value),t.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),t.querySelector("#tl-slider-wall-thick").addEventListener("input",r=>{a.wallThickness=parseFloat(r.target.value),t.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),t.querySelector("#tl-slider-liquid-l0").addEventListener("input",r=>{a.liquidL0=parseFloat(r.target.value),t.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",l()}),t.querySelector("#tl-slider-liquid-l100").addEventListener("input",r=>{a.liquidL100=parseFloat(r.target.value),t.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",l()}),t.querySelector("#tl-slider-resistance-r0").addEventListener("input",r=>{a.resistanceR0=parseFloat(r.target.value),t.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",t.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",l()}),t.querySelector("#tl-slider-resistance-r100").addEventListener("input",r=>{a.resistanceR100=parseFloat(r.target.value),t.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",t.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",l()}),t.querySelector("#tl-slider-thermistor-r25").addEventListener("input",r=>{a.thermistorR25=parseFloat(r.target.value),t.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",t.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",l()}),t.querySelector("#tl-slider-thermistor-beta").addEventListener("input",r=>{a.thermistorBeta=parseFloat(r.target.value),t.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",t.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",l()}),t.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{t.querySelector("#tl-btn-solve-q10a").classList.add("active"),t.querySelector("#tl-btn-solve-q10b").classList.remove("active"),t.querySelector("#tl-pane-q10a").classList.add("active"),t.querySelector("#tl-pane-q10b").classList.remove("active")}),t.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{t.querySelector("#tl-btn-solve-q10a").classList.remove("active"),t.querySelector("#tl-btn-solve-q10b").classList.add("active"),t.querySelector("#tl-pane-q10a").classList.remove("active"),t.querySelector("#tl-pane-q10b").classList.add("active")}),t.querySelector("#tl-input-faulty-cf").addEventListener("input",M),t.querySelector("#tl-input-faulty-cu").addEventListener("input",M),t.querySelector("#tl-btn-faulty-preset").addEventListener("click",()=>{t.querySelector("#tl-input-faulty-cf").value="-1.5",t.querySelector("#tl-input-faulty-cu").value="105",M()}),t.querySelector("#tl-input-q10a-cm").addEventListener("input",M),t.querySelector("#tl-input-q10b-t").addEventListener("input",M),t.querySelector("#tl-input-q11-r").addEventListener("input",d)}return I(),R(),l(),V=requestAnimationFrame(b),t._thermometerLabCleanup=()=>{V&&cancelAnimationFrame(V)},t}const ne=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"thermometerLab"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],pe=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],rt=[["thermometer","topic.thermometer"]];function le(){return ee()==="zh-Hant"?"zhHant":"en"}async function ot(n,t){const a=`./${n}/${t}`;try{return(await fetch(a,{method:"HEAD"})).ok}catch{return!1}}async function be(n){return ot("notes",n)}function st(n){let t="topics",a=0,i="all",c=!1,o=null,q={main:null},y=null;function F(){if(q.main){if(t==="topics"?q.main.innerHTML=z():t==="notes"?q.main.innerHTML=I():t==="tools"?q.main.innerHTML=_():t==="worksheets"?q.main.innerHTML=_e(s,{topics:rt,paperTitleKey:"worksheets.paperTitleHeat"}):t==="flashcards"?q.main.innerHTML=L():t==="summary"&&(q.main.innerHTML=G()),t==="notes"&&B(),t==="tools"&&E(),t==="worksheets"){const b=Ce.filter(S=>pe.includes(S.topic));Me(n,b,s,le,{topicFilter:(S,$)=>$.includes("thermometer")?pe.includes(S.topic):$.includes(S.topic)})}t==="flashcards"&&j(),t==="summary"&&D()}}function Q(){o==null||o.destroy(),o=ke(n,{subtitleKey:"strand.heat.subtitle",activeSection:t,onSection:b=>{t=b,o.updateSection(t),F()},onLang:()=>Q()}),q.main=o.main,o.updateSection(t),F()}function z(){return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${ne.map(b=>{const S=b.tool?`<button class="btn primary" type="button" data-go-tool="${b.tool}">${s("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${s("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${s(b.titleKey)}</h3>
              ${S}
            </div>`}).join("")}
        </div>
      </section>`}function k(b){if(b.target.closest("[data-go-tool]")){t="tools",o.updateSection(t),F();return}const $=b.target.closest("[data-go-section]");($==null?void 0:$.getAttribute("data-go-section"))==="notes"&&(t="notes",o.updateSection(t),F())}function I(){return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${ne.map(b=>`
            <div class="card" data-note-card="${b.id}">
              <h3>${s(`notes.card.${b.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function B(){const b=le();for(const S of ne){const $=n.querySelector(`[data-note-card="${S.id}"]`);if(!$)continue;const M=$.querySelector("[data-note-body]"),d=b==="zhHant"?S.fileZh:S.fileEn,l=await be(d),p=`./notes/${d}`;l?M.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${S.id}`)}" src="${p}"></iframe>
          <p style="margin-top:8px"><a href="${p}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:M.innerHTML=`<p class="lead">${s("notes.missing")}</p>`}}function _(){return`
      <section class="panel panel--tools">
        <h2>${s("tools.title")}</h2>
      ...
      </section>`}function E(){const b=n.querySelector("[data-tool-stage]");b&&(b.innerHTML="",y!=null&&y._thermometerLabCleanup&&y._thermometerLabCleanup(),y=it(s),b.appendChild(y))}function L(){return`
      <section class="panel">
        <h2>${s("flashcards.title")}</h2>
        <p class="lead">${s("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}function W(){return Te.filter(b=>pe.includes(b.topic))}function O(){const b=W();return i==="all"||i==="thermometry"?b:b.filter(S=>S.topic===i)}function P(){const b=O(),S=n.querySelector("[data-flash-progress]");if(!b.length){a=0;const R=n.querySelector("[data-flash-front]");R&&(R.textContent=""),S&&(S.hidden=!0,S.textContent="");return}a=Math.max(0,Math.min(a,b.length-1));const $=b[a],M=n.querySelector("[data-flash-front]"),d=n.querySelector("[data-flash-label]");if(!M)return;S&&(S.hidden=!1,S.textContent=s("flashcards.progress").replace("{current}",String(a+1)).replace("{total}",String(b.length)));const l=le(),p=$[l]||$.en;d&&(d.hidden=!1,d.textContent=s(c?"flashcards.answer":"flashcards.question")),M.textContent=c?p.a:p.q}function j(){const b=n.querySelector("[data-flash-deck]");b.value=i,b.addEventListener("change",()=>{i=b.value,a=0,c=!1,P()}),n.querySelector("[data-flip-card]").addEventListener("click",()=>{c=!c,P()}),n.querySelector("[data-flash-flip]").addEventListener("click",S=>{S.stopPropagation(),c=!c,P()}),n.querySelector("[data-flash-prev]").addEventListener("click",()=>{const S=O();a=(a-1+S.length)%S.length,c=!1,P()}),n.querySelector("[data-flash-next]").addEventListener("click",()=>{const S=O();a=(a+1)%S.length,c=!1,P()}),n.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const S=O();a=Math.floor(Math.random()*S.length),c=!1,P()}),P()}function G(){return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${ne.map(b=>`
            <div class="card" data-summary-card="${b.id}">
              <h3>${s(`summary.item.${b.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function D(){const b=le();for(const S of ne){const $=n.querySelector(`[data-summary-card="${S.id}"]`);if(!$)continue;const M=$.querySelector("[data-summary-body]"),d=b==="zhHant"?S.fileZh:S.fileEn,l=await be(d),p=`./notes/${d}`;l?M.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${S.id}`)}" src="${p}"></iframe>
          <p style="margin-top:8px"><a href="${p}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:M.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const N=()=>Q(),V=b=>k(b);return window.addEventListener("s3phy:lang",N),n.addEventListener("click",V),Q(),()=>{window.removeEventListener("s3phy:lang",N),n.removeEventListener("click",V),y!=null&&y._thermometerLabCleanup&&y._thermometerLabCleanup(),o==null||o.destroy()}}const ve={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Fe();const ye="s3phy_splash_seen",He={optics:tt,heat:st};let ie=null,re=null;function lt(){const n=location.hash.match(/^#\/(\w+)/),t=n==null?void 0:n[1];return t&&Object.prototype.hasOwnProperty.call(He,t)?t:null}function ct(){const n=`${location.pathname}${location.search}`;history.replaceState(null,"",n)}function Ae(n){ie==null||ie(),ie=null,re==null||re(),re=null;const t=document.getElementById("app");if(!t)return;if(t.innerHTML="",!n){location.hash&&ct(),re=We(t);return}const a=`#/${n}`;if(location.hash!==a){location.hash=a;return}ie=He[n](t)??null}function Le(){Ae(lt())}function dt(){return"./images/uniplus-logo.png"}function ut(){const n=document.createElement("div");return n.id="splash",n.className="splash",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Uni+"),n.innerHTML=`
  ...
  `,n}function ht(n,t){const a=[...ve.en,...ve.zhHant],i=()=>{if(!n.parentElement)return;const c=document.createElement("div");c.className="splash-danmaku-item",c.textContent=a[Math.floor(Math.random()*a.length)];const o=Math.random()*85+5,q=Math.random()*.8+.9,y=Math.random()*12+10;c.style.top=`${o}%`,c.style.fontSize=`${q}rem`,c.style.animationDuration=`${y}s`,t.appendChild(c),c.addEventListener("animationend",()=>c.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let c=0;c<4;c+=1)window.setTimeout(i,c*1e3)}function pt(n){const t=n.querySelector("#splashLogoWrap"),a=n.querySelector("#splashDanmaku"),i=n.querySelector("#splashStartWrap");window.setTimeout(()=>t==null?void 0:t.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{a==null||a.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),a&&ht(n,a)},1600)}function we(){Le()}function mt(){let n=!1;try{n=sessionStorage.getItem(ye)==="1"}catch{}if(n){we();return}const t=ut();document.body.insertBefore(t,document.body.firstChild),pt(t);const a=t.querySelector("#splashStart"),i=()=>{t.remove(),we()};a.addEventListener("click",()=>{try{sessionStorage.setItem(ye,"1")}catch{}t.classList.add("splash--hide"),t.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",Le);window.addEventListener("s3phy:strand",n=>{Ae(n.detail??null)});mt();
