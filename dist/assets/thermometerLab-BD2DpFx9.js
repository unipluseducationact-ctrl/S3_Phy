const kt="s3phy-thermometer-lab-css";const Vt=`
.tl-wrap {
  --tl-bg: #09090b;
...
`;function St(){if(document.getElementById(kt))return;const u=document.createElement("style");u.id=kt,u.textContent=Vt,document.head.appendChild(u)}function Ct(u){const U={x:12,y:12},K=200,{container:O,panel:n,toggleBtn:e,dragHandle:D,dragSurface:at,storageKey:E,onLayoutChange:j,breakpoint:rt=1024,collapsedClass:k="controls-collapsed",floatingClass:S="controls-floating"}=u,L=at||D;if(!O||!n||!e)return null;let q=sessionStorage.getItem(E)!=="false",w=(()=>{try{const R=localStorage.getItem(E+":pos");if(!R)return{...U};const $=JSON.parse(R);if(typeof $.x=="number"&&typeof $.y=="number")return $}catch{}return{...U}})(),C=null,W=null;const G=()=>window.innerWidth>=rt,X=(R,$)=>{const tt=O.getBoundingClientRect(),V=n.getBoundingClientRect(),st=Math.max(0,tt.width-V.width),et=Math.max(0,tt.height-V.height);return{x:Math.min(Math.max(0,R),st),y:Math.min(Math.max(0,$),et)}},H=()=>{n.style.left=w.x+"px",n.style.top=w.y+"px",n.style.right="auto",n.style.bottom="auto"},T=()=>{typeof j=="function"&&(clearTimeout(W),W=setTimeout(j,K))},P=()=>{e.setAttribute("aria-expanded",q?"false":"true"),u.getToggleTitle&&(e.title=u.getToggleTitle(q));const R=e.querySelector("[data-float-chevron]");R&&(R.textContent=q?"v":"^")},Q=()=>{G()&&(w=X(w.x,w.y),H())},it=R=>{q=R,n.classList.toggle(k,q),sessionStorage.setItem(E,q?"true":"false"),P(),T(),requestAnimationFrame(Q),setTimeout(Q,260)},pt=()=>{O.classList.add(S),n.classList.add("lab-controls-float"),w=X(w.x,w.y),H(),D&&(D.style.display="")},ot=()=>{O.classList.remove(S),n.classList.remove("lab-controls-float"),n.style.left="",n.style.top="",n.style.right="",n.style.bottom="",D&&(D.style.display="none")},nt=()=>{G()?(pt(),w=X(w.x,w.y),H()):ot(),T()};if(n.classList.toggle(k,q),P(),nt(),e.addEventListener("click",R=>{R.stopPropagation(),it(!q)}),L){L.addEventListener("pointerdown",$=>{G()&&(e.contains($.target)||($.preventDefault(),C={pointerId:$.pointerId,startX:$.clientX,startY:$.clientY,originX:w.x,originY:w.y},L.setPointerCapture($.pointerId),L.classList.add("is-dragging")))}),L.addEventListener("pointermove",$=>{!C||C.pointerId!==$.pointerId||(w=X(C.originX+$.clientX-C.startX,C.originY+$.clientY-C.startY),H())});const R=$=>{if(!(!C||C.pointerId!==$.pointerId)){L.releasePointerCapture($.pointerId),L.classList.remove("is-dragging");try{localStorage.setItem(E+":pos",JSON.stringify(w))}catch{}C=null,T()}};L.addEventListener("pointerup",R),L.addEventListener("pointercancel",R)}return window.addEventListener("resize",nt),{setCollapsed:it,refreshMode:nt,isCollapsed:()=>q}}function Ut(u,g={}){St();const U=g.type||"liquid";let K=u("tools.thermometerLab.title"),O=u("tools.thermometerLab.subtitle");g.type==="liquid"?(K=u("tools.thermometerLab.liquid.title"),O=u("tools.thermometerLab.liquid.subtitle")||u("tools.thermometerLab.subtitle")):g.type==="resistance"?(K=u("tools.thermometerLab.resistance.title"),O=u("tools.thermometerLab.resistance.subtitle")||u("tools.thermometerLab.subtitle")):g.type==="thermistor"&&(K=u("tools.thermometerLab.thermistor.title"),O=u("tools.thermometerLab.thermistor.subtitle")||u("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
    <div class="tl-head">
      <h2 class="tl-title">${K}</h2>
      <div class="tl-sub">${O}</div>
    </div>
    <div class="tl-dash">
  ...
  `;const e={liquidType:"mercury",thermometerType:U,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},D={xs:11,sm:14,md:17,lg:18,sub:10};function at(t,i,l,a){let r=Math.min(l,Math.max(i,t));return a>0&&(r=Math.round(r/a)*a,r=Math.min(l,Math.max(i,parseFloat(r.toFixed(10))))),r}function E(t,i,{min:l,max:a,step:r,decimals:d,onUpdate:f}){function o(c){const p=Number.isFinite(c)?c:l,s=at(p,l,a,r);t.value=s,i.value=s.toFixed(d),f(s)}t.addEventListener("input",()=>o(parseFloat(t.value))),i.addEventListener("change",()=>o(parseFloat(i.value))),i.addEventListener("blur",()=>o(parseFloat(i.value)))}const j=460,rt=340,k=8,S=40,L=44,q=j-S,w=130,C=640,W=420;function G(){return e.thermometerType==="liquid"?{beakerX:q/2-w/2,beakerW:w,thermometerX:q/2}:{beakerX:55,beakerW:w,thermometerX:120}}function X(){const t={left:110,top:48,right:30,bottom:65};return{gx:t.left,gy:t.top,gw:C-t.left-t.right,gh:W-t.top-t.bottom,tickFont:`bold ${Math.round(C*.024)}px Arial`,axisFont:`bold ${Math.round(C*.026)}px Arial`,dotR:8,yLabelX:t.left-75,xLabelY:W-t.bottom+32}}function H(){return{minT:0,maxT:200,tickStep:25}}function T(t,i,l,a,r){return a+(t-i)/(l-i)*r}function P(t,i,l,a,r){return a+r-(t-i)/(l-i)*r}function Q(t,i,l,a,r,d,f=null){const{gx:o,gy:c,gw:p,gh:s,tickFont:h,axisFont:y,yLabelX:x,xLabelY:m}=i;t.strokeStyle="#1e1e24",t.lineWidth=1;for(const b of d){const v=P(b.value,b.min,b.max,c,s);t.beginPath(),t.moveTo(o,v),t.lineTo(o+p,v),t.stroke()}for(let b=l;b<=a+.01;b+=r){const v=T(b,l,a,o,p);t.beginPath(),t.moveTo(v,c),t.lineTo(v,c+s),t.stroke()}t.strokeStyle="#4b5563",t.lineWidth=2.5,t.beginPath(),t.moveTo(o,c),t.lineTo(o,c+s),t.lineTo(o+p,c+s),t.stroke(),t.fillStyle="#e4e4e7",t.font=h,t.textAlign="right",t.textBaseline="middle";for(const b of d){const v=P(b.value,b.min,b.max,c,s);t.fillText(b.label,o-15,v)}t.textAlign="center",t.textBaseline="top";for(let b=l;b<=a+.01;b+=r){if(f!=null&&Math.abs(b-f)<.25)continue;const v=T(b,l,a,o,p);t.fillText(`${Math.round(b)}`,v,c+s+10)}return{gx:o,gy:c,gw:p,gh:s,axisFont:y,yLabelX:x,xLabelY:m}}function it(t,i){const l=i-t,a=l<=8?1:l<=14?2:5,r=[],d=Math.ceil(t/a)*a;for(let f=d;f<=i+.001;f+=a)r.push({value:f,label:f%1===0?`${f.toFixed(0)}`:`${f.toFixed(1)}`,min:t,max:i});return r}function pt(){const{maxT:t}=H(),i=ot(0),l=ot(t),a=l-i,r=Math.max(1,a*.1),d=Math.max(0,Math.round((i-r)*10)/10),f=Math.round((l+r)*10)/10;return{minL:d,maxL:f}}function ot(t){return e.liquidL0+(e.liquidL100-e.liquidL0)/100*t}function nt(){const{maxT:t}=H(),i=R(0),l=R(t),a=l-i,r=Math.max(.2,a*.1),d=Math.max(0,i-r),f=l+r,o=a<=2?.5:a<=4?1:2,c=[],p=Math.ceil(d/o)*o;for(let s=p;s<=f+.001;s+=o)c.push({value:s,label:s.toFixed(1),min:d,max:f});return{minR:d,maxR:f,ticks:c}}function R(t){return e.resistanceR0+(e.resistanceR100-e.resistanceR0)/100*t}function $(t){const{maxT:i}=t;let l=e.thermistorR25;for(let f=0;f<=i;f+=5){const o=f+273.15,c=e.thermistorR25*Math.exp(e.thermistorBeta*(1/o-1/298.15));l=Math.max(l,c)}l=Math.ceil(l*1.08*10)/10;const a=0,r=l<=12?2:4,d=[];for(let f=0;f<=l+.001;f+=r)d.push({value:f,label:f.toFixed(0),min:a,max:l});return{minR:a,maxR:l,ticks:d}}const tt=n.querySelector("#tl-thermometerCanvas"),V=tt.getContext("2d"),st=n.querySelector("#tl-graphCanvas"),et=st.getContext("2d"),J=window.devicePixelRatio||1;tt.width=j*J,tt.height=rt*J,V.scale(J,J),st.width=C*J,st.height=W*J,et.scale(J,J);function Lt(){const{beakerX:t,beakerW:i}=G(),l=t+5,a=i-10;e.iceCubes=[];for(let r=0;r<5;r++)e.iceCubes.push({x:l+Math.random()*a,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});e.bubbles=[];for(let r=0;r<20;r++)e.bubbles.push({x:l+Math.random()*a,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});e.heatWaves=[];for(let r=0;r<8;r++)e.heatWaves.push({x:t+10+Math.random()*(i-20),y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});e.steamParticles=[];for(let r=0;r<12;r++)e.steamParticles.push({x:l+Math.random()*a,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const qt=200,bt=11;function $t(){const t=Math.pow(e.bulbVolume/qt,.3333333333333333);return bt*t}function zt(){if(e.thermometerType==="resistance"||e.thermometerType==="thermistor")return .35;const t=e.liquidType==="mercury"?1:8,i=.2+e.wallThickness*1.5,l=.4+e.bulbVolume*.003,a=1.35-e.capillaryBore*.45;return Math.max(.1,i*l*a*t*.15)}function Ft(t){const{beakerX:i,beakerW:l}=G(),a=i+5,r=l-10,d=i+10,f=i+l-10;e.bathTemp<=8&&e.iceCubes.forEach(o=>{o.x+=o.speedX,o.y+=o.speedY,(o.x<d||o.x>f)&&(o.speedX*=-1),(o.y<195||o.y>210)&&(o.speedY*=-1)}),e.bathTemp>35&&e.heatWaves.forEach(o=>{o.y-=o.speedY*(1+e.bathTemp/100),o.y<185&&(o.y=265,o.x=i+10+Math.random()*(l-20))}),e.bathTemp>=80&&e.bubbles.forEach(o=>{o.y-=o.speedY*(1+(e.bathTemp-80)/40),o.phase+=o.wobbleSpeed,o.x+=Math.sin(o.phase)*.3,o.y<185&&(o.y=260+Math.random()*10,o.x=a+Math.random()*r)}),e.bathTemp>=95&&e.steamParticles.forEach(o=>{o.x+=o.vx,o.y+=o.vy,o.alpha-=.005,(o.alpha<=0||o.y<130)&&(o.x=a+Math.random()*r,o.y=175+Math.random()*5,o.alpha=.2+Math.random()*.4)})}function Rt(t,i){const l=i.beakerX,a=180,r=i.beakerW,d=100,f=190;let o=59,c=130,p=246;if(e.bathTemp<25){const m=e.bathTemp/25;o=Math.round(180-m*121),c=Math.round(210-m*80),p=Math.round(250-m*4)}else{const m=Math.min(1,(e.bathTemp-25)/125);o=Math.round(59+m*180),c=Math.round(130-m*100),p=Math.round(246-m*190)}if(e.bathTemp>40){const m=Math.min(1,(e.bathTemp-40)/100),b=Date.now()*.02;t.fillStyle=`rgba(239, 68, 68, ${m*.25})`,t.beginPath(),t.roundRect(l-10,a+d+4,r+20,10,4),t.fill(),t.fillStyle="rgba(249, 115, 22, 0.85)",t.beginPath(),t.moveTo(l+r/2-25,a+d+4);for(let v=-25;v<=25;v+=6){const M=m*(12+Math.sin(v*.4+b)*5);t.lineTo(l+r/2+v,a+d+4-M)}t.lineTo(l+r/2+25,a+d+4),t.closePath(),t.fill()}t.strokeStyle="#4b5563",t.lineWidth=2,t.fillStyle="#121214",t.beginPath(),t.roundRect(l,a,r,d,[0,0,10,10]),t.fill();const s=t.createLinearGradient(l,f,l,a+d);s.addColorStop(0,`rgba(${o}, ${c}, ${p}, 0.25)`),s.addColorStop(1,`rgba(${o}, ${c}, ${p}, 0.55)`),t.fillStyle=s,t.beginPath(),t.moveTo(l,f);const h=e.bathTemp>=80?2:.5,y=e.bathTemp>=80?.09:.03,x=Date.now()*y;for(let m=l;m<=l+r;m+=5){const b=f+Math.sin(m*.15+x)*h;t.lineTo(m,b)}t.lineTo(l+r,a+d),t.lineTo(l,a+d),t.closePath(),t.fill(),e.bathTemp>35&&(t.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(e.bathTemp-35)/120)})`,t.lineWidth=1.2,e.heatWaves.forEach(m=>{t.beginPath(),t.moveTo(m.x,m.y),t.quadraticCurveTo(m.x+Math.sin(m.y*.06)*5,m.y-m.length/2,m.x,m.y-m.length),t.stroke()})),e.bathTemp<=8&&(t.fillStyle="rgba(224, 242, 254, 0.55)",t.strokeStyle="rgba(186, 230, 253, 0.8)",t.lineWidth=1,e.iceCubes.forEach(m=>{t.save(),t.translate(m.x,m.y),t.rotate(m.angle),t.beginPath(),t.roundRect(-m.size/2,-m.size/2,m.size,m.size,3),t.fill(),t.stroke(),t.restore()})),e.bathTemp>=80&&(t.fillStyle="rgba(255, 255, 255, 0.4)",t.strokeStyle="rgba(255, 255, 255, 0.65)",t.lineWidth=.6,e.bubbles.forEach(m=>{t.beginPath(),t.arc(m.x,m.y,m.r,0,Math.PI*2),t.fill(),t.stroke()})),e.bathTemp>=95&&e.steamParticles.forEach(m=>{t.fillStyle=`rgba(255, 255, 255, ${m.alpha})`,t.beginPath(),t.arc(m.x,m.y,m.r,0,Math.PI*2),t.fill()}),t.strokeStyle="#9ca3af",t.lineWidth=3.5,t.beginPath(),t.moveTo(l-1,a),t.lineTo(l-1,a+d-8),t.arcTo(l-1,a+d+1,l+10,a+d+1,8),t.lineTo(l+r-10,a+d+1),t.arcTo(l+r+1,a+d+1,l+r+1,a+d-8,8),t.lineTo(l+r+1,a),t.stroke(),t.strokeStyle="rgba(255, 255, 255, 0.4)",t.lineWidth=1.5,t.beginPath(),t.moveTo(l+4,a+10),t.lineTo(l+4,a+d-10),t.stroke()}function Mt(t,i,l){const a=i.split(" "),r=[];function d(o){if(t.measureText(o).width<=l){r.push(o);return}let c="";for(const p of o){const s=c+p;t.measureText(s).width>l&&c?(r.push(c),c=p):c=s}c&&r.push(c)}let f="";for(const o of a){const c=f?`${f} ${o}`:o;t.measureText(c).width<=l||!f?f=c:(d(f),f=o)}return f&&d(f),r.length?r:[i]}function Z(t,i,l,a,r,d,f="left"){if(!e.showLabels)return;t.font="bold 9px system-ui, sans-serif";const o=11,c=5,p=3,s=Math.max(40,f==="left"?q-a-k:a-k),h=Mt(t,d,s),y=h.map(B=>t.measureText(B).width),x=Math.max(...y)+c*2,m=h.length*o+p*2;let b=f==="left"?a:a-x;b=Math.max(k,Math.min(b,q-x-k));const v=r-m/2,M=f==="left"?b:b+x;t.strokeStyle="rgba(6, 182, 212, 0.7)",t.lineWidth=1,t.setLineDash([3,3]),t.beginPath(),t.moveTo(i,l),t.lineTo(M,r),t.stroke(),t.setLineDash([]),t.fillStyle="#06b6d4",t.beginPath(),t.arc(i,l,3,0,Math.PI*2),t.fill(),t.fillStyle="rgba(21, 21, 24, 0.9)",t.strokeStyle="#06b6d4",t.lineWidth=1,t.beginPath(),t.roundRect(b,v,x,m,4),t.fill(),t.stroke(),t.fillStyle="#f4f4f5",t.textAlign="center",t.textBaseline="middle",h.forEach((B,_)=>{const z=v+p+o*(_+.5);t.fillText(B,b+x/2,z)})}function Pt(t,i){const l=i.thermometerX,a=20,r=$t(),d=250+Math.max(0,r-bt)*.35,f=d-r-1,o=10+e.wallThickness*8,c=l-o/2,p=l+o/2,s=t.createLinearGradient(c,a,p,a);s.addColorStop(0,"rgba(209, 213, 219, 0.85)"),s.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),s.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),s.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),s.addColorStop(1,"rgba(156, 163, 175, 0.9)"),t.fillStyle=s,t.strokeStyle="rgba(156, 163, 175, 0.8)",t.lineWidth=1,t.beginPath(),t.moveTo(c,f),t.lineTo(c,a+5),t.arcTo(c,a,c+5,a,5),t.arcTo(p,a,p,a+5,5),t.lineTo(p,f),t.closePath(),t.fill(),t.stroke();const h=t.createRadialGradient(l-r*.2,d-r*.2,r*.1,l,d,r);h.addColorStop(0,"rgba(255, 255, 255, 0.8)"),h.addColorStop(1,"rgba(156, 163, 175, 0.35)"),t.fillStyle=h,t.strokeStyle="#6b7280",t.lineWidth=.8+e.wallThickness*.6,t.beginPath(),t.arc(l,d,r+.5+e.wallThickness*.5,0,Math.PI*2),t.fill(),t.stroke();const y=Math.min(o*.72,.8+e.capillaryBore*4.5);t.fillStyle="#0a0a0c",t.fillRect(l-y/2,a+8,y,f-a-8);const x=e.liquidType==="mercury",m=x?"#a1a1aa":"#ef4444",b=x?"#f4f4f5":"#fee2e2",v=210,M=220,_=(v-40)/M,z=v-Math.min(M,e.thermometerTemp)*_;t.fillStyle=m,t.fillRect(l-y/2,z,y,f-z),t.beginPath(),t.ellipse(l,z,y/2,1.5,0,0,Math.PI*2),t.fill(),t.fillStyle=b,t.fillRect(l-y/6,z,y/3,f-z);const N=r*.9,F=t.createRadialGradient(l-N*.2,d-N*.2,N*.1,l,d,N);x?(F.addColorStop(0,"#f4f4f5"),F.addColorStop(.3,"#d4d4d8"),F.addColorStop(.8,"#71717a"),F.addColorStop(1,"#3f3f46")):(F.addColorStop(0,"#fee2e2"),F.addColorStop(.2,"#fca5a5"),F.addColorStop(.7,"#ef4444"),F.addColorStop(1,"#991b1b")),t.fillStyle=F,t.beginPath(),t.arc(l,d,N,0,Math.PI*2),t.fill(),t.strokeStyle="rgba(161, 161, 170, 0.6)",t.lineWidth=.5,t.font="6.5px Arial",t.fillStyle="#a1a1aa",t.textAlign="right",t.textBaseline="middle";for(let I=0;I<=200;I+=50){const A=v-I*_;t.beginPath(),t.moveTo(c,A),t.lineTo(c+4,A),t.stroke(),t.fillText(`${I}°C`,c-22,A+2.5)}if(e.showLabels){const I=i.beakerX+i.beakerW+12,A=c-28;Z(t,c+1,a+60,A,a+60,u("tools.thermometerLab.labels.thinWall"),"right"),Z(t,p+1,z,I,z,u("tools.thermometerLab.labels.meniscus"),"left"),Z(t,c,a+110,A,a+110,u("tools.thermometerLab.labels.narrowBore"),"right"),Z(t,p+1,d,I,d,u("tools.thermometerLab.labels.largeBulb"),"left")}}function Et(t,i){const l=i.thermometerX,a=20,r=245,d=10,f=l-d/2,o=t.createLinearGradient(f,a,f+d,a);o.addColorStop(0,"#71717a"),o.addColorStop(.3,"#f4f4f5"),o.addColorStop(.7,"#d4d4d8"),o.addColorStop(1,"#3f3f46"),t.fillStyle=o,t.strokeStyle="#4b5563",t.lineWidth=1,t.beginPath(),t.roundRect(f,a,d,r-a,[0,0,4,4]),t.fill(),t.stroke(),t.fillStyle="rgba(21, 21, 24, 0.8)",t.fillRect(f+2,r-45,d-4,40),t.strokeStyle="#e2e8f0",t.lineWidth=1.2,t.beginPath();let c=r-40;t.moveTo(l-2,c);for(let x=0;x<8;x++)c+=4,t.lineTo(l+2,c),c+=4,t.lineTo(l-2,c);t.stroke(),t.lineWidth=1.5,t.strokeStyle="#ef4444",t.beginPath(),t.moveTo(l-2,a),t.bezierCurveTo(l-10,a-15,200,30,245,60),t.stroke(),t.strokeStyle="#111827",t.beginPath(),t.moveTo(l+2,a),t.bezierCurveTo(l+10,a-12,210,45,245,75),t.stroke();const p=245,s=40,h=135,y=90;if(t.fillStyle="#18181b",t.strokeStyle="#6366f1",t.lineWidth=2.5,t.beginPath(),t.roundRect(p,s,h,y,10),t.fill(),t.stroke(),t.fillStyle="#022c22",t.beginPath(),t.roundRect(p+10,s+12,h-20,34,4),t.fill(),t.font='bold 17px "Courier New"',t.fillStyle="#10b981",t.textAlign="right",t.fillText(e.currentResistance.toFixed(2)+" Ω",p+h-16,s+34),t.font="6px Arial",t.fillStyle="#a7f3d0",t.textAlign="left",t.fillText("PLATINUM RTD METER",p+14,s+21),e.showLabels){const x=i.beakerX+i.beakerW+12,m=f-8;Z(t,f+1,a+80,m,a+80,u("tools.thermometerLab.labels.metalSheath"),"right"),Z(t,f+d,r-20,x,r-20,u("tools.thermometerLab.labels.platinumCoil"),"left")}}function Gt(t,i){const l=i.thermometerX,a=20,r=245;t.strokeStyle="#111827",t.lineWidth=1.2,t.beginPath(),t.moveTo(l-2,a),t.lineTo(l-2,r),t.stroke(),t.beginPath(),t.moveTo(l+2,a),t.lineTo(l+2,r),t.stroke();const d=20,f=225,o=12,c=l-o/2,p=t.createLinearGradient(c,d,c+o,d);p.addColorStop(0,"rgba(229, 231, 235, 0.4)"),p.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),p.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),p.addColorStop(1,"rgba(209, 213, 219, 0.6)"),t.fillStyle=p,t.strokeStyle="rgba(156, 163, 175, 0.6)",t.lineWidth=.8,t.beginPath(),t.roundRect(c,d,o,f-d,[0,0,3,3]),t.fill(),t.stroke();const s=7,h=t.createRadialGradient(l-s*.2,r-s*.2,s*.1,l,r,s);h.addColorStop(0,"#6b7280"),h.addColorStop(.7,"#1f2937"),h.addColorStop(1,"#09090b"),t.fillStyle=h,t.strokeStyle="#030712",t.lineWidth=1.2,t.beginPath(),t.arc(l,r,s,0,Math.PI*2),t.fill(),t.stroke(),t.lineWidth=1.5,t.strokeStyle="#ef4444",t.beginPath(),t.moveTo(l-2,a),t.bezierCurveTo(l-10,a-15,200,30,245,60),t.stroke(),t.strokeStyle="#111827",t.beginPath(),t.moveTo(l+2,a),t.bezierCurveTo(l+10,a-12,210,45,245,75),t.stroke();const y=245,x=40,m=135,b=90;if(t.fillStyle="#18181b",t.strokeStyle="#10b981",t.lineWidth=2.5,t.beginPath(),t.roundRect(y,x,m,b,10),t.fill(),t.stroke(),t.fillStyle="#022c22",t.beginPath(),t.roundRect(y+10,x+12,m-20,34,4),t.fill(),t.font='bold 17px "Courier New"',t.fillStyle="#34d399",t.textAlign="right",t.fillText(e.currentThermistorR.toFixed(2)+" kΩ",y+m-16,x+34),t.font="5px Arial",t.fillStyle="#a7f3d0",t.textAlign="left",t.fillText(u("tools.thermometerLab.thermistor.meterLabelLine1"),y+14,x+52),t.fillText(u("tools.thermometerLab.thermistor.meterLabelLine2"),y+14,x+59),e.showLabels){const v=i.beakerX+i.beakerW+12,M=c-8;Z(t,c,a+100,M,a+100,u("tools.thermometerLab.labels.leads"),"right"),Z(t,c+o,r,v,r,u("tools.thermometerLab.labels.semiconductorBead"),"left")}}function ut(t,i,l,a,r,d,f,o,c){const{gx:p,gy:s,gw:h,gh:y,tickFont:x}=i;t.strokeStyle="rgba(255, 255, 255, 0.2)",t.lineWidth=1,t.setLineDash([4,4]),t.beginPath(),t.moveTo(l,a),t.lineTo(l,s+y),t.stroke(),t.beginPath(),t.moveTo(l,a),t.lineTo(p,a),t.stroke(),t.setLineDash([]);const m=s+y+10;t.font=x,t.textAlign="center",t.textBaseline="top";const b=`${r.toFixed(1)}${f}`,v=t.measureText(b).width+10,M=18;t.fillStyle=c,t.beginPath(),t.roundRect(l-v/2,m-2,v,M,3),t.fill(),t.fillStyle="#000",t.fillText(b,l,m),t.textAlign="right",t.textBaseline="middle";const B=`${d.toFixed(2)} ${o}`,_=t.measureText(B).width+10;t.fillStyle=c,t.beginPath(),t.roundRect(p-_-2,a-7,_,15,3),t.fill(),t.fillStyle="#000",t.fillText(B,p-7,a)}function At(t){const i=X(),{minL:l,maxL:a}=pt(),{minT:r,maxT:d,tickStep:f}=H(),o=it(l,a),c=Q(t,i,r,d,f,o,e.thermometerTemp),{gx:p,gy:s,gw:h,gh:y,axisFont:x,yLabelX:m,xLabelY:b,dotR:v}={...i,...c};t.save(),t.translate(m,s+y/2),t.rotate(-Math.PI/2),t.font=x,t.fillStyle="#e4e4e7",t.fillText("Length of liquid column / cm",0,0),t.restore(),t.font=x,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",p+h/2,b);const M=d,B=T(0,r,d,p,h),_=P(ot(0),l,a,s,y),z=T(M,r,d,p,h),N=P(ot(M),l,a,s,y);t.strokeStyle="#ef4444",t.lineWidth=3,t.beginPath(),t.moveTo(B,_),t.lineTo(z,N),t.stroke();const F=e.thermometerTemp,I=e.currentLength;if(F>=r&&F<=d){const A=T(F,r,d,p,h),dt=P(I,l,a,s,y);ut(t,i,A,dt,F,I,"°C","cm","#ef4444"),t.shadowColor="#ef4444",t.shadowBlur=10,t.fillStyle="#ef4444",t.beginPath(),t.arc(A,dt,v,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function Bt(t){const i=X(),{minR:l,maxR:a,ticks:r}=nt(),d=H(),f=Q(t,i,d.minT,d.maxT,d.tickStep,r,e.thermometerTemp),{gx:o,gy:c,gw:p,gh:s,axisFont:h,yLabelX:y,xLabelY:x,dotR:m}={...i,...f};t.save(),t.translate(y,c+s/2),t.rotate(-Math.PI/2),t.font=h,t.fillStyle="#e4e4e7",t.fillText("Resistance of platinum / Ω",0,0),t.restore(),t.font=h,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",o+p/2,x);const{minT:b,maxT:v}=d,M=v,B=T(0,b,v,o,p),_=P(R(0),l,a,c,s),z=T(M,b,v,o,p),N=P(R(M),l,a,c,s);t.strokeStyle="#6366f1",t.lineWidth=3,t.beginPath(),t.moveTo(B,_),t.lineTo(z,N),t.stroke();const F=e.thermometerTemp,I=e.currentResistance;if(F>=b&&F<=v){const A=T(F,b,v,o,p),dt=P(I,l,a,c,s);ut(t,i,A,dt,F,I,"°C","Ω","#6366f1"),t.shadowColor="#6366f1",t.shadowBlur=10,t.fillStyle="#6366f1",t.beginPath(),t.arc(A,dt,m,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function It(t){const i=X(),l=H(),{minR:a,maxR:r,ticks:d}=$(l),f=Q(t,i,l.minT,l.maxT,l.tickStep,d,e.thermometerTemp),{gx:o,gy:c,gw:p,gh:s,axisFont:h,yLabelX:y,xLabelY:x,dotR:m}={...i,...f},{minT:b,maxT:v}=l;t.save(),t.translate(y,c+s/2),t.rotate(-Math.PI/2),t.font=h,t.fillStyle="#e4e4e7",t.fillText("Resistance of thermistor / kΩ",0,0),t.restore(),t.font=h,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",o+p/2,x),t.strokeStyle="#10b981",t.lineWidth=3,t.beginPath();let M=!1;for(let z=b;z<=v;z+=1){const N=z+273.15,F=e.thermistorR25*Math.exp(e.thermistorBeta*(1/N-1/298.15)),I=T(z,b,v,o,p),A=P(Math.min(r,F),a,r,c,s);A>=c&&A<=c+s&&(M?t.lineTo(I,A):(t.moveTo(I,A),M=!0))}t.stroke();const B=e.thermometerTemp,_=e.currentThermistorR;if(B>=b&&B<=v){const z=T(B,b,v,o,p),N=P(Math.min(r,_),a,r,c,s);ut(t,i,z,N,B,_,"°C","kΩ","#10b981"),t.shadowColor="#10b981",t.shadowBlur=10,t.fillStyle="#10b981",t.beginPath(),t.arc(z,N,m,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function ht(){V.clearRect(0,0,j,rt),et.clearRect(0,0,C,W),V.save(),V.translate(S,L);const t=G();Rt(V,t),e.thermometerType==="liquid"?Pt(V,t):e.thermometerType==="resistance"?Et(V,t):Gt(V,t),V.restore(),e.thermometerType==="liquid"?At(et):e.thermometerType==="resistance"?Bt(et):It(et)}function Wt(){const{sm:t,md:i,lg:l,xs:a,sub:r}=D,d=n.querySelector("#tl-svg-formula-liquid");d&&(d.innerHTML=`
      ...
      `}}function Ht(){const t=n.querySelector("#tl-faulty-svg-container");if(!t)return;const{cf:i,cu:l,interval:a}=yt(),r=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,d=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,f=n.querySelector("#tl-pane-q10a").classList.contains("active"),o=f?(r-i)/a*100:d,c=f?r:d/100*a+i,s=(h=>130-h/100*80)(o);t.innerHTML=`
    ...
    `}function Yt(t){n.querySelector("#tl-bath-temp-display").innerHTML=e.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=e.bathTemp.toFixed(1)+" °C";const i=n.querySelector("#tl-bath-state");e.bathTemp<=0?i.textContent="Melting Ice Bath":e.bathTemp>=100?i.textContent="Boiling Water/Steam":e.bathTemp===150?i.textContent="Hot Cooking Oil":i.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=t.toFixed(2)+" s";const l=n.querySelector("#tl-alcohol-boiling-warning");e.thermometerType==="liquid"&&e.liquidType==="alcohol"&&e.bathTemp>=78?l.style.display="block":l.style.display="none",e.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=e.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=e.thermometerTemp.toFixed(1)+"°C"):e.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=e.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=e.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=e.currentThermistorR.toFixed(2)+" kΩ",Wt()}let ct=null;function gt(t){e.lastTimestamp||(e.lastTimestamp=t);const i=(t-e.lastTimestamp)/1e3;e.lastTimestamp=t;const l=Math.min(i,.1),a=zt(),r=l/a*(e.bathTemp-e.thermometerTemp);e.thermometerTemp+=r,e.currentLength=e.liquidL0+(e.liquidL100-e.liquidL0)/100*e.thermometerTemp,e.currentResistance=e.resistanceR0+(e.resistanceR100-e.resistanceR0)/100*e.thermometerTemp;const d=e.thermometerTemp+273.15;e.currentThermistorR=e.thermistorR25*Math.exp(e.thermistorBeta*(1/d-1/298.15)),Ft(),ht(),Yt(a),ct=requestAnimationFrame(gt)}function yt(){const t=parseFloat(n.querySelector("#tl-input-faulty-cf").value),i=parseFloat(n.querySelector("#tl-input-faulty-cu").value),l=Number.isFinite(t)?t:-1.5,a=Number.isFinite(i)?i:105,r=a-l;return{cf:l,cu:a,interval:r}}function mt(t){const i=Math.round(t*100)/100;return i>=0?i.toFixed(1):`(${i.toFixed(1)})`}function lt(){if(!n.querySelector("#tl-input-faulty-cf"))return;const{cf:t,cu:i,interval:l}=yt(),a=n.querySelector("#tl-val-faulty-interval"),r=n.querySelector("#tl-faulty-error-a"),d=n.querySelector("#tl-faulty-error-b"),f=Math.abs(l)<.01;a.textContent=l.toFixed(1)+" °C";const o=n.querySelector("#tl-svg-formula-faulty-a"),c=n.querySelector("#tl-svg-formula-faulty-b");if(f){r.hidden=!1,r.textContent="C_u must differ from C_f (interval cannot be zero).",d.hidden=!1,d.textContent=r.textContent,o&&(o.innerHTML=""),c&&(c.innerHTML="");return}r.hidden=!0,d.hidden=!0;const p=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,s=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,h=(p-t)/l*100,y=s/100*l+t;o&&(o.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${p.toFixed(1)} - ${mt(t)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${i.toFixed(1)} - ${mt(t)}</text>
      ...
      `),c&&(c.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${mt(t)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${y.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),Ht()}function _t(){const{sm:t,md:i,sub:l}=D,a=e.thermometerTemp,r=e.liquidL100-e.liquidL0,d=e.liquidL0+r/100*a,f=n.querySelector("#tl-svg-formula-t-to-l");f&&(f.innerHTML=`
        <svg height="90" width="340" style="background:transparent; overflow:visible;">
          <line x1="10" y1="30" x2="100" y2="30" stroke="#fff" stroke-width="1.2" />
          <text x="55" y="21" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">${e.liquidL100.toFixed(1)} - ${e.liquidL0.toFixed(1)}</text>
          <text x="55" y="43" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">100 - 0</text>
      ...
      `)}function Nt(){const{sm:t,md:i,sub:l}=D,a=e.thermometerTemp,r=e.resistanceR100-e.resistanceR0,d=e.resistanceR0+r/100*a,f=n.querySelector("#tl-svg-formula-t-to-r");f&&(f.innerHTML=`
        <svg height="90" width="340" style="background:transparent; overflow:visible;">
          <line x1="10" y1="30" x2="100" y2="30" stroke="#fff" stroke-width="1.2" />
          <text x="55" y="21" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">${e.resistanceR100.toFixed(1)} - ${e.resistanceR0.toFixed(1)}</text>
          <text x="55" y="43" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">100 - 0</text>
      ...
      `)}function Y(){lt(),_t(),Nt()}function ft(t,i){n.querySelector("#"+t).addEventListener("click",()=>{e.bathTemp=i,n.querySelector("#tl-bath-temp-slider").value=i,Y()})}function vt(t){n.querySelectorAll(".tl-tab-btn").forEach(i=>{i.classList.toggle("active",i.getAttribute("data-tl-tab")===t)}),n.querySelectorAll(".tl-tab-content").forEach(i=>{i.classList.toggle("active",i.id==="tl-tab-"+t)}),n.querySelectorAll(".tl-live-tab").forEach(i=>{i.classList.toggle("active",i.id==="tl-live-"+t)}),e.thermometerType=t}function Xt(){var f,o,c,p;n.querySelectorAll(".tl-tab-btn").forEach(s=>{s.addEventListener("click",()=>{vt(s.getAttribute("data-tl-tab")),Y()})}),n.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{e.showLabels=!e.showLabels,n.querySelector("#tl-lbl-toggle-labels").textContent=e.showLabels?u("tools.thermometerLab.labels.hide"):u("tools.thermometerLab.labels.show")}),n.querySelector("#tl-bath-temp-slider").addEventListener("input",s=>{e.bathTemp=parseFloat(s.target.value),Y()}),ft("tl-btn-preset-ice",0),ft("tl-btn-preset-room",25),ft("tl-btn-preset-steam",100),ft("tl-btn-preset-oil",150),n.querySelector("#tl-card-mercury").addEventListener("click",()=>{e.liquidType="mercury",n.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",n.querySelector("#tl-card-alcohol").className="tl-seg-btn",Y()}),n.querySelector("#tl-card-alcohol").addEventListener("click",()=>{e.liquidType="alcohol",n.querySelector("#tl-card-mercury").className="tl-seg-btn",n.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",Y()}),E(n.querySelector("#tl-slider-bulb-vol"),n.querySelector("#tl-input-bulb-vol"),{min:10,max:1e3,step:10,decimals:0,onUpdate:s=>{e.bulbVolume=s}}),E(n.querySelector("#tl-slider-wall-thick"),n.querySelector("#tl-input-wall-thick"),{min:.05,max:3,step:.05,decimals:2,onUpdate:s=>{e.wallThickness=s}}),E(n.querySelector("#tl-slider-capillary-bore"),n.querySelector("#tl-input-capillary-bore"),{min:.05,max:2,step:.05,decimals:2,onUpdate:s=>{e.capillaryBore=s}}),E(n.querySelector("#tl-slider-liquid-l0"),n.querySelector("#tl-input-liquid-l0"),{min:.5,max:15,step:.1,decimals:1,onUpdate:s=>{e.liquidL0=s,Y()}}),E(n.querySelector("#tl-slider-liquid-l100"),n.querySelector("#tl-input-liquid-l100"),{min:5,max:30,step:.1,decimals:1,onUpdate:s=>{e.liquidL100=s,Y()}}),E(n.querySelector("#tl-slider-resistance-r0"),n.querySelector("#tl-input-resistance-r0"),{min:.5,max:20,step:.1,decimals:1,onUpdate:s=>{e.resistanceR0=s,n.querySelector("#tl-spec-resistance-r0").textContent=s.toFixed(1)+" Ω",Y()}}),E(n.querySelector("#tl-slider-resistance-r100"),n.querySelector("#tl-input-resistance-r100"),{min:2,max:30,step:.1,decimals:1,onUpdate:s=>{e.resistanceR100=s,n.querySelector("#tl-spec-resistance-r100").textContent=s.toFixed(1)+" Ω",Y()}}),E(n.querySelector("#tl-slider-thermistor-r25"),n.querySelector("#tl-input-thermistor-r25"),{min:.5,max:50,step:.1,decimals:1,onUpdate:s=>{e.thermistorR25=s,n.querySelector("#tl-spec-thermistor-r25").textContent=s.toFixed(1)+" kΩ",Y()}}),E(n.querySelector("#tl-slider-thermistor-beta"),n.querySelector("#tl-input-thermistor-beta"),{min:1e3,max:8e3,step:50,decimals:0,onUpdate:s=>{e.thermistorBeta=s,n.querySelector("#tl-spec-thermistor-beta").textContent=s+" K",Y()}});const l=n.querySelector("#tl-btn-solve-q10a"),a=n.querySelector("#tl-btn-solve-q10b");l&&a&&(l.addEventListener("click",()=>{l.classList.add("active"),a.classList.remove("active"),n.querySelector("#tl-pane-q10a").classList.add("active"),n.querySelector("#tl-pane-q10b").classList.remove("active"),lt()}),a.addEventListener("click",()=>{l.classList.remove("active"),a.classList.add("active"),n.querySelector("#tl-pane-q10a").classList.remove("active"),n.querySelector("#tl-pane-q10b").classList.add("active"),lt()})),(f=n.querySelector("#tl-input-faulty-cf"))==null||f.addEventListener("input",lt),(o=n.querySelector("#tl-input-faulty-cu"))==null||o.addEventListener("input",lt),(c=n.querySelector("#tl-input-q10a-cm"))==null||c.addEventListener("input",lt),(p=n.querySelector("#tl-input-q10b-t"))==null||p.addEventListener("input",lt);const r=n.querySelector("#tl-input-t-to-l");r&&r.addEventListener("input",Y);const d=n.querySelector("#tl-input-t-to-r");d&&d.addEventListener("input",Y)}if(g.type){const t=n.querySelector(".tl-tabs-container");t&&(t.style.display="none")}vt(U),Lt(),Xt(),Y();const xt=n.querySelector(".tl-dash"),wt=n.querySelector(".tl-controls"),Tt=n.querySelector("#tl-controls-toggle"),Ot=n.querySelector("#tl-controls-drag"),Dt=n.querySelector(".tl-controls-float-bar");return xt&&wt&&Tt&&Ct({container:xt,panel:wt,toggleBtn:Tt,dragHandle:Ot,dragSurface:Dt,storageKey:`s3phy-thermo-${U}`,breakpoint:1024,getToggleTitle:t=>u(t?"tools.floatingControls.showParams":"tools.floatingControls.hideParams"),onLayoutChange:()=>ht()}),ct=requestAnimationFrame(gt),n._thermometerLabCleanup=()=>{ct&&cancelAnimationFrame(ct)},n}function Kt(u){St();const g=document.createElement("div");g.className="tl-wrap tl-wrap--faulty-cal",g.innerHTML=`
    <div class="tl-head">
  ...
  `;function U(k){const S=Math.round(k*100)/100;return S>=0?S.toFixed(1):`(${S.toFixed(1)})`}function K(){const k=parseFloat(g.querySelector("#fsc-input-faulty-cf").value),S=parseFloat(g.querySelector("#fsc-input-faulty-cu").value),L=Number.isFinite(k)?k:-1.5,q=Number.isFinite(S)?S:105,w=q-L;return{cf:L,cu:q,interval:w}}function O(){const k=g.querySelector("#fsc-faulty-svg-container");if(!k)return;const{cf:S,cu:L,interval:q}=K(),w=parseFloat(g.querySelector("#fsc-input-q10a-cm").value)||0,C=parseFloat(g.querySelector("#fsc-input-q10b-t").value)||0,W=g.querySelector("#fsc-input-pane-q10a").classList.contains("active"),G=W?(w-S)/q*100:C,X=W?w:C/100*q+S,H=P=>130-P/100*80,T=Number.isFinite(G)?H(G):130;k.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        <g transform="translate(0, 0)">
          <rect x="80" y="25" width="12" height="115" rx="6" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
          <circle cx="86" cy="144" r="10" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
          ...
          <line x1="70" y1="50" x2="78" y2="50" stroke="#ef4444" stroke-width="1.5" />
          <text x="65" y="53" fill="#ef4444" font-size="10" font-weight="bold" text-anchor="end">100°C</text>
          <text x="65" y="${T+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${Number.isFinite(G)?G.toFixed(1):"—"}°C</text>
          <text x="86" y="170" fill="#a1a1aa" font-size="9" font-weight="bold" text-anchor="middle">${u("tools.thermometerLab.faulty.trueScale")}</text>
        </g>
        <g transform="translate(130, 0)">
          <rect x="100" y="25" width="12" height="115" rx="6" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
          ...
          <line x1="112" y1="50" x2="120" y2="50" stroke="#ef4444" stroke-width="1.5" />
          <text x="125" y="53" fill="#ef4444" font-size="10" font-weight="bold" text-anchor="start">C<tspan dy="3" font-size="7">u</tspan><tspan dy="-3"> = ${L.toFixed(1)}°C</tspan></text>
          <text x="125" y="${T+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${Number.isFinite(X)?X.toFixed(1):"—"}°C</text>
          <text x="106" y="170" fill="#a1a1aa" font-size="9" font-weight="bold" text-anchor="middle">${u("tools.thermometerLab.faulty.faultyScale")}</text>
        </g>
    ...
    `}function n(k){const S=k==="a";g.querySelector("#fsc-btn-solve-q10a").classList.toggle("active",S),g.querySelector("#fsc-btn-solve-q10b").classList.toggle("active",!S),g.querySelector("#fsc-input-pane-q10a").classList.toggle("active",S),g.querySelector("#fsc-input-pane-q10b").classList.toggle("active",!S),g.querySelector("#fsc-pane-q10a").classList.toggle("active",S),g.querySelector("#fsc-pane-q10b").classList.toggle("active",!S),e()}function e(){const{cf:k,cu:S,interval:L}=K(),q=g.querySelector("#fsc-val-faulty-interval"),w=g.querySelector("#fsc-faulty-error-a"),C=g.querySelector("#fsc-faulty-error-b"),W=g.querySelector("#fsc-svg-formula-faulty-a"),G=g.querySelector("#fsc-svg-formula-faulty-b"),X=Math.abs(L)<.01,H=u("tools.faultyCalibration.invalidInterval");if(q.textContent=L.toFixed(1)+" °C",X){w.hidden=!1,w.textContent=H,C.hidden=!1,C.textContent=H,W&&(W.innerHTML=""),G&&(G.innerHTML=""),O();return}w.hidden=!0,C.hidden=!0;const T=parseFloat(g.querySelector("#fsc-input-q10a-cm").value)||0,P=parseFloat(g.querySelector("#fsc-input-q10b-t").value)||0,Q=(T-k)/L*100,it=P/100*L+k;W&&(W.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">T =</text>
          <line x1="40" y1="21" x2="160" y2="21" stroke="#fff" stroke-width="1.5" />
      ...
      `),G&&(G.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">C =</text>
          <line x1="40" y1="21" x2="150" y2="21" stroke="#fff" stroke-width="1.5" />
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${P.toFixed(1)} &times; ${L.toFixed(1)}</text>
          <text x="95" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">100</text>
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${U(k)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${it.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),O()}g.querySelector("#fsc-btn-solve-q10a").addEventListener("click",()=>n("a")),g.querySelector("#fsc-btn-solve-q10b").addEventListener("click",()=>n("b")),g.querySelector("#fsc-input-faulty-cf").addEventListener("input",e),g.querySelector("#fsc-input-faulty-cu").addEventListener("input",e),g.querySelector("#fsc-input-q10a-cm").addEventListener("input",e),g.querySelector("#fsc-input-q10b-t").addEventListener("input",e);const D=g.querySelector(".tl-dash--faulty"),at=g.querySelector(".tl-controls"),E=g.querySelector("#fsc-controls-toggle"),j=g.querySelector("#fsc-controls-drag"),rt=g.querySelector(".tl-controls-float-bar");return D&&at&&E&&Ct({container:D,panel:at,toggleBtn:E,dragHandle:j,dragSurface:rt,storageKey:"s3phy-faulty-calibration",breakpoint:1024,getToggleTitle:k=>u(k?"tools.floatingControls.showParams":"tools.floatingControls.hideParams")}),e(),g._thermometerLabCleanup=()=>{},g}export{Kt as createFaultyScaleCalibrationLab,Ut as createThermometerLab};
