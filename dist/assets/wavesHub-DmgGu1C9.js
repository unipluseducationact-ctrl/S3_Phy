const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./waveMotionLab-B8Z8Lcf5.js","./createLabIframe-BrSZUwOJ.js","./index-BJ7buzgz.js","./index-D16P_DNl.css","./longitudinalWaveLab-DU0kcmqo.js","./waveInterferenceLab-Cv28JtBy.js","./thinFilmInterferenceLab-zNzxmAcM.js","./diffractionGratingCompareLab-B44EbE_I.js","./spectralOverlapLab-DQlxTc4U.js","./ultrasoundReflectionLab-BTAFaNhE.js","./soundRefractionShadowLab-BJjFgp0z.js"])))=>i.map(i=>d[i]);
import{t as n,_ as r}from"./index-BJ7buzgz.js";import{m as I}from"./hubShell-z6BQjqBr.js";import{h as T,c as S}from"./hubHelpers-BJxQ1gX7.js";import{r as R,h as O}from"./toolsShell-C-Th6Ujm.js";const m=[{id:"waveMotion",titleKey:"topic.waveMotion",fileEn:"wave-motion-en.pdf",fileZh:"wave-motion-zhHant.pdf",tool:"waveMotion"},{id:"waveProperties",titleKey:"topic.waveProperties",fileEn:"wave-properties-en.pdf",fileZh:"wave-properties-zhHant.pdf",tool:"waveInterference"},{id:"stationaryWave",titleKey:"topic.stationaryWave",fileEn:"stationary-wave-en.pdf",fileZh:"stationary-wave-zhHant.pdf"},{id:"lightWave",titleKey:"topic.lightWave",fileEn:"light-wave-en.pdf",fileZh:"light-wave-zhHant.pdf",tool:"thinFilmInterference"},{id:"soundWave",titleKey:"topic.soundWave",fileEn:"sound-wave-en.pdf",fileZh:"sound-wave-zhHant.pdf",tool:"ultrasoundReflection"}],g=["waveMotion","longitudinalWave","waveInterference","thinFilmInterference","diffractionGratingCompare","spectralOverlap","ultrasoundReflection","soundRefractionShadow"],$={waveMotion:()=>r(()=>import("./waveMotionLab-B8Z8Lcf5.js"),__vite__mapDeps([0,1,2,3]),import.meta.url).then(e=>e.createWaveMotionLab),longitudinalWave:()=>r(()=>import("./longitudinalWaveLab-DU0kcmqo.js"),__vite__mapDeps([4,1,2,3]),import.meta.url).then(e=>e.createLongitudinalWaveLab),waveInterference:()=>r(()=>import("./waveInterferenceLab-Cv28JtBy.js"),__vite__mapDeps([5,1,2,3]),import.meta.url).then(e=>e.createWaveInterferenceLab),thinFilmInterference:()=>r(()=>import("./thinFilmInterferenceLab-zNzxmAcM.js"),__vite__mapDeps([6,1,2,3]),import.meta.url).then(e=>e.createThinFilmInterferenceLab),diffractionGratingCompare:()=>r(()=>import("./diffractionGratingCompareLab-B44EbE_I.js"),__vite__mapDeps([7,1,2,3]),import.meta.url).then(e=>e.createDiffractionGratingCompareLab),spectralOverlap:()=>r(()=>import("./spectralOverlapLab-DQlxTc4U.js"),__vite__mapDeps([8,1,2,3]),import.meta.url).then(e=>e.createSpectralOverlapLab),ultrasoundReflection:()=>r(()=>import("./ultrasoundReflectionLab-BTAFaNhE.js"),__vite__mapDeps([9,1,2,3]),import.meta.url).then(e=>e.createUltrasoundReflectionLab),soundRefractionShadow:()=>r(()=>import("./soundRefractionShadowLab-BJjFgp0z.js"),__vite__mapDeps([10,1,2,3]),import.meta.url).then(e=>e.createSoundRefractionShadowLab)};function _(e){return n({waveMotion:"tools.waveMotion.title",longitudinalWave:"tools.longitudinalWave.title",waveInterference:"tools.waveInterference.title",thinFilmInterference:"tools.thinFilmInterference.title",diffractionGratingCompare:"tools.diffractionGratingCompare.title",spectralOverlap:"tools.spectralOverlap.title",ultrasoundReflection:"tools.ultrasoundReflection.title",soundRefractionShadow:"tools.soundRefractionShadow.title"}[e]||e)}function P(e){let i=sessionStorage.getItem("s3phy.waves.section")||"topics",s="waveMotion",o=null,l={main:null},u=null;function v(){S(u),u=null}async function w(t){t.innerHTML="",v();const a=$[s];if(!a)return;const d=(await a())(n);u=d,t.appendChild(d)}function c(){l.main&&(i==="topics"?l.main.innerHTML=L():i==="notes"?(l.main.innerHTML=y(),E()):i==="tools"?(l.main.innerHTML=R({toolOrder:g,toolId:s,getLabel:_,t:n}),O(e,{getLabel:_,t:n,getActiveToolId:()=>s,onSelectTool:t=>{s=t},mountTool:t=>{w(t)}})):l.main.innerHTML=`
        <section class="panel">
          <h2>${n(`nav.${i}`)}</h2>
      ...
      `)}function f(){o==null||o.refreshLabels(),c()}function b(){o==null||o.destroy(),o=I(e,{subtitleKey:"strand.waves.subtitle",activeSection:i,onSection:t=>{i==="tools"&&t!=="tools"&&v(),i=t,sessionStorage.setItem("s3phy.waves.section",t),o.updateSection(i),c()},onLang:f}),l.main=o.main,o.updateSection(i),c()}function L(){return`
