const Tt="s3phy-thermometer-lab-css";const Dt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function St(){if(document.getElementById(Tt))return;const c=document.createElement("style");c.id=Tt,c.textContent=Dt,document.head.appendChild(c)}function kt(c){const V={x:12,y:12},X=200,{container:_,panel:a,toggleBtn:e,dragHandle:N,dragSurface:lt,storageKey:B,onLayoutChange:D,breakpoint:at=1024,collapsedClass:S="controls-collapsed",floatingClass:T="controls-floating"}=c,k=lt||N;if(!_||!a||!e)return null;let F=sessionStorage.getItem(B)!=="false",v=(()=>{try{const M=localStorage.getItem(B+":pos");if(!M)return{...V};const w=JSON.parse(M);if(typeof w.x=="number"&&typeof w.y=="number")return w}catch{}return{...V}})(),C=null,H=null;const R=()=>window.innerWidth>=at,$=(M,w)=>{const tt=_.getBoundingClientRect(),J=a.getBoundingClientRect(),U=Math.max(0,tt.width-J.width),ct=Math.max(0,tt.height-J.height);return{x:Math.min(Math.max(0,M),U),y:Math.min(Math.max(0,w),ct)}},z=()=>{a.style.left=v.x+"px",a.style.top=v.y+"px",a.style.right="auto",a.style.bottom="auto"},L=()=>{typeof D=="function"&&(clearTimeout(H),H=setTimeout(D,X))},j=()=>{e.setAttribute("aria-expanded",F?"false":"true"),c.getToggleTitle&&(e.title=c.getToggleTitle(F));const M=e.querySelector("[data-float-chevron]");M&&(M.textContent=F?"v":"^")},rt=()=>{R()&&(v=$(v.x,v.y),z())},Q=M=>{F=M,a.classList.toggle(S,F),sessionStorage.setItem(B,F?"true":"false"),j(),L(),requestAnimationFrame(rt),setTimeout(rt,260)},pt=()=>{_.classList.add(T),a.classList.add("lab-controls-float"),v=$(v.x,v.y),z(),N&&(N.style.display="")},it=()=>{_.classList.remove(T),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",N&&(N.style.display="none")},ot=()=>{R()?(pt(),v=$(v.x,v.y),z()):it(),L()};if(a.classList.toggle(S,F),j(),ot(),e.addEventListener("click",M=>{M.stopPropagation(),Q(!F)}),k){k.addEventListener("pointerdown",w=>{R()&&(e.contains(w.target)||(w.preventDefault(),C={pointerId:w.pointerId,startX:w.clientX,startY:w.clientY,originX:v.x,originY:v.y},k.setPointerCapture(w.pointerId),k.classList.add("is-dragging")))}),k.addEventListener("pointermove",w=>{!C||C.pointerId!==w.pointerId||(v=$(C.originX+w.clientX-C.startX,C.originY+w.clientY-C.startY),z())});const M=w=>{if(!(!C||C.pointerId!==w.pointerId)){k.releasePointerCapture(w.pointerId),k.classList.remove("is-dragging");try{localStorage.setItem(B+":pos",JSON.stringify(v))}catch{}C=null,L()}};k.addEventListener("pointerup",M),k.addEventListener("pointercancel",M)}return window.addEventListener("resize",ot),{setCollapsed:Q,refreshMode:ot,isCollapsed:()=>F}}function Vt(c,g={}){St();const V=g.type||"liquid";let X=c("tools.thermometerLab.title"),_=c("tools.thermometerLab.subtitle");g.type==="liquid"?(X=c("tools.thermometerLab.liquid.title"),_=c("tools.thermometerLab.liquid.subtitle")||c("tools.thermometerLab.subtitle")):g.type==="resistance"?(X=c("tools.thermometerLab.resistance.title"),_=c("tools.thermometerLab.resistance.subtitle")||c("tools.thermometerLab.subtitle")):g.type==="thermistor"&&(X=c("tools.thermometerLab.thermistor.title"),_=c("tools.thermometerLab.thermistor.subtitle")||c("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
      <h2 class="tl-title">${X}</h2>
  ...
  `;const e={liquidType:"mercury",thermometerType:V,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},N={xs:11,sm:14,md:17,lg:18,sub:10};function lt(t,l,o,n){let r=Math.min(o,Math.max(l,t));return n>0&&(r=Math.round(r/n)*n,r=Math.min(o,Math.max(l,parseFloat(r.toFixed(10))))),r}function B(t,l,{min:o,max:n,step:r,decimals:f,onUpdate:s}){function d(p){const u=Number.isFinite(p)?p:o,i=lt(u,o,n,r);t.value=i,l.value=i.toFixed(f),s(i)}t.addEventListener("input",()=>d(parseFloat(t.value))),l.addEventListener("change",()=>d(parseFloat(l.value))),l.addEventListener("blur",()=>d(parseFloat(l.value)))}const D=460,at=340,S=8,T=10,k=D-S,F=40,v=640,C=420;function H(){const t={left:110,top:48,right:30,bottom:65};return{gx:t.left,gy:t.top,gw:v-t.left-t.right,gh:C-t.top-t.bottom,tickFont:`bold ${Math.round(v*.024)}px Arial`,axisFont:`bold ${Math.round(v*.026)}px Arial`,dotR:8,yLabelX:t.left-75,xLabelY:C-t.bottom+32}}function R(){return{minT:0,maxT:200,tickStep:25}}function $(t,l,o,n,r){return n+(t-l)/(o-l)*r}function z(t,l,o,n,r){return n+r-(t-l)/(o-l)*r}function L(t,l,o,n,r,f,s=null){const{gx:d,gy:p,gw:u,gh:i,tickFont:h,axisFont:y,yLabelX:m,xLabelY:q}=l;t.strokeStyle="#1e1e24",t.lineWidth=1;for(const b of f){const x=z(b.value,b.min,b.max,p,i);t.beginPath(),t.moveTo(d,x),t.lineTo(d+u,x),t.stroke()}for(let b=o;b<=n+.01;b+=r){const x=$(b,o,n,d,u);t.beginPath(),t.moveTo(x,p),t.lineTo(x,p+i),t.stroke()}t.strokeStyle="#4b5563",t.lineWidth=2.5,t.beginPath(),t.moveTo(d,p),t.lineTo(d,p+i),t.lineTo(d+u,p+i),t.stroke(),t.fillStyle="#e4e4e7",t.font=h,t.textAlign="right",t.textBaseline="middle";for(const b of f){const x=z(b.value,b.min,b.max,p,i);t.fillText(b.label,d-15,x)}t.textAlign="center",t.textBaseline="top";for(let b=o;b<=n+.01;b+=r){if(s!=null&&Math.abs(b-s)<.25)continue;const x=$(b,o,n,d,u);t.fillText(`${Math.round(b)}`,x,p+i+10)}return{gx:d,gy:p,gw:u,gh:i,axisFont:y,yLabelX:m,xLabelY:q}}function j(t,l){const o=l-t,n=o<=8?1:o<=14?2:5,r=[],f=Math.ceil(t/n)*n;for(let s=f;s<=l+.001;s+=n)r.push({value:s,label:s%1===0?`${s.toFixed(0)}`:`${s.toFixed(1)}`,min:t,max:l});return r}function rt(){const{maxT:t}=R(),l=Q(0),o=Q(t),n=o-l,r=Math.max(1,n*.1),f=Math.max(0,Math.round((l-r)*10)/10),s=Math.round((o+r)*10)/10;return{minL:f,maxL:s}}function Q(t){return e.liquidL0+(e.liquidL100-e.liquidL0)/100*t}function pt(){const{maxT:t}=R(),l=it(0),o=it(t),n=o-l,r=Math.max(.2,n*.1),f=Math.max(0,l-r),s=o+r,d=n<=2?.5:n<=4?1:2,p=[],u=Math.ceil(f/d)*d;for(let i=u;i<=s+.001;i+=d)p.push({value:i,label:i.toFixed(1),min:f,max:s});return{minR:f,maxR:s,ticks:p}}function it(t){return e.resistanceR0+(e.resistanceR100-e.resistanceR0)/100*t}function ot(t){const{maxT:l}=t;let o=e.thermistorR25;for(let s=0;s<=l;s+=5){const d=s+273.15,p=e.thermistorR25*Math.exp(e.thermistorBeta*(1/d-1/298.15));o=Math.max(o,p)}o=Math.ceil(o*1.08*10)/10;const n=0,r=o<=12?2:4,f=[];for(let s=0;s<=o+.001;s+=r)f.push({value:s,label:s.toFixed(0),min:n,max:o});return{minR:n,maxR:o,ticks:f}}const M=a.querySelector("#tl-thermometerCanvas"),w=M.getContext("2d"),tt=a.querySelector("#tl-graphCanvas"),J=tt.getContext("2d"),U=window.devicePixelRatio||1;M.width=D*U,M.height=at*U,w.scale(U,U),tt.width=v*U,tt.height=C*U,J.scale(U,U);function ct(){e.iceCubes=[];for(let t=0;t<5;t++)e.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});e.bubbles=[];for(let t=0;t<20;t++)e.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});e.heatWaves=[];for(let t=0;t<8;t++)e.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});e.steamParticles=[];for(let t=0;t<12;t++)e.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const Ct=200,mt=11;function Lt(){const t=Math.pow(e.bulbVolume/Ct,.3333333333333333);return mt*t}function qt(){if(e.thermometerType==="resistance"||e.thermometerType==="thermistor")return .35;const t=e.liquidType==="mercury"?1:8,l=.2+e.wallThickness*1.5,o=.4+e.bulbVolume*.003,n=1.35-e.capillaryBore*.45;return Math.max(.1,l*o*n*t*.15)}function $t(t){e.bathTemp<=8&&e.iceCubes.forEach(l=>{l.x+=l.speedX,l.y+=l.speedY,(l.x<65||l.x>175)&&(l.speedX*=-1),(l.y<195||l.y>210)&&(l.speedY*=-1)}),e.bathTemp>35&&e.heatWaves.forEach(l=>{l.y-=l.speedY*(1+e.bathTemp/100),l.y<185&&(l.y=265,l.x=65+Math.random()*110)}),e.bathTemp>=80&&e.bubbles.forEach(l=>{l.y-=l.speedY*(1+(e.bathTemp-80)/40),l.phase+=l.wobbleSpeed,l.x+=Math.sin(l.phase)*.3,l.y<185&&(l.y=260+Math.random()*10,l.x=60+Math.random()*120)}),e.bathTemp>=95&&e.steamParticles.forEach(l=>{l.x+=l.vx,l.y+=l.vy,l.alpha-=.005,(l.alpha<=0||l.y<130)&&(l.x=60+Math.random()*120,l.y=175+Math.random()*5,l.alpha=.2+Math.random()*.4)})}function zt(t){let s=59,d=130,p=246;if(e.bathTemp<25){const m=e.bathTemp/25;s=Math.round(180-m*121),d=Math.round(210-m*80),p=Math.round(250-m*4)}else{const m=Math.min(1,(e.bathTemp-25)/125);s=Math.round(59+m*180),d=Math.round(130-m*100),p=Math.round(246-m*190)}if(e.bathTemp>40){const m=Math.min(1,(e.bathTemp-40)/100),q=Date.now()*.02;t.fillStyle=`rgba(239, 68, 68, ${m*.25})`,t.beginPath(),t.roundRect(45,284,150,10,4),t.fill(),t.fillStyle="rgba(249, 115, 22, 0.85)",t.beginPath(),t.moveTo(55+130/2-25,284);for(let b=-25;b<=25;b+=6){const x=m*(12+Math.sin(b*.4+q)*5);t.lineTo(55+130/2+b,284-x)}t.lineTo(55+130/2+25,284),t.closePath(),t.fill()}t.strokeStyle="#4b5563",t.lineWidth=2,t.fillStyle="#121214",t.beginPath(),t.roundRect(55,180,130,100,[0,0,10,10]),t.fill();const u=t.createLinearGradient(55,190,55,280);u.addColorStop(0,`rgba(${s}, ${d}, ${p}, 0.25)`),u.addColorStop(1,`rgba(${s}, ${d}, ${p}, 0.55)`),t.fillStyle=u,t.beginPath(),t.moveTo(55,190);const i=e.bathTemp>=80?2:.5,h=e.bathTemp>=80?.09:.03,y=Date.now()*h;for(let m=55;m<=185;m+=5){const q=190+Math.sin(m*.15+y)*i;t.lineTo(m,q)}t.lineTo(185,280),t.lineTo(55,280),t.closePath(),t.fill(),e.bathTemp>35&&(t.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(e.bathTemp-35)/120)})`,t.lineWidth=1.2,e.heatWaves.forEach(m=>{t.beginPath(),t.moveTo(m.x,m.y),t.quadraticCurveTo(m.x+Math.sin(m.y*.06)*5,m.y-m.length/2,m.x,m.y-m.length),t.stroke()})),e.bathTemp<=8&&(t.fillStyle="rgba(224, 242, 254, 0.55)",t.strokeStyle="rgba(186, 230, 253, 0.8)",t.lineWidth=1,e.iceCubes.forEach(m=>{t.save(),t.translate(m.x,m.y),t.rotate(m.angle),t.beginPath(),t.roundRect(-m.size/2,-m.size/2,m.size,m.size,3),t.fill(),t.stroke(),t.restore()})),e.bathTemp>=80&&(t.fillStyle="rgba(255, 255, 255, 0.4)",t.strokeStyle="rgba(255, 255, 255, 0.65)",t.lineWidth=.6,e.bubbles.forEach(m=>{t.beginPath(),t.arc(m.x,m.y,m.r,0,Math.PI*2),t.fill(),t.stroke()})),e.bathTemp>=95&&e.steamParticles.forEach(m=>{t.fillStyle=`rgba(255, 255, 255, ${m.alpha})`,t.beginPath(),t.arc(m.x,m.y,m.r,0,Math.PI*2),t.fill()}),t.strokeStyle="#9ca3af",t.lineWidth=3.5,t.beginPath(),t.moveTo(54,180),t.lineTo(54,272),t.arcTo(54,281,65,281,8),t.lineTo(175,281),t.arcTo(186,281,186,272,8),t.lineTo(186,180),t.stroke(),t.strokeStyle="rgba(255, 255, 255, 0.4)",t.lineWidth=1.5,t.beginPath(),t.moveTo(59,190),t.lineTo(59,270),t.stroke()}function Ft(t,l,o){const n=l.split(" "),r=[];function f(d){if(t.measureText(d).width<=o){r.push(d);return}let p="";for(const u of d){const i=p+u;t.measureText(i).width>o&&p?(r.push(p),p=u):p=i}p&&r.push(p)}let s="";for(const d of n){const p=s?`${s} ${d}`:d;t.measureText(p).width<=o||!s?s=p:(f(s),s=d)}return s&&f(s),r.length?r:[l]}function Z(t,l,o,n,r,f,s="left"){if(!e.showLabels)return;t.font="bold 9px system-ui, sans-serif";const d=11,p=5,u=3,i=Math.max(40,s==="left"?D/2-S-n:n-D/2),h=Ft(t,f,i),y=h.map(E=>t.measureText(E).width),m=Math.max(...y)+p*2,q=h.length*d+u*2;let b=s==="left"?n:n-m;b=Math.max(S,Math.min(b,D-m-S));const x=r-q/2,W=s==="left"?b:b+m;t.strokeStyle="rgba(6, 182, 212, 0.7)",t.lineWidth=1,t.setLineDash([3,3]),t.beginPath(),t.moveTo(l,o),t.lineTo(W,r),t.stroke(),t.setLineDash([]),t.fillStyle="#06b6d4",t.beginPath(),t.arc(l,o,3,0,Math.PI*2),t.fill(),t.fillStyle="rgba(21, 21, 24, 0.9)",t.strokeStyle="#06b6d4",t.lineWidth=1,t.beginPath(),t.roundRect(b,x,m,q,4),t.fill(),t.stroke(),t.fillStyle="#f4f4f5",t.textAlign="center",t.textBaseline="middle",h.forEach((E,P)=>{const G=x+u+d*(P+.5);t.fillText(E,b+m/2,G)})}function Rt(t){const n=Lt(),r=250+Math.max(0,n-mt)*.35,f=r-n-1,s=10+e.wallThickness*8,d=120-s/2,p=120+s/2,u=t.createLinearGradient(d,20,p,20);u.addColorStop(0,"rgba(209, 213, 219, 0.85)"),u.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),u.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),u.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),u.addColorStop(1,"rgba(156, 163, 175, 0.9)"),t.fillStyle=u,t.strokeStyle="rgba(156, 163, 175, 0.8)",t.lineWidth=1,t.beginPath(),t.moveTo(d,f),t.lineTo(d,25),t.arcTo(d,20,d+5,20,5),t.arcTo(p,20,p,25,5),t.lineTo(p,f),t.closePath(),t.fill(),t.stroke();const i=t.createRadialGradient(120-n*.2,r-n*.2,n*.1,120,r,n);i.addColorStop(0,"rgba(255, 255, 255, 0.8)"),i.addColorStop(1,"rgba(156, 163, 175, 0.35)"),t.fillStyle=i,t.strokeStyle="#6b7280",t.lineWidth=.8+e.wallThickness*.6,t.beginPath(),t.arc(120,r,n+.5+e.wallThickness*.5,0,Math.PI*2),t.fill(),t.stroke();const h=Math.min(s*.72,.8+e.capillaryBore*4.5);t.fillStyle="#0a0a0c",t.fillRect(120-h/2,28,h,f-20-8);const y=e.liquidType==="mercury",m=y?"#a1a1aa":"#ef4444",q=y?"#f4f4f5":"#fee2e2",b=210,x=220,E=(b-40)/x,P=b-Math.min(x,e.thermometerTemp)*E;t.fillStyle=m,t.fillRect(120-h/2,P,h,f-P),t.beginPath(),t.ellipse(120,P,h/2,1.5,0,0,Math.PI*2),t.fill(),t.fillStyle=q,t.fillRect(120-h/6,P,h/3,f-P);const G=n*.9,A=t.createRadialGradient(120-G*.2,r-G*.2,G*.1,120,r,G);y?(A.addColorStop(0,"#f4f4f5"),A.addColorStop(.3,"#d4d4d8"),A.addColorStop(.8,"#71717a"),A.addColorStop(1,"#3f3f46")):(A.addColorStop(0,"#fee2e2"),A.addColorStop(.2,"#fca5a5"),A.addColorStop(.7,"#ef4444"),A.addColorStop(1,"#991b1b")),t.fillStyle=A,t.beginPath(),t.arc(120,r,G,0,Math.PI*2),t.fill(),t.strokeStyle="rgba(161, 161, 170, 0.6)",t.lineWidth=.5,t.font="6.5px Arial",t.fillStyle="#a1a1aa",t.textAlign="right",t.textBaseline="middle";for(let I=0;I<=200;I+=50){const O=b-I*E;t.beginPath(),t.moveTo(d,O),t.lineTo(d+4,O),t.stroke(),t.fillText(`${I}°C`,d-22,O+2.5)}e.showLabels&&(Z(t,d+1,80,T,50,c("tools.thermometerLab.labels.thinWall"),"left"),Z(t,120,P,k,P-15,c("tools.thermometerLab.labels.meniscus"),"right"),Z(t,120-h/2,130,T,130,c("tools.thermometerLab.labels.narrowBore"),"left"),Z(t,120,r,k,r+15,c("tools.thermometerLab.labels.largeBulb"),"right"))}function Mt(t){const s=t.createLinearGradient(115,20,125,20);s.addColorStop(0,"#71717a"),s.addColorStop(.3,"#f4f4f5"),s.addColorStop(.7,"#d4d4d8"),s.addColorStop(1,"#3f3f46"),t.fillStyle=s,t.strokeStyle="#4b5563",t.lineWidth=1,t.beginPath(),t.roundRect(115,20,10,225,[0,0,4,4]),t.fill(),t.stroke(),t.fillStyle="rgba(21, 21, 24, 0.8)",t.fillRect(117,200,6,40),t.strokeStyle="#e2e8f0",t.lineWidth=1.2,t.beginPath();let d=205;t.moveTo(118,d);for(let y=0;y<8;y++)d+=4,t.lineTo(122,d),d+=4,t.lineTo(118,d);t.stroke(),t.lineWidth=1.5,t.strokeStyle="#ef4444",t.beginPath(),t.moveTo(118,20),t.bezierCurveTo(110,5,200,30,245,60),t.stroke(),t.strokeStyle="#111827",t.beginPath(),t.moveTo(122,20),t.bezierCurveTo(130,8,210,45,245,75),t.stroke();const p=245,u=40,i=135,h=90;t.fillStyle="#18181b",t.strokeStyle="#6366f1",t.lineWidth=2.5,t.beginPath(),t.roundRect(p,u,i,h,10),t.fill(),t.stroke(),t.fillStyle="#022c22",t.beginPath(),t.roundRect(p+10,u+12,i-20,34,4),t.fill(),t.font='bold 17px "Courier New"',t.fillStyle="#10b981",t.textAlign="right",t.fillText(e.currentResistance.toFixed(2)+" Ω",p+i-16,u+34),t.font="6px Arial",t.fillStyle="#a7f3d0",t.textAlign="left",t.fillText("PLATINUM RTD METER",p+14,u+21),e.showLabels&&(Z(t,116,100,T,70,c("tools.thermometerLab.labels.metalSheath"),"left"),Z(t,120,225,k,205,c("tools.thermometerLab.labels.platinumCoil"),"right"))}function Pt(t){t.strokeStyle="#111827",t.lineWidth=1.2,t.beginPath(),t.moveTo(118,20),t.lineTo(118,245),t.stroke(),t.beginPath(),t.moveTo(122,20),t.lineTo(122,245),t.stroke();const r=20,f=225,s=12,d=120-s/2,p=t.createLinearGradient(d,r,d+s,r);p.addColorStop(0,"rgba(229, 231, 235, 0.4)"),p.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),p.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),p.addColorStop(1,"rgba(209, 213, 219, 0.6)"),t.fillStyle=p,t.strokeStyle="rgba(156, 163, 175, 0.6)",t.lineWidth=.8,t.beginPath(),t.roundRect(d,r,s,f-r,[0,0,3,3]),t.fill(),t.stroke();const u=7,i=t.createRadialGradient(120-u*.2,245-u*.2,u*.1,120,245,u);i.addColorStop(0,"#6b7280"),i.addColorStop(.7,"#1f2937"),i.addColorStop(1,"#09090b"),t.fillStyle=i,t.strokeStyle="#030712",t.lineWidth=1.2,t.beginPath(),t.arc(120,245,u,0,Math.PI*2),t.fill(),t.stroke(),t.lineWidth=1.5,t.strokeStyle="#ef4444",t.beginPath(),t.moveTo(118,20),t.bezierCurveTo(110,5,200,30,245,60),t.stroke(),t.strokeStyle="#111827",t.beginPath(),t.moveTo(122,20),t.bezierCurveTo(130,8,210,45,245,75),t.stroke();const h=245,y=40,m=135,q=90;t.fillStyle="#18181b",t.strokeStyle="#10b981",t.lineWidth=2.5,t.beginPath(),t.roundRect(h,y,m,q,10),t.fill(),t.stroke(),t.fillStyle="#022c22",t.beginPath(),t.roundRect(h+10,y+12,m-20,34,4),t.fill(),t.font='bold 17px "Courier New"',t.fillStyle="#34d399",t.textAlign="right",t.fillText(e.currentThermistorR.toFixed(2)+" kΩ",h+m-16,y+34),t.font="5px Arial",t.fillStyle="#a7f3d0",t.textAlign="left",t.fillText(c("tools.thermometerLab.thermistor.meterLabelLine1"),h+14,y+52),t.fillText(c("tools.thermometerLab.thermistor.meterLabelLine2"),h+14,y+59),e.showLabels&&(Z(t,118,120,T,90,c("tools.thermometerLab.labels.leads"),"left"),Z(t,120,245,k,225,c("tools.thermometerLab.labels.semiconductorBead"),"right"))}function ft(t,l,o,n,r,f,s,d,p){const{gx:u,gy:i,gw:h,gh:y,tickFont:m}=l;t.strokeStyle="rgba(255, 255, 255, 0.2)",t.lineWidth=1,t.setLineDash([4,4]),t.beginPath(),t.moveTo(o,n),t.lineTo(o,i+y),t.stroke(),t.beginPath(),t.moveTo(o,n),t.lineTo(u,n),t.stroke(),t.setLineDash([]);const q=i+y+10;t.font=m,t.textAlign="center",t.textBaseline="top";const b=`${r.toFixed(1)}${s}`,x=t.measureText(b).width+10,W=18;t.fillStyle=p,t.beginPath(),t.roundRect(o-x/2,q-2,x,W,3),t.fill(),t.fillStyle="#000",t.fillText(b,o,q),t.textAlign="right",t.textBaseline="middle";const E=`${f.toFixed(2)} ${d}`,P=t.measureText(E).width+10;t.fillStyle=p,t.beginPath(),t.roundRect(u-P-2,n-7,P,15,3),t.fill(),t.fillStyle="#000",t.fillText(E,u-7,n)}function Gt(t){const l=H(),{minL:o,maxL:n}=rt(),{minT:r,maxT:f,tickStep:s}=R(),d=j(o,n),p=L(t,l,r,f,s,d,e.thermometerTemp),{gx:u,gy:i,gw:h,gh:y,axisFont:m,yLabelX:q,xLabelY:b,dotR:x}={...l,...p};t.save(),t.translate(q,i+y/2),t.rotate(-Math.PI/2),t.font=m,t.fillStyle="#e4e4e7",t.fillText("Length of liquid column / cm",0,0),t.restore(),t.font=m,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",u+h/2,b);const W=f,E=$(0,r,f,u,h),P=z(Q(0),o,n,i,y),G=$(W,r,f,u,h),A=z(Q(W),o,n,i,y);t.strokeStyle="#ef4444",t.lineWidth=3,t.beginPath(),t.moveTo(E,P),t.lineTo(G,A),t.stroke();const I=e.thermometerTemp,O=e.currentLength;if(I>=r&&I<=f){const K=$(I,r,f,u,h),nt=z(O,o,n,i,y);ft(t,l,K,nt,I,O,"°C","cm","#ef4444"),t.shadowColor="#ef4444",t.shadowBlur=10,t.fillStyle="#ef4444",t.beginPath(),t.arc(K,nt,x,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function Et(t){const l=H(),{minR:o,maxR:n,ticks:r}=pt(),f=R(),s=L(t,l,f.minT,f.maxT,f.tickStep,r,e.thermometerTemp),{gx:d,gy:p,gw:u,gh:i,axisFont:h,yLabelX:y,xLabelY:m,dotR:q}={...l,...s};t.save(),t.translate(y,p+i/2),t.rotate(-Math.PI/2),t.font=h,t.fillStyle="#e4e4e7",t.fillText("Resistance of platinum / Ω",0,0),t.restore(),t.font=h,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",d+u/2,m);const{minT:b,maxT:x}=f,W=x,E=$(0,b,x,d,u),P=z(it(0),o,n,p,i),G=$(W,b,x,d,u),A=z(it(W),o,n,p,i);t.strokeStyle="#6366f1",t.lineWidth=3,t.beginPath(),t.moveTo(E,P),t.lineTo(G,A),t.stroke();const I=e.thermometerTemp,O=e.currentResistance;if(I>=b&&I<=x){const K=$(I,b,x,d,u),nt=z(O,o,n,p,i);ft(t,l,K,nt,I,O,"°C","Ω","#6366f1"),t.shadowColor="#6366f1",t.shadowBlur=10,t.fillStyle="#6366f1",t.beginPath(),t.arc(K,nt,q,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function At(t){const l=H(),o=R(),{minR:n,maxR:r,ticks:f}=ot(o),s=L(t,l,o.minT,o.maxT,o.tickStep,f,e.thermometerTemp),{gx:d,gy:p,gw:u,gh:i,axisFont:h,yLabelX:y,xLabelY:m,dotR:q}={...l,...s},{minT:b,maxT:x}=o;t.save(),t.translate(y,p+i/2),t.rotate(-Math.PI/2),t.font=h,t.fillStyle="#e4e4e7",t.fillText("Resistance of thermistor / kΩ",0,0),t.restore(),t.font=h,t.fillStyle="#e4e4e7",t.textAlign="center",t.fillText("temperature / °C",d+u/2,m),t.strokeStyle="#10b981",t.lineWidth=3,t.beginPath();let W=!1;for(let G=b;G<=x;G+=1){const A=G+273.15,I=e.thermistorR25*Math.exp(e.thermistorBeta*(1/A-1/298.15)),O=$(G,b,x,d,u),K=z(Math.min(r,I),n,r,p,i);K>=p&&K<=p+i&&(W?t.lineTo(O,K):(t.moveTo(O,K),W=!0))}t.stroke();const E=e.thermometerTemp,P=e.currentThermistorR;if(E>=b&&E<=x){const G=$(E,b,x,d,u),A=z(Math.min(r,P),n,r,p,i);ft(t,l,G,A,E,P,"°C","kΩ","#10b981"),t.shadowColor="#10b981",t.shadowBlur=10,t.fillStyle="#10b981",t.beginPath(),t.arc(G,A,q,0,Math.PI*2),t.fill(),t.shadowBlur=0}}function bt(){w.clearRect(0,0,D,at),J.clearRect(0,0,v,C),w.save(),w.translate(F,0),zt(w),e.thermometerType==="liquid"?Rt(w):e.thermometerType==="resistance"?Mt(w):Pt(w),w.restore(),e.thermometerType==="liquid"?Gt(J):e.thermometerType==="resistance"?Et(J):At(J)}function Bt(){const{sm:t,md:l,lg:o,xs:n,sub:r}=N,f=a.querySelector("#tl-svg-formula-liquid");f&&(f.innerHTML=`
    ...
    `}function Ht(t){a.querySelector("#tl-bath-temp-display").innerHTML=e.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=e.bathTemp.toFixed(1)+" °C";const l=a.querySelector("#tl-bath-state");e.bathTemp<=0?l.textContent="Melting Ice Bath":e.bathTemp>=100?l.textContent="Boiling Water/Steam":e.bathTemp===150?l.textContent="Hot Cooking Oil":l.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=t.toFixed(2)+" s";const o=a.querySelector("#tl-alcohol-boiling-warning");e.thermometerType==="liquid"&&e.liquidType==="alcohol"&&e.bathTemp>=78?o.style.display="block":o.style.display="none",e.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=e.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=e.thermometerTemp.toFixed(1)+"°C"):e.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=e.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=e.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=e.currentThermistorR.toFixed(2)+" kΩ",Bt()}let st=null;function ht(t){e.lastTimestamp||(e.lastTimestamp=t);const l=(t-e.lastTimestamp)/1e3;e.lastTimestamp=t;const o=Math.min(l,.1),n=qt(),r=o/n*(e.bathTemp-e.thermometerTemp);e.thermometerTemp+=r,e.currentLength=e.liquidL0+(e.liquidL100-e.liquidL0)/100*e.thermometerTemp,e.currentResistance=e.resistanceR0+(e.resistanceR100-e.resistanceR0)/100*e.thermometerTemp;const f=e.thermometerTemp+273.15;e.currentThermistorR=e.thermistorR25*Math.exp(e.thermistorBeta*(1/f-1/298.15)),$t(),bt(),Ht(n),st=requestAnimationFrame(ht)}function gt(){const t=parseFloat(a.querySelector("#tl-input-faulty-cf").value),l=parseFloat(a.querySelector("#tl-input-faulty-cu").value),o=Number.isFinite(t)?t:-1.5,n=Number.isFinite(l)?l:105,r=n-o;return{cf:o,cu:n,interval:r}}function ut(t){const l=Math.round(t*100)/100;return l>=0?l.toFixed(1):`(${l.toFixed(1)})`}function et(){if(!a.querySelector("#tl-input-faulty-cf"))return;const{cf:t,cu:l,interval:o}=gt(),n=a.querySelector("#tl-val-faulty-interval"),r=a.querySelector("#tl-faulty-error-a"),f=a.querySelector("#tl-faulty-error-b"),s=Math.abs(o)<.01;n.textContent=o.toFixed(1)+" °C";const d=a.querySelector("#tl-svg-formula-faulty-a"),p=a.querySelector("#tl-svg-formula-faulty-b");if(s){r.hidden=!1,r.textContent="C_u must differ from C_f (interval cannot be zero).",f.hidden=!1,f.textContent=r.textContent,d&&(d.innerHTML=""),p&&(p.innerHTML="");return}r.hidden=!0,f.hidden=!0;const u=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,i=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,h=(u-t)/o*100,y=i/100*o+t;d&&(d.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `),It()}function Yt(){const{sm:t,md:l,sub:o}=N,n=e.thermometerTemp,r=e.liquidL100-e.liquidL0,f=e.liquidL0+r/100*n,s=a.querySelector("#tl-svg-formula-t-to-l");s&&(s.innerHTML=`
        <svg height="90" width="340" style="background:transparent; overflow:visible;">
          <line x1="10" y1="30" x2="100" y2="30" stroke="#fff" stroke-width="1.2" />
          <text x="55" y="21" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">${e.liquidL100.toFixed(1)} - ${e.liquidL0.toFixed(1)}</text>
          <text x="55" y="43" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">100 - 0</text>
      ...
      `)}function Wt(){const{sm:t,md:l,sub:o}=N,n=e.thermometerTemp,r=e.resistanceR100-e.resistanceR0,f=e.resistanceR0+r/100*n,s=a.querySelector("#tl-svg-formula-t-to-r");s&&(s.innerHTML=`
        <svg height="90" width="340" style="background:transparent; overflow:visible;">
          <line x1="10" y1="30" x2="100" y2="30" stroke="#fff" stroke-width="1.2" />
          <text x="55" y="21" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">${e.resistanceR100.toFixed(1)} - ${e.resistanceR0.toFixed(1)}</text>
          <text x="55" y="43" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="${t}" text-anchor="middle">100 - 0</text>
      ...
      `)}function Y(){et(),Yt(),Wt()}function dt(t,l){a.querySelector("#"+t).addEventListener("click",()=>{e.bathTemp=l,a.querySelector("#tl-bath-temp-slider").value=l,Y()})}function yt(t){a.querySelectorAll(".tl-tab-btn").forEach(l=>{l.classList.toggle("active",l.getAttribute("data-tl-tab")===t)}),a.querySelectorAll(".tl-tab-content").forEach(l=>{l.classList.toggle("active",l.id==="tl-tab-"+t)}),a.querySelectorAll(".tl-live-tab").forEach(l=>{l.classList.toggle("active",l.id==="tl-live-"+t)}),e.thermometerType=t}function _t(){var s,d,p,u;a.querySelectorAll(".tl-tab-btn").forEach(i=>{i.addEventListener("click",()=>{yt(i.getAttribute("data-tl-tab")),Y()})}),a.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{e.showLabels=!e.showLabels,a.querySelector("#tl-lbl-toggle-labels").textContent=e.showLabels?c("tools.thermometerLab.labels.hide"):c("tools.thermometerLab.labels.show")}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",i=>{e.bathTemp=parseFloat(i.target.value),Y()}),dt("tl-btn-preset-ice",0),dt("tl-btn-preset-room",25),dt("tl-btn-preset-steam",100),dt("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{e.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",Y()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{e.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",Y()}),B(a.querySelector("#tl-slider-bulb-vol"),a.querySelector("#tl-input-bulb-vol"),{min:10,max:1e3,step:10,decimals:0,onUpdate:i=>{e.bulbVolume=i}}),B(a.querySelector("#tl-slider-wall-thick"),a.querySelector("#tl-input-wall-thick"),{min:.05,max:3,step:.05,decimals:2,onUpdate:i=>{e.wallThickness=i}}),B(a.querySelector("#tl-slider-capillary-bore"),a.querySelector("#tl-input-capillary-bore"),{min:.05,max:2,step:.05,decimals:2,onUpdate:i=>{e.capillaryBore=i}}),B(a.querySelector("#tl-slider-liquid-l0"),a.querySelector("#tl-input-liquid-l0"),{min:.5,max:15,step:.1,decimals:1,onUpdate:i=>{e.liquidL0=i,Y()}}),B(a.querySelector("#tl-slider-liquid-l100"),a.querySelector("#tl-input-liquid-l100"),{min:5,max:30,step:.1,decimals:1,onUpdate:i=>{e.liquidL100=i,Y()}}),B(a.querySelector("#tl-slider-resistance-r0"),a.querySelector("#tl-input-resistance-r0"),{min:.5,max:20,step:.1,decimals:1,onUpdate:i=>{e.resistanceR0=i,a.querySelector("#tl-spec-resistance-r0").textContent=i.toFixed(1)+" Ω",Y()}}),B(a.querySelector("#tl-slider-resistance-r100"),a.querySelector("#tl-input-resistance-r100"),{min:2,max:30,step:.1,decimals:1,onUpdate:i=>{e.resistanceR100=i,a.querySelector("#tl-spec-resistance-r100").textContent=i.toFixed(1)+" Ω",Y()}}),B(a.querySelector("#tl-slider-thermistor-r25"),a.querySelector("#tl-input-thermistor-r25"),{min:.5,max:50,step:.1,decimals:1,onUpdate:i=>{e.thermistorR25=i,a.querySelector("#tl-spec-thermistor-r25").textContent=i.toFixed(1)+" kΩ",Y()}}),B(a.querySelector("#tl-slider-thermistor-beta"),a.querySelector("#tl-input-thermistor-beta"),{min:1e3,max:8e3,step:50,decimals:0,onUpdate:i=>{e.thermistorBeta=i,a.querySelector("#tl-spec-thermistor-beta").textContent=i+" K",Y()}});const o=a.querySelector("#tl-btn-solve-q10a"),n=a.querySelector("#tl-btn-solve-q10b");o&&n&&(o.addEventListener("click",()=>{o.classList.add("active"),n.classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active"),et()}),n.addEventListener("click",()=>{o.classList.remove("active"),n.classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active"),et()})),(s=a.querySelector("#tl-input-faulty-cf"))==null||s.addEventListener("input",et),(d=a.querySelector("#tl-input-faulty-cu"))==null||d.addEventListener("input",et),(p=a.querySelector("#tl-input-q10a-cm"))==null||p.addEventListener("input",et),(u=a.querySelector("#tl-input-q10b-t"))==null||u.addEventListener("input",et);const r=a.querySelector("#tl-input-t-to-l");r&&r.addEventListener("input",Y);const f=a.querySelector("#tl-input-t-to-r");f&&f.addEventListener("input",Y)}if(g.type){const t=a.querySelector(".tl-tabs-container");t&&(t.style.display="none")}yt(V),ct(),_t(),Y();const xt=a.querySelector(".tl-dash"),vt=a.querySelector(".tl-controls"),wt=a.querySelector("#tl-controls-toggle"),Nt=a.querySelector("#tl-controls-drag"),Ot=a.querySelector(".tl-controls-float-bar");return xt&&vt&&wt&&kt({container:xt,panel:vt,toggleBtn:wt,dragHandle:Nt,dragSurface:Ot,storageKey:`s3phy-thermo-${V}`,breakpoint:1024,getToggleTitle:t=>c(t?"tools.floatingControls.showParams":"tools.floatingControls.hideParams"),onLayoutChange:()=>bt()}),st=requestAnimationFrame(ht),a._thermometerLabCleanup=()=>{st&&cancelAnimationFrame(st)},a}function Ut(c){St();const g=document.createElement("div");g.className="tl-wrap tl-wrap--faulty-cal",g.innerHTML=`
    <div class="tl-head">
  ...
  `;function V(S){const T=Math.round(S*100)/100;return T>=0?T.toFixed(1):`(${T.toFixed(1)})`}function X(){const S=parseFloat(g.querySelector("#fsc-input-faulty-cf").value),T=parseFloat(g.querySelector("#fsc-input-faulty-cu").value),k=Number.isFinite(S)?S:-1.5,F=Number.isFinite(T)?T:105,v=F-k;return{cf:k,cu:F,interval:v}}function _(){const S=g.querySelector("#fsc-faulty-svg-container");if(!S)return;const{cf:T,cu:k,interval:F}=X(),v=parseFloat(g.querySelector("#fsc-input-q10a-cm").value)||0,C=parseFloat(g.querySelector("#fsc-input-q10b-t").value)||0,H=g.querySelector("#fsc-input-pane-q10a").classList.contains("active"),R=H?(v-T)/F*100:C,$=H?v:C/100*F+T,z=j=>130-j/100*80,L=Number.isFinite(R)?z(R):130;S.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        <g transform="translate(0, 0)">
          <rect x="80" y="25" width="12" height="115" rx="6" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
          <circle cx="86" cy="144" r="10" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
          ...
          <line x1="70" y1="50" x2="78" y2="50" stroke="#ef4444" stroke-width="1.5" />
          <text x="65" y="53" fill="#ef4444" font-size="10" font-weight="bold" text-anchor="end">100°C</text>
          <text x="65" y="${L+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${Number.isFinite(R)?R.toFixed(1):"—"}°C</text>
          <text x="86" y="170" fill="#a1a1aa" font-size="9" font-weight="bold" text-anchor="middle">${c("tools.thermometerLab.faulty.trueScale")}</text>
        </g>
        <g transform="translate(130, 0)">
          <rect x="100" y="25" width="12" height="115" rx="6" fill="rgba(255,255,255,0.05)" stroke="#4b5563" stroke-width="1" />
          ...
          <text x="125" y="${L+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${Number.isFinite($)?$.toFixed(1):"—"}°C</text>
          <text x="106" y="170" fill="#a1a1aa" font-size="9" font-weight="bold" text-anchor="middle">${c("tools.thermometerLab.faulty.faultyScale")}</text>
        </g>
    ...
    `}function a(S){const T=S==="a";g.querySelector("#fsc-btn-solve-q10a").classList.toggle("active",T),g.querySelector("#fsc-btn-solve-q10b").classList.toggle("active",!T),g.querySelector("#fsc-input-pane-q10a").classList.toggle("active",T),g.querySelector("#fsc-input-pane-q10b").classList.toggle("active",!T),g.querySelector("#fsc-pane-q10a").classList.toggle("active",T),g.querySelector("#fsc-pane-q10b").classList.toggle("active",!T),e()}function e(){const{cf:S,cu:T,interval:k}=X(),F=g.querySelector("#fsc-val-faulty-interval"),v=g.querySelector("#fsc-faulty-error-a"),C=g.querySelector("#fsc-faulty-error-b"),H=g.querySelector("#fsc-svg-formula-faulty-a"),R=g.querySelector("#fsc-svg-formula-faulty-b"),$=Math.abs(k)<.01,z=c("tools.faultyCalibration.invalidInterval");if(F.textContent=k.toFixed(1)+" °C",$){v.hidden=!1,v.textContent=z,C.hidden=!1,C.textContent=z,H&&(H.innerHTML=""),R&&(R.innerHTML=""),_();return}v.hidden=!0,C.hidden=!0;const L=parseFloat(g.querySelector("#fsc-input-q10a-cm").value)||0,j=parseFloat(g.querySelector("#fsc-input-q10b-t").value)||0,rt=(L-S)/k*100,Q=j/100*k+S;H&&(H.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">T =</text>
          <line x1="40" y1="21" x2="160" y2="21" stroke="#fff" stroke-width="1.5" />
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${L.toFixed(1)} - ${V(S)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${T.toFixed(1)} - ${V(S)}</text>
          <text x="170" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
      ...
      `),R&&(R.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">100</text>
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${V(S)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${Q.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),_()}g.querySelector("#fsc-btn-solve-q10a").addEventListener("click",()=>a("a")),g.querySelector("#fsc-btn-solve-q10b").addEventListener("click",()=>a("b")),g.querySelector("#fsc-input-faulty-cf").addEventListener("input",e),g.querySelector("#fsc-input-faulty-cu").addEventListener("input",e),g.querySelector("#fsc-input-q10a-cm").addEventListener("input",e),g.querySelector("#fsc-input-q10b-t").addEventListener("input",e);const N=g.querySelector(".tl-dash--faulty"),lt=g.querySelector(".tl-controls"),B=g.querySelector("#fsc-controls-toggle"),D=g.querySelector("#fsc-controls-drag"),at=g.querySelector(".tl-controls-float-bar");return N&&lt&&B&&kt({container:N,panel:lt,toggleBtn:B,dragHandle:D,dragSurface:at,storageKey:"s3phy-faulty-calibration",breakpoint:1024,getToggleTitle:S=>c(S?"tools.floatingControls.showParams":"tools.floatingControls.hideParams")}),e(),g._thermometerLabCleanup=()=>{},g}export{Ut as createFaultyScaleCalibrationLab,Vt as createThermometerLab};
