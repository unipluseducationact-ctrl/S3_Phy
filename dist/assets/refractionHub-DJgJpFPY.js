const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./opticsLightLensWorksheet-BwsLBQZS.js","./index-zQGyD5wR.js","./index-D16P_DNl.css","./refractionLab-CRMyPjal.js","./createLabIframe-C5_C4Any.js","./tirEscapeLab-woDFf3Hq.js"])))=>i.map(i=>d[i]);
import{t as e,_ as y,g as P}from"./index-zQGyD5wR.js";import{l as j,c as z,s as g,h as V,a as Z}from"./hubHelpers-j-XRXzmY.js";import{m as W}from"./hubShell-G2I7KnJr.js";import{r as Y,h as U}from"./toolsShell-C-Th6Ujm.js";import{m as q,b as x}from"./flashcardDeck-D-G_zwKU.js";const _=["refraction","refractionTir"],v="s3phy.refraction.tool",F=["lightLens"],G="20260627-em-v2",k=[{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"}],E=[{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"}],S={lightLens:()=>y(()=>import("./opticsLightLensWorksheet-BwsLBQZS.js"),__vite__mapDeps([0,1,2]),import.meta.url).then(o=>o.createOpticsLightLensWorksheet)},B={refraction:()=>y(()=>import("./refractionLab-CRMyPjal.js"),__vite__mapDeps([3,4,1,2]),import.meta.url).then(o=>o.createRefractionLab),refractionTir:()=>y(()=>import("./tirEscapeLab-woDFf3Hq.js"),__vite__mapDeps([5,4,1,2]),import.meta.url).then(o=>o.createTirEscapeLab)};function O(o){return e({refraction:"tools.refraction.title",refractionTir:"tools.refractionTir.title"}[o]||o)}function J(o){return e({lightLens:"worksheets.opticsLightLensTitle"}[o]||o)}function ot(o){let n=sessionStorage.getItem("s3phy.refraction.section")||"topics",d=j(v,_,"refraction"),f="lightLens",a=null,c={main:null},m=null,l=null,r=null;const w=[{value:"refractionTir",labelKey:"flashcards.deck.refractionTir"}];function h(){z(m),m=null}async function R(t){t.innerHTML="",h();const i=B[d];if(!i)return;const s=(await i())(e);m=s,t.appendChild(s)}async function $(t){if(!t)return;r==null||r(),r=null,t.innerHTML="";const i=S[f];if(!i)return;const s=(await i())(e);t.appendChild(s),r=s._opticsLightLensWorksheetCleanup||null}function A(){const t=F.map(i=>`<button type="button" data-worksheet="${i}" class="${f===i?"active":""}">${J(i)}</button>`).join("");return`
