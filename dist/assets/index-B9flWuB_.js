        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${ft.map(({id:f,titleKey:n,descKey:a})=>`
            <div class="card">
              <h3>${l(n)}</h3>
              <p>${l(a)}</p>
              <button class="btn primary" type="button" data-strand="${f}">${l("strand.open")}</button>
            </div>`).join("")}
        </div>
      </section>
...
`;function gt(){if(document.getElementById(Be))return;const t=document.createElement("style");t.id=Be,t.textContent=ht,document.head.appendChild(t)}function bt(t){gt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
  ...
  `;const c=r.querySelector(".rml-canvas"),i=c.getContext("2d"),f=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),L=r.querySelector('[data-rml-disp="inc"]'),F=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,O=380,Z=300,C="#22d3ee",z="bold 17px system-ui, sans-serif";let I=0,j=-140,ae=!0,X=!0,U=!0,V=!0;function Y(m){return m*Math.PI/180}function J(m,u,d,h,A,M=2,H=!1){i.beginPath(),i.lineWidth=M,i.strokeStyle=A,i.setLineDash(H?[6,6]:[]);const y=m+Math.cos(Y(d))*h,w=u+Math.sin(Y(d))*h;return i.moveTo(m,u),i.lineTo(y,w),i.stroke(),i.setLineDash([]),{x:y,y:w}}function ee(m,u,d,h,A,M=14){const H=d-m,y=h-u,w=Math.hypot(H,y);if(w<1e-6)return;const B=H/w,R=y/w,Q=d-B*M,E=h-R*M,ce=.45*M;i.beginPath(),i.fillStyle=A,i.moveTo(d,h),i.lineTo(Q-R*ce,E+B*ce),i.lineTo(Q+R*ce,E-B*ce),i.closePath(),i.fill()}function K(m,u,d,h,A,M=25){i.beginPath(),i.strokeStyle=h,i.lineWidth=2;const H=Math.min(m,u),y=Math.max(m,u);if(i.arc($,O,d,Y(H),Y(y),!1),i.stroke(),A){const w=(H+y)/2,B=$+Math.cos(Y(w))*(d+M),R=O+Math.sin(Y(w))*(d+M);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=h,i.fillText(A,B,R),i.restore()}}function ne(m,u,d,h,A){i.clearRect(0,0,c.width,c.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,O),i.lineTo($+200,O),i.stroke(),i.setLineDash([]),i.lineCap="butt";const M=$+Math.cos(Y(m))*Z,H=O+Math.sin(Y(m))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(M,H),i.lineTo($,O),i.stroke();const y=(M+$)*.5,w=(H+O)*.5,B=Math.hypot($-M,O-H)||1,R=($-M)/B,Q=(O-H)/B;if(ee(y-R*28,w-Q*28,y,w,"#fff",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),M,H-12),i.restore(),ae){const E=J($,O,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),E.x+6,E.y-4),i.restore()}if(X){const E=J($,O,h,Z,"#00e676",2,!1);ee($,O,E.x,E.y,"#00e676",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),E.x,E.y-14),i.restore()}i.save(),i.translate($,O),i.rotate(Y(I)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let E=-190;E<200;E+=15)i.moveTo(E,0),i.lineTo(E-5,8);if(i.stroke(),i.restore(),U){const E=J($,O,u,Z-40,C,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=C,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),E.x+6,E.y-4),i.restore()}if(V){const E=J($,O,d,Z,C,4);ee($,O,E.x,E.y,C,16),Math.abs(I)>.5&&(i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=C,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),E.x,E.y-14),i.restore())}if(U&&K(m,u,100,"#ffcc00",`i=${A.toFixed(0)}°`,25),U&&V&&K(u,d,100,C,`r=${A.toFixed(0)}°`,25),ae&&U&&Math.abs(I)>.5&&K(-90,u,50,"#ffcc00",`θ=${Math.abs(I)}°`,20),X&&V&&Math.abs(I)>.5){const E=d-h;K(h,d,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${E.toFixed(0)}°`,40)}}function g(){I=parseFloat(f.value),j=parseFloat(n.value);const m=I>0?"+":"";a.textContent=`${m}${I}°`,L.textContent=`${j}°`;const u=-90,d=Math.abs(j-u),h=u+d,A=-90+I,M=Math.abs(j-A),H=A+M,y=H-h;F.textContent=`${M.toFixed(1)}°`,te.textContent=`${M.toFixed(1)}°`;const w=y>0?"+":"";P.textContent=`${w}${y.toFixed(1)}°`,ne(j,A,H,h,M)}return r.querySelectorAll("[data-rml-toggle]").forEach(m=>{m.addEventListener("click",()=>{const u=m.getAttribute("data-rml-toggle");u==="orig-norm"&&(ae=!ae),u==="orig-ray"&&(X=!X),u==="new-norm"&&(U=!U),u==="new-ray"&&(V=!V),m.classList.toggle("active"),g()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{f.value="0",g()}),f.addEventListener("input",g),n.addEventListener("input",g),g(),r}function vt(t){const r=document.createElement("div");r.className="tool-tir-escape";const c=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;return c.src=`${f}tir-escape/index.html?embed=1`,c.title=t("tools.refractionTir.title"),c.setAttribute("loading","lazy"),c.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(c),r}function yt(t,r={}){const c=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",f=document.createElement("div");f.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",L=a.endsWith("/")?a:`${a}/`;return n.src=`${L}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(c)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",f.appendChild(n),f}function wt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const c=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;function n(){return`${f}em-spectrum/index.html?lang=${encodeURIComponent(Se())}`}c.src=n(),c.title=t("tools.em.title"),c.setAttribute("loading","lazy"),c.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var L;try{(L=c.contentWindow)==null||L.postMessage({type:"s3phy:lang",lang:Se()},"*")}catch{c.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(c),r}function xt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const c=r.querySelector("[data-r]"),i=r.querySelector("[data-g]"),f=r.querySelector("[data-b]"),n=r.querySelector(".rgb-mixer-canvas"),a=r.querySelector(".rgb-mixer-stage"),L=n.getContext("2d");function F(C){return C.toString(16).padStart(2,"0")}function te(C,z,I){const j=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),X=j/2,U=ae/2,V=Math.min(j,ae)*.34,Y=V*.5,J=Math.sqrt(3)/2;L.clearRect(0,0,j,ae),L.fillStyle="#000",L.fillRect(0,0,j,ae);const ee=[{x:X,y:U-Y,rgb:[255,0,0],val:C},{x:X-Y*J,y:U+Y*.5,rgb:[0,255,0],val:z},{x:X+Y*J,y:U+Y*.5,rgb:[0,0,255],val:I}];L.globalCompositeOperation="lighter",ee.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[g,m,u]=K.rgb,d=L.createRadialGradient(K.x,K.y,0,K.x,K.y,V);d.addColorStop(0,`rgba(${g},${m},${u},${ne})`),d.addColorStop(.65,`rgba(${g},${m},${u},${ne})`),d.addColorStop(.85,`rgba(${g},${m},${u},${ne*.5})`),d.addColorStop(1,`rgba(${g},${m},${u},0)`),L.fillStyle=d,L.beginPath(),L.arc(K.x,K.y,V,0,Math.PI*2),L.fill()}),L.globalCompositeOperation="source-over"}function P(){const C=a.getBoundingClientRect(),z=Math.max(200,Math.min(C.width-8,C.height-8,720)),I=window.devicePixelRatio||1;n.width=z*I,n.height=z*I,n.style.width=`${z}px`,n.style.height=`${z}px`,L.setTransform(I,0,0,I,0,0),te(+c.value,+i.value,+f.value)}function $(){const C=+c.value,z=+i.value,I=+f.value,j=`rgb(${C}, ${z}, ${I})`,ae=`#${F(C)}${F(z)}${F(I)}`;r.querySelector("[data-r-val]").textContent=C,r.querySelector("[data-g-val]").textContent=z,r.querySelector("[data-b-val]").textContent=I,r.querySelector("[data-r-bar]").style.width=`${C/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${z/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${I/255*100}%`,c.style.setProperty("--fill",`${C/255*100}%`),i.style.setProperty("--fill",`${z/255*100}%`),f.style.setProperty("--fill",`${I/255*100}%`);const X=r.querySelector("[data-swatch]");X.style.backgroundColor=j,X.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${j}`),r.querySelector("[data-rgb-text]").textContent=j,r.querySelector("[data-hex-text]").textContent=ae,te(C,z,I)}function O(C,z,I){c.value=C,i.value=z,f.value=I,$()}return[c,i,f].forEach(C=>C.addEventListener("input",$)),r.querySelectorAll(".rgb-presets button").forEach(C=>{C.addEventListener("click",()=>{O(+C.dataset.r,+C.dataset.g,+C.dataset.b)})}),new ResizeObserver(()=>P()).observe(a),requestAnimationFrame(()=>{P(),$()}),r}const qt=["topics","notes","tools","worksheets","flashcards","summary"],St={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function tt(t,{subtitleKey:r,activeSection:c,onSection:i,onLang:f}){t.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),L=t.querySelector("[data-lang]"),F=t.querySelector("[data-strand-back]");let te=c;function P(C){te=C,a.innerHTML=qt.map(z=>`<button type="button" class="${C===z?"active":""}" data-sec="${z}">${l(St[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>i(z.getAttribute("data-sec")))})}function $(){L.innerHTML=`
      <button type="button" data-set-lang="en" class="${Se()==="en"?"active":""}">${l("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${Se()==="zh-Hant"?"active":""}">${l("lang.zhHant")}</button>
    `,L.querySelectorAll("button").forEach(C=>{C.addEventListener("click",()=>{Ze(C.getAttribute("data-set-lang")),f()})})}function O(){t.querySelector("[data-hub-subtitle]").textContent=l(r),F.textContent=l("strand.back"),t.querySelector("[data-hub-footer]").textContent=l("footer.conventions"),t.querySelector(".site-title").textContent=l("app.title")}const Z=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return F.addEventListener("click",Z),P(c),$(),{main:n,updateSection(C){P(C)},refreshLabels(){O(),P(te),$()},destroy(){F.removeEventListener("click",Z)}}}const We=["A","B","C","D"];function Ge(t){const r=t.slice();for(let c=r.length-1;c>0;c-=1){const i=Math.floor(Math.random()*(c+1));[r[c],r[i]]=[r[i],r[c]]}return r}function kt(t,r,c){return t.filter(i=>{if(c)return c(i,r);const f=i.topic;return!!(r.includes(f)||r.includes("rotatingMirror")&&f==="reflection"||r.includes("refraction")&&f==="refraction"||r.includes("tir")&&f==="tir"||f==="convex"&&r.includes("convex")||f==="concave"&&r.includes("concave"))})}function Tt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function we(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function at(t,r={}){const c=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=r.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="ws-controls no-print">
        ...
        <div class="grid cols-2" data-ws-topics>
          ${c.map(([f,n])=>`<label class="card ws-topic-card">
      ...
      ${qe}
    </div>`}function ne(){n.items.length&&(te.innerHTML=n.items.map((y,w)=>K(y,w,n.tab)).join(""),g())}function g(){n.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(y=>{y.addEventListener("change",()=>{const w=Number(y.getAttribute("data-ws-q"));if(n.resolved[w])return;const B=Number(y.getAttribute("data-ws-choice")),R=n.items[w][U()]||n.items[w].en;n.userAnswers[w]=B,B===R.a?n.resolved[w]=!0:(n.wrongAttempts[w]=(n.wrongAttempts[w]||0)+1,n.wrongAttempts[w]>=2&&(n.resolved[w]=!0)),J(),Y()&&m(),ne()})})}function m(){const y=n.items.length;let w=0,B=0;const R={};n.items.forEach((se,fe)=>{const ge=se[U()]||se.en;if(n.userAnswers[fe]===ge.a)w+=1,(n.wrongAttempts[fe]||0)===0&&(B+=1);else if(n.resolved[fe]){const xe=se.section||se.topic;R[xe]=(R[xe]||0)+1}});const Q=y?Math.round(w/y*100):0;let E=c("worksheets.revisionFair");Q>=90?E=c("worksheets.revisionExcellent"):Q>=70?E=c("worksheets.revisionGood"):Q<50&&(E=c("worksheets.revisionLow"));const ce=Object.entries(R).sort((se,fe)=>fe[1]-se[1]).map(([se,fe])=>`<li>${we(se)} (${fe})</li>`).join("");z.innerHTML=`
      <h4>${c("worksheets.sessionSummary")}</h4>
      <p>${c("worksheets.score")}: <strong>${w}/${y}</strong> (${Q}%)</p>
      <p>${c("worksheets.firstTry")}: <strong>${B}/${y}</strong></p>
      <p>${c("worksheets.revisionSuggestions")}: ${E}</p>
      ${ce?`<p>${c("worksheets.weakSections")}:</p><ul>${ce}</ul>`:""}`,z.hidden=!1}function u(y){const w=U(),B=n.items.map((R,Q)=>{const E=R[w]||R.en,ce=E.choices.map((fe,ge)=>`${We[ge]}. ${fe}`).join("<br/>"),se=y?`<p><b>${c("worksheets.answer")}:</b> ${We[E.a]}<br/><i>${E.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${E.q}<br/>${ce}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${c("worksheets.paperTitle")}</title></head>
<body><h2>${c("worksheets.paperTitle")}</h2>
${n.dateStr&&!y?`<p>${c("worksheets.date")}: ${n.dateStr}</p>`:""}
${B}</body></html>`}function d(y){const w=u(y),B=new Blob(["\uFEFF",w],{type:"application/msword"}),R=document.createElement("a");R.href=URL.createObjectURL(B),R.download=y?"worksheet-answers.doc":"worksheet.doc",R.click(),URL.revokeObjectURL(R.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),w=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),B=kt(r,w,f.topicFilter),R=Ge(B).slice(0,Math.min(y,B.length||1));n.items=R.length?R:Ge(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",L.hidden=!1,F.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),I&&(I.hidden=!1),j&&(j.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const w=y.target.closest("[data-ws-tab]");!w||!n.items.length||ee(w.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=Tt(),X.textContent=`${c("worksheets.date")}: ${n.dateStr}`),j&&(j.hidden=!n.dateStr,j.textContent=n.dateStr?`${c("worksheets.date")}: ${n.dateStr}`:"")}),(h=t.querySelector("[data-ws-word-p]"))==null||h.addEventListener("click",()=>d(!1)),(A=t.querySelector("[data-ws-word-a]"))==null||A.addEventListener("click",()=>d(!0)),(M=t.querySelector("[data-ws-print-p]"))==null||M.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(H=t.querySelector("[data-ws-print-a]"))==null||H.addEventListener("click",()=>{ee("answer"),window.print()})}const Ct=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Mt={rotatingMirror:t=>bt(t),refractionTir:t=>vt(t),lens:(t,r)=>yt(t,{defaultKind:r}),rgbMixer:t=>xt(t),em:t=>wt(t)};function _t(t){return l({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return Se()==="zh-Hant"?"zhHant":"en"}async function it(t,r){const c=`./${t}/${r}`;try{return(await fetch(c,{method:"HEAD"})).ok}catch{return!1}}async function Lt(t){return it("notes",t)}function Rt(t){let r="topics",c="rotatingMirror",i="convex",f=0,n="all",a=!1,L=null,F={main:null};function te(){F.main&&(r==="topics"?F.main.innerHTML=$():r==="notes"?F.main.innerHTML=Z():r==="tools"?F.main.innerHTML=z():r==="worksheets"?F.main.innerHTML=at(l):r==="flashcards"?F.main.innerHTML=ae():r==="summary"&&(F.main.innerHTML=K()),r==="notes"&&C(),r==="tools"&&I(),r==="worksheets"&&nt(t,Je,l,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){L==null||L.destroy(),L=tt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:u=>{r=u,L.updateSection(r),te()},onLang:()=>P()}),F.main=L.main,L.updateSection(r),te()}function $(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([d,h])=>{const A=d==="convex"||d==="concave"?"lens":d==="refraction"||d==="tir"?"refractionTir":d==="em"?"em":d,M=d==="convex"?"convex":d==="concave"?"concave":"";return`
            <div class="card">
              <h3>${l(h)}</h3>
              <button class="btn primary" type="button" data-go-tool="${A}"${M?` data-lens-kind="${M}"`:""}>${l("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function O(u){const d=u.target.closest("[data-go-tool]");if(!d)return;r="tools",c=d.getAttribute("data-go-tool");const h=d.getAttribute("data-lens-kind");(h==="convex"||h==="concave")&&(i=h),L.updateSection(r),te()}function Z(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${u.map(d=>{const h=l(`notes.card.${d.key}`);return`
            <div class="card" data-note-card="${d.key}">
              <h3>${h}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function C(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],d=Ae();for(const h of u){const A=t.querySelector(`[data-note-card="${h.key}"]`);if(!A)continue;const M=A.querySelector("[data-note-body]"),H=d==="zhHant"?h.fileZh:h.fileEn,y=await Lt(H),w=`./notes/${H}`;y?M.innerHTML=`
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ct.map(u=>`<button type="button" data-tool="${u}" class="${c===u?"active":""}">${_t(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function I(){const u=t.querySelector("[data-tool-list]"),d=t.querySelector("[data-tool-stage]");!u||!d||(u.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>{c=h.getAttribute("data-tool"),u.querySelectorAll("button").forEach(A=>A.classList.toggle("active",A.getAttribute("data-tool")===c)),j(d)})}),j(d))}function j(u){u.innerHTML="";const d=Mt[c];if(!d)return;const h=c==="lens"?d(l,i):d(l);u.appendChild(h)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(u){return!!(u!=null&&u.front)}function U(u){return`./${String(u).replace(/^\.\//,"")}`}function V(){return et.slice()}function Y(){const u=mt.slice(),d=V(),h=n==="rotatingMirror"?"reflection":n;if(h==="all")return[...u,...d];if(h==="reflection")return u;if(h==="convex"||h==="concave"){const M=d.filter(H=>H.topic==="convex"||H.topic==="concave");return M.length?M:d}if(h==="refractionTir"){const M=d.filter(H=>H.topic==="refraction"||H.topic==="tir");return M.length?M:d}const A=d.filter(M=>M.topic===h);return A.length?A:d}function J(){const u=Y(),d=t.querySelector("[data-flash-progress]");if(!u.length){f=0;const B=t.querySelector("[data-flash-front]"),R=t.querySelector("[data-flip-card]");B&&(B.textContent=""),R&&R.classList.remove("flashcard-surface--image"),d&&(d.hidden=!0,d.textContent="");return}f=Math.max(0,Math.min(f,u.length-1));const h=u[f],A=t.querySelector("[data-flash-front]"),M=t.querySelector("[data-flip-card]"),H=t.querySelector("[data-flash-label]");if(!A||!M)return;if(d&&(d.hidden=!1,d.textContent=l("flashcards.progress").replace("{current}",String(f+1)).replace("{total}",String(u.length))),X(h)){const B=h.back&&h.back!==h.front;M.classList.add("flashcard-surface--image"),H&&(B?(H.hidden=!1,H.textContent=l(a?"flashcards.answer":"flashcards.question")):H.hidden=!0);const R=a&&h.back?h.back:h.front,Q=h.alt||h.title||"";A.innerHTML=`<img src="${U(R)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}M.classList.remove("flashcard-surface--image");const y=Ae(),w=h[y]||h.en;H&&(H.hidden=!1,H.textContent=l(a?"flashcards.answer":"flashcards.question")),A.textContent=a?w.a:w.q}function ee(){n==="rotatingMirror"&&(n="reflection");const u=t.querySelector("[data-flash-deck]");u.value=n,u.addEventListener("change",()=>{n=u.value,f=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",d=>{d.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const d=Y();f=(f-1+d.length)%d.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const d=Y();f=(f+1)%d.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const d=Y();f=Math.floor(Math.random()*d.length),a=!1,J()}),J()}function K(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${u.map(d=>{const h=l(`summary.item.${d.key}`);return`
            <div class="card" data-summary-card="${d.key}">
              <h3>${h}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function ne(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],d=Ae();for(const h of u){const A=t.querySelector(`[data-summary-card="${h.key}"]`);if(!A)continue;const M=A.querySelector("[data-summary-body]"),H=d==="zhHant"?h.fileZh:h.fileEn,y=await it("summary-pdfs",H),w=`./summary-pdfs/${H}`;y?M.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${h.key}`)}" src="${w}"></iframe>
          <p style="margin-top:8px"><a href="${w}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:M.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const g=()=>P(),m=u=>O(u);return window.addEventListener("s3phy:lang",g),t.addEventListener("click",m),P(),()=>{window.removeEventListener("s3phy:lang",g),t.removeEventListener("click",m),L==null||L.destroy()}}const je="s3phy-thermometer-lab-css",zt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Ht(){if(document.getElementById(je))return;const t=document.createElement("style");t.id=je,t.textContent=zt,document.head.appendChild(t)}function Pe(t,r={}){Ht();const c=r.type||"liquid";let i=t("tools.thermometerLab.title"),f=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),f=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),f=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),f=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:c,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},L=460,F=340,te=80,P=800,$=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let o=100;const s=Math.max(a.bathTemp,a.thermometerTemp,100);s>120&&(o=150),s>145&&(o=200);const p=o<=100?20:25;return{minT:0,maxT:o,tickStep:p}}function C(e,o,s,p,v){return p+(e-o)/(s-o)*v}function z(e,o,s,p,v){return p+v-(e-o)/(s-o)*v}function I(e,o,s,p,v,_){const{gx:b,gy:x,gw:S,gh:k,tickFont:T,axisFont:W,yLabelX:N,xLabelY:q}=o;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of _){const G=z(D.value,D.min,D.max,x,k);e.beginPath(),e.moveTo(b,G),e.lineTo(b+S,G),e.stroke()}for(let D=s;D<=p+.01;D+=v){const G=C(D,s,p,b,S);e.beginPath(),e.moveTo(G,x),e.lineTo(G,x+k),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(b,x),e.lineTo(b,x+k),e.lineTo(b+S,x+k),e.stroke(),e.fillStyle="#e4e4e7",e.font=T,e.textAlign="right",e.textBaseline="middle";for(const D of _){const G=z(D.value,D.min,D.max,x,k);e.fillText(D.label,b-15,G)}e.textAlign="center",e.textBaseline="top";for(let D=s;D<=p+.01;D+=v){const G=C(D,s,p,b,S);e.fillText(`${Math.round(D)}`,G,x+k+10)}return{gx:b,gy:x,gw:S,gh:k,axisFont:W,yLabelX:N,xLabelY:q}}function j(e,o){const s=o-e,p=s<=8?1:s<=14?2:5,v=[],_=Math.ceil(e/p)*p;for(let b=_;b<=o+.001;b+=p)v.push({value:b,label:b%1===0?`${b.toFixed(0)}`:`${b.toFixed(1)}`,min:e,max:o});return v}function ae(){const{maxT:e}=Z(),o=X(0),s=X(e),p=s-o,v=Math.max(1,p*.1),_=Math.max(0,Math.round((o-v)*10)/10),b=Math.round((s+v)*10)/10;return{minL:_,maxL:b}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),o=V(0),s=V(e),p=s-o,v=Math.max(.2,p*.1),_=Math.max(0,o-v),b=s+v,x=p<=2?.5:p<=4?1:2,S=[],k=Math.ceil(_/x)*x;for(let T=k;T<=b+.001;T+=x)S.push({value:T,label:T.toFixed(1),min:_,max:b});return{minR:_,maxR:b,ticks:S}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:o}=e;let s=a.thermistorR25;for(let b=0;b<=o;b+=5){const x=b+273.15,S=a.thermistorR25*Math.exp(a.thermistorBeta*(1/x-1/298.15));s=Math.max(s,S)}s=Math.ceil(s*1.08*10)/10;const p=0,v=s<=12?2:4,_=[];for(let b=0;b<=s+.001;b+=v)_.push({value:b,label:b.toFixed(0),min:p,max:s});return{minR:p,maxR:s,ticks:_}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),g=window.devicePixelRatio||1;J.width=L*g,J.height=F*g,ee.scale(g,g),K.width=P*g,K.height=$*g,ne.scale(g,g);function m(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const u=200,d=11;function h(){const e=Math.pow(a.bulbVolume/u,.3333333333333333);return d*e}function A(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,o=.2+a.wallThickness*1.5,s=.4+a.bulbVolume*.003,p=1.35-a.capillaryBore*.45;return Math.max(.1,o*s*p*e*.15)}function M(e){a.bathTemp<=8&&a.iceCubes.forEach(o=>{o.x+=o.speedX,o.y+=o.speedY,(o.x<65||o.x>175)&&(o.speedX*=-1),(o.y<195||o.y>210)&&(o.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(o=>{o.y-=o.speedY*(1+a.bathTemp/100),o.y<185&&(o.y=265,o.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(o=>{o.y-=o.speedY*(1+(a.bathTemp-80)/40),o.phase+=o.wobbleSpeed,o.x+=Math.sin(o.phase)*.3,o.y<185&&(o.y=260+Math.random()*10,o.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(o=>{o.x+=o.vx,o.y+=o.vy,o.alpha-=.005,(o.alpha<=0||o.y<130)&&(o.x=60+Math.random()*120,o.y=175+Math.random()*5,o.alpha=.2+Math.random()*.4)})}function H(e){let b=59,x=130,S=246;if(a.bathTemp<25){const q=a.bathTemp/25;b=Math.round(180-q*121),x=Math.round(210-q*80),S=Math.round(250-q*4)}else{const q=Math.min(1,(a.bathTemp-25)/125);b=Math.round(59+q*180),x=Math.round(130-q*100),S=Math.round(246-q*190)}if(a.bathTemp>40){const q=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let G=-25;G<=25;G+=6){const ie=q*(12+Math.sin(G*.4+D)*5);e.lineTo(55+130/2+G,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const k=e.createLinearGradient(55,190,55,280);k.addColorStop(0,`rgba(${b}, ${x}, ${S}, 0.25)`),k.addColorStop(1,`rgba(${b}, ${x}, ${S}, 0.55)`),e.fillStyle=k,e.beginPath(),e.moveTo(55,190);const T=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let q=55;q<=185;q+=5){const D=190+Math.sin(q*.15+N)*T;e.lineTo(q,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,o,s,p,v,_,b="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(o,s),e.lineTo(p,v),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(o,s,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const S=e.measureText(_).width+10,k=16,T=b==="left"?p:p-S,W=v-k/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(T,W,S,k,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(_,T+S/2,W+k/2+.5)}function w(e){const p=h(),v=250+Math.max(0,p-d)*.35,_=v-p-1,b=10+a.wallThickness*8,x=120-b/2,S=120+b/2,k=e.createLinearGradient(x,20,S,20);k.addColorStop(0,"rgba(209, 213, 219, 0.85)"),k.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),k.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),k.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),k.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(x,_),e.lineTo(x,25),e.arcTo(x,20,x+5,20,5),e.arcTo(S,20,S,25,5),e.lineTo(S,_),e.closePath(),e.fill(),e.stroke();const T=e.createRadialGradient(120-p*.2,v-p*.2,p*.1,120,v,p);T.addColorStop(0,"rgba(255, 255, 255, 0.8)"),T.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=T,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,v,p+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(b*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,_-20-8);const N=a.liquidType==="mercury",q=N?"#a1a1aa":"#ef4444",D=N?"#f4f4f5":"#fee2e2",G=210,ie=220,he=(G-40)/ie,ue=G-Math.min(ie,a.thermometerTemp)*he;e.fillStyle=q,e.fillRect(120-W/2,ue,W,_-ue),e.beginPath(),e.ellipse(120,ue,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-W/6,ue,W/3,_-ue);const oe=p*.9,re=e.createRadialGradient(120-oe*.2,v-oe*.2,oe*.1,120,v,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,v,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const pe=G-le*he;e.beginPath(),e.moveTo(x,pe),e.lineTo(x+4,pe),e.stroke(),e.fillText(`${le}°C`,x-22,pe+2.5)}a.showLabels&&(y(e,x+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,ue,230,ue-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,v,230,v+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function B(e){const b=e.createLinearGradient(115,20,125,20);b.addColorStop(0,"#71717a"),b.addColorStop(.3,"#f4f4f5"),b.addColorStop(.7,"#d4d4d8"),b.addColorStop(1,"#3f3f46"),e.fillStyle=b,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let x=205;e.moveTo(118,x);for(let N=0;N<8;N++)x+=4,e.lineTo(122,x),x+=4,e.lineTo(118,x);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,k=40,T=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,k,T,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,k+12,T-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",S+T-16,k+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,k+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function R(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const v=20,_=225,b=12,x=120-b/2,S=e.createLinearGradient(x,v,x+b,v);S.addColorStop(0,"rgba(229, 231, 235, 0.4)"),S.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),S.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),S.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=S,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(x,v,b,_-v,[0,0,3,3]),e.fill(),e.stroke();const k=7,T=e.createRadialGradient(120-k*.2,245-k*.2,k*.1,120,245,k);T.addColorStop(0,"#6b7280"),T.addColorStop(.7,"#1f2937"),T.addColorStop(1,"#09090b"),e.fillStyle=T,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,k,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,q=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,q,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,q-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+q-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,o,s,p,v,_,b,x,S){const{gx:k,gy:T,gw:W,gh:N}=o;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(s,p),e.lineTo(s,T+N),e.stroke(),e.beginPath(),e.moveTo(s,p),e.lineTo(k,p),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${v.toFixed(1)}${b}`,D=e.measureText(q).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(s-D/2,T+N+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,s,T+N+4),e.textAlign="right",e.textBaseline="middle";const G=`${_.toFixed(2)} ${x}`,ie=e.measureText(G).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(k-ie-2,p-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(G,k-7,p)}function E(e){const o=O(),{minL:s,maxL:p}=ae(),{minT:v,maxT:_,tickStep:b}=Z(),x=j(s,p),S=I(e,o,v,_,b,x),{gx:k,gy:T,gw:W,gh:N,axisFont:q,yLabelX:D,xLabelY:G,dotR:ie}={...o,...S};e.save(),e.translate(D,T+N/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",k+W/2,G);const ye=_,he=C(0,v,_,k,W),ue=z(X(0),s,p,T,N),oe=C(ye,v,_,k,W),re=z(X(ye),s,p,T,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(he,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentLength;if(le>=v&&le<=_){const be=C(le,v,_,k,W),Ce=z(pe,s,p,T,N);Q(e,o,be,Ce,le,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(be,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ce(e){const o=O(),{minR:s,maxR:p,ticks:v}=U(),_=Z(),b=I(e,o,_.minT,_.maxT,_.tickStep,v),{gx:x,gy:S,gw:k,gh:T,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...b};e.save(),e.translate(N,S+T/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+k/2,q);const{minT:G,maxT:ie}=_,ye=ie,he=C(0,G,ie,x,k),ue=z(V(0),s,p,S,T),oe=C(ye,G,ie,x,k),re=z(V(ye),s,p,S,T);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(he,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentResistance;if(le>=G&&le<=ie){const be=C(le,G,ie,x,k),Ce=z(pe,s,p,S,T);Q(e,o,be,Ce,le,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(be,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const o=O(),s=Z(),{minR:p,maxR:v,ticks:_}=Y(s),b=I(e,o,s.minT,s.maxT,s.tickStep,_),{gx:x,gy:S,gw:k,gh:T,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...b},{minT:G,maxT:ie}=s;e.save(),e.translate(N,S+T/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+k/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let ye=!1;for(let oe=G;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),pe=C(oe,G,ie,x,k),be=z(Math.min(v,le),p,v,S,T);be>=S&&be<=S+T&&(ye?e.lineTo(pe,be):(e.moveTo(pe,be),ye=!0))}e.stroke();const he=a.thermometerTemp,ue=a.currentThermistorR;if(he>=G&&he<=ie){const oe=C(he,G,ie,x,k),re=z(Math.min(v,ue),p,v,S,T);Q(e,o,oe,re,he,ue,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function fe(){ee.clearRect(0,0,L,F),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),H(ee),a.thermometerType==="liquid"?w(ee):a.thermometerType==="resistance"?B(ee):R(ee),ee.restore(),a.thermometerType==="liquid"?E(ne):a.thermometerType==="resistance"?ce(ne):se(ne)}function ge(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const o=n.querySelector("#tl-svg-formula-liquid-sub");if(o){const b=(a.liquidL100-a.liquidL0)/100;o.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          ...
          <text x="225" y="22" fill="#10b981" font-family="system-ui, sans-serif" font-weight="800" font-size="14">= ${b.toFixed(4)} cm/°C</text>
          ...
          <text x="235" y="85" fill="#10b981" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${b.toFixed(4)}</text>
      ...
      `);const p=n.querySelector("#tl-svg-formula-resistance-sub");if(p){const b=(a.resistanceR100-a.resistanceR0)/100;p.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Calculate Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="170" y="29" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">100</text>
          <text x="225" y="22" fill="#10b981" font-family="system-ui, sans-serif" font-weight="800" font-size="14">= ${b.toFixed(4)} Ω/°C</text>
      ...
      `}const v=n.querySelector("#tl-svg-formula-thermistor");v&&(v.innerHTML=`
      ...
      `);const _=n.querySelector("#tl-svg-formula-thermistor-sub");if(_){const b=a.thermometerTemp+273.15;_.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `}}function ke(){const e=n.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:o,cu:s,interval:p}=ze(),v=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,_=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,b=n.querySelector("#tl-pane-q10a").classList.contains("active"),x=b?(v-o)/p*100:_,S=b?v:_/100*p+o,T=(W=>130-W/100*80)(x);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="53" fill="#ef4444" font-size="10" font-weight="bold" text-anchor="start">C<tspan dy="3" font-size="7">u</tspan><tspan dy="-3"> = ${s.toFixed(1)}°C</tspan></text>
    ...
    `}function xe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const o=n.querySelector("#tl-bath-state");a.bathTemp<=0?o.textContent="Melting Ice Bath":a.bathTemp>=100?o.textContent="Boiling Water/Steam":a.bathTemp===150?o.textContent="Hot Cooking Oil":o.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const s=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?s.style.display="block":s.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let qe=null;function Re(e){a.lastTimestamp||(a.lastTimestamp=e);const o=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const s=Math.min(o,.1),p=A(),v=s/p*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=v,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const _=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/_-1/298.15)),M(),fe(),xe(p),qe=requestAnimationFrame(Re)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),o=parseFloat(n.querySelector("#tl-input-faulty-cu").value),s=Number.isFinite(e)?e:-1.5,p=Number.isFinite(o)?o:105,v=p-s;return{cf:s,cu:p,interval:v}}function He(e){const o=Math.round(e*100)/100;return o>=0?o.toFixed(1):`(${o.toFixed(1)})`}function me(){const{cf:e,cu:o,interval:s}=ze(),p=n.querySelector("#tl-val-faulty-interval"),v=n.querySelector("#tl-faulty-error-a"),_=n.querySelector("#tl-faulty-error-b"),b=Math.abs(s)<.01;p.textContent=s.toFixed(1)+" °C";const x=n.querySelector("#tl-svg-formula-faulty-a"),S=n.querySelector("#tl-svg-formula-faulty-b");if(b){v.hidden=!1,v.textContent="C_u must differ from C_f (interval cannot be zero).",_.hidden=!1,_.textContent=v.textContent,x&&(x.innerHTML=""),S&&(S.innerHTML="");return}v.hidden=!0,_.hidden=!0;const k=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(k-e)/s*100,N=T/100*s+e;x&&(x.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function Te(){const e=a.thermometerTemp,o=(a.liquidL100-a.liquidL0)/100,s=a.liquidL0+o*e,p=n.querySelector("#tl-svg-formula-t-to-l");p&&(p.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
          ...
          <!-- Step 3: Calculation -->
          <text x="10" y="82" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 3: L<tspan dy="3" font-size="9">T</tspan><tspan dy="-3"> = </tspan>${a.liquidL0.toFixed(1)} + ${o.toFixed(4)} &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${s.toFixed(2)} cm</tspan></text>
        </svg>
      `)}function Oe(){const e=a.thermometerTemp,o=(a.resistanceR100-a.resistanceR0)/100,s=a.resistanceR0+o*e,p=n.querySelector("#tl-svg-formula-t-to-r");p&&(p.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
          ...
          <!-- Step 3: Calculation -->
          <text x="10" y="82" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 3: R<tspan dy="3" font-size="9">T</tspan><tspan dy="-3"> = </tspan>${a.resistanceR0.toFixed(1)} + ${o.toFixed(4)} &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${s.toFixed(2)} Ω</tspan></text>
        </svg>
      `)}function de(){me(),ve(),Te(),Oe()}function $e(e,o){n.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=o,n.querySelector("#tl-bath-temp-slider").value=o,de()})}function lt(){n.querySelectorAll(".tl-tab-btn").forEach(s=>{s.addEventListener("click",()=>{n.querySelectorAll(".tl-tab-btn").forEach(v=>v.classList.remove("active")),n.querySelectorAll(".tl-tab-content").forEach(v=>v.classList.remove("active")),s.classList.add("active");const p=s.getAttribute("data-tl-tab");n.querySelector("#tl-tab-"+p).classList.add("active"),a.thermometerType=p,de()})}),n.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{a.showLabels=!a.showLabels,n.querySelector("#tl-lbl-toggle-labels").textContent=a.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),n.querySelector("#tl-bath-temp-slider").addEventListener("input",s=>{a.bathTemp=parseFloat(s.target.value),de()}),$e("tl-btn-preset-ice",0),$e("tl-btn-preset-room",25),$e("tl-btn-preset-steam",100),$e("tl-btn-preset-oil",150),n.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",n.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",n.querySelector("#tl-card-alcohol").className="tl-seg-btn",de()}),n.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",n.querySelector("#tl-card-mercury").className="tl-seg-btn",n.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",de()}),n.querySelector("#tl-slider-bulb-vol").addEventListener("input",s=>{a.bulbVolume=parseFloat(s.target.value),n.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),n.querySelector("#tl-slider-wall-thick").addEventListener("input",s=>{a.wallThickness=parseFloat(s.target.value),n.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),n.querySelector("#tl-slider-capillary-bore").addEventListener("input",s=>{a.capillaryBore=parseFloat(s.target.value),n.querySelector("#tl-val-capillary-bore").textContent=a.capillaryBore.toFixed(2)+" mm"}),n.querySelector("#tl-slider-liquid-l0").addEventListener("input",s=>{a.liquidL0=parseFloat(s.target.value),n.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-liquid-l100").addEventListener("input",s=>{a.liquidL100=parseFloat(s.target.value),n.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-resistance-r0").addEventListener("input",s=>{a.resistanceR0=parseFloat(s.target.value),n.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-resistance-r100").addEventListener("input",s=>{a.resistanceR100=parseFloat(s.target.value),n.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-thermistor-r25").addEventListener("input",s=>{a.thermistorR25=parseFloat(s.target.value),n.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",n.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",de()}),n.querySelector("#tl-slider-thermistor-beta").addEventListener("input",s=>{a.thermistorBeta=parseFloat(s.target.value),n.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",n.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",de()}),n.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.add("active"),n.querySelector("#tl-btn-solve-q10b").classList.remove("active"),n.querySelector("#tl-pane-q10a").classList.add("active"),n.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),n.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.remove("active"),n.querySelector("#tl-btn-solve-q10b").classList.add("active"),n.querySelector("#tl-pane-q10a").classList.remove("active"),n.querySelector("#tl-pane-q10b").classList.add("active"),me()}),n.querySelector("#tl-input-faulty-cf").addEventListener("input",me),n.querySelector("#tl-input-faulty-cu").addEventListener("input",me),n.querySelector("#tl-input-q10a-cm").addEventListener("input",me),n.querySelector("#tl-input-q10b-t").addEventListener("input",me),n.querySelector("#tl-input-q11-r").addEventListener("input",ve),n.querySelector("#tl-input-t-to-l").addEventListener("input",de),n.querySelector("#tl-input-t-to-r").addEventListener("input",de)}if(r.type){const e=n.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return n.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===c?e.classList.add("active"):e.classList.remove("active")}),n.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===c?e.classList.add("active"):e.classList.remove("active")}),m(),lt(),de(),qe=requestAnimationFrame(Re),n._thermometerLabCleanup=()=>{qe&&cancelAnimationFrame(qe)},n}const Me=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],De=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],$t=[["thermometer","topic.thermometer"]],Qe=["liquid","resistance","thermistor"],At={liquid:t=>Pe(t,{type:"liquid"}),resistance:t=>Pe(t,{type:"resistance"}),thermistor:t=>Pe(t,{type:"thermistor"})};function Et(t){return l({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title"}[t]||t)}function Ee(){return Se()==="zh-Hant"?"zhHant":"en"}async function Ft(t,r){const c=`./${t}/${r}`;try{return(await fetch(c,{method:"HEAD"})).ok}catch{return!1}}async function Ne(t){return Ft("notes",t)}function It(t){let r="topics",c="liquid",i=0,f="all",n=!1,a=null,L={main:null},F=null;function te(){if(L.main){if(r==="topics"?L.main.innerHTML=$():r==="notes"?L.main.innerHTML=Z():r==="tools"?L.main.innerHTML=z():r==="worksheets"?L.main.innerHTML=at(l,{topics:$t,paperTitleKey:"worksheets.paperTitleHeat"}):r==="flashcards"?L.main.innerHTML=ae():r==="summary"&&(L.main.innerHTML=J()),r==="notes"&&C(),r==="tools"&&I(),r==="worksheets"){const g=Je.filter(m=>De.includes(m.topic));nt(t,g,l,Ee,{topicFilter:(m,u)=>u.includes("thermometer")?De.includes(m.topic):u.includes(m.topic)})}r==="flashcards"&&Y(),r==="summary"&&ee()}}function P(){a==null||a.destroy(),a=tt(t,{subtitleKey:"strand.heat.subtitle",activeSection:r,onSection:g=>{r==="tools"&&g!=="tools"&&F!=null&&F._thermometerLabCleanup&&(F._thermometerLabCleanup(),F=null),r=g,a.updateSection(r),te()},onLang:()=>P()}),L.main=a.main,a.updateSection(r),te()}function $(){return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Me.map(g=>{const m=g.tool?`<button class="btn primary" type="button" data-go-tool="${g.tool}">${l("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${l("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${l(g.titleKey)}</h3>
              ${m}
            </div>`}).join("")}
        </div>
      </section>`}function O(g){const m=g.target.closest("[data-go-tool]");if(m){const d=m.getAttribute("data-go-tool");Qe.includes(d)?c=d:c="liquid",r="tools",a.updateSection(r),te();return}const u=g.target.closest("[data-go-section]");(u==null?void 0:u.getAttribute("data-go-section"))==="notes"&&(r="notes",a.updateSection(r),te())}function Z(){return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
      ...
      </section>`}async function C(){const g=Ee();for(const m of Me){const u=t.querySelector(`[data-note-card="${m.id}"]`);if(!u)continue;const d=u.querySelector("[data-note-body]"),h=g==="zhHant"?m.fileZh:m.fileEn,A=await Ne(h),M=`./notes/${h}`;A?d.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${m.id}`)}" src="${M}"></iframe>
          <p style="margin-top:8px"><a href="${M}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:d.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function z(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Qe.map(g=>`<button type="button" data-tool="${g}" class="${c===g?"active":""}">${Et(g)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function I(){const g=t.querySelector("[data-tool-list]"),m=t.querySelector("[data-tool-stage]");!g||!m||(g.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{c=u.getAttribute("data-tool"),g.querySelectorAll("button").forEach(d=>d.classList.toggle("active",d.getAttribute("data-tool")===c)),j(m)})}),j(m))}function j(g){g.innerHTML="",F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup();const m=At[c];m&&(F=m(l),g.appendChild(F))}function ae(){return`
      <section class="panel">
        <h2>${l("flashcards.title")}</h2>
        <p class="lead">${l("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}function X(){return et.filter(g=>De.includes(g.topic))}function U(){const g=X();return f==="all"||f==="thermometry"?g:g.filter(m=>m.topic===f)}function V(){const g=U(),m=t.querySelector("[data-flash-progress]");if(!g.length){i=0;const H=t.querySelector("[data-flash-front]");H&&(H.textContent=""),m&&(m.hidden=!0,m.textContent="");return}i=Math.max(0,Math.min(i,g.length-1));const u=g[i],d=t.querySelector("[data-flash-front]"),h=t.querySelector("[data-flash-label]");if(!d)return;m&&(m.hidden=!1,m.textContent=l("flashcards.progress").replace("{current}",String(i+1)).replace("{total}",String(g.length)));const A=Ee(),M=u[A]||u.en;h&&(h.hidden=!1,h.textContent=l(n?"flashcards.answer":"flashcards.question")),d.textContent=n?M.a:M.q}function Y(){const g=t.querySelector("[data-flash-deck]");g.value=f,g.addEventListener("change",()=>{f=g.value,i=0,n=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{n=!n,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",m=>{m.stopPropagation(),n=!n,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const m=U();i=(i-1+m.length)%m.length,n=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const m=U();i=(i+1)%m.length,n=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const m=U();i=Math.floor(Math.random()*m.length),n=!1,V()}),V()}function J(){return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
  ...
  `,t}function Bt(t,r){const c=[...Ve.en,...Ve.zhHant],i=()=>{if(!t.parentElement)return;const f=document.createElement("div");f.className="splash-danmaku-item",f.textContent=c[Math.floor(Math.random()*c.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,L=Math.random()*12+10;f.style.top=`${n}%`,f.style.fontSize=`${a}rem`,f.style.animationDuration=`${L}s`,r.appendChild(f),f.addEventListener("animationend",()=>f.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let f=0;f<4;f+=1)window.setTimeout(i,f*1e3)}function Gt(t){const r=t.querySelector("#splashLogoWrap"),c=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{c==null||c.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),c&&Bt(t,c)},1600)}function Ue(){st()}function jt(){let t=!1;try{t=sessionStorage.getItem(Ye)==="1"}catch{}if(t){Ue();return}const r=Ot();document.body.insertBefore(r,document.body.firstChild),Gt(r);const c=r.querySelector("#splashStart"),i=()=>{r.remove(),Ue()};c.addEventListener("click",()=>{try{sessionStorage.setItem(Ye,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",st);window.addEventListener("s3phy:strand",t=>{ot(t.detail??null)});jt();
