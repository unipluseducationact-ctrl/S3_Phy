...
`;function kt(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=xt,document.head.appendChild(t)}function qt(t){kt();const i=document.createElement("div");i.className="rml",i.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=i.querySelector(".rml-canvas"),n=o.getContext("2d"),u=i.querySelector("[data-rml-rot]"),r=i.querySelector("[data-rml-inc]"),a=i.querySelector('[data-rml-disp="rot"]'),w=i.querySelector('[data-rml-disp="inc"]'),A=i.querySelector('[data-rml-val="i"]'),J=i.querySelector('[data-rml-val="r"]'),W=i.querySelector('[data-rml-val="shift"]'),F=350,O=380,X=300,M="#22d3ee",z="bold 17px system-ui, sans-serif";let E=0,B=-140,te=!0,Y=!0,ee=!0,ae=!0;function N(P){return P*Math.PI/180}function V(P,l,s,f,L,R=2,_=!1){n.beginPath(),n.lineWidth=R,n.strokeStyle=L,n.setLineDash(_?[6,6]:[]);const b=P+Math.cos(N(s))*f,v=l+Math.sin(N(s))*f;return n.moveTo(P,l),n.lineTo(b,v),n.stroke(),n.setLineDash([]),{x:b,y:v}}function Z(P,l,s,f,L,R=14){const _=s-P,b=f-l,v=Math.hypot(_,b);if(v<1e-6)return;const H=_/v,C=b/v,G=s-H*R,$=f-C*R,de=.45*R;n.beginPath(),n.fillStyle=L,n.moveTo(s,f),n.lineTo(G-C*de,$+H*de),n.lineTo(G+C*de,$-H*de),n.closePath(),n.fill()}function K(P,l,s,f,L,R=25){n.beginPath(),n.strokeStyle=f,n.lineWidth=2;const _=Math.min(P,l),b=Math.max(P,l);if(n.arc(F,O,s,N(_),N(b),!1),n.stroke(),L){const v=(_+b)/2,H=F+Math.cos(N(v))*(s+R),C=O+Math.sin(N(v))*(s+R);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="center",n.textBaseline="middle",n.fillStyle=f,n.fillText(L,H,C),n.restore()}}function ne(P,l,s,f,L){n.clearRect(0,0,o.width,o.height),n.beginPath(),n.setLineDash([10,6]),n.strokeStyle="rgba(255, 204, 0, 0.45)",n.lineWidth=3,n.lineCap="round",n.moveTo(F-200,O),n.lineTo(F+200,O),n.stroke(),n.setLineDash([]),n.lineCap="butt";const R=F+Math.cos(N(P))*X,_=O+Math.sin(N(P))*X;n.beginPath(),n.lineWidth=3,n.strokeStyle="#fff",n.moveTo(R,_),n.lineTo(F,O),n.stroke();const b=(R+F)*.5,v=(_+O)*.5,H=Math.hypot(F-R,O-_)||1,C=(F-R)/H,G=(O-_)/H;if(Z(b-C*28,v-G*28,b,v,"#fff",16),n.save(),n.font=z,n.textAlign="center",n.textBaseline="bottom",n.fillStyle="#fff",n.fillText(t("tools.rotatingMirror.canvas.incident"),R,_-12),n.restore(),te){const $=V(F,O,-90,X-60,"#00e676",1,!0);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="left",n.textBaseline="bottom",n.fillStyle="#00e676",n.fillText(t("tools.rotatingMirror.canvas.n"),$.x+6,$.y-4),n.restore()}if(Y){const $=V(F,O,f,X,"#00e676",2,!1);Z(F,O,$.x,$.y,"#00e676",16),n.save(),n.font=z,n.textAlign="center",n.textBaseline="bottom",n.fillStyle="#00e676",n.fillText(t("tools.rotatingMirror.canvas.originalReflected"),$.x,$.y-14),n.restore()}n.save(),n.translate(F,O),n.rotate(N(E)),n.beginPath(),n.lineWidth=6,n.strokeStyle="#ffcc00",n.lineCap="round",n.moveTo(-200,0),n.lineTo(200,0),n.stroke(),n.beginPath(),n.lineWidth=1,n.strokeStyle="#666";for(let $=-190;$<200;$+=15)n.moveTo($,0),n.lineTo($-5,8);if(n.stroke(),n.restore(),ee){const $=V(F,O,l,X-40,M,2,!0);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="left",n.textBaseline="bottom",n.fillStyle=M,n.fillText(t("tools.rotatingMirror.canvas.nPrime"),$.x+6,$.y-4),n.restore()}if(ae){const $=V(F,O,s,X,M,4);Z(F,O,$.x,$.y,M,16),Math.abs(E)>.5&&(n.save(),n.font=z,n.textAlign="center",n.textBaseline="bottom",n.fillStyle=M,n.fillText(t("tools.rotatingMirror.canvas.newReflected"),$.x,$.y-14),n.restore())}if(ee&&K(P,l,100,"#ffcc00",`i=${L.toFixed(0)}°`,25),ee&&ae&&K(l,s,100,M,`r=${L.toFixed(0)}°`,25),te&&ee&&Math.abs(E)>.5&&K(-90,l,50,"#ffcc00",`θ=${Math.abs(E)}°`,20),Y&&ae&&Math.abs(E)>.5){const $=s-f;K(f,s,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${$.toFixed(0)}°`,40)}}function U(){E=parseFloat(u.value),B=parseFloat(r.value);const P=E>0?"+":"";a.textContent=`${P}${E}°`,w.textContent=`${B}°`;const l=-90,s=Math.abs(B-l),f=l+s,L=-90+E,R=Math.abs(B-L),_=L+R,b=_-f;A.textContent=`${R.toFixed(1)}°`,J.textContent=`${R.toFixed(1)}°`;const v=b>0?"+":"";W.textContent=`${v}${b.toFixed(1)}°`,ne(B,L,_,f,R)}return i.querySelectorAll("[data-rml-toggle]").forEach(P=>{P.addEventListener("click",()=>{const l=P.getAttribute("data-rml-toggle");l==="orig-norm"&&(te=!te),l==="orig-ray"&&(Y=!Y),l==="new-norm"&&(ee=!ee),l==="new-ray"&&(ae=!ae),P.classList.toggle("active"),U()})}),i.querySelector("[data-rml-reset]").addEventListener("click",()=>{u.value="0",U()}),u.addEventListener("input",U),r.addEventListener("input",U),U(),i}function St(t){const i=document.createElement("div");i.className="tool-tir-escape";const o=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:`${n}/`;return o.src=`${u}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",i.appendChild(o),i}function Tt(t,i={}){const o=i.defaultKind==="concave"?"concave":"convex",n="tools.lens.title",u=document.createElement("div");u.className="tool-lens-simulator";const r=document.createElement("iframe"),a="./",w=a.endsWith("/")?a:`${a}/`;return r.src=`${w}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,r.title=t(n),r.setAttribute("loading","lazy"),r.referrerPolicy="strict-origin-when-cross-origin",u.appendChild(r),u}function Ct(t){const i=document.createElement("div");i.className="tool-em-spectrum";const o=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:`${n}/`;function r(){return`${u}em-spectrum/index.html?lang=${encodeURIComponent(ce())}`}o.src=r(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=o.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=r()}};return window.addEventListener("s3phy:lang",a),i._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(o),i}function Lt(t){const i=document.createElement("div");i.className="rgb-mixer",i.innerHTML=`
  ...
  `;const o=i.querySelector("[data-r]"),n=i.querySelector("[data-g]"),u=i.querySelector("[data-b]"),r=i.querySelector(".rgb-mixer-canvas"),a=i.querySelector(".rgb-mixer-stage"),w=r.getContext("2d");function A(M){return M.toString(16).padStart(2,"0")}function J(M,z,E){const B=r.width/(window.devicePixelRatio||1),te=r.height/(window.devicePixelRatio||1),Y=B/2,ee=te/2,ae=Math.min(B,te)*.34,N=ae*.5,V=Math.sqrt(3)/2;w.clearRect(0,0,B,te),w.fillStyle="#000",w.fillRect(0,0,B,te);const Z=[{x:Y,y:ee-N,rgb:[255,0,0],val:M},{x:Y-N*V,y:ee+N*.5,rgb:[0,255,0],val:z},{x:Y+N*V,y:ee+N*.5,rgb:[0,0,255],val:E}];w.globalCompositeOperation="lighter",Z.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[U,P,l]=K.rgb,s=w.createRadialGradient(K.x,K.y,0,K.x,K.y,ae);s.addColorStop(0,`rgba(${U},${P},${l},${ne})`),s.addColorStop(.65,`rgba(${U},${P},${l},${ne})`),s.addColorStop(.85,`rgba(${U},${P},${l},${ne*.5})`),s.addColorStop(1,`rgba(${U},${P},${l},0)`),w.fillStyle=s,w.beginPath(),w.arc(K.x,K.y,ae,0,Math.PI*2),w.fill()}),w.globalCompositeOperation="source-over"}function W(){const M=a.getBoundingClientRect(),z=Math.max(200,Math.min(M.width-8,M.height-8,720)),E=window.devicePixelRatio||1;r.width=z*E,r.height=z*E,r.style.width=`${z}px`,r.style.height=`${z}px`,w.setTransform(E,0,0,E,0,0),J(+o.value,+n.value,+u.value)}function F(){const M=+o.value,z=+n.value,E=+u.value,B=`rgb(${M}, ${z}, ${E})`,te=`#${A(M)}${A(z)}${A(E)}`;i.querySelector("[data-r-val]").textContent=M,i.querySelector("[data-g-val]").textContent=z,i.querySelector("[data-b-val]").textContent=E,i.querySelector("[data-r-bar]").style.width=`${M/255*100}%`,i.querySelector("[data-g-bar]").style.width=`${z/255*100}%`,i.querySelector("[data-b-bar]").style.width=`${E/255*100}%`,o.style.setProperty("--fill",`${M/255*100}%`),n.style.setProperty("--fill",`${z/255*100}%`),u.style.setProperty("--fill",`${E/255*100}%`);const Y=i.querySelector("[data-swatch]");Y.style.backgroundColor=B,Y.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${B}`),i.querySelector("[data-rgb-text]").textContent=B,i.querySelector("[data-hex-text]").textContent=te,J(M,z,E)}function O(M,z,E){o.value=M,n.value=z,u.value=E,F()}return[o,n,u].forEach(M=>M.addEventListener("input",F)),i.querySelectorAll(".rgb-presets button").forEach(M=>{M.addEventListener("click",()=>{O(+M.dataset.r,+M.dataset.g,+M.dataset.b)})}),new ResizeObserver(()=>W()).observe(a),requestAnimationFrame(()=>{W(),F()}),i}const Rt=["topics","notes","tools","worksheets","flashcards","summary"],Mt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function lt(t,{subtitleKey:i,activeSection:o,onSection:n,onLang:u}){t.innerHTML=`
    <header class="site-header">
      <div class="site-header__brand">
        ...
        <div class="brand-text-block">
          <h1 class="site-title">${d("app.title")}</h1>
          <p class="site-subtitle" data-hub-subtitle>${d(i)}</p>
        </div>
      </div>
      <div class="site-header__actions">
  ...
  `;const r=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),w=t.querySelector("[data-lang]"),A=t.querySelector("[data-strand-back]");let J=o;function W(M){J=M,a.innerHTML=Rt.map(z=>`<button type="button" class="${M===z?"active":""}" data-sec="${z}">${d(Mt[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>n(z.getAttribute("data-sec")))})}function F(){w.innerHTML=`
      <button type="button" data-set-lang="en" class="${ce()==="en"?"active":""}">${d("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${ce()==="zh-Hant"?"active":""}">${d("lang.zhHant")}</button>
    `,w.querySelectorAll("button").forEach(M=>{M.addEventListener("click",()=>{it(M.getAttribute("data-set-lang")),u()})})}function O(){t.querySelector("[data-hub-subtitle]").textContent=d(i),A.textContent=d("strand.back"),t.querySelector("[data-hub-footer]").textContent=d("footer.conventions"),t.querySelector(".site-title").textContent=d("app.title")}const X=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return A.addEventListener("click",X),W(o),F(),{main:r,updateSection(M){W(M)},refreshLabels(){O(),W(J),F()},destroy(){A.removeEventListener("click",X)}}}const We=["A","B","C","D"];function Ke(t){const i=t.slice();for(let o=i.length-1;o>0;o-=1){const n=Math.floor(Math.random()*(o+1));[i[o],i[n]]=[i[n],i[o]]}return i}function _t(t,i,o){return t.filter(n=>{if(o)return o(n,i);const u=n.topic;return!!(i.includes(u)||i.includes("rotatingMirror")&&u==="reflection"||i.includes("refraction")&&u==="refraction"||i.includes("tir")&&u==="tir"||u==="convex"&&i.includes("convex")||u==="concave"&&i.includes("concave"))})}function zt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ct(t,i={}){const o=i.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],n=i.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="ws-controls no-print">
        ...
        <div class="grid cols-2" data-ws-topics>
          ${o.map(([u,r])=>`<label class="card ws-topic-card">
    ...
    </section>`}function dt(t,i,o,n,u={}){var f,L,R,_;const r={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),w=t.querySelector("[data-ws-preview-area]"),A=t.querySelector("[data-ws-out]"),J=t.querySelector("[data-ws-body]"),W=t.querySelector("[data-ws-paper]"),F=t.querySelector("[data-ws-tabs]"),O=t.querySelector("[data-ws-practice-actions]"),X=t.querySelector("[data-ws-score]"),M=t.querySelector("[data-ws-score-val]"),z=t.querySelector("[data-ws-summary]"),E=t.querySelector("[data-ws-date-row]"),B=t.querySelector("[data-ws-date-print]"),te=t.querySelector("[data-ws-date-today]"),Y=t.querySelector("[data-ws-date-label]");if(!a||!J)return;function ee(){return n()}function ae(){r.userAnswers={},r.wrongAttempts={},r.resolved={},X.hidden=!0,z.hidden=!0}function N(){return r.items.length>0&&r.items.every((b,v)=>r.resolved[v])}function V(){let b=0;r.items.forEach((H,C)=>{if(!r.resolved[C])return;const G=H[ee()]||H.en;r.userAnswers[C]===G.a&&(b+=1)}),Object.keys(r.resolved).length>0&&(M.textContent=`${b}/${r.items.length}`,X.hidden=!1)}function Z(b){r.tab=b,F==null||F.querySelectorAll("[data-ws-tab]").forEach(v=>{v.classList.toggle("active",v.getAttribute("data-ws-tab")===b)}),O&&(O.hidden=b!=="practice"),E&&(E.hidden=b!=="practice"),B&&(B.hidden=!r.dateStr,B.textContent=r.dateStr?`${o("worksheets.date")}: ${r.dateStr}`:""),W==null||W.classList.toggle("practice-mode",b==="practice"),ne()}function K(b,v,H){const C=b[ee()]||b.en,G=We,$=v+1,de=b.section?`<span class="q-section">${xe(b.section)}</span>`:"";if(H==="answer"){const me=C.choices.map((ye,Te)=>`<li class="${Te===C.a?"choice-correct":""}"><strong>${G[Te]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${$} ${de}</h4>
        <p>${xe(C.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${G[C.a]}</p>
        <p class="q-exp"><em>${xe(C.exp)}</em></p>
      </div>`}const se=r.userAnswers[v],pe=r.wrongAttempts[v]||0,ge=r.resolved[v],Se=ge&&se===C.a,ke=ge&&se!==C.a;let qe="";pe===1&&!ge?qe=`<p class="q-hint"><strong>${o("worksheets.hint")}:</strong> ${xe(C.hint||C.exp)}</p>`:ke&&(qe=`<p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${G[C.a]}</p>
        <p class="q-exp q-summary"><em>${xe(C.exp)}</em></p>`);const _e=Se?"correct":ke?"incorrect":"",ze=C.choices.map((me,ye)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${v}" value="${ye}" data-ws-q="${v}" data-ws-choice="${ye}"${se===ye?" checked":""}${ge?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${G[ye]}.</strong> ${xe(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${_e}" data-ws-row="${v}">
      <div class="q-header"><h4>Q${$} ${de}</h4>${Se?'<span class="result-icon">✓</span>':ke?'<span class="result-icon">✗</span>':""}</div>
      <p>${xe(C.q)}</p>
      <ol class="choice-list choice-list--radio">${ze}</ol>
      ${qe}
    </div>`}function ne(){r.items.length&&(J.innerHTML=r.items.map((b,v)=>K(b,v,r.tab)).join(""),U())}function U(){r.tab==="practice"&&J.querySelectorAll("[data-ws-choice]").forEach(b=>{b.addEventListener("change",()=>{const v=Number(b.getAttribute("data-ws-q"));if(r.resolved[v])return;const H=Number(b.getAttribute("data-ws-choice")),C=r.items[v][ee()]||r.items[v].en;r.userAnswers[v]=H,H===C.a?r.resolved[v]=!0:(r.wrongAttempts[v]=(r.wrongAttempts[v]||0)+1,r.wrongAttempts[v]>=2&&(r.resolved[v]=!0)),V(),N()&&P(),ne()})})}function P(){const b=r.items.length;let v=0,H=0;const C={};r.items.forEach((se,pe)=>{const ge=se[ee()]||se.en;if(r.userAnswers[pe]===ge.a)v+=1,(r.wrongAttempts[pe]||0)===0&&(H+=1);else if(r.resolved[pe]){const ke=se.section||se.topic;C[ke]=(C[ke]||0)+1}});const G=b?Math.round(v/b*100):0;let $=o("worksheets.revisionFair");G>=90?$=o("worksheets.revisionExcellent"):G>=70?$=o("worksheets.revisionGood"):G<50&&($=o("worksheets.revisionLow"));const de=Object.entries(C).sort((se,pe)=>pe[1]-se[1]).map(([se,pe])=>`<li>${xe(se)} (${pe})</li>`).join("");z.innerHTML=`
      <h4>${o("worksheets.sessionSummary")}</h4>
      <p>${o("worksheets.score")}: <strong>${v}/${b}</strong> (${G}%)</p>
      <p>${o("worksheets.firstTry")}: <strong>${H}/${b}</strong></p>
      <p>${o("worksheets.revisionSuggestions")}: ${$}</p>
      ${de?`<p>${o("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,z.hidden=!1}function l(b){const v=ee(),H=r.items.map((C,G)=>{const $=C[v]||C.en,de=$.choices.map((pe,ge)=>`${We[ge]}. ${pe}`).join("<br/>"),se=b?`<p><b>${o("worksheets.answer")}:</b> ${We[$.a]}<br/><i>${$.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${G+1}.</b> ${$.q}<br/>${de}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${o("worksheets.paperTitle")}</title></head>
<body><h2>${o("worksheets.paperTitle")}</h2>
${r.dateStr&&!b?`<p>${o("worksheets.date")}: ${r.dateStr}</p>`:""}
${H}</body></html>`}function s(b){const v=l(b),H=new Blob(["\uFEFF",v],{type:"application/msword"}),C=document.createElement("a");C.href=URL.createObjectURL(H),C.download=b?"worksheet-answers.doc":"worksheet.doc",C.click(),URL.revokeObjectURL(C.href)}a.addEventListener("click",()=>{const b=Number(t.querySelector("[data-ws-count]").value),v=[...t.querySelectorAll("[data-ws-topic]")].filter(G=>G.checked).map(G=>G.getAttribute("data-ws-topic")),H=_t(i,v,u.topicFilter),C=Ke(H).slice(0,Math.min(b,H.length||1));r.items=C.length?C:Ke(i).slice(0,Math.min(b,i.length)),ae(),r.tab="practice",r.dateStr="",w.hidden=!1,A.hidden=!0,F==null||F.querySelectorAll("[data-ws-tab]").forEach(G=>{G.classList.toggle("active",G.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),E&&(E.hidden=!1),B&&(B.hidden=!0),Y.textContent="",W==null||W.classList.add("practice-mode"),ne()}),F==null||F.addEventListener("click",b=>{const v=b.target.closest("[data-ws-tab]");!v||!r.items.length||Z(v.getAttribute("data-ws-tab"))}),te==null||te.addEventListener("click",()=>{r.dateStr?(r.dateStr="",Y.textContent=""):(r.dateStr=zt(),Y.textContent=`${o("worksheets.date")}: ${r.dateStr}`),B&&(B.hidden=!r.dateStr,B.textContent=r.dateStr?`${o("worksheets.date")}: ${r.dateStr}`:"")}),(f=t.querySelector("[data-ws-word-p]"))==null||f.addEventListener("click",()=>s(!1)),(L=t.querySelector("[data-ws-word-a]"))==null||L.addEventListener("click",()=>s(!0)),(R=t.querySelector("[data-ws-print-p]"))==null||R.addEventListener("click",()=>{Z("practice"),W==null||W.classList.add("ws-print-blank");const b=()=>W==null?void 0:W.classList.remove("ws-print-blank");window.addEventListener("afterprint",b,{once:!0}),window.print()}),(_=t.querySelector("[data-ws-print-a]"))==null||_.addEventListener("click",()=>{Z("answer"),window.print()})}const Ht=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Ft={rotatingMirror:t=>qt(t),refractionTir:t=>St(t),lens:(t,i)=>Tt(t,{defaultKind:i}),rgbMixer:t=>Lt(t),em:t=>Ct(t)};function $t(t){return d({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function $e(){return ce()==="zh-Hant"?"zhHant":"en"}async function Oe(t,i){const o=`./${t}/${i}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function At(t){return Oe("notes",t)}function Et(t){let i="topics",o="rotatingMirror",n="convex",u=0,r="all",a=!1,w=null,A={main:null};function J(){A.main&&(i==="topics"?A.main.innerHTML=F():i==="notes"?A.main.innerHTML=X():i==="tools"?A.main.innerHTML=z():i==="worksheets"?A.main.innerHTML=ct(d):i==="flashcards"?A.main.innerHTML=te():i==="summary"&&(A.main.innerHTML=K()),i==="notes"&&M(),i==="tools"&&E(),i==="worksheets"&&dt(t,ot,d,$e),i==="flashcards"&&Z(),i==="summary"&&ne())}function W(){w==null||w.destroy(),w=lt(t,{subtitleKey:"strand.optics.subtitle",activeSection:i,onSection:l=>{i=l,w.updateSection(i),J()},onLang:()=>W()}),A.main=w.main,w.updateSection(i),J()}function F(){const l=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${d("topics.title")}</h2>
        <p class="lead">${d("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${l.map(([s,f])=>{const L=s==="convex"||s==="concave"?"lens":s==="refraction"||s==="tir"?"refractionTir":s==="em"?"em":s,R=s==="convex"?"convex":s==="concave"?"concave":"";return`
            <div class="card">
              <h3>${d(f)}</h3>
              <button class="btn primary" type="button" data-go-tool="${L}"${R?` data-lens-kind="${R}"`:""}>${d("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function O(l){const s=l.target.closest("[data-go-tool]");if(!s)return;i="tools",o=s.getAttribute("data-go-tool");const f=s.getAttribute("data-lens-kind");(f==="convex"||f==="concave")&&(n=f),w.updateSection(i),J()}function X(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${d("notes.title")}</h2>
        <p class="lead">${d("notes.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${l.map(s=>{const f=d(`notes.card.${s.key}`);return`
            <div class="card" data-note-card="${s.key}">
              <h3>${f}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function M(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],s=$e();for(const f of l){const L=t.querySelector(`[data-note-card="${f.key}"]`);if(!L)continue;const R=L.querySelector("[data-note-body]"),_=s==="zhHant"?f.fileZh:f.fileEn,b=await At(_),v=`./notes/${_}`;b?R.innerHTML=`
          <iframe class="notes-grid" title="${d(`notes.card.${f.key}`)}" src="${v}"></iframe>
          <p style="margin-top:8px"><a href="${v}" target="_blank" rel="noopener">${d("notes.openPdf")}</a></p>`:R.innerHTML=`<p class="lead">${d("notes.missing")}</p>
      ...
      <section class="panel panel--tools">
        <h2>${d("tools.title")}</h2>
        <p class="lead">${d("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ht.map(l=>`<button type="button" data-tool="${l}" class="${o===l?"active":""}">${$t(l)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function E(){const l=t.querySelector("[data-tool-list]"),s=t.querySelector("[data-tool-stage]");!l||!s||(l.querySelectorAll("button").forEach(f=>{f.addEventListener("click",()=>{o=f.getAttribute("data-tool"),l.querySelectorAll("button").forEach(L=>L.classList.toggle("active",L.getAttribute("data-tool")===o)),B(s)})}),B(s))}function B(l){l.innerHTML="";const s=Ft[o];if(!s)return;const f=o==="lens"?s(d,n):s(d);l.appendChild(f)}function te(){return`
      <section class="panel">
        ...
        <div class="control" style="margin-bottom:10px">
          ...
          <select data-flash-deck>
            <option value="all">${d("flashcards.all")}</option>
            <option value="reflection">${d("topic.reflection")}</option>
            <option value="refractionTir">${d("flashcards.deck.refractionTir")}</option>
            <option value="convex">${d("topic.convex")}</option>
            <option value="concave">${d("topic.concave")}</option>
            <option value="em">${d("topic.em")}</option>
          </select>
        </div>
        <div class="flashcard-box">
          <div class="flashcard-surface" data-flip-card>
            <div class="label" data-flash-label>${d("flashcards.question")}</div>
          ...
          <div class="flash-toolbar no-print">
            <button class="btn" type="button" data-flash-prev>${d("flashcards.prev")}</button>
            <button class="btn primary" type="button" data-flash-flip>${d("flashcards.flip")}</button>
            <button class="btn" type="button" data-flash-next>${d("flashcards.next")}</button>
            <button class="btn" type="button" data-flash-shuf>${d("flashcards.shuffle")}</button>
          </div>
        </div>
      </section>`}function Y(l){return!!(l!=null&&l.front)}function ee(l){return`./${String(l).replace(/^\.\//,"")}`}function ae(){return st.slice()}function N(){const l=ae(),s=r==="rotatingMirror"?"reflection":r;if(s==="all"){const L=l.filter(R=>R.topic!=="convex"&&R.topic!=="concave"&&R.topic!=="refraction"&&R.topic!=="tir"&&R.topic!=="em");return[...je,...Be,...Qe,...Ne,...Ve,...Ue,...L]}if(s==="reflection")return je.slice();if(s==="convex")return Ve.slice();if(s==="concave")return Ue.slice();if(s==="refractionTir")return[...Be,...Qe];if(s==="em")return Ne.slice();const f=l.filter(L=>L.topic===s);return f.length?f:l}function V(){const l=N(),s=t.querySelector("[data-flash-progress]");if(!l.length){u=0;const H=t.querySelector("[data-flash-front]"),C=t.querySelector("[data-flip-card]");H&&(H.textContent=""),C&&C.classList.remove("flashcard-surface--image"),s&&(s.hidden=!0,s.textContent="");return}u=Math.max(0,Math.min(u,l.length-1));const f=l[u],L=t.querySelector("[data-flash-front]"),R=t.querySelector("[data-flip-card]"),_=t.querySelector("[data-flash-label]");if(!L||!R)return;if(s&&(s.hidden=!1,s.textContent=d("flashcards.progress").replace("{current}",String(u+1)).replace("{total}",String(l.length))),Y(f)){const H=f.back&&f.back!==f.front;R.classList.add("flashcard-surface--image"),_&&(H?(_.hidden=!1,_.textContent=d(a?"flashcards.answer":"flashcards.question")):_.hidden=!0);const C=a&&f.back?f.back:f.front,G=f.alt||f.title||"";L.innerHTML=`<img src="${ee(C)}" alt="${G.replace(/"/g,"&quot;")}" loading="lazy" />`;return}R.classList.remove("flashcard-surface--image");const b=$e(),v=f[b]||f.en;_&&(_.hidden=!1,_.textContent=d(a?"flashcards.answer":"flashcards.question")),L.textContent=a?v.a:v.q}function Z(){r==="rotatingMirror"&&(r="reflection");const l=t.querySelector("[data-flash-deck]");l.value=r,l.addEventListener("change",()=>{r=l.value,u=0,a=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",s=>{s.stopPropagation(),a=!a,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const s=N();u=(u-1+s.length)%s.length,a=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const s=N();u=(u+1)%s.length,a=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const s=N();u=Math.floor(Math.random()*s.length),a=!1,V()}),V()}function K(){const l=[{key:"reflection",type:"image",file:"reflection.webp"},{key:"refraction",type:"image",file:"refraction.webp"},{key:"tir",type:"image",file:"tir.webp"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",type:"image",file:"concave.webp"},{key:"em",type:"image",file:"em.webp"}];return`
      <section class="panel">
        <h2>${d("summary.title")}</h2>
        <p class="lead">${d("summary.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${l.map(s=>{const f=d(`summary.item.${s.key}`);return`
            <div class="card" data-summary-card="${s.key}">
              <h3>${f}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function ne(){const l=[{key:"reflection",type:"image",file:"reflection.webp"},{key:"refraction",type:"image",file:"refraction.webp"},{key:"tir",type:"image",file:"tir.webp"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",type:"image",file:"concave.webp"},{key:"em",type:"image",file:"em.webp"}],s=$e();for(const f of l){const L=t.querySelector(`[data-summary-card="${f.key}"]`);if(!L)continue;const R=L.querySelector("[data-summary-body]");if(f.type==="image"){const H=await Oe("summary",f.file),C=`./summary/${f.file}`;H?R.innerHTML=`
          <img class="summary-thumb" src="${C}" alt="${d(`summary.item.${f.key}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${C}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:R.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}const _=s==="zhHant"?f.fileZh:f.fileEn,b=await Oe("summary-pdfs",_),v=`./summary-pdfs/${_}`;b?R.innerHTML=`
          <iframe class="notes-grid" title="${d(`summary.item.${f.key}`)}" src="${v}"></iframe>
          <p style="margin-top:8px"><a href="${v}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:R.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const U=()=>W(),P=l=>O(l);return window.addEventListener("s3phy:lang",U),t.addEventListener("click",P),W(),()=>{window.removeEventListener("s3phy:lang",U),t.removeEventListener("click",P),w==null||w.destroy()}}const It=[{id:1,topic:"thermometer",title:"What is Temperature?",front:"./flashcards/thermometer/01-front.webp",alt:"Flashcard 1 - What is Temperature?",back:"./flashcards/thermometer/01-back.webp"},{id:2,topic:"thermometer",title:"Celsius Scale & Fixed Points",front:"./flashcards/thermometer/02-front.webp",alt:"Flashcard 2 - Celsius Scale & Fixed Points",back:"./flashcards/thermometer/02-back.webp"},{id:3,topic:"thermometer",title:"Calibration of Unmarked Thermometer",front:"./flashcards/thermometer/03-front.webp",alt:"Flashcard 3 - Calibration of Unmarked Thermometer",back:"./flashcards/thermometer/03-back.webp"},{id:4,topic:"thermometer",title:"Liquid-in-Glass Thermometer",front:"./flashcards/thermometer/04-front.webp",alt:"Flashcard 4 - Liquid-in-Glass Thermometer",back:"./flashcards/thermometer/04-back.webp"},{id:5,topic:"thermometer",title:"Mercury vs Alcohol Thermometer",front:"./flashcards/thermometer/05-front.webp",alt:"Flashcard 5 - Mercury vs Alcohol Thermometer",back:"./flashcards/thermometer/05-back.webp"},{id:6,topic:"thermometer",title:"Types of Thermometers",front:"./flashcards/thermometer/06-front.webp",alt:"Flashcard 6 - Types of Thermometers",back:"./flashcards/thermometer/06-back.webp"},{id:7,topic:"thermometer",title:"Temperature-Dependent Properties",front:"./flashcards/thermometer/07-front.webp",alt:"Flashcard 7 - Temperature-Dependent Properties",back:"./flashcards/thermometer/07-back.webp"},{id:8,topic:"thermometer",title:"Sensitivity of Thermometer",front:"./flashcards/thermometer/08-front.webp",alt:"Flashcard 8 - Sensitivity of Thermometer",back:"./flashcards/thermometer/08-back.webp"},{id:9,topic:"thermometer",title:"Calibration Calculation",front:"./flashcards/thermometer/09-front.webp",alt:"Flashcard 9 - Calibration Calculation",back:"./flashcards/thermometer/09-back.webp"},{id:10,topic:"thermometer",title:"Faulty Thermometer Correction",front:"./flashcards/thermometer/10-front.webp",alt:"Flashcard 10 - Faulty Thermometer Correction",back:"./flashcards/thermometer/10-back.webp"}],Xe="s3phy-thermometer-lab-css",Wt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Pt(){if(document.getElementById(Xe))return;const t=document.createElement("style");t.id=Xe,t.textContent=Wt,document.head.appendChild(t)}function Pe(t,i={}){Pt();const o=i.type||"liquid";let n=t("tools.thermometerLab.title"),u=t("tools.thermometerLab.subtitle");i.type==="liquid"?(n=t("tools.thermometerLab.liquid.title"),u=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="resistance"?(n=t("tools.thermometerLab.resistance.title"),u=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="thermistor"&&(n=t("tools.thermometerLab.thermistor.title"),u=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const r=document.createElement("div");r.className="tl-wrap",r.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},w=460,A=340,J=80,W=800,F=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:W-e.left-e.right,gh:F-e.top-e.bottom,tickFont:`bold ${Math.round(W*.024)}px Arial`,axisFont:`bold ${Math.round(W*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:F-e.bottom+32}}function X(){let c=100;const h=Math.max(a.bathTemp,a.thermometerTemp,100);h>120&&(c=150),h>145&&(c=200);const m=c<=100?20:25;return{minT:0,maxT:c,tickStep:m}}function M(e,c,h,m,p){return m+(e-c)/(h-c)*p}function z(e,c,h,m,p){return m+p-(e-c)/(h-c)*p}function E(e,c,h,m,p,q){const{gx:g,gy:y,gw:k,gh:S,tickFont:T,axisFont:I,yLabelX:Q,xLabelY:x}=c;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of q){const j=z(D.value,D.min,D.max,y,S);e.beginPath(),e.moveTo(g,j),e.lineTo(g+k,j),e.stroke()}for(let D=h;D<=m+.01;D+=p){const j=M(D,h,m,g,k);e.beginPath(),e.moveTo(j,y),e.lineTo(j,y+S),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(g,y),e.lineTo(g,y+S),e.lineTo(g+k,y+S),e.stroke(),e.fillStyle="#e4e4e7",e.font=T,e.textAlign="right",e.textBaseline="middle";for(const D of q){const j=z(D.value,D.min,D.max,y,S);e.fillText(D.label,g-15,j)}e.textAlign="center",e.textBaseline="top";for(let D=h;D<=m+.01;D+=p){const j=M(D,h,m,g,k);e.fillText(`${Math.round(D)}`,j,y+S+10)}return{gx:g,gy:y,gw:k,gh:S,axisFont:I,yLabelX:Q,xLabelY:x}}function B(e,c){const h=c-e,m=h<=8?1:h<=14?2:5,p=[],q=Math.ceil(e/m)*m;for(let g=q;g<=c+.001;g+=m)p.push({value:g,label:g%1===0?`${g.toFixed(0)}`:`${g.toFixed(1)}`,min:e,max:c});return p}function te(){const{maxT:e}=X(),c=Y(0),h=Y(e),m=h-c,p=Math.max(1,m*.1),q=Math.max(0,Math.round((c-p)*10)/10),g=Math.round((h+p)*10)/10;return{minL:q,maxL:g}}function Y(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function ee(){const{maxT:e}=X(),c=ae(0),h=ae(e),m=h-c,p=Math.max(.2,m*.1),q=Math.max(0,c-p),g=h+p,y=m<=2?.5:m<=4?1:2,k=[],S=Math.ceil(q/y)*y;for(let T=S;T<=g+.001;T+=y)k.push({value:T,label:T.toFixed(1),min:q,max:g});return{minR:q,maxR:g,ticks:k}}function ae(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function N(e){const{maxT:c}=e;let h=a.thermistorR25;for(let g=0;g<=c;g+=5){const y=g+273.15,k=a.thermistorR25*Math.exp(a.thermistorBeta*(1/y-1/298.15));h=Math.max(h,k)}h=Math.ceil(h*1.08*10)/10;const m=0,p=h<=12?2:4,q=[];for(let g=0;g<=h+.001;g+=p)q.push({value:g,label:g.toFixed(0),min:m,max:h});return{minR:m,maxR:h,ticks:q}}const V=r.querySelector("#tl-thermometerCanvas"),Z=V.getContext("2d"),K=r.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),U=window.devicePixelRatio||1;V.width=w*U,V.height=A*U,Z.scale(U,U),K.width=W*U,K.height=F*U,ne.scale(U,U);function P(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const l=200,s=11;function f(){const e=Math.pow(a.bulbVolume/l,.3333333333333333);return s*e}function L(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,c=.2+a.wallThickness*1.5,h=.4+a.bulbVolume*.003,m=1.35-a.capillaryBore*.45;return Math.max(.1,c*h*m*e*.15)}function R(e){a.bathTemp<=8&&a.iceCubes.forEach(c=>{c.x+=c.speedX,c.y+=c.speedY,(c.x<65||c.x>175)&&(c.speedX*=-1),(c.y<195||c.y>210)&&(c.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(c=>{c.y-=c.speedY*(1+a.bathTemp/100),c.y<185&&(c.y=265,c.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(c=>{c.y-=c.speedY*(1+(a.bathTemp-80)/40),c.phase+=c.wobbleSpeed,c.x+=Math.sin(c.phase)*.3,c.y<185&&(c.y=260+Math.random()*10,c.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(c=>{c.x+=c.vx,c.y+=c.vy,c.alpha-=.005,(c.alpha<=0||c.y<130)&&(c.x=60+Math.random()*120,c.y=175+Math.random()*5,c.alpha=.2+Math.random()*.4)})}function _(e){let g=59,y=130,k=246;if(a.bathTemp<25){const x=a.bathTemp/25;g=Math.round(180-x*121),y=Math.round(210-x*80),k=Math.round(250-x*4)}else{const x=Math.min(1,(a.bathTemp-25)/125);g=Math.round(59+x*180),y=Math.round(130-x*100),k=Math.round(246-x*190)}if(a.bathTemp>40){const x=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${x*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let j=-25;j<=25;j+=6){const re=x*(12+Math.sin(j*.4+D)*5);e.lineTo(55+130/2+j,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const S=e.createLinearGradient(55,190,55,280);S.addColorStop(0,`rgba(${g}, ${y}, ${k}, 0.25)`),S.addColorStop(1,`rgba(${g}, ${y}, ${k}, 0.55)`),e.fillStyle=S,e.beginPath(),e.moveTo(55,190);const T=a.bathTemp>=80?2:.5,I=a.bathTemp>=80?.09:.03,Q=Date.now()*I;for(let x=55;x<=185;x+=5){const D=190+Math.sin(x*.15+Q)*T;e.lineTo(x,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(x=>{e.beginPath(),e.moveTo(x.x,x.y),e.quadraticCurveTo(x.x+Math.sin(x.y*.06)*5,x.y-x.length/2,x.x,x.y-x.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(x=>{e.save(),e.translate(x.x,x.y),e.rotate(x.angle),e.beginPath(),e.roundRect(-x.size/2,-x.size/2,x.size,x.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(x=>{e.beginPath(),e.arc(x.x,x.y,x.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(x=>{e.fillStyle=`rgba(255, 255, 255, ${x.alpha})`,e.beginPath(),e.arc(x.x,x.y,x.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function b(e,c,h,m,p,q,g="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(c,h),e.lineTo(m,p),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(c,h,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const k=e.measureText(q).width+10,S=16,T=g==="left"?m:m-k,I=p-S/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(T,I,k,S,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(q,T+k/2,I+S/2+.5)}function v(e){const m=f(),p=250+Math.max(0,m-s)*.35,q=p-m-1,g=10+a.wallThickness*8,y=120-g/2,k=120+g/2,S=e.createLinearGradient(y,20,k,20);S.addColorStop(0,"rgba(209, 213, 219, 0.85)"),S.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),S.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),S.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),S.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=S,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(y,q),e.lineTo(y,25),e.arcTo(y,20,y+5,20,5),e.arcTo(k,20,k,25,5),e.lineTo(k,q),e.closePath(),e.fill(),e.stroke();const T=e.createRadialGradient(120-m*.2,p-m*.2,m*.1,120,p,m);T.addColorStop(0,"rgba(255, 255, 255, 0.8)"),T.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=T,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,p,m+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const I=Math.min(g*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-I/2,28,I,q-20-8);const Q=a.liquidType==="mercury",x=Q?"#a1a1aa":"#ef4444",D=Q?"#f4f4f5":"#fee2e2",j=210,re=220,be=(j-40)/re,fe=j-Math.min(re,a.thermometerTemp)*be;e.fillStyle=x,e.fillRect(120-I/2,fe,I,q-fe),e.beginPath(),e.ellipse(120,fe,I/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-I/6,fe,I/3,q-fe);const oe=m*.9,ie=e.createRadialGradient(120-oe*.2,p-oe*.2,oe*.1,120,p,oe);Q?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,p,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const he=j-le*be;e.beginPath(),e.moveTo(y,he),e.lineTo(y+4,he),e.stroke(),e.fillText(`${le}°C`,y-22,he+2.5)}a.showLabels&&(b(e,y+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),b(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),b(e,120-I/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),b(e,120,p,230,p+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function H(e){const g=e.createLinearGradient(115,20,125,20);g.addColorStop(0,"#71717a"),g.addColorStop(.3,"#f4f4f5"),g.addColorStop(.7,"#d4d4d8"),g.addColorStop(1,"#3f3f46"),e.fillStyle=g,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let y=205;e.moveTo(118,y);for(let Q=0;Q<8;Q++)y+=4,e.lineTo(122,y),y+=4,e.lineTo(118,y);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const k=245,S=40,T=135,I=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(k,S,T,I,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(k+10,S+12,T-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",k+T-16,S+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",k+14,S+21),a.showLabels&&(b(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),b(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function C(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,q=225,g=12,y=120-g/2,k=e.createLinearGradient(y,p,y+g,p);k.addColorStop(0,"rgba(229, 231, 235, 0.4)"),k.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),k.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),k.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(y,p,g,q-p,[0,0,3,3]),e.fill(),e.stroke();const S=7,T=e.createRadialGradient(120-S*.2,245-S*.2,S*.1,120,245,S);T.addColorStop(0,"#6b7280"),T.addColorStop(.7,"#1f2937"),T.addColorStop(1,"#09090b"),e.fillStyle=T,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,S,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const I=245,Q=40,x=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(I,Q,x,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(I+10,Q+12,x-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",I+x-16,Q+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",I+14,Q+21),a.showLabels&&(b(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),b(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function G(e,c,h,m,p,q,g,y,k){const{gx:S,gy:T,gw:I,gh:Q}=c;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(h,m),e.lineTo(h,T+Q),e.stroke(),e.beginPath(),e.moveTo(h,m),e.lineTo(S,m),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const x=`${p.toFixed(1)}${g}`,D=e.measureText(x).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(h-D/2,T+Q+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(x,h,T+Q+4),e.textAlign="right",e.textBaseline="middle";const j=`${q.toFixed(2)} ${y}`,re=e.measureText(j).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(S-re-2,m-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(j,S-7,m)}function $(e){const c=O(),{minL:h,maxL:m}=te(),{minT:p,maxT:q,tickStep:g}=X(),y=B(h,m),k=E(e,c,p,q,g,y),{gx:S,gy:T,gw:I,gh:Q,axisFont:x,yLabelX:D,xLabelY:j,dotR:re}={...c,...k};e.save(),e.translate(D,T+Q/2),e.rotate(-Math.PI/2),e.font=x,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=x,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",S+I/2,j);const we=q,be=M(0,p,q,S,I),fe=z(Y(0),h,m,T,Q),oe=M(we,p,q,S,I),ie=z(Y(we),h,m,T,Q);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,he=a.currentLength;if(le>=p&&le<=q){const ve=M(le,p,q,S,I),Ce=z(he,h,m,T,Q);G(e,c,ve,Ce,le,he,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const c=O(),{minR:h,maxR:m,ticks:p}=ee(),q=X(),g=E(e,c,q.minT,q.maxT,q.tickStep,p),{gx:y,gy:k,gw:S,gh:T,axisFont:I,yLabelX:Q,xLabelY:x,dotR:D}={...c,...g};e.save(),e.translate(Q,k+T/2),e.rotate(-Math.PI/2),e.font=I,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=I,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+S/2,x);const{minT:j,maxT:re}=q,we=re,be=M(0,j,re,y,S),fe=z(ae(0),h,m,k,T),oe=M(we,j,re,y,S),ie=z(ae(we),h,m,k,T);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,he=a.currentResistance;if(le>=j&&le<=re){const ve=M(le,j,re,y,S),Ce=z(he,h,m,k,T);G(e,c,ve,Ce,le,he,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const c=O(),h=X(),{minR:m,maxR:p,ticks:q}=N(h),g=E(e,c,h.minT,h.maxT,h.tickStep,q),{gx:y,gy:k,gw:S,gh:T,axisFont:I,yLabelX:Q,xLabelY:x,dotR:D}={...c,...g},{minT:j,maxT:re}=h;e.save(),e.translate(Q,k+T/2),e.rotate(-Math.PI/2),e.font=I,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=I,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+S/2,x),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=j;oe<=re;oe+=1){const ie=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/ie-1/298.15)),he=M(oe,j,re,y,S),ve=z(Math.min(p,le),m,p,k,T);ve>=k&&ve<=k+T&&(we?e.lineTo(he,ve):(e.moveTo(he,ve),we=!0))}e.stroke();const be=a.thermometerTemp,fe=a.currentThermistorR;if(be>=j&&be<=re){const oe=M(be,j,re,y,S),ie=z(Math.min(p,fe),m,p,k,T);G(e,c,oe,ie,be,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,ie,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function pe(){Z.clearRect(0,0,w,A),ne.clearRect(0,0,W,F),Z.save(),Z.translate(J,0),_(Z),a.thermometerType==="liquid"?v(Z):a.thermometerType==="resistance"?H(Z):C(Z),Z.restore(),a.thermometerType==="liquid"?$(ne):a.thermometerType==="resistance"?de(ne):se(ne)}function ge(){const e=r.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const c=r.querySelector("#tl-svg-formula-liquid-sub");if(c){const g=a.liquidL100-a.liquidL0,y=a.currentLength-a.liquidL0;c.innerHTML=`
      ...
      `}const h=r.querySelector("#tl-svg-formula-resistance");h&&(h.innerHTML=`
        <svg height="55" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="31" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">Slope Equation:</text>
          <line x1="120" y1="26" x2="210" y2="26" stroke="#fff" stroke-width="1.5" />
      ...
      `);const m=r.querySelector("#tl-svg-formula-resistance-sub");if(m){const g=a.resistanceR100-a.resistanceR0,y=a.currentResistance-a.resistanceR0;m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `}const p=r.querySelector("#tl-svg-formula-thermistor");p&&(p.innerHTML=`
      ...
      `);const q=r.querySelector("#tl-svg-formula-thermistor-sub");if(q){const g=a.thermometerTemp+273.15;q.innerHTML=`
      ...
      `}}function Se(){const e=r.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:c,cu:h,interval:m}=ze(),p=parseFloat(r.querySelector("#tl-input-q10a-cm").value)||0,q=parseFloat(r.querySelector("#tl-input-q10b-t").value)||0,g=r.querySelector("#tl-pane-q10a").classList.contains("active"),y=g?(p-c)/m*100:q,k=g?p:q/100*m+c,T=(I=>130-I/100*80)(y);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Current Point -->
          <text x="65" y="${T+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${y.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${T+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${k.toFixed(1)}°C</text>
    ...
    `}function ke(e){r.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",r.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const c=r.querySelector("#tl-bath-state");a.bathTemp<=0?c.textContent="Melting Ice Bath":a.bathTemp>=100?c.textContent="Boiling Water/Steam":a.bathTemp===150?c.textContent="Hot Cooking Oil":c.textContent="Liquid Water",r.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const h=r.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?h.style.display="block":h.style.display="none",a.thermometerType==="liquid"?(r.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",r.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(r.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",r.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):r.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let qe=null;function _e(e){a.lastTimestamp||(a.lastTimestamp=e);const c=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const h=Math.min(c,.1),m=L(),p=h/m*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=p,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const q=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/q-1/298.15)),R(),pe(),ke(m),qe=requestAnimationFrame(_e)}function ze(){const e=parseFloat(r.querySelector("#tl-input-faulty-cf").value),c=parseFloat(r.querySelector("#tl-input-faulty-cu").value),h=Number.isFinite(e)?e:-1.5,m=Number.isFinite(c)?c:105,p=m-h;return{cf:h,cu:m,interval:p}}function He(e){const c=Math.round(e*100)/100;return c>=0?c.toFixed(1):`(${c.toFixed(1)})`}function me(){const{cf:e,cu:c,interval:h}=ze(),m=r.querySelector("#tl-val-faulty-interval"),p=r.querySelector("#tl-faulty-error-a"),q=r.querySelector("#tl-faulty-error-b"),g=Math.abs(h)<.01;m.textContent=h.toFixed(1)+" °C";const y=r.querySelector("#tl-svg-formula-faulty-a"),k=r.querySelector("#tl-svg-formula-faulty-b");if(g){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",q.hidden=!1,q.textContent=p.textContent,y&&(y.innerHTML=""),k&&(k.innerHTML="");return}p.hidden=!0,q.hidden=!0;const S=parseFloat(r.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(r.querySelector("#tl-input-q10b-t").value)||0,I=(S-e)/h*100,Q=T/100*h+e;y&&(y.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${S.toFixed(1)} - ${He(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${c.toFixed(1)} - ${He(e)}</text>
          <text x="170" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            &times; 100 = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${I.toFixed(1)}°C</tspan>
          </text>
        </svg>
      `),k&&(k.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${T.toFixed(1)} &times; ${h.toFixed(1)}</text>
          ...
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${He(e)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${Q.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),Se()}function ye(){const e=parseFloat(r.querySelector("#tl-input-q11-r").value)||0,c=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100,h=r.querySelector("#tl-svg-formula-resistance-solver");h&&(h.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function Te(){const e=a.thermometerTemp,c=a.liquidL100-a.liquidL0,h=a.liquidL0+c/100*e,m=r.querySelector("#tl-svg-formula-t-to-l");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `)}function Ge(){const e=a.thermometerTemp,c=a.resistanceR100-a.resistanceR0,h=a.resistanceR0+c/100*e,m=r.querySelector("#tl-svg-formula-t-to-r");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `)}function ue(){me(),ye(),Te(),Ge()}function Fe(e,c){r.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=c,r.querySelector("#tl-bath-temp-slider").value=c,ue()})}function mt(){r.querySelectorAll(".tl-tab-btn").forEach(p=>{p.addEventListener("click",()=>{r.querySelectorAll(".tl-tab-btn").forEach(g=>g.classList.remove("active")),r.querySelectorAll(".tl-tab-content").forEach(g=>g.classList.remove("active")),p.classList.add("active");const q=p.getAttribute("data-tl-tab");r.querySelector("#tl-tab-"+q).classList.add("active"),a.thermometerType=q,ue()})}),r.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{a.showLabels=!a.showLabels,r.querySelector("#tl-lbl-toggle-labels").textContent=a.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),r.querySelector("#tl-bath-temp-slider").addEventListener("input",p=>{a.bathTemp=parseFloat(p.target.value),ue()}),Fe("tl-btn-preset-ice",0),Fe("tl-btn-preset-room",25),Fe("tl-btn-preset-steam",100),Fe("tl-btn-preset-oil",150),r.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",r.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",r.querySelector("#tl-card-alcohol").className="tl-seg-btn",ue()}),r.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",r.querySelector("#tl-card-mercury").className="tl-seg-btn",r.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",ue()}),r.querySelector("#tl-slider-bulb-vol").addEventListener("input",p=>{a.bulbVolume=parseFloat(p.target.value),r.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),r.querySelector("#tl-slider-wall-thick").addEventListener("input",p=>{a.wallThickness=parseFloat(p.target.value),r.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),r.querySelector("#tl-slider-capillary-bore").addEventListener("input",p=>{a.capillaryBore=parseFloat(p.target.value),r.querySelector("#tl-val-capillary-bore").textContent=a.capillaryBore.toFixed(2)+" mm"}),r.querySelector("#tl-slider-liquid-l0").addEventListener("input",p=>{a.liquidL0=parseFloat(p.target.value),r.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",ue()}),r.querySelector("#tl-slider-liquid-l100").addEventListener("input",p=>{a.liquidL100=parseFloat(p.target.value),r.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",ue()}),r.querySelector("#tl-slider-resistance-r0").addEventListener("input",p=>{a.resistanceR0=parseFloat(p.target.value),r.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",r.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",ue()}),r.querySelector("#tl-slider-resistance-r100").addEventListener("input",p=>{a.resistanceR100=parseFloat(p.target.value),r.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",r.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",ue()}),r.querySelector("#tl-slider-thermistor-r25").addEventListener("input",p=>{a.thermistorR25=parseFloat(p.target.value),r.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",r.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",ue()}),r.querySelector("#tl-slider-thermistor-beta").addEventListener("input",p=>{a.thermistorBeta=parseFloat(p.target.value),r.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",r.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",ue()}),r.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{r.querySelector("#tl-btn-solve-q10a").classList.add("active"),r.querySelector("#tl-btn-solve-q10b").classList.remove("active"),r.querySelector("#tl-pane-q10a").classList.add("active"),r.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),r.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{r.querySelector("#tl-btn-solve-q10a").classList.remove("active"),r.querySelector("#tl-btn-solve-q10b").classList.add("active"),r.querySelector("#tl-pane-q10a").classList.remove("active"),r.querySelector("#tl-pane-q10b").classList.add("active"),me()}),r.querySelector("#tl-input-faulty-cf").addEventListener("input",me),r.querySelector("#tl-input-faulty-cu").addEventListener("input",me),r.querySelector("#tl-input-q10a-cm").addEventListener("input",me),r.querySelector("#tl-input-q10b-t").addEventListener("input",me),r.querySelector("#tl-input-q11-r").addEventListener("input",ye);const h=r.querySelector("#tl-input-t-to-l");h&&h.addEventListener("input",ue);const m=r.querySelector("#tl-input-t-to-r");m&&m.addEventListener("input",ue)}if(i.type){const e=r.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return r.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===o?e.classList.add("active"):e.classList.remove("active")}),r.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===o?e.classList.add("active"):e.classList.remove("active")}),P(),mt(),ue(),qe=requestAnimationFrame(_e),r._thermometerLabCleanup=()=>{qe&&cancelAnimationFrame(qe)},r}function Dt(t){const i=document.createElement("div");i.className="tool-specific-heat";const o=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"specific-heat/index.html?lang="+encodeURIComponent(ce())}o.src=r(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=o.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(o),i}function Ot(t){const i=document.createElement("div");i.className="tool-thermal-mixing";const o=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"thermal-mixing/index.html?lang="+encodeURIComponent(ce())}o.src=r(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=o.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(o),i}function Gt(t){const i=document.createElement("div");i.className="tool-change-of-state";const o=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"change-of-state/index.html?lang="+encodeURIComponent(ce())}o.src=r(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=o.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(o),i}function jt(t){const i=document.createElement("div");i.className="tool-heat-transfer";const o=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:n+"/";function r(){return u+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(ce())}o.src=r(),o.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=o.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=r()}};return window.addEventListener("s3phy:lang",a),i._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(o),i}const Le=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],De=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],Bt=[["thermometer","topic.thermometer"]],Ze=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],Qt={liquid:t=>Pe(t,{type:"liquid"}),resistance:t=>Pe(t,{type:"resistance"}),thermistor:t=>Pe(t,{type:"thermistor"}),specificHeat:t=>Dt(t),thermalMixing:t=>Ot(t),changeOfState:t=>Gt(t),heatTransfer:t=>jt(t)};function Nt(t){return d({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function Ae(){return ce()==="zh-Hant"?"zhHant":"en"}async function ut(t,i){const o=`./${t}/${i}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function Je(t){return ut("notes",t)}function Vt(t){let i="topics",o="liquid",n=0,u="all",r=!1,a=null,w={main:null},A=null;function J(){if(w.main){if(i==="topics"?w.main.innerHTML=F():i==="notes"?w.main.innerHTML=X():i==="tools"?w.main.innerHTML=z():i==="worksheets"?w.main.innerHTML=ct(d,{topics:Bt,paperTitleKey:"worksheets.paperTitleHeat"}):i==="flashcards"?w.main.innerHTML=te():i==="summary"&&(w.main.innerHTML=K()),i==="notes"&&M(),i==="tools"&&E(),i==="worksheets"){const l=ot.filter(s=>De.includes(s.topic));dt(t,l,d,Ae,{topicFilter:(s,f)=>f.includes("thermometer")?De.includes(s.topic):f.includes(s.topic)})}i==="flashcards"&&Z(),i==="summary"&&ne()}}function W(){a==null||a.destroy(),a=lt(t,{subtitleKey:"strand.heat.subtitle",activeSection:i,onSection:l=>{i==="tools"&&l!=="tools"&&A!=null&&A._thermometerLabCleanup&&(A._thermometerLabCleanup(),A=null),i=l,a.updateSection(i),J()},onLang:()=>W()}),w.main=a.main,a.updateSection(i),J()}function F(){return`
      <section class="panel panel--topic-hub">
        <h2>${d("topics.title")}</h2>
        <p class="lead">${d("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Le.map(l=>{const s=l.tool?`<button class="btn primary" type="button" data-go-tool="${l.tool}">${d("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${d("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${d(l.titleKey)}</h3>
              ${s}
            </div>`}).join("")}
        </div>
      </section>`}function O(l){const s=l.target.closest("[data-go-tool]");if(s){const L=s.getAttribute("data-go-tool");Ze.includes(L)?o=L:o="liquid",i="tools",a.updateSection(i),J();return}const f=l.target.closest("[data-go-section]");(f==null?void 0:f.getAttribute("data-go-section"))==="notes"&&(i="notes",a.updateSection(i),J())}function X(){return`
      <section class="panel">
        <h2>${d("notes.title")}</h2>
        <p class="lead">${d("notes.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${Le.map(l=>`
            <div class="card" data-note-card="${l.id}">
              <h3>${d(`notes.card.${l.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function M(){const l=Ae();for(const s of Le){const f=t.querySelector(`[data-note-card="${s.id}"]`);if(!f)continue;const L=f.querySelector("[data-note-body]"),R=l==="zhHant"?s.fileZh:s.fileEn,_=await Je(R),b=`./notes/${R}`;_?L.innerHTML=`
          <iframe class="notes-grid" title="${d(`notes.card.${s.id}`)}" src="${b}"></iframe>
          <p style="margin-top:8px"><a href="${b}" target="_blank" rel="noopener">${d("notes.openPdf")}</a></p>`:L.innerHTML=`<p class="lead">${d("notes.missing")}</p>`}}function z(){return`
      <section class="panel panel--tools">
        <h2>${d("tools.title")}</h2>
        <p class="lead">${d("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ze.map(l=>`<button type="button" data-tool="${l}" class="${o===l?"active":""}">${Nt(l)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function E(){const l=t.querySelector("[data-tool-list]"),s=t.querySelector("[data-tool-stage]");!l||!s||(l.querySelectorAll("button").forEach(f=>{f.addEventListener("click",()=>{o=f.getAttribute("data-tool"),l.querySelectorAll("button").forEach(L=>L.classList.toggle("active",L.getAttribute("data-tool")===o)),B(s)})}),B(s))}function B(l){l.innerHTML="",A!=null&&A._thermometerLabCleanup&&A._thermometerLabCleanup();const s=Qt[o];s&&(A=s(d),l.appendChild(A))}function te(){return`
      <section class="panel">
        <h2>${d("flashcards.title")}</h2>
        <p class="lead">${d("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
          ...
          <select data-flash-deck>
            <option value="all">${d("flashcards.all")}</option>
            <option value="thermometry">${d("flashcards.deck.thermometry")}</option>
          </select>
        </div>
        <div class="flashcard-box">
          <div class="flashcard-surface" data-flip-card>
      ...
      </section>`}function Y(){return st.filter(l=>De.includes(l.topic))}function ee(l){return!!(l!=null&&l.front)}function ae(l){return`./${String(l).replace(/^\.\//,"")}`}function N(){if(u==="all"||u==="thermometry")return It.slice();const l=Y().filter(s=>s.topic===u);return l.length?l:Y()}function V(){const l=N(),s=t.querySelector("[data-flash-progress]");if(!l.length){n=0;const H=t.querySelector("[data-flash-front]"),C=t.querySelector("[data-flip-card]");H&&(H.textContent=""),C&&C.classList.remove("flashcard-surface--image"),s&&(s.hidden=!0,s.textContent="");return}n=Math.max(0,Math.min(n,l.length-1));const f=l[n],L=t.querySelector("[data-flash-front]"),R=t.querySelector("[data-flip-card]"),_=t.querySelector("[data-flash-label]");if(!L||!R)return;if(s&&(s.hidden=!1,s.textContent=d("flashcards.progress").replace("{current}",String(n+1)).replace("{total}",String(l.length))),ee(f)){const H=f.back&&f.back!==f.front;R.classList.add("flashcard-surface--image"),_&&(H?(_.hidden=!1,_.textContent=d(r?"flashcards.answer":"flashcards.question")):_.hidden=!0);const C=r&&f.back?f.back:f.front,G=f.alt||f.title||"";L.innerHTML=`<img src="${ae(C)}" alt="${G.replace(/"/g,"&quot;")}" loading="lazy" />`;return}R.classList.remove("flashcard-surface--image");const b=Ae(),v=f[b]||f.en;_&&(_.hidden=!1,_.textContent=d(r?"flashcards.answer":"flashcards.question")),L.textContent=r?v.a:v.q}function Z(){const l=t.querySelector("[data-flash-deck]");l.value=u,l.addEventListener("change",()=>{u=l.value,n=0,r=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{r=!r,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",s=>{s.stopPropagation(),r=!r,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const s=N();n=(n-1+s.length)%s.length,r=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const s=N();n=(n+1)%s.length,r=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const s=N();n=Math.floor(Math.random()*s.length),r=!1,V()}),V()}function K(){return`
      <section class="panel">
        <h2>${d("summary.title")}</h2>
        <p class="lead">${d("summary.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${Le.map(l=>`
            <div class="card" data-summary-card="${l.id}">
              <h3>${d(`summary.item.${l.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function ne(){const l=Ae();for(const s of Le){const f=t.querySelector(`[data-summary-card="${s.id}"]`);if(!f)continue;const L=f.querySelector("[data-summary-body]");if(s.id==="thermometer"){const v=await ut("summary","thermometer.webp"),H="./summary/thermometer.webp";v?L.innerHTML=`
          <img class="summary-thumb" src="${H}" alt="${d("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${H}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:L.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}const R=l==="zhHant"?s.fileZh:s.fileEn,_=await Je(R),b=`./notes/${R}`;_?L.innerHTML=`
          <iframe class="notes-grid" title="${d(`summary.item.${s.id}`)}" src="${b}"></iframe>
          <p style="margin-top:8px"><a href="${b}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:L.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const U=()=>W(),P=l=>O(l);return window.addEventListener("s3phy:lang",U),t.addEventListener("click",P),W(),()=>{window.removeEventListener("s3phy:lang",U),t.removeEventListener("click",P),A!=null&&A._thermometerLabCleanup&&A._thermometerLabCleanup(),a==null||a.destroy()}}const et={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};vt();const tt="s3phy_splash_seen",ft={optics:Et,heat:Vt};let Re=null,Me=null;function Ut(){const t=location.hash.match(/^#\/(\w+)/),i=t==null?void 0:t[1];return i&&Object.prototype.hasOwnProperty.call(ft,i)?i:null}function Yt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function pt(t){Re==null||Re(),Re=null,Me==null||Me(),Me=null;const i=document.getElementById("app");if(!i)return;if(i.innerHTML="",!t){location.hash&&Yt(),Me=wt(i);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Re=ft[t](i)??null}function ht(){pt(Ut())}function Kt(){return"./images/uniplus-logo.png"}function Xt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Kt()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Zt(t,i){const o=[...et.en,...et.zhHant],n=()=>{if(!t.parentElement)return;const u=document.createElement("div");u.className="splash-danmaku-item",u.textContent=o[Math.floor(Math.random()*o.length)];const r=Math.random()*85+5,a=Math.random()*.8+.9,w=Math.random()*12+10;u.style.top=`${r}%`,u.style.fontSize=`${a}rem`,u.style.animationDuration=`${w}s`,i.appendChild(u),u.addEventListener("animationend",()=>u.remove()),window.setTimeout(n,1500+Math.random()*1e3)};for(let u=0;u<4;u+=1)window.setTimeout(n,u*1e3)}function Jt(t){const i=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),n=t.querySelector("#splashStartWrap");window.setTimeout(()=>i==null?void 0:i.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),n==null||n.classList.add("splash-start-wrap--in"),o&&Zt(t,o)},1600)}function at(){ht()}function ea(){let t=!1;try{t=sessionStorage.getItem(tt)==="1"}catch{}if(t){at();return}const i=Xt();document.body.insertBefore(i,document.body.firstChild),Jt(i);const o=i.querySelector("#splashStart"),n=()=>{i.remove(),at()};o.addEventListener("click",()=>{try{sessionStorage.setItem(tt,"1")}catch{}i.classList.add("splash--hide"),i.addEventListener("transitionend",n,{once:!0}),window.setTimeout(n,480)})}window.addEventListener("hashchange",ht);window.addEventListener("s3phy:strand",t=>{pt(t.detail??null)});ea();
