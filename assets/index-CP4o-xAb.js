...
`;function Nt(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=jt,document.head.appendChild(t)}function Qt(t){Nt();const n=document.createElement("div");n.className="rml",n.innerHTML=`
  ...
  `;const o=n.querySelector(".rml-canvas"),i=o.getContext("2d"),s=n.querySelector("[data-rml-rot]"),a=n.querySelector("[data-rml-inc]"),r=n.querySelector('[data-rml-disp="rot"]'),l=n.querySelector('[data-rml-disp="inc"]'),P=n.querySelector('[data-rml-val="i"]'),F=n.querySelector('[data-rml-val="r"]'),A=n.querySelector('[data-rml-val="shift"]'),I=350,q=380,W=300,m="#22d3ee",S="bold 17px system-ui, sans-serif";let $=0,g=-140,u=!0,f=!0,w=!0,v=!0;function T(Q){return Q*Math.PI/180}function C(Q,U,Y,re,le,te=2,ne=!1){i.beginPath(),i.lineWidth=te,i.strokeStyle=le,i.setLineDash(ne?[6,6]:[]);const ee=Q+Math.cos(T(Y))*re,oe=U+Math.sin(T(Y))*re;return i.moveTo(Q,U),i.lineTo(ee,oe),i.stroke(),i.setLineDash([]),{x:ee,y:oe}}function B(Q,U,Y,re,le,te=14){const ne=Y-Q,ee=re-U,oe=Math.hypot(ne,ee);if(oe<1e-6)return;const be=ne/oe,z=ee/oe,L=Y-be*te,k=re-z*te,G=.45*te;i.beginPath(),i.fillStyle=le,i.moveTo(Y,re),i.lineTo(L-z*G,k+be*G),i.lineTo(L+z*G,k-be*G),i.closePath(),i.fill()}function j(Q,U,Y,re,le,te=25){i.beginPath(),i.strokeStyle=re,i.lineWidth=2;const ne=Math.min(Q,U),ee=Math.max(Q,U);if(i.arc(I,q,Y,T(ne),T(ee),!1),i.stroke(),le){const oe=(ne+ee)/2,be=I+Math.cos(T(oe))*(Y+te),z=q+Math.sin(T(oe))*(Y+te);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=re,i.fillText(le,be,z),i.restore()}}function O(Q,U,Y,re,le){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(I-200,q),i.lineTo(I+200,q),i.stroke(),i.setLineDash([]),i.lineCap="butt";const te=I+Math.cos(T(Q))*W,ne=q+Math.sin(T(Q))*W;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(te,ne),i.lineTo(I,q),i.stroke();const ee=(te+I)*.5,oe=(ne+q)*.5,be=Math.hypot(I-te,q-ne)||1,z=(I-te)/be,L=(q-ne)/be;if(B(ee-z*28,oe-L*28,ee,oe,"#fff",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),te,ne-12),i.restore(),u){const k=C(I,q,-90,W-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),k.x+6,k.y-4),i.restore()}if(f){const k=C(I,q,re,W,"#00e676",2,!1);B(I,q,k.x,k.y,"#00e676",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),k.x,k.y-14),i.restore()}i.save(),i.translate(I,q),i.rotate(T($)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let k=-190;k<200;k+=15)i.moveTo(k,0),i.lineTo(k-5,8);if(i.stroke(),i.restore(),w){const k=C(I,q,U,W-40,m,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=m,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),k.x+6,k.y-4),i.restore()}if(v){const k=C(I,q,Y,W,m,4);B(I,q,k.x,k.y,m,16),Math.abs($)>.5&&(i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=m,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),k.x,k.y-14),i.restore())}if(w&&j(Q,U,100,"#ffcc00",`i=${le.toFixed(0)}°`,25),w&&v&&j(U,Y,100,m,`r=${le.toFixed(0)}°`,25),u&&w&&Math.abs($)>.5&&j(-90,U,50,"#ffcc00",`θ=${Math.abs($)}°`,20),f&&v&&Math.abs($)>.5){const k=Y-re;j(re,Y,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${k.toFixed(0)}°`,40)}}function D(){$=parseFloat(s.value),g=parseFloat(a.value);const Q=$>0?"+":"";r.textContent=`${Q}${$}°`,l.textContent=`${g}°`;const U=-90,Y=Math.abs(g-U),re=U+Y,le=-90+$,te=Math.abs(g-le),ne=le+te,ee=ne-re;P.textContent=`${te.toFixed(1)}°`,F.textContent=`${te.toFixed(1)}°`;const oe=ee>0?"+":"";A.textContent=`${oe}${ee.toFixed(1)}°`,O(g,le,ne,re,te)}return n.querySelectorAll("[data-rml-toggle]").forEach(Q=>{Q.addEventListener("click",()=>{const U=Q.getAttribute("data-rml-toggle");U==="orig-norm"&&(u=!u),U==="orig-ray"&&(f=!f),U==="new-norm"&&(w=!w),U==="new-ray"&&(v=!v),Q.classList.toggle("active"),D()})}),n.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",D()}),s.addEventListener("input",D),a.addEventListener("input",D),D(),n}function Vt(t){const n=document.createElement("div");n.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;return o.src=`${s}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",n.appendChild(o),n}function Kt(t,n={}){const o=n.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),r="./",l=r.endsWith("/")?r:`${r}/`;return a.src=`${l}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,a.title=t(i),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function Ut(t){const n=document.createElement("div");n.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(de())}`}o.src=a(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var l;try{(l=o.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._emLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function Yt(t){const n=document.createElement("div");n.className="rgb-mixer",n.innerHTML=`
  ...
  `;const a=t.querySelector("[data-main]"),r=t.querySelector("[data-nav]"),l=t.querySelector("[data-lang]"),P=t.querySelector("[data-strand-back]");let F=o;function A(m){F=m,r.innerHTML=Xt.map(S=>`<button type="button" class="${m===S?"active":""}" data-sec="${S}">${d(Zt[S])}</button>`).join(""),r.querySelectorAll("button").forEach(S=>{S.addEventListener("click",()=>i(S.getAttribute("data-sec")))})}function I(){l.innerHTML=`
    ...
    <section class="panel panel--worksheets">
      ...
      ${se}
    </article>`}function D(){if(!a.items.length){F.className="ws-quiz-area ws-quiz-empty",F.innerHTML=`<p>${Z(o("worksheets.empty"))}</p>`;return}F.className="ws-quiz-area",F.innerHTML=a.items.map((z,L)=>O(z,L)).join(""),F.querySelectorAll("[data-ws-option]").forEach(z=>{z.addEventListener("click",()=>{const L=Number(z.getAttribute("data-ws-q"));if(a.resolved[L])return;const k=Number(z.getAttribute("data-ws-option"));a.pending[L]=k,F.querySelectorAll(`[data-ws-q="${L}"][data-ws-option]`).forEach(G=>{G.classList.toggle("ws-option-btn--selected",Number(G.getAttribute("data-ws-option"))===k)})})}),F.querySelectorAll("[data-ws-check]").forEach(z=>{z.addEventListener("click",()=>{const L=Number(z.getAttribute("data-ws-check"));if(a.resolved[L])return;const k=a.pending[L];if(k===void 0)return;const G=a.items[L][f()]||a.items[L].en;a.userAnswers[L]=k,k===G.a?a.resolved[L]=!0:(a.wrongAttempts[L]=(a.wrongAttempts[L]||0)+1,a.wrongAttempts[L]>=2&&(a.resolved[L]=!0)),C(),j()&&Q(),D()})})}function Q(){const z=a.items.length;let L=0,k=0;const G={};a.items.forEach((se,he)=>{const ve=se[f()]||se.en;if(a.userAnswers[he]===ve.a)L+=1,(a.wrongAttempts[he]||0)===0&&(k+=1);else if(a.resolved[he]){const xe=se.section||se.topic;G[xe]=(G[xe]||0)+1}});const J=z?Math.round(L/z*100):0;let ae=o("worksheets.revisionFair");J>=90?ae=o("worksheets.revisionExcellent"):J>=70?ae=o("worksheets.revisionGood"):J<50&&(ae=o("worksheets.revisionLow"));const we=Object.entries(G).sort((se,he)=>he[1]-se[1]).map(([se,he])=>`<li>${Z(se)} (${he})</li>`).join("");q.innerHTML=`
    ...
    <section class="panel panel--flashcards">
      ...
      <section class="panel">
        ...
        <div class="grid cols-2" data-summary-grid>
          ...
          <p style="margin-top:8px"><a href="${j}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:T.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const $=()=>F(),g=u=>I(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",g),F(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",g),r==null||r(),s==null||s.destroy()}}const ft="s3phy-thermometer-lab-css",wa=900,xa=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function ka(){if(document.getElementById(ft))return;const t=document.createElement("style");t.id=ft,t.textContent=xa,document.head.appendChild(t)}function Sa(t){const o={x:12,y:12},i=200,{container:s,panel:a,toggleBtn:r,dragHandle:l,storageKey:P,onLayoutChange:F,breakpoint:A=1024,collapsedClass:I="controls-collapsed",floatingClass:q="controls-floating"}=t;if(!s||!a||!r)return null;let W=sessionStorage.getItem(P)!=="false",m=(()=>{try{const O=localStorage.getItem(P+":pos");if(!O)return{...o};const D=JSON.parse(O);if(typeof D.x=="number"&&typeof D.y=="number")return D}catch{}return{...o}})(),S=null,$=null;const g=()=>window.innerWidth>=A,u=(O,D)=>{const Q=s.getBoundingClientRect(),U=a.getBoundingClientRect(),Y=Math.max(0,Q.width-U.width),re=Math.max(0,Q.height-U.height);return{x:Math.min(Math.max(0,O),Y),y:Math.min(Math.max(0,D),re)}},f=()=>{a.style.left=m.x+"px",a.style.top=m.y+"px",a.style.right="auto",a.style.bottom="auto"},w=()=>{typeof F=="function"&&(clearTimeout($),$=setTimeout(F,i))},v=()=>{r.setAttribute("aria-expanded",W?"false":"true"),t.getToggleTitle&&(r.title=t.getToggleTitle(W));const O=r.querySelector("[data-float-chevron]");O&&(O.textContent=W?"v":"^")},T=O=>{W=O,a.classList.toggle(I,W),sessionStorage.setItem(P,W?"true":"false"),v(),w()},C=()=>{s.classList.add(q),a.classList.add("lab-controls-float"),m=u(m.x,m.y),f(),l&&(l.style.display="")},B=()=>{s.classList.remove(q),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",l&&(l.style.display="none")},j=()=>{g()?(C(),m=u(m.x,m.y),f()):B(),w()};if(a.classList.toggle(I,W),v(),j(),r.addEventListener("click",O=>{O.stopPropagation(),T(!W)}),l){l.addEventListener("pointerdown",D=>{g()&&(D.preventDefault(),S={pointerId:D.pointerId,startX:D.clientX,startY:D.clientY,originX:m.x,originY:m.y},l.setPointerCapture(D.pointerId),l.classList.add("is-dragging"))}),l.addEventListener("pointermove",D=>{!S||S.pointerId!==D.pointerId||(m=u(S.originX+D.clientX-S.startX,S.originY+D.clientY-S.startY),f())});const O=D=>{if(!(!S||S.pointerId!==D.pointerId)){l.releasePointerCapture(D.pointerId),l.classList.remove("is-dragging");try{localStorage.setItem(P+":pos",JSON.stringify(m))}catch{}S=null,w()}};l.addEventListener("pointerup",O),l.addEventListener("pointercancel",O)}return window.addEventListener("resize",j),{setCollapsed:T,refreshMode:j,isCollapsed:()=>W}}function Be(t,n={}){ka();const o=n.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");n.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
  ...
  `;const r={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},l=460,P=340,F=80,A=800,I=560;function q(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:A-e.left-e.right,gh:I-e.top-e.bottom,tickFont:`bold ${Math.round(A*.024)}px Arial`,axisFont:`bold ${Math.round(A*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:I-e.bottom+32}}function W(){let c=100;const p=Math.max(r.bathTemp,r.thermometerTemp,100);p>120&&(c=150),p>145&&(c=200);const b=c<=100?20:25;return{minT:0,maxT:c,tickStep:b}}function m(e,c,p,b,h){return b+(e-c)/(p-c)*h}function S(e,c,p,b,h){return b+h-(e-c)/(p-c)*h}function $(e,c,p,b,h,E){const{gx:y,gy:x,gw:M,gh:H,tickFont:_,axisFont:N,yLabelX:X,xLabelY:R}=c;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const V of E){const K=S(V.value,V.min,V.max,x,H);e.beginPath(),e.moveTo(y,K),e.lineTo(y+M,K),e.stroke()}for(let V=p;V<=b+.01;V+=h){const K=m(V,p,b,y,M);e.beginPath(),e.moveTo(K,x),e.lineTo(K,x+H),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(y,x),e.lineTo(y,x+H),e.lineTo(y+M,x+H),e.stroke(),e.fillStyle="#e4e4e7",e.font=_,e.textAlign="right",e.textBaseline="middle";for(const V of E){const K=S(V.value,V.min,V.max,x,H);e.fillText(V.label,y-15,K)}e.textAlign="center",e.textBaseline="top";for(let V=p;V<=b+.01;V+=h){const K=m(V,p,b,y,M);e.fillText(`${Math.round(V)}`,K,x+H+10)}return{gx:y,gy:x,gw:M,gh:H,axisFont:N,yLabelX:X,xLabelY:R}}function g(e,c){const p=c-e,b=p<=8?1:p<=14?2:5,h=[],E=Math.ceil(e/b)*b;for(let y=E;y<=c+.001;y+=b)h.push({value:y,label:y%1===0?`${y.toFixed(0)}`:`${y.toFixed(1)}`,min:e,max:c});return h}function u(){const{maxT:e}=W(),c=f(0),p=f(e),b=p-c,h=Math.max(1,b*.1),E=Math.max(0,Math.round((c-h)*10)/10),y=Math.round((p+h)*10)/10;return{minL:E,maxL:y}}function f(e){return r.liquidL0+(r.liquidL100-r.liquidL0)/100*e}function w(){const{maxT:e}=W(),c=v(0),p=v(e),b=p-c,h=Math.max(.2,b*.1),E=Math.max(0,c-h),y=p+h,x=b<=2?.5:b<=4?1:2,M=[],H=Math.ceil(E/x)*x;for(let _=H;_<=y+.001;_+=x)M.push({value:_,label:_.toFixed(1),min:E,max:y});return{minR:E,maxR:y,ticks:M}}function v(e){return r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*e}function T(e){const{maxT:c}=e;let p=r.thermistorR25;for(let y=0;y<=c;y+=5){const x=y+273.15,M=r.thermistorR25*Math.exp(r.thermistorBeta*(1/x-1/298.15));p=Math.max(p,M)}p=Math.ceil(p*1.08*10)/10;const b=0,h=p<=12?2:4,E=[];for(let y=0;y<=p+.001;y+=h)E.push({value:y,label:y.toFixed(0),min:b,max:p});return{minR:b,maxR:p,ticks:E}}const C=a.querySelector("#tl-thermometerCanvas"),B=C.getContext("2d"),j=a.querySelector("#tl-graphCanvas"),O=j.getContext("2d"),D=window.devicePixelRatio||1;C.width=l*D,C.height=P*D,B.scale(D,D),j.width=A*D,j.height=I*D,O.scale(D,D);function Q(){r.iceCubes=[];for(let e=0;e<5;e++)r.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});r.bubbles=[];for(let e=0;e<20;e++)r.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});r.heatWaves=[];for(let e=0;e<8;e++)r.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});r.steamParticles=[];for(let e=0;e<12;e++)r.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const U=200,Y=11;function re(){const e=Math.pow(r.bulbVolume/U,.3333333333333333);return Y*e}function le(){if(r.thermometerType==="resistance"||r.thermometerType==="thermistor")return .35;const e=r.liquidType==="mercury"?1:8,c=.2+r.wallThickness*1.5,p=.4+r.bulbVolume*.003,b=1.35-r.capillaryBore*.45;return Math.max(.1,c*p*b*e*.15)}function te(e){r.bathTemp<=8&&r.iceCubes.forEach(c=>{c.x+=c.speedX,c.y+=c.speedY,(c.x<65||c.x>175)&&(c.speedX*=-1),(c.y<195||c.y>210)&&(c.speedY*=-1)}),r.bathTemp>35&&r.heatWaves.forEach(c=>{c.y-=c.speedY*(1+r.bathTemp/100),c.y<185&&(c.y=265,c.x=65+Math.random()*110)}),r.bathTemp>=80&&r.bubbles.forEach(c=>{c.y-=c.speedY*(1+(r.bathTemp-80)/40),c.phase+=c.wobbleSpeed,c.x+=Math.sin(c.phase)*.3,c.y<185&&(c.y=260+Math.random()*10,c.x=60+Math.random()*120)}),r.bathTemp>=95&&r.steamParticles.forEach(c=>{c.x+=c.vx,c.y+=c.vy,c.alpha-=.005,(c.alpha<=0||c.y<130)&&(c.x=60+Math.random()*120,c.y=175+Math.random()*5,c.alpha=.2+Math.random()*.4)})}function ne(e){let y=59,x=130,M=246;if(r.bathTemp<25){const R=r.bathTemp/25;y=Math.round(180-R*121),x=Math.round(210-R*80),M=Math.round(250-R*4)}else{const R=Math.min(1,(r.bathTemp-25)/125);y=Math.round(59+R*180),x=Math.round(130-R*100),M=Math.round(246-R*190)}if(r.bathTemp>40){const R=Math.min(1,(r.bathTemp-40)/100),V=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${R*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let K=-25;K<=25;K+=6){const ie=R*(12+Math.sin(K*.4+V)*5);e.lineTo(55+130/2+K,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const H=e.createLinearGradient(55,190,55,280);H.addColorStop(0,`rgba(${y}, ${x}, ${M}, 0.25)`),H.addColorStop(1,`rgba(${y}, ${x}, ${M}, 0.55)`),e.fillStyle=H,e.beginPath(),e.moveTo(55,190);const _=r.bathTemp>=80?2:.5,N=r.bathTemp>=80?.09:.03,X=Date.now()*N;for(let R=55;R<=185;R+=5){const V=190+Math.sin(R*.15+X)*_;e.lineTo(R,V)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),r.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(r.bathTemp-35)/120)})`,e.lineWidth=1.2,r.heatWaves.forEach(R=>{e.beginPath(),e.moveTo(R.x,R.y),e.quadraticCurveTo(R.x+Math.sin(R.y*.06)*5,R.y-R.length/2,R.x,R.y-R.length),e.stroke()})),r.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,r.iceCubes.forEach(R=>{e.save(),e.translate(R.x,R.y),e.rotate(R.angle),e.beginPath(),e.roundRect(-R.size/2,-R.size/2,R.size,R.size,3),e.fill(),e.stroke(),e.restore()})),r.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,r.bubbles.forEach(R=>{e.beginPath(),e.arc(R.x,R.y,R.r,0,Math.PI*2),e.fill(),e.stroke()})),r.bathTemp>=95&&r.steamParticles.forEach(R=>{e.fillStyle=`rgba(255, 255, 255, ${R.alpha})`,e.beginPath(),e.arc(R.x,R.y,R.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function ee(e,c,p,b,h,E,y="left"){if(!r.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(c,p),e.lineTo(b,h),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(c,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const M=e.measureText(E).width+10,H=16,_=y==="left"?b:b-M,N=h-H/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(_,N,M,H,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(E,_+M/2,N+H/2+.5)}function oe(e){const b=re(),h=250+Math.max(0,b-Y)*.35,E=h-b-1,y=10+r.wallThickness*8,x=120-y/2,M=120+y/2,H=e.createLinearGradient(x,20,M,20);H.addColorStop(0,"rgba(209, 213, 219, 0.85)"),H.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),H.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),H.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),H.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=H,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(x,E),e.lineTo(x,25),e.arcTo(x,20,x+5,20,5),e.arcTo(M,20,M,25,5),e.lineTo(M,E),e.closePath(),e.fill(),e.stroke();const _=e.createRadialGradient(120-b*.2,h-b*.2,b*.1,120,h,b);_.addColorStop(0,"rgba(255, 255, 255, 0.8)"),_.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=_,e.strokeStyle="#6b7280",e.lineWidth=.8+r.wallThickness*.6,e.beginPath(),e.arc(120,h,b+.5+r.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const N=Math.min(y*.72,.8+r.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-N/2,28,N,E-20-8);const X=r.liquidType==="mercury",R=X?"#a1a1aa":"#ef4444",V=X?"#f4f4f5":"#fee2e2",K=210,ie=220,ye=(K-40)/ie,me=K-Math.min(ie,r.thermometerTemp)*ye;e.fillStyle=R,e.fillRect(120-N/2,me,N,E-me),e.beginPath(),e.ellipse(120,me,N/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=V,e.fillRect(120-N/6,me,N/3,E-me);const ue=b*.9,ce=e.createRadialGradient(120-ue*.2,h-ue*.2,ue*.1,120,h,ue);X?(ce.addColorStop(0,"#f4f4f5"),ce.addColorStop(.3,"#d4d4d8"),ce.addColorStop(.8,"#71717a"),ce.addColorStop(1,"#3f3f46")):(ce.addColorStop(0,"#fee2e2"),ce.addColorStop(.2,"#fca5a5"),ce.addColorStop(.7,"#ef4444"),ce.addColorStop(1,"#991b1b")),e.fillStyle=ce,e.beginPath(),e.arc(120,h,ue,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let fe=0;fe<=200;fe+=50){const ge=K-fe*ye;e.beginPath(),e.moveTo(x,ge),e.lineTo(x+4,ge),e.stroke(),e.fillText(`${fe}°C`,x-22,ge+2.5)}r.showLabels&&(ee(e,x+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),ee(e,120,me,230,me-15,t("tools.thermometerLab.labels.meniscus"),"left"),ee(e,120-N/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),ee(e,120,h,230,h+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function be(e){const y=e.createLinearGradient(115,20,125,20);y.addColorStop(0,"#71717a"),y.addColorStop(.3,"#f4f4f5"),y.addColorStop(.7,"#d4d4d8"),y.addColorStop(1,"#3f3f46"),e.fillStyle=y,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let x=205;e.moveTo(118,x);for(let X=0;X<8;X++)x+=4,e.lineTo(122,x),x+=4,e.lineTo(118,x);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const M=245,H=40,_=135,N=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(M,H,_,N,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(M+10,H+12,_-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(r.currentResistance.toFixed(2)+" Ω",M+_-16,H+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",M+14,H+21),r.showLabels&&(ee(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),ee(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function z(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const h=20,E=225,y=12,x=120-y/2,M=e.createLinearGradient(x,h,x+y,h);M.addColorStop(0,"rgba(229, 231, 235, 0.4)"),M.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),M.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),M.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=M,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(x,h,y,E-h,[0,0,3,3]),e.fill(),e.stroke();const H=7,_=e.createRadialGradient(120-H*.2,245-H*.2,H*.1,120,245,H);_.addColorStop(0,"#6b7280"),_.addColorStop(.7,"#1f2937"),_.addColorStop(1,"#09090b"),e.fillStyle=_,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,H,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const N=245,X=40,R=135,V=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(N,X,R,V,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(N+10,X+12,R-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(r.currentThermistorR.toFixed(2)+" kΩ",N+R-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",N+14,X+21),r.showLabels&&(ee(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),ee(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function L(e,c,p,b,h,E,y,x,M){const{gx:H,gy:_,gw:N,gh:X}=c;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,b),e.lineTo(p,_+X),e.stroke(),e.beginPath(),e.moveTo(p,b),e.lineTo(H,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const R=`${h.toFixed(1)}${y}`,V=e.measureText(R).width+10;e.fillStyle=M,e.beginPath(),e.roundRect(p-V/2,_+X+2,V,15,3),e.fill(),e.fillStyle="#000",e.fillText(R,p,_+X+4),e.textAlign="right",e.textBaseline="middle";const K=`${E.toFixed(2)} ${x}`,ie=e.measureText(K).width+10;e.fillStyle=M,e.beginPath(),e.roundRect(H-ie-2,b-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(K,H-7,b)}function k(e){const c=q(),{minL:p,maxL:b}=u(),{minT:h,maxT:E,tickStep:y}=W(),x=g(p,b),M=$(e,c,h,E,y,x),{gx:H,gy:_,gw:N,gh:X,axisFont:R,yLabelX:V,xLabelY:K,dotR:ie}={...c,...M};e.save(),e.translate(V,_+X/2),e.rotate(-Math.PI/2),e.font=R,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=R,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",H+N/2,K);const qe=E,ye=m(0,h,E,H,N),me=S(f(0),p,b,_,X),ue=m(qe,h,E,H,N),ce=S(f(qe),p,b,_,X);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(ye,me),e.lineTo(ue,ce),e.stroke();const fe=r.thermometerTemp,ge=r.currentLength;if(fe>=h&&fe<=E){const ke=m(fe,h,E,H,N),Re=S(ge,p,b,_,X);L(e,c,ke,Re,fe,ge,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ke,Re,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function G(e){const c=q(),{minR:p,maxR:b,ticks:h}=w(),E=W(),y=$(e,c,E.minT,E.maxT,E.tickStep,h),{gx:x,gy:M,gw:H,gh:_,axisFont:N,yLabelX:X,xLabelY:R,dotR:V}={...c,...y};e.save(),e.translate(X,M+_/2),e.rotate(-Math.PI/2),e.font=N,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=N,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+H/2,R);const{minT:K,maxT:ie}=E,qe=ie,ye=m(0,K,ie,x,H),me=S(v(0),p,b,M,_),ue=m(qe,K,ie,x,H),ce=S(v(qe),p,b,M,_);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(ye,me),e.lineTo(ue,ce),e.stroke();const fe=r.thermometerTemp,ge=r.currentResistance;if(fe>=K&&fe<=ie){const ke=m(fe,K,ie,x,H),Re=S(ge,p,b,M,_);L(e,c,ke,Re,fe,ge,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ke,Re,V,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function J(e){const c=q(),p=W(),{minR:b,maxR:h,ticks:E}=T(p),y=$(e,c,p.minT,p.maxT,p.tickStep,E),{gx:x,gy:M,gw:H,gh:_,axisFont:N,yLabelX:X,xLabelY:R,dotR:V}={...c,...y},{minT:K,maxT:ie}=p;e.save(),e.translate(X,M+_/2),e.rotate(-Math.PI/2),e.font=N,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=N,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+H/2,R),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let qe=!1;for(let ue=K;ue<=ie;ue+=1){const ce=ue+273.15,fe=r.thermistorR25*Math.exp(r.thermistorBeta*(1/ce-1/298.15)),ge=m(ue,K,ie,x,H),ke=S(Math.min(h,fe),b,h,M,_);ke>=M&&ke<=M+_&&(qe?e.lineTo(ge,ke):(e.moveTo(ge,ke),qe=!0))}e.stroke();const ye=r.thermometerTemp,me=r.currentThermistorR;if(ye>=K&&ye<=ie){const ue=m(ye,K,ie,x,H),ce=S(Math.min(h,me),b,h,M,_);L(e,c,ue,ce,ye,me,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(ue,ce,V,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ae(){B.clearRect(0,0,l,P),O.clearRect(0,0,A,I),B.save(),B.translate(F,0),ne(B),r.thermometerType==="liquid"?oe(B):r.thermometerType==="resistance"?be(B):z(B),B.restore(),r.thermometerType==="liquid"?k(O):r.thermometerType==="resistance"?G(O):J(O)}function we(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const E=a.querySelector("#tl-svg-formula-thermistor-sub");if(E){const y=r.thermometerTemp+273.15;E.innerHTML=`
      ...
      `}}function se(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:c,cu:p,interval:b}=xe(),h=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,E=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,y=a.querySelector("#tl-pane-q10a").classList.contains("active"),x=y?(h-c)/b*100:E,M=y?h:E/100*b+c,_=(N=>130-N/100*80)(x);e.innerHTML=`
    ...
    `}function he(e){a.querySelector("#tl-bath-temp-display").innerHTML=r.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=r.bathTemp.toFixed(1)+" °C";const c=a.querySelector("#tl-bath-state");r.bathTemp<=0?c.textContent="Melting Ice Bath":r.bathTemp>=100?c.textContent="Boiling Water/Steam":r.bathTemp===150?c.textContent="Hot Cooking Oil":c.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=a.querySelector("#tl-alcohol-boiling-warning");r.thermometerType==="liquid"&&r.liquidType==="alcohol"&&r.bathTemp>=78?p.style.display="block":p.style.display="none",r.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=r.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):r.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=r.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=r.currentThermistorR.toFixed(2)+" kΩ",we()}let ve=null;function Ce(e){r.lastTimestamp||(r.lastTimestamp=e);const c=(e-r.lastTimestamp)/1e3;r.lastTimestamp=e;const p=Math.min(c,.1),b=le(),h=p/b*(r.bathTemp-r.thermometerTemp);r.thermometerTemp+=h,r.currentLength=r.liquidL0+(r.liquidL100-r.liquidL0)/100*r.thermometerTemp,r.currentResistance=r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*r.thermometerTemp;const E=r.thermometerTemp+273.15;r.currentThermistorR=r.thermistorR25*Math.exp(r.thermistorBeta*(1/E-1/298.15)),te(),ae(),he(b),ve=requestAnimationFrame(Ce)}function xe(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),c=parseFloat(a.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,b=Number.isFinite(c)?c:105,h=b-p;return{cf:p,cu:b,interval:h}}function ze(e){const c=Math.round(e*100)/100;return c>=0?c.toFixed(1):`(${c.toFixed(1)})`}function Se(){const{cf:e,cu:c,interval:p}=xe(),b=a.querySelector("#tl-val-faulty-interval"),h=a.querySelector("#tl-faulty-error-a"),E=a.querySelector("#tl-faulty-error-b"),y=Math.abs(p)<.01;b.textContent=p.toFixed(1)+" °C";const x=a.querySelector("#tl-svg-formula-faulty-a"),M=a.querySelector("#tl-svg-formula-faulty-b");if(y){h.hidden=!1,h.textContent="C_u must differ from C_f (interval cannot be zero).",E.hidden=!1,E.textContent=h.textContent,x&&(x.innerHTML=""),M&&(M.innerHTML="");return}h.hidden=!0,E.hidden=!0;const H=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,_=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,N=(H-e)/p*100,X=_/100*p+e;x&&(x.innerHTML=`
      ...
      `),se()}function Ee(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,c=(e-r.resistanceR0)/(r.resistanceR100-r.resistanceR0)*100,p=a.querySelector("#tl-svg-formula-resistance-solver");p&&(p.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      <section class="panel">
        ...
        <div class="grid cols-2" data-summary-grid>
      ...
      </section>`}async function S(){const u=je();for(const f of Me){const w=t.querySelector(`[data-summary-card="${f.id}"]`);if(!w)continue;const v=w.querySelector("[data-summary-body]");if(f.id==="thermometer"){const j=await Fe("summary","thermometer.webp"),O="./summary/thermometer.webp";j?v.innerHTML=`
          <img class="summary-thumb" src="${O}" alt="${d("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${O}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="heatInternalEnergy"){const j=u==="zhHant"?"heat-internal-energy-zhHant.webp":"heat-internal-energy-en.webp",O=await Fe("summary",j),D=`./summary/${j}`;O?v.innerHTML=`
          <img class="summary-thumb" src="${D}" alt="${d("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${D}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="changeOfState"){const j=await Fe("summary","change-of-state.webp"),O="./summary/change-of-state.webp";j?v.innerHTML=`
          <img class="summary-thumb" src="${O}" alt="${d("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${O}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="heatTransfer"){const j=await Fe("summary","heat-transfer.webp"),O="./summary/heat-transfer.webp";j?v.innerHTML=`
          ...
          <p style="margin-top:8px"><a href="${B}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const $=()=>F(),g=u=>I(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",g),F(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",g),r==null||r(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const gt={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Wt();Ot();const vt="s3phy_splash_seen",_t={optics:ya,heat:Ma};let He=null,_e=null;function Ha(){const t=location.hash.match(/^#\/(\w+)/),n=t==null?void 0:t[1];return n&&Object.prototype.hasOwnProperty.call(_t,n)?n:null}function _a(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function Ft(t){He==null||He(),He=null,_e==null||_e(),_e=null;const n=document.getElementById("app");if(!n)return;if(n.innerHTML="",!t){location.hash&&_a(),_e=Bt(n);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}He=_t[t](n)??null}function Et(){Ft(Ha())}function Fa(){return"./images/uniplus-logo.png"}function Ea(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
