(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const u of document.querySelectorAll('link[rel="modulepreload"]'))n(u);new MutationObserver(u=>{for(const r of u)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(u){const r={};return u.integrity&&(r.integrity=u.integrity),u.referrerPolicy&&(r.referrerPolicy=u.referrerPolicy),u.crossOrigin==="use-credentials"?r.credentials="include":u.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(u){if(u.ep)return;u.ep=!0;const r=s(u);fetch(u.href,r)}})();const Ee={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Flip cards to revise key terms. Reflection, Refraction, TIR, EM waves, Convex lens, and Concave lens use picture cards from your flashcard sets.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.shuffle":"Shuffle","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF or image). Preview below or open in a new tab.","summary.viewImage":"Open full image","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","flashcards.deck.heatInternalEnergy":"Heat and internal energy","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.specificHeat.title":"Specific Heat Capacity Lab","tools.thermalMixing.title":"Thermal Mixing Lab","tools.changeOfState.title":"Change of State Lab","tools.heatTransfer.title":"Heat Transfer Laboratory","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","tools.thermometerLab.liquid.title":"Liquid-in-Glass Thermometer","tools.thermometerLab.liquid.subtitle":"Explore the effects of bulb volume, capillary bore, and liquid type on sensitivity and response time.","tools.thermometerLab.resistance.title":"Platinum Resistance Thermometer","tools.thermometerLab.resistance.subtitle":"Investigate how platinum resistance varies linearly with temperature and solve calibration problems.","tools.thermometerLab.thermistor.title":"NTC Thermistor","tools.thermometerLab.thermistor.subtitle":"Study the non-linear resistance-temperature relationship of NTC thermistors and live beta calculations.","tools.thermometerLab.labels.show":"Show Structure Labels","tools.thermometerLab.labels.hide":"Hide Structure Labels","tools.thermometerLab.labels.thinWall":"Thin glass wall (fast heat transfer)","tools.thermometerLab.labels.largeBulb":"Large bulb (contains more liquid, increases sensitivity)","tools.thermometerLab.labels.narrowBore":"Narrow capillary bore (liquid rises higher, increases sensitivity)","tools.thermometerLab.labels.meniscus":"Meniscus (reading point)","tools.thermometerLab.labels.platinumCoil":"Platinum coil (resistance increases linearly with temp)","tools.thermometerLab.labels.metalSheath":"Metal sheath (protects & conducts heat quickly)","tools.thermometerLab.labels.semiconductorBead":"Semiconductor bead (resistance decreases exponentially with temp)","tools.thermometerLab.labels.leads":"Connecting leads","tools.thermometerLab.faulty.dualScale":"Dual-Scale Comparison Diagram","tools.thermometerLab.faulty.trueScale":"True Scale (°C)","tools.thermometerLab.faulty.faultyScale":"Faulty Scale (°C)","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},vt={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"翻卡複習重要詞彙。反射、折射、全內反射、電磁波、凸透鏡與凹透鏡課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.shuffle":"洗牌","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF 或圖片）。可於下方預覽，或新分頁開啟。","summary.viewImage":"開啟完整圖片","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","flashcards.deck.heatInternalEnergy":"熱與內能","tools.thermometerLab.title":"溫度計與校準實驗室","tools.specificHeat.title":"比熱容量實驗室","tools.thermalMixing.title":"熱混合實驗室","tools.changeOfState.title":"物態變化實驗室","tools.heatTransfer.title":"熱的轉移實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","tools.thermometerLab.liquid.title":"液體玻璃溫度計","tools.thermometerLab.liquid.subtitle":"探索玻璃泡容積、毛細管內外徑和液體種類對靉敏度及反應時間的影響。","tools.thermometerLab.resistance.title":"鈐電阻溫度計","tools.thermometerLab.resistance.subtitle":"研究鈐電阻如何隨溫度呈線性變化，並解決溫度校準問題。","tools.thermometerLab.thermistor.title":"NTC 熱敏電阻溫度計","tools.thermometerLab.thermistor.subtitle":"學習負溫度係數（NTC）熱敏電阻的非線性電阻-溫度關係，並進行實時 Beta 計算。","tools.thermometerLab.labels.show":"顯示結構標註","tools.thermometerLab.labels.hide":"隱藏結構標註","tools.thermometerLab.labels.thinWall":"薄玻璃壁 (快速傳熱)","tools.thermometerLab.labels.largeBulb":"大玻璃泡 (容納更多液體，提高靉敏度)","tools.thermometerLab.labels.narrowBore":"細毛細管 (液柱升得更高，提高靉敏度)","tools.thermometerLab.labels.meniscus":"彎月面 (讀數位置)","tools.thermometerLab.labels.platinumCoil":"鈐絲線圈 (電阻隨溫度線性增加)","tools.thermometerLab.labels.metalSheath":"金屬保護套 (保護並快速導熱)","tools.thermometerLab.labels.semiconductorBead":"半導體小珠 (電阻隨溫度指數級減少)","tools.thermometerLab.labels.leads":"連接導線","tools.thermometerLab.faulty.dualScale":"雙刻度對比示意圖","tools.thermometerLab.faulty.trueScale":"標準溫標 (°C)","tools.thermometerLab.faulty.faultyScale":"偏差溫標 (°C)","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},ot="s3phy.lang",st={en:Ee,"zh-Hant":vt};let Ie="en";function yt(){try{const t=localStorage.getItem(ot);if(t==="zh-Hant"||t==="en")return t}catch{}return"en"}function wt(){Ie=yt()}function lt(t){if(st[t]){Ie=t;try{localStorage.setItem(ot,t)}catch{}document.documentElement.lang=t==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function ce(){return Ie}function d(t){const i=st[Ie]||Ee;return Object.prototype.hasOwnProperty.call(i,t)?i[t]:Object.prototype.hasOwnProperty.call(Ee,t)?Ee[t]:t}const xt=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function kt(t){function i(){t.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${xt.map(({id:u,titleKey:r,descKey:a})=>`
            <div class="card">
              <h3>${d(r)}</h3>
              <p>${d(a)}</p>
...
`;function St(){if(document.getElementById(Ke))return;const t=document.createElement("style");t.id=Ke,t.textContent=qt,document.head.appendChild(t)}function Ct(t){St();const i=document.createElement("div");i.className="rml",i.innerHTML=`
    <div class="rml-head">
  ...
  `;const s=i.querySelector(".rml-canvas"),n=s.getContext("2d"),u=i.querySelector("[data-rml-rot]"),r=i.querySelector("[data-rml-inc]"),a=i.querySelector('[data-rml-disp="rot"]'),w=i.querySelector('[data-rml-disp="inc"]'),A=i.querySelector('[data-rml-val="i"]'),J=i.querySelector('[data-rml-val="r"]'),W=i.querySelector('[data-rml-val="shift"]'),F=350,O=380,X=300,M="#22d3ee",z="bold 17px system-ui, sans-serif";let E=0,B=-140,te=!0,Y=!0,ee=!0,ae=!0;function N(P){return P*Math.PI/180}function V(P,l,o,f,q,R=2,_=!1){n.beginPath(),n.lineWidth=R,n.strokeStyle=q,n.setLineDash(_?[6,6]:[]);const b=P+Math.cos(N(o))*f,v=l+Math.sin(N(o))*f;return n.moveTo(P,l),n.lineTo(b,v),n.stroke(),n.setLineDash([]),{x:b,y:v}}function Z(P,l,o,f,q,R=14){const _=o-P,b=f-l,v=Math.hypot(_,b);if(v<1e-6)return;const H=_/v,L=b/v,G=o-H*R,$=f-L*R,de=.45*R;n.beginPath(),n.fillStyle=q,n.moveTo(o,f),n.lineTo(G-L*de,$+H*de),n.lineTo(G+L*de,$-H*de),n.closePath(),n.fill()}function K(P,l,o,f,q,R=25){n.beginPath(),n.strokeStyle=f,n.lineWidth=2;const _=Math.min(P,l),b=Math.max(P,l);if(n.arc(F,O,o,N(_),N(b),!1),n.stroke(),q){const v=(_+b)/2,H=F+Math.cos(N(v))*(o+R),L=O+Math.sin(N(v))*(o+R);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="center",n.textBaseline="middle",n.fillStyle=f,n.fillText(q,H,L),n.restore()}}function ne(P,l,o,f,q){n.clearRect(0,0,s.width,s.height),n.beginPath(),n.setLineDash([10,6]),n.strokeStyle="rgba(255, 204, 0, 0.45)",n.lineWidth=3,n.lineCap="round",n.moveTo(F-200,O),n.lineTo(F+200,O),n.stroke(),n.setLineDash([]),n.lineCap="butt";const R=F+Math.cos(N(P))*X,_=O+Math.sin(N(P))*X;n.beginPath(),n.lineWidth=3,n.strokeStyle="#fff",n.moveTo(R,_),n.lineTo(F,O),n.stroke();const b=(R+F)*.5,v=(_+O)*.5,H=Math.hypot(F-R,O-_)||1,L=(F-R)/H,G=(O-_)/H;if(Z(b-L*28,v-G*28,b,v,"#fff",16),n.save(),n.font=z,n.textAlign="center",n.textBaseline="bottom",n.fillStyle="#fff",n.fillText(t("tools.rotatingMirror.canvas.incident"),R,_-12),n.restore(),te){const $=V(F,O,-90,X-60,"#00e676",1,!0);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="left",n.textBaseline="bottom",n.fillStyle="#00e676",n.fillText(t("tools.rotatingMirror.canvas.n"),$.x+6,$.y-4),n.restore()}if(Y){const $=V(F,O,f,X,"#00e676",2,!1);Z(F,O,$.x,$.y,"#00e676",16),n.save(),n.font=z,n.textAlign="center",n.textBaseline="bottom",n.fillStyle="#00e676",n.fillText(t("tools.rotatingMirror.canvas.originalReflected"),$.x,$.y-14),n.restore()}n.save(),n.translate(F,O),n.rotate(N(E)),n.beginPath(),n.lineWidth=6,n.strokeStyle="#ffcc00",n.lineCap="round",n.moveTo(-200,0),n.lineTo(200,0),n.stroke(),n.beginPath(),n.lineWidth=1,n.strokeStyle="#666";for(let $=-190;$<200;$+=15)n.moveTo($,0),n.lineTo($-5,8);if(n.stroke(),n.restore(),ee){const $=V(F,O,l,X-40,M,2,!0);n.save(),n.font="bold 14px system-ui, sans-serif",n.textAlign="left",n.textBaseline="bottom",n.fillStyle=M,n.fillText(t("tools.rotatingMirror.canvas.nPrime"),$.x+6,$.y-4),n.restore()}if(ae){const $=V(F,O,o,X,M,4);Z(F,O,$.x,$.y,M,16),Math.abs(E)>.5&&(n.save(),n.font=z,n.textAlign="center",n.textBaseline="bottom",n.fillStyle=M,n.fillText(t("tools.rotatingMirror.canvas.newReflected"),$.x,$.y-14),n.restore())}if(ee&&K(P,l,100,"#ffcc00",`i=${q.toFixed(0)}°`,25),ee&&ae&&K(l,o,100,M,`r=${q.toFixed(0)}°`,25),te&&ee&&Math.abs(E)>.5&&K(-90,l,50,"#ffcc00",`θ=${Math.abs(E)}°`,20),Y&&ae&&Math.abs(E)>.5){const $=o-f;K(f,o,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${$.toFixed(0)}°`,40)}}function U(){E=parseFloat(u.value),B=parseFloat(r.value);const P=E>0?"+":"";a.textContent=`${P}${E}°`,w.textContent=`${B}°`;const l=-90,o=Math.abs(B-l),f=l+o,q=-90+E,R=Math.abs(B-q),_=q+R,b=_-f;A.textContent=`${R.toFixed(1)}°`,J.textContent=`${R.toFixed(1)}°`;const v=b>0?"+":"";W.textContent=`${v}${b.toFixed(1)}°`,ne(B,q,_,f,R)}return i.querySelectorAll("[data-rml-toggle]").forEach(P=>{P.addEventListener("click",()=>{const l=P.getAttribute("data-rml-toggle");l==="orig-norm"&&(te=!te),l==="orig-ray"&&(Y=!Y),l==="new-norm"&&(ee=!ee),l==="new-ray"&&(ae=!ae),P.classList.toggle("active"),U()})}),i.querySelector("[data-rml-reset]").addEventListener("click",()=>{u.value="0",U()}),u.addEventListener("input",U),r.addEventListener("input",U),U(),i}function Tt(t){const i=document.createElement("div");i.className="tool-tir-escape";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:`${n}/`;return s.src=`${u}tir-escape/index.html?embed=1`,s.title=t("tools.refractionTir.title"),s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin",i.appendChild(s),i}function Lt(t,i={}){const s=i.defaultKind==="concave"?"concave":"convex",n="tools.lens.title",u=document.createElement("div");u.className="tool-lens-simulator";const r=document.createElement("iframe"),a="./",w=a.endsWith("/")?a:`${a}/`;return r.src=`${w}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(s)}`,r.title=t(n),r.setAttribute("loading","lazy"),r.referrerPolicy="strict-origin-when-cross-origin",u.appendChild(r),u}function Rt(t){const i=document.createElement("div");i.className="tool-em-spectrum";const s=document.createElement("iframe"),n="./",u=n.endsWith("/")?n:`${n}/`;function r(){return`${u}em-spectrum/index.html?lang=${encodeURIComponent(ce())}`}s.src=r(),s.title=t("tools.em.title"),s.setAttribute("loading","lazy"),s.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var w;try{(w=s.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{s.src=r()}};return window.addEventListener("s3phy:lang",a),i._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(s),i}function Mt(t){const i=document.createElement("div");i.className="rgb-mixer",i.innerHTML=`
  ...
  `;const s=i.querySelector("[data-r]"),n=i.querySelector("[data-g]"),u=i.querySelector("[data-b]"),r=i.querySelector(".rgb-mixer-canvas"),a=i.querySelector(".rgb-mixer-stage"),w=r.getContext("2d");function A(M){return M.toString(16).padStart(2,"0")}function J(M,z,E){const B=r.width/(window.devicePixelRatio||1),te=r.height/(window.devicePixelRatio||1),Y=B/2,ee=te/2,ae=Math.min(B,te)*.34,N=ae*.5,V=Math.sqrt(3)/2;w.clearRect(0,0,B,te),w.fillStyle="#000",w.fillRect(0,0,B,te);const Z=[{x:Y,y:ee-N,rgb:[255,0,0],val:M},{x:Y-N*V,y:ee+N*.5,rgb:[0,255,0],val:z},{x:Y+N*V,y:ee+N*.5,rgb:[0,0,255],val:E}];w.globalCompositeOperation="lighter",Z.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[U,P,l]=K.rgb,o=w.createRadialGradient(K.x,K.y,0,K.x,K.y,ae);o.addColorStop(0,`rgba(${U},${P},${l},${ne})`),o.addColorStop(.65,`rgba(${U},${P},${l},${ne})`),o.addColorStop(.85,`rgba(${U},${P},${l},${ne*.5})`),o.addColorStop(1,`rgba(${U},${P},${l},0)`),w.fillStyle=o,w.beginPath(),w.arc(K.x,K.y,ae,0,Math.PI*2),w.fill()}),w.globalCompositeOperation="source-over"}function W(){const M=a.getBoundingClientRect(),z=Math.max(200,Math.min(M.width-8,M.height-8,720)),E=window.devicePixelRatio||1;r.width=z*E,r.height=z*E,r.style.width=`${z}px`,r.style.height=`${z}px`,w.setTransform(E,0,0,E,0,0),J(+s.value,+n.value,+u.value)}function F(){const M=+s.value,z=+n.value,E=+u.value,B=`rgb(${M}, ${z}, ${E})`,te=`#${A(M)}${A(z)}${A(E)}`;i.querySelector("[data-r-val]").textContent=M,i.querySelector("[data-g-val]").textContent=z,i.querySelector("[data-b-val]").textContent=E,i.querySelector("[data-r-bar]").style.width=`${M/255*100}%`,i.querySelector("[data-g-bar]").style.width=`${z/255*100}%`,i.querySelector("[data-b-bar]").style.width=`${E/255*100}%`,s.style.setProperty("--fill",`${M/255*100}%`),n.style.setProperty("--fill",`${z/255*100}%`),u.style.setProperty("--fill",`${E/255*100}%`);const Y=i.querySelector("[data-swatch]");Y.style.backgroundColor=B,Y.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${B}`),i.querySelector("[data-rgb-text]").textContent=B,i.querySelector("[data-hex-text]").textContent=te,J(M,z,E)}function O(M,z,E){s.value=M,n.value=z,u.value=E,F()}return[s,n,u].forEach(M=>M.addEventListener("input",F)),i.querySelectorAll(".rgb-presets button").forEach(M=>{M.addEventListener("click",()=>{O(+M.dataset.r,+M.dataset.g,+M.dataset.b)})}),new ResizeObserver(()=>W()).observe(a),requestAnimationFrame(()=>{W(),F()}),i}const _t=["topics","notes","tools","worksheets","flashcards","summary"],Ht={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function ut(t,{subtitleKey:i,activeSection:s,onSection:n,onLang:u}){t.innerHTML=`
  ...
  `;const r=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),w=t.querySelector("[data-lang]"),A=t.querySelector("[data-strand-back]");let J=s;function W(M){J=M,a.innerHTML=_t.map(z=>`<button type="button" class="${M===z?"active":""}" data-sec="${z}">${d(Ht[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>n(z.getAttribute("data-sec")))})}function F(){w.innerHTML=`
      <button type="button" data-set-lang="en" class="${ce()==="en"?"active":""}">${d("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${ce()==="zh-Hant"?"active":""}">${d("lang.zhHant")}</button>
    `,w.querySelectorAll("button").forEach(M=>{M.addEventListener("click",()=>{lt(M.getAttribute("data-set-lang")),u()})})}function O(){t.querySelector("[data-hub-subtitle]").textContent=d(i),A.textContent=d("strand.back"),t.querySelector("[data-hub-footer]").textContent=d("footer.conventions"),t.querySelector(".site-title").textContent=d("app.title")}const X=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return A.addEventListener("click",X),W(s),F(),{main:r,updateSection(M){W(M)},refreshLabels(){O(),W(J),F()},destroy(){A.removeEventListener("click",X)}}}const We=["A","B","C","D"];function Xe(t){const i=t.slice();for(let s=i.length-1;s>0;s-=1){const n=Math.floor(Math.random()*(s+1));[i[s],i[n]]=[i[n],i[s]]}return i}function zt(t,i,s){return t.filter(n=>{if(s)return s(n,i);const u=n.topic;return!!(i.includes(u)||i.includes("rotatingMirror")&&u==="reflection"||i.includes("refraction")&&u==="refraction"||i.includes("tir")&&u==="tir"||u==="convex"&&i.includes("convex")||u==="concave"&&i.includes("concave"))})}function Ft(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ft(t,i={}){const s=i.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],n=i.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
    ...
    </section>`}function pt(t,i,s,n,u={}){var f,q,R,_;const r={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),w=t.querySelector("[data-ws-preview-area]"),A=t.querySelector("[data-ws-out]"),J=t.querySelector("[data-ws-body]"),W=t.querySelector("[data-ws-paper]"),F=t.querySelector("[data-ws-tabs]"),O=t.querySelector("[data-ws-practice-actions]"),X=t.querySelector("[data-ws-score]"),M=t.querySelector("[data-ws-score-val]"),z=t.querySelector("[data-ws-summary]"),E=t.querySelector("[data-ws-date-row]"),B=t.querySelector("[data-ws-date-print]"),te=t.querySelector("[data-ws-date-today]"),Y=t.querySelector("[data-ws-date-label]");if(!a||!J)return;function ee(){return n()}function ae(){r.userAnswers={},r.wrongAttempts={},r.resolved={},X.hidden=!0,z.hidden=!0}function N(){return r.items.length>0&&r.items.every((b,v)=>r.resolved[v])}function V(){let b=0;r.items.forEach((H,L)=>{if(!r.resolved[L])return;const G=H[ee()]||H.en;r.userAnswers[L]===G.a&&(b+=1)}),Object.keys(r.resolved).length>0&&(M.textContent=`${b}/${r.items.length}`,X.hidden=!1)}function Z(b){r.tab=b,F==null||F.querySelectorAll("[data-ws-tab]").forEach(v=>{v.classList.toggle("active",v.getAttribute("data-ws-tab")===b)}),O&&(O.hidden=b!=="practice"),E&&(E.hidden=b!=="practice"),B&&(B.hidden=!r.dateStr,B.textContent=r.dateStr?`${s("worksheets.date")}: ${r.dateStr}`:""),W==null||W.classList.toggle("practice-mode",b==="practice"),ne()}function K(b,v,H){const L=b[ee()]||b.en,G=We,$=v+1,de=b.section?`<span class="q-section">${xe(b.section)}</span>`:"";if(H==="answer"){const me=L.choices.map((ye,Ce)=>`<li class="${Ce===L.a?"choice-correct":""}"><strong>${G[Ce]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${$} ${de}</h4>
        <p>${xe(L.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${s("worksheets.answer")}:</strong> ${G[L.a]}</p>
        <p class="q-exp"><em>${xe(L.exp)}</em></p>
      </div>`}const se=r.userAnswers[v],pe=r.wrongAttempts[v]||0,ge=r.resolved[v],Se=ge&&se===L.a,ke=ge&&se!==L.a;let qe="";pe===1&&!ge?qe=`<p class="q-hint"><strong>${s("worksheets.hint")}:</strong> ${xe(L.hint||L.exp)}</p>`:ke&&(qe=`<p class="q-exp"><strong>${s("worksheets.answer")}:</strong> ${G[L.a]}</p>
        <p class="q-exp q-summary"><em>${xe(L.exp)}</em></p>`);const _e=Se?"correct":ke?"incorrect":"",He=L.choices.map((me,ye)=>`<li>
      ...
      ${qe}
    </div>`}function ne(){r.items.length&&(J.innerHTML=r.items.map((b,v)=>K(b,v,r.tab)).join(""),U())}function U(){r.tab==="practice"&&J.querySelectorAll("[data-ws-choice]").forEach(b=>{b.addEventListener("change",()=>{const v=Number(b.getAttribute("data-ws-q"));if(r.resolved[v])return;const H=Number(b.getAttribute("data-ws-choice")),L=r.items[v][ee()]||r.items[v].en;r.userAnswers[v]=H,H===L.a?r.resolved[v]=!0:(r.wrongAttempts[v]=(r.wrongAttempts[v]||0)+1,r.wrongAttempts[v]>=2&&(r.resolved[v]=!0)),V(),N()&&P(),ne()})})}function P(){const b=r.items.length;let v=0,H=0;const L={};r.items.forEach((se,pe)=>{const ge=se[ee()]||se.en;if(r.userAnswers[pe]===ge.a)v+=1,(r.wrongAttempts[pe]||0)===0&&(H+=1);else if(r.resolved[pe]){const ke=se.section||se.topic;L[ke]=(L[ke]||0)+1}});const G=b?Math.round(v/b*100):0;let $=s("worksheets.revisionFair");G>=90?$=s("worksheets.revisionExcellent"):G>=70?$=s("worksheets.revisionGood"):G<50&&($=s("worksheets.revisionLow"));const de=Object.entries(L).sort((se,pe)=>pe[1]-se[1]).map(([se,pe])=>`<li>${xe(se)} (${pe})</li>`).join("");z.innerHTML=`
      <h4>${s("worksheets.sessionSummary")}</h4>
      <p>${s("worksheets.score")}: <strong>${v}/${b}</strong> (${G}%)</p>
      <p>${s("worksheets.firstTry")}: <strong>${H}/${b}</strong></p>
      <p>${s("worksheets.revisionSuggestions")}: ${$}</p>
      ${de?`<p>${s("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,z.hidden=!1}function l(b){const v=ee(),H=r.items.map((L,G)=>{const $=L[v]||L.en,de=$.choices.map((pe,ge)=>`${We[ge]}. ${pe}`).join("<br/>"),se=b?`<p><b>${s("worksheets.answer")}:</b> ${We[$.a]}<br/><i>${$.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${G+1}.</b> ${$.q}<br/>${de}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${H}</body></html>`}function o(b){const v=l(b),H=new Blob(["\uFEFF",v],{type:"application/msword"}),L=document.createElement("a");L.href=URL.createObjectURL(H),L.download=b?"worksheet-answers.doc":"worksheet.doc",L.click(),URL.revokeObjectURL(L.href)}a.addEventListener("click",()=>{const b=Number(t.querySelector("[data-ws-count]").value),v=[...t.querySelectorAll("[data-ws-topic]")].filter(G=>G.checked).map(G=>G.getAttribute("data-ws-topic")),H=zt(i,v,u.topicFilter),L=Xe(H).slice(0,Math.min(b,H.length||1));r.items=L.length?L:Xe(i).slice(0,Math.min(b,i.length)),ae(),r.tab="practice",r.dateStr="",w.hidden=!1,A.hidden=!0,F==null||F.querySelectorAll("[data-ws-tab]").forEach(G=>{G.classList.toggle("active",G.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),E&&(E.hidden=!1),B&&(B.hidden=!0),Y.textContent="",W==null||W.classList.add("practice-mode"),ne()}),F==null||F.addEventListener("click",b=>{const v=b.target.closest("[data-ws-tab]");!v||!r.items.length||Z(v.getAttribute("data-ws-tab"))}),te==null||te.addEventListener("click",()=>{r.dateStr?(r.dateStr="",Y.textContent=""):(r.dateStr=Ft(),Y.textContent=`${s("worksheets.date")}: ${r.dateStr}`),B&&(B.hidden=!r.dateStr,B.textContent=r.dateStr?`${s("worksheets.date")}: ${r.dateStr}`:"")}),(f=t.querySelector("[data-ws-word-p]"))==null||f.addEventListener("click",()=>o(!1)),(q=t.querySelector("[data-ws-word-a]"))==null||q.addEventListener("click",()=>o(!0)),(R=t.querySelector("[data-ws-print-p]"))==null||R.addEventListener("click",()=>{Z("practice"),W==null||W.classList.add("ws-print-blank");const b=()=>W==null?void 0:W.classList.remove("ws-print-blank");window.addEventListener("afterprint",b,{once:!0}),window.print()}),(_=t.querySelector("[data-ws-print-a]"))==null||_.addEventListener("click",()=>{Z("answer"),window.print()})}const $t=["rotatingMirror","refractionTir","lens","rgbMixer","em"],At={rotatingMirror:t=>Ct(t),refractionTir:t=>Tt(t),lens:(t,i)=>Lt(t,{defaultKind:i}),rgbMixer:t=>Mt(t),em:t=>Rt(t)};function Et(t){return d({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function $e(){return ce()==="zh-Hant"?"zhHant":"en"}async function Oe(t,i){const s=`./${t}/${i}`;try{return(await fetch(s,{method:"HEAD"})).ok}catch{return!1}}async function It(t){return Oe("notes",t)}function Wt(t){let i="topics",s="rotatingMirror",n="convex",u=0,r="all",a=!1,w=null,A={main:null};function J(){A.main&&(i==="topics"?A.main.innerHTML=F():i==="notes"?A.main.innerHTML=X():i==="tools"?A.main.innerHTML=z():i==="worksheets"?A.main.innerHTML=ft(d):i==="flashcards"?A.main.innerHTML=te():i==="summary"&&(A.main.innerHTML=K()),i==="notes"&&M(),i==="tools"&&E(),i==="worksheets"&&pt(t,ct,d,$e),i==="flashcards"&&Z(),i==="summary"&&ne())}function W(){w==null||w.destroy(),w=ut(t,{subtitleKey:"strand.optics.subtitle",activeSection:i,onSection:l=>{i=l,w.updateSection(i),J()},onLang:()=>W()}),A.main=w.main,w.updateSection(i),J()}function F(){const l=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${d("topics.title")}</h2>
        <p class="lead">${d("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${l.map(([o,f])=>{const q=o==="convex"||o==="concave"?"lens":o==="refraction"||o==="tir"?"refractionTir":o==="em"?"em":o,R=o==="convex"?"convex":o==="concave"?"concave":"";return`
            <div class="card">
              <h3>${d(f)}</h3>
              <button class="btn primary" type="button" data-go-tool="${q}"${R?` data-lens-kind="${R}"`:""}>${d("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function O(l){const o=l.target.closest("[data-go-tool]");if(!o)return;i="tools",s=o.getAttribute("data-go-tool");const f=o.getAttribute("data-lens-kind");(f==="convex"||f==="concave")&&(n=f),w.updateSection(i),J()}function X(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${d("notes.title")}</h2>
        <p class="lead">${d("notes.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${l.map(o=>{const f=d(`notes.card.${o.key}`);return`
            <div class="card" data-note-card="${o.key}">
              <h3>${f}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function M(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],o=$e();for(const f of l){const q=t.querySelector(`[data-note-card="${f.key}"]`);if(!q)continue;const R=q.querySelector("[data-note-body]"),_=o==="zhHant"?f.fileZh:f.fileEn,b=await It(_),v=`./notes/${_}`;b?R.innerHTML=`
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${$t.map(l=>`<button type="button" data-tool="${l}" class="${s===l?"active":""}">${Et(l)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function E(){const l=t.querySelector("[data-tool-list]"),o=t.querySelector("[data-tool-stage]");!l||!o||(l.querySelectorAll("button").forEach(f=>{f.addEventListener("click",()=>{s=f.getAttribute("data-tool"),l.querySelectorAll("button").forEach(q=>q.classList.toggle("active",q.getAttribute("data-tool")===s)),B(o)})}),B(o))}function B(l){l.innerHTML="";const o=At[s];if(!o)return;const f=s==="lens"?o(d,n):o(d);l.appendChild(f)}function te(){return`
      <section class="panel">
...
`;function Dt(){if(document.getElementById(et))return;const t=document.createElement("style");t.id=et,t.textContent=Pt,document.head.appendChild(t)}function Pe(t,i={}){Dt();const s=i.type||"liquid";let n=t("tools.thermometerLab.title"),u=t("tools.thermometerLab.subtitle");i.type==="liquid"?(n=t("tools.thermometerLab.liquid.title"),u=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="resistance"?(n=t("tools.thermometerLab.resistance.title"),u=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="thermistor"&&(n=t("tools.thermometerLab.thermistor.title"),u=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const r=document.createElement("div");r.className="tl-wrap",r.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:s,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},w=460,A=340,J=80,W=800,F=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:W-e.left-e.right,gh:F-e.top-e.bottom,tickFont:`bold ${Math.round(W*.024)}px Arial`,axisFont:`bold ${Math.round(W*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:F-e.bottom+32}}function X(){let c=100;const h=Math.max(a.bathTemp,a.thermometerTemp,100);h>120&&(c=150),h>145&&(c=200);const m=c<=100?20:25;return{minT:0,maxT:c,tickStep:m}}function M(e,c,h,m,p){return m+(e-c)/(h-c)*p}function z(e,c,h,m,p){return m+p-(e-c)/(h-c)*p}function E(e,c,h,m,p,S){const{gx:g,gy:y,gw:k,gh:C,tickFont:T,axisFont:I,yLabelX:Q,xLabelY:x}=c;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of S){const j=z(D.value,D.min,D.max,y,C);e.beginPath(),e.moveTo(g,j),e.lineTo(g+k,j),e.stroke()}for(let D=h;D<=m+.01;D+=p){const j=M(D,h,m,g,k);e.beginPath(),e.moveTo(j,y),e.lineTo(j,y+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(g,y),e.lineTo(g,y+C),e.lineTo(g+k,y+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=T,e.textAlign="right",e.textBaseline="middle";for(const D of S){const j=z(D.value,D.min,D.max,y,C);e.fillText(D.label,g-15,j)}e.textAlign="center",e.textBaseline="top";for(let D=h;D<=m+.01;D+=p){const j=M(D,h,m,g,k);e.fillText(`${Math.round(D)}`,j,y+C+10)}return{gx:g,gy:y,gw:k,gh:C,axisFont:I,yLabelX:Q,xLabelY:x}}function B(e,c){const h=c-e,m=h<=8?1:h<=14?2:5,p=[],S=Math.ceil(e/m)*m;for(let g=S;g<=c+.001;g+=m)p.push({value:g,label:g%1===0?`${g.toFixed(0)}`:`${g.toFixed(1)}`,min:e,max:c});return p}function te(){const{maxT:e}=X(),c=Y(0),h=Y(e),m=h-c,p=Math.max(1,m*.1),S=Math.max(0,Math.round((c-p)*10)/10),g=Math.round((h+p)*10)/10;return{minL:S,maxL:g}}function Y(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function ee(){const{maxT:e}=X(),c=ae(0),h=ae(e),m=h-c,p=Math.max(.2,m*.1),S=Math.max(0,c-p),g=h+p,y=m<=2?.5:m<=4?1:2,k=[],C=Math.ceil(S/y)*y;for(let T=C;T<=g+.001;T+=y)k.push({value:T,label:T.toFixed(1),min:S,max:g});return{minR:S,maxR:g,ticks:k}}function ae(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function N(e){const{maxT:c}=e;let h=a.thermistorR25;for(let g=0;g<=c;g+=5){const y=g+273.15,k=a.thermistorR25*Math.exp(a.thermistorBeta*(1/y-1/298.15));h=Math.max(h,k)}h=Math.ceil(h*1.08*10)/10;const m=0,p=h<=12?2:4,S=[];for(let g=0;g<=h+.001;g+=p)S.push({value:g,label:g.toFixed(0),min:m,max:h});return{minR:m,maxR:h,ticks:S}}const V=r.querySelector("#tl-thermometerCanvas"),Z=V.getContext("2d"),K=r.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),U=window.devicePixelRatio||1;V.width=w*U,V.height=A*U,Z.scale(U,U),K.width=W*U,K.height=F*U,ne.scale(U,U);function P(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const l=200,o=11;function f(){const e=Math.pow(a.bulbVolume/l,.3333333333333333);return o*e}function q(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,c=.2+a.wallThickness*1.5,h=.4+a.bulbVolume*.003,m=1.35-a.capillaryBore*.45;return Math.max(.1,c*h*m*e*.15)}function R(e){a.bathTemp<=8&&a.iceCubes.forEach(c=>{c.x+=c.speedX,c.y+=c.speedY,(c.x<65||c.x>175)&&(c.speedX*=-1),(c.y<195||c.y>210)&&(c.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(c=>{c.y-=c.speedY*(1+a.bathTemp/100),c.y<185&&(c.y=265,c.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(c=>{c.y-=c.speedY*(1+(a.bathTemp-80)/40),c.phase+=c.wobbleSpeed,c.x+=Math.sin(c.phase)*.3,c.y<185&&(c.y=260+Math.random()*10,c.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(c=>{c.x+=c.vx,c.y+=c.vy,c.alpha-=.005,(c.alpha<=0||c.y<130)&&(c.x=60+Math.random()*120,c.y=175+Math.random()*5,c.alpha=.2+Math.random()*.4)})}function _(e){let g=59,y=130,k=246;if(a.bathTemp<25){const x=a.bathTemp/25;g=Math.round(180-x*121),y=Math.round(210-x*80),k=Math.round(250-x*4)}else{const x=Math.min(1,(a.bathTemp-25)/125);g=Math.round(59+x*180),y=Math.round(130-x*100),k=Math.round(246-x*190)}if(a.bathTemp>40){const x=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${x*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let j=-25;j<=25;j+=6){const re=x*(12+Math.sin(j*.4+D)*5);e.lineTo(55+130/2+j,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${g}, ${y}, ${k}, 0.25)`),C.addColorStop(1,`rgba(${g}, ${y}, ${k}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const T=a.bathTemp>=80?2:.5,I=a.bathTemp>=80?.09:.03,Q=Date.now()*I;for(let x=55;x<=185;x+=5){const D=190+Math.sin(x*.15+Q)*T;e.lineTo(x,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(x=>{e.beginPath(),e.moveTo(x.x,x.y),e.quadraticCurveTo(x.x+Math.sin(x.y*.06)*5,x.y-x.length/2,x.x,x.y-x.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(x=>{e.save(),e.translate(x.x,x.y),e.rotate(x.angle),e.beginPath(),e.roundRect(-x.size/2,-x.size/2,x.size,x.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(x=>{e.beginPath(),e.arc(x.x,x.y,x.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(x=>{e.fillStyle=`rgba(255, 255, 255, ${x.alpha})`,e.beginPath(),e.arc(x.x,x.y,x.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function b(e,c,h,m,p,S,g="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(c,h),e.lineTo(m,p),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(c,h,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const k=e.measureText(S).width+10,C=16,T=g==="left"?m:m-k,I=p-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(T,I,k,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(S,T+k/2,I+C/2+.5)}function v(e){const m=f(),p=250+Math.max(0,m-o)*.35,S=p-m-1,g=10+a.wallThickness*8,y=120-g/2,k=120+g/2,C=e.createLinearGradient(y,20,k,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(y,S),e.lineTo(y,25),e.arcTo(y,20,y+5,20,5),e.arcTo(k,20,k,25,5),e.lineTo(k,S),e.closePath(),e.fill(),e.stroke();const T=e.createRadialGradient(120-m*.2,p-m*.2,m*.1,120,p,m);T.addColorStop(0,"rgba(255, 255, 255, 0.8)"),T.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=T,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,p,m+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const I=Math.min(g*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-I/2,28,I,S-20-8);const Q=a.liquidType==="mercury",x=Q?"#a1a1aa":"#ef4444",D=Q?"#f4f4f5":"#fee2e2",j=210,re=220,be=(j-40)/re,fe=j-Math.min(re,a.thermometerTemp)*be;e.fillStyle=x,e.fillRect(120-I/2,fe,I,S-fe),e.beginPath(),e.ellipse(120,fe,I/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-I/6,fe,I/3,S-fe);const oe=m*.9,ie=e.createRadialGradient(120-oe*.2,p-oe*.2,oe*.1,120,p,oe);Q?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,p,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const he=j-le*be;e.beginPath(),e.moveTo(y,he),e.lineTo(y+4,he),e.stroke(),e.fillText(`${le}°C`,y-22,he+2.5)}a.showLabels&&(b(e,y+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),b(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),b(e,120-I/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),b(e,120,p,230,p+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function H(e){const g=e.createLinearGradient(115,20,125,20);g.addColorStop(0,"#71717a"),g.addColorStop(.3,"#f4f4f5"),g.addColorStop(.7,"#d4d4d8"),g.addColorStop(1,"#3f3f46"),e.fillStyle=g,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let y=205;e.moveTo(118,y);for(let Q=0;Q<8;Q++)y+=4,e.lineTo(122,y),y+=4,e.lineTo(118,y);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const k=245,C=40,T=135,I=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(k,C,T,I,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(k+10,C+12,T-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",k+T-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",k+14,C+21),a.showLabels&&(b(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),b(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function L(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,S=225,g=12,y=120-g/2,k=e.createLinearGradient(y,p,y+g,p);k.addColorStop(0,"rgba(229, 231, 235, 0.4)"),k.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),k.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),k.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(y,p,g,S-p,[0,0,3,3]),e.fill(),e.stroke();const C=7,T=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);T.addColorStop(0,"#6b7280"),T.addColorStop(.7,"#1f2937"),T.addColorStop(1,"#09090b"),e.fillStyle=T,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const I=245,Q=40,x=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(I,Q,x,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(I+10,Q+12,x-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",I+x-16,Q+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",I+14,Q+21),a.showLabels&&(b(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),b(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function G(e,c,h,m,p,S,g,y,k){const{gx:C,gy:T,gw:I,gh:Q}=c;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(h,m),e.lineTo(h,T+Q),e.stroke(),e.beginPath(),e.moveTo(h,m),e.lineTo(C,m),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const x=`${p.toFixed(1)}${g}`,D=e.measureText(x).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(h-D/2,T+Q+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(x,h,T+Q+4),e.textAlign="right",e.textBaseline="middle";const j=`${S.toFixed(2)} ${y}`,re=e.measureText(j).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(C-re-2,m-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(j,C-7,m)}function $(e){const c=O(),{minL:h,maxL:m}=te(),{minT:p,maxT:S,tickStep:g}=X(),y=B(h,m),k=E(e,c,p,S,g,y),{gx:C,gy:T,gw:I,gh:Q,axisFont:x,yLabelX:D,xLabelY:j,dotR:re}={...c,...k};e.save(),e.translate(D,T+Q/2),e.rotate(-Math.PI/2),e.font=x,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=x,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+I/2,j);const we=S,be=M(0,p,S,C,I),fe=z(Y(0),h,m,T,Q),oe=M(we,p,S,C,I),ie=z(Y(we),h,m,T,Q);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,he=a.currentLength;if(le>=p&&le<=S){const ve=M(le,p,S,C,I),Te=z(he,h,m,T,Q);G(e,c,ve,Te,le,he,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Te,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const c=O(),{minR:h,maxR:m,ticks:p}=ee(),S=X(),g=E(e,c,S.minT,S.maxT,S.tickStep,p),{gx:y,gy:k,gw:C,gh:T,axisFont:I,yLabelX:Q,xLabelY:x,dotR:D}={...c,...g};e.save(),e.translate(Q,k+T/2),e.rotate(-Math.PI/2),e.font=I,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=I,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+C/2,x);const{minT:j,maxT:re}=S,we=re,be=M(0,j,re,y,C),fe=z(ae(0),h,m,k,T),oe=M(we,j,re,y,C),ie=z(ae(we),h,m,k,T);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,he=a.currentResistance;if(le>=j&&le<=re){const ve=M(le,j,re,y,C),Te=z(he,h,m,k,T);G(e,c,ve,Te,le,he,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Te,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const c=O(),h=X(),{minR:m,maxR:p,ticks:S}=N(h),g=E(e,c,h.minT,h.maxT,h.tickStep,S),{gx:y,gy:k,gw:C,gh:T,axisFont:I,yLabelX:Q,xLabelY:x,dotR:D}={...c,...g},{minT:j,maxT:re}=h;e.save(),e.translate(Q,k+T/2),e.rotate(-Math.PI/2),e.font=I,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=I,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+C/2,x),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=j;oe<=re;oe+=1){const ie=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/ie-1/298.15)),he=M(oe,j,re,y,C),ve=z(Math.min(p,le),m,p,k,T);ve>=k&&ve<=k+T&&(we?e.lineTo(he,ve):(e.moveTo(he,ve),we=!0))}e.stroke();const be=a.thermometerTemp,fe=a.currentThermistorR;if(be>=j&&be<=re){const oe=M(be,j,re,y,C),ie=z(Math.min(p,fe),m,p,k,T);G(e,c,oe,ie,be,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,ie,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function pe(){Z.clearRect(0,0,w,A),ne.clearRect(0,0,W,F),Z.save(),Z.translate(J,0),_(Z),a.thermometerType==="liquid"?v(Z):a.thermometerType==="resistance"?H(Z):L(Z),Z.restore(),a.thermometerType==="liquid"?$(ne):a.thermometerType==="resistance"?de(ne):se(ne)}function ge(){const e=r.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const S=r.querySelector("#tl-svg-formula-thermistor-sub");if(S){const g=a.thermometerTemp+273.15;S.innerHTML=`
      ...
      `}}function Se(){const e=r.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:c,cu:h,interval:m}=He(),p=parseFloat(r.querySelector("#tl-input-q10a-cm").value)||0,S=parseFloat(r.querySelector("#tl-input-q10b-t").value)||0,g=r.querySelector("#tl-pane-q10a").classList.contains("active"),y=g?(p-c)/m*100:S,k=g?p:S/100*m+c,T=(I=>130-I/100*80)(y);e.innerHTML=`
    ...
    `}function ke(e){r.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",r.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const c=r.querySelector("#tl-bath-state");a.bathTemp<=0?c.textContent="Melting Ice Bath":a.bathTemp>=100?c.textContent="Boiling Water/Steam":a.bathTemp===150?c.textContent="Hot Cooking Oil":c.textContent="Liquid Water",r.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const h=r.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?h.style.display="block":h.style.display="none",a.thermometerType==="liquid"?(r.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",r.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(r.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",r.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):r.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let qe=null;function _e(e){a.lastTimestamp||(a.lastTimestamp=e);const c=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const h=Math.min(c,.1),m=q(),p=h/m*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=p,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const S=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/S-1/298.15)),R(),pe(),ke(m),qe=requestAnimationFrame(_e)}function He(){const e=parseFloat(r.querySelector("#tl-input-faulty-cf").value),c=parseFloat(r.querySelector("#tl-input-faulty-cu").value),h=Number.isFinite(e)?e:-1.5,m=Number.isFinite(c)?c:105,p=m-h;return{cf:h,cu:m,interval:p}}function ze(e){const c=Math.round(e*100)/100;return c>=0?c.toFixed(1):`(${c.toFixed(1)})`}function me(){const{cf:e,cu:c,interval:h}=He(),m=r.querySelector("#tl-val-faulty-interval"),p=r.querySelector("#tl-faulty-error-a"),S=r.querySelector("#tl-faulty-error-b"),g=Math.abs(h)<.01;m.textContent=h.toFixed(1)+" °C";const y=r.querySelector("#tl-svg-formula-faulty-a"),k=r.querySelector("#tl-svg-formula-faulty-b");if(g){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",S.hidden=!1,S.textContent=p.textContent,y&&(y.innerHTML=""),k&&(k.innerHTML="");return}p.hidden=!0,S.hidden=!0;const C=parseFloat(r.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(r.querySelector("#tl-input-q10b-t").value)||0,I=(C-e)/h*100,Q=T/100*h+e;y&&(y.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${C.toFixed(1)} - ${ze(e)}</text>
      ...
      `),k&&(k.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${ze(e)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${Q.toFixed(2)}°C</tspan>
          </text>
        </svg>
      ...
      `)}function Ce(){const e=a.thermometerTemp,c=a.liquidL100-a.liquidL0,h=a.liquidL0+c/100*e,m=r.querySelector("#tl-svg-formula-t-to-l");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `)}function je(){const e=a.thermometerTemp,c=a.resistanceR100-a.resistanceR0,h=a.resistanceR0+c/100*e,m=r.querySelector("#tl-svg-formula-t-to-r");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      </section>`}async function M(){const l=Ae();for(const o of Le){const f=t.querySelector(`[data-note-card="${o.id}"]`);if(!f)continue;const q=f.querySelector("[data-note-body]"),R=l==="zhHant"?o.fileZh:o.fileEn,_=await at(R),b=`./notes/${R}`;_?q.innerHTML=`
          <iframe class="notes-grid" title="${d(`notes.card.${o.id}`)}" src="${b}"></iframe>
          <p style="margin-top:8px"><a href="${b}" target="_blank" rel="noopener">${d("notes.openPdf")}</a></p>`:q.innerHTML=`<p class="lead">${d("notes.missing")}</p>`}}function z(){return`
      <section class="panel panel--tools">
        <h2>${d("tools.title")}</h2>
        <p class="lead">${d("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${tt.map(l=>`<button type="button" data-tool="${l}" class="${s===l?"active":""}">${Vt(l)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function E(){const l=t.querySelector("[data-tool-list]"),o=t.querySelector("[data-tool-stage]");!l||!o||(l.querySelectorAll("button").forEach(f=>{f.addEventListener("click",()=>{s=f.getAttribute("data-tool"),l.querySelectorAll("button").forEach(q=>q.classList.toggle("active",q.getAttribute("data-tool")===s)),B(o)})}),B(o))}function B(l){l.innerHTML="",A!=null&&A._thermometerLabCleanup&&A._thermometerLabCleanup();const o=Nt[s];o&&(A=o(d),l.appendChild(A))}function te(){return`
      <section class="panel">
        <h2>${d("flashcards.title")}</h2>
        <p class="lead">${d("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
          ...
          <select data-flash-deck>
            ...
            <option value="heatInternalEnergy">${d("flashcards.deck.heatInternalEnergy")}</option>
          </select>
        </div>
        <div class="flashcard-box">
          <div class="flashcard-surface" data-flip-card>
      ...
      </section>`}function Y(){return dt.filter(l=>De.includes(l.topic))}function ee(l){return!!(l!=null&&l.front)}function ae(l){return`./${String(l).replace(/^\.\//,"")}`}function N(){if(u==="all")return[...Ze,...Je];if(u==="thermometry")return Ze.slice();if(u==="heatInternalEnergy")return Je.slice();const l=Y().filter(o=>o.topic===u);return l.length?l:Y()}function V(){const l=N(),o=t.querySelector("[data-flash-progress]");if(!l.length){n=0;const H=t.querySelector("[data-flash-front]"),L=t.querySelector("[data-flip-card]");H&&(H.textContent=""),L&&L.classList.remove("flashcard-surface--image"),o&&(o.hidden=!0,o.textContent="");return}n=Math.max(0,Math.min(n,l.length-1));const f=l[n],q=t.querySelector("[data-flash-front]"),R=t.querySelector("[data-flip-card]"),_=t.querySelector("[data-flash-label]");if(!q||!R)return;if(o&&(o.hidden=!1,o.textContent=d("flashcards.progress").replace("{current}",String(n+1)).replace("{total}",String(l.length))),ee(f)){const H=f.back&&f.back!==f.front;R.classList.add("flashcard-surface--image"),_&&(H?(_.hidden=!1,_.textContent=d(r?"flashcards.answer":"flashcards.question")):_.hidden=!0);const L=r&&f.back?f.back:f.front,G=f.alt||f.title||"";q.innerHTML=`<img src="${ae(L)}" alt="${G.replace(/"/g,"&quot;")}" loading="lazy" />`;return}R.classList.remove("flashcard-surface--image");const b=Ae(),v=f[b]||f.en;_&&(_.hidden=!1,_.textContent=d(r?"flashcards.answer":"flashcards.question")),q.textContent=r?v.a:v.q}function Z(){const l=t.querySelector("[data-flash-deck]");l.value=u,l.addEventListener("change",()=>{u=l.value,n=0,r=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{r=!r,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",o=>{o.stopPropagation(),r=!r,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const o=N();n=(n-1+o.length)%o.length,r=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const o=N();n=(n+1)%o.length,r=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const o=N();n=Math.floor(Math.random()*o.length),r=!1,V()}),V()}function K(){return`
      <section class="panel">
        <h2>${d("summary.title")}</h2>
        <p class="lead">${d("summary.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
      ...
      </section>`}async function ne(){const l=Ae();for(const o of Le){const f=t.querySelector(`[data-summary-card="${o.id}"]`);if(!f)continue;const q=f.querySelector("[data-summary-body]");if(o.id==="thermometer"){const v=await Ge("summary","thermometer.webp"),H="./summary/thermometer.webp";v?q.innerHTML=`
          <img class="summary-thumb" src="${H}" alt="${d("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${H}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:q.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(o.id==="heatInternalEnergy"){const v=await Ge("summary","heat-internal-energy.webp"),H="./summary/heat-internal-energy.webp";v?q.innerHTML=`
          <img class="summary-thumb" src="${H}" alt="${d("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${H}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:q.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}const R=l==="zhHant"?o.fileZh:o.fileEn,_=await at(R),b=`./notes/${R}`;_?q.innerHTML=`
          <iframe class="notes-grid" title="${d(`summary.item.${o.id}`)}" src="${b}"></iframe>
          <p style="margin-top:8px"><a href="${b}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:q.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const U=()=>W(),P=l=>O(l);return window.addEventListener("s3phy:lang",U),t.addEventListener("click",P),W(),()=>{window.removeEventListener("s3phy:lang",U),t.removeEventListener("click",P),A!=null&&A._thermometerLabCleanup&&A._thermometerLabCleanup(),a==null||a.destroy()}}const rt={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};wt();const nt="s3phy_splash_seen",ht={optics:Wt,heat:Ut};let Re=null,Me=null;function Yt(){const t=location.hash.match(/^#\/(\w+)/),i=t==null?void 0:t[1];return i&&Object.prototype.hasOwnProperty.call(ht,i)?i:null}function Kt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function mt(t){Re==null||Re(),Re=null,Me==null||Me(),Me=null;const i=document.getElementById("app");if(!i)return;if(i.innerHTML="",!t){location.hash&&Kt(),Me=kt(i);return}const s=`#/${t}`;if(location.hash!==s){location.hash=s;return}Re=ht[t](i)??null}function bt(){mt(Yt())}function Xt(){return"./images/uniplus-logo.png"}function Zt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Xt()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Jt(t,i){const s=[...rt.en,...rt.zhHant],n=()=>{if(!t.parentElement)return;const u=document.createElement("div");u.className="splash-danmaku-item",u.textContent=s[Math.floor(Math.random()*s.length)];const r=Math.random()*85+5,a=Math.random()*.8+.9,w=Math.random()*12+10;u.style.top=`${r}%`,u.style.fontSize=`${a}rem`,u.style.animationDuration=`${w}s`,i.appendChild(u),u.addEventListener("animationend",()=>u.remove()),window.setTimeout(n,1500+Math.random()*1e3)};for(let u=0;u<4;u+=1)window.setTimeout(n,u*1e3)}function ea(t){const i=t.querySelector("#splashLogoWrap"),s=t.querySelector("#splashDanmaku"),n=t.querySelector("#splashStartWrap");window.setTimeout(()=>i==null?void 0:i.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{s==null||s.classList.add("splash-danmaku--visible"),n==null||n.classList.add("splash-start-wrap--in"),s&&Jt(t,s)},1600)}function it(){bt()}function ta(){let t=!1;try{t=sessionStorage.getItem(nt)==="1"}catch{}if(t){it();return}const i=Zt();document.body.insertBefore(i,document.body.firstChild),ea(i);const s=i.querySelector("#splashStart"),n=()=>{i.remove(),it()};s.addEventListener("click",()=>{try{sessionStorage.setItem(nt,"1")}catch{}i.classList.add("splash--hide"),i.addEventListener("transitionend",n,{once:!0}),window.setTimeout(n,480)})}window.addEventListener("hashchange",bt);window.addEventListener("s3phy:strand",t=>{mt(t.detail??null)});ta();
