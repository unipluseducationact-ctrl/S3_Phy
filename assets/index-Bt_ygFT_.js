...
`;function gt(){if(document.getElementById(Be))return;const t=document.createElement("style");t.id=Be,t.textContent=ht,document.head.appendChild(t)}function bt(t){gt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
    <div class="rml-head">
  ...
  `;const l=r.querySelector(".rml-canvas"),i=l.getContext("2d"),f=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),L=r.querySelector('[data-rml-disp="inc"]'),F=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,O=380,Z=300,M="#22d3ee",z="bold 17px system-ui, sans-serif";let I=0,j=-140,ae=!0,X=!0,U=!0,V=!0;function Y(g){return g*Math.PI/180}function J(g,d,c,b,A,_=2,H=!1){i.beginPath(),i.lineWidth=_,i.strokeStyle=A,i.setLineDash(H?[6,6]:[]);const y=g+Math.cos(Y(c))*b,w=d+Math.sin(Y(c))*b;return i.moveTo(g,d),i.lineTo(y,w),i.stroke(),i.setLineDash([]),{x:y,y:w}}function ee(g,d,c,b,A,_=14){const H=c-g,y=b-d,w=Math.hypot(H,y);if(w<1e-6)return;const B=H/w,R=y/w,Q=c-B*_,E=b-R*_,ce=.45*_;i.beginPath(),i.fillStyle=A,i.moveTo(c,b),i.lineTo(Q-R*ce,E+B*ce),i.lineTo(Q+R*ce,E-B*ce),i.closePath(),i.fill()}function K(g,d,c,b,A,_=25){i.beginPath(),i.strokeStyle=b,i.lineWidth=2;const H=Math.min(g,d),y=Math.max(g,d);if(i.arc($,O,c,Y(H),Y(y),!1),i.stroke(),A){const w=(H+y)/2,B=$+Math.cos(Y(w))*(c+_),R=O+Math.sin(Y(w))*(c+_);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=b,i.fillText(A,B,R),i.restore()}}function ne(g,d,c,b,A){i.clearRect(0,0,l.width,l.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,O),i.lineTo($+200,O),i.stroke(),i.setLineDash([]),i.lineCap="butt";const _=$+Math.cos(Y(g))*Z,H=O+Math.sin(Y(g))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(_,H),i.lineTo($,O),i.stroke();const y=(_+$)*.5,w=(H+O)*.5,B=Math.hypot($-_,O-H)||1,R=($-_)/B,Q=(O-H)/B;if(ee(y-R*28,w-Q*28,y,w,"#fff",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),_,H-12),i.restore(),ae){const E=J($,O,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),E.x+6,E.y-4),i.restore()}if(X){const E=J($,O,b,Z,"#00e676",2,!1);ee($,O,E.x,E.y,"#00e676",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),E.x,E.y-14),i.restore()}i.save(),i.translate($,O),i.rotate(Y(I)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let E=-190;E<200;E+=15)i.moveTo(E,0),i.lineTo(E-5,8);if(i.stroke(),i.restore(),U){const E=J($,O,d,Z-40,M,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=M,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),E.x+6,E.y-4),i.restore()}if(V){const E=J($,O,c,Z,M,4);ee($,O,E.x,E.y,M,16),Math.abs(I)>.5&&(i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=M,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),E.x,E.y-14),i.restore())}if(U&&K(g,d,100,"#ffcc00",`i=${A.toFixed(0)}°`,25),U&&V&&K(d,c,100,M,`r=${A.toFixed(0)}°`,25),ae&&U&&Math.abs(I)>.5&&K(-90,d,50,"#ffcc00",`θ=${Math.abs(I)}°`,20),X&&V&&Math.abs(I)>.5){const E=c-b;K(b,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${E.toFixed(0)}°`,40)}}function v(){I=parseFloat(f.value),j=parseFloat(n.value);const g=I>0?"+":"";a.textContent=`${g}${I}°`,L.textContent=`${j}°`;const d=-90,c=Math.abs(j-d),b=d+c,A=-90+I,_=Math.abs(j-A),H=A+_,y=H-b;F.textContent=`${_.toFixed(1)}°`,te.textContent=`${_.toFixed(1)}°`;const w=y>0?"+":"";P.textContent=`${w}${y.toFixed(1)}°`,ne(j,A,H,b,_)}return r.querySelectorAll("[data-rml-toggle]").forEach(g=>{g.addEventListener("click",()=>{const d=g.getAttribute("data-rml-toggle");d==="orig-norm"&&(ae=!ae),d==="orig-ray"&&(X=!X),d==="new-norm"&&(U=!U),d==="new-ray"&&(V=!V),g.classList.toggle("active"),v()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{f.value="0",v()}),f.addEventListener("input",v),n.addEventListener("input",v),v(),r}function vt(t){const r=document.createElement("div");r.className="tool-tir-escape";const l=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;return l.src=`${f}tir-escape/index.html?embed=1`,l.title=t("tools.refractionTir.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(l),r}function yt(t,r={}){const l=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",f=document.createElement("div");f.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",L=a.endsWith("/")?a:`${a}/`;return n.src=`${L}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(l)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",f.appendChild(n),f}function wt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const l=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;function n(){return`${f}em-spectrum/index.html?lang=${encodeURIComponent(Se())}`}l.src=n(),l.title=t("tools.em.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var L;try{(L=l.contentWindow)==null||L.postMessage({type:"s3phy:lang",lang:Se()},"*")}catch{l.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(l),r}function xt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const l=r.querySelector("[data-r]"),i=r.querySelector("[data-g]"),f=r.querySelector("[data-b]"),n=r.querySelector(".rgb-mixer-canvas"),a=r.querySelector(".rgb-mixer-stage"),L=n.getContext("2d");function F(M){return M.toString(16).padStart(2,"0")}function te(M,z,I){const j=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),X=j/2,U=ae/2,V=Math.min(j,ae)*.34,Y=V*.5,J=Math.sqrt(3)/2;L.clearRect(0,0,j,ae),L.fillStyle="#000",L.fillRect(0,0,j,ae);const ee=[{x:X,y:U-Y,rgb:[255,0,0],val:M},{x:X-Y*J,y:U+Y*.5,rgb:[0,255,0],val:z},{x:X+Y*J,y:U+Y*.5,rgb:[0,0,255],val:I}];L.globalCompositeOperation="lighter",ee.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[v,g,d]=K.rgb,c=L.createRadialGradient(K.x,K.y,0,K.x,K.y,V);c.addColorStop(0,`rgba(${v},${g},${d},${ne})`),c.addColorStop(.65,`rgba(${v},${g},${d},${ne})`),c.addColorStop(.85,`rgba(${v},${g},${d},${ne*.5})`),c.addColorStop(1,`rgba(${v},${g},${d},0)`),L.fillStyle=c,L.beginPath(),L.arc(K.x,K.y,V,0,Math.PI*2),L.fill()}),L.globalCompositeOperation="source-over"}function P(){const M=a.getBoundingClientRect(),z=Math.max(200,Math.min(M.width-8,M.height-8,720)),I=window.devicePixelRatio||1;n.width=z*I,n.height=z*I,n.style.width=`${z}px`,n.style.height=`${z}px`,L.setTransform(I,0,0,I,0,0),te(+l.value,+i.value,+f.value)}function $(){const M=+l.value,z=+i.value,I=+f.value,j=`rgb(${M}, ${z}, ${I})`,ae=`#${F(M)}${F(z)}${F(I)}`;r.querySelector("[data-r-val]").textContent=M,r.querySelector("[data-g-val]").textContent=z,r.querySelector("[data-b-val]").textContent=I,r.querySelector("[data-r-bar]").style.width=`${M/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${z/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${I/255*100}%`,l.style.setProperty("--fill",`${M/255*100}%`),i.style.setProperty("--fill",`${z/255*100}%`),f.style.setProperty("--fill",`${I/255*100}%`);const X=r.querySelector("[data-swatch]");X.style.backgroundColor=j,X.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${j}`),r.querySelector("[data-rgb-text]").textContent=j,r.querySelector("[data-hex-text]").textContent=ae,te(M,z,I)}function O(M,z,I){l.value=M,i.value=z,f.value=I,$()}return[l,i,f].forEach(M=>M.addEventListener("input",$)),r.querySelectorAll(".rgb-presets button").forEach(M=>{M.addEventListener("click",()=>{O(+M.dataset.r,+M.dataset.g,+M.dataset.b)})}),new ResizeObserver(()=>P()).observe(a),requestAnimationFrame(()=>{P(),$()}),r}const qt=["topics","notes","tools","worksheets","flashcards","summary"],St={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function tt(t,{subtitleKey:r,activeSection:l,onSection:i,onLang:f}){t.innerHTML=`
    <header class="site-header">
      <div class="site-header__brand">
        ...
        <div class="brand-text-block">
          <h1 class="site-title">${s("app.title")}</h1>
          <p class="site-subtitle" data-hub-subtitle>${s(r)}</p>
        </div>
      </div>
      <div class="site-header__actions">
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),L=t.querySelector("[data-lang]"),F=t.querySelector("[data-strand-back]");let te=l;function P(M){te=M,a.innerHTML=qt.map(z=>`<button type="button" class="${M===z?"active":""}" data-sec="${z}">${s(St[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>i(z.getAttribute("data-sec")))})}function $(){L.innerHTML=`
      <button type="button" data-set-lang="en" class="${Se()==="en"?"active":""}">${s("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${Se()==="zh-Hant"?"active":""}">${s("lang.zhHant")}</button>
    `,L.querySelectorAll("button").forEach(M=>{M.addEventListener("click",()=>{Ze(M.getAttribute("data-set-lang")),f()})})}function O(){t.querySelector("[data-hub-subtitle]").textContent=s(r),F.textContent=s("strand.back"),t.querySelector("[data-hub-footer]").textContent=s("footer.conventions"),t.querySelector(".site-title").textContent=s("app.title")}const Z=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return F.addEventListener("click",Z),P(l),$(),{main:n,updateSection(M){P(M)},refreshLabels(){O(),P(te),$()},destroy(){F.removeEventListener("click",Z)}}}const We=["A","B","C","D"];function Ge(t){const r=t.slice();for(let l=r.length-1;l>0;l-=1){const i=Math.floor(Math.random()*(l+1));[r[l],r[i]]=[r[i],r[l]]}return r}function Tt(t,r,l){return t.filter(i=>{if(l)return l(i,r);const f=i.topic;return!!(r.includes(f)||r.includes("rotatingMirror")&&f==="reflection"||r.includes("refraction")&&f==="refraction"||r.includes("tir")&&f==="tir"||f==="convex"&&r.includes("convex")||f==="concave"&&r.includes("concave"))})}function kt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function we(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function at(t,r={}){const l=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=r.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="ws-controls no-print">
        ...
        <div class="grid cols-2" data-ws-topics>
          ${l.map(([f,n])=>`<label class="card ws-topic-card">
            <input type="checkbox" data-ws-topic="${f}" checked />
            <span>${t(n)}</span>
          </label>`).join("")}
        </div>
    ...
    </section>`}function nt(t,r,l,i,f={}){var b,A,_,H;const n={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),L=t.querySelector("[data-ws-preview-area]"),F=t.querySelector("[data-ws-out]"),te=t.querySelector("[data-ws-body]"),P=t.querySelector("[data-ws-paper]"),$=t.querySelector("[data-ws-tabs]"),O=t.querySelector("[data-ws-practice-actions]"),Z=t.querySelector("[data-ws-score]"),M=t.querySelector("[data-ws-score-val]"),z=t.querySelector("[data-ws-summary]"),I=t.querySelector("[data-ws-date-row]"),j=t.querySelector("[data-ws-date-print]"),ae=t.querySelector("[data-ws-date-today]"),X=t.querySelector("[data-ws-date-label]");if(!a||!te)return;function U(){return i()}function V(){n.userAnswers={},n.wrongAttempts={},n.resolved={},Z.hidden=!0,z.hidden=!0}function Y(){return n.items.length>0&&n.items.every((y,w)=>n.resolved[w])}function J(){let y=0;n.items.forEach((B,R)=>{if(!n.resolved[R])return;const Q=B[U()]||B.en;n.userAnswers[R]===Q.a&&(y+=1)}),Object.keys(n.resolved).length>0&&(M.textContent=`${y}/${n.items.length}`,Z.hidden=!1)}function ee(y){n.tab=y,$==null||$.querySelectorAll("[data-ws-tab]").forEach(w=>{w.classList.toggle("active",w.getAttribute("data-ws-tab")===y)}),O&&(O.hidden=y!=="practice"),I&&(I.hidden=y!=="practice"),j&&(j.hidden=!n.dateStr,j.textContent=n.dateStr?`${l("worksheets.date")}: ${n.dateStr}`:""),P==null||P.classList.toggle("practice-mode",y==="practice"),ne()}function K(y,w,B){const R=y[U()]||y.en,Q=We,E=w+1,ce=y.section?`<span class="q-section">${we(y.section)}</span>`:"";if(B==="answer"){const me=R.choices.map((ve,ke)=>`<li class="${ke===R.a?"choice-correct":""}"><strong>${Q[ke]}.</strong> ${we(ve)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${E} ${ce}</h4>
        <p>${we(R.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${l("worksheets.answer")}:</strong> ${Q[R.a]}</p>
        <p class="q-exp"><em>${we(R.exp)}</em></p>
      </div>`}const se=n.userAnswers[w],fe=n.wrongAttempts[w]||0,ge=n.resolved[w],Te=ge&&se===R.a,xe=ge&&se!==R.a;let qe="";fe===1&&!ge?qe=`<p class="q-hint"><strong>${l("worksheets.hint")}:</strong> ${we(R.hint||R.exp)}</p>`:xe&&(qe=`<p class="q-exp"><strong>${l("worksheets.answer")}:</strong> ${Q[R.a]}</p>
        <p class="q-exp q-summary"><em>${we(R.exp)}</em></p>`);const Re=Te?"correct":xe?"incorrect":"",ze=R.choices.map((me,ve)=>`<li>
          <label class="choice-radio">
            ...
            <strong>${Q[ve]}.</strong> ${we(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${Re}" data-ws-row="${w}">
      <div class="q-header"><h4>Q${E} ${ce}</h4>${Te?'<span class="result-icon">✓</span>':xe?'<span class="result-icon">✗</span>':""}</div>
      <p>${we(R.q)}</p>
      <ol class="choice-list choice-list--radio">${ze}</ol>
      ${qe}
    </div>`}function ne(){n.items.length&&(te.innerHTML=n.items.map((y,w)=>K(y,w,n.tab)).join(""),v())}function v(){n.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(y=>{y.addEventListener("change",()=>{const w=Number(y.getAttribute("data-ws-q"));if(n.resolved[w])return;const B=Number(y.getAttribute("data-ws-choice")),R=n.items[w][U()]||n.items[w].en;n.userAnswers[w]=B,B===R.a?n.resolved[w]=!0:(n.wrongAttempts[w]=(n.wrongAttempts[w]||0)+1,n.wrongAttempts[w]>=2&&(n.resolved[w]=!0)),J(),Y()&&g(),ne()})})}function g(){const y=n.items.length;let w=0,B=0;const R={};n.items.forEach((se,fe)=>{const ge=se[U()]||se.en;if(n.userAnswers[fe]===ge.a)w+=1,(n.wrongAttempts[fe]||0)===0&&(B+=1);else if(n.resolved[fe]){const xe=se.section||se.topic;R[xe]=(R[xe]||0)+1}});const Q=y?Math.round(w/y*100):0;let E=l("worksheets.revisionFair");Q>=90?E=l("worksheets.revisionExcellent"):Q>=70?E=l("worksheets.revisionGood"):Q<50&&(E=l("worksheets.revisionLow"));const ce=Object.entries(R).sort((se,fe)=>fe[1]-se[1]).map(([se,fe])=>`<li>${we(se)} (${fe})</li>`).join("");z.innerHTML=`
      <h4>${l("worksheets.sessionSummary")}</h4>
      <p>${l("worksheets.score")}: <strong>${w}/${y}</strong> (${Q}%)</p>
      <p>${l("worksheets.firstTry")}: <strong>${B}/${y}</strong></p>
      <p>${l("worksheets.revisionSuggestions")}: ${E}</p>
      ${ce?`<p>${l("worksheets.weakSections")}:</p><ul>${ce}</ul>`:""}`,z.hidden=!1}function d(y){const w=U(),B=n.items.map((R,Q)=>{const E=R[w]||R.en,ce=E.choices.map((fe,ge)=>`${We[ge]}. ${fe}`).join("<br/>"),se=y?`<p><b>${l("worksheets.answer")}:</b> ${We[E.a]}<br/><i>${E.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${E.q}<br/>${ce}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${l("worksheets.paperTitle")}</title></head>
<body><h2>${l("worksheets.paperTitle")}</h2>
${n.dateStr&&!y?`<p>${l("worksheets.date")}: ${n.dateStr}</p>`:""}
${B}</body></html>`}function c(y){const w=d(y),B=new Blob(["\uFEFF",w],{type:"application/msword"}),R=document.createElement("a");R.href=URL.createObjectURL(B),R.download=y?"worksheet-answers.doc":"worksheet.doc",R.click(),URL.revokeObjectURL(R.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),w=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),B=Tt(r,w,f.topicFilter),R=Ge(B).slice(0,Math.min(y,B.length||1));n.items=R.length?R:Ge(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",L.hidden=!1,F.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),I&&(I.hidden=!1),j&&(j.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const w=y.target.closest("[data-ws-tab]");!w||!n.items.length||ee(w.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=kt(),X.textContent=`${l("worksheets.date")}: ${n.dateStr}`),j&&(j.hidden=!n.dateStr,j.textContent=n.dateStr?`${l("worksheets.date")}: ${n.dateStr}`:"")}),(b=t.querySelector("[data-ws-word-p]"))==null||b.addEventListener("click",()=>c(!1)),(A=t.querySelector("[data-ws-word-a]"))==null||A.addEventListener("click",()=>c(!0)),(_=t.querySelector("[data-ws-print-p]"))==null||_.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(H=t.querySelector("[data-ws-print-a]"))==null||H.addEventListener("click",()=>{ee("answer"),window.print()})}const Ct=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Mt={rotatingMirror:t=>bt(t),refractionTir:t=>vt(t),lens:(t,r)=>yt(t,{defaultKind:r}),rgbMixer:t=>xt(t),em:t=>wt(t)};function _t(t){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return Se()==="zh-Hant"?"zhHant":"en"}async function it(t,r){const l=`./${t}/${r}`;try{return(await fetch(l,{method:"HEAD"})).ok}catch{return!1}}async function Lt(t){return it("notes",t)}function Rt(t){let r="topics",l="rotatingMirror",i="convex",f=0,n="all",a=!1,L=null,F={main:null};function te(){F.main&&(r==="topics"?F.main.innerHTML=$():r==="notes"?F.main.innerHTML=Z():r==="tools"?F.main.innerHTML=z():r==="worksheets"?F.main.innerHTML=at(s):r==="flashcards"?F.main.innerHTML=ae():r==="summary"&&(F.main.innerHTML=K()),r==="notes"&&M(),r==="tools"&&I(),r==="worksheets"&&nt(t,Je,s,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){L==null||L.destroy(),L=tt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:d=>{r=d,L.updateSection(r),te()},onLang:()=>P()}),F.main=L.main,L.updateSection(r),te()}function $(){const d=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${d.map(([c,b])=>{const A=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,_=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${s(b)}</h3>
              <button class="btn primary" type="button" data-go-tool="${A}"${_?` data-lens-kind="${_}"`:""}>${s("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function O(d){const c=d.target.closest("[data-go-tool]");if(!c)return;r="tools",l=c.getAttribute("data-go-tool");const b=c.getAttribute("data-lens-kind");(b==="convex"||b==="concave")&&(i=b),L.updateSection(r),te()}function Z(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${d.map(c=>{const b=s(`notes.card.${c.key}`);return`
            <div class="card" data-note-card="${c.key}">
              <h3>${b}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function M(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Ae();for(const b of d){const A=t.querySelector(`[data-note-card="${b.key}"]`);if(!A)continue;const _=A.querySelector("[data-note-body]"),H=c==="zhHant"?b.fileZh:b.fileEn,y=await Lt(H),w=`./notes/${H}`;y?_.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${b.key}`)}" src="${w}"></iframe>
          <p style="margin-top:8px"><a href="${w}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:_.innerHTML=`<p class="lead">${s("notes.missing")}</p>
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ct.map(d=>`<button type="button" data-tool="${d}" class="${l===d?"active":""}">${_t(d)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function I(){const d=t.querySelector("[data-tool-list]"),c=t.querySelector("[data-tool-stage]");!d||!c||(d.querySelectorAll("button").forEach(b=>{b.addEventListener("click",()=>{l=b.getAttribute("data-tool"),d.querySelectorAll("button").forEach(A=>A.classList.toggle("active",A.getAttribute("data-tool")===l)),j(c)})}),j(c))}function j(d){d.innerHTML="";const c=Mt[l];if(!c)return;const b=l==="lens"?c(s,i):c(s);d.appendChild(b)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(d){return!!(d!=null&&d.front)}function U(d){return`./${String(d).replace(/^\.\//,"")}`}function V(){return et.slice()}function Y(){const d=mt.slice(),c=V(),b=n==="rotatingMirror"?"reflection":n;if(b==="all")return[...d,...c];if(b==="reflection")return d;if(b==="convex"||b==="concave"){const _=c.filter(H=>H.topic==="convex"||H.topic==="concave");return _.length?_:c}if(b==="refractionTir"){const _=c.filter(H=>H.topic==="refraction"||H.topic==="tir");return _.length?_:c}const A=c.filter(_=>_.topic===b);return A.length?A:c}function J(){const d=Y(),c=t.querySelector("[data-flash-progress]");if(!d.length){f=0;const B=t.querySelector("[data-flash-front]"),R=t.querySelector("[data-flip-card]");B&&(B.textContent=""),R&&R.classList.remove("flashcard-surface--image"),c&&(c.hidden=!0,c.textContent="");return}f=Math.max(0,Math.min(f,d.length-1));const b=d[f],A=t.querySelector("[data-flash-front]"),_=t.querySelector("[data-flip-card]"),H=t.querySelector("[data-flash-label]");if(!A||!_)return;if(c&&(c.hidden=!1,c.textContent=s("flashcards.progress").replace("{current}",String(f+1)).replace("{total}",String(d.length))),X(b)){const B=b.back&&b.back!==b.front;_.classList.add("flashcard-surface--image"),H&&(B?(H.hidden=!1,H.textContent=s(a?"flashcards.answer":"flashcards.question")):H.hidden=!0);const R=a&&b.back?b.back:b.front,Q=b.alt||b.title||"";A.innerHTML=`<img src="${U(R)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}_.classList.remove("flashcard-surface--image");const y=Ae(),w=b[y]||b.en;H&&(H.hidden=!1,H.textContent=s(a?"flashcards.answer":"flashcards.question")),A.textContent=a?w.a:w.q}function ee(){n==="rotatingMirror"&&(n="reflection");const d=t.querySelector("[data-flash-deck]");d.value=n,d.addEventListener("change",()=>{n=d.value,f=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",c=>{c.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const c=Y();f=(f-1+c.length)%c.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const c=Y();f=(f+1)%c.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const c=Y();f=Math.floor(Math.random()*c.length),a=!1,J()}),J()}function K(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${d.map(c=>{const b=s(`summary.item.${c.key}`);return`
            <div class="card" data-summary-card="${c.key}">
              <h3>${b}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function ne(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],c=Ae();for(const b of d){const A=t.querySelector(`[data-summary-card="${b.key}"]`);if(!A)continue;const _=A.querySelector("[data-summary-body]"),H=c==="zhHant"?b.fileZh:b.fileEn,y=await it("summary-pdfs",H),w=`./summary-pdfs/${H}`;y?_.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${b.key}`)}" src="${w}"></iframe>
          <p style="margin-top:8px"><a href="${w}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:_.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const v=()=>P(),g=d=>O(d);return window.addEventListener("s3phy:lang",v),t.addEventListener("click",g),P(),()=>{window.removeEventListener("s3phy:lang",v),t.removeEventListener("click",g),L==null||L.destroy()}}const je="s3phy-thermometer-lab-css",zt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Ht(){if(document.getElementById(je))return;const t=document.createElement("style");t.id=je,t.textContent=zt,document.head.appendChild(t)}function Pe(t,r={}){Ht();const l=r.type||"liquid";let i=t("tools.thermometerLab.title"),f=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),f=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),f=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),f=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
    <div class="tl-head">
      <h2 class="tl-title">${i}</h2>
      <div class="tl-sub">${f}</div>
    </div>
    <div class="tl-dash">
  ...
  `;const a={liquidType:"mercury",thermometerType:l,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},L=460,F=340,te=80,P=800,$=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let o=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(o=150),p>145&&(o=200);const m=o<=100?20:25;return{minT:0,maxT:o,tickStep:m}}function M(e,o,p,m,u){return m+(e-o)/(p-o)*u}function z(e,o,p,m,u){return m+u-(e-o)/(p-o)*u}function I(e,o,p,m,u,T){const{gx:h,gy:x,gw:S,gh:k,tickFont:C,axisFont:W,yLabelX:N,xLabelY:q}=o;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of T){const G=z(D.value,D.min,D.max,x,k);e.beginPath(),e.moveTo(h,G),e.lineTo(h+S,G),e.stroke()}for(let D=p;D<=m+.01;D+=u){const G=M(D,p,m,h,S);e.beginPath(),e.moveTo(G,x),e.lineTo(G,x+k),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(h,x),e.lineTo(h,x+k),e.lineTo(h+S,x+k),e.stroke(),e.fillStyle="#e4e4e7",e.font=C,e.textAlign="right",e.textBaseline="middle";for(const D of T){const G=z(D.value,D.min,D.max,x,k);e.fillText(D.label,h-15,G)}e.textAlign="center",e.textBaseline="top";for(let D=p;D<=m+.01;D+=u){const G=M(D,p,m,h,S);e.fillText(`${Math.round(D)}`,G,x+k+10)}return{gx:h,gy:x,gw:S,gh:k,axisFont:W,yLabelX:N,xLabelY:q}}function j(e,o){const p=o-e,m=p<=8?1:p<=14?2:5,u=[],T=Math.ceil(e/m)*m;for(let h=T;h<=o+.001;h+=m)u.push({value:h,label:h%1===0?`${h.toFixed(0)}`:`${h.toFixed(1)}`,min:e,max:o});return u}function ae(){const{maxT:e}=Z(),o=X(0),p=X(e),m=p-o,u=Math.max(1,m*.1),T=Math.max(0,Math.round((o-u)*10)/10),h=Math.round((p+u)*10)/10;return{minL:T,maxL:h}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),o=V(0),p=V(e),m=p-o,u=Math.max(.2,m*.1),T=Math.max(0,o-u),h=p+u,x=m<=2?.5:m<=4?1:2,S=[],k=Math.ceil(T/x)*x;for(let C=k;C<=h+.001;C+=x)S.push({value:C,label:C.toFixed(1),min:T,max:h});return{minR:T,maxR:h,ticks:S}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:o}=e;let p=a.thermistorR25;for(let h=0;h<=o;h+=5){const x=h+273.15,S=a.thermistorR25*Math.exp(a.thermistorBeta*(1/x-1/298.15));p=Math.max(p,S)}p=Math.ceil(p*1.08*10)/10;const m=0,u=p<=12?2:4,T=[];for(let h=0;h<=p+.001;h+=u)T.push({value:h,label:h.toFixed(0),min:m,max:p});return{minR:m,maxR:p,ticks:T}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),v=window.devicePixelRatio||1;J.width=L*v,J.height=F*v,ee.scale(v,v),K.width=P*v,K.height=$*v,ne.scale(v,v);function g(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const d=200,c=11;function b(){const e=Math.pow(a.bulbVolume/d,.3333333333333333);return c*e}function A(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,o=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,m=1.35-a.capillaryBore*.45;return Math.max(.1,o*p*m*e*.15)}function _(e){a.bathTemp<=8&&a.iceCubes.forEach(o=>{o.x+=o.speedX,o.y+=o.speedY,(o.x<65||o.x>175)&&(o.speedX*=-1),(o.y<195||o.y>210)&&(o.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(o=>{o.y-=o.speedY*(1+a.bathTemp/100),o.y<185&&(o.y=265,o.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(o=>{o.y-=o.speedY*(1+(a.bathTemp-80)/40),o.phase+=o.wobbleSpeed,o.x+=Math.sin(o.phase)*.3,o.y<185&&(o.y=260+Math.random()*10,o.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(o=>{o.x+=o.vx,o.y+=o.vy,o.alpha-=.005,(o.alpha<=0||o.y<130)&&(o.x=60+Math.random()*120,o.y=175+Math.random()*5,o.alpha=.2+Math.random()*.4)})}function H(e){let h=59,x=130,S=246;if(a.bathTemp<25){const q=a.bathTemp/25;h=Math.round(180-q*121),x=Math.round(210-q*80),S=Math.round(250-q*4)}else{const q=Math.min(1,(a.bathTemp-25)/125);h=Math.round(59+q*180),x=Math.round(130-q*100),S=Math.round(246-q*190)}if(a.bathTemp>40){const q=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let G=-25;G<=25;G+=6){const ie=q*(12+Math.sin(G*.4+D)*5);e.lineTo(55+130/2+G,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const k=e.createLinearGradient(55,190,55,280);k.addColorStop(0,`rgba(${h}, ${x}, ${S}, 0.25)`),k.addColorStop(1,`rgba(${h}, ${x}, ${S}, 0.55)`),e.fillStyle=k,e.beginPath(),e.moveTo(55,190);const C=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let q=55;q<=185;q+=5){const D=190+Math.sin(q*.15+N)*C;e.lineTo(q,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,o,p,m,u,T,h="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(o,p),e.lineTo(m,u),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(o,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const S=e.measureText(T).width+10,k=16,C=h==="left"?m:m-S,W=u-k/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(C,W,S,k,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(T,C+S/2,W+k/2+.5)}function w(e){const m=b(),u=250+Math.max(0,m-c)*.35,T=u-m-1,h=10+a.wallThickness*8,x=120-h/2,S=120+h/2,k=e.createLinearGradient(x,20,S,20);k.addColorStop(0,"rgba(209, 213, 219, 0.85)"),k.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),k.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),k.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),k.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(x,T),e.lineTo(x,25),e.arcTo(x,20,x+5,20,5),e.arcTo(S,20,S,25,5),e.lineTo(S,T),e.closePath(),e.fill(),e.stroke();const C=e.createRadialGradient(120-m*.2,u-m*.2,m*.1,120,u,m);C.addColorStop(0,"rgba(255, 255, 255, 0.8)"),C.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=C,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,u,m+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(h*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,T-20-8);const N=a.liquidType==="mercury",q=N?"#a1a1aa":"#ef4444",D=N?"#f4f4f5":"#fee2e2",G=210,ie=220,he=(G-40)/ie,ue=G-Math.min(ie,a.thermometerTemp)*he;e.fillStyle=q,e.fillRect(120-W/2,ue,W,T-ue),e.beginPath(),e.ellipse(120,ue,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-W/6,ue,W/3,T-ue);const oe=m*.9,re=e.createRadialGradient(120-oe*.2,u-oe*.2,oe*.1,120,u,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,u,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const pe=G-le*he;e.beginPath(),e.moveTo(x,pe),e.lineTo(x+4,pe),e.stroke(),e.fillText(`${le}°C`,x-22,pe+2.5)}a.showLabels&&(y(e,x+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,ue,230,ue-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,u,230,u+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function B(e){const h=e.createLinearGradient(115,20,125,20);h.addColorStop(0,"#71717a"),h.addColorStop(.3,"#f4f4f5"),h.addColorStop(.7,"#d4d4d8"),h.addColorStop(1,"#3f3f46"),e.fillStyle=h,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let x=205;e.moveTo(118,x);for(let N=0;N<8;N++)x+=4,e.lineTo(122,x),x+=4,e.lineTo(118,x);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,k=40,C=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,k,C,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,k+12,C-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",S+C-16,k+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,k+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function R(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const u=20,T=225,h=12,x=120-h/2,S=e.createLinearGradient(x,u,x+h,u);S.addColorStop(0,"rgba(229, 231, 235, 0.4)"),S.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),S.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),S.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=S,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(x,u,h,T-u,[0,0,3,3]),e.fill(),e.stroke();const k=7,C=e.createRadialGradient(120-k*.2,245-k*.2,k*.1,120,245,k);C.addColorStop(0,"#6b7280"),C.addColorStop(.7,"#1f2937"),C.addColorStop(1,"#09090b"),e.fillStyle=C,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,k,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,q=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,q,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,q-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+q-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,o,p,m,u,T,h,x,S){const{gx:k,gy:C,gw:W,gh:N}=o;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,m),e.lineTo(p,C+N),e.stroke(),e.beginPath(),e.moveTo(p,m),e.lineTo(k,m),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${u.toFixed(1)}${h}`,D=e.measureText(q).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(p-D/2,C+N+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,p,C+N+4),e.textAlign="right",e.textBaseline="middle";const G=`${T.toFixed(2)} ${x}`,ie=e.measureText(G).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(k-ie-2,m-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(G,k-7,m)}function E(e){const o=O(),{minL:p,maxL:m}=ae(),{minT:u,maxT:T,tickStep:h}=Z(),x=j(p,m),S=I(e,o,u,T,h,x),{gx:k,gy:C,gw:W,gh:N,axisFont:q,yLabelX:D,xLabelY:G,dotR:ie}={...o,...S};e.save(),e.translate(D,C+N/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",k+W/2,G);const ye=T,he=M(0,u,T,k,W),ue=z(X(0),p,m,C,N),oe=M(ye,u,T,k,W),re=z(X(ye),p,m,C,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(he,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentLength;if(le>=u&&le<=T){const be=M(le,u,T,k,W),Ce=z(pe,p,m,C,N);Q(e,o,be,Ce,le,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(be,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ce(e){const o=O(),{minR:p,maxR:m,ticks:u}=U(),T=Z(),h=I(e,o,T.minT,T.maxT,T.tickStep,u),{gx:x,gy:S,gw:k,gh:C,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...h};e.save(),e.translate(N,S+C/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+k/2,q);const{minT:G,maxT:ie}=T,ye=ie,he=M(0,G,ie,x,k),ue=z(V(0),p,m,S,C),oe=M(ye,G,ie,x,k),re=z(V(ye),p,m,S,C);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(he,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentResistance;if(le>=G&&le<=ie){const be=M(le,G,ie,x,k),Ce=z(pe,p,m,S,C);Q(e,o,be,Ce,le,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(be,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const o=O(),p=Z(),{minR:m,maxR:u,ticks:T}=Y(p),h=I(e,o,p.minT,p.maxT,p.tickStep,T),{gx:x,gy:S,gw:k,gh:C,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...h},{minT:G,maxT:ie}=p;e.save(),e.translate(N,S+C/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+k/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let ye=!1;for(let oe=G;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),pe=M(oe,G,ie,x,k),be=z(Math.min(u,le),m,u,S,C);be>=S&&be<=S+C&&(ye?e.lineTo(pe,be):(e.moveTo(pe,be),ye=!0))}e.stroke();const he=a.thermometerTemp,ue=a.currentThermistorR;if(he>=G&&he<=ie){const oe=M(he,G,ie,x,k),re=z(Math.min(u,ue),m,u,S,C);Q(e,o,oe,re,he,ue,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function fe(){ee.clearRect(0,0,L,F),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),H(ee),a.thermometerType==="liquid"?w(ee):a.thermometerType==="resistance"?B(ee):R(ee),ee.restore(),a.thermometerType==="liquid"?E(ne):a.thermometerType==="resistance"?ce(ne):se(ne)}function ge(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const o=n.querySelector("#tl-svg-formula-liquid-sub");if(o){const h=(a.liquidL100-a.liquidL0)/100;o.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          ...
          <text x="170" y="12" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${a.liquidL100.toFixed(1)} - ${a.liquidL0.toFixed(1)}</text>
          <text x="170" y="29" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">100</text>
          <text x="225" y="22" fill="#10b981" font-family="system-ui, sans-serif" font-weight="800" font-size="14">= ${h.toFixed(4)} cm/°C</text>
          ...
          <text x="235" y="68" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">${a.currentLength.toFixed(2)} - ${a.liquidL0.toFixed(1)}</text>
          <text x="235" y="85" fill="#10b981" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${h.toFixed(4)}</text>
          <text x="285" y="78" fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" font-size="15" class="tl-final-ans">= ${a.thermometerTemp.toFixed(1)}°C</text>
        </svg>
      ...
      `);const m=n.querySelector("#tl-svg-formula-resistance-sub");if(m){const h=(a.resistanceR100-a.resistanceR0)/100;m.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Calculate Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
          <text x="170" y="12" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${a.resistanceR100.toFixed(1)} - ${a.resistanceR0.toFixed(1)}</text>
          <text x="170" y="29" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">100</text>
          <text x="225" y="22" fill="#10b981" font-family="system-ui, sans-serif" font-weight="800" font-size="14">= ${h.toFixed(4)} Ω/°C</text>
          ...
          <text x="175" y="78" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">=</text>
          <line x1="195" y1="73" x2="275" y2="73" stroke="#fff" stroke-width="1.2" />
          <text x="235" y="68" fill="#6366f1" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="11" text-anchor="middle">${a.currentResistance.toFixed(2)} - ${a.resistanceR0.toFixed(1)}</text>
          <text x="235" y="85" fill="#10b981" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${h.toFixed(4)}</text>
          <text x="285" y="78" fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" font-size="15" class="tl-final-ans">= ${a.thermometerTemp.toFixed(1)}°C</text>
        </svg>
      `}const u=n.querySelector("#tl-svg-formula-thermistor");u&&(u.innerHTML=`
      ...
      `);const T=n.querySelector("#tl-svg-formula-thermistor-sub");if(T){const h=a.thermometerTemp+273.15;T.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            T<tspan dy="3" font-size="10">K</tspan><tspan dy="-3" fill="#10b981" font-weight="bold"> = ${h.toFixed(2)} K</tspan>
      ...
      `}}function Te(){const e=n.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:o,cu:p,interval:m}=ze(),u=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,h=n.querySelector("#tl-pane-q10a").classList.contains("active"),x=h?(u-o)/m*100:T,S=h?u:T/100*m+o,C=(W=>130-W/100*80)(x);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Liquid Core -->
          <rect x="84" y="${C}" width="4" height="${144-C}" fill="#3b82f6" />
          ...
          <!-- Current Point -->
          <text x="65" y="${C+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${x.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <!-- Liquid Core -->
          <rect x="104" y="${C}" width="4" height="${144-C}" fill="#f59e0b" />
          <circle cx="106" cy="144" r="8" fill="#f59e0b" />
          
          <!-- Ticks -->
          <!-- Faulty Ice Point Cf -->
          <line x1="112" y1="130" x2="120" y2="130" stroke="#f59e0b" stroke-width="1.5" />
          <text x="125" y="133" fill="#f59e0b" font-size="10" font-weight="bold" text-anchor="start">C<tspan dy="3" font-size="7">f</tspan><tspan dy="-3"> = ${o.toFixed(1)}°C</tspan></text>
          ...
          <text x="125" y="${C+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${S.toFixed(1)}°C</text>
        ...
        <line x1="86" y1="${C}" x2="236" y2="${C}" stroke="#34d399" stroke-dasharray="3,3" stroke-width="1.5" />
        <circle cx="86" cy="${C}" r="3" fill="#34d399" />
        <circle cx="236" cy="${C}" r="3" fill="#34d399" />
      </svg>
    `}function xe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const o=n.querySelector("#tl-bath-state");a.bathTemp<=0?o.textContent="Melting Ice Bath":a.bathTemp>=100?o.textContent="Boiling Water/Steam":a.bathTemp===150?o.textContent="Hot Cooking Oil":o.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let qe=null;function Re(e){a.lastTimestamp||(a.lastTimestamp=e);const o=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(o,.1),m=A(),u=p/m*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=u,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const T=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/T-1/298.15)),_(),fe(),xe(m),qe=requestAnimationFrame(Re)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),o=parseFloat(n.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,m=Number.isFinite(o)?o:105,u=m-p;return{cf:p,cu:m,interval:u}}function He(e){const o=Math.round(e*100)/100;return o>=0?o.toFixed(1):`(${o.toFixed(1)})`}function me(){const{cf:e,cu:o,interval:p}=ze(),m=n.querySelector("#tl-val-faulty-interval"),u=n.querySelector("#tl-faulty-error-a"),T=n.querySelector("#tl-faulty-error-b"),h=Math.abs(p)<.01;m.textContent=p.toFixed(1)+" °C";const x=n.querySelector("#tl-svg-formula-faulty-a"),S=n.querySelector("#tl-svg-formula-faulty-b");if(h){u.hidden=!1,u.textContent="C_u must differ from C_f (interval cannot be zero).",T.hidden=!1,T.textContent=u.textContent,x&&(x.innerHTML=""),S&&(S.innerHTML="");return}u.hidden=!0,T.hidden=!0;const k=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,C=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(k-e)/p*100,N=C/100*p+e;x&&(x.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${k.toFixed(1)} - ${He(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${o.toFixed(1)} - ${He(e)}</text>
      ...
      `),S&&(S.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${C.toFixed(1)} &times; ${p.toFixed(1)}</text>
      ...
      `),Te()}function ve(){const e=parseFloat(n.querySelector("#tl-input-q11-r").value)||0,o=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100,p=n.querySelector("#tl-svg-formula-resistance-solver");p&&(p.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function ke(){const e=a.thermometerTemp,o=(a.liquidL100-a.liquidL0)/100,p=a.liquidL0+o*e,m=n.querySelector("#tl-svg-formula-t-to-l");m&&(m.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
          <text x="170" y="12" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${a.liquidL100.toFixed(1)} - ${a.liquidL0.toFixed(1)}</text>
          <text x="170" y="29" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">100</text>
          <text x="225" y="22" fill="#10b981" font-family="system-ui, sans-serif" font-weight="800" font-size="14">= ${o.toFixed(4)} cm/°C</text>

          <!-- Step 2: Linear Equation -->
          <text x="10" y="52" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 2: L<tspan dy="3" font-size="9">T</tspan><tspan dy="-3"> = L</tspan><tspan dy="3" font-size="9">0</tspan><tspan dy="-3"> + m &times; T</tspan></text>
          
          <!-- Step 3: Calculation -->
          <text x="10" y="82" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 3: L<tspan dy="3" font-size="9">T</tspan><tspan dy="-3"> = </tspan>${a.liquidL0.toFixed(1)} + ${o.toFixed(4)} &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} cm</tspan></text>
        </svg>
      `)}function Oe(){const e=a.thermometerTemp,o=(a.resistanceR100-a.resistanceR0)/100,p=a.resistanceR0+o*e,m=n.querySelector("#tl-svg-formula-t-to-r");m&&(m.innerHTML=`
        <svg height="100" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 1: Slope (m) =</text>
          <line x1="125" y1="17" x2="215" y2="17" stroke="#fff" stroke-width="1.2" />
          <text x="170" y="12" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${a.resistanceR100.toFixed(1)} - ${a.resistanceR0.toFixed(1)}</text>
          <text x="170" y="29" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">100</text>
          <text x="225" y="22" fill="#10b981" font-family="system-ui, sans-serif" font-weight="800" font-size="14">= ${o.toFixed(4)} Ω/°C</text>

          <!-- Step 2: Linear Equation -->
          <text x="10" y="52" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 2: R<tspan dy="3" font-size="9">T</tspan><tspan dy="-3"> = R</tspan><tspan dy="3" font-size="9">0</tspan><tspan dy="-3"> + m &times; T</tspan></text>
          
          <!-- Step 3: Calculation -->
          <text x="10" y="82" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">Step 3: R<tspan dy="3" font-size="9">T</tspan><tspan dy="-3"> = </tspan>${a.resistanceR0.toFixed(1)} + ${o.toFixed(4)} &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} Ω</tspan></text>
        </svg>
      `)}function de(){me(),ve(),ke(),Oe()}function $e(e,o){n.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=o,n.querySelector("#tl-bath-temp-slider").value=o,de()})}function lt(){n.querySelectorAll(".tl-tab-btn").forEach(u=>{u.addEventListener("click",()=>{n.querySelectorAll(".tl-tab-btn").forEach(h=>h.classList.remove("active")),n.querySelectorAll(".tl-tab-content").forEach(h=>h.classList.remove("active")),u.classList.add("active");const T=u.getAttribute("data-tl-tab");n.querySelector("#tl-tab-"+T).classList.add("active"),a.thermometerType=T,de()})}),n.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{a.showLabels=!a.showLabels,n.querySelector("#tl-lbl-toggle-labels").textContent=a.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),n.querySelector("#tl-bath-temp-slider").addEventListener("input",u=>{a.bathTemp=parseFloat(u.target.value),de()}),$e("tl-btn-preset-ice",0),$e("tl-btn-preset-room",25),$e("tl-btn-preset-steam",100),$e("tl-btn-preset-oil",150),n.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",n.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",n.querySelector("#tl-card-alcohol").className="tl-seg-btn",de()}),n.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",n.querySelector("#tl-card-mercury").className="tl-seg-btn",n.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",de()}),n.querySelector("#tl-slider-bulb-vol").addEventListener("input",u=>{a.bulbVolume=parseFloat(u.target.value),n.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),n.querySelector("#tl-slider-wall-thick").addEventListener("input",u=>{a.wallThickness=parseFloat(u.target.value),n.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),n.querySelector("#tl-slider-capillary-bore").addEventListener("input",u=>{a.capillaryBore=parseFloat(u.target.value),n.querySelector("#tl-val-capillary-bore").textContent=a.capillaryBore.toFixed(2)+" mm"}),n.querySelector("#tl-slider-liquid-l0").addEventListener("input",u=>{a.liquidL0=parseFloat(u.target.value),n.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-liquid-l100").addEventListener("input",u=>{a.liquidL100=parseFloat(u.target.value),n.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",de()}),n.querySelector("#tl-slider-resistance-r0").addEventListener("input",u=>{a.resistanceR0=parseFloat(u.target.value),n.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-resistance-r100").addEventListener("input",u=>{a.resistanceR100=parseFloat(u.target.value),n.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",de()}),n.querySelector("#tl-slider-thermistor-r25").addEventListener("input",u=>{a.thermistorR25=parseFloat(u.target.value),n.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",n.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",de()}),n.querySelector("#tl-slider-thermistor-beta").addEventListener("input",u=>{a.thermistorBeta=parseFloat(u.target.value),n.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",n.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",de()}),n.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.add("active"),n.querySelector("#tl-btn-solve-q10b").classList.remove("active"),n.querySelector("#tl-pane-q10a").classList.add("active"),n.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),n.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.remove("active"),n.querySelector("#tl-btn-solve-q10b").classList.add("active"),n.querySelector("#tl-pane-q10a").classList.remove("active"),n.querySelector("#tl-pane-q10b").classList.add("active"),me()}),n.querySelector("#tl-input-faulty-cf").addEventListener("input",me),n.querySelector("#tl-input-faulty-cu").addEventListener("input",me),n.querySelector("#tl-input-q10a-cm").addEventListener("input",me),n.querySelector("#tl-input-q10b-t").addEventListener("input",me),n.querySelector("#tl-input-q11-r").addEventListener("input",ve);const p=n.querySelector("#tl-input-t-to-l");p&&p.addEventListener("input",de);const m=n.querySelector("#tl-input-t-to-r");m&&m.addEventListener("input",de)}if(r.type){const e=n.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return n.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===l?e.classList.add("active"):e.classList.remove("active")}),n.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===l?e.classList.add("active"):e.classList.remove("active")}),g(),lt(),de(),qe=requestAnimationFrame(Re),n._thermometerLabCleanup=()=>{qe&&cancelAnimationFrame(qe)},n}const Me=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],De=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],$t=[["thermometer","topic.thermometer"]],Qe=["liquid","resistance","thermistor"],At={liquid:t=>Pe(t,{type:"liquid"}),resistance:t=>Pe(t,{type:"resistance"}),thermistor:t=>Pe(t,{type:"thermistor"})};function Et(t){return s({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title"}[t]||t)}function Ee(){return Se()==="zh-Hant"?"zhHant":"en"}async function Ft(t,r){const l=`./${t}/${r}`;try{return(await fetch(l,{method:"HEAD"})).ok}catch{return!1}}async function Ne(t){return Ft("notes",t)}function It(t){let r="topics",l="liquid",i=0,f="all",n=!1,a=null,L={main:null},F=null;function te(){if(L.main){if(r==="topics"?L.main.innerHTML=$():r==="notes"?L.main.innerHTML=Z():r==="tools"?L.main.innerHTML=z():r==="worksheets"?L.main.innerHTML=at(s,{topics:$t,paperTitleKey:"worksheets.paperTitleHeat"}):r==="flashcards"?L.main.innerHTML=ae():r==="summary"&&(L.main.innerHTML=J()),r==="notes"&&M(),r==="tools"&&I(),r==="worksheets"){const v=Je.filter(g=>De.includes(g.topic));nt(t,v,s,Ee,{topicFilter:(g,d)=>d.includes("thermometer")?De.includes(g.topic):d.includes(g.topic)})}r==="flashcards"&&Y(),r==="summary"&&ee()}}function P(){a==null||a.destroy(),a=tt(t,{subtitleKey:"strand.heat.subtitle",activeSection:r,onSection:v=>{r==="tools"&&v!=="tools"&&F!=null&&F._thermometerLabCleanup&&(F._thermometerLabCleanup(),F=null),r=v,a.updateSection(r),te()},onLang:()=>P()}),L.main=a.main,a.updateSection(r),te()}function $(){return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Me.map(v=>{const g=v.tool?`<button class="btn primary" type="button" data-go-tool="${v.tool}">${s("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${s("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${s(v.titleKey)}</h3>
              ${g}
            </div>`}).join("")}
        </div>
      </section>`}function O(v){const g=v.target.closest("[data-go-tool]");if(g){const c=g.getAttribute("data-go-tool");Qe.includes(c)?l=c:l="liquid",r="tools",a.updateSection(r),te();return}const d=v.target.closest("[data-go-section]");(d==null?void 0:d.getAttribute("data-go-section"))==="notes"&&(r="notes",a.updateSection(r),te())}function Z(){return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${Me.map(v=>`
            <div class="card" data-note-card="${v.id}">
              <h3>${s(`notes.card.${v.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function M(){const v=Ee();for(const g of Me){const d=t.querySelector(`[data-note-card="${g.id}"]`);if(!d)continue;const c=d.querySelector("[data-note-body]"),b=v==="zhHant"?g.fileZh:g.fileEn,A=await Ne(b),_=`./notes/${b}`;A?c.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${g.id}`)}" src="${_}"></iframe>
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:c.innerHTML=`<p class="lead">${s("notes.missing")}</p>`}}function z(){return`
      <section class="panel panel--tools">
        <h2>${s("tools.title")}</h2>
        <p class="lead">${s("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Qe.map(v=>`<button type="button" data-tool="${v}" class="${l===v?"active":""}">${Et(v)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function I(){const v=t.querySelector("[data-tool-list]"),g=t.querySelector("[data-tool-stage]");!v||!g||(v.querySelectorAll("button").forEach(d=>{d.addEventListener("click",()=>{l=d.getAttribute("data-tool"),v.querySelectorAll("button").forEach(c=>c.classList.toggle("active",c.getAttribute("data-tool")===l)),j(g)})}),j(g))}function j(v){v.innerHTML="",F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup();const g=At[l];g&&(F=g(s),v.appendChild(F))}function ae(){return`
      <section class="panel">
        <h2>${s("flashcards.title")}</h2>
        <p class="lead">${s("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}function X(){return et.filter(v=>De.includes(v.topic))}function U(){const v=X();return f==="all"||f==="thermometry"?v:v.filter(g=>g.topic===f)}function V(){const v=U(),g=t.querySelector("[data-flash-progress]");if(!v.length){i=0;const H=t.querySelector("[data-flash-front]");H&&(H.textContent=""),g&&(g.hidden=!0,g.textContent="");return}i=Math.max(0,Math.min(i,v.length-1));const d=v[i],c=t.querySelector("[data-flash-front]"),b=t.querySelector("[data-flash-label]");if(!c)return;g&&(g.hidden=!1,g.textContent=s("flashcards.progress").replace("{current}",String(i+1)).replace("{total}",String(v.length)));const A=Ee(),_=d[A]||d.en;b&&(b.hidden=!1,b.textContent=s(n?"flashcards.answer":"flashcards.question")),c.textContent=n?_.a:_.q}function Y(){const v=t.querySelector("[data-flash-deck]");v.value=f,v.addEventListener("change",()=>{f=v.value,i=0,n=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{n=!n,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",g=>{g.stopPropagation(),n=!n,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const g=U();i=(i-1+g.length)%g.length,n=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const g=U();i=(i+1)%g.length,n=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const g=U();i=Math.floor(Math.random()*g.length),n=!1,V()}),V()}function J(){return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${Me.map(v=>`
            <div class="card" data-summary-card="${v.id}">
              <h3>${s(`summary.item.${v.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function ee(){const v=Ee();for(const g of Me){const d=t.querySelector(`[data-summary-card="${g.id}"]`);if(!d)continue;const c=d.querySelector("[data-summary-body]"),b=v==="zhHant"?g.fileZh:g.fileEn,A=await Ne(b),_=`./notes/${b}`;A?c.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${g.id}`)}" src="${_}"></iframe>
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const K=()=>P(),ne=v=>O(v);return window.addEventListener("s3phy:lang",K),t.addEventListener("click",ne),P(),()=>{window.removeEventListener("s3phy:lang",K),t.removeEventListener("click",ne),F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup(),a==null||a.destroy()}}const Ve={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};ut();const Ye="s3phy_splash_seen",rt={optics:Rt,heat:It};let _e=null,Le=null;function Wt(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(rt,r)?r:null}function Pt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function ot(t){_e==null||_e(),_e=null,Le==null||Le(),Le=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&Pt(),Le=pt(r);return}const l=`#/${t}`;if(location.hash!==l){location.hash=l;return}_e=rt[t](r)??null}function st(){ot(Wt())}function Dt(){return"./images/uniplus-logo.png"}function Ot(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Dt()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Bt(t,r){const l=[...Ve.en,...Ve.zhHant],i=()=>{if(!t.parentElement)return;const f=document.createElement("div");f.className="splash-danmaku-item",f.textContent=l[Math.floor(Math.random()*l.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,L=Math.random()*12+10;f.style.top=`${n}%`,f.style.fontSize=`${a}rem`,f.style.animationDuration=`${L}s`,r.appendChild(f),f.addEventListener("animationend",()=>f.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let f=0;f<4;f+=1)window.setTimeout(i,f*1e3)}function Gt(t){const r=t.querySelector("#splashLogoWrap"),l=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{l==null||l.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),l&&Bt(t,l)},1600)}function Ue(){st()}function jt(){let t=!1;try{t=sessionStorage.getItem(Ye)==="1"}catch{}if(t){Ue();return}const r=Ot();document.body.insertBefore(r,document.body.firstChild),Gt(r);const l=r.querySelector("#splashStart"),i=()=>{r.remove(),Ue()};l.addEventListener("click",()=>{try{sessionStorage.setItem(Ye,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",st);window.addEventListener("s3phy:strand",t=>{ot(t.detail??null)});jt();
