...
`;function vt(){if(document.getElementById(Ne))return;const t=document.createElement("style");t.id=Ne,t.textContent=bt,document.head.appendChild(t)}function yt(t){vt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=r.querySelector(".rml-canvas"),i=o.getContext("2d"),d=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),q=r.querySelector('[data-rml-disp="inc"]'),E=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,G=380,Z=300,L="#22d3ee",H="bold 17px system-ui, sans-serif";let F=0,B=-140,ae=!0,X=!0,U=!0,V=!0;function Y(h){return h*Math.PI/180}function J(h,u,c,g,z,R=2,I=!1){i.beginPath(),i.lineWidth=R,i.strokeStyle=z,i.setLineDash(I?[6,6]:[]);const y=h+Math.cos(Y(c))*g,x=u+Math.sin(Y(c))*g;return i.moveTo(h,u),i.lineTo(y,x),i.stroke(),i.setLineDash([]),{x:y,y:x}}function ee(h,u,c,g,z,R=14){const I=c-h,y=g-u,x=Math.hypot(I,y);if(x<1e-6)return;const D=I/x,_=y/x,Q=c-D*R,A=g-_*R,de=.45*R;i.beginPath(),i.fillStyle=z,i.moveTo(c,g),i.lineTo(Q-_*de,A+D*de),i.lineTo(Q+_*de,A-D*de),i.closePath(),i.fill()}function K(h,u,c,g,z,R=25){i.beginPath(),i.strokeStyle=g,i.lineWidth=2;const I=Math.min(h,u),y=Math.max(h,u);if(i.arc($,G,c,Y(I),Y(y),!1),i.stroke(),z){const x=(I+y)/2,D=$+Math.cos(Y(x))*(c+R),_=G+Math.sin(Y(x))*(c+R);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=g,i.fillText(z,D,_),i.restore()}}function ne(h,u,c,g,z){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,G),i.lineTo($+200,G),i.stroke(),i.setLineDash([]),i.lineCap="butt";const R=$+Math.cos(Y(h))*Z,I=G+Math.sin(Y(h))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(R,I),i.lineTo($,G),i.stroke();const y=(R+$)*.5,x=(I+G)*.5,D=Math.hypot($-R,G-I)||1,_=($-R)/D,Q=(G-I)/D;if(ee(y-_*28,x-Q*28,y,x,"#fff",16),i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),R,I-12),i.restore(),ae){const A=J($,G,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),A.x+6,A.y-4),i.restore()}if(X){const A=J($,G,g,Z,"#00e676",2,!1);ee($,G,A.x,A.y,"#00e676",16),i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),A.x,A.y-14),i.restore()}i.save(),i.translate($,G),i.rotate(Y(F)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let A=-190;A<200;A+=15)i.moveTo(A,0),i.lineTo(A-5,8);if(i.stroke(),i.restore(),U){const A=J($,G,u,Z-40,L,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=L,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),A.x+6,A.y-4),i.restore()}if(V){const A=J($,G,c,Z,L,4);ee($,G,A.x,A.y,L,16),Math.abs(F)>.5&&(i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=L,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),A.x,A.y-14),i.restore())}if(U&&K(h,u,100,"#ffcc00",`i=${z.toFixed(0)}°`,25),U&&V&&K(u,c,100,L,`r=${z.toFixed(0)}°`,25),ae&&U&&Math.abs(F)>.5&&K(-90,u,50,"#ffcc00",`θ=${Math.abs(F)}°`,20),X&&V&&Math.abs(F)>.5){const A=c-g;K(g,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${A.toFixed(0)}°`,40)}}function v(){F=parseFloat(d.value),B=parseFloat(n.value);const h=F>0?"+":"";a.textContent=`${h}${F}°`,q.textContent=`${B}°`;const u=-90,c=Math.abs(B-u),g=u+c,z=-90+F,R=Math.abs(B-z),I=z+R,y=I-g;E.textContent=`${R.toFixed(1)}°`,te.textContent=`${R.toFixed(1)}°`;const x=y>0?"+":"";P.textContent=`${x}${y.toFixed(1)}°`,ne(B,z,I,g,R)}return r.querySelectorAll("[data-rml-toggle]").forEach(h=>{h.addEventListener("click",()=>{const u=h.getAttribute("data-rml-toggle");u==="orig-norm"&&(ae=!ae),u==="orig-ray"&&(X=!X),u==="new-norm"&&(U=!U),u==="new-ray"&&(V=!V),h.classList.toggle("active"),v()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{d.value="0",v()}),d.addEventListener("input",v),n.addEventListener("input",v),v(),r}function wt(t){const r=document.createElement("div");r.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;return o.src=`${d}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(o),r}function xt(t,r={}){const o=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",d=document.createElement("div");d.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",q=a.endsWith("/")?a:`${a}/`;return n.src=`${q}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",d.appendChild(n),d}function qt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;function n(){return`${d}em-spectrum/index.html?lang=${encodeURIComponent(ce())}`}o.src=n(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function St(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const o=r.querySelector("[data-r]"),i=r.querySelector("[data-g]"),d=r.querySelector("[data-b]"),n=r.querySelector(".rgb-mixer-canvas"),a=r.querySelector(".rgb-mixer-stage"),q=n.getContext("2d");function E(L){return L.toString(16).padStart(2,"0")}function te(L,H,F){const B=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),X=B/2,U=ae/2,V=Math.min(B,ae)*.34,Y=V*.5,J=Math.sqrt(3)/2;q.clearRect(0,0,B,ae),q.fillStyle="#000",q.fillRect(0,0,B,ae);const ee=[{x:X,y:U-Y,rgb:[255,0,0],val:L},{x:X-Y*J,y:U+Y*.5,rgb:[0,255,0],val:H},{x:X+Y*J,y:U+Y*.5,rgb:[0,0,255],val:F}];q.globalCompositeOperation="lighter",ee.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[v,h,u]=K.rgb,c=q.createRadialGradient(K.x,K.y,0,K.x,K.y,V);c.addColorStop(0,`rgba(${v},${h},${u},${ne})`),c.addColorStop(.65,`rgba(${v},${h},${u},${ne})`),c.addColorStop(.85,`rgba(${v},${h},${u},${ne*.5})`),c.addColorStop(1,`rgba(${v},${h},${u},0)`),q.fillStyle=c,q.beginPath(),q.arc(K.x,K.y,V,0,Math.PI*2),q.fill()}),q.globalCompositeOperation="source-over"}function P(){const L=a.getBoundingClientRect(),H=Math.max(200,Math.min(L.width-8,L.height-8,720)),F=window.devicePixelRatio||1;n.width=H*F,n.height=H*F,n.style.width=`${H}px`,n.style.height=`${H}px`,q.setTransform(F,0,0,F,0,0),te(+o.value,+i.value,+d.value)}function $(){const L=+o.value,H=+i.value,F=+d.value,B=`rgb(${L}, ${H}, ${F})`,ae=`#${E(L)}${E(H)}${E(F)}`;r.querySelector("[data-r-val]").textContent=L,r.querySelector("[data-g-val]").textContent=H,r.querySelector("[data-b-val]").textContent=F,r.querySelector("[data-r-bar]").style.width=`${L/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${H/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${F/255*100}%`,o.style.setProperty("--fill",`${L/255*100}%`),i.style.setProperty("--fill",`${H/255*100}%`),d.style.setProperty("--fill",`${F/255*100}%`);const X=r.querySelector("[data-swatch]");X.style.backgroundColor=B,X.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${B}`),r.querySelector("[data-rgb-text]").textContent=B,r.querySelector("[data-hex-text]").textContent=ae,te(L,H,F)}function G(L,H,F){o.value=L,i.value=H,d.value=F,$()}return[o,i,d].forEach(L=>L.addEventListener("input",$)),r.querySelectorAll(".rgb-presets button").forEach(L=>{L.addEventListener("click",()=>{G(+L.dataset.r,+L.dataset.g,+L.dataset.b)})}),new ResizeObserver(()=>P()).observe(a),requestAnimationFrame(()=>{P(),$()}),r}const kt=["topics","notes","tools","worksheets","flashcards","summary"],Tt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function rt(t,{subtitleKey:r,activeSection:o,onSection:i,onLang:d}){t.innerHTML=`
    <header class="site-header">
      <div class="site-header__brand">
        ...
        <div class="brand-text-block">
          <h1 class="site-title">${l("app.title")}</h1>
          <p class="site-subtitle" data-hub-subtitle>${l(r)}</p>
        </div>
      </div>
      <div class="site-header__actions">
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),q=t.querySelector("[data-lang]"),E=t.querySelector("[data-strand-back]");let te=o;function P(L){te=L,a.innerHTML=kt.map(H=>`<button type="button" class="${L===H?"active":""}" data-sec="${H}">${l(Tt[H])}</button>`).join(""),a.querySelectorAll("button").forEach(H=>{H.addEventListener("click",()=>i(H.getAttribute("data-sec")))})}function $(){q.innerHTML=`
      <button type="button" data-set-lang="en" class="${ce()==="en"?"active":""}">${l("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${ce()==="zh-Hant"?"active":""}">${l("lang.zhHant")}</button>
    `,q.querySelectorAll("button").forEach(L=>{L.addEventListener("click",()=>{at(L.getAttribute("data-set-lang")),d()})})}function G(){t.querySelector("[data-hub-subtitle]").textContent=l(r),E.textContent=l("strand.back"),t.querySelector("[data-hub-footer]").textContent=l("footer.conventions"),t.querySelector(".site-title").textContent=l("app.title")}const Z=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return E.addEventListener("click",Z),P(o),$(),{main:n,updateSection(L){P(L)},refreshLabels(){G(),P(te),$()},destroy(){E.removeEventListener("click",Z)}}}const We=["A","B","C","D"];function Ve(t){const r=t.slice();for(let o=r.length-1;o>0;o-=1){const i=Math.floor(Math.random()*(o+1));[r[o],r[i]]=[r[i],r[o]]}return r}function Ct(t,r,o){return t.filter(i=>{if(o)return o(i,r);const d=i.topic;return!!(r.includes(d)||r.includes("rotatingMirror")&&d==="reflection"||r.includes("refraction")&&d==="refraction"||r.includes("tir")&&d==="tir"||d==="convex"&&r.includes("convex")||d==="concave"&&r.includes("concave"))})}function Mt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ot(t,r={}){const o=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=r.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="ws-controls no-print">
        ...
        <div class="grid cols-2" data-ws-topics>
          ${o.map(([d,n])=>`<label class="card ws-topic-card">
            <input type="checkbox" data-ws-topic="${d}" checked />
            <span>${t(n)}</span>
          </label>`).join("")}
        </div>
    ...
    </section>`}function st(t,r,o,i,d={}){var g,z,R,I;const n={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),q=t.querySelector("[data-ws-preview-area]"),E=t.querySelector("[data-ws-out]"),te=t.querySelector("[data-ws-body]"),P=t.querySelector("[data-ws-paper]"),$=t.querySelector("[data-ws-tabs]"),G=t.querySelector("[data-ws-practice-actions]"),Z=t.querySelector("[data-ws-score]"),L=t.querySelector("[data-ws-score-val]"),H=t.querySelector("[data-ws-summary]"),F=t.querySelector("[data-ws-date-row]"),B=t.querySelector("[data-ws-date-print]"),ae=t.querySelector("[data-ws-date-today]"),X=t.querySelector("[data-ws-date-label]");if(!a||!te)return;function U(){return i()}function V(){n.userAnswers={},n.wrongAttempts={},n.resolved={},Z.hidden=!0,H.hidden=!0}function Y(){return n.items.length>0&&n.items.every((y,x)=>n.resolved[x])}function J(){let y=0;n.items.forEach((D,_)=>{if(!n.resolved[_])return;const Q=D[U()]||D.en;n.userAnswers[_]===Q.a&&(y+=1)}),Object.keys(n.resolved).length>0&&(L.textContent=`${y}/${n.items.length}`,Z.hidden=!1)}function ee(y){n.tab=y,$==null||$.querySelectorAll("[data-ws-tab]").forEach(x=>{x.classList.toggle("active",x.getAttribute("data-ws-tab")===y)}),G&&(G.hidden=y!=="practice"),F&&(F.hidden=y!=="practice"),B&&(B.hidden=!n.dateStr,B.textContent=n.dateStr?`${o("worksheets.date")}: ${n.dateStr}`:""),P==null||P.classList.toggle("practice-mode",y==="practice"),ne()}function K(y,x,D){const _=y[U()]||y.en,Q=We,A=x+1,de=y.section?`<span class="q-section">${xe(y.section)}</span>`:"";if(D==="answer"){const he=_.choices.map((ye,Te)=>`<li class="${Te===_.a?"choice-correct":""}"><strong>${Q[Te]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${A} ${de}</h4>
        <p>${xe(_.q)}</p>
        <ol class="choice-list">${he}</ol>
        <p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Q[_.a]}</p>
        <p class="q-exp"><em>${xe(_.exp)}</em></p>
      </div>`}const se=n.userAnswers[x],pe=n.wrongAttempts[x]||0,be=n.resolved[x],ke=be&&se===_.a,qe=be&&se!==_.a;let Se="";pe===1&&!be?Se=`<p class="q-hint"><strong>${o("worksheets.hint")}:</strong> ${xe(_.hint||_.exp)}</p>`:qe&&(Se=`<p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Q[_.a]}</p>
        <p class="q-exp q-summary"><em>${xe(_.exp)}</em></p>`);const _e=ke?"correct":qe?"incorrect":"",ze=_.choices.map((he,ye)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${x}" value="${ye}" data-ws-q="${x}" data-ws-choice="${ye}"${se===ye?" checked":""}${be?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${Q[ye]}.</strong> ${xe(he)}
          </label>
        </li>`).join("");return`<div class="question-row ${_e}" data-ws-row="${x}">
      <div class="q-header"><h4>Q${A} ${de}</h4>${ke?'<span class="result-icon">✓</span>':qe?'<span class="result-icon">✗</span>':""}</div>
      <p>${xe(_.q)}</p>
      <ol class="choice-list choice-list--radio">${ze}</ol>
      ${Se}
    </div>`}function ne(){n.items.length&&(te.innerHTML=n.items.map((y,x)=>K(y,x,n.tab)).join(""),v())}function v(){n.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(y=>{y.addEventListener("change",()=>{const x=Number(y.getAttribute("data-ws-q"));if(n.resolved[x])return;const D=Number(y.getAttribute("data-ws-choice")),_=n.items[x][U()]||n.items[x].en;n.userAnswers[x]=D,D===_.a?n.resolved[x]=!0:(n.wrongAttempts[x]=(n.wrongAttempts[x]||0)+1,n.wrongAttempts[x]>=2&&(n.resolved[x]=!0)),J(),Y()&&h(),ne()})})}function h(){const y=n.items.length;let x=0,D=0;const _={};n.items.forEach((se,pe)=>{const be=se[U()]||se.en;if(n.userAnswers[pe]===be.a)x+=1,(n.wrongAttempts[pe]||0)===0&&(D+=1);else if(n.resolved[pe]){const qe=se.section||se.topic;_[qe]=(_[qe]||0)+1}});const Q=y?Math.round(x/y*100):0;let A=o("worksheets.revisionFair");Q>=90?A=o("worksheets.revisionExcellent"):Q>=70?A=o("worksheets.revisionGood"):Q<50&&(A=o("worksheets.revisionLow"));const de=Object.entries(_).sort((se,pe)=>pe[1]-se[1]).map(([se,pe])=>`<li>${xe(se)} (${pe})</li>`).join("");H.innerHTML=`
      <h4>${o("worksheets.sessionSummary")}</h4>
      <p>${o("worksheets.score")}: <strong>${x}/${y}</strong> (${Q}%)</p>
      <p>${o("worksheets.firstTry")}: <strong>${D}/${y}</strong></p>
      <p>${o("worksheets.revisionSuggestions")}: ${A}</p>
      ${de?`<p>${o("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,H.hidden=!1}function u(y){const x=U(),D=n.items.map((_,Q)=>{const A=_[x]||_.en,de=A.choices.map((pe,be)=>`${We[be]}. ${pe}`).join("<br/>"),se=y?`<p><b>${o("worksheets.answer")}:</b> ${We[A.a]}<br/><i>${A.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${A.q}<br/>${de}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${o("worksheets.paperTitle")}</title></head>
<body><h2>${o("worksheets.paperTitle")}</h2>
${n.dateStr&&!y?`<p>${o("worksheets.date")}: ${n.dateStr}</p>`:""}
${D}</body></html>`}function c(y){const x=u(y),D=new Blob(["\uFEFF",x],{type:"application/msword"}),_=document.createElement("a");_.href=URL.createObjectURL(D),_.download=y?"worksheet-answers.doc":"worksheet.doc",_.click(),URL.revokeObjectURL(_.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),x=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),D=Ct(r,x,d.topicFilter),_=Ve(D).slice(0,Math.min(y,D.length||1));n.items=_.length?_:Ve(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",q.hidden=!1,E.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),G&&(G.hidden=!1),F&&(F.hidden=!1),B&&(B.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const x=y.target.closest("[data-ws-tab]");!x||!n.items.length||ee(x.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=Mt(),X.textContent=`${o("worksheets.date")}: ${n.dateStr}`),B&&(B.hidden=!n.dateStr,B.textContent=n.dateStr?`${o("worksheets.date")}: ${n.dateStr}`:"")}),(g=t.querySelector("[data-ws-word-p]"))==null||g.addEventListener("click",()=>c(!1)),(z=t.querySelector("[data-ws-word-a]"))==null||z.addEventListener("click",()=>c(!0)),(R=t.querySelector("[data-ws-print-p]"))==null||R.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(I=t.querySelector("[data-ws-print-a]"))==null||I.addEventListener("click",()=>{ee("answer"),window.print()})}const Lt=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Rt={rotatingMirror:t=>yt(t),refractionTir:t=>wt(t),lens:(t,r)=>xt(t,{defaultKind:r}),rgbMixer:t=>St(t),em:t=>qt(t)};function _t(t){return l({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return ce()==="zh-Hant"?"zhHant":"en"}async function Oe(t,r){const o=`./${t}/${r}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function zt(t){return Oe("notes",t)}function Ht(t){let r="topics",o="rotatingMirror",i="convex",d=0,n="all",a=!1,q=null,E={main:null};function te(){E.main&&(r==="topics"?E.main.innerHTML=$():r==="notes"?E.main.innerHTML=Z():r==="tools"?E.main.innerHTML=H():r==="worksheets"?E.main.innerHTML=ot(l):r==="flashcards"?E.main.innerHTML=ae():r==="summary"&&(E.main.innerHTML=K()),r==="notes"&&L(),r==="tools"&&F(),r==="worksheets"&&st(t,nt,l,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){q==null||q.destroy(),q=rt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:u=>{r=u,q.updateSection(r),te()},onLang:()=>P()}),E.main=q.main,q.updateSection(r),te()}function $(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([c,g])=>{const z=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,R=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${l(g)}</h3>
              <button class="btn primary" type="button" data-go-tool="${z}"${R?` data-lens-kind="${R}"`:""}>${l("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function G(u){const c=u.target.closest("[data-go-tool]");if(!c)return;r="tools",o=c.getAttribute("data-go-tool");const g=c.getAttribute("data-lens-kind");(g==="convex"||g==="concave")&&(i=g),q.updateSection(r),te()}function Z(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${u.map(c=>{const g=l(`notes.card.${c.key}`);return`
            <div class="card" data-note-card="${c.key}">
              <h3>${g}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function L(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Ae();for(const g of u){const z=t.querySelector(`[data-note-card="${g.key}"]`);if(!z)continue;const R=z.querySelector("[data-note-body]"),I=c==="zhHant"?g.fileZh:g.fileEn,y=await zt(I),x=`./notes/${I}`;y?R.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${g.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:R.innerHTML=`<p class="lead">${l("notes.missing")}</p>
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Lt.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${_t(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function F(){const u=t.querySelector("[data-tool-list]"),c=t.querySelector("[data-tool-stage]");!u||!c||(u.querySelectorAll("button").forEach(g=>{g.addEventListener("click",()=>{o=g.getAttribute("data-tool"),u.querySelectorAll("button").forEach(z=>z.classList.toggle("active",z.getAttribute("data-tool")===o)),B(c)})}),B(c))}function B(u){u.innerHTML="";const c=Rt[o];if(!c)return;const g=o==="lens"?c(l,i):c(l);u.appendChild(g)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(u){return!!(u!=null&&u.front)}function U(u){return`./${String(u).replace(/^\.\//,"")}`}function V(){return it.slice()}function Y(){const u=V(),c=n==="rotatingMirror"?"reflection":n;if(c==="all"){const z=u.filter(R=>R.topic!=="convex"&&R.topic!=="concave");return[...je,...Be,...Qe,...z]}if(c==="reflection")return je.slice();if(c==="convex")return Be.slice();if(c==="concave")return Qe.slice();if(c==="refractionTir"){const z=u.filter(R=>R.topic==="refraction"||R.topic==="tir");return z.length?z:u}const g=u.filter(z=>z.topic===c);return g.length?g:u}function J(){const u=Y(),c=t.querySelector("[data-flash-progress]");if(!u.length){d=0;const D=t.querySelector("[data-flash-front]"),_=t.querySelector("[data-flip-card]");D&&(D.textContent=""),_&&_.classList.remove("flashcard-surface--image"),c&&(c.hidden=!0,c.textContent="");return}d=Math.max(0,Math.min(d,u.length-1));const g=u[d],z=t.querySelector("[data-flash-front]"),R=t.querySelector("[data-flip-card]"),I=t.querySelector("[data-flash-label]");if(!z||!R)return;if(c&&(c.hidden=!1,c.textContent=l("flashcards.progress").replace("{current}",String(d+1)).replace("{total}",String(u.length))),X(g)){const D=g.back&&g.back!==g.front;R.classList.add("flashcard-surface--image"),I&&(D?(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")):I.hidden=!0);const _=a&&g.back?g.back:g.front,Q=g.alt||g.title||"";z.innerHTML=`<img src="${U(_)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}R.classList.remove("flashcard-surface--image");const y=Ae(),x=g[y]||g.en;I&&(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")),z.textContent=a?x.a:x.q}function ee(){n==="rotatingMirror"&&(n="reflection");const u=t.querySelector("[data-flash-deck]");u.value=n,u.addEventListener("change",()=>{n=u.value,d=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",c=>{c.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const c=Y();d=(d-1+c.length)%c.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const c=Y();d=(d+1)%c.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const c=Y();d=Math.floor(Math.random()*c.length),a=!1,J()}),J()}function K(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${u.map(c=>{const g=l(`summary.item.${c.key}`);return`
            <div class="card" data-summary-card="${c.key}">
              <h3>${g}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function ne(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],c=Ae();for(const g of u){const z=t.querySelector(`[data-summary-card="${g.key}"]`);if(!z)continue;const R=z.querySelector("[data-summary-body]");if(g.type==="image"){const D=await Oe("summary",g.file),_=`./summary/${g.file}`;D?R.innerHTML=`
          <img class="summary-thumb" src="${_}" alt="${l(`summary.item.${g.key}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:R.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const I=c==="zhHant"?g.fileZh:g.fileEn,y=await Oe("summary-pdfs",I),x=`./summary-pdfs/${I}`;y?R.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${g.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:R.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const v=()=>P(),h=u=>G(u);return window.addEventListener("s3phy:lang",v),t.addEventListener("click",h),P(),()=>{window.removeEventListener("s3phy:lang",v),t.removeEventListener("click",h),q==null||q.destroy()}}const Ye="s3phy-thermometer-lab-css",$t=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function At(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=$t,document.head.appendChild(t)}function Pe(t,r={}){At();const o=r.type||"liquid";let i=t("tools.thermometerLab.title"),d=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),d=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),d=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),d=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
    <div class="tl-head">
  ...
  `;const a={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},q=460,E=340,te=80,P=800,$=560;function G(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let s=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(s=150),p>145&&(s=200);const m=s<=100?20:25;return{minT:0,maxT:s,tickStep:m}}function L(e,s,p,m,f){return m+(e-s)/(p-s)*f}function H(e,s,p,m,f){return m+f-(e-s)/(p-s)*f}function F(e,s,p,m,f,T){const{gx:b,gy:w,gw:k,gh:C,tickFont:M,axisFont:W,yLabelX:N,xLabelY:S}=s;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const O of T){const j=H(O.value,O.min,O.max,w,C);e.beginPath(),e.moveTo(b,j),e.lineTo(b+k,j),e.stroke()}for(let O=p;O<=m+.01;O+=f){const j=L(O,p,m,b,k);e.beginPath(),e.moveTo(j,w),e.lineTo(j,w+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(b,w),e.lineTo(b,w+C),e.lineTo(b+k,w+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=M,e.textAlign="right",e.textBaseline="middle";for(const O of T){const j=H(O.value,O.min,O.max,w,C);e.fillText(O.label,b-15,j)}e.textAlign="center",e.textBaseline="top";for(let O=p;O<=m+.01;O+=f){const j=L(O,p,m,b,k);e.fillText(`${Math.round(O)}`,j,w+C+10)}return{gx:b,gy:w,gw:k,gh:C,axisFont:W,yLabelX:N,xLabelY:S}}function B(e,s){const p=s-e,m=p<=8?1:p<=14?2:5,f=[],T=Math.ceil(e/m)*m;for(let b=T;b<=s+.001;b+=m)f.push({value:b,label:b%1===0?`${b.toFixed(0)}`:`${b.toFixed(1)}`,min:e,max:s});return f}function ae(){const{maxT:e}=Z(),s=X(0),p=X(e),m=p-s,f=Math.max(1,m*.1),T=Math.max(0,Math.round((s-f)*10)/10),b=Math.round((p+f)*10)/10;return{minL:T,maxL:b}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),s=V(0),p=V(e),m=p-s,f=Math.max(.2,m*.1),T=Math.max(0,s-f),b=p+f,w=m<=2?.5:m<=4?1:2,k=[],C=Math.ceil(T/w)*w;for(let M=C;M<=b+.001;M+=w)k.push({value:M,label:M.toFixed(1),min:T,max:b});return{minR:T,maxR:b,ticks:k}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:s}=e;let p=a.thermistorR25;for(let b=0;b<=s;b+=5){const w=b+273.15,k=a.thermistorR25*Math.exp(a.thermistorBeta*(1/w-1/298.15));p=Math.max(p,k)}p=Math.ceil(p*1.08*10)/10;const m=0,f=p<=12?2:4,T=[];for(let b=0;b<=p+.001;b+=f)T.push({value:b,label:b.toFixed(0),min:m,max:p});return{minR:m,maxR:p,ticks:T}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),v=window.devicePixelRatio||1;J.width=q*v,J.height=E*v,ee.scale(v,v),K.width=P*v,K.height=$*v,ne.scale(v,v);function h(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const u=200,c=11;function g(){const e=Math.pow(a.bulbVolume/u,.3333333333333333);return c*e}function z(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,s=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,m=1.35-a.capillaryBore*.45;return Math.max(.1,s*p*m*e*.15)}function R(e){a.bathTemp<=8&&a.iceCubes.forEach(s=>{s.x+=s.speedX,s.y+=s.speedY,(s.x<65||s.x>175)&&(s.speedX*=-1),(s.y<195||s.y>210)&&(s.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(s=>{s.y-=s.speedY*(1+a.bathTemp/100),s.y<185&&(s.y=265,s.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(s=>{s.y-=s.speedY*(1+(a.bathTemp-80)/40),s.phase+=s.wobbleSpeed,s.x+=Math.sin(s.phase)*.3,s.y<185&&(s.y=260+Math.random()*10,s.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(s=>{s.x+=s.vx,s.y+=s.vy,s.alpha-=.005,(s.alpha<=0||s.y<130)&&(s.x=60+Math.random()*120,s.y=175+Math.random()*5,s.alpha=.2+Math.random()*.4)})}function I(e){let b=59,w=130,k=246;if(a.bathTemp<25){const S=a.bathTemp/25;b=Math.round(180-S*121),w=Math.round(210-S*80),k=Math.round(250-S*4)}else{const S=Math.min(1,(a.bathTemp-25)/125);b=Math.round(59+S*180),w=Math.round(130-S*100),k=Math.round(246-S*190)}if(a.bathTemp>40){const S=Math.min(1,(a.bathTemp-40)/100),O=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${S*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let j=-25;j<=25;j+=6){const ie=S*(12+Math.sin(j*.4+O)*5);e.lineTo(55+130/2+j,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${b}, ${w}, ${k}, 0.25)`),C.addColorStop(1,`rgba(${b}, ${w}, ${k}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const M=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let S=55;S<=185;S+=5){const O=190+Math.sin(S*.15+N)*M;e.lineTo(S,O)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(S=>{e.beginPath(),e.moveTo(S.x,S.y),e.quadraticCurveTo(S.x+Math.sin(S.y*.06)*5,S.y-S.length/2,S.x,S.y-S.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(S=>{e.save(),e.translate(S.x,S.y),e.rotate(S.angle),e.beginPath(),e.roundRect(-S.size/2,-S.size/2,S.size,S.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(S=>{e.beginPath(),e.arc(S.x,S.y,S.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(S=>{e.fillStyle=`rgba(255, 255, 255, ${S.alpha})`,e.beginPath(),e.arc(S.x,S.y,S.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,s,p,m,f,T,b="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(s,p),e.lineTo(m,f),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(s,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const k=e.measureText(T).width+10,C=16,M=b==="left"?m:m-k,W=f-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(M,W,k,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(T,M+k/2,W+C/2+.5)}function x(e){const m=g(),f=250+Math.max(0,m-c)*.35,T=f-m-1,b=10+a.wallThickness*8,w=120-b/2,k=120+b/2,C=e.createLinearGradient(w,20,k,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,T),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(k,20,k,25,5),e.lineTo(k,T),e.closePath(),e.fill(),e.stroke();const M=e.createRadialGradient(120-m*.2,f-m*.2,m*.1,120,f,m);M.addColorStop(0,"rgba(255, 255, 255, 0.8)"),M.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=M,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,f,m+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(b*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,T-20-8);const N=a.liquidType==="mercury",S=N?"#a1a1aa":"#ef4444",O=N?"#f4f4f5":"#fee2e2",j=210,ie=220,ge=(j-40)/ie,fe=j-Math.min(ie,a.thermometerTemp)*ge;e.fillStyle=S,e.fillRect(120-W/2,fe,W,T-fe),e.beginPath(),e.ellipse(120,fe,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=O,e.fillRect(120-W/6,fe,W/3,T-fe);const oe=m*.9,re=e.createRadialGradient(120-oe*.2,f-oe*.2,oe*.1,120,f,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,f,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const me=j-le*ge;e.beginPath(),e.moveTo(w,me),e.lineTo(w+4,me),e.stroke(),e.fillText(`${le}°C`,w-22,me+2.5)}a.showLabels&&(y(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,f,230,f+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function D(e){const b=e.createLinearGradient(115,20,125,20);b.addColorStop(0,"#71717a"),b.addColorStop(.3,"#f4f4f5"),b.addColorStop(.7,"#d4d4d8"),b.addColorStop(1,"#3f3f46"),e.fillStyle=b,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let N=0;N<8;N++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const k=245,C=40,M=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(k,C,M,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(k+10,C+12,M-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",k+M-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",k+14,C+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function _(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const f=20,T=225,b=12,w=120-b/2,k=e.createLinearGradient(w,f,w+b,f);k.addColorStop(0,"rgba(229, 231, 235, 0.4)"),k.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),k.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),k.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,f,b,T-f,[0,0,3,3]),e.fill(),e.stroke();const C=7,M=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);M.addColorStop(0,"#6b7280"),M.addColorStop(.7,"#1f2937"),M.addColorStop(1,"#09090b"),e.fillStyle=M,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,S=135,O=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,S,O,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,S-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+S-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,s,p,m,f,T,b,w,k){const{gx:C,gy:M,gw:W,gh:N}=s;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,m),e.lineTo(p,M+N),e.stroke(),e.beginPath(),e.moveTo(p,m),e.lineTo(C,m),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const S=`${f.toFixed(1)}${b}`,O=e.measureText(S).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(p-O/2,M+N+2,O,15,3),e.fill(),e.fillStyle="#000",e.fillText(S,p,M+N+4),e.textAlign="right",e.textBaseline="middle";const j=`${T.toFixed(2)} ${w}`,ie=e.measureText(j).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(C-ie-2,m-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(j,C-7,m)}function A(e){const s=G(),{minL:p,maxL:m}=ae(),{minT:f,maxT:T,tickStep:b}=Z(),w=B(p,m),k=F(e,s,f,T,b,w),{gx:C,gy:M,gw:W,gh:N,axisFont:S,yLabelX:O,xLabelY:j,dotR:ie}={...s,...k};e.save(),e.translate(O,M+N/2),e.rotate(-Math.PI/2),e.font=S,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=S,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+W/2,j);const we=T,ge=L(0,f,T,C,W),fe=H(X(0),p,m,M,N),oe=L(we,f,T,C,W),re=H(X(we),p,m,M,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(ge,fe),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,me=a.currentLength;if(le>=f&&le<=T){const ve=L(le,f,T,C,W),Ce=H(me,p,m,M,N);Q(e,s,ve,Ce,le,me,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const s=G(),{minR:p,maxR:m,ticks:f}=U(),T=Z(),b=F(e,s,T.minT,T.maxT,T.tickStep,f),{gx:w,gy:k,gw:C,gh:M,axisFont:W,yLabelX:N,xLabelY:S,dotR:O}={...s,...b};e.save(),e.translate(N,k+M/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,S);const{minT:j,maxT:ie}=T,we=ie,ge=L(0,j,ie,w,C),fe=H(V(0),p,m,k,M),oe=L(we,j,ie,w,C),re=H(V(we),p,m,k,M);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(ge,fe),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,me=a.currentResistance;if(le>=j&&le<=ie){const ve=L(le,j,ie,w,C),Ce=H(me,p,m,k,M);Q(e,s,ve,Ce,le,me,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,O,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const s=G(),p=Z(),{minR:m,maxR:f,ticks:T}=Y(p),b=F(e,s,p.minT,p.maxT,p.tickStep,T),{gx:w,gy:k,gw:C,gh:M,axisFont:W,yLabelX:N,xLabelY:S,dotR:O}={...s,...b},{minT:j,maxT:ie}=p;e.save(),e.translate(N,k+M/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,S),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=j;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),me=L(oe,j,ie,w,C),ve=H(Math.min(f,le),m,f,k,M);ve>=k&&ve<=k+M&&(we?e.lineTo(me,ve):(e.moveTo(me,ve),we=!0))}e.stroke();const ge=a.thermometerTemp,fe=a.currentThermistorR;if(ge>=j&&ge<=ie){const oe=L(ge,j,ie,w,C),re=H(Math.min(f,fe),m,f,k,M);Q(e,s,oe,re,ge,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,O,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function pe(){ee.clearRect(0,0,q,E),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),I(ee),a.thermometerType==="liquid"?x(ee):a.thermometerType==="resistance"?D(ee):_(ee),ee.restore(),a.thermometerType==="liquid"?A(ne):a.thermometerType==="resistance"?de(ne):se(ne)}function be(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const s=n.querySelector("#tl-svg-formula-liquid-sub");if(s){const b=a.liquidL100-a.liquidL0,w=a.currentLength-a.liquidL0;s.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          ...
          <text x="160" y="94" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${b.toFixed(1)}</text>
      ...
      `}const p=n.querySelector("#tl-svg-formula-resistance");p&&(p.innerHTML=`
        <svg height="55" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="31" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">Slope Equation:</text>
          <line x1="120" y1="26" x2="210" y2="26" stroke="#fff" stroke-width="1.5" />
      ...
      `);const m=n.querySelector("#tl-svg-formula-resistance-sub");if(m){const b=a.resistanceR100-a.resistanceR0,w=a.currentResistance-a.resistanceR0;m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `}const f=n.querySelector("#tl-svg-formula-thermistor");f&&(f.innerHTML=`
      ...
      `);const T=n.querySelector("#tl-svg-formula-thermistor-sub");if(T){const b=a.thermometerTemp+273.15;T.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            T<tspan dy="3" font-size="10">K</tspan><tspan dy="-3" fill="#10b981" font-weight="bold"> = ${b.toFixed(2)} K</tspan>
      ...
      `}}function ke(){const e=n.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:s,cu:p,interval:m}=ze(),f=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,b=n.querySelector("#tl-pane-q10a").classList.contains("active"),w=b?(f-s)/m*100:T,k=b?f:T/100*m+s,M=(W=>130-W/100*80)(w);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Current Point -->
          <text x="65" y="${M+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${w.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${M+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${k.toFixed(1)}°C</text>
    ...
    `}function qe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const s=n.querySelector("#tl-bath-state");a.bathTemp<=0?s.textContent="Melting Ice Bath":a.bathTemp>=100?s.textContent="Boiling Water/Steam":a.bathTemp===150?s.textContent="Hot Cooking Oil":s.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",be()}let Se=null;function _e(e){a.lastTimestamp||(a.lastTimestamp=e);const s=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(s,.1),m=z(),f=p/m*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=f,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const T=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/T-1/298.15)),R(),pe(),qe(m),Se=requestAnimationFrame(_e)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),s=parseFloat(n.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,m=Number.isFinite(s)?s:105,f=m-p;return{cf:p,cu:m,interval:f}}function He(e){const s=Math.round(e*100)/100;return s>=0?s.toFixed(1):`(${s.toFixed(1)})`}function he(){const{cf:e,cu:s,interval:p}=ze(),m=n.querySelector("#tl-val-faulty-interval"),f=n.querySelector("#tl-faulty-error-a"),T=n.querySelector("#tl-faulty-error-b"),b=Math.abs(p)<.01;m.textContent=p.toFixed(1)+" °C";const w=n.querySelector("#tl-svg-formula-faulty-a"),k=n.querySelector("#tl-svg-formula-faulty-b");if(b){f.hidden=!1,f.textContent="C_u must differ from C_f (interval cannot be zero).",T.hidden=!1,T.textContent=f.textContent,w&&(w.innerHTML=""),k&&(k.innerHTML="");return}f.hidden=!0,T.hidden=!0;const C=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,M=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(C-e)/p*100,N=M/100*p+e;w&&(w.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${C.toFixed(1)} - ${He(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${s.toFixed(1)} - ${He(e)}</text>
      ...
      `),k&&(k.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${M.toFixed(1)} &times; ${p.toFixed(1)}</text>
          ...
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${He(e)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${N.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),ke()}function ye(){const e=parseFloat(n.querySelector("#tl-input-q11-r").value)||0,s=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100,p=n.querySelector("#tl-svg-formula-resistance-solver");p&&(p.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="170" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            &times; 100 = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${s.toFixed(1)}°C</tspan>
          </text>
        </svg>
      `)}function Te(){const e=a.thermometerTemp,s=a.liquidL100-a.liquidL0,p=a.liquidL0+s/100*e,m=n.querySelector("#tl-svg-formula-t-to-l");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${a.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${s.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function Ge(){const e=a.thermometerTemp,s=a.resistanceR100-a.resistanceR0,p=a.resistanceR0+s/100*e,m=n.querySelector("#tl-svg-formula-t-to-r");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">R<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${a.resistanceR0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${s.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} Ω</tspan>
          </text>
        </svg>
      `)}function ue(){he(),ye(),Te(),Ge()}function $e(e,s){n.querySelector("#"+e).addEventListener("click",()=>{a.bathTemp=s,n.querySelector("#tl-bath-temp-slider").value=s,ue()})}function ut(){n.querySelectorAll(".tl-tab-btn").forEach(f=>{f.addEventListener("click",()=>{n.querySelectorAll(".tl-tab-btn").forEach(b=>b.classList.remove("active")),n.querySelectorAll(".tl-tab-content").forEach(b=>b.classList.remove("active")),f.classList.add("active");const T=f.getAttribute("data-tl-tab");n.querySelector("#tl-tab-"+T).classList.add("active"),a.thermometerType=T,ue()})}),n.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{a.showLabels=!a.showLabels,n.querySelector("#tl-lbl-toggle-labels").textContent=a.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),n.querySelector("#tl-bath-temp-slider").addEventListener("input",f=>{a.bathTemp=parseFloat(f.target.value),ue()}),$e("tl-btn-preset-ice",0),$e("tl-btn-preset-room",25),$e("tl-btn-preset-steam",100),$e("tl-btn-preset-oil",150),n.querySelector("#tl-card-mercury").addEventListener("click",()=>{a.liquidType="mercury",n.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",n.querySelector("#tl-card-alcohol").className="tl-seg-btn",ue()}),n.querySelector("#tl-card-alcohol").addEventListener("click",()=>{a.liquidType="alcohol",n.querySelector("#tl-card-mercury").className="tl-seg-btn",n.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",ue()}),n.querySelector("#tl-slider-bulb-vol").addEventListener("input",f=>{a.bulbVolume=parseFloat(f.target.value),n.querySelector("#tl-val-bulb-vol").textContent=a.bulbVolume+" mm³"}),n.querySelector("#tl-slider-wall-thick").addEventListener("input",f=>{a.wallThickness=parseFloat(f.target.value),n.querySelector("#tl-val-wall-thickness").textContent=a.wallThickness.toFixed(1)+" mm"}),n.querySelector("#tl-slider-capillary-bore").addEventListener("input",f=>{a.capillaryBore=parseFloat(f.target.value),n.querySelector("#tl-val-capillary-bore").textContent=a.capillaryBore.toFixed(2)+" mm"}),n.querySelector("#tl-slider-liquid-l0").addEventListener("input",f=>{a.liquidL0=parseFloat(f.target.value),n.querySelector("#tl-val-liquid-l0").textContent=a.liquidL0.toFixed(1)+" cm",ue()}),n.querySelector("#tl-slider-liquid-l100").addEventListener("input",f=>{a.liquidL100=parseFloat(f.target.value),n.querySelector("#tl-val-liquid-l100").textContent=a.liquidL100.toFixed(1)+" cm",ue()}),n.querySelector("#tl-slider-resistance-r0").addEventListener("input",f=>{a.resistanceR0=parseFloat(f.target.value),n.querySelector("#tl-val-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r0").textContent=a.resistanceR0.toFixed(1)+" Ω",ue()}),n.querySelector("#tl-slider-resistance-r100").addEventListener("input",f=>{a.resistanceR100=parseFloat(f.target.value),n.querySelector("#tl-val-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",n.querySelector("#tl-spec-resistance-r100").textContent=a.resistanceR100.toFixed(1)+" Ω",ue()}),n.querySelector("#tl-slider-thermistor-r25").addEventListener("input",f=>{a.thermistorR25=parseFloat(f.target.value),n.querySelector("#tl-val-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",n.querySelector("#tl-spec-thermistor-r25").textContent=a.thermistorR25.toFixed(1)+" kΩ",ue()}),n.querySelector("#tl-slider-thermistor-beta").addEventListener("input",f=>{a.thermistorBeta=parseFloat(f.target.value),n.querySelector("#tl-val-thermistor-beta").textContent=a.thermistorBeta+" K",n.querySelector("#tl-spec-thermistor-beta").textContent=a.thermistorBeta+" K",ue()}),n.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.add("active"),n.querySelector("#tl-btn-solve-q10b").classList.remove("active"),n.querySelector("#tl-pane-q10a").classList.add("active"),n.querySelector("#tl-pane-q10b").classList.remove("active"),he()}),n.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{n.querySelector("#tl-btn-solve-q10a").classList.remove("active"),n.querySelector("#tl-btn-solve-q10b").classList.add("active"),n.querySelector("#tl-pane-q10a").classList.remove("active"),n.querySelector("#tl-pane-q10b").classList.add("active"),he()}),n.querySelector("#tl-input-faulty-cf").addEventListener("input",he),n.querySelector("#tl-input-faulty-cu").addEventListener("input",he),n.querySelector("#tl-input-q10a-cm").addEventListener("input",he),n.querySelector("#tl-input-q10b-t").addEventListener("input",he),n.querySelector("#tl-input-q11-r").addEventListener("input",ye);const p=n.querySelector("#tl-input-t-to-l");p&&p.addEventListener("input",ue);const m=n.querySelector("#tl-input-t-to-r");m&&m.addEventListener("input",ue)}if(r.type){const e=n.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return n.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===o?e.classList.add("active"):e.classList.remove("active")}),n.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===o?e.classList.add("active"):e.classList.remove("active")}),h(),ut(),ue(),Se=requestAnimationFrame(_e),n._thermometerLabCleanup=()=>{Se&&cancelAnimationFrame(Se)},n}function Et(t){const r=document.createElement("div");r.className="tool-specific-heat";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:i+"/";function n(){return d+"specific-heat/index.html?lang="+encodeURIComponent(ce())}o.src=n(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function Ft(t){const r=document.createElement("div");r.className="tool-thermal-mixing";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:i+"/";function n(){return d+"thermal-mixing/index.html?lang="+encodeURIComponent(ce())}o.src=n(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function It(t){const r=document.createElement("div");r.className="tool-change-of-state";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:i+"/";function n(){return d+"change-of-state/index.html?lang="+encodeURIComponent(ce())}o.src=n(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function Wt(t){const r=document.createElement("div");r.className="tool-heat-transfer";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:i+"/";function n(){return d+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(ce())}o.src=n(),o.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}const Me=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],De=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],Pt=[["thermometer","topic.thermometer"]],Ue=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],Dt={liquid:t=>Pe(t,{type:"liquid"}),resistance:t=>Pe(t,{type:"resistance"}),thermistor:t=>Pe(t,{type:"thermistor"}),specificHeat:t=>Et(t),thermalMixing:t=>Ft(t),changeOfState:t=>It(t),heatTransfer:t=>Wt(t)};function Ot(t){return l({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function Ee(){return ce()==="zh-Hant"?"zhHant":"en"}async function Gt(t,r){const o=`./${t}/${r}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function Ke(t){return Gt("notes",t)}function jt(t){let r="topics",o="liquid",i=0,d="all",n=!1,a=null,q={main:null},E=null;function te(){if(q.main){if(r==="topics"?q.main.innerHTML=$():r==="notes"?q.main.innerHTML=Z():r==="tools"?q.main.innerHTML=H():r==="worksheets"?q.main.innerHTML=ot(l,{topics:Pt,paperTitleKey:"worksheets.paperTitleHeat"}):r==="flashcards"?q.main.innerHTML=ae():r==="summary"&&(q.main.innerHTML=J()),r==="notes"&&L(),r==="tools"&&F(),r==="worksheets"){const v=nt.filter(h=>De.includes(h.topic));st(t,v,l,Ee,{topicFilter:(h,u)=>u.includes("thermometer")?De.includes(h.topic):u.includes(h.topic)})}r==="flashcards"&&Y(),r==="summary"&&ee()}}function P(){a==null||a.destroy(),a=rt(t,{subtitleKey:"strand.heat.subtitle",activeSection:r,onSection:v=>{r==="tools"&&v!=="tools"&&E!=null&&E._thermometerLabCleanup&&(E._thermometerLabCleanup(),E=null),r=v,a.updateSection(r),te()},onLang:()=>P()}),q.main=a.main,a.updateSection(r),te()}function $(){return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Me.map(v=>{const h=v.tool?`<button class="btn primary" type="button" data-go-tool="${v.tool}">${l("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${l("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${l(v.titleKey)}</h3>
              ${h}
            </div>`}).join("")}
        </div>
      </section>`}function G(v){const h=v.target.closest("[data-go-tool]");if(h){const c=h.getAttribute("data-go-tool");Ue.includes(c)?o=c:o="liquid",r="tools",a.updateSection(r),te();return}const u=v.target.closest("[data-go-section]");(u==null?void 0:u.getAttribute("data-go-section"))==="notes"&&(r="notes",a.updateSection(r),te())}function Z(){return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${Me.map(v=>`
            <div class="card" data-note-card="${v.id}">
              <h3>${l(`notes.card.${v.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function L(){const v=Ee();for(const h of Me){const u=t.querySelector(`[data-note-card="${h.id}"]`);if(!u)continue;const c=u.querySelector("[data-note-body]"),g=v==="zhHant"?h.fileZh:h.fileEn,z=await Ke(g),R=`./notes/${g}`;z?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${h.id}`)}" src="${R}"></iframe>
          <p style="margin-top:8px"><a href="${R}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:c.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function H(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ue.map(v=>`<button type="button" data-tool="${v}" class="${o===v?"active":""}">${Ot(v)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function F(){const v=t.querySelector("[data-tool-list]"),h=t.querySelector("[data-tool-stage]");!v||!h||(v.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{o=u.getAttribute("data-tool"),v.querySelectorAll("button").forEach(c=>c.classList.toggle("active",c.getAttribute("data-tool")===o)),B(h)})}),B(h))}function B(v){v.innerHTML="",E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup();const h=Dt[o];h&&(E=h(l),v.appendChild(E))}function ae(){return`
      <section class="panel">
        <h2>${l("flashcards.title")}</h2>
        <p class="lead">${l("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}function X(){return it.filter(v=>De.includes(v.topic))}function U(){const v=X();return d==="all"||d==="thermometry"?v:v.filter(h=>h.topic===d)}function V(){const v=U(),h=t.querySelector("[data-flash-progress]");if(!v.length){i=0;const I=t.querySelector("[data-flash-front]");I&&(I.textContent=""),h&&(h.hidden=!0,h.textContent="");return}i=Math.max(0,Math.min(i,v.length-1));const u=v[i],c=t.querySelector("[data-flash-front]"),g=t.querySelector("[data-flash-label]");if(!c)return;h&&(h.hidden=!1,h.textContent=l("flashcards.progress").replace("{current}",String(i+1)).replace("{total}",String(v.length)));const z=Ee(),R=u[z]||u.en;g&&(g.hidden=!1,g.textContent=l(n?"flashcards.answer":"flashcards.question")),c.textContent=n?R.a:R.q}function Y(){const v=t.querySelector("[data-flash-deck]");v.value=d,v.addEventListener("change",()=>{d=v.value,i=0,n=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{n=!n,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",h=>{h.stopPropagation(),n=!n,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const h=U();i=(i-1+h.length)%h.length,n=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const h=U();i=(i+1)%h.length,n=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const h=U();i=Math.floor(Math.random()*h.length),n=!1,V()}),V()}function J(){return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${Me.map(v=>`
            <div class="card" data-summary-card="${v.id}">
              <h3>${l(`summary.item.${v.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function ee(){const v=Ee();for(const h of Me){const u=t.querySelector(`[data-summary-card="${h.id}"]`);if(!u)continue;const c=u.querySelector("[data-summary-body]"),g=v==="zhHant"?h.fileZh:h.fileEn,z=await Ke(g),R=`./notes/${g}`;z?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${h.id}`)}" src="${R}"></iframe>
          <p style="margin-top:8px"><a href="${R}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const K=()=>P(),ne=v=>G(v);return window.addEventListener("s3phy:lang",K),t.addEventListener("click",ne),P(),()=>{window.removeEventListener("s3phy:lang",K),t.removeEventListener("click",ne),E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup(),a==null||a.destroy()}}const Xe={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};mt();const Ze="s3phy_splash_seen",lt={optics:Ht,heat:jt};let Le=null,Re=null;function Bt(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(lt,r)?r:null}function Qt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function ct(t){Le==null||Le(),Le=null,Re==null||Re(),Re=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&Qt(),Re=gt(r);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Le=lt[t](r)??null}function dt(){ct(Bt())}function Nt(){return"./images/uniplus-logo.png"}function Vt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Nt()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Yt(t,r){const o=[...Xe.en,...Xe.zhHant],i=()=>{if(!t.parentElement)return;const d=document.createElement("div");d.className="splash-danmaku-item",d.textContent=o[Math.floor(Math.random()*o.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,q=Math.random()*12+10;d.style.top=`${n}%`,d.style.fontSize=`${a}rem`,d.style.animationDuration=`${q}s`,r.appendChild(d),d.addEventListener("animationend",()=>d.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let d=0;d<4;d+=1)window.setTimeout(i,d*1e3)}function Ut(t){const r=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),o&&Yt(t,o)},1600)}function Je(){dt()}function Kt(){let t=!1;try{t=sessionStorage.getItem(Ze)==="1"}catch{}if(t){Je();return}const r=Vt();document.body.insertBefore(r,document.body.firstChild),Ut(r);const o=r.querySelector("#splashStart"),i=()=>{r.remove(),Je()};o.addEventListener("click",()=>{try{sessionStorage.setItem(Ze,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",dt);window.addEventListener("s3phy:strand",t=>{ct(t.detail??null)});Kt();
