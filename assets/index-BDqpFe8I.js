...
`;function vt(){if(document.getElementById(Ne))return;const t=document.createElement("style");t.id=Ne,t.textContent=bt,document.head.appendChild(t)}function yt(t){vt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
  ...
  `;const o=r.querySelector(".rml-canvas"),i=o.getContext("2d"),d=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),q=r.querySelector('[data-rml-disp="inc"]'),E=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,G=380,Z=300,R="#22d3ee",H="bold 17px system-ui, sans-serif";let F=0,B=-140,ae=!0,X=!0,U=!0,V=!0;function Y(m){return m*Math.PI/180}function J(m,u,c,g,z,M=2,I=!1){i.beginPath(),i.lineWidth=M,i.strokeStyle=z,i.setLineDash(I?[6,6]:[]);const y=m+Math.cos(Y(c))*g,x=u+Math.sin(Y(c))*g;return i.moveTo(m,u),i.lineTo(y,x),i.stroke(),i.setLineDash([]),{x:y,y:x}}function ee(m,u,c,g,z,M=14){const I=c-m,y=g-u,x=Math.hypot(I,y);if(x<1e-6)return;const D=I/x,_=y/x,Q=c-D*M,A=g-_*M,de=.45*M;i.beginPath(),i.fillStyle=z,i.moveTo(c,g),i.lineTo(Q-_*de,A+D*de),i.lineTo(Q+_*de,A-D*de),i.closePath(),i.fill()}function K(m,u,c,g,z,M=25){i.beginPath(),i.strokeStyle=g,i.lineWidth=2;const I=Math.min(m,u),y=Math.max(m,u);if(i.arc($,G,c,Y(I),Y(y),!1),i.stroke(),z){const x=(I+y)/2,D=$+Math.cos(Y(x))*(c+M),_=G+Math.sin(Y(x))*(c+M);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=g,i.fillText(z,D,_),i.restore()}}function ne(m,u,c,g,z){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,G),i.lineTo($+200,G),i.stroke(),i.setLineDash([]),i.lineCap="butt";const M=$+Math.cos(Y(m))*Z,I=G+Math.sin(Y(m))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(M,I),i.lineTo($,G),i.stroke();const y=(M+$)*.5,x=(I+G)*.5,D=Math.hypot($-M,G-I)||1,_=($-M)/D,Q=(G-I)/D;if(ee(y-_*28,x-Q*28,y,x,"#fff",16),i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),M,I-12),i.restore(),ae){const A=J($,G,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),A.x+6,A.y-4),i.restore()}if(X){const A=J($,G,g,Z,"#00e676",2,!1);ee($,G,A.x,A.y,"#00e676",16),i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),A.x,A.y-14),i.restore()}i.save(),i.translate($,G),i.rotate(Y(F)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let A=-190;A<200;A+=15)i.moveTo(A,0),i.lineTo(A-5,8);if(i.stroke(),i.restore(),U){const A=J($,G,u,Z-40,R,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=R,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),A.x+6,A.y-4),i.restore()}if(V){const A=J($,G,c,Z,R,4);ee($,G,A.x,A.y,R,16),Math.abs(F)>.5&&(i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=R,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),A.x,A.y-14),i.restore())}if(U&&K(m,u,100,"#ffcc00",`i=${z.toFixed(0)}°`,25),U&&V&&K(u,c,100,R,`r=${z.toFixed(0)}°`,25),ae&&U&&Math.abs(F)>.5&&K(-90,u,50,"#ffcc00",`θ=${Math.abs(F)}°`,20),X&&V&&Math.abs(F)>.5){const A=c-g;K(g,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${A.toFixed(0)}°`,40)}}function v(){F=parseFloat(d.value),B=parseFloat(n.value);const m=F>0?"+":"";a.textContent=`${m}${F}°`,q.textContent=`${B}°`;const u=-90,c=Math.abs(B-u),g=u+c,z=-90+F,M=Math.abs(B-z),I=z+M,y=I-g;E.textContent=`${M.toFixed(1)}°`,te.textContent=`${M.toFixed(1)}°`;const x=y>0?"+":"";P.textContent=`${x}${y.toFixed(1)}°`,ne(B,z,I,g,M)}return r.querySelectorAll("[data-rml-toggle]").forEach(m=>{m.addEventListener("click",()=>{const u=m.getAttribute("data-rml-toggle");u==="orig-norm"&&(ae=!ae),u==="orig-ray"&&(X=!X),u==="new-norm"&&(U=!U),u==="new-ray"&&(V=!V),m.classList.toggle("active"),v()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{d.value="0",v()}),d.addEventListener("input",v),n.addEventListener("input",v),v(),r}function wt(t){const r=document.createElement("div");r.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;return o.src=`${d}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(o),r}function xt(t,r={}){const o=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",d=document.createElement("div");d.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",q=a.endsWith("/")?a:`${a}/`;return n.src=`${q}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",d.appendChild(n),d}function qt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;function n(){return`${d}em-spectrum/index.html?lang=${encodeURIComponent(ce())}`}o.src=n(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function St(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const o=r.querySelector("[data-r]"),i=r.querySelector("[data-g]"),d=r.querySelector("[data-b]"),n=r.querySelector(".rgb-mixer-canvas"),a=r.querySelector(".rgb-mixer-stage"),q=n.getContext("2d");function E(R){return R.toString(16).padStart(2,"0")}function te(R,H,F){const B=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),X=B/2,U=ae/2,V=Math.min(B,ae)*.34,Y=V*.5,J=Math.sqrt(3)/2;q.clearRect(0,0,B,ae),q.fillStyle="#000",q.fillRect(0,0,B,ae);const ee=[{x:X,y:U-Y,rgb:[255,0,0],val:R},{x:X-Y*J,y:U+Y*.5,rgb:[0,255,0],val:H},{x:X+Y*J,y:U+Y*.5,rgb:[0,0,255],val:F}];q.globalCompositeOperation="lighter",ee.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[v,m,u]=K.rgb,c=q.createRadialGradient(K.x,K.y,0,K.x,K.y,V);c.addColorStop(0,`rgba(${v},${m},${u},${ne})`),c.addColorStop(.65,`rgba(${v},${m},${u},${ne})`),c.addColorStop(.85,`rgba(${v},${m},${u},${ne*.5})`),c.addColorStop(1,`rgba(${v},${m},${u},0)`),q.fillStyle=c,q.beginPath(),q.arc(K.x,K.y,V,0,Math.PI*2),q.fill()}),q.globalCompositeOperation="source-over"}function P(){const R=a.getBoundingClientRect(),H=Math.max(200,Math.min(R.width-8,R.height-8,720)),F=window.devicePixelRatio||1;n.width=H*F,n.height=H*F,n.style.width=`${H}px`,n.style.height=`${H}px`,q.setTransform(F,0,0,F,0,0),te(+o.value,+i.value,+d.value)}function $(){const R=+o.value,H=+i.value,F=+d.value,B=`rgb(${R}, ${H}, ${F})`,ae=`#${E(R)}${E(H)}${E(F)}`;r.querySelector("[data-r-val]").textContent=R,r.querySelector("[data-g-val]").textContent=H,r.querySelector("[data-b-val]").textContent=F,r.querySelector("[data-r-bar]").style.width=`${R/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${H/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${F/255*100}%`,o.style.setProperty("--fill",`${R/255*100}%`),i.style.setProperty("--fill",`${H/255*100}%`),d.style.setProperty("--fill",`${F/255*100}%`);const X=r.querySelector("[data-swatch]");X.style.backgroundColor=B,X.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${B}`),r.querySelector("[data-rgb-text]").textContent=B,r.querySelector("[data-hex-text]").textContent=ae,te(R,H,F)}function G(R,H,F){o.value=R,i.value=H,d.value=F,$()}return[o,i,d].forEach(R=>R.addEventListener("input",$)),r.querySelectorAll(".rgb-presets button").forEach(R=>{R.addEventListener("click",()=>{G(+R.dataset.r,+R.dataset.g,+R.dataset.b)})}),new ResizeObserver(()=>P()).observe(a),requestAnimationFrame(()=>{P(),$()}),r}const kt=["topics","notes","tools","worksheets","flashcards","summary"],Tt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function rt(t,{subtitleKey:r,activeSection:o,onSection:i,onLang:d}){t.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),q=t.querySelector("[data-lang]"),E=t.querySelector("[data-strand-back]");let te=o;function P(R){te=R,a.innerHTML=kt.map(H=>`<button type="button" class="${R===H?"active":""}" data-sec="${H}">${l(Tt[H])}</button>`).join(""),a.querySelectorAll("button").forEach(H=>{H.addEventListener("click",()=>i(H.getAttribute("data-sec")))})}function $(){q.innerHTML=`
      <button type="button" data-set-lang="en" class="${ce()==="en"?"active":""}">${l("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${ce()==="zh-Hant"?"active":""}">${l("lang.zhHant")}</button>
    `,q.querySelectorAll("button").forEach(R=>{R.addEventListener("click",()=>{at(R.getAttribute("data-set-lang")),d()})})}function G(){t.querySelector("[data-hub-subtitle]").textContent=l(r),E.textContent=l("strand.back"),t.querySelector("[data-hub-footer]").textContent=l("footer.conventions"),t.querySelector(".site-title").textContent=l("app.title")}const Z=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return E.addEventListener("click",Z),P(o),$(),{main:n,updateSection(R){P(R)},refreshLabels(){G(),P(te),$()},destroy(){E.removeEventListener("click",Z)}}}const We=["A","B","C","D"];function Ve(t){const r=t.slice();for(let o=r.length-1;o>0;o-=1){const i=Math.floor(Math.random()*(o+1));[r[o],r[i]]=[r[i],r[o]]}return r}function Ct(t,r,o){return t.filter(i=>{if(o)return o(i,r);const d=i.topic;return!!(r.includes(d)||r.includes("rotatingMirror")&&d==="reflection"||r.includes("refraction")&&d==="refraction"||r.includes("tir")&&d==="tir"||d==="convex"&&r.includes("convex")||d==="concave"&&r.includes("concave"))})}function Lt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ot(t,r={}){const o=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=r.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="worksheet-output" data-ws-out><p class="lead">${t("worksheets.empty")}</p></div>
        ...
        <p class="q-exp q-summary"><em>${xe(_.exp)}</em></p>`);const _e=ke?"correct":qe?"incorrect":"",ze=_.choices.map((me,ye)=>`<li>
      ...
      ${Se}
    </div>`}function ne(){n.items.length&&(te.innerHTML=n.items.map((y,x)=>K(y,x,n.tab)).join(""),v())}function v(){n.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(y=>{y.addEventListener("change",()=>{const x=Number(y.getAttribute("data-ws-q"));if(n.resolved[x])return;const D=Number(y.getAttribute("data-ws-choice")),_=n.items[x][U()]||n.items[x].en;n.userAnswers[x]=D,D===_.a?n.resolved[x]=!0:(n.wrongAttempts[x]=(n.wrongAttempts[x]||0)+1,n.wrongAttempts[x]>=2&&(n.resolved[x]=!0)),J(),Y()&&m(),ne()})})}function m(){const y=n.items.length;let x=0,D=0;const _={};n.items.forEach((se,pe)=>{const be=se[U()]||se.en;if(n.userAnswers[pe]===be.a)x+=1,(n.wrongAttempts[pe]||0)===0&&(D+=1);else if(n.resolved[pe]){const qe=se.section||se.topic;_[qe]=(_[qe]||0)+1}});const Q=y?Math.round(x/y*100):0;let A=o("worksheets.revisionFair");Q>=90?A=o("worksheets.revisionExcellent"):Q>=70?A=o("worksheets.revisionGood"):Q<50&&(A=o("worksheets.revisionLow"));const de=Object.entries(_).sort((se,pe)=>pe[1]-se[1]).map(([se,pe])=>`<li>${xe(se)} (${pe})</li>`).join("");H.innerHTML=`
...
${D}</body></html>`}function c(y){const x=u(y),D=new Blob(["\uFEFF",x],{type:"application/msword"}),_=document.createElement("a");_.href=URL.createObjectURL(D),_.download=y?"worksheet-answers.doc":"worksheet.doc",_.click(),URL.revokeObjectURL(_.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),x=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),D=Ct(r,x,d.topicFilter),_=Ve(D).slice(0,Math.min(y,D.length||1));n.items=_.length?_:Ve(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",q.hidden=!1,E.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),G&&(G.hidden=!1),F&&(F.hidden=!1),B&&(B.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const x=y.target.closest("[data-ws-tab]");!x||!n.items.length||ee(x.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=Lt(),X.textContent=`${o("worksheets.date")}: ${n.dateStr}`),B&&(B.hidden=!n.dateStr,B.textContent=n.dateStr?`${o("worksheets.date")}: ${n.dateStr}`:"")}),(g=t.querySelector("[data-ws-word-p]"))==null||g.addEventListener("click",()=>c(!1)),(z=t.querySelector("[data-ws-word-a]"))==null||z.addEventListener("click",()=>c(!0)),(M=t.querySelector("[data-ws-print-p]"))==null||M.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(I=t.querySelector("[data-ws-print-a]"))==null||I.addEventListener("click",()=>{ee("answer"),window.print()})}const Rt=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Mt={rotatingMirror:t=>yt(t),refractionTir:t=>wt(t),lens:(t,r)=>xt(t,{defaultKind:r}),rgbMixer:t=>St(t),em:t=>qt(t)};function _t(t){return l({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return ce()==="zh-Hant"?"zhHant":"en"}async function Oe(t,r){const o=`./${t}/${r}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function zt(t){return Oe("notes",t)}function Ht(t){let r="topics",o="rotatingMirror",i="convex",d=0,n="all",a=!1,q=null,E={main:null};function te(){E.main&&(r==="topics"?E.main.innerHTML=$():r==="notes"?E.main.innerHTML=Z():r==="tools"?E.main.innerHTML=H():r==="worksheets"?E.main.innerHTML=ot(l):r==="flashcards"?E.main.innerHTML=ae():r==="summary"&&(E.main.innerHTML=K()),r==="notes"&&R(),r==="tools"&&F(),r==="worksheets"&&st(t,nt,l,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){q==null||q.destroy(),q=rt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:u=>{r=u,q.updateSection(r),te()},onLang:()=>P()}),E.main=q.main,q.updateSection(r),te()}function $(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([c,g])=>{const z=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,M=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${l(g)}</h3>
              <button class="btn primary" type="button" data-go-tool="${z}"${M?` data-lens-kind="${M}"`:""}>${l("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      ...
      </section>`}async function R(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Ae();for(const g of u){const z=t.querySelector(`[data-note-card="${g.key}"]`);if(!z)continue;const M=z.querySelector("[data-note-body]"),I=c==="zhHant"?g.fileZh:g.fileEn,y=await zt(I),x=`./notes/${I}`;y?M.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${g.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:M.innerHTML=`<p class="lead">${l("notes.missing")}</p>
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Rt.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${_t(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function F(){const u=t.querySelector("[data-tool-list]"),c=t.querySelector("[data-tool-stage]");!u||!c||(u.querySelectorAll("button").forEach(g=>{g.addEventListener("click",()=>{o=g.getAttribute("data-tool"),u.querySelectorAll("button").forEach(z=>z.classList.toggle("active",z.getAttribute("data-tool")===o)),B(c)})}),B(c))}function B(u){u.innerHTML="";const c=Mt[o];if(!c)return;const g=o==="lens"?c(l,i):c(l);u.appendChild(g)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(u){return!!(u!=null&&u.front)}function U(u){return`./${String(u).replace(/^\.\//,"")}`}function V(){return it.slice()}function Y(){const u=V(),c=n==="rotatingMirror"?"reflection":n;if(c==="all"){const z=u.filter(M=>M.topic!=="convex"&&M.topic!=="concave");return[...je,...Be,...Qe,...z]}if(c==="reflection")return je.slice();if(c==="convex")return Be.slice();if(c==="concave")return Qe.slice();if(c==="refractionTir"){const z=u.filter(M=>M.topic==="refraction"||M.topic==="tir");return z.length?z:u}const g=u.filter(z=>z.topic===c);return g.length?g:u}function J(){const u=Y(),c=t.querySelector("[data-flash-progress]");if(!u.length){d=0;const D=t.querySelector("[data-flash-front]"),_=t.querySelector("[data-flip-card]");D&&(D.textContent=""),_&&_.classList.remove("flashcard-surface--image"),c&&(c.hidden=!0,c.textContent="");return}d=Math.max(0,Math.min(d,u.length-1));const g=u[d],z=t.querySelector("[data-flash-front]"),M=t.querySelector("[data-flip-card]"),I=t.querySelector("[data-flash-label]");if(!z||!M)return;if(c&&(c.hidden=!1,c.textContent=l("flashcards.progress").replace("{current}",String(d+1)).replace("{total}",String(u.length))),X(g)){const D=g.back&&g.back!==g.front;M.classList.add("flashcard-surface--image"),I&&(D?(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")):I.hidden=!0);const _=a&&g.back?g.back:g.front,Q=g.alt||g.title||"";z.innerHTML=`<img src="${U(_)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}M.classList.remove("flashcard-surface--image");const y=Ae(),x=g[y]||g.en;I&&(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")),z.textContent=a?x.a:x.q}function ee(){n==="rotatingMirror"&&(n="reflection");const u=t.querySelector("[data-flash-deck]");u.value=n,u.addEventListener("change",()=>{n=u.value,d=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",c=>{c.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const c=Y();d=(d-1+c.length)%c.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const c=Y();d=(d+1)%c.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const c=Y();d=Math.floor(Math.random()*c.length),a=!1,J()}),J()}function K(){const u=[{key:"reflection",type:"image",file:"reflection.webp"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",type:"image",file:"concave.webp"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
      ...
      </section>`}async function ne(){const u=[{key:"reflection",type:"image",file:"reflection.webp"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",type:"image",file:"concave.webp"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],c=Ae();for(const g of u){const z=t.querySelector(`[data-summary-card="${g.key}"]`);if(!z)continue;const M=z.querySelector("[data-summary-body]");if(g.type==="image"){const D=await Oe("summary",g.file),_=`./summary/${g.file}`;D?M.innerHTML=`
          <img class="summary-thumb" src="${_}" alt="${l(`summary.item.${g.key}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:M.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const I=c==="zhHant"?g.fileZh:g.fileEn,y=await Oe("summary-pdfs",I),x=`./summary-pdfs/${I}`;y?M.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${g.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:M.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const v=()=>P(),m=u=>G(u);return window.addEventListener("s3phy:lang",v),t.addEventListener("click",m),P(),()=>{window.removeEventListener("s3phy:lang",v),t.removeEventListener("click",m),q==null||q.destroy()}}const Ye="s3phy-thermometer-lab-css",$t=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function At(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=$t,document.head.appendChild(t)}function Pe(t,r={}){At();const o=r.type||"liquid";let i=t("tools.thermometerLab.title"),d=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),d=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),d=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),d=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},q=460,E=340,te=80,P=800,$=560;function G(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let s=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(s=150),p>145&&(s=200);const h=s<=100?20:25;return{minT:0,maxT:s,tickStep:h}}function R(e,s,p,h,f){return h+(e-s)/(p-s)*f}function H(e,s,p,h,f){return h+f-(e-s)/(p-s)*f}function F(e,s,p,h,f,T){const{gx:b,gy:w,gw:k,gh:C,tickFont:L,axisFont:W,yLabelX:N,xLabelY:S}=s;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const O of T){const j=H(O.value,O.min,O.max,w,C);e.beginPath(),e.moveTo(b,j),e.lineTo(b+k,j),e.stroke()}for(let O=p;O<=h+.01;O+=f){const j=R(O,p,h,b,k);e.beginPath(),e.moveTo(j,w),e.lineTo(j,w+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(b,w),e.lineTo(b,w+C),e.lineTo(b+k,w+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=L,e.textAlign="right",e.textBaseline="middle";for(const O of T){const j=H(O.value,O.min,O.max,w,C);e.fillText(O.label,b-15,j)}e.textAlign="center",e.textBaseline="top";for(let O=p;O<=h+.01;O+=f){const j=R(O,p,h,b,k);e.fillText(`${Math.round(O)}`,j,w+C+10)}return{gx:b,gy:w,gw:k,gh:C,axisFont:W,yLabelX:N,xLabelY:S}}function B(e,s){const p=s-e,h=p<=8?1:p<=14?2:5,f=[],T=Math.ceil(e/h)*h;for(let b=T;b<=s+.001;b+=h)f.push({value:b,label:b%1===0?`${b.toFixed(0)}`:`${b.toFixed(1)}`,min:e,max:s});return f}function ae(){const{maxT:e}=Z(),s=X(0),p=X(e),h=p-s,f=Math.max(1,h*.1),T=Math.max(0,Math.round((s-f)*10)/10),b=Math.round((p+f)*10)/10;return{minL:T,maxL:b}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),s=V(0),p=V(e),h=p-s,f=Math.max(.2,h*.1),T=Math.max(0,s-f),b=p+f,w=h<=2?.5:h<=4?1:2,k=[],C=Math.ceil(T/w)*w;for(let L=C;L<=b+.001;L+=w)k.push({value:L,label:L.toFixed(1),min:T,max:b});return{minR:T,maxR:b,ticks:k}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:s}=e;let p=a.thermistorR25;for(let b=0;b<=s;b+=5){const w=b+273.15,k=a.thermistorR25*Math.exp(a.thermistorBeta*(1/w-1/298.15));p=Math.max(p,k)}p=Math.ceil(p*1.08*10)/10;const h=0,f=p<=12?2:4,T=[];for(let b=0;b<=p+.001;b+=f)T.push({value:b,label:b.toFixed(0),min:h,max:p});return{minR:h,maxR:p,ticks:T}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),v=window.devicePixelRatio||1;J.width=q*v,J.height=E*v,ee.scale(v,v),K.width=P*v,K.height=$*v,ne.scale(v,v);function m(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const u=200,c=11;function g(){const e=Math.pow(a.bulbVolume/u,.3333333333333333);return c*e}function z(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,s=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,h=1.35-a.capillaryBore*.45;return Math.max(.1,s*p*h*e*.15)}function M(e){a.bathTemp<=8&&a.iceCubes.forEach(s=>{s.x+=s.speedX,s.y+=s.speedY,(s.x<65||s.x>175)&&(s.speedX*=-1),(s.y<195||s.y>210)&&(s.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(s=>{s.y-=s.speedY*(1+a.bathTemp/100),s.y<185&&(s.y=265,s.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(s=>{s.y-=s.speedY*(1+(a.bathTemp-80)/40),s.phase+=s.wobbleSpeed,s.x+=Math.sin(s.phase)*.3,s.y<185&&(s.y=260+Math.random()*10,s.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(s=>{s.x+=s.vx,s.y+=s.vy,s.alpha-=.005,(s.alpha<=0||s.y<130)&&(s.x=60+Math.random()*120,s.y=175+Math.random()*5,s.alpha=.2+Math.random()*.4)})}function I(e){let b=59,w=130,k=246;if(a.bathTemp<25){const S=a.bathTemp/25;b=Math.round(180-S*121),w=Math.round(210-S*80),k=Math.round(250-S*4)}else{const S=Math.min(1,(a.bathTemp-25)/125);b=Math.round(59+S*180),w=Math.round(130-S*100),k=Math.round(246-S*190)}if(a.bathTemp>40){const S=Math.min(1,(a.bathTemp-40)/100),O=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${S*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let j=-25;j<=25;j+=6){const ie=S*(12+Math.sin(j*.4+O)*5);e.lineTo(55+130/2+j,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${b}, ${w}, ${k}, 0.25)`),C.addColorStop(1,`rgba(${b}, ${w}, ${k}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const L=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let S=55;S<=185;S+=5){const O=190+Math.sin(S*.15+N)*L;e.lineTo(S,O)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(S=>{e.beginPath(),e.moveTo(S.x,S.y),e.quadraticCurveTo(S.x+Math.sin(S.y*.06)*5,S.y-S.length/2,S.x,S.y-S.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(S=>{e.save(),e.translate(S.x,S.y),e.rotate(S.angle),e.beginPath(),e.roundRect(-S.size/2,-S.size/2,S.size,S.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(S=>{e.beginPath(),e.arc(S.x,S.y,S.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(S=>{e.fillStyle=`rgba(255, 255, 255, ${S.alpha})`,e.beginPath(),e.arc(S.x,S.y,S.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,s,p,h,f,T,b="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(s,p),e.lineTo(h,f),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(s,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const k=e.measureText(T).width+10,C=16,L=b==="left"?h:h-k,W=f-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(L,W,k,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(T,L+k/2,W+C/2+.5)}function x(e){const h=g(),f=250+Math.max(0,h-c)*.35,T=f-h-1,b=10+a.wallThickness*8,w=120-b/2,k=120+b/2,C=e.createLinearGradient(w,20,k,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,T),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(k,20,k,25,5),e.lineTo(k,T),e.closePath(),e.fill(),e.stroke();const L=e.createRadialGradient(120-h*.2,f-h*.2,h*.1,120,f,h);L.addColorStop(0,"rgba(255, 255, 255, 0.8)"),L.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=L,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,f,h+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(b*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,T-20-8);const N=a.liquidType==="mercury",S=N?"#a1a1aa":"#ef4444",O=N?"#f4f4f5":"#fee2e2",j=210,ie=220,ge=(j-40)/ie,fe=j-Math.min(ie,a.thermometerTemp)*ge;e.fillStyle=S,e.fillRect(120-W/2,fe,W,T-fe),e.beginPath(),e.ellipse(120,fe,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=O,e.fillRect(120-W/6,fe,W/3,T-fe);const oe=h*.9,re=e.createRadialGradient(120-oe*.2,f-oe*.2,oe*.1,120,f,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,f,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const he=j-le*ge;e.beginPath(),e.moveTo(w,he),e.lineTo(w+4,he),e.stroke(),e.fillText(`${le}°C`,w-22,he+2.5)}a.showLabels&&(y(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,f,230,f+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function D(e){const b=e.createLinearGradient(115,20,125,20);b.addColorStop(0,"#71717a"),b.addColorStop(.3,"#f4f4f5"),b.addColorStop(.7,"#d4d4d8"),b.addColorStop(1,"#3f3f46"),e.fillStyle=b,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let N=0;N<8;N++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const k=245,C=40,L=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(k,C,L,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(k+10,C+12,L-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",k+L-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",k+14,C+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function _(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const f=20,T=225,b=12,w=120-b/2,k=e.createLinearGradient(w,f,w+b,f);k.addColorStop(0,"rgba(229, 231, 235, 0.4)"),k.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),k.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),k.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,f,b,T-f,[0,0,3,3]),e.fill(),e.stroke();const C=7,L=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);L.addColorStop(0,"#6b7280"),L.addColorStop(.7,"#1f2937"),L.addColorStop(1,"#09090b"),e.fillStyle=L,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,S=135,O=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,S,O,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,S-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+S-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,s,p,h,f,T,b,w,k){const{gx:C,gy:L,gw:W,gh:N}=s;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,h),e.lineTo(p,L+N),e.stroke(),e.beginPath(),e.moveTo(p,h),e.lineTo(C,h),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const S=`${f.toFixed(1)}${b}`,O=e.measureText(S).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(p-O/2,L+N+2,O,15,3),e.fill(),e.fillStyle="#000",e.fillText(S,p,L+N+4),e.textAlign="right",e.textBaseline="middle";const j=`${T.toFixed(2)} ${w}`,ie=e.measureText(j).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(C-ie-2,h-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(j,C-7,h)}function A(e){const s=G(),{minL:p,maxL:h}=ae(),{minT:f,maxT:T,tickStep:b}=Z(),w=B(p,h),k=F(e,s,f,T,b,w),{gx:C,gy:L,gw:W,gh:N,axisFont:S,yLabelX:O,xLabelY:j,dotR:ie}={...s,...k};e.save(),e.translate(O,L+N/2),e.rotate(-Math.PI/2),e.font=S,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=S,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+W/2,j);const we=T,ge=R(0,f,T,C,W),fe=H(X(0),p,h,L,N),oe=R(we,f,T,C,W),re=H(X(we),p,h,L,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(ge,fe),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,he=a.currentLength;if(le>=f&&le<=T){const ve=R(le,f,T,C,W),Ce=H(he,p,h,L,N);Q(e,s,ve,Ce,le,he,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const s=G(),{minR:p,maxR:h,ticks:f}=U(),T=Z(),b=F(e,s,T.minT,T.maxT,T.tickStep,f),{gx:w,gy:k,gw:C,gh:L,axisFont:W,yLabelX:N,xLabelY:S,dotR:O}={...s,...b};e.save(),e.translate(N,k+L/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,S);const{minT:j,maxT:ie}=T,we=ie,ge=R(0,j,ie,w,C),fe=H(V(0),p,h,k,L),oe=R(we,j,ie,w,C),re=H(V(we),p,h,k,L);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(ge,fe),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,he=a.currentResistance;if(le>=j&&le<=ie){const ve=R(le,j,ie,w,C),Ce=H(he,p,h,k,L);Q(e,s,ve,Ce,le,he,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,O,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const s=G(),p=Z(),{minR:h,maxR:f,ticks:T}=Y(p),b=F(e,s,p.minT,p.maxT,p.tickStep,T),{gx:w,gy:k,gw:C,gh:L,axisFont:W,yLabelX:N,xLabelY:S,dotR:O}={...s,...b},{minT:j,maxT:ie}=p;e.save(),e.translate(N,k+L/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,S),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=j;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),he=R(oe,j,ie,w,C),ve=H(Math.min(f,le),h,f,k,L);ve>=k&&ve<=k+L&&(we?e.lineTo(he,ve):(e.moveTo(he,ve),we=!0))}e.stroke();const ge=a.thermometerTemp,fe=a.currentThermistorR;if(ge>=j&&ge<=ie){const oe=R(ge,j,ie,w,C),re=H(Math.min(f,fe),h,f,k,L);Q(e,s,oe,re,ge,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,O,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function pe(){ee.clearRect(0,0,q,E),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),I(ee),a.thermometerType==="liquid"?x(ee):a.thermometerType==="resistance"?D(ee):_(ee),ee.restore(),a.thermometerType==="liquid"?A(ne):a.thermometerType==="resistance"?de(ne):se(ne)}function be(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const h=n.querySelector("#tl-svg-formula-resistance-sub");if(h){const b=a.resistanceR100-a.resistanceR0,w=a.currentResistance-a.resistanceR0;h.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `}}function ke(){const e=n.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:s,cu:p,interval:h}=ze(),f=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,b=n.querySelector("#tl-pane-q10a").classList.contains("active"),w=b?(f-s)/h*100:T,k=b?f:T/100*h+s,L=(W=>130-W/100*80)(w);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${L+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${k.toFixed(1)}°C</text>
    ...
    `}function qe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const s=n.querySelector("#tl-bath-state");a.bathTemp<=0?s.textContent="Melting Ice Bath":a.bathTemp>=100?s.textContent="Boiling Water/Steam":a.bathTemp===150?s.textContent="Hot Cooking Oil":s.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",be()}let Se=null;function _e(e){a.lastTimestamp||(a.lastTimestamp=e);const s=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(s,.1),h=z(),f=p/h*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=f,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const T=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/T-1/298.15)),M(),pe(),qe(h),Se=requestAnimationFrame(_e)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),s=parseFloat(n.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,h=Number.isFinite(s)?s:105,f=h-p;return{cf:p,cu:h,interval:f}}function He(e){const s=Math.round(e*100)/100;return s>=0?s.toFixed(1):`(${s.toFixed(1)})`}function me(){const{cf:e,cu:s,interval:p}=ze(),h=n.querySelector("#tl-val-faulty-interval"),f=n.querySelector("#tl-faulty-error-a"),T=n.querySelector("#tl-faulty-error-b"),b=Math.abs(p)<.01;h.textContent=p.toFixed(1)+" °C";const w=n.querySelector("#tl-svg-formula-faulty-a"),k=n.querySelector("#tl-svg-formula-faulty-b");if(b){f.hidden=!1,f.textContent="C_u must differ from C_f (interval cannot be zero).",T.hidden=!1,T.textContent=f.textContent,w&&(w.innerHTML=""),k&&(k.innerHTML="");return}f.hidden=!0,T.hidden=!0;const C=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,L=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(C-e)/p*100,N=L/100*p+e;w&&(w.innerHTML=`
      ...
      `)}function Ge(){const e=a.thermometerTemp,s=a.resistanceR100-a.resistanceR0,p=a.resistanceR0+s/100*e,h=n.querySelector("#tl-svg-formula-t-to-r");h&&(h.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      </section>`}async function R(){const v=Ee();for(const m of Le){const u=t.querySelector(`[data-note-card="${m.id}"]`);if(!u)continue;const c=u.querySelector("[data-note-body]"),g=v==="zhHant"?m.fileZh:m.fileEn,z=await Ke(g),M=`./notes/${g}`;z?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${m.id}`)}" src="${M}"></iframe>
          <p style="margin-top:8px"><a href="${M}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:c.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function H(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
      ...
      </section>`}function F(){const v=t.querySelector("[data-tool-list]"),m=t.querySelector("[data-tool-stage]");!v||!m||(v.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{o=u.getAttribute("data-tool"),v.querySelectorAll("button").forEach(c=>c.classList.toggle("active",c.getAttribute("data-tool")===o)),B(m)})}),B(m))}function B(v){v.innerHTML="",E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup();const m=Dt[o];m&&(E=m(l),v.appendChild(E))}function ae(){return`
      <section class="panel">
        <h2>${l("flashcards.title")}</h2>
        <p class="lead">${l("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}async function ee(){const v=Ee();for(const m of Le){const u=t.querySelector(`[data-summary-card="${m.id}"]`);if(!u)continue;const c=u.querySelector("[data-summary-body]"),g=v==="zhHant"?m.fileZh:m.fileEn,z=await Ke(g),M=`./notes/${g}`;z?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${m.id}`)}" src="${M}"></iframe>
          <p style="margin-top:8px"><a href="${M}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const K=()=>P(),ne=v=>G(v);return window.addEventListener("s3phy:lang",K),t.addEventListener("click",ne),P(),()=>{window.removeEventListener("s3phy:lang",K),t.removeEventListener("click",ne),E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup(),a==null||a.destroy()}}const Xe={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};ht();const Ze="s3phy_splash_seen",lt={optics:Ht,heat:jt};let Re=null,Me=null;function Bt(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(lt,r)?r:null}function Qt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function ct(t){Re==null||Re(),Re=null,Me==null||Me(),Me=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&Qt(),Me=gt(r);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Re=lt[t](r)??null}function dt(){ct(Bt())}function Nt(){return"./images/uniplus-logo.png"}function Vt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
