(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function o(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=o(s);fetch(s.href,a)}})();const $e={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Study with spaced repetition — cards you find harder appear more often in later rounds. Picture decks for reflection, refraction, TIR, EM waves, and lenses.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","flashcards.mode.sequence":"Sequence","flashcards.mode.random":"Random","flashcards.again":"Again","flashcards.gotIt":"Got it","flashcards.round":"Round {round} · {total} cards","flashcards.flipFirst":"Tap the card, press Space, or Flip to reveal the answer first.","flashcards.hint.rated":"← Again · Got it →  (or keys 1 / 2)","flashcards.summary.title":"Round {round} complete","flashcards.summary.stats":"{total} cards studied · Again {again} · Got it {gotIt} · Next {neutral}","flashcards.summary.keep":"{count} to keep practising","flashcards.summary.confident":"{count} confident","flashcards.summary.nextRound":"Next round","flashcards.summary.restart":"Restart session","flashcards.summary.complete":"Session complete","flashcards.summary.completeStats":"Great work — you have finished all scheduled copies.","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF or image). Preview below or open in a new tab.","summary.viewImage":"Open full image","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","flashcards.deck.heatInternalEnergy":"Heat and internal energy","flashcards.deck.changeOfState":"Change of state","flashcards.deck.heatTransfer":"Heat transfer","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.specificHeat.title":"Specific Heat Capacity Lab","tools.thermalMixing.title":"Thermal Mixing Lab","tools.changeOfState.title":"Change of State Lab","tools.heatTransfer.title":"Heat Transfer Laboratory","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","tools.thermometerLab.liquid.title":"Liquid-in-Glass Thermometer","tools.thermometerLab.liquid.subtitle":"Explore the effects of bulb volume, capillary bore, and liquid type on sensitivity and response time.","tools.thermometerLab.resistance.title":"Platinum Resistance Thermometer","tools.thermometerLab.resistance.subtitle":"Investigate how platinum resistance varies linearly with temperature and solve calibration problems.","tools.thermometerLab.thermistor.title":"NTC Thermistor","tools.thermometerLab.thermistor.subtitle":"Study the non-linear resistance-temperature relationship of NTC thermistors and live beta calculations.","tools.thermometerLab.labels.show":"Show Structure Labels","tools.thermometerLab.labels.hide":"Hide Structure Labels","tools.thermometerLab.labels.thinWall":"Thin glass wall (fast heat transfer)","tools.thermometerLab.labels.largeBulb":"Large bulb (contains more liquid, increases sensitivity)","tools.thermometerLab.labels.narrowBore":"Narrow capillary bore (liquid rises higher, increases sensitivity)","tools.thermometerLab.labels.meniscus":"Meniscus (reading point)","tools.thermometerLab.labels.platinumCoil":"Platinum coil (resistance increases linearly with temp)","tools.thermometerLab.labels.metalSheath":"Metal sheath (protects & conducts heat quickly)","tools.thermometerLab.labels.semiconductorBead":"Semiconductor bead (resistance decreases exponentially with temp)","tools.thermometerLab.labels.leads":"Connecting leads","tools.thermometerLab.faulty.dualScale":"Dual-Scale Comparison Diagram","tools.thermometerLab.faulty.trueScale":"True Scale (°C)","tools.thermometerLab.faulty.faultyScale":"Faulty Scale (°C)","tools.thermometerLab.paramSettings":"Parameter settings","tools.floatingControls.dragHint":"Drag to move","tools.floatingControls.showParams":"Show parameters","tools.floatingControls.hideParams":"Hide parameters","tools.thermometerLab.faultySolver":"Faulty thermometer solver","tools.thermometerLab.resistanceSolver":"Resistance-to-temperature solver","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},Mt={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"使用間隔重複習—難記的卡片在下一輪會更頻繁出現。反射、折射、全內反射、電磁波、凸透鏡與凹透鏡課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","flashcards.mode.sequence":"順序","flashcards.mode.random":"隨機","flashcards.again":"再來","flashcards.gotIt":"懂了","flashcards.round":"第 {round} 輪 · {total} 張卡","flashcards.flipFirst":"請先點擊卡片、按空白鍵或翻面查看答案。","flashcards.hint.rated":"← 再來 · 懂了 →（或按 1 / 2）","flashcards.summary.title":"第 {round} 輪完成","flashcards.summary.stats":"共 {total} 張 · 再來 {again} · 懂了 {gotIt} · 下一張 {neutral}","flashcards.summary.keep":"{count} 張需繼續練習","flashcards.summary.confident":"{count} 張已掌握","flashcards.summary.nextRound":"下一輪","flashcards.summary.restart":"重新開始","flashcards.summary.complete":"練習完成","flashcards.summary.completeStats":"很好！你已完成所有排程的卡片。","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF 或圖片）。可於下方預覽，或新分頁開啟。","summary.viewImage":"開啟完整圖片","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","flashcards.deck.heatInternalEnergy":"熱與內能","flashcards.deck.changeOfState":"物態變化","flashcards.deck.heatTransfer":"熱傳入","tools.thermometerLab.title":"溫度計與校準實驗室","tools.specificHeat.title":"比熱容量實驗室","tools.thermalMixing.title":"熱混合實驗室","tools.changeOfState.title":"物態變化實驗室","tools.heatTransfer.title":"熱的轉移實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","tools.thermometerLab.liquid.title":"液體玻璃溫度計","tools.thermometerLab.liquid.subtitle":"探索玻璃泡容積、毛細管內外徑和液體種類對靉敏度及反應時間的影響。","tools.thermometerLab.resistance.title":"鈐電阻溫度計","tools.thermometerLab.resistance.subtitle":"研究鈐電阻如何隨溫度呈線性變化，並解決溫度校準問題。","tools.thermometerLab.thermistor.title":"NTC 熱敏電阻溫度計","tools.thermometerLab.thermistor.subtitle":"學習負溫度係數（NTC）熱敏電阻的非線性電阻-溫度關係，並進行實時 Beta 計算。","tools.thermometerLab.labels.show":"顯示結構標註","tools.thermometerLab.labels.hide":"隱藏結構標註","tools.thermometerLab.labels.thinWall":"薄玻璃壁 (快速傳熱)","tools.thermometerLab.labels.largeBulb":"大玻璃泡 (容納更多液體，提高靉敏度)","tools.thermometerLab.labels.narrowBore":"細毛細管 (液柱升得更高，提高靉敏度)","tools.thermometerLab.labels.meniscus":"彎月面 (讀數位置)","tools.thermometerLab.labels.platinumCoil":"鈐絲線圈 (電阻隨溫度線性增加)","tools.thermometerLab.labels.metalSheath":"金屬保護套 (保護並快速導熱)","tools.thermometerLab.labels.semiconductorBead":"半導體小珠 (電阻隨溫度指數級減少)","tools.thermometerLab.labels.leads":"連接導線","tools.thermometerLab.faulty.dualScale":"雙刻度對比示意圖","tools.thermometerLab.faulty.trueScale":"標準溫標 (°C)","tools.thermometerLab.faulty.faultyScale":"偏差溫標 (°C)","tools.thermometerLab.paramSettings":"參數設定","tools.floatingControls.dragHint":"拖曳以移動","tools.floatingControls.showParams":"顯示參數","tools.floatingControls.hideParams":"隱藏參數","tools.thermometerLab.faultySolver":"故障溫度計求解器","tools.thermometerLab.resistanceSolver":"電阻求溫度求解器","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},mt="s3phy.lang",bt={en:$e,"zh-Hant":Mt};let Ie="en";function _t(){try{const t=localStorage.getItem(mt);if(t==="zh-Hant"||t==="en")return t}catch{}return"en"}function Ht(){Ie=_t()}function gt(t){if(bt[t]){Ie=t;try{localStorage.setItem(mt,t)}catch{}document.documentElement.lang=t==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function oe(){return Ie}function l(t){const n=bt[Ie]||$e;return Object.prototype.hasOwnProperty.call(n,t)?n[t]:Object.prototype.hasOwnProperty.call($e,t)?$e[t]:t}const Ft=.78;function Pe(){const t=document.documentElement,n=window.innerWidth,o=Math.max(window.innerHeight,1),i=n/o;let s=1;if(n<=1360?s=.88:n<=1500&&(s=.94),n>1700&&i>1.7){const a=Math.min(.07,(i-1.7)*.09),r=Math.min(.05,(n-1700)/1800*.05);s-=a+r}o<=700&&(s=Math.min(s,.82)),s=Math.max(Ft,Math.min(1,s)),t.style.setProperty("--hub-scale",s.toFixed(3))}function Et(){return Pe(),window.addEventListener("resize",Pe),()=>window.removeEventListener("resize",Pe)}const At=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function $t(t){function n(){t.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${At.map(({id:s,titleKey:a,descKey:r})=>`
            <div class="card">
              <h3>${l(a)}</h3>
              <p>${l(r)}</p>
...
`;function Pt(){if(document.getElementById(Ue))return;const t=document.createElement("style");t.id=Ue,t.textContent=It,document.head.appendChild(t)}function Wt(t){Pt();const n=document.createElement("div");n.className="rml",n.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=n.querySelector(".rml-canvas"),i=o.getContext("2d"),s=n.querySelector("[data-rml-rot]"),a=n.querySelector("[data-rml-inc]"),r=n.querySelector('[data-rml-disp="rot"]'),c=n.querySelector('[data-rml-disp="inc"]'),O=n.querySelector('[data-rml-val="i"]'),I=n.querySelector('[data-rml-val="r"]'),R=n.querySelector('[data-rml-val="shift"]'),H=350,M=380,B=300,y="#22d3ee",S="bold 17px system-ui, sans-serif";let F=0,g=-140,A=!0,$=!0,V=!0,u=!0;function f(W){return W*Math.PI/180}function h(W,P,U,ee,ne,te=2,ae=!1){i.beginPath(),i.lineWidth=te,i.strokeStyle=ne,i.setLineDash(ae?[6,6]:[]);const k=W+Math.cos(f(U))*ee,_=P+Math.sin(f(U))*ee;return i.moveTo(W,P),i.lineTo(k,_),i.stroke(),i.setLineDash([]),{x:k,y:_}}function x(W,P,U,ee,ne,te=14){const ae=U-W,k=ee-P,_=Math.hypot(ae,k);if(_<1e-6)return;const J=ae/_,D=k/_,Z=U-J*te,N=ee-D*te,de=.45*te;i.beginPath(),i.fillStyle=ne,i.moveTo(U,ee),i.lineTo(Z-D*de,N+J*de),i.lineTo(Z+D*de,N-J*de),i.closePath(),i.fill()}function G(W,P,U,ee,ne,te=25){i.beginPath(),i.strokeStyle=ee,i.lineWidth=2;const ae=Math.min(W,P),k=Math.max(W,P);if(i.arc(H,M,U,f(ae),f(k),!1),i.stroke(),ne){const _=(ae+k)/2,J=H+Math.cos(f(_))*(U+te),D=M+Math.sin(f(_))*(U+te);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=ee,i.fillText(ne,J,D),i.restore()}}function j(W,P,U,ee,ne){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(H-200,M),i.lineTo(H+200,M),i.stroke(),i.setLineDash([]),i.lineCap="butt";const te=H+Math.cos(f(W))*B,ae=M+Math.sin(f(W))*B;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(te,ae),i.lineTo(H,M),i.stroke();const k=(te+H)*.5,_=(ae+M)*.5,J=Math.hypot(H-te,M-ae)||1,D=(H-te)/J,Z=(M-ae)/J;if(x(k-D*28,_-Z*28,k,_,"#fff",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),te,ae-12),i.restore(),A){const N=h(H,M,-90,B-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),N.x+6,N.y-4),i.restore()}if($){const N=h(H,M,ee,B,"#00e676",2,!1);x(H,M,N.x,N.y,"#00e676",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),N.x,N.y-14),i.restore()}i.save(),i.translate(H,M),i.rotate(f(F)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let N=-190;N<200;N+=15)i.moveTo(N,0),i.lineTo(N-5,8);if(i.stroke(),i.restore(),V){const N=h(H,M,P,B-40,y,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=y,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),N.x+6,N.y-4),i.restore()}if(u){const N=h(H,M,U,B,y,4);x(H,M,N.x,N.y,y,16),Math.abs(F)>.5&&(i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=y,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),N.x,N.y-14),i.restore())}if(V&&G(W,P,100,"#ffcc00",`i=${ne.toFixed(0)}°`,25),V&&u&&G(P,U,100,y,`r=${ne.toFixed(0)}°`,25),A&&V&&Math.abs(F)>.5&&G(-90,P,50,"#ffcc00",`θ=${Math.abs(F)}°`,20),$&&u&&Math.abs(F)>.5){const N=U-ee;G(ee,U,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${N.toFixed(0)}°`,40)}}function E(){F=parseFloat(s.value),g=parseFloat(a.value);const W=F>0?"+":"";r.textContent=`${W}${F}°`,c.textContent=`${g}°`;const P=-90,U=Math.abs(g-P),ee=P+U,ne=-90+F,te=Math.abs(g-ne),ae=ne+te,k=ae-ee;O.textContent=`${te.toFixed(1)}°`,I.textContent=`${te.toFixed(1)}°`;const _=k>0?"+":"";R.textContent=`${_}${k.toFixed(1)}°`,j(g,ne,ae,ee,te)}return n.querySelectorAll("[data-rml-toggle]").forEach(W=>{W.addEventListener("click",()=>{const P=W.getAttribute("data-rml-toggle");P==="orig-norm"&&(A=!A),P==="orig-ray"&&($=!$),P==="new-norm"&&(V=!V),P==="new-ray"&&(u=!u),W.classList.toggle("active"),E()})}),n.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",E()}),s.addEventListener("input",E),a.addEventListener("input",E),E(),n}function Dt(t){const n=document.createElement("div");n.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;return o.src=`${s}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",n.appendChild(o),n}function Ot(t,n={}){const o=n.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),r="./",c=r.endsWith("/")?r:`${r}/`;return a.src=`${c}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,a.title=t(i),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function Gt(t){const n=document.createElement("div");n.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(oe())}`}o.src=a(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._emLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function jt(t){const n=document.createElement("div");n.className="rgb-mixer",n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-r]"),i=n.querySelector("[data-g]"),s=n.querySelector("[data-b]"),a=n.querySelector(".rgb-mixer-canvas"),r=n.querySelector(".rgb-mixer-stage"),c=a.getContext("2d");function O(y){return y.toString(16).padStart(2,"0")}function I(y,S,F){const g=a.width/(window.devicePixelRatio||1),A=a.height/(window.devicePixelRatio||1),$=g/2,V=A/2,u=Math.min(g,A)*.34,f=u*.5,h=Math.sqrt(3)/2;c.clearRect(0,0,g,A),c.fillStyle="#000",c.fillRect(0,0,g,A);const x=[{x:$,y:V-f,rgb:[255,0,0],val:y},{x:$-f*h,y:V+f*.5,rgb:[0,255,0],val:S},{x:$+f*h,y:V+f*.5,rgb:[0,0,255],val:F}];c.globalCompositeOperation="lighter",x.forEach(G=>{if(G.val<=0)return;const j=G.val/255,[E,W,P]=G.rgb,U=c.createRadialGradient(G.x,G.y,0,G.x,G.y,u);U.addColorStop(0,`rgba(${E},${W},${P},${j})`),U.addColorStop(.65,`rgba(${E},${W},${P},${j})`),U.addColorStop(.85,`rgba(${E},${W},${P},${j*.5})`),U.addColorStop(1,`rgba(${E},${W},${P},0)`),c.fillStyle=U,c.beginPath(),c.arc(G.x,G.y,u,0,Math.PI*2),c.fill()}),c.globalCompositeOperation="source-over"}function R(){const y=r.getBoundingClientRect(),S=Math.max(200,Math.min(y.width-8,y.height-8,720)),F=window.devicePixelRatio||1;a.width=S*F,a.height=S*F,a.style.width=`${S}px`,a.style.height=`${S}px`,c.setTransform(F,0,0,F,0,0),I(+o.value,+i.value,+s.value)}function H(){const y=+o.value,S=+i.value,F=+s.value,g=`rgb(${y}, ${S}, ${F})`,A=`#${O(y)}${O(S)}${O(F)}`;n.querySelector("[data-r-val]").textContent=y,n.querySelector("[data-g-val]").textContent=S,n.querySelector("[data-b-val]").textContent=F,n.querySelector("[data-r-bar]").style.width=`${y/255*100}%`,n.querySelector("[data-g-bar]").style.width=`${S/255*100}%`,n.querySelector("[data-b-bar]").style.width=`${F/255*100}%`,o.style.setProperty("--fill",`${y/255*100}%`),i.style.setProperty("--fill",`${S/255*100}%`),s.style.setProperty("--fill",`${F/255*100}%`);const $=n.querySelector("[data-swatch]");$.style.backgroundColor=g,$.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${g}`),n.querySelector("[data-rgb-text]").textContent=g,n.querySelector("[data-hex-text]").textContent=A,I(y,S,F)}function M(y,S,F){o.value=y,i.value=S,s.value=F,H()}return[o,i,s].forEach(y=>y.addEventListener("input",H)),n.querySelectorAll(".rgb-presets button").forEach(y=>{y.addEventListener("click",()=>{M(+y.dataset.r,+y.dataset.g,+y.dataset.b)})}),new ResizeObserver(()=>R()).observe(r),requestAnimationFrame(()=>{R(),H()}),n}const Bt=["topics","notes","tools","worksheets","flashcards","summary"],Nt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function yt(t,{subtitleKey:n,activeSection:o,onSection:i,onLang:s}){t.innerHTML=`
  ...
  `;const a=t.querySelector("[data-main]"),r=t.querySelector("[data-nav]"),c=t.querySelector("[data-lang]"),O=t.querySelector("[data-strand-back]");let I=o;function R(y){I=y,r.innerHTML=Bt.map(S=>`<button type="button" class="${y===S?"active":""}" data-sec="${S}">${l(Nt[S])}</button>`).join(""),r.querySelectorAll("button").forEach(S=>{S.addEventListener("click",()=>i(S.getAttribute("data-sec")))})}function H(){c.innerHTML=`
      <button type="button" data-set-lang="en" class="${oe()==="en"?"active":""}">${l("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${oe()==="zh-Hant"?"active":""}">${l("lang.zhHant")}</button>
    `,c.querySelectorAll("button").forEach(y=>{y.addEventListener("click",()=>{gt(y.getAttribute("data-set-lang")),s()})})}function M(){t.querySelector("[data-hub-subtitle]").textContent=l(n),O.textContent=l("strand.back"),t.querySelector("[data-hub-footer]").textContent=l("footer.conventions"),t.querySelector(".site-title").textContent=l("app.title")}const B=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return O.addEventListener("click",B),R(o),H(),{main:a,updateSection(y){R(y)},refreshLabels(){M(),R(I),H()},destroy(){O.removeEventListener("click",B)}}}const We=["A","B","C","D"];function Ye(t){const n=t.slice();for(let o=n.length-1;o>0;o-=1){const i=Math.floor(Math.random()*(o+1));[n[o],n[i]]=[n[i],n[o]]}return n}function Qt(t,n,o){return t.filter(i=>{if(o)return o(i,n);const s=i.topic;return!!(n.includes(s)||n.includes("rotatingMirror")&&s==="reflection"||n.includes("refraction")&&s==="refraction"||n.includes("tir")&&s==="tir"||s==="convex"&&n.includes("convex")||s==="concave"&&n.includes("concave"))})}function Vt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function wt(t,n={}){const o=n.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=n.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="worksheet-output" data-ws-out><p class="lead">${t("worksheets.empty")}</p></div>
    </section>`}function xt(t,n,o,i,s={}){var ee,ne,te,ae;const a={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},r=t.querySelector("[data-ws-gen]"),c=t.querySelector("[data-ws-preview-area]"),O=t.querySelector("[data-ws-out]"),I=t.querySelector("[data-ws-body]"),R=t.querySelector("[data-ws-paper]"),H=t.querySelector("[data-ws-tabs]"),M=t.querySelector("[data-ws-practice-actions]"),B=t.querySelector("[data-ws-score]"),y=t.querySelector("[data-ws-score-val]"),S=t.querySelector("[data-ws-summary]"),F=t.querySelector("[data-ws-date-row]"),g=t.querySelector("[data-ws-date-print]"),A=t.querySelector("[data-ws-date-today]"),$=t.querySelector("[data-ws-date-label]");if(!r||!I)return;function V(){return i()}function u(){a.userAnswers={},a.wrongAttempts={},a.resolved={},B.hidden=!0,S.hidden=!0}function f(){return a.items.length>0&&a.items.every((k,_)=>a.resolved[_])}function h(){let k=0;a.items.forEach((J,D)=>{if(!a.resolved[D])return;const Z=J[V()]||J.en;a.userAnswers[D]===Z.a&&(k+=1)}),Object.keys(a.resolved).length>0&&(y.textContent=`${k}/${a.items.length}`,B.hidden=!1)}function x(k){a.tab=k,H==null||H.querySelectorAll("[data-ws-tab]").forEach(_=>{_.classList.toggle("active",_.getAttribute("data-ws-tab")===k)}),M&&(M.hidden=k!=="practice"),F&&(F.hidden=k!=="practice"),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:""),R==null||R.classList.toggle("practice-mode",k==="practice"),j()}function G(k,_,J){const D=k[V()]||k.en,Z=We,N=_+1,de=k.section?`<span class="q-section">${xe(k.section)}</span>`:"";if(J==="answer"){const me=D.choices.map((ye,Ce)=>`<li class="${Ce===D.a?"choice-correct":""}"><strong>${Z[Ce]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${N} ${de}</h4>
        <p>${xe(D.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Z[D.a]}</p>
        <p class="q-exp"><em>${xe(D.exp)}</em></p>
      </div>`}const le=a.userAnswers[_],ue=a.wrongAttempts[_]||0,ge=a.resolved[_],qe=ge&&le===D.a,ke=ge&&le!==D.a;let Se="";ue===1&&!ge?Se=`<p class="q-hint"><strong>${o("worksheets.hint")}:</strong> ${xe(D.hint||D.exp)}</p>`:ke&&(Se=`<p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Z[D.a]}</p>
        <p class="q-exp q-summary"><em>${xe(D.exp)}</em></p>`);const _e=qe?"correct":ke?"incorrect":"",He=D.choices.map((me,ye)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${_}" value="${ye}" data-ws-q="${_}" data-ws-choice="${ye}"${le===ye?" checked":""}${ge?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${Z[ye]}.</strong> ${xe(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${_e}" data-ws-row="${_}">
      ...
      ${Se}
    </div>`}function j(){a.items.length&&(I.innerHTML=a.items.map((k,_)=>G(k,_,a.tab)).join(""),E())}function E(){a.tab==="practice"&&I.querySelectorAll("[data-ws-choice]").forEach(k=>{k.addEventListener("change",()=>{const _=Number(k.getAttribute("data-ws-q"));if(a.resolved[_])return;const J=Number(k.getAttribute("data-ws-choice")),D=a.items[_][V()]||a.items[_].en;a.userAnswers[_]=J,J===D.a?a.resolved[_]=!0:(a.wrongAttempts[_]=(a.wrongAttempts[_]||0)+1,a.wrongAttempts[_]>=2&&(a.resolved[_]=!0)),h(),f()&&W(),j()})})}function W(){const k=a.items.length;let _=0,J=0;const D={};a.items.forEach((le,ue)=>{const ge=le[V()]||le.en;if(a.userAnswers[ue]===ge.a)_+=1,(a.wrongAttempts[ue]||0)===0&&(J+=1);else if(a.resolved[ue]){const ke=le.section||le.topic;D[ke]=(D[ke]||0)+1}});const Z=k?Math.round(_/k*100):0;let N=o("worksheets.revisionFair");Z>=90?N=o("worksheets.revisionExcellent"):Z>=70?N=o("worksheets.revisionGood"):Z<50&&(N=o("worksheets.revisionLow"));const de=Object.entries(D).sort((le,ue)=>ue[1]-le[1]).map(([le,ue])=>`<li>${xe(le)} (${ue})</li>`).join("");S.innerHTML=`
      <h4>${o("worksheets.sessionSummary")}</h4>
      <p>${o("worksheets.score")}: <strong>${_}/${k}</strong> (${Z}%)</p>
      <p>${o("worksheets.firstTry")}: <strong>${J}/${k}</strong></p>
      <p>${o("worksheets.revisionSuggestions")}: ${N}</p>
      ${de?`<p>${o("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,S.hidden=!1}function P(k){const _=V(),J=a.items.map((D,Z)=>{const N=D[_]||D.en,de=N.choices.map((ue,ge)=>`${We[ge]}. ${ue}`).join("<br/>"),le=k?`<p><b>${o("worksheets.answer")}:</b> ${We[N.a]}<br/><i>${N.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Z+1}.</b> ${N.q}<br/>${de}${le}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${J}</body></html>`}function U(k){const _=P(k),J=new Blob(["\uFEFF",_],{type:"application/msword"}),D=document.createElement("a");D.href=URL.createObjectURL(J),D.download=k?"worksheet-answers.doc":"worksheet.doc",D.click(),URL.revokeObjectURL(D.href)}r.addEventListener("click",()=>{const k=Number(t.querySelector("[data-ws-count]").value),_=[...t.querySelectorAll("[data-ws-topic]")].filter(Z=>Z.checked).map(Z=>Z.getAttribute("data-ws-topic")),J=Qt(n,_,s.topicFilter),D=Ye(J).slice(0,Math.min(k,J.length||1));a.items=D.length?D:Ye(n).slice(0,Math.min(k,n.length)),u(),a.tab="practice",a.dateStr="",c.hidden=!1,O.hidden=!0,H==null||H.querySelectorAll("[data-ws-tab]").forEach(Z=>{Z.classList.toggle("active",Z.getAttribute("data-ws-tab")==="practice")}),M&&(M.hidden=!1),F&&(F.hidden=!1),g&&(g.hidden=!0),$.textContent="",R==null||R.classList.add("practice-mode"),j()}),H==null||H.addEventListener("click",k=>{const _=k.target.closest("[data-ws-tab]");!_||!a.items.length||x(_.getAttribute("data-ws-tab"))}),A==null||A.addEventListener("click",()=>{a.dateStr?(a.dateStr="",$.textContent=""):(a.dateStr=Vt(),$.textContent=`${o("worksheets.date")}: ${a.dateStr}`),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:"")}),(ee=t.querySelector("[data-ws-word-p]"))==null||ee.addEventListener("click",()=>U(!1)),(ne=t.querySelector("[data-ws-word-a]"))==null||ne.addEventListener("click",()=>U(!0)),(te=t.querySelector("[data-ws-print-p]"))==null||te.addEventListener("click",()=>{x("practice"),R==null||R.classList.add("ws-print-blank");const k=()=>R==null?void 0:R.classList.remove("ws-print-blank");window.addEventListener("afterprint",k,{once:!0}),window.print()}),(ae=t.querySelector("[data-ws-print-a]"))==null||ae.addEventListener("click",()=>{x("answer"),window.print()})}const Kt=1.7,Ut=.7,De=1,Yt=.1,Xt=3;function Zt(t){const n=Math.floor(t),o=t-n;return n+(Math.random()<o?1:0)}function Xe(t){for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function Jt(t){const n=new Map(t.map(a=>[a.id,a.copies])),o=[];let i=null;const s=t.reduce((a,r)=>a+r.copies,0);for(let a=0;a<s;a+=1){let r=[...n.entries()].filter(([I,R])=>R>0&&I!==i);r.length===0&&(r=[...n.entries()].filter(([,I])=>I>0)),r.sort((I,R)=>R[1]-I[1]);const[c,O]=r[0];o.push(c),n.set(c,O-1),i=c}return o}function ea(t){const n=[];return t.forEach(({id:o,copies:i})=>{for(let s=0;s<i;s+=1)n.push(o)}),n}function ta(t){let n="sequence",o=1,i=[],s=[],a=0,r=!1,c=!1,O=!1;const I=new Map;function R(){return t()}function H(){return new Map(R().map(u=>[u.id,u]))}function M(){I.clear(),R().forEach(u=>{I.set(u.id,{nextRate:De,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function B(){const u=R();return o===1?u.map(f=>({id:f.id,copies:1})):u.map(f=>{var h;return{id:f.id,copies:Zt(((h=I.get(f.id))==null?void 0:h.nextRate)??De)}}).filter(f=>f.copies>0)}function y(u){if(u.length===0)return[];if(o===1){const f=u.map(h=>h.id);return n==="random"?Xe([...f]):[...f].sort((h,x)=>h-x)}return n==="random"?Xe(ea(u)):Jt(u)}function S(){if(c=!1,O=!1,i=B(),i.reduce((f,h)=>f+h.copies,0)===0){O=!0,c=!0,s=[],a=0;return}R().forEach(f=>{const h=I.get(f.id);h&&(h.roundAgain=0,h.roundGotIt=0,h.roundNeutral=0)}),s=y(i),a=0,r=!1}function F(){o=1,M(),S()}function g(){return s[a]??null}function A(){const u=g();return u==null?null:H().get(u)??null}function $(u){const f=g();if(f==null)return;const h=I.get(f);h&&(u==="again"?(h.nextRate=Kt,h.totalGotIt=0,h.roundAgain+=1):u==="gotit"?(h.totalGotIt+=1,h.roundGotIt+=1,h.nextRate=h.totalGotIt>=Xt?Yt:Ut):u==="neutral"&&(h.roundNeutral+=1,h.nextRate=De))}function V(){return r=!1,a<s.length-1?(a+=1,!1):(c=!0,!0)}return F(),{getMode:()=>n,setMode(u){n!==u&&(n=u,s=y(i),a=0,r=!1)},resetSession:F,getRoundNumber:()=>o,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>r,flip(){r=!r},unflip(){r=!1},currentCard:A,prev(){return a>0?(a-=1,r=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,r=!1,!0):!1},rateAgain(){return r?($("again"),V()):!1},rateGotIt(){return r?($("gotit"),V()):!1},rateNeutral(){return r?($("neutral"),V()):!1},isSummary:()=>c,isSessionComplete:()=>O,getRoundStats(){let u=0,f=0,h=0;return I.forEach(x=>{u+=x.roundAgain,f+=x.roundGotIt,h+=x.roundNeutral}),{again:u,gotIt:f,neutral:h}},nextRound(){o+=1,S()},restart(){F()}}}function kt(t,{deckOptions:n,buildDeck:o,initialDeck:i="all"}){let s=i,a=null,r=null;t.innerHTML=`
      ...
      <section class="panel panel--topic-hub">
        ...
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([f,h])=>{const x=f==="convex"||f==="concave"?"lens":f==="refraction"||f==="tir"?"refractionTir":f==="em"?"em":f,G=f==="convex"?"convex":f==="concave"?"concave":"";return`
            <div class="card">
              <h3>${l(h)}</h3>
              <button class="btn primary" type="button" data-go-tool="${x}"${G?` data-lens-kind="${G}"`:""}>${l("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function H(u){const f=u.target.closest("[data-go-tool]");if(!f)return;n="tools",o=f.getAttribute("data-go-tool");const h=f.getAttribute("data-lens-kind");(h==="convex"||h==="concave")&&(i=h),s.updateSection(n),O()}function M(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${u.map(f=>{const h=l(`notes.card.${f.key}`);return`
            <div class="card" data-note-card="${f.key}">
              <h3>${h}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function B(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],f=Oe();for(const h of u){const x=t.querySelector(`[data-note-card="${h.key}"]`);if(!x)continue;const G=x.querySelector("[data-note-body]"),j=f==="zhHant"?h.fileZh:h.fileEn,E=await ha(j),W=`./notes/${j}`;E?G.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${h.key}`)}" src="${W}"></iframe>
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:G.innerHTML=`<p class="lead">${l("notes.missing")}</p>
          <p><a class="btn" href="./notes/README.txt" target="_blank" rel="noopener">README</a></p>`}}function y(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${da.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${fa(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function S(){const u=t.querySelector("[data-tool-list]"),f=t.querySelector("[data-tool-stage]");!u||!f||(u.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>{o=h.getAttribute("data-tool"),u.querySelectorAll("button").forEach(x=>x.classList.toggle("active",x.getAttribute("data-tool")===o)),F(f)})}),F(f))}function F(u){u.innerHTML="";const f=ua[o];if(!f)return;const h=o==="lens"?f(l,i):f(l);u.appendChild(h)}function g(){const u=[{key:"reflection",type:"image",fileEn:"reflection-en.webp",fileZh:"reflection-zhHant.webp"},{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"},{key:"convex",type:"image",fileEn:"convex-en.webp",fileZh:"convex-zhHant.webp"},{key:"concave",type:"image",fileEn:"concave-en.webp",fileZh:"concave-zhHant.webp"},{key:"em",type:"image",file:"em.webp"}];return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${u.map(f=>{const h=l(`summary.item.${f.key}`);return`
          ...
          <p style="margin-top:8px"><a href="${ee}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:G.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const j=f==="zhHant"?h.fileZh:h.fileEn,E=await Be("summary-pdfs",j),W=`./summary-pdfs/${j}`;E?G.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${h.key}`)}" src="${W}"></iframe>
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:G.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const $=()=>I(),V=u=>H(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",V),I(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",V),r==null||r(),s==null||s.destroy()}}const lt="s3phy-thermometer-lab-css",ma=900,ba=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function ga(){if(document.getElementById(lt))return;const t=document.createElement("style");t.id=lt,t.textContent=ba,document.head.appendChild(t)}function va(t){const o={x:12,y:12},i=200,{container:s,panel:a,toggleBtn:r,dragHandle:c,storageKey:O,onLayoutChange:I,breakpoint:R=1024,collapsedClass:H="controls-collapsed",floatingClass:M="controls-floating"}=t;if(!s||!a||!r)return null;let B=sessionStorage.getItem(O)!=="false",y=(()=>{try{const j=localStorage.getItem(O+":pos");if(!j)return{...o};const E=JSON.parse(j);if(typeof E.x=="number"&&typeof E.y=="number")return E}catch{}return{...o}})(),S=null,F=null;const g=()=>window.innerWidth>=R,A=(j,E)=>{const W=s.getBoundingClientRect(),P=a.getBoundingClientRect(),U=Math.max(0,W.width-P.width),ee=Math.max(0,W.height-P.height);return{x:Math.min(Math.max(0,j),U),y:Math.min(Math.max(0,E),ee)}},$=()=>{a.style.left=y.x+"px",a.style.top=y.y+"px",a.style.right="auto",a.style.bottom="auto"},V=()=>{typeof I=="function"&&(clearTimeout(F),F=setTimeout(I,i))},u=()=>{r.setAttribute("aria-expanded",B?"false":"true"),t.getToggleTitle&&(r.title=t.getToggleTitle(B));const j=r.querySelector("[data-float-chevron]");j&&(j.textContent=B?"v":"^")},f=j=>{B=j,a.classList.toggle(H,B),sessionStorage.setItem(O,B?"true":"false"),u(),V()},h=()=>{s.classList.add(M),a.classList.add("lab-controls-float"),y=A(y.x,y.y),$(),c&&(c.style.display="")},x=()=>{s.classList.remove(M),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",c&&(c.style.display="none")},G=()=>{g()?(h(),y=A(y.x,y.y),$()):x(),V()};if(a.classList.toggle(H,B),u(),G(),r.addEventListener("click",j=>{j.stopPropagation(),f(!B)}),c){c.addEventListener("pointerdown",E=>{g()&&(E.preventDefault(),S={pointerId:E.pointerId,startX:E.clientX,startY:E.clientY,originX:y.x,originY:y.y},c.setPointerCapture(E.pointerId),c.classList.add("is-dragging"))}),c.addEventListener("pointermove",E=>{!S||S.pointerId!==E.pointerId||(y=A(S.originX+E.clientX-S.startX,S.originY+E.clientY-S.startY),$())});const j=E=>{if(!(!S||S.pointerId!==E.pointerId)){c.releasePointerCapture(E.pointerId),c.classList.remove("is-dragging");try{localStorage.setItem(O+":pos",JSON.stringify(y))}catch{}S=null,V()}};c.addEventListener("pointerup",j),c.addEventListener("pointercancel",j)}return window.addEventListener("resize",G),{setCollapsed:f,refreshMode:G,isCollapsed:()=>B}}function Ge(t,n={}){ga();const o=n.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");n.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
  ...
  `;const r={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},c=460,O=340,I=80,R=800,H=560;function M(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:R-e.left-e.right,gh:H-e.top-e.bottom,tickFont:`bold ${Math.round(R*.024)}px Arial`,axisFont:`bold ${Math.round(R*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:H-e.bottom+32}}function B(){let d=100;const m=Math.max(r.bathTemp,r.thermometerTemp,100);m>120&&(d=150),m>145&&(d=200);const b=d<=100?20:25;return{minT:0,maxT:d,tickStep:b}}function y(e,d,m,b,p){return b+(e-d)/(m-d)*p}function S(e,d,m,b,p){return b+p-(e-d)/(m-d)*p}function F(e,d,m,b,p,T){const{gx:v,gy:w,gw:C,gh:L,tickFont:z,axisFont:Q,yLabelX:X,xLabelY:q}=d;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const K of T){const Y=S(K.value,K.min,K.max,w,L);e.beginPath(),e.moveTo(v,Y),e.lineTo(v+C,Y),e.stroke()}for(let K=m;K<=b+.01;K+=p){const Y=y(K,m,b,v,C);e.beginPath(),e.moveTo(Y,w),e.lineTo(Y,w+L),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(v,w),e.lineTo(v,w+L),e.lineTo(v+C,w+L),e.stroke(),e.fillStyle="#e4e4e7",e.font=z,e.textAlign="right",e.textBaseline="middle";for(const K of T){const Y=S(K.value,K.min,K.max,w,L);e.fillText(K.label,v-15,Y)}e.textAlign="center",e.textBaseline="top";for(let K=m;K<=b+.01;K+=p){const Y=y(K,m,b,v,C);e.fillText(`${Math.round(K)}`,Y,w+L+10)}return{gx:v,gy:w,gw:C,gh:L,axisFont:Q,yLabelX:X,xLabelY:q}}function g(e,d){const m=d-e,b=m<=8?1:m<=14?2:5,p=[],T=Math.ceil(e/b)*b;for(let v=T;v<=d+.001;v+=b)p.push({value:v,label:v%1===0?`${v.toFixed(0)}`:`${v.toFixed(1)}`,min:e,max:d});return p}function A(){const{maxT:e}=B(),d=$(0),m=$(e),b=m-d,p=Math.max(1,b*.1),T=Math.max(0,Math.round((d-p)*10)/10),v=Math.round((m+p)*10)/10;return{minL:T,maxL:v}}function $(e){return r.liquidL0+(r.liquidL100-r.liquidL0)/100*e}function V(){const{maxT:e}=B(),d=u(0),m=u(e),b=m-d,p=Math.max(.2,b*.1),T=Math.max(0,d-p),v=m+p,w=b<=2?.5:b<=4?1:2,C=[],L=Math.ceil(T/w)*w;for(let z=L;z<=v+.001;z+=w)C.push({value:z,label:z.toFixed(1),min:T,max:v});return{minR:T,maxR:v,ticks:C}}function u(e){return r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*e}function f(e){const{maxT:d}=e;let m=r.thermistorR25;for(let v=0;v<=d;v+=5){const w=v+273.15,C=r.thermistorR25*Math.exp(r.thermistorBeta*(1/w-1/298.15));m=Math.max(m,C)}m=Math.ceil(m*1.08*10)/10;const b=0,p=m<=12?2:4,T=[];for(let v=0;v<=m+.001;v+=p)T.push({value:v,label:v.toFixed(0),min:b,max:m});return{minR:b,maxR:m,ticks:T}}const h=a.querySelector("#tl-thermometerCanvas"),x=h.getContext("2d"),G=a.querySelector("#tl-graphCanvas"),j=G.getContext("2d"),E=window.devicePixelRatio||1;h.width=c*E,h.height=O*E,x.scale(E,E),G.width=R*E,G.height=H*E,j.scale(E,E);function W(){r.iceCubes=[];for(let e=0;e<5;e++)r.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});r.bubbles=[];for(let e=0;e<20;e++)r.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});r.heatWaves=[];for(let e=0;e<8;e++)r.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});r.steamParticles=[];for(let e=0;e<12;e++)r.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const P=200,U=11;function ee(){const e=Math.pow(r.bulbVolume/P,.3333333333333333);return U*e}function ne(){if(r.thermometerType==="resistance"||r.thermometerType==="thermistor")return .35;const e=r.liquidType==="mercury"?1:8,d=.2+r.wallThickness*1.5,m=.4+r.bulbVolume*.003,b=1.35-r.capillaryBore*.45;return Math.max(.1,d*m*b*e*.15)}function te(e){r.bathTemp<=8&&r.iceCubes.forEach(d=>{d.x+=d.speedX,d.y+=d.speedY,(d.x<65||d.x>175)&&(d.speedX*=-1),(d.y<195||d.y>210)&&(d.speedY*=-1)}),r.bathTemp>35&&r.heatWaves.forEach(d=>{d.y-=d.speedY*(1+r.bathTemp/100),d.y<185&&(d.y=265,d.x=65+Math.random()*110)}),r.bathTemp>=80&&r.bubbles.forEach(d=>{d.y-=d.speedY*(1+(r.bathTemp-80)/40),d.phase+=d.wobbleSpeed,d.x+=Math.sin(d.phase)*.3,d.y<185&&(d.y=260+Math.random()*10,d.x=60+Math.random()*120)}),r.bathTemp>=95&&r.steamParticles.forEach(d=>{d.x+=d.vx,d.y+=d.vy,d.alpha-=.005,(d.alpha<=0||d.y<130)&&(d.x=60+Math.random()*120,d.y=175+Math.random()*5,d.alpha=.2+Math.random()*.4)})}function ae(e){let v=59,w=130,C=246;if(r.bathTemp<25){const q=r.bathTemp/25;v=Math.round(180-q*121),w=Math.round(210-q*80),C=Math.round(250-q*4)}else{const q=Math.min(1,(r.bathTemp-25)/125);v=Math.round(59+q*180),w=Math.round(130-q*100),C=Math.round(246-q*190)}if(r.bathTemp>40){const q=Math.min(1,(r.bathTemp-40)/100),K=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let Y=-25;Y<=25;Y+=6){const re=q*(12+Math.sin(Y*.4+K)*5);e.lineTo(55+130/2+Y,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const L=e.createLinearGradient(55,190,55,280);L.addColorStop(0,`rgba(${v}, ${w}, ${C}, 0.25)`),L.addColorStop(1,`rgba(${v}, ${w}, ${C}, 0.55)`),e.fillStyle=L,e.beginPath(),e.moveTo(55,190);const z=r.bathTemp>=80?2:.5,Q=r.bathTemp>=80?.09:.03,X=Date.now()*Q;for(let q=55;q<=185;q+=5){const K=190+Math.sin(q*.15+X)*z;e.lineTo(q,K)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),r.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(r.bathTemp-35)/120)})`,e.lineWidth=1.2,r.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),r.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,r.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),r.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,r.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),r.bathTemp>=95&&r.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function k(e,d,m,b,p,T,v="left"){if(!r.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(d,m),e.lineTo(b,p),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(d,m,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const C=e.measureText(T).width+10,L=16,z=v==="left"?b:b-C,Q=p-L/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(z,Q,C,L,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(T,z+C/2,Q+L/2+.5)}function _(e){const b=ee(),p=250+Math.max(0,b-U)*.35,T=p-b-1,v=10+r.wallThickness*8,w=120-v/2,C=120+v/2,L=e.createLinearGradient(w,20,C,20);L.addColorStop(0,"rgba(209, 213, 219, 0.85)"),L.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),L.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),L.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),L.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=L,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,T),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(C,20,C,25,5),e.lineTo(C,T),e.closePath(),e.fill(),e.stroke();const z=e.createRadialGradient(120-b*.2,p-b*.2,b*.1,120,p,b);z.addColorStop(0,"rgba(255, 255, 255, 0.8)"),z.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=z,e.strokeStyle="#6b7280",e.lineWidth=.8+r.wallThickness*.6,e.beginPath(),e.arc(120,p,b+.5+r.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const Q=Math.min(v*.72,.8+r.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-Q/2,28,Q,T-20-8);const X=r.liquidType==="mercury",q=X?"#a1a1aa":"#ef4444",K=X?"#f4f4f5":"#fee2e2",Y=210,re=220,be=(Y-40)/re,he=Y-Math.min(re,r.thermometerTemp)*be;e.fillStyle=q,e.fillRect(120-Q/2,he,Q,T-he),e.beginPath(),e.ellipse(120,he,Q/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=K,e.fillRect(120-Q/6,he,Q/3,T-he);const se=b*.9,ie=e.createRadialGradient(120-se*.2,p-se*.2,se*.1,120,p,se);X?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,p,se,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ce=0;ce<=200;ce+=50){const pe=Y-ce*be;e.beginPath(),e.moveTo(w,pe),e.lineTo(w+4,pe),e.stroke(),e.fillText(`${ce}°C`,w-22,pe+2.5)}r.showLabels&&(k(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),k(e,120,he,230,he-15,t("tools.thermometerLab.labels.meniscus"),"left"),k(e,120-Q/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),k(e,120,p,230,p+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function J(e){const v=e.createLinearGradient(115,20,125,20);v.addColorStop(0,"#71717a"),v.addColorStop(.3,"#f4f4f5"),v.addColorStop(.7,"#d4d4d8"),v.addColorStop(1,"#3f3f46"),e.fillStyle=v,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let X=0;X<8;X++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const C=245,L=40,z=135,Q=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(C,L,z,Q,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(C+10,L+12,z-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(r.currentResistance.toFixed(2)+" Ω",C+z-16,L+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",C+14,L+21),r.showLabels&&(k(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),k(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function D(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,T=225,v=12,w=120-v/2,C=e.createLinearGradient(w,p,w+v,p);C.addColorStop(0,"rgba(229, 231, 235, 0.4)"),C.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),C.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),C.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,p,v,T-p,[0,0,3,3]),e.fill(),e.stroke();const L=7,z=e.createRadialGradient(120-L*.2,245-L*.2,L*.1,120,245,L);z.addColorStop(0,"#6b7280"),z.addColorStop(.7,"#1f2937"),z.addColorStop(1,"#09090b"),e.fillStyle=z,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,L,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const Q=245,X=40,q=135,K=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(Q,X,q,K,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(Q+10,X+12,q-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(r.currentThermistorR.toFixed(2)+" kΩ",Q+q-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",Q+14,X+21),r.showLabels&&(k(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),k(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Z(e,d,m,b,p,T,v,w,C){const{gx:L,gy:z,gw:Q,gh:X}=d;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(m,b),e.lineTo(m,z+X),e.stroke(),e.beginPath(),e.moveTo(m,b),e.lineTo(L,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${p.toFixed(1)}${v}`,K=e.measureText(q).width+10;e.fillStyle=C,e.beginPath(),e.roundRect(m-K/2,z+X+2,K,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,m,z+X+4),e.textAlign="right",e.textBaseline="middle";const Y=`${T.toFixed(2)} ${w}`,re=e.measureText(Y).width+10;e.fillStyle=C,e.beginPath(),e.roundRect(L-re-2,b-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(Y,L-7,b)}function N(e){const d=M(),{minL:m,maxL:b}=A(),{minT:p,maxT:T,tickStep:v}=B(),w=g(m,b),C=F(e,d,p,T,v,w),{gx:L,gy:z,gw:Q,gh:X,axisFont:q,yLabelX:K,xLabelY:Y,dotR:re}={...d,...C};e.save(),e.translate(K,z+X/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",L+Q/2,Y);const we=T,be=y(0,p,T,L,Q),he=S($(0),m,b,z,X),se=y(we,p,T,L,Q),ie=S($(we),m,b,z,X);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentLength;if(ce>=p&&ce<=T){const ve=y(ce,p,T,L,Q),Te=S(pe,m,b,z,X);Z(e,d,ve,Te,ce,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Te,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const d=M(),{minR:m,maxR:b,ticks:p}=V(),T=B(),v=F(e,d,T.minT,T.maxT,T.tickStep,p),{gx:w,gy:C,gw:L,gh:z,axisFont:Q,yLabelX:X,xLabelY:q,dotR:K}={...d,...v};e.save(),e.translate(X,C+z/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+L/2,q);const{minT:Y,maxT:re}=T,we=re,be=y(0,Y,re,w,L),he=S(u(0),m,b,C,z),se=y(we,Y,re,w,L),ie=S(u(we),m,b,C,z);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentResistance;if(ce>=Y&&ce<=re){const ve=y(ce,Y,re,w,L),Te=S(pe,m,b,C,z);Z(e,d,ve,Te,ce,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Te,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function le(e){const d=M(),m=B(),{minR:b,maxR:p,ticks:T}=f(m),v=F(e,d,m.minT,m.maxT,m.tickStep,T),{gx:w,gy:C,gw:L,gh:z,axisFont:Q,yLabelX:X,xLabelY:q,dotR:K}={...d,...v},{minT:Y,maxT:re}=m;e.save(),e.translate(X,C+z/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+L/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let se=Y;se<=re;se+=1){const ie=se+273.15,ce=r.thermistorR25*Math.exp(r.thermistorBeta*(1/ie-1/298.15)),pe=y(se,Y,re,w,L),ve=S(Math.min(p,ce),b,p,C,z);ve>=C&&ve<=C+z&&(we?e.lineTo(pe,ve):(e.moveTo(pe,ve),we=!0))}e.stroke();const be=r.thermometerTemp,he=r.currentThermistorR;if(be>=Y&&be<=re){const se=y(be,Y,re,w,L),ie=S(Math.min(p,he),b,p,C,z);Z(e,d,se,ie,be,he,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(se,ie,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ue(){x.clearRect(0,0,c,O),j.clearRect(0,0,R,H),x.save(),x.translate(I,0),ae(x),r.thermometerType==="liquid"?_(x):r.thermometerType==="resistance"?J(x):D(x),x.restore(),r.thermometerType==="liquid"?N(j):r.thermometerType==="resistance"?de(j):le(j)}function ge(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const d=a.querySelector("#tl-svg-formula-liquid-sub");if(d){const v=r.liquidL100-r.liquidL0,w=r.currentLength-r.liquidL0;d.innerHTML=`
      ...
      `);const b=a.querySelector("#tl-svg-formula-resistance-sub");if(b){const v=r.resistanceR100-r.resistanceR0,w=r.currentResistance-r.resistanceR0;b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `);const T=a.querySelector("#tl-svg-formula-thermistor-sub");if(T){const v=r.thermometerTemp+273.15;T.innerHTML=`
      ...
      `}}function qe(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:d,cu:m,interval:b}=He(),p=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,v=a.querySelector("#tl-pane-q10a").classList.contains("active"),w=v?(p-d)/b*100:T,C=v?p:T/100*b+d,z=(Q=>130-Q/100*80)(w);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="133" fill="#f59e0b" font-size="10" font-weight="bold" text-anchor="start">C<tspan dy="3" font-size="7">f</tspan><tspan dy="-3"> = ${d.toFixed(1)}°C</tspan></text>
          ...
          <text x="125" y="${z+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${C.toFixed(1)}°C</text>
    ...
    `}function ke(e){a.querySelector("#tl-bath-temp-display").innerHTML=r.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=r.bathTemp.toFixed(1)+" °C";const d=a.querySelector("#tl-bath-state");r.bathTemp<=0?d.textContent="Melting Ice Bath":r.bathTemp>=100?d.textContent="Boiling Water/Steam":r.bathTemp===150?d.textContent="Hot Cooking Oil":d.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const m=a.querySelector("#tl-alcohol-boiling-warning");r.thermometerType==="liquid"&&r.liquidType==="alcohol"&&r.bathTemp>=78?m.style.display="block":m.style.display="none",r.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=r.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):r.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=r.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=r.currentThermistorR.toFixed(2)+" kΩ",ge()}let Se=null;function _e(e){r.lastTimestamp||(r.lastTimestamp=e);const d=(e-r.lastTimestamp)/1e3;r.lastTimestamp=e;const m=Math.min(d,.1),b=ne(),p=m/b*(r.bathTemp-r.thermometerTemp);r.thermometerTemp+=p,r.currentLength=r.liquidL0+(r.liquidL100-r.liquidL0)/100*r.thermometerTemp,r.currentResistance=r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*r.thermometerTemp;const T=r.thermometerTemp+273.15;r.currentThermistorR=r.thermistorR25*Math.exp(r.thermistorBeta*(1/T-1/298.15)),te(),ue(),ke(b),Se=requestAnimationFrame(_e)}function He(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),d=parseFloat(a.querySelector("#tl-input-faulty-cu").value),m=Number.isFinite(e)?e:-1.5,b=Number.isFinite(d)?d:105,p=b-m;return{cf:m,cu:b,interval:p}}function Fe(e){const d=Math.round(e*100)/100;return d>=0?d.toFixed(1):`(${d.toFixed(1)})`}function me(){const{cf:e,cu:d,interval:m}=He(),b=a.querySelector("#tl-val-faulty-interval"),p=a.querySelector("#tl-faulty-error-a"),T=a.querySelector("#tl-faulty-error-b"),v=Math.abs(m)<.01;b.textContent=m.toFixed(1)+" °C";const w=a.querySelector("#tl-svg-formula-faulty-a"),C=a.querySelector("#tl-svg-formula-faulty-b");if(v){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",T.hidden=!1,T.textContent=p.textContent,w&&(w.innerHTML=""),C&&(C.innerHTML="");return}p.hidden=!0,T.hidden=!0;const L=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,z=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,Q=(L-e)/m*100,X=z/100*m+e;w&&(w.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${L.toFixed(1)} - ${Fe(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${d.toFixed(1)} - ${Fe(e)}</text>
      ...
      `),C&&(C.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${Fe(e)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${X.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),qe()}function ye(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,d=(e-r.resistanceR0)/(r.resistanceR100-r.resistanceR0)*100,m=a.querySelector("#tl-svg-formula-resistance-solver");m&&(m.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="170" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            &times; 100 = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${d.toFixed(1)}°C</tspan>
          </text>
        </svg>
      `)}function Ce(){const e=r.thermometerTemp,d=r.liquidL100-r.liquidL0,m=r.liquidL0+d/100*e,b=a.querySelector("#tl-svg-formula-t-to-l");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${r.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${d.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${m.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function Ne(){const e=r.thermometerTemp,d=r.resistanceR100-r.resistanceR0,m=r.resistanceR0+d/100*e,b=a.querySelector("#tl-svg-formula-t-to-r");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">R<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${r.resistanceR0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${d.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${m.toFixed(2)} Ω</tspan>
          </text>
        </svg>
      `)}function fe(){me(),ye(),Ce(),Ne()}function Ee(e,d){a.querySelector("#"+e).addEventListener("click",()=>{r.bathTemp=d,a.querySelector("#tl-bath-temp-slider").value=d,fe()})}function zt(){a.querySelectorAll(".tl-tab-btn").forEach(p=>{p.addEventListener("click",()=>{a.querySelectorAll(".tl-tab-btn").forEach(v=>v.classList.remove("active")),a.querySelectorAll(".tl-tab-content").forEach(v=>v.classList.remove("active")),p.classList.add("active");const T=p.getAttribute("data-tl-tab");a.querySelector("#tl-tab-"+T).classList.add("active"),r.thermometerType=T,fe()})}),a.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{r.showLabels=!r.showLabels,a.querySelector("#tl-lbl-toggle-labels").textContent=r.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",p=>{r.bathTemp=parseFloat(p.target.value),fe()}),Ee("tl-btn-preset-ice",0),Ee("tl-btn-preset-room",25),Ee("tl-btn-preset-steam",100),Ee("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{r.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",fe()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{r.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",fe()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",p=>{r.bulbVolume=parseFloat(p.target.value),a.querySelector("#tl-val-bulb-vol").textContent=r.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",p=>{r.wallThickness=parseFloat(p.target.value),a.querySelector("#tl-val-wall-thickness").textContent=r.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-capillary-bore").addEventListener("input",p=>{r.capillaryBore=parseFloat(p.target.value),a.querySelector("#tl-val-capillary-bore").textContent=r.capillaryBore.toFixed(2)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",p=>{r.liquidL0=parseFloat(p.target.value),a.querySelector("#tl-val-liquid-l0").textContent=r.liquidL0.toFixed(1)+" cm",fe()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",p=>{r.liquidL100=parseFloat(p.target.value),a.querySelector("#tl-val-liquid-l100").textContent=r.liquidL100.toFixed(1)+" cm",fe()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",p=>{r.resistanceR0=parseFloat(p.target.value),a.querySelector("#tl-val-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",fe()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",p=>{r.resistanceR100=parseFloat(p.target.value),a.querySelector("#tl-val-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",fe()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",p=>{r.thermistorR25=parseFloat(p.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",fe()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",p=>{r.thermistorBeta=parseFloat(p.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=r.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=r.thermistorBeta+" K",fe()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active"),me()}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",me),a.querySelector("#tl-input-faulty-cu").addEventListener("input",me),a.querySelector("#tl-input-q10a-cm").addEventListener("input",me),a.querySelector("#tl-input-q10b-t").addEventListener("input",me),a.querySelector("#tl-input-q11-r").addEventListener("input",ye);const m=a.querySelector("#tl-input-t-to-l");m&&m.addEventListener("input",fe);const b=a.querySelector("#tl-input-t-to-r");b&&b.addEventListener("input",fe)}if(n.type){const e=a.querySelector(".tl-tabs-container");e&&(e.style.display="none")}a.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===o?e.classList.add("active"):e.classList.remove("active")}),a.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===o?e.classList.add("active"):e.classList.remove("active")}),W(),zt(),fe();const Qe=a.querySelector(".tl-dash"),Ve=a.querySelector(".tl-controls"),Ke=a.querySelector("#tl-controls-toggle"),Rt=a.querySelector("#tl-controls-drag");return Qe&&Ve&&Ke&&va({container:Qe,panel:Ve,toggleBtn:Ke,dragHandle:Rt,storageKey:`s3phy-thermo-${o}`,breakpoint:ma,getToggleTitle:e=>t(e?"tools.floatingControls.showParams":"tools.floatingControls.hideParams"),onLayoutChange:()=>ue()}),Se=requestAnimationFrame(_e),a._thermometerLabCleanup=()=>{Se&&cancelAnimationFrame(Se)},a}function ya(t){const n=document.createElement("div");n.className="tool-specific-heat";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"specific-heat/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function wa(t){const n=document.createElement("div");n.className="tool-thermal-mixing";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"thermal-mixing/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function xa(t){const n=document.createElement("div");n.className="tool-change-of-state";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"change-of-state/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function ka(t){const n=document.createElement("div");n.className="tool-heat-transfer";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}const Le=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],ct=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],Sa=[["thermometer","topic.thermometer"]],dt=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],qa={liquid:t=>Ge(t,{type:"liquid"}),resistance:t=>Ge(t,{type:"resistance"}),thermistor:t=>Ge(t,{type:"thermistor"}),specificHeat:t=>ya(t),thermalMixing:t=>wa(t),changeOfState:t=>xa(t),heatTransfer:t=>ka(t)};function Ca(t){return l({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function je(){return oe()==="zh-Hant"?"zhHant":"en"}async function Me(t,n){const o=`./${t}/${n}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function ut(t){return Me("notes",t)}function Ta(t){let n="topics",o="liquid",i=null,s={main:null},a=null,r=null;const c=[{value:"all",labelKey:"flashcards.all"},{value:"thermometry",labelKey:"flashcards.deck.thermometry"},{value:"heatInternalEnergy",labelKey:"flashcards.deck.heatInternalEnergy"},{value:"changeOfState",labelKey:"flashcards.deck.changeOfState"},{value:"heatTransfer",labelKey:"flashcards.deck.heatTransfer"}];function O(){if(s.main){if(r==null||r(),r=null,n==="topics"?s.main.innerHTML=R():n==="notes"?s.main.innerHTML=M():n==="tools"?s.main.innerHTML=y():n==="worksheets"?s.main.innerHTML=wt(l,{topics:Sa,paperTitleKey:"worksheets.paperTitleHeat"}):n==="flashcards"?r=kt(s.main,{deckOptions:c.map(u=>({value:u.value,label:l(u.labelKey)})),buildDeck:u=>ca(u,oe())}):n==="summary"&&(s.main.innerHTML=g()),n==="notes"&&B(),n==="tools"&&S(),n==="worksheets"){const u=vt.filter(f=>ct.includes(f.topic));xt(t,u,l,je,{topicFilter:(f,h)=>h.includes("thermometer")?ct.includes(f.topic):h.includes(f.topic)})}n==="summary"&&A()}}function I(){i==null||i.destroy(),i=yt(t,{subtitleKey:"strand.heat.subtitle",activeSection:n,onSection:u=>{n==="tools"&&u!=="tools"&&a!=null&&a._thermometerLabCleanup&&(a._thermometerLabCleanup(),a=null),n=u,i.updateSection(n),O()},onLang:()=>I()}),s.main=i.main,i.updateSection(n),O()}function R(){return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Le.map(u=>{const f=u.tool?`<button class="btn primary" type="button" data-go-tool="${u.tool}">${l("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${l("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${l(u.titleKey)}</h3>
              ${f}
            </div>`}).join("")}
        </div>
      </section>`}function H(u){const f=u.target.closest("[data-go-tool]");if(f){const x=f.getAttribute("data-go-tool");dt.includes(x)?o=x:o="liquid",n="tools",i.updateSection(n),O();return}const h=u.target.closest("[data-go-section]");(h==null?void 0:h.getAttribute("data-go-section"))==="notes"&&(n="notes",i.updateSection(n),O())}function M(){return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${Le.map(u=>`
            <div class="card" data-note-card="${u.id}">
              <h3>${l(`notes.card.${u.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function B(){const u=je();for(const f of Le){const h=t.querySelector(`[data-note-card="${f.id}"]`);if(!h)continue;const x=h.querySelector("[data-note-body]"),G=u==="zhHant"?f.fileZh:f.fileEn,j=await ut(G),E=`./notes/${G}`;j?x.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${f.id}`)}" src="${E}"></iframe>
          <p style="margin-top:8px"><a href="${E}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:x.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function y(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${dt.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${Ca(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function S(){const u=t.querySelector("[data-tool-list]"),f=t.querySelector("[data-tool-stage]");!u||!f||(u.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>{o=h.getAttribute("data-tool"),u.querySelectorAll("button").forEach(x=>x.classList.toggle("active",x.getAttribute("data-tool")===o)),F(f)})}),F(f))}function F(u){u.innerHTML="",a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup();const f=qa[o];f&&(a=f(l),u.appendChild(a))}function g(){return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ...
          <img class="summary-thumb" src="${P}" alt="${l("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}if(f.id==="heatInternalEnergy"){const W=await Me("summary","heat-internal-energy.webp"),P="./summary/heat-internal-energy.webp";W?x.innerHTML=`
          <img class="summary-thumb" src="${P}" alt="${l("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}if(f.id==="changeOfState"){const W=await Me("summary","change-of-state.webp"),P="./summary/change-of-state.webp";W?x.innerHTML=`
          <img class="summary-thumb" src="${P}" alt="${l("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}if(f.id==="heatTransfer"){const W=await Me("summary","heat-transfer.webp"),P="./summary/heat-transfer.webp";W?x.innerHTML=`
          <img class="summary-thumb" src="${P}" alt="${l("summary.item.heatTransfer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const G=u==="zhHant"?f.fileZh:f.fileEn,j=await ut(G),E=`./notes/${G}`;j?x.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${f.id}`)}" src="${E}"></iframe>
          <p style="margin-top:8px"><a href="${E}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:x.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const $=()=>I(),V=u=>H(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",V),I(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",V),r==null||r(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const ft={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Ht();Et();const ht="s3phy_splash_seen",Ct={optics:pa,heat:Ta};let ze=null,Re=null;function La(){const t=location.hash.match(/^#\/(\w+)/),n=t==null?void 0:t[1];return n&&Object.prototype.hasOwnProperty.call(Ct,n)?n:null}function za(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function Tt(t){ze==null||ze(),ze=null,Re==null||Re(),Re=null;const n=document.getElementById("app");if(!n)return;if(n.innerHTML="",!t){location.hash&&za(),Re=$t(n);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}ze=Ct[t](n)??null}function Lt(){Tt(La())}function Ra(){return"./images/uniplus-logo.png"}function Ma(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Ra()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function _a(t,n){const o=[...ft.en,...ft.zhHant],i=()=>{if(!t.parentElement)return;const s=document.createElement("div");s.className="splash-danmaku-item",s.textContent=o[Math.floor(Math.random()*o.length)];const a=Math.random()*85+5,r=Math.random()*.8+.9,c=Math.random()*12+10;s.style.top=`${a}%`,s.style.fontSize=`${r}rem`,s.style.animationDuration=`${c}s`,n.appendChild(s),s.addEventListener("animationend",()=>s.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let s=0;s<4;s+=1)window.setTimeout(i,s*1e3)}function Ha(t){const n=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>n==null?void 0:n.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),o&&_a(t,o)},1600)}function pt(){Lt()}function Fa(){let t=!1;try{t=sessionStorage.getItem(ht)==="1"}catch{}if(t){pt();return}const n=Ma();document.body.insertBefore(n,document.body.firstChild),Ha(n);const o=n.querySelector("#splashStart"),i=()=>{n.remove(),pt()};o.addEventListener("click",()=>{try{sessionStorage.setItem(ht,"1")}catch{}n.classList.add("splash--hide"),n.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",Lt);window.addEventListener("s3phy:strand",t=>{Tt(t.detail??null)});Fa();
