(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function o(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=o(s);fetch(s.href,a)}})();const $e={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.hideLabList":"Hide lab list","tools.showLabList":"Show lab list","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Study with spaced repetition — cards you find harder appear more often in later rounds. Picture decks for reflection, refraction, TIR, EM waves, and lenses.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","flashcards.mode.sequence":"Sequence","flashcards.mode.random":"Random","flashcards.again":"Again","flashcards.gotIt":"Got it","flashcards.round":"Round {round} · {total} cards","flashcards.flipFirst":"Tap the card, press Space, or Flip to reveal the answer first.","flashcards.hint.rated":"← Again · Got it →  (or keys 1 / 2)","flashcards.summary.title":"Round {round} complete","flashcards.summary.stats":"{total} cards studied · Again {again} · Got it {gotIt} · Next {neutral}","flashcards.summary.keep":"{count} to keep practising","flashcards.summary.confident":"{count} confident","flashcards.summary.nextRound":"Next round","flashcards.summary.restart":"Restart session","flashcards.summary.complete":"Session complete","flashcards.summary.completeStats":"Great work — you have finished all scheduled copies.","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF or image). Preview below or open in a new tab.","summary.viewImage":"Open full image","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","flashcards.deck.heatInternalEnergy":"Heat and internal energy","flashcards.deck.changeOfState":"Change of state","flashcards.deck.heatTransfer":"Heat transfer","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.specificHeat.title":"Specific Heat Capacity Lab","tools.thermalMixing.title":"Thermal Mixing Lab","tools.changeOfState.title":"Change of State Lab","tools.heatTransfer.title":"Heat Transfer Laboratory","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","tools.thermometerLab.liquid.title":"Liquid-in-Glass Thermometer","tools.thermometerLab.liquid.subtitle":"Explore the effects of bulb volume, capillary bore, and liquid type on sensitivity and response time.","tools.thermometerLab.resistance.title":"Platinum Resistance Thermometer","tools.thermometerLab.resistance.subtitle":"Investigate how platinum resistance varies linearly with temperature and solve calibration problems.","tools.thermometerLab.thermistor.title":"NTC Thermistor","tools.thermometerLab.thermistor.subtitle":"Study the non-linear resistance-temperature relationship of NTC thermistors and live beta calculations.","tools.thermometerLab.labels.show":"Show Structure Labels","tools.thermometerLab.labels.hide":"Hide Structure Labels","tools.thermometerLab.labels.thinWall":"Thin glass wall (fast heat transfer)","tools.thermometerLab.labels.largeBulb":"Large bulb (contains more liquid, increases sensitivity)","tools.thermometerLab.labels.narrowBore":"Narrow capillary bore (liquid rises higher, increases sensitivity)","tools.thermometerLab.labels.meniscus":"Meniscus (reading point)","tools.thermometerLab.labels.platinumCoil":"Platinum coil (resistance increases linearly with temp)","tools.thermometerLab.labels.metalSheath":"Metal sheath (protects & conducts heat quickly)","tools.thermometerLab.labels.semiconductorBead":"Semiconductor bead (resistance decreases exponentially with temp)","tools.thermometerLab.labels.leads":"Connecting leads","tools.thermometerLab.faulty.dualScale":"Dual-Scale Comparison Diagram","tools.thermometerLab.faulty.trueScale":"True Scale (°C)","tools.thermometerLab.faulty.faultyScale":"Faulty Scale (°C)","tools.thermometerLab.paramSettings":"Parameter settings","tools.floatingControls.dragHint":"Drag to move","tools.floatingControls.showParams":"Show parameters","tools.floatingControls.hideParams":"Hide parameters","tools.thermometerLab.faultySolver":"Faulty thermometer solver","tools.thermometerLab.resistanceSolver":"Resistance-to-temperature solver","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},$t={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.hideLabList":"收合實驗列表","tools.showLabList":"顯示實驗列表","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"使用間隔重複習—難記的卡片在下一輪會更頻繁出現。反射、折射、全內反射、電磁波、凸透鏡與凹透鏡課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","flashcards.mode.sequence":"順序","flashcards.mode.random":"隨機","flashcards.again":"再來","flashcards.gotIt":"懂了","flashcards.round":"第 {round} 輪 · {total} 張卡","flashcards.flipFirst":"請先點擊卡片、按空白鍵或翻面查看答案。","flashcards.hint.rated":"← 再來 · 懂了 →（或按 1 / 2）","flashcards.summary.title":"第 {round} 輪完成","flashcards.summary.stats":"共 {total} 張 · 再來 {again} · 懂了 {gotIt} · 下一張 {neutral}","flashcards.summary.keep":"{count} 張需繼續練習","flashcards.summary.confident":"{count} 張已掌握","flashcards.summary.nextRound":"下一輪","flashcards.summary.restart":"重新開始","flashcards.summary.complete":"練習完成","flashcards.summary.completeStats":"很好！你已完成所有排程的卡片。","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF 或圖片）。可於下方預覽，或新分頁開啟。","summary.viewImage":"開啟完整圖片","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","flashcards.deck.heatInternalEnergy":"熱與內能","flashcards.deck.changeOfState":"物態變化","flashcards.deck.heatTransfer":"熱傳入","tools.thermometerLab.title":"溫度計與校準實驗室","tools.specificHeat.title":"比熱容量實驗室","tools.thermalMixing.title":"熱混合實驗室","tools.changeOfState.title":"物態變化實驗室","tools.heatTransfer.title":"熱的轉移實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","tools.thermometerLab.liquid.title":"液體玻璃溫度計","tools.thermometerLab.liquid.subtitle":"探索玻璃泡容積、毛細管內外徑和液體種類對靉敏度及反應時間的影響。","tools.thermometerLab.resistance.title":"鈐電阻溫度計","tools.thermometerLab.resistance.subtitle":"研究鈐電阻如何隨溫度呈線性變化，並解決溫度校準問題。","tools.thermometerLab.thermistor.title":"NTC 熱敏電阻溫度計","tools.thermometerLab.thermistor.subtitle":"學習負溫度係數（NTC）熱敏電阻的非線性電阻-溫度關係，並進行實時 Beta 計算。","tools.thermometerLab.labels.show":"顯示結構標註","tools.thermometerLab.labels.hide":"隱藏結構標註","tools.thermometerLab.labels.thinWall":"薄玻璃壁 (快速傳熱)","tools.thermometerLab.labels.largeBulb":"大玻璃泡 (容納更多液體，提高靉敏度)","tools.thermometerLab.labels.narrowBore":"細毛細管 (液柱升得更高，提高靉敏度)","tools.thermometerLab.labels.meniscus":"彎月面 (讀數位置)","tools.thermometerLab.labels.platinumCoil":"鈐絲線圈 (電阻隨溫度線性增加)","tools.thermometerLab.labels.metalSheath":"金屬保護套 (保護並快速導熱)","tools.thermometerLab.labels.semiconductorBead":"半導體小珠 (電阻隨溫度指數級減少)","tools.thermometerLab.labels.leads":"連接導線","tools.thermometerLab.faulty.dualScale":"雙刻度對比示意圖","tools.thermometerLab.faulty.trueScale":"標準溫標 (°C)","tools.thermometerLab.faulty.faultyScale":"偏差溫標 (°C)","tools.thermometerLab.paramSettings":"參數設定","tools.floatingControls.dragHint":"拖曳以移動","tools.floatingControls.showParams":"顯示參數","tools.floatingControls.hideParams":"隱藏參數","tools.thermometerLab.faultySolver":"故障溫度計求解器","tools.thermometerLab.resistanceSolver":"電阻求溫度求解器","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},yt="s3phy.lang",wt={en:$e,"zh-Hant":$t};let Ie="en";function It(){try{const t=localStorage.getItem(yt);if(t==="zh-Hant"||t==="en")return t}catch{}return"en"}function Pt(){Ie=It()}function xt(t){if(wt[t]){Ie=t;try{localStorage.setItem(yt,t)}catch{}document.documentElement.lang=t==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function oe(){return Ie}function d(t){const n=wt[Ie]||$e;return Object.prototype.hasOwnProperty.call(n,t)?n[t]:Object.prototype.hasOwnProperty.call($e,t)?$e[t]:t}const Wt=.78;function Pe(){const t=document.documentElement,n=window.innerWidth,o=Math.max(window.innerHeight,1),i=n/o;let s=1;if(n<=1360?s=.88:n<=1500&&(s=.94),n>1700&&i>1.7){const a=Math.min(.07,(i-1.7)*.09),r=Math.min(.05,(n-1700)/1800*.05);s-=a+r}o<=700&&(s=Math.min(s,.82)),s=Math.max(Wt,Math.min(1,s)),t.style.setProperty("--hub-scale",s.toFixed(3))}function Ot(){return Pe(),window.addEventListener("resize",Pe),()=>window.removeEventListener("resize",Pe)}const Dt=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function Gt(t){function n(){t.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${Dt.map(({id:s,titleKey:a,descKey:r})=>`
            <div class="card">
              <h3>${d(a)}</h3>
              <p>${d(r)}</p>
...
`;function jt(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=Bt,document.head.appendChild(t)}function Nt(t){jt();const n=document.createElement("div");n.className="rml",n.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=n.querySelector(".rml-canvas"),i=o.getContext("2d"),s=n.querySelector("[data-rml-rot]"),a=n.querySelector("[data-rml-inc]"),r=n.querySelector('[data-rml-disp="rot"]'),c=n.querySelector('[data-rml-disp="inc"]'),I=n.querySelector('[data-rml-val="i"]'),$=n.querySelector('[data-rml-val="r"]'),T=n.querySelector('[data-rml-val="shift"]'),E=350,L=380,P=300,m="#22d3ee",k="bold 17px system-ui, sans-serif";let F=0,b=-140,u=!0,f=!0,v=!0,y=!0;function q(Q){return Q*Math.PI/180}function z(Q,U,Y,te,ne,ee=2,ae=!1){i.beginPath(),i.lineWidth=ee,i.strokeStyle=ne,i.setLineDash(ae?[6,6]:[]);const S=Q+Math.cos(q(Y))*te,H=U+Math.sin(q(Y))*te;return i.moveTo(Q,U),i.lineTo(S,H),i.stroke(),i.setLineDash([]),{x:S,y:H}}function G(Q,U,Y,te,ne,ee=14){const ae=Y-Q,S=te-U,H=Math.hypot(ae,S);if(H<1e-6)return;const J=ae/H,D=S/H,Z=Y-J*ee,B=te-D*ee,de=.45*ee;i.beginPath(),i.fillStyle=ne,i.moveTo(Y,te),i.lineTo(Z-D*de,B+J*de),i.lineTo(Z+D*de,B-J*de),i.closePath(),i.fill()}function j(Q,U,Y,te,ne,ee=25){i.beginPath(),i.strokeStyle=te,i.lineWidth=2;const ae=Math.min(Q,U),S=Math.max(Q,U);if(i.arc(E,L,Y,q(ae),q(S),!1),i.stroke(),ne){const H=(ae+S)/2,J=E+Math.cos(q(H))*(Y+ee),D=L+Math.sin(q(H))*(Y+ee);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=te,i.fillText(ne,J,D),i.restore()}}function W(Q,U,Y,te,ne){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(E-200,L),i.lineTo(E+200,L),i.stroke(),i.setLineDash([]),i.lineCap="butt";const ee=E+Math.cos(q(Q))*P,ae=L+Math.sin(q(Q))*P;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(ee,ae),i.lineTo(E,L),i.stroke();const S=(ee+E)*.5,H=(ae+L)*.5,J=Math.hypot(E-ee,L-ae)||1,D=(E-ee)/J,Z=(L-ae)/J;if(G(S-D*28,H-Z*28,S,H,"#fff",16),i.save(),i.font=k,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),ee,ae-12),i.restore(),u){const B=z(E,L,-90,P-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),B.x+6,B.y-4),i.restore()}if(f){const B=z(E,L,te,P,"#00e676",2,!1);G(E,L,B.x,B.y,"#00e676",16),i.save(),i.font=k,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),B.x,B.y-14),i.restore()}i.save(),i.translate(E,L),i.rotate(q(F)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let B=-190;B<200;B+=15)i.moveTo(B,0),i.lineTo(B-5,8);if(i.stroke(),i.restore(),v){const B=z(E,L,U,P-40,m,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=m,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),B.x+6,B.y-4),i.restore()}if(y){const B=z(E,L,Y,P,m,4);G(E,L,B.x,B.y,m,16),Math.abs(F)>.5&&(i.save(),i.font=k,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=m,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),B.x,B.y-14),i.restore())}if(v&&j(Q,U,100,"#ffcc00",`i=${ne.toFixed(0)}°`,25),v&&y&&j(U,Y,100,m,`r=${ne.toFixed(0)}°`,25),u&&v&&Math.abs(F)>.5&&j(-90,U,50,"#ffcc00",`θ=${Math.abs(F)}°`,20),f&&y&&Math.abs(F)>.5){const B=Y-te;j(te,Y,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${B.toFixed(0)}°`,40)}}function O(){F=parseFloat(s.value),b=parseFloat(a.value);const Q=F>0?"+":"";r.textContent=`${Q}${F}°`,c.textContent=`${b}°`;const U=-90,Y=Math.abs(b-U),te=U+Y,ne=-90+F,ee=Math.abs(b-ne),ae=ne+ee,S=ae-te;I.textContent=`${ee.toFixed(1)}°`,$.textContent=`${ee.toFixed(1)}°`;const H=S>0?"+":"";T.textContent=`${H}${S.toFixed(1)}°`,W(b,ne,ae,te,ee)}return n.querySelectorAll("[data-rml-toggle]").forEach(Q=>{Q.addEventListener("click",()=>{const U=Q.getAttribute("data-rml-toggle");U==="orig-norm"&&(u=!u),U==="orig-ray"&&(f=!f),U==="new-norm"&&(v=!v),U==="new-ray"&&(y=!y),Q.classList.toggle("active"),O()})}),n.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",O()}),s.addEventListener("input",O),a.addEventListener("input",O),O(),n}function Qt(t){const n=document.createElement("div");n.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;return o.src=`${s}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",n.appendChild(o),n}function Vt(t,n={}){const o=n.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),r="./",c=r.endsWith("/")?r:`${r}/`;return a.src=`${c}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,a.title=t(i),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function Kt(t){const n=document.createElement("div");n.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(oe())}`}o.src=a(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._emLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function Ut(t){const n=document.createElement("div");n.className="rgb-mixer",n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-r]"),i=n.querySelector("[data-g]"),s=n.querySelector("[data-b]"),a=n.querySelector(".rgb-mixer-canvas"),r=n.querySelector(".rgb-mixer-stage"),c=a.getContext("2d");function I(m){return m.toString(16).padStart(2,"0")}function $(m,k,F){const b=a.width/(window.devicePixelRatio||1),u=a.height/(window.devicePixelRatio||1),f=b/2,v=u/2,y=Math.min(b,u)*.34,q=y*.5,z=Math.sqrt(3)/2;c.clearRect(0,0,b,u),c.fillStyle="#000",c.fillRect(0,0,b,u);const G=[{x:f,y:v-q,rgb:[255,0,0],val:m},{x:f-q*z,y:v+q*.5,rgb:[0,255,0],val:k},{x:f+q*z,y:v+q*.5,rgb:[0,0,255],val:F}];c.globalCompositeOperation="lighter",G.forEach(j=>{if(j.val<=0)return;const W=j.val/255,[O,Q,U]=j.rgb,Y=c.createRadialGradient(j.x,j.y,0,j.x,j.y,y);Y.addColorStop(0,`rgba(${O},${Q},${U},${W})`),Y.addColorStop(.65,`rgba(${O},${Q},${U},${W})`),Y.addColorStop(.85,`rgba(${O},${Q},${U},${W*.5})`),Y.addColorStop(1,`rgba(${O},${Q},${U},0)`),c.fillStyle=Y,c.beginPath(),c.arc(j.x,j.y,y,0,Math.PI*2),c.fill()}),c.globalCompositeOperation="source-over"}function T(){const m=r.getBoundingClientRect(),k=Math.max(200,Math.min(m.width-8,m.height-8,720)),F=window.devicePixelRatio||1;a.width=k*F,a.height=k*F,a.style.width=`${k}px`,a.style.height=`${k}px`,c.setTransform(F,0,0,F,0,0),$(+o.value,+i.value,+s.value)}function E(){const m=+o.value,k=+i.value,F=+s.value,b=`rgb(${m}, ${k}, ${F})`,u=`#${I(m)}${I(k)}${I(F)}`;n.querySelector("[data-r-val]").textContent=m,n.querySelector("[data-g-val]").textContent=k,n.querySelector("[data-b-val]").textContent=F,n.querySelector("[data-r-bar]").style.width=`${m/255*100}%`,n.querySelector("[data-g-bar]").style.width=`${k/255*100}%`,n.querySelector("[data-b-bar]").style.width=`${F/255*100}%`,o.style.setProperty("--fill",`${m/255*100}%`),i.style.setProperty("--fill",`${k/255*100}%`),s.style.setProperty("--fill",`${F/255*100}%`);const f=n.querySelector("[data-swatch]");f.style.backgroundColor=b,f.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${b}`),n.querySelector("[data-rgb-text]").textContent=b,n.querySelector("[data-hex-text]").textContent=u,$(m,k,F)}function L(m,k,F){o.value=m,i.value=k,s.value=F,E()}return[o,i,s].forEach(m=>m.addEventListener("input",E)),n.querySelectorAll(".rgb-presets button").forEach(m=>{m.addEventListener("click",()=>{L(+m.dataset.r,+m.dataset.g,+m.dataset.b)})}),new ResizeObserver(()=>T()).observe(r),requestAnimationFrame(()=>{T(),E()}),n}const Yt=["topics","notes","tools","worksheets","flashcards","summary"],Xt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function St(t,{subtitleKey:n,activeSection:o,onSection:i,onLang:s}){t.innerHTML=`
  ...
  `;const a=t.querySelector("[data-main]"),r=t.querySelector("[data-nav]"),c=t.querySelector("[data-lang]"),I=t.querySelector("[data-strand-back]");let $=o;function T(m){$=m,r.innerHTML=Yt.map(k=>`<button type="button" class="${m===k?"active":""}" data-sec="${k}">${d(Xt[k])}</button>`).join(""),r.querySelectorAll("button").forEach(k=>{k.addEventListener("click",()=>i(k.getAttribute("data-sec")))})}function E(){c.innerHTML=`
      <button type="button" data-set-lang="en" class="${oe()==="en"?"active":""}">${d("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${oe()==="zh-Hant"?"active":""}">${d("lang.zhHant")}</button>
    `,c.querySelectorAll("button").forEach(m=>{m.addEventListener("click",()=>{xt(m.getAttribute("data-set-lang")),s()})})}function L(){t.querySelector("[data-hub-subtitle]").textContent=d(n),I.textContent=d("strand.back"),t.querySelector("[data-hub-footer]").textContent=d("footer.conventions"),t.querySelector(".site-title").textContent=d("app.title")}const P=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return I.addEventListener("click",P),T(o),E(),{main:a,updateSection(m){T(m)},refreshLabels(){L(),T($),E()},destroy(){I.removeEventListener("click",P)}}}const Xe="s3phy:tool-picker-collapsed",Zt=820;function qt({toolOrder:t,toolId:n,getLabel:o,t:i}){const s=t.map(a=>`<button type="button" data-tool="${a}" class="${n===a?"active":""}">${o(a)}</button>`).join("");return`
      ...
      </section>`}function Tt(t,{getLabel:n,t:o,onSelectTool:i,mountTool:s,getActiveToolId:a}){const r=t.querySelector("[data-tools-panel]"),c=t.querySelector("[data-tool-picker]"),I=t.querySelector("[data-tool-list]"),$=t.querySelector("[data-tool-stage]"),T=t.querySelector("[data-tool-picker-toggle]"),E=t.querySelector("[data-tool-picker-toggle-label]"),L=t.querySelector("[data-tool-picker-chevron]"),P=t.querySelector("[data-tool-active-label]");if(!r||!c||!I||!$||!T)return;let m=sessionStorage.getItem(Xe)==="true";const k=()=>{P&&(P.textContent=n(a()))},F=()=>{T.setAttribute("aria-expanded",m?"false":"true"),E&&(E.textContent=o(m?"tools.showLabList":"tools.hideLabList")),L&&(L.textContent=m?"▼":"▲"),P&&(P.hidden=!m)},b=u=>{m=u,r.classList.toggle("is-picker-collapsed",m),sessionStorage.setItem(Xe,m?"true":"false"),F()};r.classList.toggle("is-picker-collapsed",m),k(),F(),T.addEventListener("click",()=>{b(!m)}),I.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{const f=u.getAttribute("data-tool");f&&(i(f),I.querySelectorAll("button").forEach(v=>{v.classList.toggle("active",v.getAttribute("data-tool")===f)}),k(),s($),window.innerWidth<=Zt&&b(!0))})}),s($)}const We=["A","B","C","D"];function Ze(t){const n=t.slice();for(let o=n.length-1;o>0;o-=1){const i=Math.floor(Math.random()*(o+1));[n[o],n[i]]=[n[i],n[o]]}return n}function Jt(t,n,o){return t.filter(i=>{if(o)return o(i,n);const s=i.topic;return!!(n.includes(s)||n.includes("rotatingMirror")&&s==="reflection"||n.includes("refraction")&&s==="refraction"||n.includes("tir")&&s==="tir"||s==="convex"&&n.includes("convex")||s==="concave"&&n.includes("concave"))})}function ea(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ct(t,n={}){const o=n.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=n.paperTitleKey??"worksheets.paperTitle";return`
      ...
      <div class="worksheet-output" data-ws-out><p class="lead">${t("worksheets.empty")}</p></div>
    </section>`}function zt(t,n,o,i,s={}){var te,ne,ee,ae;const a={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},r=t.querySelector("[data-ws-gen]"),c=t.querySelector("[data-ws-preview-area]"),I=t.querySelector("[data-ws-out]"),$=t.querySelector("[data-ws-body]"),T=t.querySelector("[data-ws-paper]"),E=t.querySelector("[data-ws-tabs]"),L=t.querySelector("[data-ws-practice-actions]"),P=t.querySelector("[data-ws-score]"),m=t.querySelector("[data-ws-score-val]"),k=t.querySelector("[data-ws-summary]"),F=t.querySelector("[data-ws-date-row]"),b=t.querySelector("[data-ws-date-print]"),u=t.querySelector("[data-ws-date-today]"),f=t.querySelector("[data-ws-date-label]");if(!r||!$)return;function v(){return i()}function y(){a.userAnswers={},a.wrongAttempts={},a.resolved={},P.hidden=!0,k.hidden=!0}function q(){return a.items.length>0&&a.items.every((S,H)=>a.resolved[H])}function z(){let S=0;a.items.forEach((J,D)=>{if(!a.resolved[D])return;const Z=J[v()]||J.en;a.userAnswers[D]===Z.a&&(S+=1)}),Object.keys(a.resolved).length>0&&(m.textContent=`${S}/${a.items.length}`,P.hidden=!1)}function G(S){a.tab=S,E==null||E.querySelectorAll("[data-ws-tab]").forEach(H=>{H.classList.toggle("active",H.getAttribute("data-ws-tab")===S)}),L&&(L.hidden=S!=="practice"),F&&(F.hidden=S!=="practice"),b&&(b.hidden=!a.dateStr,b.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:""),T==null||T.classList.toggle("practice-mode",S==="practice"),W()}function j(S,H,J){const D=S[v()]||S.en,Z=We,B=H+1,de=S.section?`<span class="q-section">${xe(S.section)}</span>`:"";if(J==="answer"){const me=D.choices.map((ye,Te)=>`<li class="${Te===D.a?"choice-correct":""}"><strong>${Z[Te]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${B} ${de}</h4>
        <p>${xe(D.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Z[D.a]}</p>
        <p class="q-exp"><em>${xe(D.exp)}</em></p>
      </div>`}const le=a.userAnswers[H],ue=a.wrongAttempts[H]||0,ge=a.resolved[H],qe=ge&&le===D.a,ke=ge&&le!==D.a;let Se="";ue===1&&!ge?Se=`<p class="q-hint"><strong>${o("worksheets.hint")}:</strong> ${xe(D.hint||D.exp)}</p>`:ke&&(Se=`<p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Z[D.a]}</p>
        <p class="q-exp q-summary"><em>${xe(D.exp)}</em></p>`);const _e=qe?"correct":ke?"incorrect":"",He=D.choices.map((me,ye)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${H}" value="${ye}" data-ws-q="${H}" data-ws-choice="${ye}"${le===ye?" checked":""}${ge?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${Z[ye]}.</strong> ${xe(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${_e}" data-ws-row="${H}">
      <div class="q-header"><h4>Q${B} ${de}</h4>${qe?'<span class="result-icon">✓</span>':ke?'<span class="result-icon">✗</span>':""}</div>
      <p>${xe(D.q)}</p>
      <ol class="choice-list choice-list--radio">${He}</ol>
      ${Se}
    </div>`}function W(){a.items.length&&($.innerHTML=a.items.map((S,H)=>j(S,H,a.tab)).join(""),O())}function O(){a.tab==="practice"&&$.querySelectorAll("[data-ws-choice]").forEach(S=>{S.addEventListener("change",()=>{const H=Number(S.getAttribute("data-ws-q"));if(a.resolved[H])return;const J=Number(S.getAttribute("data-ws-choice")),D=a.items[H][v()]||a.items[H].en;a.userAnswers[H]=J,J===D.a?a.resolved[H]=!0:(a.wrongAttempts[H]=(a.wrongAttempts[H]||0)+1,a.wrongAttempts[H]>=2&&(a.resolved[H]=!0)),z(),q()&&Q(),W()})})}function Q(){const S=a.items.length;let H=0,J=0;const D={};a.items.forEach((le,ue)=>{const ge=le[v()]||le.en;if(a.userAnswers[ue]===ge.a)H+=1,(a.wrongAttempts[ue]||0)===0&&(J+=1);else if(a.resolved[ue]){const ke=le.section||le.topic;D[ke]=(D[ke]||0)+1}});const Z=S?Math.round(H/S*100):0;let B=o("worksheets.revisionFair");Z>=90?B=o("worksheets.revisionExcellent"):Z>=70?B=o("worksheets.revisionGood"):Z<50&&(B=o("worksheets.revisionLow"));const de=Object.entries(D).sort((le,ue)=>ue[1]-le[1]).map(([le,ue])=>`<li>${xe(le)} (${ue})</li>`).join("");k.innerHTML=`
      <h4>${o("worksheets.sessionSummary")}</h4>
      <p>${o("worksheets.score")}: <strong>${H}/${S}</strong> (${Z}%)</p>
      <p>${o("worksheets.firstTry")}: <strong>${J}/${S}</strong></p>
      <p>${o("worksheets.revisionSuggestions")}: ${B}</p>
      ${de?`<p>${o("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,k.hidden=!1}function U(S){const H=v(),J=a.items.map((D,Z)=>{const B=D[H]||D.en,de=B.choices.map((ue,ge)=>`${We[ge]}. ${ue}`).join("<br/>"),le=S?`<p><b>${o("worksheets.answer")}:</b> ${We[B.a]}<br/><i>${B.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Z+1}.</b> ${B.q}<br/>${de}${le}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${o("worksheets.paperTitle")}</title></head>
<body><h2>${o("worksheets.paperTitle")}</h2>
${a.dateStr&&!S?`<p>${o("worksheets.date")}: ${a.dateStr}</p>`:""}
${J}</body></html>`}function Y(S){const H=U(S),J=new Blob(["\uFEFF",H],{type:"application/msword"}),D=document.createElement("a");D.href=URL.createObjectURL(J),D.download=S?"worksheet-answers.doc":"worksheet.doc",D.click(),URL.revokeObjectURL(D.href)}r.addEventListener("click",()=>{const S=Number(t.querySelector("[data-ws-count]").value),H=[...t.querySelectorAll("[data-ws-topic]")].filter(Z=>Z.checked).map(Z=>Z.getAttribute("data-ws-topic")),J=Jt(n,H,s.topicFilter),D=Ze(J).slice(0,Math.min(S,J.length||1));a.items=D.length?D:Ze(n).slice(0,Math.min(S,n.length)),y(),a.tab="practice",a.dateStr="",c.hidden=!1,I.hidden=!0,E==null||E.querySelectorAll("[data-ws-tab]").forEach(Z=>{Z.classList.toggle("active",Z.getAttribute("data-ws-tab")==="practice")}),L&&(L.hidden=!1),F&&(F.hidden=!1),b&&(b.hidden=!0),f.textContent="",T==null||T.classList.add("practice-mode"),W()}),E==null||E.addEventListener("click",S=>{const H=S.target.closest("[data-ws-tab]");!H||!a.items.length||G(H.getAttribute("data-ws-tab"))}),u==null||u.addEventListener("click",()=>{a.dateStr?(a.dateStr="",f.textContent=""):(a.dateStr=ea(),f.textContent=`${o("worksheets.date")}: ${a.dateStr}`),b&&(b.hidden=!a.dateStr,b.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:"")}),(te=t.querySelector("[data-ws-word-p]"))==null||te.addEventListener("click",()=>Y(!1)),(ne=t.querySelector("[data-ws-word-a]"))==null||ne.addEventListener("click",()=>Y(!0)),(ee=t.querySelector("[data-ws-print-p]"))==null||ee.addEventListener("click",()=>{G("practice"),T==null||T.classList.add("ws-print-blank");const S=()=>T==null?void 0:T.classList.remove("ws-print-blank");window.addEventListener("afterprint",S,{once:!0}),window.print()}),(ae=t.querySelector("[data-ws-print-a]"))==null||ae.addEventListener("click",()=>{G("answer"),window.print()})}const ta=1.7,aa=.7,Oe=1,ra=.1,na=3;function ia(t){const n=Math.floor(t),o=t-n;return n+(Math.random()<o?1:0)}function Je(t){for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function oa(t){const n=new Map(t.map(a=>[a.id,a.copies])),o=[];let i=null;const s=t.reduce((a,r)=>a+r.copies,0);for(let a=0;a<s;a+=1){let r=[...n.entries()].filter(([$,T])=>T>0&&$!==i);r.length===0&&(r=[...n.entries()].filter(([,$])=>$>0)),r.sort(($,T)=>T[1]-$[1]);const[c,I]=r[0];o.push(c),n.set(c,I-1),i=c}return o}function sa(t){const n=[];return t.forEach(({id:o,copies:i})=>{for(let s=0;s<i;s+=1)n.push(o)}),n}function la(t){let n="sequence",o=1,i=[],s=[],a=0,r=!1,c=!1,I=!1;const $=new Map;function T(){return t()}function E(){return new Map(T().map(y=>[y.id,y]))}function L(){$.clear(),T().forEach(y=>{$.set(y.id,{nextRate:Oe,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function P(){const y=T();return o===1?y.map(q=>({id:q.id,copies:1})):y.map(q=>{var z;return{id:q.id,copies:ia(((z=$.get(q.id))==null?void 0:z.nextRate)??Oe)}}).filter(q=>q.copies>0)}function m(y){if(y.length===0)return[];if(o===1){const q=y.map(z=>z.id);return n==="random"?Je([...q]):[...q].sort((z,G)=>z-G)}return n==="random"?Je(sa(y)):oa(y)}function k(){if(c=!1,I=!1,i=P(),i.reduce((q,z)=>q+z.copies,0)===0){I=!0,c=!0,s=[],a=0;return}T().forEach(q=>{const z=$.get(q.id);z&&(z.roundAgain=0,z.roundGotIt=0,z.roundNeutral=0)}),s=m(i),a=0,r=!1}function F(){o=1,L(),k()}function b(){return s[a]??null}function u(){const y=b();return y==null?null:E().get(y)??null}function f(y){const q=b();if(q==null)return;const z=$.get(q);z&&(y==="again"?(z.nextRate=ta,z.totalGotIt=0,z.roundAgain+=1):y==="gotit"?(z.totalGotIt+=1,z.roundGotIt+=1,z.nextRate=z.totalGotIt>=na?ra:aa):y==="neutral"&&(z.roundNeutral+=1,z.nextRate=Oe))}function v(){return r=!1,a<s.length-1?(a+=1,!1):(c=!0,!0)}return F(),{getMode:()=>n,setMode(y){n!==y&&(n=y,s=m(i),a=0,r=!1)},resetSession:F,getRoundNumber:()=>o,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>r,flip(){r=!r},unflip(){r=!1},currentCard:u,prev(){return a>0?(a-=1,r=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,r=!1,!0):!1},rateAgain(){return r?(f("again"),v()):!1},rateGotIt(){return r?(f("gotit"),v()):!1},rateNeutral(){return r?(f("neutral"),v()):!1},isSummary:()=>c,isSessionComplete:()=>I,getRoundStats(){let y=0,q=0,z=0;return $.forEach(G=>{y+=G.roundAgain,q+=G.roundGotIt,z+=G.roundNeutral}),{again:y,gotIt:q,neutral:z}},nextRound(){o+=1,k()},restart(){F()}}}function Lt(t,{deckOptions:n,buildDeck:o,initialDeck:i="all"}){let s=i,a=null,r=null;t.innerHTML=`
    <section class="panel panel--flashcards">
      ...
      <div class="flash-study-controls no-print">
        <div class="control">
          ...
          <select data-fc-deck>
            ${n.map(b=>`<option value="${b.value}">${b.label}</option>`).join("")}
          </select>
        </div>
      ...
      <section class="panel">
        ...
        <div class="grid cols-2" data-summary-grid>
          ${u.map(f=>{const v=d(`summary.item.${f.key}`);return`
            <div class="card" data-summary-card="${f.key}">
              <h3>${v}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function k(){const u=[{key:"reflection",type:"image",fileEn:"reflection-en.webp",fileZh:"reflection-zhHant.webp"},{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"},{key:"convex",type:"image",fileEn:"convex-en.webp",fileZh:"convex-zhHant.webp"},{key:"concave",type:"image",fileEn:"concave-en.webp",fileZh:"concave-zhHant.webp"},{key:"em",type:"image",file:"em.webp"}],f=De();for(const v of u){const y=t.querySelector(`[data-summary-card="${v.key}"]`);if(!y)continue;const q=y.querySelector("[data-summary-body]");if(v.type==="image"){const W=v.fileEn&&v.fileZh?f==="zhHant"?v.fileZh:v.fileEn:v.file,O=await je("summary",W),Q=`./summary/${W}`;O?q.innerHTML=`
          <img class="summary-thumb" src="${Q}" alt="${d(`summary.item.${v.key}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${Q}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:q.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}const z=f==="zhHant"?v.fileZh:v.fileEn,G=await je("summary-pdfs",z),j=`./summary-pdfs/${z}`;G?q.innerHTML=`
          <iframe class="notes-grid" title="${d(`summary.item.${v.key}`)}" src="${j}"></iframe>
          <p style="margin-top:8px"><a href="${j}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:q.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const F=()=>$(),b=u=>E(u);return window.addEventListener("s3phy:lang",F),t.addEventListener("click",b),$(),()=>{window.removeEventListener("s3phy:lang",F),t.removeEventListener("click",b),r==null||r(),s==null||s.destroy()}}const ut="s3phy-thermometer-lab-css",xa=900,ka=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Sa(){if(document.getElementById(ut))return;const t=document.createElement("style");t.id=ut,t.textContent=ka,document.head.appendChild(t)}function qa(t){const o={x:12,y:12},i=200,{container:s,panel:a,toggleBtn:r,dragHandle:c,storageKey:I,onLayoutChange:$,breakpoint:T=1024,collapsedClass:E="controls-collapsed",floatingClass:L="controls-floating"}=t;if(!s||!a||!r)return null;let P=sessionStorage.getItem(I)!=="false",m=(()=>{try{const W=localStorage.getItem(I+":pos");if(!W)return{...o};const O=JSON.parse(W);if(typeof O.x=="number"&&typeof O.y=="number")return O}catch{}return{...o}})(),k=null,F=null;const b=()=>window.innerWidth>=T,u=(W,O)=>{const Q=s.getBoundingClientRect(),U=a.getBoundingClientRect(),Y=Math.max(0,Q.width-U.width),te=Math.max(0,Q.height-U.height);return{x:Math.min(Math.max(0,W),Y),y:Math.min(Math.max(0,O),te)}},f=()=>{a.style.left=m.x+"px",a.style.top=m.y+"px",a.style.right="auto",a.style.bottom="auto"},v=()=>{typeof $=="function"&&(clearTimeout(F),F=setTimeout($,i))},y=()=>{r.setAttribute("aria-expanded",P?"false":"true"),t.getToggleTitle&&(r.title=t.getToggleTitle(P));const W=r.querySelector("[data-float-chevron]");W&&(W.textContent=P?"v":"^")},q=W=>{P=W,a.classList.toggle(E,P),sessionStorage.setItem(I,P?"true":"false"),y(),v()},z=()=>{s.classList.add(L),a.classList.add("lab-controls-float"),m=u(m.x,m.y),f(),c&&(c.style.display="")},G=()=>{s.classList.remove(L),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",c&&(c.style.display="none")},j=()=>{b()?(z(),m=u(m.x,m.y),f()):G(),v()};if(a.classList.toggle(E,P),y(),j(),r.addEventListener("click",W=>{W.stopPropagation(),q(!P)}),c){c.addEventListener("pointerdown",O=>{b()&&(O.preventDefault(),k={pointerId:O.pointerId,startX:O.clientX,startY:O.clientY,originX:m.x,originY:m.y},c.setPointerCapture(O.pointerId),c.classList.add("is-dragging"))}),c.addEventListener("pointermove",O=>{!k||k.pointerId!==O.pointerId||(m=u(k.originX+O.clientX-k.startX,k.originY+O.clientY-k.startY),f())});const W=O=>{if(!(!k||k.pointerId!==O.pointerId)){c.releasePointerCapture(O.pointerId),c.classList.remove("is-dragging");try{localStorage.setItem(I+":pos",JSON.stringify(m))}catch{}k=null,v()}};c.addEventListener("pointerup",W),c.addEventListener("pointercancel",W)}return window.addEventListener("resize",j),{setCollapsed:q,refreshMode:j,isCollapsed:()=>P}}function Ge(t,n={}){Sa();const o=n.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");n.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
  ...
  `;const r={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},c=460,I=340,$=80,T=800,E=560;function L(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:T-e.left-e.right,gh:E-e.top-e.bottom,tickFont:`bold ${Math.round(T*.024)}px Arial`,axisFont:`bold ${Math.round(T*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:E-e.bottom+32}}function P(){let l=100;const p=Math.max(r.bathTemp,r.thermometerTemp,100);p>120&&(l=150),p>145&&(l=200);const g=l<=100?20:25;return{minT:0,maxT:l,tickStep:g}}function m(e,l,p,g,h){return g+(e-l)/(p-l)*h}function k(e,l,p,g,h){return g+h-(e-l)/(p-l)*h}function F(e,l,p,g,h,A){const{gx:w,gy:x,gw:R,gh:M,tickFont:_,axisFont:N,yLabelX:X,xLabelY:C}=l;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const V of A){const K=k(V.value,V.min,V.max,x,M);e.beginPath(),e.moveTo(w,K),e.lineTo(w+R,K),e.stroke()}for(let V=p;V<=g+.01;V+=h){const K=m(V,p,g,w,R);e.beginPath(),e.moveTo(K,x),e.lineTo(K,x+M),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(w,x),e.lineTo(w,x+M),e.lineTo(w+R,x+M),e.stroke(),e.fillStyle="#e4e4e7",e.font=_,e.textAlign="right",e.textBaseline="middle";for(const V of A){const K=k(V.value,V.min,V.max,x,M);e.fillText(V.label,w-15,K)}e.textAlign="center",e.textBaseline="top";for(let V=p;V<=g+.01;V+=h){const K=m(V,p,g,w,R);e.fillText(`${Math.round(V)}`,K,x+M+10)}return{gx:w,gy:x,gw:R,gh:M,axisFont:N,yLabelX:X,xLabelY:C}}function b(e,l){const p=l-e,g=p<=8?1:p<=14?2:5,h=[],A=Math.ceil(e/g)*g;for(let w=A;w<=l+.001;w+=g)h.push({value:w,label:w%1===0?`${w.toFixed(0)}`:`${w.toFixed(1)}`,min:e,max:l});return h}function u(){const{maxT:e}=P(),l=f(0),p=f(e),g=p-l,h=Math.max(1,g*.1),A=Math.max(0,Math.round((l-h)*10)/10),w=Math.round((p+h)*10)/10;return{minL:A,maxL:w}}function f(e){return r.liquidL0+(r.liquidL100-r.liquidL0)/100*e}function v(){const{maxT:e}=P(),l=y(0),p=y(e),g=p-l,h=Math.max(.2,g*.1),A=Math.max(0,l-h),w=p+h,x=g<=2?.5:g<=4?1:2,R=[],M=Math.ceil(A/x)*x;for(let _=M;_<=w+.001;_+=x)R.push({value:_,label:_.toFixed(1),min:A,max:w});return{minR:A,maxR:w,ticks:R}}function y(e){return r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*e}function q(e){const{maxT:l}=e;let p=r.thermistorR25;for(let w=0;w<=l;w+=5){const x=w+273.15,R=r.thermistorR25*Math.exp(r.thermistorBeta*(1/x-1/298.15));p=Math.max(p,R)}p=Math.ceil(p*1.08*10)/10;const g=0,h=p<=12?2:4,A=[];for(let w=0;w<=p+.001;w+=h)A.push({value:w,label:w.toFixed(0),min:g,max:p});return{minR:g,maxR:p,ticks:A}}const z=a.querySelector("#tl-thermometerCanvas"),G=z.getContext("2d"),j=a.querySelector("#tl-graphCanvas"),W=j.getContext("2d"),O=window.devicePixelRatio||1;z.width=c*O,z.height=I*O,G.scale(O,O),j.width=T*O,j.height=E*O,W.scale(O,O);function Q(){r.iceCubes=[];for(let e=0;e<5;e++)r.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});r.bubbles=[];for(let e=0;e<20;e++)r.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});r.heatWaves=[];for(let e=0;e<8;e++)r.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});r.steamParticles=[];for(let e=0;e<12;e++)r.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const U=200,Y=11;function te(){const e=Math.pow(r.bulbVolume/U,.3333333333333333);return Y*e}function ne(){if(r.thermometerType==="resistance"||r.thermometerType==="thermistor")return .35;const e=r.liquidType==="mercury"?1:8,l=.2+r.wallThickness*1.5,p=.4+r.bulbVolume*.003,g=1.35-r.capillaryBore*.45;return Math.max(.1,l*p*g*e*.15)}function ee(e){r.bathTemp<=8&&r.iceCubes.forEach(l=>{l.x+=l.speedX,l.y+=l.speedY,(l.x<65||l.x>175)&&(l.speedX*=-1),(l.y<195||l.y>210)&&(l.speedY*=-1)}),r.bathTemp>35&&r.heatWaves.forEach(l=>{l.y-=l.speedY*(1+r.bathTemp/100),l.y<185&&(l.y=265,l.x=65+Math.random()*110)}),r.bathTemp>=80&&r.bubbles.forEach(l=>{l.y-=l.speedY*(1+(r.bathTemp-80)/40),l.phase+=l.wobbleSpeed,l.x+=Math.sin(l.phase)*.3,l.y<185&&(l.y=260+Math.random()*10,l.x=60+Math.random()*120)}),r.bathTemp>=95&&r.steamParticles.forEach(l=>{l.x+=l.vx,l.y+=l.vy,l.alpha-=.005,(l.alpha<=0||l.y<130)&&(l.x=60+Math.random()*120,l.y=175+Math.random()*5,l.alpha=.2+Math.random()*.4)})}function ae(e){let w=59,x=130,R=246;if(r.bathTemp<25){const C=r.bathTemp/25;w=Math.round(180-C*121),x=Math.round(210-C*80),R=Math.round(250-C*4)}else{const C=Math.min(1,(r.bathTemp-25)/125);w=Math.round(59+C*180),x=Math.round(130-C*100),R=Math.round(246-C*190)}if(r.bathTemp>40){const C=Math.min(1,(r.bathTemp-40)/100),V=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${C*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let K=-25;K<=25;K+=6){const re=C*(12+Math.sin(K*.4+V)*5);e.lineTo(55+130/2+K,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const M=e.createLinearGradient(55,190,55,280);M.addColorStop(0,`rgba(${w}, ${x}, ${R}, 0.25)`),M.addColorStop(1,`rgba(${w}, ${x}, ${R}, 0.55)`),e.fillStyle=M,e.beginPath(),e.moveTo(55,190);const _=r.bathTemp>=80?2:.5,N=r.bathTemp>=80?.09:.03,X=Date.now()*N;for(let C=55;C<=185;C+=5){const V=190+Math.sin(C*.15+X)*_;e.lineTo(C,V)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),r.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(r.bathTemp-35)/120)})`,e.lineWidth=1.2,r.heatWaves.forEach(C=>{e.beginPath(),e.moveTo(C.x,C.y),e.quadraticCurveTo(C.x+Math.sin(C.y*.06)*5,C.y-C.length/2,C.x,C.y-C.length),e.stroke()})),r.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,r.iceCubes.forEach(C=>{e.save(),e.translate(C.x,C.y),e.rotate(C.angle),e.beginPath(),e.roundRect(-C.size/2,-C.size/2,C.size,C.size,3),e.fill(),e.stroke(),e.restore()})),r.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,r.bubbles.forEach(C=>{e.beginPath(),e.arc(C.x,C.y,C.r,0,Math.PI*2),e.fill(),e.stroke()})),r.bathTemp>=95&&r.steamParticles.forEach(C=>{e.fillStyle=`rgba(255, 255, 255, ${C.alpha})`,e.beginPath(),e.arc(C.x,C.y,C.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function S(e,l,p,g,h,A,w="left"){if(!r.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(l,p),e.lineTo(g,h),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(l,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const R=e.measureText(A).width+10,M=16,_=w==="left"?g:g-R,N=h-M/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(_,N,R,M,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(A,_+R/2,N+M/2+.5)}function H(e){const g=te(),h=250+Math.max(0,g-Y)*.35,A=h-g-1,w=10+r.wallThickness*8,x=120-w/2,R=120+w/2,M=e.createLinearGradient(x,20,R,20);M.addColorStop(0,"rgba(209, 213, 219, 0.85)"),M.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),M.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),M.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),M.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=M,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(x,A),e.lineTo(x,25),e.arcTo(x,20,x+5,20,5),e.arcTo(R,20,R,25,5),e.lineTo(R,A),e.closePath(),e.fill(),e.stroke();const _=e.createRadialGradient(120-g*.2,h-g*.2,g*.1,120,h,g);_.addColorStop(0,"rgba(255, 255, 255, 0.8)"),_.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=_,e.strokeStyle="#6b7280",e.lineWidth=.8+r.wallThickness*.6,e.beginPath(),e.arc(120,h,g+.5+r.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const N=Math.min(w*.72,.8+r.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-N/2,28,N,A-20-8);const X=r.liquidType==="mercury",C=X?"#a1a1aa":"#ef4444",V=X?"#f4f4f5":"#fee2e2",K=210,re=220,be=(K-40)/re,he=K-Math.min(re,r.thermometerTemp)*be;e.fillStyle=C,e.fillRect(120-N/2,he,N,A-he),e.beginPath(),e.ellipse(120,he,N/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=V,e.fillRect(120-N/6,he,N/3,A-he);const se=g*.9,ie=e.createRadialGradient(120-se*.2,h-se*.2,se*.1,120,h,se);X?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,h,se,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ce=0;ce<=200;ce+=50){const pe=K-ce*be;e.beginPath(),e.moveTo(x,pe),e.lineTo(x+4,pe),e.stroke(),e.fillText(`${ce}°C`,x-22,pe+2.5)}r.showLabels&&(S(e,x+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),S(e,120,he,230,he-15,t("tools.thermometerLab.labels.meniscus"),"left"),S(e,120-N/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),S(e,120,h,230,h+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function J(e){const w=e.createLinearGradient(115,20,125,20);w.addColorStop(0,"#71717a"),w.addColorStop(.3,"#f4f4f5"),w.addColorStop(.7,"#d4d4d8"),w.addColorStop(1,"#3f3f46"),e.fillStyle=w,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let x=205;e.moveTo(118,x);for(let X=0;X<8;X++)x+=4,e.lineTo(122,x),x+=4,e.lineTo(118,x);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const R=245,M=40,_=135,N=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(R,M,_,N,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(R+10,M+12,_-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(r.currentResistance.toFixed(2)+" Ω",R+_-16,M+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",R+14,M+21),r.showLabels&&(S(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),S(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function D(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const h=20,A=225,w=12,x=120-w/2,R=e.createLinearGradient(x,h,x+w,h);R.addColorStop(0,"rgba(229, 231, 235, 0.4)"),R.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),R.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),R.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=R,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(x,h,w,A-h,[0,0,3,3]),e.fill(),e.stroke();const M=7,_=e.createRadialGradient(120-M*.2,245-M*.2,M*.1,120,245,M);_.addColorStop(0,"#6b7280"),_.addColorStop(.7,"#1f2937"),_.addColorStop(1,"#09090b"),e.fillStyle=_,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,M,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const N=245,X=40,C=135,V=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(N,X,C,V,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(N+10,X+12,C-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(r.currentThermistorR.toFixed(2)+" kΩ",N+C-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",N+14,X+21),r.showLabels&&(S(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),S(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Z(e,l,p,g,h,A,w,x,R){const{gx:M,gy:_,gw:N,gh:X}=l;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,g),e.lineTo(p,_+X),e.stroke(),e.beginPath(),e.moveTo(p,g),e.lineTo(M,g),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const C=`${h.toFixed(1)}${w}`,V=e.measureText(C).width+10;e.fillStyle=R,e.beginPath(),e.roundRect(p-V/2,_+X+2,V,15,3),e.fill(),e.fillStyle="#000",e.fillText(C,p,_+X+4),e.textAlign="right",e.textBaseline="middle";const K=`${A.toFixed(2)} ${x}`,re=e.measureText(K).width+10;e.fillStyle=R,e.beginPath(),e.roundRect(M-re-2,g-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(K,M-7,g)}function B(e){const l=L(),{minL:p,maxL:g}=u(),{minT:h,maxT:A,tickStep:w}=P(),x=b(p,g),R=F(e,l,h,A,w,x),{gx:M,gy:_,gw:N,gh:X,axisFont:C,yLabelX:V,xLabelY:K,dotR:re}={...l,...R};e.save(),e.translate(V,_+X/2),e.rotate(-Math.PI/2),e.font=C,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=C,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",M+N/2,K);const we=A,be=m(0,h,A,M,N),he=k(f(0),p,g,_,X),se=m(we,h,A,M,N),ie=k(f(we),p,g,_,X);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentLength;if(ce>=h&&ce<=A){const ve=m(ce,h,A,M,N),Ce=k(pe,p,g,_,X);Z(e,l,ve,Ce,ce,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const l=L(),{minR:p,maxR:g,ticks:h}=v(),A=P(),w=F(e,l,A.minT,A.maxT,A.tickStep,h),{gx:x,gy:R,gw:M,gh:_,axisFont:N,yLabelX:X,xLabelY:C,dotR:V}={...l,...w};e.save(),e.translate(X,R+_/2),e.rotate(-Math.PI/2),e.font=N,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=N,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+M/2,C);const{minT:K,maxT:re}=A,we=re,be=m(0,K,re,x,M),he=k(y(0),p,g,R,_),se=m(we,K,re,x,M),ie=k(y(we),p,g,R,_);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentResistance;if(ce>=K&&ce<=re){const ve=m(ce,K,re,x,M),Ce=k(pe,p,g,R,_);Z(e,l,ve,Ce,ce,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,V,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function le(e){const l=L(),p=P(),{minR:g,maxR:h,ticks:A}=q(p),w=F(e,l,p.minT,p.maxT,p.tickStep,A),{gx:x,gy:R,gw:M,gh:_,axisFont:N,yLabelX:X,xLabelY:C,dotR:V}={...l,...w},{minT:K,maxT:re}=p;e.save(),e.translate(X,R+_/2),e.rotate(-Math.PI/2),e.font=N,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=N,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+M/2,C),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let se=K;se<=re;se+=1){const ie=se+273.15,ce=r.thermistorR25*Math.exp(r.thermistorBeta*(1/ie-1/298.15)),pe=m(se,K,re,x,M),ve=k(Math.min(h,ce),g,h,R,_);ve>=R&&ve<=R+_&&(we?e.lineTo(pe,ve):(e.moveTo(pe,ve),we=!0))}e.stroke();const be=r.thermometerTemp,he=r.currentThermistorR;if(be>=K&&be<=re){const se=m(be,K,re,x,M),ie=k(Math.min(h,he),g,h,R,_);Z(e,l,se,ie,be,he,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(se,ie,V,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ue(){G.clearRect(0,0,c,I),W.clearRect(0,0,T,E),G.save(),G.translate($,0),ae(G),r.thermometerType==="liquid"?H(G):r.thermometerType==="resistance"?J(G):D(G),G.restore(),r.thermometerType==="liquid"?B(W):r.thermometerType==="resistance"?de(W):le(W)}function ge(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const l=a.querySelector("#tl-svg-formula-liquid-sub");if(l){const w=r.liquidL100-r.liquidL0,x=r.currentLength-r.liquidL0;l.innerHTML=`
      ...
      `);const g=a.querySelector("#tl-svg-formula-resistance-sub");if(g){const w=r.resistanceR100-r.resistanceR0,x=r.currentResistance-r.resistanceR0;g.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `);const A=a.querySelector("#tl-svg-formula-thermistor-sub");if(A){const w=r.thermometerTemp+273.15;A.innerHTML=`
      ...
      `}}function qe(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:l,cu:p,interval:g}=He(),h=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,A=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,w=a.querySelector("#tl-pane-q10a").classList.contains("active"),x=w?(h-l)/g*100:A,R=w?h:A/100*g+l,_=(N=>130-N/100*80)(x);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${_+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${R.toFixed(1)}°C</text>
    ...
    `}function ke(e){a.querySelector("#tl-bath-temp-display").innerHTML=r.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=r.bathTemp.toFixed(1)+" °C";const l=a.querySelector("#tl-bath-state");r.bathTemp<=0?l.textContent="Melting Ice Bath":r.bathTemp>=100?l.textContent="Boiling Water/Steam":r.bathTemp===150?l.textContent="Hot Cooking Oil":l.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=a.querySelector("#tl-alcohol-boiling-warning");r.thermometerType==="liquid"&&r.liquidType==="alcohol"&&r.bathTemp>=78?p.style.display="block":p.style.display="none",r.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=r.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):r.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=r.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=r.currentThermistorR.toFixed(2)+" kΩ",ge()}let Se=null;function _e(e){r.lastTimestamp||(r.lastTimestamp=e);const l=(e-r.lastTimestamp)/1e3;r.lastTimestamp=e;const p=Math.min(l,.1),g=ne(),h=p/g*(r.bathTemp-r.thermometerTemp);r.thermometerTemp+=h,r.currentLength=r.liquidL0+(r.liquidL100-r.liquidL0)/100*r.thermometerTemp,r.currentResistance=r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*r.thermometerTemp;const A=r.thermometerTemp+273.15;r.currentThermistorR=r.thermistorR25*Math.exp(r.thermistorBeta*(1/A-1/298.15)),ee(),ue(),ke(g),Se=requestAnimationFrame(_e)}function He(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),l=parseFloat(a.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,g=Number.isFinite(l)?l:105,h=g-p;return{cf:p,cu:g,interval:h}}function Ee(e){const l=Math.round(e*100)/100;return l>=0?l.toFixed(1):`(${l.toFixed(1)})`}function me(){const{cf:e,cu:l,interval:p}=He(),g=a.querySelector("#tl-val-faulty-interval"),h=a.querySelector("#tl-faulty-error-a"),A=a.querySelector("#tl-faulty-error-b"),w=Math.abs(p)<.01;g.textContent=p.toFixed(1)+" °C";const x=a.querySelector("#tl-svg-formula-faulty-a"),R=a.querySelector("#tl-svg-formula-faulty-b");if(w){h.hidden=!1,h.textContent="C_u must differ from C_f (interval cannot be zero).",A.hidden=!1,A.textContent=h.textContent,x&&(x.innerHTML=""),R&&(R.innerHTML="");return}h.hidden=!0,A.hidden=!0;const M=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,_=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,N=(M-e)/p*100,X=_/100*p+e;x&&(x.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${M.toFixed(1)} - ${Ee(e)}</text>
      ...
      `),qe()}function ye(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,l=(e-r.resistanceR0)/(r.resistanceR100-r.resistanceR0)*100,p=a.querySelector("#tl-svg-formula-resistance-solver");p&&(p.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function Te(){const e=r.thermometerTemp,l=r.liquidL100-r.liquidL0,p=r.liquidL0+l/100*e,g=a.querySelector("#tl-svg-formula-t-to-l");g&&(g.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${r.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${l.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function Ne(){const e=r.thermometerTemp,l=r.resistanceR100-r.resistanceR0,p=r.resistanceR0+l/100*e,g=a.querySelector("#tl-svg-formula-t-to-r");g&&(g.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">R<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${r.resistanceR0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${l.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} Ω</tspan>
          </text>
        </svg>
      `)}function fe(){me(),ye(),Te(),Ne()}function Fe(e,l){a.querySelector("#"+e).addEventListener("click",()=>{r.bathTemp=l,a.querySelector("#tl-bath-temp-slider").value=l,fe()})}function Qe(e){a.querySelectorAll(".tl-tab-btn").forEach(l=>{l.classList.toggle("active",l.getAttribute("data-tl-tab")===e)}),a.querySelectorAll(".tl-tab-content").forEach(l=>{l.classList.toggle("active",l.id==="tl-tab-"+e)}),a.querySelectorAll(".tl-live-tab").forEach(l=>{l.classList.toggle("active",l.id==="tl-live-"+e)}),r.thermometerType=e}function Ft(){a.querySelectorAll(".tl-tab-btn").forEach(h=>{h.addEventListener("click",()=>{Qe(h.getAttribute("data-tl-tab")),fe()})}),a.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{r.showLabels=!r.showLabels,a.querySelector("#tl-lbl-toggle-labels").textContent=r.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",h=>{r.bathTemp=parseFloat(h.target.value),fe()}),Fe("tl-btn-preset-ice",0),Fe("tl-btn-preset-room",25),Fe("tl-btn-preset-steam",100),Fe("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{r.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",fe()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{r.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",fe()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",h=>{r.bulbVolume=parseFloat(h.target.value),a.querySelector("#tl-val-bulb-vol").textContent=r.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",h=>{r.wallThickness=parseFloat(h.target.value),a.querySelector("#tl-val-wall-thickness").textContent=r.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-capillary-bore").addEventListener("input",h=>{r.capillaryBore=parseFloat(h.target.value),a.querySelector("#tl-val-capillary-bore").textContent=r.capillaryBore.toFixed(2)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",h=>{r.liquidL0=parseFloat(h.target.value),a.querySelector("#tl-val-liquid-l0").textContent=r.liquidL0.toFixed(1)+" cm",fe()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",h=>{r.liquidL100=parseFloat(h.target.value),a.querySelector("#tl-val-liquid-l100").textContent=r.liquidL100.toFixed(1)+" cm",fe()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",h=>{r.resistanceR0=parseFloat(h.target.value),a.querySelector("#tl-val-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",fe()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",h=>{r.resistanceR100=parseFloat(h.target.value),a.querySelector("#tl-val-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",fe()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",h=>{r.thermistorR25=parseFloat(h.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",fe()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",h=>{r.thermistorBeta=parseFloat(h.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=r.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=r.thermistorBeta+" K",fe()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active"),me()}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",me),a.querySelector("#tl-input-faulty-cu").addEventListener("input",me),a.querySelector("#tl-input-q10a-cm").addEventListener("input",me),a.querySelector("#tl-input-q10b-t").addEventListener("input",me),a.querySelector("#tl-input-q11-r").addEventListener("input",ye);const p=a.querySelector("#tl-input-t-to-l");p&&p.addEventListener("input",fe);const g=a.querySelector("#tl-input-t-to-r");g&&g.addEventListener("input",fe)}if(n.type){const e=a.querySelector(".tl-tabs-container");e&&(e.style.display="none")}Qe(o),Q(),Ft(),fe();const Ve=a.querySelector(".tl-dash"),Ke=a.querySelector(".tl-controls"),Ue=a.querySelector("#tl-controls-toggle"),At=a.querySelector("#tl-controls-drag");return Ve&&Ke&&Ue&&qa({container:Ve,panel:Ke,toggleBtn:Ue,dragHandle:At,storageKey:`s3phy-thermo-${o}`,breakpoint:xa,getToggleTitle:e=>t(e?"tools.floatingControls.showParams":"tools.floatingControls.hideParams"),onLayoutChange:()=>ue()}),Se=requestAnimationFrame(_e),a._thermometerLabCleanup=()=>{Se&&cancelAnimationFrame(Se)},a}function Ta(t){const n=document.createElement("div");n.className="tool-specific-heat";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"specific-heat/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function Ca(t){const n=document.createElement("div");n.className="tool-thermal-mixing";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"thermal-mixing/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function za(t){const n=document.createElement("div");n.className="tool-change-of-state";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"change-of-state/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function La(t){const n=document.createElement("div");n.className="tool-heat-transfer";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var c;try{(c=o.contentWindow)==null||c.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}const ze=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],ft=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],Ra=[["thermometer","topic.thermometer"]],ht=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],Ma={liquid:t=>Ge(t,{type:"liquid"}),resistance:t=>Ge(t,{type:"resistance"}),thermistor:t=>Ge(t,{type:"thermistor"}),specificHeat:t=>Ta(t),thermalMixing:t=>Ca(t),changeOfState:t=>za(t),heatTransfer:t=>La(t)};function pt(t){return d({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function Be(){return oe()==="zh-Hant"?"zhHant":"en"}async function Me(t,n){const o=`./${t}/${n}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function mt(t){return Me("notes",t)}function _a(t){let n="topics",o="liquid",i=null,s={main:null},a=null,r=null;const c=[{value:"all",labelKey:"flashcards.all"},{value:"thermometry",labelKey:"flashcards.deck.thermometry"},{value:"heatInternalEnergy",labelKey:"flashcards.deck.heatInternalEnergy"},{value:"changeOfState",labelKey:"flashcards.deck.changeOfState"},{value:"heatTransfer",labelKey:"flashcards.deck.heatTransfer"}];function I(){if(s.main){if(r==null||r(),r=null,n==="topics"?s.main.innerHTML=T():n==="notes"?s.main.innerHTML=L():n==="tools"?s.main.innerHTML=qt({toolOrder:ht,toolId:o,getLabel:pt,t:d}):n==="worksheets"?s.main.innerHTML=Ct(d,{topics:Ra,paperTitleKey:"worksheets.paperTitleHeat"}):n==="flashcards"?r=Lt(s.main,{deckOptions:c.map(u=>({value:u.value,label:d(u.labelKey)})),buildDeck:u=>ba(u,oe())}):n==="summary"&&(s.main.innerHTML=m()),n==="notes"&&P(),n==="tools"&&Tt(t,{getLabel:pt,t:d,getActiveToolId:()=>o,onSelectTool:u=>{o=u},mountTool:u=>{u.innerHTML="",a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup();const f=Ma[o];f&&(a=f(d),u.appendChild(a))}}),n==="worksheets"){const u=kt.filter(f=>ft.includes(f.topic));zt(t,u,d,Be,{topicFilter:(f,v)=>v.includes("thermometer")?ft.includes(f.topic):v.includes(f.topic)})}n==="summary"&&k()}}function $(){i==null||i.destroy(),i=St(t,{subtitleKey:"strand.heat.subtitle",activeSection:n,onSection:u=>{n==="tools"&&u!=="tools"&&a!=null&&a._thermometerLabCleanup&&(a._thermometerLabCleanup(),a=null),n=u,i.updateSection(n),I()},onLang:()=>$()}),s.main=i.main,i.updateSection(n),I()}function T(){return`
      <section class="panel panel--topic-hub">
        <h2>${d("topics.title")}</h2>
        <p class="lead">${d("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${ze.map(u=>{const f=u.tool?`<button class="btn primary" type="button" data-go-tool="${u.tool}">${d("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${d("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${d(u.titleKey)}</h3>
              ${f}
            </div>`}).join("")}
        </div>
      </section>`}function E(u){const f=u.target.closest("[data-go-tool]");if(f){const y=f.getAttribute("data-go-tool");ht.includes(y)?o=y:o="liquid",n="tools",i.updateSection(n),I();return}const v=u.target.closest("[data-go-section]");(v==null?void 0:v.getAttribute("data-go-section"))==="notes"&&(n="notes",i.updateSection(n),I())}function L(){return`
      <section class="panel">
        <h2>${d("notes.title")}</h2>
        <p class="lead">${d("notes.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
      ...
      </section>`}async function P(){const u=Be();for(const f of ze){const v=t.querySelector(`[data-note-card="${f.id}"]`);if(!v)continue;const y=v.querySelector("[data-note-body]"),q=u==="zhHant"?f.fileZh:f.fileEn,z=await mt(q),G=`./notes/${q}`;z?y.innerHTML=`
          <iframe class="notes-grid" title="${d(`notes.card.${f.id}`)}" src="${G}"></iframe>
          <p style="margin-top:8px"><a href="${G}" target="_blank" rel="noopener">${d("notes.openPdf")}</a></p>`:y.innerHTML=`<p class="lead">${d("notes.missing")}</p>`}}function m(){return`
      <section class="panel">
        <h2>${d("summary.title")}</h2>
        <p class="lead">${d("summary.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
      ...
      </section>`}async function k(){const u=Be();for(const f of ze){const v=t.querySelector(`[data-summary-card="${f.id}"]`);if(!v)continue;const y=v.querySelector("[data-summary-body]");if(f.id==="thermometer"){const j=await Me("summary","thermometer.webp"),W="./summary/thermometer.webp";j?y.innerHTML=`
          <img class="summary-thumb" src="${W}" alt="${d("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:y.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="heatInternalEnergy"){const j=u==="zhHant"?"heat-internal-energy-zhHant.webp":"heat-internal-energy-en.webp",W=await Me("summary",j),O=`./summary/${j}`;W?y.innerHTML=`
          <img class="summary-thumb" src="${O}" alt="${d("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${O}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:y.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="changeOfState"){const j=await Me("summary","change-of-state.webp"),W="./summary/change-of-state.webp";j?y.innerHTML=`
          <img class="summary-thumb" src="${W}" alt="${d("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:y.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="heatTransfer"){const j=await Me("summary","heat-transfer.webp"),W="./summary/heat-transfer.webp";j?y.innerHTML=`
          <img class="summary-thumb" src="${W}" alt="${d("summary.item.heatTransfer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:y.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}const q=u==="zhHant"?f.fileZh:f.fileEn,z=await mt(q),G=`./notes/${q}`;z?y.innerHTML=`
          <iframe class="notes-grid" title="${d(`summary.item.${f.id}`)}" src="${G}"></iframe>
          <p style="margin-top:8px"><a href="${G}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:y.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const F=()=>$(),b=u=>E(u);return window.addEventListener("s3phy:lang",F),t.addEventListener("click",b),$(),()=>{window.removeEventListener("s3phy:lang",F),t.removeEventListener("click",b),r==null||r(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const bt={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Pt();Ot();const gt="s3phy_splash_seen",_t={optics:wa,heat:_a};let Le=null,Re=null;function Ha(){const t=location.hash.match(/^#\/(\w+)/),n=t==null?void 0:t[1];return n&&Object.prototype.hasOwnProperty.call(_t,n)?n:null}function Ea(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function Ht(t){Le==null||Le(),Le=null,Re==null||Re(),Re=null;const n=document.getElementById("app");if(!n)return;if(n.innerHTML="",!t){location.hash&&Ea(),Re=Gt(n);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Le=_t[t](n)??null}function Et(){Ht(Ha())}function Fa(){return"./images/uniplus-logo.png"}function Aa(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
