...
`;function Wt(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=Pt,document.head.appendChild(t)}function Dt(t){Wt();const n=document.createElement("div");n.className="rml",n.innerHTML=`
  ...
  `;const o=n.querySelector(".rml-canvas"),i=o.getContext("2d"),s=n.querySelector("[data-rml-rot]"),a=n.querySelector("[data-rml-inc]"),r=n.querySelector('[data-rml-disp="rot"]'),d=n.querySelector('[data-rml-disp="inc"]'),O=n.querySelector('[data-rml-val="i"]'),I=n.querySelector('[data-rml-val="r"]'),L=n.querySelector('[data-rml-val="shift"]'),H=350,R=380,B=300,v="#22d3ee",S="bold 17px system-ui, sans-serif";let E=0,g=-140,A=!0,$=!0,K=!0,u=!0;function f(P){return P*Math.PI/180}function h(P,W,V,ee,ne,te=2,ae=!1){i.beginPath(),i.lineWidth=te,i.strokeStyle=ne,i.setLineDash(ae?[6,6]:[]);const k=P+Math.cos(f(V))*ee,M=W+Math.sin(f(V))*ee;return i.moveTo(P,W),i.lineTo(k,M),i.stroke(),i.setLineDash([]),{x:k,y:M}}function x(P,W,V,ee,ne,te=14){const ae=V-P,k=ee-W,M=Math.hypot(ae,k);if(M<1e-6)return;const J=ae/M,D=k/M,Z=V-J*te,N=ee-D*te,de=.45*te;i.beginPath(),i.fillStyle=ne,i.moveTo(V,ee),i.lineTo(Z-D*de,N+J*de),i.lineTo(Z+D*de,N-J*de),i.closePath(),i.fill()}function G(P,W,V,ee,ne,te=25){i.beginPath(),i.strokeStyle=ee,i.lineWidth=2;const ae=Math.min(P,W),k=Math.max(P,W);if(i.arc(H,R,V,f(ae),f(k),!1),i.stroke(),ne){const M=(ae+k)/2,J=H+Math.cos(f(M))*(V+te),D=R+Math.sin(f(M))*(V+te);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=ee,i.fillText(ne,J,D),i.restore()}}function j(P,W,V,ee,ne){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(H-200,R),i.lineTo(H+200,R),i.stroke(),i.setLineDash([]),i.lineCap="butt";const te=H+Math.cos(f(P))*B,ae=R+Math.sin(f(P))*B;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(te,ae),i.lineTo(H,R),i.stroke();const k=(te+H)*.5,M=(ae+R)*.5,J=Math.hypot(H-te,R-ae)||1,D=(H-te)/J,Z=(R-ae)/J;if(x(k-D*28,M-Z*28,k,M,"#fff",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),te,ae-12),i.restore(),A){const N=h(H,R,-90,B-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),N.x+6,N.y-4),i.restore()}if($){const N=h(H,R,ee,B,"#00e676",2,!1);x(H,R,N.x,N.y,"#00e676",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),N.x,N.y-14),i.restore()}i.save(),i.translate(H,R),i.rotate(f(E)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let N=-190;N<200;N+=15)i.moveTo(N,0),i.lineTo(N-5,8);if(i.stroke(),i.restore(),K){const N=h(H,R,W,B-40,v,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=v,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),N.x+6,N.y-4),i.restore()}if(u){const N=h(H,R,V,B,v,4);x(H,R,N.x,N.y,v,16),Math.abs(E)>.5&&(i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=v,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),N.x,N.y-14),i.restore())}if(K&&G(P,W,100,"#ffcc00",`i=${ne.toFixed(0)}°`,25),K&&u&&G(W,V,100,v,`r=${ne.toFixed(0)}°`,25),A&&K&&Math.abs(E)>.5&&G(-90,W,50,"#ffcc00",`θ=${Math.abs(E)}°`,20),$&&u&&Math.abs(E)>.5){const N=V-ee;G(ee,V,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${N.toFixed(0)}°`,40)}}function F(){E=parseFloat(s.value),g=parseFloat(a.value);const P=E>0?"+":"";r.textContent=`${P}${E}°`,d.textContent=`${g}°`;const W=-90,V=Math.abs(g-W),ee=W+V,ne=-90+E,te=Math.abs(g-ne),ae=ne+te,k=ae-ee;O.textContent=`${te.toFixed(1)}°`,I.textContent=`${te.toFixed(1)}°`;const M=k>0?"+":"";L.textContent=`${M}${k.toFixed(1)}°`,j(g,ne,ae,ee,te)}return n.querySelectorAll("[data-rml-toggle]").forEach(P=>{P.addEventListener("click",()=>{const W=P.getAttribute("data-rml-toggle");W==="orig-norm"&&(A=!A),W==="orig-ray"&&($=!$),W==="new-norm"&&(K=!K),W==="new-ray"&&(u=!u),P.classList.toggle("active"),F()})}),n.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",F()}),s.addEventListener("input",F),a.addEventListener("input",F),F(),n}function Ot(t){const n=document.createElement("div");n.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;return o.src=`${s}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",n.appendChild(o),n}function Gt(t,n={}){const o=n.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),r="./",d=r.endsWith("/")?r:`${r}/`;return a.src=`${d}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,a.title=t(i),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function jt(t){const n=document.createElement("div");n.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(oe())}`}o.src=a(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var d;try{(d=o.contentWindow)==null||d.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._emLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function Bt(t){const n=document.createElement("div");n.className="rgb-mixer",n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-r]"),i=n.querySelector("[data-g]"),s=n.querySelector("[data-b]"),a=n.querySelector(".rgb-mixer-canvas"),r=n.querySelector(".rgb-mixer-stage"),d=a.getContext("2d");function O(v){return v.toString(16).padStart(2,"0")}function I(v,S,E){const g=a.width/(window.devicePixelRatio||1),A=a.height/(window.devicePixelRatio||1),$=g/2,K=A/2,u=Math.min(g,A)*.34,f=u*.5,h=Math.sqrt(3)/2;d.clearRect(0,0,g,A),d.fillStyle="#000",d.fillRect(0,0,g,A);const x=[{x:$,y:K-f,rgb:[255,0,0],val:v},{x:$-f*h,y:K+f*.5,rgb:[0,255,0],val:S},{x:$+f*h,y:K+f*.5,rgb:[0,0,255],val:E}];d.globalCompositeOperation="lighter",x.forEach(G=>{if(G.val<=0)return;const j=G.val/255,[F,P,W]=G.rgb,V=d.createRadialGradient(G.x,G.y,0,G.x,G.y,u);V.addColorStop(0,`rgba(${F},${P},${W},${j})`),V.addColorStop(.65,`rgba(${F},${P},${W},${j})`),V.addColorStop(.85,`rgba(${F},${P},${W},${j*.5})`),V.addColorStop(1,`rgba(${F},${P},${W},0)`),d.fillStyle=V,d.beginPath(),d.arc(G.x,G.y,u,0,Math.PI*2),d.fill()}),d.globalCompositeOperation="source-over"}function L(){const v=r.getBoundingClientRect(),S=Math.max(200,Math.min(v.width-8,v.height-8,720)),E=window.devicePixelRatio||1;a.width=S*E,a.height=S*E,a.style.width=`${S}px`,a.style.height=`${S}px`,d.setTransform(E,0,0,E,0,0),I(+o.value,+i.value,+s.value)}function H(){const v=+o.value,S=+i.value,E=+s.value,g=`rgb(${v}, ${S}, ${E})`,A=`#${O(v)}${O(S)}${O(E)}`;n.querySelector("[data-r-val]").textContent=v,n.querySelector("[data-g-val]").textContent=S,n.querySelector("[data-b-val]").textContent=E,n.querySelector("[data-r-bar]").style.width=`${v/255*100}%`,n.querySelector("[data-g-bar]").style.width=`${S/255*100}%`,n.querySelector("[data-b-bar]").style.width=`${E/255*100}%`,o.style.setProperty("--fill",`${v/255*100}%`),i.style.setProperty("--fill",`${S/255*100}%`),s.style.setProperty("--fill",`${E/255*100}%`);const $=n.querySelector("[data-swatch]");$.style.backgroundColor=g,$.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${g}`),n.querySelector("[data-rgb-text]").textContent=g,n.querySelector("[data-hex-text]").textContent=A,I(v,S,E)}function R(v,S,E){o.value=v,i.value=S,s.value=E,H()}return[o,i,s].forEach(v=>v.addEventListener("input",H)),n.querySelectorAll(".rgb-presets button").forEach(v=>{v.addEventListener("click",()=>{R(+v.dataset.r,+v.dataset.g,+v.dataset.b)})}),new ResizeObserver(()=>L()).observe(r),requestAnimationFrame(()=>{L(),H()}),n}const Nt=["topics","notes","tools","worksheets","flashcards","summary"],Qt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function wt(t,{subtitleKey:n,activeSection:o,onSection:i,onLang:s}){t.innerHTML=`
...
${J}</body></html>`}function V(k){const M=W(k),J=new Blob(["\uFEFF",M],{type:"application/msword"}),D=document.createElement("a");D.href=URL.createObjectURL(J),D.download=k?"worksheet-answers.doc":"worksheet.doc",D.click(),URL.revokeObjectURL(D.href)}r.addEventListener("click",()=>{const k=Number(t.querySelector("[data-ws-count]").value),M=[...t.querySelectorAll("[data-ws-topic]")].filter(Z=>Z.checked).map(Z=>Z.getAttribute("data-ws-topic")),J=Vt(n,M,s.topicFilter),D=Xe(J).slice(0,Math.min(k,J.length||1));a.items=D.length?D:Xe(n).slice(0,Math.min(k,n.length)),u(),a.tab="practice",a.dateStr="",d.hidden=!1,O.hidden=!0,H==null||H.querySelectorAll("[data-ws-tab]").forEach(Z=>{Z.classList.toggle("active",Z.getAttribute("data-ws-tab")==="practice")}),R&&(R.hidden=!1),E&&(E.hidden=!1),g&&(g.hidden=!0),$.textContent="",L==null||L.classList.add("practice-mode"),j()}),H==null||H.addEventListener("click",k=>{const M=k.target.closest("[data-ws-tab]");!M||!a.items.length||x(M.getAttribute("data-ws-tab"))}),A==null||A.addEventListener("click",()=>{a.dateStr?(a.dateStr="",$.textContent=""):(a.dateStr=Kt(),$.textContent=`${o("worksheets.date")}: ${a.dateStr}`),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:"")}),(ee=t.querySelector("[data-ws-word-p]"))==null||ee.addEventListener("click",()=>V(!1)),(ne=t.querySelector("[data-ws-word-a]"))==null||ne.addEventListener("click",()=>V(!0)),(te=t.querySelector("[data-ws-print-p]"))==null||te.addEventListener("click",()=>{x("practice"),L==null||L.classList.add("ws-print-blank");const k=()=>L==null?void 0:L.classList.remove("ws-print-blank");window.addEventListener("afterprint",k,{once:!0}),window.print()}),(ae=t.querySelector("[data-ws-print-a]"))==null||ae.addEventListener("click",()=>{x("answer"),window.print()})}const Ut=1.7,Yt=.7,De=1,Xt=.1,Zt=3;function Jt(t){const n=Math.floor(t),o=t-n;return n+(Math.random()<o?1:0)}function Ze(t){for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function ea(t){const n=new Map(t.map(a=>[a.id,a.copies])),o=[];let i=null;const s=t.reduce((a,r)=>a+r.copies,0);for(let a=0;a<s;a+=1){let r=[...n.entries()].filter(([I,L])=>L>0&&I!==i);r.length===0&&(r=[...n.entries()].filter(([,I])=>I>0)),r.sort((I,L)=>L[1]-I[1]);const[d,O]=r[0];o.push(d),n.set(d,O-1),i=d}return o}function ta(t){const n=[];return t.forEach(({id:o,copies:i})=>{for(let s=0;s<i;s+=1)n.push(o)}),n}function aa(t){let n="sequence",o=1,i=[],s=[],a=0,r=!1,d=!1,O=!1;const I=new Map;function L(){return t()}function H(){return new Map(L().map(u=>[u.id,u]))}function R(){I.clear(),L().forEach(u=>{I.set(u.id,{nextRate:De,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function B(){const u=L();return o===1?u.map(f=>({id:f.id,copies:1})):u.map(f=>{var h;return{id:f.id,copies:Jt(((h=I.get(f.id))==null?void 0:h.nextRate)??De)}}).filter(f=>f.copies>0)}function v(u){if(u.length===0)return[];if(o===1){const f=u.map(h=>h.id);return n==="random"?Ze([...f]):[...f].sort((h,x)=>h-x)}return n==="random"?Ze(ta(u)):ea(u)}function S(){if(d=!1,O=!1,i=B(),i.reduce((f,h)=>f+h.copies,0)===0){O=!0,d=!0,s=[],a=0;return}L().forEach(f=>{const h=I.get(f.id);h&&(h.roundAgain=0,h.roundGotIt=0,h.roundNeutral=0)}),s=v(i),a=0,r=!1}function E(){o=1,R(),S()}function g(){return s[a]??null}function A(){const u=g();return u==null?null:H().get(u)??null}function $(u){const f=g();if(f==null)return;const h=I.get(f);h&&(u==="again"?(h.nextRate=Ut,h.totalGotIt=0,h.roundAgain+=1):u==="gotit"?(h.totalGotIt+=1,h.roundGotIt+=1,h.nextRate=h.totalGotIt>=Zt?Xt:Yt):u==="neutral"&&(h.roundNeutral+=1,h.nextRate=De))}function K(){return r=!1,a<s.length-1?(a+=1,!1):(d=!0,!0)}return E(),{getMode:()=>n,setMode(u){n!==u&&(n=u,s=v(i),a=0,r=!1)},resetSession:E,getRoundNumber:()=>o,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>r,flip(){r=!r},unflip(){r=!1},currentCard:A,prev(){return a>0?(a-=1,r=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,r=!1,!0):!1},rateAgain(){return r?($("again"),K()):!1},rateGotIt(){return r?($("gotit"),K()):!1},rateNeutral(){return r?($("neutral"),K()):!1},isSummary:()=>d,isSessionComplete:()=>O,getRoundStats(){let u=0,f=0,h=0;return I.forEach(x=>{u+=x.roundAgain,f+=x.roundGotIt,h+=x.roundNeutral}),{again:u,gotIt:f,neutral:h}},nextRound(){o+=1,S()},restart(){E()}}}function St(t,{deckOptions:n,buildDeck:o,initialDeck:i="all"}){let s=i,a=null,r=null;t.innerHTML=`
    <section class="panel panel--flashcards">
      ...
      </section>`}async function A(){const u=[{key:"reflection",type:"image",fileEn:"reflection-en.webp",fileZh:"reflection-zhHant.webp"},{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"},{key:"convex",type:"image",fileEn:"convex-en.webp",fileZh:"convex-zhHant.webp"},{key:"concave",type:"image",fileEn:"concave-en.webp",fileZh:"concave-zhHant.webp"},{key:"em",type:"image",file:"em.webp"}],f=Oe();for(const h of u){const x=t.querySelector(`[data-summary-card="${h.key}"]`);if(!x)continue;const G=x.querySelector("[data-summary-body]");if(h.type==="image"){const W=h.fileEn&&h.fileZh?f==="zhHant"?h.fileZh:h.fileEn:h.file,V=await Be("summary",W),ee=`./summary/${W}`;V?G.innerHTML=`
          <img class="summary-thumb" src="${ee}" alt="${c(`summary.item.${h.key}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${ee}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:G.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}const j=f==="zhHant"?h.fileZh:h.fileEn,F=await Be("summary-pdfs",j),P=`./summary-pdfs/${j}`;F?G.innerHTML=`
          <iframe class="notes-grid" title="${c(`summary.item.${h.key}`)}" src="${P}"></iframe>
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${c("summary.download")}</a></p>`:G.innerHTML=`<p class="lead">${c("summary.missing")}</p>`}}const $=()=>I(),K=u=>H(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",K),I(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",K),r==null||r(),s==null||s.destroy()}}const ct="s3phy-thermometer-lab-css",ba=900,ga=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function va(){if(document.getElementById(ct))return;const t=document.createElement("style");t.id=ct,t.textContent=ga,document.head.appendChild(t)}function ya(t){const o={x:12,y:12},i=200,{container:s,panel:a,toggleBtn:r,dragHandle:d,storageKey:O,onLayoutChange:I,breakpoint:L=1024,collapsedClass:H="controls-collapsed",floatingClass:R="controls-floating"}=t;if(!s||!a||!r)return null;let B=sessionStorage.getItem(O)!=="false",v=(()=>{try{const j=localStorage.getItem(O+":pos");if(!j)return{...o};const F=JSON.parse(j);if(typeof F.x=="number"&&typeof F.y=="number")return F}catch{}return{...o}})(),S=null,E=null;const g=()=>window.innerWidth>=L,A=(j,F)=>{const P=s.getBoundingClientRect(),W=a.getBoundingClientRect(),V=Math.max(0,P.width-W.width),ee=Math.max(0,P.height-W.height);return{x:Math.min(Math.max(0,j),V),y:Math.min(Math.max(0,F),ee)}},$=()=>{a.style.left=v.x+"px",a.style.top=v.y+"px",a.style.right="auto",a.style.bottom="auto"},K=()=>{typeof I=="function"&&(clearTimeout(E),E=setTimeout(I,i))},u=()=>{r.setAttribute("aria-expanded",B?"false":"true"),t.getToggleTitle&&(r.title=t.getToggleTitle(B));const j=r.querySelector("[data-float-chevron]");j&&(j.textContent=B?"v":"^")},f=j=>{B=j,a.classList.toggle(H,B),sessionStorage.setItem(O,B?"true":"false"),u(),K()},h=()=>{s.classList.add(R),a.classList.add("lab-controls-float"),v=A(v.x,v.y),$(),d&&(d.style.display="")},x=()=>{s.classList.remove(R),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",d&&(d.style.display="none")},G=()=>{g()?(h(),v=A(v.x,v.y),$()):x(),K()};if(a.classList.toggle(H,B),u(),G(),r.addEventListener("click",j=>{j.stopPropagation(),f(!B)}),d){d.addEventListener("pointerdown",F=>{g()&&(F.preventDefault(),S={pointerId:F.pointerId,startX:F.clientX,startY:F.clientY,originX:v.x,originY:v.y},d.setPointerCapture(F.pointerId),d.classList.add("is-dragging"))}),d.addEventListener("pointermove",F=>{!S||S.pointerId!==F.pointerId||(v=A(S.originX+F.clientX-S.startX,S.originY+F.clientY-S.startY),$())});const j=F=>{if(!(!S||S.pointerId!==F.pointerId)){d.releasePointerCapture(F.pointerId),d.classList.remove("is-dragging");try{localStorage.setItem(O+":pos",JSON.stringify(v))}catch{}S=null,K()}};d.addEventListener("pointerup",j),d.addEventListener("pointercancel",j)}return window.addEventListener("resize",G),{setCollapsed:f,refreshMode:G,isCollapsed:()=>B}}function Ge(t,n={}){va();const o=n.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");n.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
  ...
  `;const r={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},d=460,O=340,I=80,L=800,H=560;function R(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:L-e.left-e.right,gh:H-e.top-e.bottom,tickFont:`bold ${Math.round(L*.024)}px Arial`,axisFont:`bold ${Math.round(L*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:H-e.bottom+32}}function B(){let l=100;const m=Math.max(r.bathTemp,r.thermometerTemp,100);m>120&&(l=150),m>145&&(l=200);const b=l<=100?20:25;return{minT:0,maxT:l,tickStep:b}}function v(e,l,m,b,p){return b+(e-l)/(m-l)*p}function S(e,l,m,b,p){return b+p-(e-l)/(m-l)*p}function E(e,l,m,b,p,_){const{gx:y,gy:w,gw:T,gh:C,tickFont:z,axisFont:Q,yLabelX:X,xLabelY:q}=l;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const U of _){const Y=S(U.value,U.min,U.max,w,C);e.beginPath(),e.moveTo(y,Y),e.lineTo(y+T,Y),e.stroke()}for(let U=m;U<=b+.01;U+=p){const Y=v(U,m,b,y,T);e.beginPath(),e.moveTo(Y,w),e.lineTo(Y,w+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(y,w),e.lineTo(y,w+C),e.lineTo(y+T,w+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=z,e.textAlign="right",e.textBaseline="middle";for(const U of _){const Y=S(U.value,U.min,U.max,w,C);e.fillText(U.label,y-15,Y)}e.textAlign="center",e.textBaseline="top";for(let U=m;U<=b+.01;U+=p){const Y=v(U,m,b,y,T);e.fillText(`${Math.round(U)}`,Y,w+C+10)}return{gx:y,gy:w,gw:T,gh:C,axisFont:Q,yLabelX:X,xLabelY:q}}function g(e,l){const m=l-e,b=m<=8?1:m<=14?2:5,p=[],_=Math.ceil(e/b)*b;for(let y=_;y<=l+.001;y+=b)p.push({value:y,label:y%1===0?`${y.toFixed(0)}`:`${y.toFixed(1)}`,min:e,max:l});return p}function A(){const{maxT:e}=B(),l=$(0),m=$(e),b=m-l,p=Math.max(1,b*.1),_=Math.max(0,Math.round((l-p)*10)/10),y=Math.round((m+p)*10)/10;return{minL:_,maxL:y}}function $(e){return r.liquidL0+(r.liquidL100-r.liquidL0)/100*e}function K(){const{maxT:e}=B(),l=u(0),m=u(e),b=m-l,p=Math.max(.2,b*.1),_=Math.max(0,l-p),y=m+p,w=b<=2?.5:b<=4?1:2,T=[],C=Math.ceil(_/w)*w;for(let z=C;z<=y+.001;z+=w)T.push({value:z,label:z.toFixed(1),min:_,max:y});return{minR:_,maxR:y,ticks:T}}function u(e){return r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*e}function f(e){const{maxT:l}=e;let m=r.thermistorR25;for(let y=0;y<=l;y+=5){const w=y+273.15,T=r.thermistorR25*Math.exp(r.thermistorBeta*(1/w-1/298.15));m=Math.max(m,T)}m=Math.ceil(m*1.08*10)/10;const b=0,p=m<=12?2:4,_=[];for(let y=0;y<=m+.001;y+=p)_.push({value:y,label:y.toFixed(0),min:b,max:m});return{minR:b,maxR:m,ticks:_}}const h=a.querySelector("#tl-thermometerCanvas"),x=h.getContext("2d"),G=a.querySelector("#tl-graphCanvas"),j=G.getContext("2d"),F=window.devicePixelRatio||1;h.width=d*F,h.height=O*F,x.scale(F,F),G.width=L*F,G.height=H*F,j.scale(F,F);function P(){r.iceCubes=[];for(let e=0;e<5;e++)r.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});r.bubbles=[];for(let e=0;e<20;e++)r.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});r.heatWaves=[];for(let e=0;e<8;e++)r.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});r.steamParticles=[];for(let e=0;e<12;e++)r.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const W=200,V=11;function ee(){const e=Math.pow(r.bulbVolume/W,.3333333333333333);return V*e}function ne(){if(r.thermometerType==="resistance"||r.thermometerType==="thermistor")return .35;const e=r.liquidType==="mercury"?1:8,l=.2+r.wallThickness*1.5,m=.4+r.bulbVolume*.003,b=1.35-r.capillaryBore*.45;return Math.max(.1,l*m*b*e*.15)}function te(e){r.bathTemp<=8&&r.iceCubes.forEach(l=>{l.x+=l.speedX,l.y+=l.speedY,(l.x<65||l.x>175)&&(l.speedX*=-1),(l.y<195||l.y>210)&&(l.speedY*=-1)}),r.bathTemp>35&&r.heatWaves.forEach(l=>{l.y-=l.speedY*(1+r.bathTemp/100),l.y<185&&(l.y=265,l.x=65+Math.random()*110)}),r.bathTemp>=80&&r.bubbles.forEach(l=>{l.y-=l.speedY*(1+(r.bathTemp-80)/40),l.phase+=l.wobbleSpeed,l.x+=Math.sin(l.phase)*.3,l.y<185&&(l.y=260+Math.random()*10,l.x=60+Math.random()*120)}),r.bathTemp>=95&&r.steamParticles.forEach(l=>{l.x+=l.vx,l.y+=l.vy,l.alpha-=.005,(l.alpha<=0||l.y<130)&&(l.x=60+Math.random()*120,l.y=175+Math.random()*5,l.alpha=.2+Math.random()*.4)})}function ae(e){let y=59,w=130,T=246;if(r.bathTemp<25){const q=r.bathTemp/25;y=Math.round(180-q*121),w=Math.round(210-q*80),T=Math.round(250-q*4)}else{const q=Math.min(1,(r.bathTemp-25)/125);y=Math.round(59+q*180),w=Math.round(130-q*100),T=Math.round(246-q*190)}if(r.bathTemp>40){const q=Math.min(1,(r.bathTemp-40)/100),U=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let Y=-25;Y<=25;Y+=6){const re=q*(12+Math.sin(Y*.4+U)*5);e.lineTo(55+130/2+Y,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${y}, ${w}, ${T}, 0.25)`),C.addColorStop(1,`rgba(${y}, ${w}, ${T}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const z=r.bathTemp>=80?2:.5,Q=r.bathTemp>=80?.09:.03,X=Date.now()*Q;for(let q=55;q<=185;q+=5){const U=190+Math.sin(q*.15+X)*z;e.lineTo(q,U)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),r.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(r.bathTemp-35)/120)})`,e.lineWidth=1.2,r.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),r.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,r.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),r.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,r.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),r.bathTemp>=95&&r.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function k(e,l,m,b,p,_,y="left"){if(!r.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(l,m),e.lineTo(b,p),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(l,m,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const T=e.measureText(_).width+10,C=16,z=y==="left"?b:b-T,Q=p-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(z,Q,T,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(_,z+T/2,Q+C/2+.5)}function M(e){const b=ee(),p=250+Math.max(0,b-V)*.35,_=p-b-1,y=10+r.wallThickness*8,w=120-y/2,T=120+y/2,C=e.createLinearGradient(w,20,T,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,_),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(T,20,T,25,5),e.lineTo(T,_),e.closePath(),e.fill(),e.stroke();const z=e.createRadialGradient(120-b*.2,p-b*.2,b*.1,120,p,b);z.addColorStop(0,"rgba(255, 255, 255, 0.8)"),z.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=z,e.strokeStyle="#6b7280",e.lineWidth=.8+r.wallThickness*.6,e.beginPath(),e.arc(120,p,b+.5+r.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const Q=Math.min(y*.72,.8+r.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-Q/2,28,Q,_-20-8);const X=r.liquidType==="mercury",q=X?"#a1a1aa":"#ef4444",U=X?"#f4f4f5":"#fee2e2",Y=210,re=220,be=(Y-40)/re,he=Y-Math.min(re,r.thermometerTemp)*be;e.fillStyle=q,e.fillRect(120-Q/2,he,Q,_-he),e.beginPath(),e.ellipse(120,he,Q/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=U,e.fillRect(120-Q/6,he,Q/3,_-he);const se=b*.9,ie=e.createRadialGradient(120-se*.2,p-se*.2,se*.1,120,p,se);X?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,p,se,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ce=0;ce<=200;ce+=50){const pe=Y-ce*be;e.beginPath(),e.moveTo(w,pe),e.lineTo(w+4,pe),e.stroke(),e.fillText(`${ce}°C`,w-22,pe+2.5)}r.showLabels&&(k(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),k(e,120,he,230,he-15,t("tools.thermometerLab.labels.meniscus"),"left"),k(e,120-Q/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),k(e,120,p,230,p+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function J(e){const y=e.createLinearGradient(115,20,125,20);y.addColorStop(0,"#71717a"),y.addColorStop(.3,"#f4f4f5"),y.addColorStop(.7,"#d4d4d8"),y.addColorStop(1,"#3f3f46"),e.fillStyle=y,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let X=0;X<8;X++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const T=245,C=40,z=135,Q=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(T,C,z,Q,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(T+10,C+12,z-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(r.currentResistance.toFixed(2)+" Ω",T+z-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",T+14,C+21),r.showLabels&&(k(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),k(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function D(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,_=225,y=12,w=120-y/2,T=e.createLinearGradient(w,p,w+y,p);T.addColorStop(0,"rgba(229, 231, 235, 0.4)"),T.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),T.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),T.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=T,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,p,y,_-p,[0,0,3,3]),e.fill(),e.stroke();const C=7,z=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);z.addColorStop(0,"#6b7280"),z.addColorStop(.7,"#1f2937"),z.addColorStop(1,"#09090b"),e.fillStyle=z,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const Q=245,X=40,q=135,U=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(Q,X,q,U,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(Q+10,X+12,q-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(r.currentThermistorR.toFixed(2)+" kΩ",Q+q-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",Q+14,X+21),r.showLabels&&(k(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),k(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Z(e,l,m,b,p,_,y,w,T){const{gx:C,gy:z,gw:Q,gh:X}=l;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(m,b),e.lineTo(m,z+X),e.stroke(),e.beginPath(),e.moveTo(m,b),e.lineTo(C,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${p.toFixed(1)}${y}`,U=e.measureText(q).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(m-U/2,z+X+2,U,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,m,z+X+4),e.textAlign="right",e.textBaseline="middle";const Y=`${_.toFixed(2)} ${w}`,re=e.measureText(Y).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(C-re-2,b-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(Y,C-7,b)}function N(e){const l=R(),{minL:m,maxL:b}=A(),{minT:p,maxT:_,tickStep:y}=B(),w=g(m,b),T=E(e,l,p,_,y,w),{gx:C,gy:z,gw:Q,gh:X,axisFont:q,yLabelX:U,xLabelY:Y,dotR:re}={...l,...T};e.save(),e.translate(U,z+X/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+Q/2,Y);const we=_,be=v(0,p,_,C,Q),he=S($(0),m,b,z,X),se=v(we,p,_,C,Q),ie=S($(we),m,b,z,X);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentLength;if(ce>=p&&ce<=_){const ve=v(ce,p,_,C,Q),Ce=S(pe,m,b,z,X);Z(e,l,ve,Ce,ce,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const l=R(),{minR:m,maxR:b,ticks:p}=K(),_=B(),y=E(e,l,_.minT,_.maxT,_.tickStep,p),{gx:w,gy:T,gw:C,gh:z,axisFont:Q,yLabelX:X,xLabelY:q,dotR:U}={...l,...y};e.save(),e.translate(X,T+z/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,q);const{minT:Y,maxT:re}=_,we=re,be=v(0,Y,re,w,C),he=S(u(0),m,b,T,z),se=v(we,Y,re,w,C),ie=S(u(we),m,b,T,z);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentResistance;if(ce>=Y&&ce<=re){const ve=v(ce,Y,re,w,C),Ce=S(pe,m,b,T,z);Z(e,l,ve,Ce,ce,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,U,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function le(e){const l=R(),m=B(),{minR:b,maxR:p,ticks:_}=f(m),y=E(e,l,m.minT,m.maxT,m.tickStep,_),{gx:w,gy:T,gw:C,gh:z,axisFont:Q,yLabelX:X,xLabelY:q,dotR:U}={...l,...y},{minT:Y,maxT:re}=m;e.save(),e.translate(X,T+z/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let se=Y;se<=re;se+=1){const ie=se+273.15,ce=r.thermistorR25*Math.exp(r.thermistorBeta*(1/ie-1/298.15)),pe=v(se,Y,re,w,C),ve=S(Math.min(p,ce),b,p,T,z);ve>=T&&ve<=T+z&&(we?e.lineTo(pe,ve):(e.moveTo(pe,ve),we=!0))}e.stroke();const be=r.thermometerTemp,he=r.currentThermistorR;if(be>=Y&&be<=re){const se=v(be,Y,re,w,C),ie=S(Math.min(p,he),b,p,T,z);Z(e,l,se,ie,be,he,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(se,ie,U,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ue(){x.clearRect(0,0,d,O),j.clearRect(0,0,L,H),x.save(),x.translate(I,0),ae(x),r.thermometerType==="liquid"?M(x):r.thermometerType==="resistance"?J(x):D(x),x.restore(),r.thermometerType==="liquid"?N(j):r.thermometerType==="resistance"?de(j):le(j)}function ge(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Current Point -->
          <text x="65" y="${z+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${w.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${z+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${T.toFixed(1)}°C</text>
    ...
    `}function ke(e){a.querySelector("#tl-bath-temp-display").innerHTML=r.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=r.bathTemp.toFixed(1)+" °C";const l=a.querySelector("#tl-bath-state");r.bathTemp<=0?l.textContent="Melting Ice Bath":r.bathTemp>=100?l.textContent="Boiling Water/Steam":r.bathTemp===150?l.textContent="Hot Cooking Oil":l.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const m=a.querySelector("#tl-alcohol-boiling-warning");r.thermometerType==="liquid"&&r.liquidType==="alcohol"&&r.bathTemp>=78?m.style.display="block":m.style.display="none",r.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=r.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):r.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=r.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=r.currentThermistorR.toFixed(2)+" kΩ",ge()}let Se=null;function _e(e){r.lastTimestamp||(r.lastTimestamp=e);const l=(e-r.lastTimestamp)/1e3;r.lastTimestamp=e;const m=Math.min(l,.1),b=ne(),p=m/b*(r.bathTemp-r.thermometerTemp);r.thermometerTemp+=p,r.currentLength=r.liquidL0+(r.liquidL100-r.liquidL0)/100*r.thermometerTemp,r.currentResistance=r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*r.thermometerTemp;const _=r.thermometerTemp+273.15;r.currentThermistorR=r.thermistorR25*Math.exp(r.thermistorBeta*(1/_-1/298.15)),te(),ue(),ke(b),Se=requestAnimationFrame(_e)}function He(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),l=parseFloat(a.querySelector("#tl-input-faulty-cu").value),m=Number.isFinite(e)?e:-1.5,b=Number.isFinite(l)?l:105,p=b-m;return{cf:m,cu:b,interval:p}}function Ee(e){const l=Math.round(e*100)/100;return l>=0?l.toFixed(1):`(${l.toFixed(1)})`}function me(){const{cf:e,cu:l,interval:m}=He(),b=a.querySelector("#tl-val-faulty-interval"),p=a.querySelector("#tl-faulty-error-a"),_=a.querySelector("#tl-faulty-error-b"),y=Math.abs(m)<.01;b.textContent=m.toFixed(1)+" °C";const w=a.querySelector("#tl-svg-formula-faulty-a"),T=a.querySelector("#tl-svg-formula-faulty-b");if(y){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",_.hidden=!1,_.textContent=p.textContent,w&&(w.innerHTML=""),T&&(T.innerHTML="");return}p.hidden=!0,_.hidden=!0;const C=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,z=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,Q=(C-e)/m*100,X=z/100*m+e;w&&(w.innerHTML=`
      ...
      </section>`}async function B(){const u=je();for(const f of ze){const h=t.querySelector(`[data-note-card="${f.id}"]`);if(!h)continue;const x=h.querySelector("[data-note-body]"),G=u==="zhHant"?f.fileZh:f.fileEn,j=await ft(G),F=`./notes/${G}`;j?x.innerHTML=`
      ...
      </section>`}async function A(){const u=je();for(const f of ze){const h=t.querySelector(`[data-summary-card="${f.id}"]`);if(!h)continue;const x=h.querySelector("[data-summary-body]");if(f.id==="thermometer"){const P=await Me("summary","thermometer.webp"),W="./summary/thermometer.webp";P?x.innerHTML=`
          <img class="summary-thumb" src="${W}" alt="${c("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(f.id==="heatInternalEnergy"){const P=u==="zhHant"?"heat-internal-energy-zhHant.webp":"heat-internal-energy-en.webp",W=await Me("summary",P),V=`./summary/${P}`;W?x.innerHTML=`
          <img class="summary-thumb" src="${V}" alt="${c("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${V}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(f.id==="changeOfState"){const P=await Me("summary","change-of-state.webp"),W="./summary/change-of-state.webp";P?x.innerHTML=`
          <img class="summary-thumb" src="${W}" alt="${c("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(f.id==="heatTransfer"){const P=await Me("summary","heat-transfer.webp"),W="./summary/heat-transfer.webp";P?x.innerHTML=`
          <img class="summary-thumb" src="${W}" alt="${c("summary.item.heatTransfer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${W}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}const G=u==="zhHant"?f.fileZh:f.fileEn,j=await ft(G),F=`./notes/${G}`;j?x.innerHTML=`
          <iframe class="notes-grid" title="${c(`summary.item.${f.id}`)}" src="${F}"></iframe>
          <p style="margin-top:8px"><a href="${F}" target="_blank" rel="noopener">${c("summary.download")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`}}const $=()=>I(),K=u=>H(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",K),I(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",K),r==null||r(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const ht={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Et();At();const pt="s3phy_splash_seen",Ct={optics:ma,heat:za};let Le=null,Re=null;function La(){const t=location.hash.match(/^#\/(\w+)/),n=t==null?void 0:t[1];return n&&Object.prototype.hasOwnProperty.call(Ct,n)?n:null}function Ra(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function zt(t){Le==null||Le(),Le=null,Re==null||Re(),Re=null;const n=document.getElementById("app");if(!n)return;if(n.innerHTML="",!t){location.hash&&Ra(),Re=It(n);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Le=Ct[t](n)??null}function Lt(){zt(La())}function Ma(){return"./images/uniplus-logo.png"}function _a(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
