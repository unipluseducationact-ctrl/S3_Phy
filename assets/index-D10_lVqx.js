...
`;function Et(){if(document.getElementById(Qe))return;const t=document.createElement("style");t.id=Qe,t.textContent=Ft,document.head.appendChild(t)}function At(t){Et();const n=document.createElement("div");n.className="rml",n.innerHTML=`
  ...
  `;const o=n.querySelector(".rml-canvas"),i=o.getContext("2d"),s=n.querySelector("[data-rml-rot]"),a=n.querySelector("[data-rml-inc]"),r=n.querySelector('[data-rml-disp="rot"]'),u=n.querySelector('[data-rml-disp="inc"]'),j=n.querySelector('[data-rml-val="i"]'),A=n.querySelector('[data-rml-val="r"]'),z=n.querySelector('[data-rml-val="shift"]'),H=350,M=380,K=300,x="#22d3ee",_="bold 17px system-ui, sans-serif";let F=0,g=-140,E=!0,$=!0,U=!0,d=!0;function f(P){return P*Math.PI/180}function p(P,I,V,ee,ne,te=2,ae=!1){i.beginPath(),i.lineWidth=te,i.strokeStyle=ne,i.setLineDash(ae?[6,6]:[]);const w=P+Math.cos(f(V))*ee,L=I+Math.sin(f(V))*ee;return i.moveTo(P,I),i.lineTo(w,L),i.stroke(),i.setLineDash([]),{x:w,y:L}}function R(P,I,V,ee,ne,te=14){const ae=V-P,w=ee-I,L=Math.hypot(ae,w);if(L<1e-6)return;const Z=ae/L,W=w/L,X=V-Z*te,D=ee-W*te,de=.45*te;i.beginPath(),i.fillStyle=ne,i.moveTo(V,ee),i.lineTo(X-W*de,D+Z*de),i.lineTo(X+W*de,D-Z*de),i.closePath(),i.fill()}function G(P,I,V,ee,ne,te=25){i.beginPath(),i.strokeStyle=ee,i.lineWidth=2;const ae=Math.min(P,I),w=Math.max(P,I);if(i.arc(H,M,V,f(ae),f(w),!1),i.stroke(),ne){const L=(ae+w)/2,Z=H+Math.cos(f(L))*(V+te),W=M+Math.sin(f(L))*(V+te);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=ee,i.fillText(ne,Z,W),i.restore()}}function J(P,I,V,ee,ne){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(H-200,M),i.lineTo(H+200,M),i.stroke(),i.setLineDash([]),i.lineCap="butt";const te=H+Math.cos(f(P))*K,ae=M+Math.sin(f(P))*K;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(te,ae),i.lineTo(H,M),i.stroke();const w=(te+H)*.5,L=(ae+M)*.5,Z=Math.hypot(H-te,M-ae)||1,W=(H-te)/Z,X=(M-ae)/Z;if(R(w-W*28,L-X*28,w,L,"#fff",16),i.save(),i.font=_,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),te,ae-12),i.restore(),E){const D=p(H,M,-90,K-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),D.x+6,D.y-4),i.restore()}if($){const D=p(H,M,ee,K,"#00e676",2,!1);R(H,M,D.x,D.y,"#00e676",16),i.save(),i.font=_,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),D.x,D.y-14),i.restore()}i.save(),i.translate(H,M),i.rotate(f(F)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let D=-190;D<200;D+=15)i.moveTo(D,0),i.lineTo(D-5,8);if(i.stroke(),i.restore(),U){const D=p(H,M,I,K-40,x,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=x,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),D.x+6,D.y-4),i.restore()}if(d){const D=p(H,M,V,K,x,4);R(H,M,D.x,D.y,x,16),Math.abs(F)>.5&&(i.save(),i.font=_,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=x,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),D.x,D.y-14),i.restore())}if(U&&G(P,I,100,"#ffcc00",`i=${ne.toFixed(0)}°`,25),U&&d&&G(I,V,100,x,`r=${ne.toFixed(0)}°`,25),E&&U&&Math.abs(F)>.5&&G(-90,I,50,"#ffcc00",`θ=${Math.abs(F)}°`,20),$&&d&&Math.abs(F)>.5){const D=V-ee;G(ee,V,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${D.toFixed(0)}°`,40)}}function Q(){F=parseFloat(s.value),g=parseFloat(a.value);const P=F>0?"+":"";r.textContent=`${P}${F}°`,u.textContent=`${g}°`;const I=-90,V=Math.abs(g-I),ee=I+V,ne=-90+F,te=Math.abs(g-ne),ae=ne+te,w=ae-ee;j.textContent=`${te.toFixed(1)}°`,A.textContent=`${te.toFixed(1)}°`;const L=w>0?"+":"";z.textContent=`${L}${w.toFixed(1)}°`,J(g,ne,ae,ee,te)}return n.querySelectorAll("[data-rml-toggle]").forEach(P=>{P.addEventListener("click",()=>{const I=P.getAttribute("data-rml-toggle");I==="orig-norm"&&(E=!E),I==="orig-ray"&&($=!$),I==="new-norm"&&(U=!U),I==="new-ray"&&(d=!d),P.classList.toggle("active"),Q()})}),n.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",Q()}),s.addEventListener("input",Q),a.addEventListener("input",Q),Q(),n}function $t(t){const n=document.createElement("div");n.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;return o.src=`${s}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",n.appendChild(o),n}function It(t,n={}){const o=n.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),r="./",u=r.endsWith("/")?r:`${r}/`;return a.src=`${u}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,a.title=t(i),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function Wt(t){const n=document.createElement("div");n.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(oe())}`}o.src=a(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var u;try{(u=o.contentWindow)==null||u.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._emLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function Pt(t){const n=document.createElement("div");n.className="rgb-mixer",n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-r]"),i=n.querySelector("[data-g]"),s=n.querySelector("[data-b]"),a=n.querySelector(".rgb-mixer-canvas"),r=n.querySelector(".rgb-mixer-stage"),u=a.getContext("2d");function j(x){return x.toString(16).padStart(2,"0")}function A(x,_,F){const g=a.width/(window.devicePixelRatio||1),E=a.height/(window.devicePixelRatio||1),$=g/2,U=E/2,d=Math.min(g,E)*.34,f=d*.5,p=Math.sqrt(3)/2;u.clearRect(0,0,g,E),u.fillStyle="#000",u.fillRect(0,0,g,E);const R=[{x:$,y:U-f,rgb:[255,0,0],val:x},{x:$-f*p,y:U+f*.5,rgb:[0,255,0],val:_},{x:$+f*p,y:U+f*.5,rgb:[0,0,255],val:F}];u.globalCompositeOperation="lighter",R.forEach(G=>{if(G.val<=0)return;const J=G.val/255,[Q,P,I]=G.rgb,V=u.createRadialGradient(G.x,G.y,0,G.x,G.y,d);V.addColorStop(0,`rgba(${Q},${P},${I},${J})`),V.addColorStop(.65,`rgba(${Q},${P},${I},${J})`),V.addColorStop(.85,`rgba(${Q},${P},${I},${J*.5})`),V.addColorStop(1,`rgba(${Q},${P},${I},0)`),u.fillStyle=V,u.beginPath(),u.arc(G.x,G.y,d,0,Math.PI*2),u.fill()}),u.globalCompositeOperation="source-over"}function z(){const x=r.getBoundingClientRect(),_=Math.max(200,Math.min(x.width-8,x.height-8,720)),F=window.devicePixelRatio||1;a.width=_*F,a.height=_*F,a.style.width=`${_}px`,a.style.height=`${_}px`,u.setTransform(F,0,0,F,0,0),A(+o.value,+i.value,+s.value)}function H(){const x=+o.value,_=+i.value,F=+s.value,g=`rgb(${x}, ${_}, ${F})`,E=`#${j(x)}${j(_)}${j(F)}`;n.querySelector("[data-r-val]").textContent=x,n.querySelector("[data-g-val]").textContent=_,n.querySelector("[data-b-val]").textContent=F,n.querySelector("[data-r-bar]").style.width=`${x/255*100}%`,n.querySelector("[data-g-bar]").style.width=`${_/255*100}%`,n.querySelector("[data-b-bar]").style.width=`${F/255*100}%`,o.style.setProperty("--fill",`${x/255*100}%`),i.style.setProperty("--fill",`${_/255*100}%`),s.style.setProperty("--fill",`${F/255*100}%`);const $=n.querySelector("[data-swatch]");$.style.backgroundColor=g,$.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${g}`),n.querySelector("[data-rgb-text]").textContent=g,n.querySelector("[data-hex-text]").textContent=E,A(x,_,F)}function M(x,_,F){o.value=x,i.value=_,s.value=F,H()}return[o,i,s].forEach(x=>x.addEventListener("input",H)),n.querySelectorAll(".rgb-presets button").forEach(x=>{x.addEventListener("click",()=>{M(+x.dataset.r,+x.dataset.g,+x.dataset.b)})}),new ResizeObserver(()=>z()).observe(r),requestAnimationFrame(()=>{z(),H()}),n}const Dt=["topics","notes","tools","worksheets","flashcards","summary"],Ot={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function bt(t,{subtitleKey:n,activeSection:o,onSection:i,onLang:s}){t.innerHTML=`
  ...
  `;const a=t.querySelector("[data-main]"),r=t.querySelector("[data-nav]"),u=t.querySelector("[data-lang]"),j=t.querySelector("[data-strand-back]");let A=o;function z(x){A=x,r.innerHTML=Dt.map(_=>`<button type="button" class="${x===_?"active":""}" data-sec="${_}">${l(Ot[_])}</button>`).join(""),r.querySelectorAll("button").forEach(_=>{_.addEventListener("click",()=>i(_.getAttribute("data-sec")))})}function H(){u.innerHTML=`
    ...
    <section class="panel panel--worksheets">
      ...
      <div class="worksheet-output" data-ws-out><p class="lead">${t("worksheets.empty")}</p></div>
    </section>`}function vt(t,n,o,i,s={}){var ee,ne,te,ae;const a={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},r=t.querySelector("[data-ws-gen]"),u=t.querySelector("[data-ws-preview-area]"),j=t.querySelector("[data-ws-out]"),A=t.querySelector("[data-ws-body]"),z=t.querySelector("[data-ws-paper]"),H=t.querySelector("[data-ws-tabs]"),M=t.querySelector("[data-ws-practice-actions]"),K=t.querySelector("[data-ws-score]"),x=t.querySelector("[data-ws-score-val]"),_=t.querySelector("[data-ws-summary]"),F=t.querySelector("[data-ws-date-row]"),g=t.querySelector("[data-ws-date-print]"),E=t.querySelector("[data-ws-date-today]"),$=t.querySelector("[data-ws-date-label]");if(!r||!A)return;function U(){return i()}function d(){a.userAnswers={},a.wrongAttempts={},a.resolved={},K.hidden=!0,_.hidden=!0}function f(){return a.items.length>0&&a.items.every((w,L)=>a.resolved[L])}function p(){let w=0;a.items.forEach((Z,W)=>{if(!a.resolved[W])return;const X=Z[U()]||Z.en;a.userAnswers[W]===X.a&&(w+=1)}),Object.keys(a.resolved).length>0&&(x.textContent=`${w}/${a.items.length}`,K.hidden=!1)}function R(w){a.tab=w,H==null||H.querySelectorAll("[data-ws-tab]").forEach(L=>{L.classList.toggle("active",L.getAttribute("data-ws-tab")===w)}),M&&(M.hidden=w!=="practice"),F&&(F.hidden=w!=="practice"),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:""),z==null||z.classList.toggle("practice-mode",w==="practice"),J()}function G(w,L,Z){const W=w[U()]||w.en,X=Pe,D=L+1,de=w.section?`<span class="q-section">${xe(w.section)}</span>`:"";if(Z==="answer"){const me=W.choices.map((ye,Ce)=>`<li class="${Ce===W.a?"choice-correct":""}"><strong>${X[Ce]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${D} ${de}</h4>
        <p>${xe(W.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${X[W.a]}</p>
        <p class="q-exp"><em>${xe(W.exp)}</em></p>
      </div>`}const le=a.userAnswers[L],he=a.wrongAttempts[L]||0,ge=a.resolved[L],qe=ge&&le===W.a,ke=ge&&le!==W.a;let Se="";he===1&&!ge?Se=`<p class="q-hint"><strong>${o("worksheets.hint")}:</strong> ${xe(W.hint||W.exp)}</p>`:ke&&(Se=`<p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${X[W.a]}</p>
        <p class="q-exp q-summary"><em>${xe(W.exp)}</em></p>`);const _e=qe?"correct":ke?"incorrect":"",He=W.choices.map((me,ye)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${L}" value="${ye}" data-ws-q="${L}" data-ws-choice="${ye}"${le===ye?" checked":""}${ge?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${X[ye]}.</strong> ${xe(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${_e}" data-ws-row="${L}">
      ...
      ${Se}
    </div>`}function J(){a.items.length&&(A.innerHTML=a.items.map((w,L)=>G(w,L,a.tab)).join(""),Q())}function Q(){a.tab==="practice"&&A.querySelectorAll("[data-ws-choice]").forEach(w=>{w.addEventListener("change",()=>{const L=Number(w.getAttribute("data-ws-q"));if(a.resolved[L])return;const Z=Number(w.getAttribute("data-ws-choice")),W=a.items[L][U()]||a.items[L].en;a.userAnswers[L]=Z,Z===W.a?a.resolved[L]=!0:(a.wrongAttempts[L]=(a.wrongAttempts[L]||0)+1,a.wrongAttempts[L]>=2&&(a.resolved[L]=!0)),p(),f()&&P(),J()})})}function P(){const w=a.items.length;let L=0,Z=0;const W={};a.items.forEach((le,he)=>{const ge=le[U()]||le.en;if(a.userAnswers[he]===ge.a)L+=1,(a.wrongAttempts[he]||0)===0&&(Z+=1);else if(a.resolved[he]){const ke=le.section||le.topic;W[ke]=(W[ke]||0)+1}});const X=w?Math.round(L/w*100):0;let D=o("worksheets.revisionFair");X>=90?D=o("worksheets.revisionExcellent"):X>=70?D=o("worksheets.revisionGood"):X<50&&(D=o("worksheets.revisionLow"));const de=Object.entries(W).sort((le,he)=>he[1]-le[1]).map(([le,he])=>`<li>${xe(le)} (${he})</li>`).join("");_.innerHTML=`
      <h4>${o("worksheets.sessionSummary")}</h4>
      <p>${o("worksheets.score")}: <strong>${L}/${w}</strong> (${X}%)</p>
      <p>${o("worksheets.firstTry")}: <strong>${Z}/${w}</strong></p>
      <p>${o("worksheets.revisionSuggestions")}: ${D}</p>
      ${de?`<p>${o("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,_.hidden=!1}function I(w){const L=U(),Z=a.items.map((W,X)=>{const D=W[L]||W.en,de=D.choices.map((he,ge)=>`${Pe[ge]}. ${he}`).join("<br/>"),le=w?`<p><b>${o("worksheets.answer")}:</b> ${Pe[D.a]}<br/><i>${D.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${X+1}.</b> ${D.q}<br/>${de}${le}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${Z}</body></html>`}function V(w){const L=I(w),Z=new Blob(["\uFEFF",L],{type:"application/msword"}),W=document.createElement("a");W.href=URL.createObjectURL(Z),W.download=w?"worksheet-answers.doc":"worksheet.doc",W.click(),URL.revokeObjectURL(W.href)}r.addEventListener("click",()=>{const w=Number(t.querySelector("[data-ws-count]").value),L=[...t.querySelectorAll("[data-ws-topic]")].filter(X=>X.checked).map(X=>X.getAttribute("data-ws-topic")),Z=Gt(n,L,s.topicFilter),W=Ve(Z).slice(0,Math.min(w,Z.length||1));a.items=W.length?W:Ve(n).slice(0,Math.min(w,n.length)),d(),a.tab="practice",a.dateStr="",u.hidden=!1,j.hidden=!0,H==null||H.querySelectorAll("[data-ws-tab]").forEach(X=>{X.classList.toggle("active",X.getAttribute("data-ws-tab")==="practice")}),M&&(M.hidden=!1),F&&(F.hidden=!1),g&&(g.hidden=!0),$.textContent="",z==null||z.classList.add("practice-mode"),J()}),H==null||H.addEventListener("click",w=>{const L=w.target.closest("[data-ws-tab]");!L||!a.items.length||R(L.getAttribute("data-ws-tab"))}),E==null||E.addEventListener("click",()=>{a.dateStr?(a.dateStr="",$.textContent=""):(a.dateStr=jt(),$.textContent=`${o("worksheets.date")}: ${a.dateStr}`),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:"")}),(ee=t.querySelector("[data-ws-word-p]"))==null||ee.addEventListener("click",()=>V(!1)),(ne=t.querySelector("[data-ws-word-a]"))==null||ne.addEventListener("click",()=>V(!0)),(te=t.querySelector("[data-ws-print-p]"))==null||te.addEventListener("click",()=>{R("practice"),z==null||z.classList.add("ws-print-blank");const w=()=>z==null?void 0:z.classList.remove("ws-print-blank");window.addEventListener("afterprint",w,{once:!0}),window.print()}),(ae=t.querySelector("[data-ws-print-a]"))==null||ae.addEventListener("click",()=>{R("answer"),window.print()})}const Bt=1.7,Nt=.7,De=1,Qt=.1,Vt=3;function Kt(t){const n=Math.floor(t),o=t-n;return n+(Math.random()<o?1:0)}function Ke(t){for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function Ut(t){const n=new Map(t.map(a=>[a.id,a.copies])),o=[];let i=null;const s=t.reduce((a,r)=>a+r.copies,0);for(let a=0;a<s;a+=1){let r=[...n.entries()].filter(([A,z])=>z>0&&A!==i);r.length===0&&(r=[...n.entries()].filter(([,A])=>A>0)),r.sort((A,z)=>z[1]-A[1]);const[u,j]=r[0];o.push(u),n.set(u,j-1),i=u}return o}function Yt(t){const n=[];return t.forEach(({id:o,copies:i})=>{for(let s=0;s<i;s+=1)n.push(o)}),n}function Xt(t){let n="sequence",o=1,i=[],s=[],a=0,r=!1,u=!1,j=!1;const A=new Map;function z(){return t()}function H(){return new Map(z().map(d=>[d.id,d]))}function M(){A.clear(),z().forEach(d=>{A.set(d.id,{nextRate:De,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function K(){const d=z();return o===1?d.map(f=>({id:f.id,copies:1})):d.map(f=>{var p;return{id:f.id,copies:Kt(((p=A.get(f.id))==null?void 0:p.nextRate)??De)}}).filter(f=>f.copies>0)}function x(d){if(d.length===0)return[];if(o===1){const f=d.map(p=>p.id);return n==="random"?Ke([...f]):[...f].sort((p,R)=>p-R)}return n==="random"?Ke(Yt(d)):Ut(d)}function _(){if(u=!1,j=!1,i=K(),i.reduce((f,p)=>f+p.copies,0)===0){j=!0,u=!0,s=[],a=0;return}z().forEach(f=>{const p=A.get(f.id);p&&(p.roundAgain=0,p.roundGotIt=0,p.roundNeutral=0)}),s=x(i),a=0,r=!1}function F(){o=1,M(),_()}function g(){return s[a]??null}function E(){const d=g();return d==null?null:H().get(d)??null}function $(d){const f=g();if(f==null)return;const p=A.get(f);p&&(d==="again"?(p.nextRate=Bt,p.totalGotIt=0,p.roundAgain+=1):d==="gotit"?(p.totalGotIt+=1,p.roundGotIt+=1,p.nextRate=p.totalGotIt>=Vt?Qt:Nt):d==="neutral"&&(p.roundNeutral+=1,p.nextRate=De))}function U(){return r=!1,a<s.length-1?(a+=1,!1):(u=!0,!0)}return F(),{getMode:()=>n,setMode(d){n!==d&&(n=d,s=x(i),a=0,r=!1)},resetSession:F,getRoundNumber:()=>o,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>r,flip(){r=!r},unflip(){r=!1},currentCard:E,prev(){return a>0?(a-=1,r=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,r=!1,!0):!1},rateAgain(){return r?($("again"),U()):!1},rateGotIt(){return r?($("gotit"),U()):!1},rateNeutral(){return r?($("neutral"),U()):!1},isSummary:()=>u,isSessionComplete:()=>j,getRoundStats(){let d=0,f=0,p=0;return A.forEach(R=>{d+=R.roundAgain,f+=R.roundGotIt,p+=R.roundNeutral}),{again:d,gotIt:f,neutral:p}},nextRound(){o+=1,_()},restart(){F()}}}function yt(t,{deckOptions:n,buildDeck:o,initialDeck:i="all"}){let s=i,a=null,r=null;t.innerHTML=`
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${ia.map(d=>`<button type="button" data-tool="${d}" class="${o===d?"active":""}">${sa(d)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function _(){const d=t.querySelector("[data-tool-list]"),f=t.querySelector("[data-tool-stage]");!d||!f||(d.querySelectorAll("button").forEach(p=>{p.addEventListener("click",()=>{o=p.getAttribute("data-tool"),d.querySelectorAll("button").forEach(R=>R.classList.toggle("active",R.getAttribute("data-tool")===o)),F(f)})}),F(f))}function F(d){d.innerHTML="";const f=oa[o];if(!f)return;const p=o==="lens"?f(l,i):f(l);d.appendChild(p)}function g(){const d=[{key:"reflection",type:"image",fileEn:"reflection-en.webp",fileZh:"reflection-zhHant.webp"},{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"},{key:"convex",type:"image",fileEn:"convex-en.webp",fileZh:"convex-zhHant.webp"},{key:"concave",type:"image",fileEn:"concave-en.webp",fileZh:"concave-zhHant.webp"},{key:"em",type:"image",file:"em.webp"}];return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${d.map(f=>{const p=l(`summary.item.${f.key}`);return`
            <div class="card" data-summary-card="${f.key}">
              <h3>${p}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function E(){const d=[{key:"reflection",type:"image",fileEn:"reflection-en.webp",fileZh:"reflection-zhHant.webp"},{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"},{key:"convex",type:"image",fileEn:"convex-en.webp",fileZh:"convex-zhHant.webp"},{key:"concave",type:"image",fileEn:"concave-en.webp",fileZh:"concave-zhHant.webp"},{key:"em",type:"image",file:"em.webp"}],f=Oe();for(const p of d){const R=t.querySelector(`[data-summary-card="${p.key}"]`);if(!R)continue;const G=R.querySelector("[data-summary-body]");if(p.type==="image"){const I=p.fileEn&&p.fileZh?f==="zhHant"?p.fileZh:p.fileEn:p.file,V=await Be("summary",I),ee=`./summary/${I}`;V?G.innerHTML=`
          <img class="summary-thumb" src="${ee}" alt="${l(`summary.item.${p.key}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${ee}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:G.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const J=f==="zhHant"?p.fileZh:p.fileEn,Q=await Be("summary-pdfs",J),P=`./summary-pdfs/${J}`;Q?G.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${p.key}`)}" src="${P}"></iframe>
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:G.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const $=()=>A(),U=d=>H(d);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",U),A(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",U),r==null||r(),s==null||s.destroy()}}const it="s3phy-thermometer-lab-css",da=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function ua(){if(document.getElementById(it))return;const t=document.createElement("style");t.id=it,t.textContent=da,document.head.appendChild(t)}function Ge(t,n={}){ua();const o=n.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");n.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
  ...
  `;const r={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},u=460,j=340,A=80,z=800,H=560;function M(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:z-e.left-e.right,gh:H-e.top-e.bottom,tickFont:`bold ${Math.round(z*.024)}px Arial`,axisFont:`bold ${Math.round(z*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:H-e.bottom+32}}function K(){let c=100;const m=Math.max(r.bathTemp,r.thermometerTemp,100);m>120&&(c=150),m>145&&(c=200);const b=c<=100?20:25;return{minT:0,maxT:c,tickStep:b}}function x(e,c,m,b,h){return b+(e-c)/(m-c)*h}function _(e,c,m,b,h){return b+h-(e-c)/(m-c)*h}function F(e,c,m,b,h,q){const{gx:v,gy:y,gw:S,gh:C,tickFont:T,axisFont:O,yLabelX:Y,xLabelY:k}=c;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const B of q){const N=_(B.value,B.min,B.max,y,C);e.beginPath(),e.moveTo(v,N),e.lineTo(v+S,N),e.stroke()}for(let B=m;B<=b+.01;B+=h){const N=x(B,m,b,v,S);e.beginPath(),e.moveTo(N,y),e.lineTo(N,y+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(v,y),e.lineTo(v,y+C),e.lineTo(v+S,y+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=T,e.textAlign="right",e.textBaseline="middle";for(const B of q){const N=_(B.value,B.min,B.max,y,C);e.fillText(B.label,v-15,N)}e.textAlign="center",e.textBaseline="top";for(let B=m;B<=b+.01;B+=h){const N=x(B,m,b,v,S);e.fillText(`${Math.round(B)}`,N,y+C+10)}return{gx:v,gy:y,gw:S,gh:C,axisFont:O,yLabelX:Y,xLabelY:k}}function g(e,c){const m=c-e,b=m<=8?1:m<=14?2:5,h=[],q=Math.ceil(e/b)*b;for(let v=q;v<=c+.001;v+=b)h.push({value:v,label:v%1===0?`${v.toFixed(0)}`:`${v.toFixed(1)}`,min:e,max:c});return h}function E(){const{maxT:e}=K(),c=$(0),m=$(e),b=m-c,h=Math.max(1,b*.1),q=Math.max(0,Math.round((c-h)*10)/10),v=Math.round((m+h)*10)/10;return{minL:q,maxL:v}}function $(e){return r.liquidL0+(r.liquidL100-r.liquidL0)/100*e}function U(){const{maxT:e}=K(),c=d(0),m=d(e),b=m-c,h=Math.max(.2,b*.1),q=Math.max(0,c-h),v=m+h,y=b<=2?.5:b<=4?1:2,S=[],C=Math.ceil(q/y)*y;for(let T=C;T<=v+.001;T+=y)S.push({value:T,label:T.toFixed(1),min:q,max:v});return{minR:q,maxR:v,ticks:S}}function d(e){return r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*e}function f(e){const{maxT:c}=e;let m=r.thermistorR25;for(let v=0;v<=c;v+=5){const y=v+273.15,S=r.thermistorR25*Math.exp(r.thermistorBeta*(1/y-1/298.15));m=Math.max(m,S)}m=Math.ceil(m*1.08*10)/10;const b=0,h=m<=12?2:4,q=[];for(let v=0;v<=m+.001;v+=h)q.push({value:v,label:v.toFixed(0),min:b,max:m});return{minR:b,maxR:m,ticks:q}}const p=a.querySelector("#tl-thermometerCanvas"),R=p.getContext("2d"),G=a.querySelector("#tl-graphCanvas"),J=G.getContext("2d"),Q=window.devicePixelRatio||1;p.width=u*Q,p.height=j*Q,R.scale(Q,Q),G.width=z*Q,G.height=H*Q,J.scale(Q,Q);function P(){r.iceCubes=[];for(let e=0;e<5;e++)r.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});r.bubbles=[];for(let e=0;e<20;e++)r.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});r.heatWaves=[];for(let e=0;e<8;e++)r.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});r.steamParticles=[];for(let e=0;e<12;e++)r.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const I=200,V=11;function ee(){const e=Math.pow(r.bulbVolume/I,.3333333333333333);return V*e}function ne(){if(r.thermometerType==="resistance"||r.thermometerType==="thermistor")return .35;const e=r.liquidType==="mercury"?1:8,c=.2+r.wallThickness*1.5,m=.4+r.bulbVolume*.003,b=1.35-r.capillaryBore*.45;return Math.max(.1,c*m*b*e*.15)}function te(e){r.bathTemp<=8&&r.iceCubes.forEach(c=>{c.x+=c.speedX,c.y+=c.speedY,(c.x<65||c.x>175)&&(c.speedX*=-1),(c.y<195||c.y>210)&&(c.speedY*=-1)}),r.bathTemp>35&&r.heatWaves.forEach(c=>{c.y-=c.speedY*(1+r.bathTemp/100),c.y<185&&(c.y=265,c.x=65+Math.random()*110)}),r.bathTemp>=80&&r.bubbles.forEach(c=>{c.y-=c.speedY*(1+(r.bathTemp-80)/40),c.phase+=c.wobbleSpeed,c.x+=Math.sin(c.phase)*.3,c.y<185&&(c.y=260+Math.random()*10,c.x=60+Math.random()*120)}),r.bathTemp>=95&&r.steamParticles.forEach(c=>{c.x+=c.vx,c.y+=c.vy,c.alpha-=.005,(c.alpha<=0||c.y<130)&&(c.x=60+Math.random()*120,c.y=175+Math.random()*5,c.alpha=.2+Math.random()*.4)})}function ae(e){let v=59,y=130,S=246;if(r.bathTemp<25){const k=r.bathTemp/25;v=Math.round(180-k*121),y=Math.round(210-k*80),S=Math.round(250-k*4)}else{const k=Math.min(1,(r.bathTemp-25)/125);v=Math.round(59+k*180),y=Math.round(130-k*100),S=Math.round(246-k*190)}if(r.bathTemp>40){const k=Math.min(1,(r.bathTemp-40)/100),B=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${k*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let N=-25;N<=25;N+=6){const re=k*(12+Math.sin(N*.4+B)*5);e.lineTo(55+130/2+N,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${v}, ${y}, ${S}, 0.25)`),C.addColorStop(1,`rgba(${v}, ${y}, ${S}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const T=r.bathTemp>=80?2:.5,O=r.bathTemp>=80?.09:.03,Y=Date.now()*O;for(let k=55;k<=185;k+=5){const B=190+Math.sin(k*.15+Y)*T;e.lineTo(k,B)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),r.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(r.bathTemp-35)/120)})`,e.lineWidth=1.2,r.heatWaves.forEach(k=>{e.beginPath(),e.moveTo(k.x,k.y),e.quadraticCurveTo(k.x+Math.sin(k.y*.06)*5,k.y-k.length/2,k.x,k.y-k.length),e.stroke()})),r.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,r.iceCubes.forEach(k=>{e.save(),e.translate(k.x,k.y),e.rotate(k.angle),e.beginPath(),e.roundRect(-k.size/2,-k.size/2,k.size,k.size,3),e.fill(),e.stroke(),e.restore()})),r.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,r.bubbles.forEach(k=>{e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill(),e.stroke()})),r.bathTemp>=95&&r.steamParticles.forEach(k=>{e.fillStyle=`rgba(255, 255, 255, ${k.alpha})`,e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function w(e,c,m,b,h,q,v="left"){if(!r.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(c,m),e.lineTo(b,h),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(c,m,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const S=e.measureText(q).width+10,C=16,T=v==="left"?b:b-S,O=h-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(T,O,S,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(q,T+S/2,O+C/2+.5)}function L(e){const b=ee(),h=250+Math.max(0,b-V)*.35,q=h-b-1,v=10+r.wallThickness*8,y=120-v/2,S=120+v/2,C=e.createLinearGradient(y,20,S,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(y,q),e.lineTo(y,25),e.arcTo(y,20,y+5,20,5),e.arcTo(S,20,S,25,5),e.lineTo(S,q),e.closePath(),e.fill(),e.stroke();const T=e.createRadialGradient(120-b*.2,h-b*.2,b*.1,120,h,b);T.addColorStop(0,"rgba(255, 255, 255, 0.8)"),T.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=T,e.strokeStyle="#6b7280",e.lineWidth=.8+r.wallThickness*.6,e.beginPath(),e.arc(120,h,b+.5+r.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const O=Math.min(v*.72,.8+r.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-O/2,28,O,q-20-8);const Y=r.liquidType==="mercury",k=Y?"#a1a1aa":"#ef4444",B=Y?"#f4f4f5":"#fee2e2",N=210,re=220,be=(N-40)/re,fe=N-Math.min(re,r.thermometerTemp)*be;e.fillStyle=k,e.fillRect(120-O/2,fe,O,q-fe),e.beginPath(),e.ellipse(120,fe,O/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=B,e.fillRect(120-O/6,fe,O/3,q-fe);const se=b*.9,ie=e.createRadialGradient(120-se*.2,h-se*.2,se*.1,120,h,se);Y?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,h,se,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ce=0;ce<=200;ce+=50){const pe=N-ce*be;e.beginPath(),e.moveTo(y,pe),e.lineTo(y+4,pe),e.stroke(),e.fillText(`${ce}°C`,y-22,pe+2.5)}r.showLabels&&(w(e,y+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),w(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),w(e,120-O/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),w(e,120,h,230,h+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function Z(e){const v=e.createLinearGradient(115,20,125,20);v.addColorStop(0,"#71717a"),v.addColorStop(.3,"#f4f4f5"),v.addColorStop(.7,"#d4d4d8"),v.addColorStop(1,"#3f3f46"),e.fillStyle=v,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let y=205;e.moveTo(118,y);for(let Y=0;Y<8;Y++)y+=4,e.lineTo(122,y),y+=4,e.lineTo(118,y);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,C=40,T=135,O=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,C,T,O,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,C+12,T-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(r.currentResistance.toFixed(2)+" Ω",S+T-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,C+21),r.showLabels&&(w(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),w(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function W(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const h=20,q=225,v=12,y=120-v/2,S=e.createLinearGradient(y,h,y+v,h);S.addColorStop(0,"rgba(229, 231, 235, 0.4)"),S.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),S.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),S.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=S,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(y,h,v,q-h,[0,0,3,3]),e.fill(),e.stroke();const C=7,T=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);T.addColorStop(0,"#6b7280"),T.addColorStop(.7,"#1f2937"),T.addColorStop(1,"#09090b"),e.fillStyle=T,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const O=245,Y=40,k=135,B=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(O,Y,k,B,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(O+10,Y+12,k-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(r.currentThermistorR.toFixed(2)+" kΩ",O+k-16,Y+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",O+14,Y+21),r.showLabels&&(w(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),w(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function X(e,c,m,b,h,q,v,y,S){const{gx:C,gy:T,gw:O,gh:Y}=c;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(m,b),e.lineTo(m,T+Y),e.stroke(),e.beginPath(),e.moveTo(m,b),e.lineTo(C,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const k=`${h.toFixed(1)}${v}`,B=e.measureText(k).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(m-B/2,T+Y+2,B,15,3),e.fill(),e.fillStyle="#000",e.fillText(k,m,T+Y+4),e.textAlign="right",e.textBaseline="middle";const N=`${q.toFixed(2)} ${y}`,re=e.measureText(N).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(C-re-2,b-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(N,C-7,b)}function D(e){const c=M(),{minL:m,maxL:b}=E(),{minT:h,maxT:q,tickStep:v}=K(),y=g(m,b),S=F(e,c,h,q,v,y),{gx:C,gy:T,gw:O,gh:Y,axisFont:k,yLabelX:B,xLabelY:N,dotR:re}={...c,...S};e.save(),e.translate(B,T+Y/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=k,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+O/2,N);const we=q,be=x(0,h,q,C,O),fe=_($(0),m,b,T,Y),se=x(we,h,q,C,O),ie=_($(we),m,b,T,Y);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentLength;if(ce>=h&&ce<=q){const ve=x(ce,h,q,C,O),Te=_(pe,m,b,T,Y);X(e,c,ve,Te,ce,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Te,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const c=M(),{minR:m,maxR:b,ticks:h}=U(),q=K(),v=F(e,c,q.minT,q.maxT,q.tickStep,h),{gx:y,gy:S,gw:C,gh:T,axisFont:O,yLabelX:Y,xLabelY:k,dotR:B}={...c,...v};e.save(),e.translate(Y,S+T/2),e.rotate(-Math.PI/2),e.font=O,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=O,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+C/2,k);const{minT:N,maxT:re}=q,we=re,be=x(0,N,re,y,C),fe=_(d(0),m,b,S,T),se=x(we,N,re,y,C),ie=_(d(we),m,b,S,T);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentResistance;if(ce>=N&&ce<=re){const ve=x(ce,N,re,y,C),Te=_(pe,m,b,S,T);X(e,c,ve,Te,ce,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Te,B,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function le(e){const c=M(),m=K(),{minR:b,maxR:h,ticks:q}=f(m),v=F(e,c,m.minT,m.maxT,m.tickStep,q),{gx:y,gy:S,gw:C,gh:T,axisFont:O,yLabelX:Y,xLabelY:k,dotR:B}={...c,...v},{minT:N,maxT:re}=m;e.save(),e.translate(Y,S+T/2),e.rotate(-Math.PI/2),e.font=O,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=O,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",y+C/2,k),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let se=N;se<=re;se+=1){const ie=se+273.15,ce=r.thermistorR25*Math.exp(r.thermistorBeta*(1/ie-1/298.15)),pe=x(se,N,re,y,C),ve=_(Math.min(h,ce),b,h,S,T);ve>=S&&ve<=S+T&&(we?e.lineTo(pe,ve):(e.moveTo(pe,ve),we=!0))}e.stroke();const be=r.thermometerTemp,fe=r.currentThermistorR;if(be>=N&&be<=re){const se=x(be,N,re,y,C),ie=_(Math.min(h,fe),b,h,S,T);X(e,c,se,ie,be,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(se,ie,B,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function he(){R.clearRect(0,0,u,j),J.clearRect(0,0,z,H),R.save(),R.translate(A,0),ae(R),r.thermometerType==="liquid"?L(R):r.thermometerType==="resistance"?Z(R):W(R),R.restore(),r.thermometerType==="liquid"?D(J):r.thermometerType==="resistance"?de(J):le(J)}function ge(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const q=a.querySelector("#tl-svg-formula-thermistor-sub");if(q){const v=r.thermometerTemp+273.15;q.innerHTML=`
      ...
      `}}function qe(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:c,cu:m,interval:b}=He(),h=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,q=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,v=a.querySelector("#tl-pane-q10a").classList.contains("active"),y=v?(h-c)/b*100:q,S=v?h:q/100*b+c,T=(O=>130-O/100*80)(y);e.innerHTML=`
    ...
    `}function ke(e){a.querySelector("#tl-bath-temp-display").innerHTML=r.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=r.bathTemp.toFixed(1)+" °C";const c=a.querySelector("#tl-bath-state");r.bathTemp<=0?c.textContent="Melting Ice Bath":r.bathTemp>=100?c.textContent="Boiling Water/Steam":r.bathTemp===150?c.textContent="Hot Cooking Oil":c.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const m=a.querySelector("#tl-alcohol-boiling-warning");r.thermometerType==="liquid"&&r.liquidType==="alcohol"&&r.bathTemp>=78?m.style.display="block":m.style.display="none",r.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=r.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):r.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=r.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=r.currentThermistorR.toFixed(2)+" kΩ",ge()}let Se=null;function _e(e){r.lastTimestamp||(r.lastTimestamp=e);const c=(e-r.lastTimestamp)/1e3;r.lastTimestamp=e;const m=Math.min(c,.1),b=ne(),h=m/b*(r.bathTemp-r.thermometerTemp);r.thermometerTemp+=h,r.currentLength=r.liquidL0+(r.liquidL100-r.liquidL0)/100*r.thermometerTemp,r.currentResistance=r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*r.thermometerTemp;const q=r.thermometerTemp+273.15;r.currentThermistorR=r.thermistorR25*Math.exp(r.thermistorBeta*(1/q-1/298.15)),te(),he(),ke(b),Se=requestAnimationFrame(_e)}function He(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),c=parseFloat(a.querySelector("#tl-input-faulty-cu").value),m=Number.isFinite(e)?e:-1.5,b=Number.isFinite(c)?c:105,h=b-m;return{cf:m,cu:b,interval:h}}function Fe(e){const c=Math.round(e*100)/100;return c>=0?c.toFixed(1):`(${c.toFixed(1)})`}function me(){const{cf:e,cu:c,interval:m}=He(),b=a.querySelector("#tl-val-faulty-interval"),h=a.querySelector("#tl-faulty-error-a"),q=a.querySelector("#tl-faulty-error-b"),v=Math.abs(m)<.01;b.textContent=m.toFixed(1)+" °C";const y=a.querySelector("#tl-svg-formula-faulty-a"),S=a.querySelector("#tl-svg-formula-faulty-b");if(v){h.hidden=!1,h.textContent="C_u must differ from C_f (interval cannot be zero).",q.hidden=!1,q.textContent=h.textContent,y&&(y.innerHTML=""),S&&(S.innerHTML="");return}h.hidden=!0,q.hidden=!0;const C=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,O=(C-e)/m*100,Y=T/100*m+e;y&&(y.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `),S&&(S.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${T.toFixed(1)} &times; ${m.toFixed(1)}</text>
      ...
      `)}function ue(){me(),ye(),Ce(),Ne()}function Ee(e,c){a.querySelector("#"+e).addEventListener("click",()=>{r.bathTemp=c,a.querySelector("#tl-bath-temp-slider").value=c,ue()})}function Ct(){a.querySelectorAll(".tl-tab-btn").forEach(h=>{h.addEventListener("click",()=>{a.querySelectorAll(".tl-tab-btn").forEach(v=>v.classList.remove("active")),a.querySelectorAll(".tl-tab-content").forEach(v=>v.classList.remove("active")),h.classList.add("active");const q=h.getAttribute("data-tl-tab");a.querySelector("#tl-tab-"+q).classList.add("active"),r.thermometerType=q,ue()})}),a.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{r.showLabels=!r.showLabels,a.querySelector("#tl-lbl-toggle-labels").textContent=r.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",h=>{r.bathTemp=parseFloat(h.target.value),ue()}),Ee("tl-btn-preset-ice",0),Ee("tl-btn-preset-room",25),Ee("tl-btn-preset-steam",100),Ee("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{r.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",ue()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{r.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",ue()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",h=>{r.bulbVolume=parseFloat(h.target.value),a.querySelector("#tl-val-bulb-vol").textContent=r.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",h=>{r.wallThickness=parseFloat(h.target.value),a.querySelector("#tl-val-wall-thickness").textContent=r.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-capillary-bore").addEventListener("input",h=>{r.capillaryBore=parseFloat(h.target.value),a.querySelector("#tl-val-capillary-bore").textContent=r.capillaryBore.toFixed(2)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",h=>{r.liquidL0=parseFloat(h.target.value),a.querySelector("#tl-val-liquid-l0").textContent=r.liquidL0.toFixed(1)+" cm",ue()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",h=>{r.liquidL100=parseFloat(h.target.value),a.querySelector("#tl-val-liquid-l100").textContent=r.liquidL100.toFixed(1)+" cm",ue()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",h=>{r.resistanceR0=parseFloat(h.target.value),a.querySelector("#tl-val-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",ue()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",h=>{r.resistanceR100=parseFloat(h.target.value),a.querySelector("#tl-val-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",ue()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",h=>{r.thermistorR25=parseFloat(h.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",ue()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",h=>{r.thermistorBeta=parseFloat(h.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=r.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=r.thermistorBeta+" K",ue()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active"),me()}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",me),a.querySelector("#tl-input-faulty-cu").addEventListener("input",me),a.querySelector("#tl-input-q10a-cm").addEventListener("input",me),a.querySelector("#tl-input-q10b-t").addEventListener("input",me),a.querySelector("#tl-input-q11-r").addEventListener("input",ye);const m=a.querySelector("#tl-input-t-to-l");m&&m.addEventListener("input",ue);const b=a.querySelector("#tl-input-t-to-r");b&&b.addEventListener("input",ue)}if(n.type){const e=a.querySelector(".tl-tabs-container");e&&(e.style.display="none")}return a.querySelectorAll(".tl-tab-btn").forEach(e=>{e.getAttribute("data-tl-tab")===o?e.classList.add("active"):e.classList.remove("active")}),a.querySelectorAll(".tl-tab-content").forEach(e=>{e.id.replace("tl-tab-","")===o?e.classList.add("active"):e.classList.remove("active")}),P(),Ct(),ue(),Se=requestAnimationFrame(_e),a._thermometerLabCleanup=()=>{Se&&cancelAnimationFrame(Se)},a}function fa(t){const n=document.createElement("div");n.className="tool-specific-heat";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"specific-heat/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var u;try{(u=o.contentWindow)==null||u.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function ha(t){const n=document.createElement("div");n.className="tool-thermal-mixing";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"thermal-mixing/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var u;try{(u=o.contentWindow)==null||u.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function pa(t){const n=document.createElement("div");n.className="tool-change-of-state";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"change-of-state/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var u;try{(u=o.contentWindow)==null||u.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function ma(t){const n=document.createElement("div");n.className="tool-heat-transfer";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var u;try{(u=o.contentWindow)==null||u.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}const Re=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],ot=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],ba=[["thermometer","topic.thermometer"]],st=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],ga={liquid:t=>Ge(t,{type:"liquid"}),resistance:t=>Ge(t,{type:"resistance"}),thermistor:t=>Ge(t,{type:"thermistor"}),specificHeat:t=>fa(t),thermalMixing:t=>ha(t),changeOfState:t=>pa(t),heatTransfer:t=>ma(t)};function va(t){return l({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function je(){return oe()==="zh-Hant"?"zhHant":"en"}async function Me(t,n){const o=`./${t}/${n}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function lt(t){return Me("notes",t)}function ya(t){let n="topics",o="liquid",i=null,s={main:null},a=null,r=null;const u=[{value:"all",labelKey:"flashcards.all"},{value:"thermometry",labelKey:"flashcards.deck.thermometry"},{value:"heatInternalEnergy",labelKey:"flashcards.deck.heatInternalEnergy"},{value:"changeOfState",labelKey:"flashcards.deck.changeOfState"},{value:"heatTransfer",labelKey:"flashcards.deck.heatTransfer"}];function j(){if(s.main){if(r==null||r(),r=null,n==="topics"?s.main.innerHTML=z():n==="notes"?s.main.innerHTML=M():n==="tools"?s.main.innerHTML=x():n==="worksheets"?s.main.innerHTML=gt(l,{topics:ba,paperTitleKey:"worksheets.paperTitleHeat"}):n==="flashcards"?r=yt(s.main,{deckOptions:u.map(d=>({value:d.value,label:l(d.labelKey)})),buildDeck:d=>na(d,oe())}):n==="summary"&&(s.main.innerHTML=g()),n==="notes"&&K(),n==="tools"&&_(),n==="worksheets"){const d=mt.filter(f=>ot.includes(f.topic));vt(t,d,l,je,{topicFilter:(f,p)=>p.includes("thermometer")?ot.includes(f.topic):p.includes(f.topic)})}n==="summary"&&E()}}function A(){i==null||i.destroy(),i=bt(t,{subtitleKey:"strand.heat.subtitle",activeSection:n,onSection:d=>{n==="tools"&&d!=="tools"&&a!=null&&a._thermometerLabCleanup&&(a._thermometerLabCleanup(),a=null),n=d,i.updateSection(n),j()},onLang:()=>A()}),s.main=i.main,i.updateSection(n),j()}function z(){return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Re.map(d=>{const f=d.tool?`<button class="btn primary" type="button" data-go-tool="${d.tool}">${l("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${l("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${l(d.titleKey)}</h3>
              ${f}
            </div>`}).join("")}
        </div>
      </section>`}function H(d){const f=d.target.closest("[data-go-tool]");if(f){const R=f.getAttribute("data-go-tool");st.includes(R)?o=R:o="liquid",n="tools",i.updateSection(n),j();return}const p=d.target.closest("[data-go-section]");(p==null?void 0:p.getAttribute("data-go-section"))==="notes"&&(n="notes",i.updateSection(n),j())}function M(){return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
      ...
      </section>`}async function K(){const d=je();for(const f of Re){const p=t.querySelector(`[data-note-card="${f.id}"]`);if(!p)continue;const R=p.querySelector("[data-note-body]"),G=d==="zhHant"?f.fileZh:f.fileEn,J=await lt(G),Q=`./notes/${G}`;J?R.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${f.id}`)}" src="${Q}"></iframe>
          <p style="margin-top:8px"><a href="${Q}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:R.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function x(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${st.map(d=>`<button type="button" data-tool="${d}" class="${o===d?"active":""}">${va(d)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function _(){const d=t.querySelector("[data-tool-list]"),f=t.querySelector("[data-tool-stage]");!d||!f||(d.querySelectorAll("button").forEach(p=>{p.addEventListener("click",()=>{o=p.getAttribute("data-tool"),d.querySelectorAll("button").forEach(R=>R.classList.toggle("active",R.getAttribute("data-tool")===o)),F(f)})}),F(f))}function F(d){d.innerHTML="",a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup();const f=ga[o];f&&(a=f(l),d.appendChild(a))}function g(){return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
      ...
      </section>`}async function E(){const d=je();for(const f of Re){const p=t.querySelector(`[data-summary-card="${f.id}"]`);if(!p)continue;const R=p.querySelector("[data-summary-body]");if(f.id==="thermometer"){const P=await Me("summary","thermometer.webp"),I="./summary/thermometer.webp";P?R.innerHTML=`
          <img class="summary-thumb" src="${I}" alt="${l("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${I}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:R.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}if(f.id==="heatInternalEnergy"){const P=await Me("summary","heat-internal-energy.webp"),I="./summary/heat-internal-energy.webp";P?R.innerHTML=`
          <img class="summary-thumb" src="${I}" alt="${l("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${I}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:R.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}if(f.id==="changeOfState"){const P=await Me("summary","change-of-state.webp"),I="./summary/change-of-state.webp";P?R.innerHTML=`
          <img class="summary-thumb" src="${I}" alt="${l("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${I}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:R.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}if(f.id==="heatTransfer"){const P=await Me("summary","heat-transfer.webp"),I="./summary/heat-transfer.webp";P?R.innerHTML=`
          <img class="summary-thumb" src="${I}" alt="${l("summary.item.heatTransfer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${I}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:R.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const G=d==="zhHant"?f.fileZh:f.fileEn,J=await lt(G),Q=`./notes/${G}`;J?R.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${f.id}`)}" src="${Q}"></iframe>
          <p style="margin-top:8px"><a href="${Q}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:R.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const $=()=>A(),U=d=>H(d);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",U),A(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",U),r==null||r(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const ct={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Lt();Mt();const dt="s3phy_splash_seen",kt={optics:ca,heat:ya};let Le=null,ze=null;function wa(){const t=location.hash.match(/^#\/(\w+)/),n=t==null?void 0:t[1];return n&&Object.prototype.hasOwnProperty.call(kt,n)?n:null}function xa(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function St(t){Le==null||Le(),Le=null,ze==null||ze(),ze=null;const n=document.getElementById("app");if(!n)return;if(n.innerHTML="",!t){location.hash&&xa(),ze=Ht(n);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Le=kt[t](n)??null}function qt(){St(wa())}function ka(){return"./images/uniplus-logo.png"}function Sa(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${ka()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
