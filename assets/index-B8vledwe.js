...
`;function gt(){if(document.getElementById(Oe))return;const t=document.createElement("style");t.id=Oe,t.textContent=ht,document.head.appendChild(t)}function bt(t){gt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
    <div class="rml-head">
  ...
  `;const l=r.querySelector(".rml-canvas"),i=l.getContext("2d"),f=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),R=r.querySelector('[data-rml-disp="inc"]'),F=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,G=380,Z=300,M="#22d3ee",z="bold 17px system-ui, sans-serif";let I=0,j=-140,ae=!0,X=!0,U=!0,V=!0;function Y(h){return h*Math.PI/180}function J(h,d,c,g,A,_=2,H=!1){i.beginPath(),i.lineWidth=_,i.strokeStyle=A,i.setLineDash(H?[6,6]:[]);const y=h+Math.cos(Y(c))*g,x=d+Math.sin(Y(c))*g;return i.moveTo(h,d),i.lineTo(y,x),i.stroke(),i.setLineDash([]),{x:y,y:x}}function ee(h,d,c,g,A,_=14){const H=c-h,y=g-d,x=Math.hypot(H,y);if(x<1e-6)return;const O=H/x,L=y/x,Q=c-O*_,E=g-L*_,ce=.45*_;i.beginPath(),i.fillStyle=A,i.moveTo(c,g),i.lineTo(Q-L*ce,E+O*ce),i.lineTo(Q+L*ce,E-O*ce),i.closePath(),i.fill()}function K(h,d,c,g,A,_=25){i.beginPath(),i.strokeStyle=g,i.lineWidth=2;const H=Math.min(h,d),y=Math.max(h,d);if(i.arc($,G,c,Y(H),Y(y),!1),i.stroke(),A){const x=(H+y)/2,O=$+Math.cos(Y(x))*(c+_),L=G+Math.sin(Y(x))*(c+_);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=g,i.fillText(A,O,L),i.restore()}}function ne(h,d,c,g,A){i.clearRect(0,0,l.width,l.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,G),i.lineTo($+200,G),i.stroke(),i.setLineDash([]),i.lineCap="butt";const _=$+Math.cos(Y(h))*Z,H=G+Math.sin(Y(h))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(_,H),i.lineTo($,G),i.stroke();const y=(_+$)*.5,x=(H+G)*.5,O=Math.hypot($-_,G-H)||1,L=($-_)/O,Q=(G-H)/O;if(ee(y-L*28,x-Q*28,y,x,"#fff",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),_,H-12),i.restore(),ae){const E=J($,G,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),E.x+6,E.y-4),i.restore()}if(X){const E=J($,G,g,Z,"#00e676",2,!1);ee($,G,E.x,E.y,"#00e676",16),i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),E.x,E.y-14),i.restore()}i.save(),i.translate($,G),i.rotate(Y(I)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let E=-190;E<200;E+=15)i.moveTo(E,0),i.lineTo(E-5,8);if(i.stroke(),i.restore(),U){const E=J($,G,d,Z-40,M,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=M,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),E.x+6,E.y-4),i.restore()}if(V){const E=J($,G,c,Z,M,4);ee($,G,E.x,E.y,M,16),Math.abs(I)>.5&&(i.save(),i.font=z,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=M,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),E.x,E.y-14),i.restore())}if(U&&K(h,d,100,"#ffcc00",`i=${A.toFixed(0)}°`,25),U&&V&&K(d,c,100,M,`r=${A.toFixed(0)}°`,25),ae&&U&&Math.abs(I)>.5&&K(-90,d,50,"#ffcc00",`θ=${Math.abs(I)}°`,20),X&&V&&Math.abs(I)>.5){const E=c-g;K(g,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${E.toFixed(0)}°`,40)}}function v(){I=parseFloat(f.value),j=parseFloat(n.value);const h=I>0?"+":"";a.textContent=`${h}${I}°`,R.textContent=`${j}°`;const d=-90,c=Math.abs(j-d),g=d+c,A=-90+I,_=Math.abs(j-A),H=A+_,y=H-g;F.textContent=`${_.toFixed(1)}°`,te.textContent=`${_.toFixed(1)}°`;const x=y>0?"+":"";P.textContent=`${x}${y.toFixed(1)}°`,ne(j,A,H,g,_)}return r.querySelectorAll("[data-rml-toggle]").forEach(h=>{h.addEventListener("click",()=>{const d=h.getAttribute("data-rml-toggle");d==="orig-norm"&&(ae=!ae),d==="orig-ray"&&(X=!X),d==="new-norm"&&(U=!U),d==="new-ray"&&(V=!V),h.classList.toggle("active"),v()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{f.value="0",v()}),f.addEventListener("input",v),n.addEventListener("input",v),v(),r}function vt(t){const r=document.createElement("div");r.className="tool-tir-escape";const l=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;return l.src=`${f}tir-escape/index.html?embed=1`,l.title=t("tools.refractionTir.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(l),r}function yt(t,r={}){const l=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",f=document.createElement("div");f.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",R=a.endsWith("/")?a:`${a}/`;return n.src=`${R}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(l)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",f.appendChild(n),f}function wt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const l=document.createElement("iframe"),i="./",f=i.endsWith("/")?i:`${i}/`;function n(){return`${f}em-spectrum/index.html?lang=${encodeURIComponent(Se())}`}l.src=n(),l.title=t("tools.em.title"),l.setAttribute("loading","lazy"),l.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var R;try{(R=l.contentWindow)==null||R.postMessage({type:"s3phy:lang",lang:Se()},"*")}catch{l.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(l),r}function xt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const l=r.querySelector("[data-r]"),i=r.querySelector("[data-g]"),f=r.querySelector("[data-b]"),n=r.querySelector(".rgb-mixer-canvas"),a=r.querySelector(".rgb-mixer-stage"),R=n.getContext("2d");function F(M){return M.toString(16).padStart(2,"0")}function te(M,z,I){const j=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),X=j/2,U=ae/2,V=Math.min(j,ae)*.34,Y=V*.5,J=Math.sqrt(3)/2;R.clearRect(0,0,j,ae),R.fillStyle="#000",R.fillRect(0,0,j,ae);const ee=[{x:X,y:U-Y,rgb:[255,0,0],val:M},{x:X-Y*J,y:U+Y*.5,rgb:[0,255,0],val:z},{x:X+Y*J,y:U+Y*.5,rgb:[0,0,255],val:I}];R.globalCompositeOperation="lighter",ee.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[v,h,d]=K.rgb,c=R.createRadialGradient(K.x,K.y,0,K.x,K.y,V);c.addColorStop(0,`rgba(${v},${h},${d},${ne})`),c.addColorStop(.65,`rgba(${v},${h},${d},${ne})`),c.addColorStop(.85,`rgba(${v},${h},${d},${ne*.5})`),c.addColorStop(1,`rgba(${v},${h},${d},0)`),R.fillStyle=c,R.beginPath(),R.arc(K.x,K.y,V,0,Math.PI*2),R.fill()}),R.globalCompositeOperation="source-over"}function P(){const M=a.getBoundingClientRect(),z=Math.max(200,Math.min(M.width-8,M.height-8,720)),I=window.devicePixelRatio||1;n.width=z*I,n.height=z*I,n.style.width=`${z}px`,n.style.height=`${z}px`,R.setTransform(I,0,0,I,0,0),te(+l.value,+i.value,+f.value)}function $(){const M=+l.value,z=+i.value,I=+f.value,j=`rgb(${M}, ${z}, ${I})`,ae=`#${F(M)}${F(z)}${F(I)}`;r.querySelector("[data-r-val]").textContent=M,r.querySelector("[data-g-val]").textContent=z,r.querySelector("[data-b-val]").textContent=I,r.querySelector("[data-r-bar]").style.width=`${M/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${z/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${I/255*100}%`,l.style.setProperty("--fill",`${M/255*100}%`),i.style.setProperty("--fill",`${z/255*100}%`),f.style.setProperty("--fill",`${I/255*100}%`);const X=r.querySelector("[data-swatch]");X.style.backgroundColor=j,X.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${j}`),r.querySelector("[data-rgb-text]").textContent=j,r.querySelector("[data-hex-text]").textContent=ae,te(M,z,I)}function G(M,z,I){l.value=M,i.value=z,f.value=I,$()}return[l,i,f].forEach(M=>M.addEventListener("input",$)),r.querySelectorAll(".rgb-presets button").forEach(M=>{M.addEventListener("click",()=>{G(+M.dataset.r,+M.dataset.g,+M.dataset.b)})}),new ResizeObserver(()=>P()).observe(a),requestAnimationFrame(()=>{P(),$()}),r}const qt=["topics","notes","tools","worksheets","flashcards","summary"],St={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function tt(t,{subtitleKey:r,activeSection:l,onSection:i,onLang:f}){t.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),R=t.querySelector("[data-lang]"),F=t.querySelector("[data-strand-back]");let te=l;function P(M){te=M,a.innerHTML=qt.map(z=>`<button type="button" class="${M===z?"active":""}" data-sec="${z}">${s(St[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>i(z.getAttribute("data-sec")))})}function $(){R.innerHTML=`
      <button type="button" data-set-lang="en" class="${Se()==="en"?"active":""}">${s("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${Se()==="zh-Hant"?"active":""}">${s("lang.zhHant")}</button>
    `,R.querySelectorAll("button").forEach(M=>{M.addEventListener("click",()=>{Ze(M.getAttribute("data-set-lang")),f()})})}function G(){t.querySelector("[data-hub-subtitle]").textContent=s(r),F.textContent=s("strand.back"),t.querySelector("[data-hub-footer]").textContent=s("footer.conventions"),t.querySelector(".site-title").textContent=s("app.title")}const Z=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return F.addEventListener("click",Z),P(l),$(),{main:n,updateSection(M){P(M)},refreshLabels(){G(),P(te),$()},destroy(){F.removeEventListener("click",Z)}}}const We=["A","B","C","D"];function Be(t){const r=t.slice();for(let l=r.length-1;l>0;l-=1){const i=Math.floor(Math.random()*(l+1));[r[l],r[i]]=[r[i],r[l]]}return r}function kt(t,r,l){return t.filter(i=>{if(l)return l(i,r);const f=i.topic;return!!(r.includes(f)||r.includes("rotatingMirror")&&f==="reflection"||r.includes("refraction")&&f==="refraction"||r.includes("tir")&&f==="tir"||f==="convex"&&r.includes("convex")||f==="concave"&&r.includes("concave"))})}function Tt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function we(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function at(t,r={}){const l=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=r.paperTitleKey??"worksheets.paperTitle";return`
    ...
    </section>`}function nt(t,r,l,i,f={}){var g,A,_,H;const n={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),R=t.querySelector("[data-ws-preview-area]"),F=t.querySelector("[data-ws-out]"),te=t.querySelector("[data-ws-body]"),P=t.querySelector("[data-ws-paper]"),$=t.querySelector("[data-ws-tabs]"),G=t.querySelector("[data-ws-practice-actions]"),Z=t.querySelector("[data-ws-score]"),M=t.querySelector("[data-ws-score-val]"),z=t.querySelector("[data-ws-summary]"),I=t.querySelector("[data-ws-date-row]"),j=t.querySelector("[data-ws-date-print]"),ae=t.querySelector("[data-ws-date-today]"),X=t.querySelector("[data-ws-date-label]");if(!a||!te)return;function U(){return i()}function V(){n.userAnswers={},n.wrongAttempts={},n.resolved={},Z.hidden=!0,z.hidden=!0}function Y(){return n.items.length>0&&n.items.every((y,x)=>n.resolved[x])}function J(){let y=0;n.items.forEach((O,L)=>{if(!n.resolved[L])return;const Q=O[U()]||O.en;n.userAnswers[L]===Q.a&&(y+=1)}),Object.keys(n.resolved).length>0&&(M.textContent=`${y}/${n.items.length}`,Z.hidden=!1)}function ee(y){n.tab=y,$==null||$.querySelectorAll("[data-ws-tab]").forEach(x=>{x.classList.toggle("active",x.getAttribute("data-ws-tab")===y)}),G&&(G.hidden=y!=="practice"),I&&(I.hidden=y!=="practice"),j&&(j.hidden=!n.dateStr,j.textContent=n.dateStr?`${l("worksheets.date")}: ${n.dateStr}`:""),P==null||P.classList.toggle("practice-mode",y==="practice"),ne()}function K(y,x,O){const L=y[U()]||y.en,Q=We,E=x+1,ce=y.section?`<span class="q-section">${we(y.section)}</span>`:"";if(O==="answer"){const me=L.choices.map((ve,Te)=>`<li class="${Te===L.a?"choice-correct":""}"><strong>${Q[Te]}.</strong> ${we(ve)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${E} ${ce}</h4>
        <p>${we(L.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${l("worksheets.answer")}:</strong> ${Q[L.a]}</p>
        <p class="q-exp"><em>${we(L.exp)}</em></p>
      </div>`}const se=n.userAnswers[x],fe=n.wrongAttempts[x]||0,ge=n.resolved[x],ke=ge&&se===L.a,xe=ge&&se!==L.a;let qe="";fe===1&&!ge?qe=`<p class="q-hint"><strong>${l("worksheets.hint")}:</strong> ${we(L.hint||L.exp)}</p>`:xe&&(qe=`<p class="q-exp"><strong>${l("worksheets.answer")}:</strong> ${Q[L.a]}</p>
        <p class="q-exp q-summary"><em>${we(L.exp)}</em></p>`);const Le=ke?"correct":xe?"incorrect":"",ze=L.choices.map((me,ve)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${x}" value="${ve}" data-ws-q="${x}" data-ws-choice="${ve}"${se===ve?" checked":""}${ge?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${Q[ve]}.</strong> ${we(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${Le}" data-ws-row="${x}">
      <div class="q-header"><h4>Q${E} ${ce}</h4>${ke?'<span class="result-icon">✓</span>':xe?'<span class="result-icon">✗</span>':""}</div>
      <p>${we(L.q)}</p>
      <ol class="choice-list choice-list--radio">${ze}</ol>
      ${qe}
    </div>`}function ne(){n.items.length&&(te.innerHTML=n.items.map((y,x)=>K(y,x,n.tab)).join(""),v())}function v(){n.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(y=>{y.addEventListener("change",()=>{const x=Number(y.getAttribute("data-ws-q"));if(n.resolved[x])return;const O=Number(y.getAttribute("data-ws-choice")),L=n.items[x][U()]||n.items[x].en;n.userAnswers[x]=O,O===L.a?n.resolved[x]=!0:(n.wrongAttempts[x]=(n.wrongAttempts[x]||0)+1,n.wrongAttempts[x]>=2&&(n.resolved[x]=!0)),J(),Y()&&h(),ne()})})}function h(){const y=n.items.length;let x=0,O=0;const L={};n.items.forEach((se,fe)=>{const ge=se[U()]||se.en;if(n.userAnswers[fe]===ge.a)x+=1,(n.wrongAttempts[fe]||0)===0&&(O+=1);else if(n.resolved[fe]){const xe=se.section||se.topic;L[xe]=(L[xe]||0)+1}});const Q=y?Math.round(x/y*100):0;let E=l("worksheets.revisionFair");Q>=90?E=l("worksheets.revisionExcellent"):Q>=70?E=l("worksheets.revisionGood"):Q<50&&(E=l("worksheets.revisionLow"));const ce=Object.entries(L).sort((se,fe)=>fe[1]-se[1]).map(([se,fe])=>`<li>${we(se)} (${fe})</li>`).join("");z.innerHTML=`
      <h4>${l("worksheets.sessionSummary")}</h4>
      <p>${l("worksheets.score")}: <strong>${x}/${y}</strong> (${Q}%)</p>
      <p>${l("worksheets.firstTry")}: <strong>${O}/${y}</strong></p>
      <p>${l("worksheets.revisionSuggestions")}: ${E}</p>
      ${ce?`<p>${l("worksheets.weakSections")}:</p><ul>${ce}</ul>`:""}`,z.hidden=!1}function d(y){const x=U(),O=n.items.map((L,Q)=>{const E=L[x]||L.en,ce=E.choices.map((fe,ge)=>`${We[ge]}. ${fe}`).join("<br/>"),se=y?`<p><b>${l("worksheets.answer")}:</b> ${We[E.a]}<br/><i>${E.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${E.q}<br/>${ce}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${O}</body></html>`}function c(y){const x=d(y),O=new Blob(["\uFEFF",x],{type:"application/msword"}),L=document.createElement("a");L.href=URL.createObjectURL(O),L.download=y?"worksheet-answers.doc":"worksheet.doc",L.click(),URL.revokeObjectURL(L.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),x=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),O=kt(r,x,f.topicFilter),L=Be(O).slice(0,Math.min(y,O.length||1));n.items=L.length?L:Be(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",R.hidden=!1,F.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),G&&(G.hidden=!1),I&&(I.hidden=!1),j&&(j.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const x=y.target.closest("[data-ws-tab]");!x||!n.items.length||ee(x.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=Tt(),X.textContent=`${l("worksheets.date")}: ${n.dateStr}`),j&&(j.hidden=!n.dateStr,j.textContent=n.dateStr?`${l("worksheets.date")}: ${n.dateStr}`:"")}),(g=t.querySelector("[data-ws-word-p]"))==null||g.addEventListener("click",()=>c(!1)),(A=t.querySelector("[data-ws-word-a]"))==null||A.addEventListener("click",()=>c(!0)),(_=t.querySelector("[data-ws-print-p]"))==null||_.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(H=t.querySelector("[data-ws-print-a]"))==null||H.addEventListener("click",()=>{ee("answer"),window.print()})}const Ct=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Mt={rotatingMirror:t=>bt(t),refractionTir:t=>vt(t),lens:(t,r)=>yt(t,{defaultKind:r}),rgbMixer:t=>xt(t),em:t=>wt(t)};function _t(t){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return Se()==="zh-Hant"?"zhHant":"en"}async function it(t,r){const l=`./${t}/${r}`;try{return(await fetch(l,{method:"HEAD"})).ok}catch{return!1}}async function Rt(t){return it("notes",t)}function Lt(t){let r="topics",l="rotatingMirror",i="convex",f=0,n="all",a=!1,R=null,F={main:null};function te(){F.main&&(r==="topics"?F.main.innerHTML=$():r==="notes"?F.main.innerHTML=Z():r==="tools"?F.main.innerHTML=z():r==="worksheets"?F.main.innerHTML=at(s):r==="flashcards"?F.main.innerHTML=ae():r==="summary"&&(F.main.innerHTML=K()),r==="notes"&&M(),r==="tools"&&I(),r==="worksheets"&&nt(t,Je,s,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){R==null||R.destroy(),R=tt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:d=>{r=d,R.updateSection(r),te()},onLang:()=>P()}),F.main=R.main,R.updateSection(r),te()}function $(){const d=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${d.map(([c,g])=>{const A=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,_=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${s(g)}</h3>
              <button class="btn primary" type="button" data-go-tool="${A}"${_?` data-lens-kind="${_}"`:""}>${s("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function G(d){const c=d.target.closest("[data-go-tool]");if(!c)return;r="tools",l=c.getAttribute("data-go-tool");const g=c.getAttribute("data-lens-kind");(g==="convex"||g==="concave")&&(i=g),R.updateSection(r),te()}function Z(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${d.map(c=>{const g=s(`notes.card.${c.key}`);return`
            <div class="card" data-note-card="${c.key}">
              <h3>${g}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function M(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Ae();for(const g of d){const A=t.querySelector(`[data-note-card="${g.key}"]`);if(!A)continue;const _=A.querySelector("[data-note-body]"),H=c==="zhHant"?g.fileZh:g.fileEn,y=await Rt(H),x=`./notes/${H}`;y?_.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${g.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:_.innerHTML=`<p class="lead">${s("notes.missing")}</p>
      ...
      </section>`}function I(){const d=t.querySelector("[data-tool-list]"),c=t.querySelector("[data-tool-stage]");!d||!c||(d.querySelectorAll("button").forEach(g=>{g.addEventListener("click",()=>{l=g.getAttribute("data-tool"),d.querySelectorAll("button").forEach(A=>A.classList.toggle("active",A.getAttribute("data-tool")===l)),j(c)})}),j(c))}function j(d){d.innerHTML="";const c=Mt[l];if(!c)return;const g=l==="lens"?c(s,i):c(s);d.appendChild(g)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(d){return!!(d!=null&&d.front)}function U(d){return`./${String(d).replace(/^\.\//,"")}`}function V(){return et.slice()}function Y(){const d=mt.slice(),c=V(),g=n==="rotatingMirror"?"reflection":n;if(g==="all")return[...d,...c];if(g==="reflection")return d;if(g==="convex"||g==="concave"){const _=c.filter(H=>H.topic==="convex"||H.topic==="concave");return _.length?_:c}if(g==="refractionTir"){const _=c.filter(H=>H.topic==="refraction"||H.topic==="tir");return _.length?_:c}const A=c.filter(_=>_.topic===g);return A.length?A:c}function J(){const d=Y(),c=t.querySelector("[data-flash-progress]");if(!d.length){f=0;const O=t.querySelector("[data-flash-front]"),L=t.querySelector("[data-flip-card]");O&&(O.textContent=""),L&&L.classList.remove("flashcard-surface--image"),c&&(c.hidden=!0,c.textContent="");return}f=Math.max(0,Math.min(f,d.length-1));const g=d[f],A=t.querySelector("[data-flash-front]"),_=t.querySelector("[data-flip-card]"),H=t.querySelector("[data-flash-label]");if(!A||!_)return;if(c&&(c.hidden=!1,c.textContent=s("flashcards.progress").replace("{current}",String(f+1)).replace("{total}",String(d.length))),X(g)){const O=g.back&&g.back!==g.front;_.classList.add("flashcard-surface--image"),H&&(O?(H.hidden=!1,H.textContent=s(a?"flashcards.answer":"flashcards.question")):H.hidden=!0);const L=a&&g.back?g.back:g.front,Q=g.alt||g.title||"";A.innerHTML=`<img src="${U(L)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}_.classList.remove("flashcard-surface--image");const y=Ae(),x=g[y]||g.en;H&&(H.hidden=!1,H.textContent=s(a?"flashcards.answer":"flashcards.question")),A.textContent=a?x.a:x.q}function ee(){n==="rotatingMirror"&&(n="reflection");const d=t.querySelector("[data-flash-deck]");d.value=n,d.addEventListener("change",()=>{n=d.value,f=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",c=>{c.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const c=Y();f=(f-1+c.length)%c.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const c=Y();f=(f+1)%c.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const c=Y();f=Math.floor(Math.random()*c.length),a=!1,J()}),J()}function K(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${d.map(c=>{const g=s(`summary.item.${c.key}`);return`
            <div class="card" data-summary-card="${c.key}">
              <h3>${g}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function ne(){const d=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],c=Ae();for(const g of d){const A=t.querySelector(`[data-summary-card="${g.key}"]`);if(!A)continue;const _=A.querySelector("[data-summary-body]"),H=c==="zhHant"?g.fileZh:g.fileEn,y=await it("summary-pdfs",H),x=`./summary-pdfs/${H}`;y?_.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${g.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:_.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const v=()=>P(),h=d=>G(d);return window.addEventListener("s3phy:lang",v),t.addEventListener("click",h),P(),()=>{window.removeEventListener("s3phy:lang",v),t.removeEventListener("click",h),R==null||R.destroy()}}const je="s3phy-thermometer-lab-css",zt=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Ht(){if(document.getElementById(je))return;const t=document.createElement("style");t.id=je,t.textContent=zt,document.head.appendChild(t)}function Pe(t,r={}){Ht();const l=r.type||"liquid";let i=t("tools.thermometerLab.title"),f=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),f=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),f=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),f=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:l,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},R=460,F=340,te=80,P=800,$=560;function G(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let o=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(o=150),p>145&&(o=200);const m=o<=100?20:25;return{minT:0,maxT:o,tickStep:m}}function M(e,o,p,m,u){return m+(e-o)/(p-o)*u}function z(e,o,p,m,u){return m+u-(e-o)/(p-o)*u}function I(e,o,p,m,u,k){const{gx:b,gy:w,gw:S,gh:T,tickFont:C,axisFont:W,yLabelX:N,xLabelY:q}=o;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of k){const B=z(D.value,D.min,D.max,w,T);e.beginPath(),e.moveTo(b,B),e.lineTo(b+S,B),e.stroke()}for(let D=p;D<=m+.01;D+=u){const B=M(D,p,m,b,S);e.beginPath(),e.moveTo(B,w),e.lineTo(B,w+T),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(b,w),e.lineTo(b,w+T),e.lineTo(b+S,w+T),e.stroke(),e.fillStyle="#e4e4e7",e.font=C,e.textAlign="right",e.textBaseline="middle";for(const D of k){const B=z(D.value,D.min,D.max,w,T);e.fillText(D.label,b-15,B)}e.textAlign="center",e.textBaseline="top";for(let D=p;D<=m+.01;D+=u){const B=M(D,p,m,b,S);e.fillText(`${Math.round(D)}`,B,w+T+10)}return{gx:b,gy:w,gw:S,gh:T,axisFont:W,yLabelX:N,xLabelY:q}}function j(e,o){const p=o-e,m=p<=8?1:p<=14?2:5,u=[],k=Math.ceil(e/m)*m;for(let b=k;b<=o+.001;b+=m)u.push({value:b,label:b%1===0?`${b.toFixed(0)}`:`${b.toFixed(1)}`,min:e,max:o});return u}function ae(){const{maxT:e}=Z(),o=X(0),p=X(e),m=p-o,u=Math.max(1,m*.1),k=Math.max(0,Math.round((o-u)*10)/10),b=Math.round((p+u)*10)/10;return{minL:k,maxL:b}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),o=V(0),p=V(e),m=p-o,u=Math.max(.2,m*.1),k=Math.max(0,o-u),b=p+u,w=m<=2?.5:m<=4?1:2,S=[],T=Math.ceil(k/w)*w;for(let C=T;C<=b+.001;C+=w)S.push({value:C,label:C.toFixed(1),min:k,max:b});return{minR:k,maxR:b,ticks:S}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:o}=e;let p=a.thermistorR25;for(let b=0;b<=o;b+=5){const w=b+273.15,S=a.thermistorR25*Math.exp(a.thermistorBeta*(1/w-1/298.15));p=Math.max(p,S)}p=Math.ceil(p*1.08*10)/10;const m=0,u=p<=12?2:4,k=[];for(let b=0;b<=p+.001;b+=u)k.push({value:b,label:b.toFixed(0),min:m,max:p});return{minR:m,maxR:p,ticks:k}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),v=window.devicePixelRatio||1;J.width=R*v,J.height=F*v,ee.scale(v,v),K.width=P*v,K.height=$*v,ne.scale(v,v);function h(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const d=200,c=11;function g(){const e=Math.pow(a.bulbVolume/d,.3333333333333333);return c*e}function A(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,o=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,m=1.35-a.capillaryBore*.45;return Math.max(.1,o*p*m*e*.15)}function _(e){a.bathTemp<=8&&a.iceCubes.forEach(o=>{o.x+=o.speedX,o.y+=o.speedY,(o.x<65||o.x>175)&&(o.speedX*=-1),(o.y<195||o.y>210)&&(o.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(o=>{o.y-=o.speedY*(1+a.bathTemp/100),o.y<185&&(o.y=265,o.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(o=>{o.y-=o.speedY*(1+(a.bathTemp-80)/40),o.phase+=o.wobbleSpeed,o.x+=Math.sin(o.phase)*.3,o.y<185&&(o.y=260+Math.random()*10,o.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(o=>{o.x+=o.vx,o.y+=o.vy,o.alpha-=.005,(o.alpha<=0||o.y<130)&&(o.x=60+Math.random()*120,o.y=175+Math.random()*5,o.alpha=.2+Math.random()*.4)})}function H(e){let b=59,w=130,S=246;if(a.bathTemp<25){const q=a.bathTemp/25;b=Math.round(180-q*121),w=Math.round(210-q*80),S=Math.round(250-q*4)}else{const q=Math.min(1,(a.bathTemp-25)/125);b=Math.round(59+q*180),w=Math.round(130-q*100),S=Math.round(246-q*190)}if(a.bathTemp>40){const q=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let B=-25;B<=25;B+=6){const ie=q*(12+Math.sin(B*.4+D)*5);e.lineTo(55+130/2+B,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const T=e.createLinearGradient(55,190,55,280);T.addColorStop(0,`rgba(${b}, ${w}, ${S}, 0.25)`),T.addColorStop(1,`rgba(${b}, ${w}, ${S}, 0.55)`),e.fillStyle=T,e.beginPath(),e.moveTo(55,190);const C=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let q=55;q<=185;q+=5){const D=190+Math.sin(q*.15+N)*C;e.lineTo(q,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,o,p,m,u,k,b="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(o,p),e.lineTo(m,u),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(o,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const S=e.measureText(k).width+10,T=16,C=b==="left"?m:m-S,W=u-T/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(C,W,S,T,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(k,C+S/2,W+T/2+.5)}function x(e){const m=g(),u=250+Math.max(0,m-c)*.35,k=u-m-1,b=10+a.wallThickness*8,w=120-b/2,S=120+b/2,T=e.createLinearGradient(w,20,S,20);T.addColorStop(0,"rgba(209, 213, 219, 0.85)"),T.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),T.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),T.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),T.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=T,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,k),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(S,20,S,25,5),e.lineTo(S,k),e.closePath(),e.fill(),e.stroke();const C=e.createRadialGradient(120-m*.2,u-m*.2,m*.1,120,u,m);C.addColorStop(0,"rgba(255, 255, 255, 0.8)"),C.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=C,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,u,m+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(b*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,k-20-8);const N=a.liquidType==="mercury",q=N?"#a1a1aa":"#ef4444",D=N?"#f4f4f5":"#fee2e2",B=210,ie=220,he=(B-40)/ie,ue=B-Math.min(ie,a.thermometerTemp)*he;e.fillStyle=q,e.fillRect(120-W/2,ue,W,k-ue),e.beginPath(),e.ellipse(120,ue,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-W/6,ue,W/3,k-ue);const oe=m*.9,re=e.createRadialGradient(120-oe*.2,u-oe*.2,oe*.1,120,u,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,u,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const pe=B-le*he;e.beginPath(),e.moveTo(w,pe),e.lineTo(w+4,pe),e.stroke(),e.fillText(`${le}°C`,w-22,pe+2.5)}a.showLabels&&(y(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,ue,230,ue-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,u,230,u+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function O(e){const b=e.createLinearGradient(115,20,125,20);b.addColorStop(0,"#71717a"),b.addColorStop(.3,"#f4f4f5"),b.addColorStop(.7,"#d4d4d8"),b.addColorStop(1,"#3f3f46"),e.fillStyle=b,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let N=0;N<8;N++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,T=40,C=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,T,C,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,T+12,C-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",S+C-16,T+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,T+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function L(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const u=20,k=225,b=12,w=120-b/2,S=e.createLinearGradient(w,u,w+b,u);S.addColorStop(0,"rgba(229, 231, 235, 0.4)"),S.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),S.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),S.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=S,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,u,b,k-u,[0,0,3,3]),e.fill(),e.stroke();const T=7,C=e.createRadialGradient(120-T*.2,245-T*.2,T*.1,120,245,T);C.addColorStop(0,"#6b7280"),C.addColorStop(.7,"#1f2937"),C.addColorStop(1,"#09090b"),e.fillStyle=C,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,T,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,q=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,q,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,q-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+q-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,o,p,m,u,k,b,w,S){const{gx:T,gy:C,gw:W,gh:N}=o;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,m),e.lineTo(p,C+N),e.stroke(),e.beginPath(),e.moveTo(p,m),e.lineTo(T,m),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${u.toFixed(1)}${b}`,D=e.measureText(q).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(p-D/2,C+N+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,p,C+N+4),e.textAlign="right",e.textBaseline="middle";const B=`${k.toFixed(2)} ${w}`,ie=e.measureText(B).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(T-ie-2,m-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(B,T-7,m)}function E(e){const o=G(),{minL:p,maxL:m}=ae(),{minT:u,maxT:k,tickStep:b}=Z(),w=j(p,m),S=I(e,o,u,k,b,w),{gx:T,gy:C,gw:W,gh:N,axisFont:q,yLabelX:D,xLabelY:B,dotR:ie}={...o,...S};e.save(),e.translate(D,C+N/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",T+W/2,B);const ye=k,he=M(0,u,k,T,W),ue=z(X(0),p,m,C,N),oe=M(ye,u,k,T,W),re=z(X(ye),p,m,C,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(he,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentLength;if(le>=u&&le<=k){const be=M(le,u,k,T,W),Ce=z(pe,p,m,C,N);Q(e,o,be,Ce,le,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(be,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ce(e){const o=G(),{minR:p,maxR:m,ticks:u}=U(),k=Z(),b=I(e,o,k.minT,k.maxT,k.tickStep,u),{gx:w,gy:S,gw:T,gh:C,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...b};e.save(),e.translate(N,S+C/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+T/2,q);const{minT:B,maxT:ie}=k,ye=ie,he=M(0,B,ie,w,T),ue=z(V(0),p,m,S,C),oe=M(ye,B,ie,w,T),re=z(V(ye),p,m,S,C);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(he,ue),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,pe=a.currentResistance;if(le>=B&&le<=ie){const be=M(le,B,ie,w,T),Ce=z(pe,p,m,S,C);Q(e,o,be,Ce,le,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(be,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const o=G(),p=Z(),{minR:m,maxR:u,ticks:k}=Y(p),b=I(e,o,p.minT,p.maxT,p.tickStep,k),{gx:w,gy:S,gw:T,gh:C,axisFont:W,yLabelX:N,xLabelY:q,dotR:D}={...o,...b},{minT:B,maxT:ie}=p;e.save(),e.translate(N,S+C/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+T/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let ye=!1;for(let oe=B;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),pe=M(oe,B,ie,w,T),be=z(Math.min(u,le),m,u,S,C);be>=S&&be<=S+C&&(ye?e.lineTo(pe,be):(e.moveTo(pe,be),ye=!0))}e.stroke();const he=a.thermometerTemp,ue=a.currentThermistorR;if(he>=B&&he<=ie){const oe=M(he,B,ie,w,T),re=z(Math.min(u,ue),m,u,S,C);Q(e,o,oe,re,he,ue,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function fe(){ee.clearRect(0,0,R,F),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),H(ee),a.thermometerType==="liquid"?x(ee):a.thermometerType==="resistance"?O(ee):L(ee),ee.restore(),a.thermometerType==="liquid"?E(ne):a.thermometerType==="resistance"?ce(ne):se(ne)}function ge(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const o=n.querySelector("#tl-svg-formula-liquid-sub");if(o){const b=a.liquidL100-a.liquidL0,w=a.currentLength-a.liquidL0;o.innerHTML=`
      ...
      `}}function ke(){const e=n.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:o,cu:p,interval:m}=ze(),u=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,k=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,b=n.querySelector("#tl-pane-q10a").classList.contains("active"),w=b?(u-o)/m*100:k,S=b?u:k/100*m+o,C=(W=>130-W/100*80)(w);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Current Point -->
          <text x="65" y="${C+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${w.toFixed(1)}°C</text>
    ...
    `}function xe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const o=n.querySelector("#tl-bath-state");a.bathTemp<=0?o.textContent="Melting Ice Bath":a.bathTemp>=100?o.textContent="Boiling Water/Steam":a.bathTemp===150?o.textContent="Hot Cooking Oil":o.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let qe=null;function Le(e){a.lastTimestamp||(a.lastTimestamp=e);const o=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(o,.1),m=A(),u=p/m*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=u,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const k=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/k-1/298.15)),_(),fe(),xe(m),qe=requestAnimationFrame(Le)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),o=parseFloat(n.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,m=Number.isFinite(o)?o:105,u=m-p;return{cf:p,cu:m,interval:u}}function He(e){const o=Math.round(e*100)/100;return o>=0?o.toFixed(1):`(${o.toFixed(1)})`}function me(){const{cf:e,cu:o,interval:p}=ze(),m=n.querySelector("#tl-val-faulty-interval"),u=n.querySelector("#tl-faulty-error-a"),k=n.querySelector("#tl-faulty-error-b"),b=Math.abs(p)<.01;m.textContent=p.toFixed(1)+" °C";const w=n.querySelector("#tl-svg-formula-faulty-a"),S=n.querySelector("#tl-svg-formula-faulty-b");if(b){u.hidden=!1,u.textContent="C_u must differ from C_f (interval cannot be zero).",k.hidden=!1,k.textContent=u.textContent,w&&(w.innerHTML=""),S&&(S.innerHTML="");return}u.hidden=!0,k.hidden=!0;const T=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,C=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(T-e)/p*100,N=C/100*p+e;w&&(w.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${T.toFixed(1)} - ${He(e)}</text>
      ...
      `),ke()}function ve(){const e=parseFloat(n.querySelector("#tl-input-q11-r").value)||0,o=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100,p=n.querySelector("#tl-svg-formula-resistance-solver");p&&(p.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function Te(){const e=a.thermometerTemp,o=a.liquidL100-a.liquidL0,p=a.liquidL0+o/100*e,m=n.querySelector("#tl-svg-formula-t-to-l");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${a.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${o.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${p.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function Ge(){const e=a.thermometerTemp,o=a.resistanceR100-a.resistanceR0,p=a.resistanceR0+o/100*e,m=n.querySelector("#tl-svg-formula-t-to-r");m&&(m.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      </section>`}async function M(){const v=Ee();for(const h of Me){const d=t.querySelector(`[data-note-card="${h.id}"]`);if(!d)continue;const c=d.querySelector("[data-note-body]"),g=v==="zhHant"?h.fileZh:h.fileEn,A=await Ne(g),_=`./notes/${g}`;A?c.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${h.id}`)}" src="${_}"></iframe>
      ...
      </section>`}function I(){const v=t.querySelector("[data-tool-list]"),h=t.querySelector("[data-tool-stage]");!v||!h||(v.querySelectorAll("button").forEach(d=>{d.addEventListener("click",()=>{l=d.getAttribute("data-tool"),v.querySelectorAll("button").forEach(c=>c.classList.toggle("active",c.getAttribute("data-tool")===l)),j(h)})}),j(h))}function j(v){v.innerHTML="",F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup();const h=At[l];h&&(F=h(s),v.appendChild(F))}function ae(){return`
      <section class="panel">
        <h2>${s("flashcards.title")}</h2>
        <p class="lead">${s("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}async function ee(){const v=Ee();for(const h of Me){const d=t.querySelector(`[data-summary-card="${h.id}"]`);if(!d)continue;const c=d.querySelector("[data-summary-body]"),g=v==="zhHant"?h.fileZh:h.fileEn,A=await Ne(g),_=`./notes/${g}`;A?c.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${h.id}`)}" src="${_}"></iframe>
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const K=()=>P(),ne=v=>G(v);return window.addEventListener("s3phy:lang",K),t.addEventListener("click",ne),P(),()=>{window.removeEventListener("s3phy:lang",K),t.removeEventListener("click",ne),F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup(),a==null||a.destroy()}}const Ve={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};ut();const Ye="s3phy_splash_seen",rt={optics:Lt,heat:It};let _e=null,Re=null;function Wt(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(rt,r)?r:null}function Pt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function ot(t){_e==null||_e(),_e=null,Re==null||Re(),Re=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&Pt(),Re=pt(r);return}const l=`#/${t}`;if(location.hash!==l){location.hash=l;return}_e=rt[t](r)??null}function st(){ot(Wt())}function Dt(){return"./images/uniplus-logo.png"}function Gt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
  ...
  `,t}function Ot(t,r){const l=[...Ve.en,...Ve.zhHant],i=()=>{if(!t.parentElement)return;const f=document.createElement("div");f.className="splash-danmaku-item",f.textContent=l[Math.floor(Math.random()*l.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,R=Math.random()*12+10;f.style.top=`${n}%`,f.style.fontSize=`${a}rem`,f.style.animationDuration=`${R}s`,r.appendChild(f),f.addEventListener("animationend",()=>f.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let f=0;f<4;f+=1)window.setTimeout(i,f*1e3)}function Bt(t){const r=t.querySelector("#splashLogoWrap"),l=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{l==null||l.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),l&&Ot(t,l)},1600)}function Ue(){st()}function jt(){let t=!1;try{t=sessionStorage.getItem(Ye)==="1"}catch{}if(t){Ue();return}const r=Gt();document.body.insertBefore(r,document.body.firstChild),Bt(r);const l=r.querySelector("#splashStart"),i=()=>{r.remove(),Ue()};l.addEventListener("click",()=>{try{sessionStorage.setItem(Ye,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",st);window.addEventListener("s3phy:strand",t=>{ot(t.detail??null)});jt();
