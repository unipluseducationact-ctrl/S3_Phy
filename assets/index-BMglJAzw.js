(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))r(d);new MutationObserver(d=>{for(const n of d)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function o(d){const n={};return d.integrity&&(n.integrity=d.integrity),d.referrerPolicy&&(n.referrerPolicy=d.referrerPolicy),d.crossOrigin==="use-credentials"?n.credentials="include":d.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(d){if(d.ep)return;d.ep=!0;const n=o(d);fetch(d.href,n)}})();const Ee={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Flip cards to revise key terms. Reflection, Refraction, TIR, Convex lens, and Concave lens use picture cards from your flashcard sets.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.shuffle":"Shuffle","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF or image). Preview below or open in a new tab.","summary.viewImage":"Open full image","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.specificHeat.title":"Specific Heat Capacity Lab","tools.thermalMixing.title":"Thermal Mixing Lab","tools.changeOfState.title":"Change of State Lab","tools.heatTransfer.title":"Heat Transfer Laboratory","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","tools.thermometerLab.liquid.title":"Liquid-in-Glass Thermometer","tools.thermometerLab.liquid.subtitle":"Explore the effects of bulb volume, capillary bore, and liquid type on sensitivity and response time.","tools.thermometerLab.resistance.title":"Platinum Resistance Thermometer","tools.thermometerLab.resistance.subtitle":"Investigate how platinum resistance varies linearly with temperature and solve calibration problems.","tools.thermometerLab.thermistor.title":"NTC Thermistor","tools.thermometerLab.thermistor.subtitle":"Study the non-linear resistance-temperature relationship of NTC thermistors and live beta calculations.","tools.thermometerLab.labels.show":"Show Structure Labels","tools.thermometerLab.labels.hide":"Hide Structure Labels","tools.thermometerLab.labels.thinWall":"Thin glass wall (fast heat transfer)","tools.thermometerLab.labels.largeBulb":"Large bulb (contains more liquid, increases sensitivity)","tools.thermometerLab.labels.narrowBore":"Narrow capillary bore (liquid rises higher, increases sensitivity)","tools.thermometerLab.labels.meniscus":"Meniscus (reading point)","tools.thermometerLab.labels.platinumCoil":"Platinum coil (resistance increases linearly with temp)","tools.thermometerLab.labels.metalSheath":"Metal sheath (protects & conducts heat quickly)","tools.thermometerLab.labels.semiconductorBead":"Semiconductor bead (resistance decreases exponentially with temp)","tools.thermometerLab.labels.leads":"Connecting leads","tools.thermometerLab.faulty.dualScale":"Dual-Scale Comparison Diagram","tools.thermometerLab.faulty.trueScale":"True Scale (°C)","tools.thermometerLab.faulty.faultyScale":"Faulty Scale (°C)","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},ht={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"翻卡複習重要詞彙。反射、折射、全內反射、凸透鏡與凹透鏡課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.shuffle":"洗牌","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF 或圖片）。可於下方預覽，或新分頁開啟。","summary.viewImage":"開啟完整圖片","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","tools.thermometerLab.title":"溫度計與校準實驗室","tools.specificHeat.title":"比熱容量實驗室","tools.thermalMixing.title":"熱混合實驗室","tools.changeOfState.title":"物態變化實驗室","tools.heatTransfer.title":"熱的轉移實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","tools.thermometerLab.liquid.title":"液體玻璃溫度計","tools.thermometerLab.liquid.subtitle":"探索玻璃泡容積、毛細管內外徑和液體種類對靉敏度及反應時間的影響。","tools.thermometerLab.resistance.title":"鈐電阻溫度計","tools.thermometerLab.resistance.subtitle":"研究鈐電阻如何隨溫度呈線性變化，並解決溫度校準問題。","tools.thermometerLab.thermistor.title":"NTC 熱敏電阻溫度計","tools.thermometerLab.thermistor.subtitle":"學習負溫度係數（NTC）熱敏電阻的非線性電阻-溫度關係，並進行實時 Beta 計算。","tools.thermometerLab.labels.show":"顯示結構標註","tools.thermometerLab.labels.hide":"隱藏結構標註","tools.thermometerLab.labels.thinWall":"薄玻璃壁 (快速傳熱)","tools.thermometerLab.labels.largeBulb":"大玻璃泡 (容納更多液體，提高靉敏度)","tools.thermometerLab.labels.narrowBore":"細毛細管 (液柱升得更高，提高靉敏度)","tools.thermometerLab.labels.meniscus":"彎月面 (讀數位置)","tools.thermometerLab.labels.platinumCoil":"鈐絲線圈 (電阻隨溫度線性增加)","tools.thermometerLab.labels.metalSheath":"金屬保護套 (保護並快速導熱)","tools.thermometerLab.labels.semiconductorBead":"半導體小珠 (電阻隨溫度指數級減少)","tools.thermometerLab.labels.leads":"連接導線","tools.thermometerLab.faulty.dualScale":"雙刻度對比示意圖","tools.thermometerLab.faulty.trueScale":"標準溫標 (°C)","tools.thermometerLab.faulty.faultyScale":"偏差溫標 (°C)","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},at="s3phy.lang",nt={en:Ee,"zh-Hant":ht};let Ie="en";function mt(){try{const t=localStorage.getItem(at);if(t==="zh-Hant"||t==="en")return t}catch{}return"en"}function bt(){Ie=mt()}function rt(t){if(nt[t]){Ie=t;try{localStorage.setItem(at,t)}catch{}document.documentElement.lang=t==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function ce(){return Ie}function l(t){const i=nt[Ie]||Ee;return Object.prototype.hasOwnProperty.call(i,t)?i[t]:Object.prototype.hasOwnProperty.call(Ee,t)?Ee[t]:t}const gt=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function vt(t){function i(){t.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${gt.map(({id:d,titleKey:n,descKey:a})=>`
            <div class="card">
              <h3>${l(n)}</h3>
              <p>${l(a)}</p>
...
`;function wt(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=yt,document.head.appendChild(t)}function xt(t){wt();const i=document.createElement("div");i.className="rml",i.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=i.querySelector(".rml-canvas"),r=o.getContext("2d"),d=i.querySelector("[data-rml-rot]"),n=i.querySelector("[data-rml-inc]"),a=i.querySelector('[data-rml-disp="rot"]'),q=i.querySelector('[data-rml-disp="inc"]'),F=i.querySelector('[data-rml-val="i"]'),te=i.querySelector('[data-rml-val="r"]'),P=i.querySelector('[data-rml-val="shift"]'),$=350,G=380,Z=300,L="#22d3ee",z="bold 17px system-ui, sans-serif";let E=0,B=-140,ae=!0,X=!0,U=!0,V=!0;function Y(m){return m*Math.PI/180}function J(m,u,c,b,H,M=2,I=!1){r.beginPath(),r.lineWidth=M,r.strokeStyle=H,r.setLineDash(I?[6,6]:[]);const y=m+Math.cos(Y(c))*b,x=u+Math.sin(Y(c))*b;return r.moveTo(m,u),r.lineTo(y,x),r.stroke(),r.setLineDash([]),{x:y,y:x}}function ee(m,u,c,b,H,M=14){const I=c-m,y=b-u,x=Math.hypot(I,y);if(x<1e-6)return;const D=I/x,_=y/x,Q=c-D*M,A=b-_*M,de=.45*M;r.beginPath(),r.fillStyle=H,r.moveTo(c,b),r.lineTo(Q-_*de,A+D*de),r.lineTo(Q+_*de,A-D*de),r.closePath(),r.fill()}function K(m,u,c,b,H,M=25){r.beginPath(),r.strokeStyle=b,r.lineWidth=2;const I=Math.min(m,u),y=Math.max(m,u);if(r.arc($,G,c,Y(I),Y(y),!1),r.stroke(),H){const x=(I+y)/2,D=$+Math.cos(Y(x))*(c+M),_=G+Math.sin(Y(x))*(c+M);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillStyle=b,r.fillText(H,D,_),r.restore()}}function ne(m,u,c,b,H){r.clearRect(0,0,o.width,o.height),r.beginPath(),r.setLineDash([10,6]),r.strokeStyle="rgba(255, 204, 0, 0.45)",r.lineWidth=3,r.lineCap="round",r.moveTo($-200,G),r.lineTo($+200,G),r.stroke(),r.setLineDash([]),r.lineCap="butt";const M=$+Math.cos(Y(m))*Z,I=G+Math.sin(Y(m))*Z;r.beginPath(),r.lineWidth=3,r.strokeStyle="#fff",r.moveTo(M,I),r.lineTo($,G),r.stroke();const y=(M+$)*.5,x=(I+G)*.5,D=Math.hypot($-M,G-I)||1,_=($-M)/D,Q=(G-I)/D;if(ee(y-_*28,x-Q*28,y,x,"#fff",16),r.save(),r.font=z,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#fff",r.fillText(t("tools.rotatingMirror.canvas.incident"),M,I-12),r.restore(),ae){const A=J($,G,-90,Z-60,"#00e676",1,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(t("tools.rotatingMirror.canvas.n"),A.x+6,A.y-4),r.restore()}if(X){const A=J($,G,b,Z,"#00e676",2,!1);ee($,G,A.x,A.y,"#00e676",16),r.save(),r.font=z,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(t("tools.rotatingMirror.canvas.originalReflected"),A.x,A.y-14),r.restore()}r.save(),r.translate($,G),r.rotate(Y(E)),r.beginPath(),r.lineWidth=6,r.strokeStyle="#ffcc00",r.lineCap="round",r.moveTo(-200,0),r.lineTo(200,0),r.stroke(),r.beginPath(),r.lineWidth=1,r.strokeStyle="#666";for(let A=-190;A<200;A+=15)r.moveTo(A,0),r.lineTo(A-5,8);if(r.stroke(),r.restore(),U){const A=J($,G,u,Z-40,L,2,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle=L,r.fillText(t("tools.rotatingMirror.canvas.nPrime"),A.x+6,A.y-4),r.restore()}if(V){const A=J($,G,c,Z,L,4);ee($,G,A.x,A.y,L,16),Math.abs(E)>.5&&(r.save(),r.font=z,r.textAlign="center",r.textBaseline="bottom",r.fillStyle=L,r.fillText(t("tools.rotatingMirror.canvas.newReflected"),A.x,A.y-14),r.restore())}if(U&&K(m,u,100,"#ffcc00",`i=${H.toFixed(0)}°`,25),U&&V&&K(u,c,100,L,`r=${H.toFixed(0)}°`,25),ae&&U&&Math.abs(E)>.5&&K(-90,u,50,"#ffcc00",`θ=${Math.abs(E)}°`,20),X&&V&&Math.abs(E)>.5){const A=c-b;K(b,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${A.toFixed(0)}°`,40)}}function v(){E=parseFloat(d.value),B=parseFloat(n.value);const m=E>0?"+":"";a.textContent=`${m}${E}°`,q.textContent=`${B}°`;const u=-90,c=Math.abs(B-u),b=u+c,H=-90+E,M=Math.abs(B-H),I=H+M,y=I-b;F.textContent=`${M.toFixed(1)}°`,te.textContent=`${M.toFixed(1)}°`;const x=y>0?"+":"";P.textContent=`${x}${y.toFixed(1)}°`,ne(B,H,I,b,M)}return i.querySelectorAll("[data-rml-toggle]").forEach(m=>{m.addEventListener("click",()=>{const u=m.getAttribute("data-rml-toggle");u==="orig-norm"&&(ae=!ae),u==="orig-ray"&&(X=!X),u==="new-norm"&&(U=!U),u==="new-ray"&&(V=!V),m.classList.toggle("active"),v()})}),i.querySelector("[data-rml-reset]").addEventListener("click",()=>{d.value="0",v()}),d.addEventListener("input",v),n.addEventListener("input",v),v(),i}function qt(t){const i=document.createElement("div");i.className="tool-tir-escape";const o=document.createElement("iframe"),r="./",d=r.endsWith("/")?r:`${r}/`;return o.src=`${d}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",i.appendChild(o),i}function kt(t,i={}){const o=i.defaultKind==="concave"?"concave":"convex",r="tools.lens.title",d=document.createElement("div");d.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",q=a.endsWith("/")?a:`${a}/`;return n.src=`${q}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,n.title=t(r),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",d.appendChild(n),d}function St(t){const i=document.createElement("div");i.className="tool-em-spectrum";const o=document.createElement("iframe"),r="./",d=r.endsWith("/")?r:`${r}/`;function n(){return`${d}em-spectrum/index.html?lang=${encodeURIComponent(ce())}`}o.src=n(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),i._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),i.appendChild(o),i}function Tt(t){const i=document.createElement("div");i.className="rgb-mixer",i.innerHTML=`
  ...
  `;const o=i.querySelector("[data-r]"),r=i.querySelector("[data-g]"),d=i.querySelector("[data-b]"),n=i.querySelector(".rgb-mixer-canvas"),a=i.querySelector(".rgb-mixer-stage"),q=n.getContext("2d");function F(L){return L.toString(16).padStart(2,"0")}function te(L,z,E){const B=n.width/(window.devicePixelRatio||1),ae=n.height/(window.devicePixelRatio||1),X=B/2,U=ae/2,V=Math.min(B,ae)*.34,Y=V*.5,J=Math.sqrt(3)/2;q.clearRect(0,0,B,ae),q.fillStyle="#000",q.fillRect(0,0,B,ae);const ee=[{x:X,y:U-Y,rgb:[255,0,0],val:L},{x:X-Y*J,y:U+Y*.5,rgb:[0,255,0],val:z},{x:X+Y*J,y:U+Y*.5,rgb:[0,0,255],val:E}];q.globalCompositeOperation="lighter",ee.forEach(K=>{if(K.val<=0)return;const ne=K.val/255,[v,m,u]=K.rgb,c=q.createRadialGradient(K.x,K.y,0,K.x,K.y,V);c.addColorStop(0,`rgba(${v},${m},${u},${ne})`),c.addColorStop(.65,`rgba(${v},${m},${u},${ne})`),c.addColorStop(.85,`rgba(${v},${m},${u},${ne*.5})`),c.addColorStop(1,`rgba(${v},${m},${u},0)`),q.fillStyle=c,q.beginPath(),q.arc(K.x,K.y,V,0,Math.PI*2),q.fill()}),q.globalCompositeOperation="source-over"}function P(){const L=a.getBoundingClientRect(),z=Math.max(200,Math.min(L.width-8,L.height-8,720)),E=window.devicePixelRatio||1;n.width=z*E,n.height=z*E,n.style.width=`${z}px`,n.style.height=`${z}px`,q.setTransform(E,0,0,E,0,0),te(+o.value,+r.value,+d.value)}function $(){const L=+o.value,z=+r.value,E=+d.value,B=`rgb(${L}, ${z}, ${E})`,ae=`#${F(L)}${F(z)}${F(E)}`;i.querySelector("[data-r-val]").textContent=L,i.querySelector("[data-g-val]").textContent=z,i.querySelector("[data-b-val]").textContent=E,i.querySelector("[data-r-bar]").style.width=`${L/255*100}%`,i.querySelector("[data-g-bar]").style.width=`${z/255*100}%`,i.querySelector("[data-b-bar]").style.width=`${E/255*100}%`,o.style.setProperty("--fill",`${L/255*100}%`),r.style.setProperty("--fill",`${z/255*100}%`),d.style.setProperty("--fill",`${E/255*100}%`);const X=i.querySelector("[data-swatch]");X.style.backgroundColor=B,X.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${B}`),i.querySelector("[data-rgb-text]").textContent=B,i.querySelector("[data-hex-text]").textContent=ae,te(L,z,E)}function G(L,z,E){o.value=L,r.value=z,d.value=E,$()}return[o,r,d].forEach(L=>L.addEventListener("input",$)),i.querySelectorAll(".rgb-presets button").forEach(L=>{L.addEventListener("click",()=>{G(+L.dataset.r,+L.dataset.g,+L.dataset.b)})}),new ResizeObserver(()=>P()).observe(a),requestAnimationFrame(()=>{P(),$()}),i}const Ct=["topics","notes","tools","worksheets","flashcards","summary"],Rt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function st(t,{subtitleKey:i,activeSection:o,onSection:r,onLang:d}){t.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),q=t.querySelector("[data-lang]"),F=t.querySelector("[data-strand-back]");let te=o;function P(L){te=L,a.innerHTML=Ct.map(z=>`<button type="button" class="${L===z?"active":""}" data-sec="${z}">${l(Rt[z])}</button>`).join(""),a.querySelectorAll("button").forEach(z=>{z.addEventListener("click",()=>r(z.getAttribute("data-sec")))})}function $(){q.innerHTML=`
      <button type="button" data-set-lang="en" class="${ce()==="en"?"active":""}">${l("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${ce()==="zh-Hant"?"active":""}">${l("lang.zhHant")}</button>
    `,q.querySelectorAll("button").forEach(L=>{L.addEventListener("click",()=>{rt(L.getAttribute("data-set-lang")),d()})})}function G(){t.querySelector("[data-hub-subtitle]").textContent=l(i),F.textContent=l("strand.back"),t.querySelector("[data-hub-footer]").textContent=l("footer.conventions"),t.querySelector(".site-title").textContent=l("app.title")}const Z=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return F.addEventListener("click",Z),P(o),$(),{main:n,updateSection(L){P(L)},refreshLabels(){G(),P(te),$()},destroy(){F.removeEventListener("click",Z)}}}const We=["A","B","C","D"];function Ue(t){const i=t.slice();for(let o=i.length-1;o>0;o-=1){const r=Math.floor(Math.random()*(o+1));[i[o],i[r]]=[i[r],i[o]]}return i}function Lt(t,i,o){return t.filter(r=>{if(o)return o(r,i);const d=r.topic;return!!(i.includes(d)||i.includes("rotatingMirror")&&d==="reflection"||i.includes("refraction")&&d==="refraction"||i.includes("tir")&&d==="tir"||d==="convex"&&i.includes("convex")||d==="concave"&&i.includes("concave"))})}function Mt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function lt(t,i={}){const o=i.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],r=i.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
      ...
      <div class="q-header"><h4>Q${A} ${de}</h4>${Se?'<span class="result-icon">✓</span>':qe?'<span class="result-icon">✗</span>':""}</div>
      <p>${xe(_.q)}</p>
      <ol class="choice-list choice-list--radio">${ze}</ol>
      ${ke}
    </div>`}function ne(){n.items.length&&(te.innerHTML=n.items.map((y,x)=>K(y,x,n.tab)).join(""),v())}function v(){n.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(y=>{y.addEventListener("change",()=>{const x=Number(y.getAttribute("data-ws-q"));if(n.resolved[x])return;const D=Number(y.getAttribute("data-ws-choice")),_=n.items[x][U()]||n.items[x].en;n.userAnswers[x]=D,D===_.a?n.resolved[x]=!0:(n.wrongAttempts[x]=(n.wrongAttempts[x]||0)+1,n.wrongAttempts[x]>=2&&(n.resolved[x]=!0)),J(),Y()&&m(),ne()})})}function m(){const y=n.items.length;let x=0,D=0;const _={};n.items.forEach((se,pe)=>{const ge=se[U()]||se.en;if(n.userAnswers[pe]===ge.a)x+=1,(n.wrongAttempts[pe]||0)===0&&(D+=1);else if(n.resolved[pe]){const qe=se.section||se.topic;_[qe]=(_[qe]||0)+1}});const Q=y?Math.round(x/y*100):0;let A=o("worksheets.revisionFair");Q>=90?A=o("worksheets.revisionExcellent"):Q>=70?A=o("worksheets.revisionGood"):Q<50&&(A=o("worksheets.revisionLow"));const de=Object.entries(_).sort((se,pe)=>pe[1]-se[1]).map(([se,pe])=>`<li>${xe(se)} (${pe})</li>`).join("");z.innerHTML=`
...
${D}</body></html>`}function c(y){const x=u(y),D=new Blob(["\uFEFF",x],{type:"application/msword"}),_=document.createElement("a");_.href=URL.createObjectURL(D),_.download=y?"worksheet-answers.doc":"worksheet.doc",_.click(),URL.revokeObjectURL(_.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),x=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),D=Lt(i,x,d.topicFilter),_=Ue(D).slice(0,Math.min(y,D.length||1));n.items=_.length?_:Ue(i).slice(0,Math.min(y,i.length)),V(),n.tab="practice",n.dateStr="",q.hidden=!1,F.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),G&&(G.hidden=!1),E&&(E.hidden=!1),B&&(B.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const x=y.target.closest("[data-ws-tab]");!x||!n.items.length||ee(x.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=Mt(),X.textContent=`${o("worksheets.date")}: ${n.dateStr}`),B&&(B.hidden=!n.dateStr,B.textContent=n.dateStr?`${o("worksheets.date")}: ${n.dateStr}`:"")}),(b=t.querySelector("[data-ws-word-p]"))==null||b.addEventListener("click",()=>c(!1)),(H=t.querySelector("[data-ws-word-a]"))==null||H.addEventListener("click",()=>c(!0)),(M=t.querySelector("[data-ws-print-p]"))==null||M.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(I=t.querySelector("[data-ws-print-a]"))==null||I.addEventListener("click",()=>{ee("answer"),window.print()})}const _t=["rotatingMirror","refractionTir","lens","rgbMixer","em"],zt={rotatingMirror:t=>xt(t),refractionTir:t=>qt(t),lens:(t,i)=>kt(t,{defaultKind:i}),rgbMixer:t=>Tt(t),em:t=>St(t)};function Ht(t){return l({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return ce()==="zh-Hant"?"zhHant":"en"}async function Oe(t,i){const o=`./${t}/${i}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function $t(t){return Oe("notes",t)}function At(t){let i="topics",o="rotatingMirror",r="convex",d=0,n="all",a=!1,q=null,F={main:null};function te(){F.main&&(i==="topics"?F.main.innerHTML=$():i==="notes"?F.main.innerHTML=Z():i==="tools"?F.main.innerHTML=z():i==="worksheets"?F.main.innerHTML=lt(l):i==="flashcards"?F.main.innerHTML=ae():i==="summary"&&(F.main.innerHTML=K()),i==="notes"&&L(),i==="tools"&&E(),i==="worksheets"&&ct(t,it,l,Ae),i==="flashcards"&&ee(),i==="summary"&&ne())}function P(){q==null||q.destroy(),q=st(t,{subtitleKey:"strand.optics.subtitle",activeSection:i,onSection:u=>{i=u,q.updateSection(i),te()},onLang:()=>P()}),F.main=q.main,q.updateSection(i),te()}function $(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([c,b])=>{const H=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,M=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${l(b)}</h3>
              <button class="btn primary" type="button" data-go-tool="${H}"${M?` data-lens-kind="${M}"`:""}>${l("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function G(u){const c=u.target.closest("[data-go-tool]");if(!c)return;i="tools",o=c.getAttribute("data-go-tool");const b=c.getAttribute("data-lens-kind");(b==="convex"||b==="concave")&&(r=b),q.updateSection(i),te()}function Z(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${u.map(c=>{const b=l(`notes.card.${c.key}`);return`
            <div class="card" data-note-card="${c.key}">
              <h3>${b}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function L(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Ae();for(const b of u){const H=t.querySelector(`[data-note-card="${b.key}"]`);if(!H)continue;const M=H.querySelector("[data-note-body]"),I=c==="zhHant"?b.fileZh:b.fileEn,y=await $t(I),x=`./notes/${I}`;y?M.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${b.key}`)}" src="${x}"></iframe>
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${_t.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${Ht(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function E(){const u=t.querySelector("[data-tool-list]"),c=t.querySelector("[data-tool-stage]");!u||!c||(u.querySelectorAll("button").forEach(b=>{b.addEventListener("click",()=>{o=b.getAttribute("data-tool"),u.querySelectorAll("button").forEach(H=>H.classList.toggle("active",H.getAttribute("data-tool")===o)),B(c)})}),B(c))}function B(u){u.innerHTML="";const c=zt[o];if(!c)return;const b=o==="lens"?c(l,r):c(l);u.appendChild(b)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(u){return!!(u!=null&&u.front)}function U(u){return`./${String(u).replace(/^\.\//,"")}`}function V(){return ot.slice()}function Y(){const u=V(),c=n==="rotatingMirror"?"reflection":n;if(c==="all"){const H=u.filter(M=>M.topic!=="convex"&&M.topic!=="concave"&&M.topic!=="refraction"&&M.topic!=="tir");return[...je,...Be,...Qe,...Ne,...Ve,...H]}if(c==="reflection")return je.slice();if(c==="convex")return Ne.slice();if(c==="concave")return Ve.slice();if(c==="refractionTir")return[...Be,...Qe];const b=u.filter(H=>H.topic===c);return b.length?b:u}function J(){const u=Y(),c=t.querySelector("[data-flash-progress]");if(!u.length){d=0;const D=t.querySelector("[data-flash-front]"),_=t.querySelector("[data-flip-card]");D&&(D.textContent=""),_&&_.classList.remove("flashcard-surface--image"),c&&(c.hidden=!0,c.textContent="");return}d=Math.max(0,Math.min(d,u.length-1));const b=u[d],H=t.querySelector("[data-flash-front]"),M=t.querySelector("[data-flip-card]"),I=t.querySelector("[data-flash-label]");if(!H||!M)return;if(c&&(c.hidden=!1,c.textContent=l("flashcards.progress").replace("{current}",String(d+1)).replace("{total}",String(u.length))),X(b)){const D=b.back&&b.back!==b.front;M.classList.add("flashcard-surface--image"),I&&(D?(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")):I.hidden=!0);const _=a&&b.back?b.back:b.front,Q=b.alt||b.title||"";H.innerHTML=`<img src="${U(_)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}M.classList.remove("flashcard-surface--image");const y=Ae(),x=b[y]||b.en;I&&(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")),H.textContent=a?x.a:x.q}function ee(){n==="rotatingMirror"&&(n="reflection");const u=t.querySelector("[data-flash-deck]");u.value=n,u.addEventListener("change",()=>{n=u.value,d=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",c=>{c.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const c=Y();d=(d-1+c.length)%c.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const c=Y();d=(d+1)%c.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const c=Y();d=Math.floor(Math.random()*c.length),a=!1,J()}),J()}function K(){const u=[{key:"reflection",type:"image",file:"reflection.webp"},{key:"refraction",type:"image",file:"refraction.webp"},{key:"tir",type:"image",file:"tir.webp"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",type:"image",file:"concave.webp"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${u.map(c=>{const b=l(`summary.item.${c.key}`);return`
            <div class="card" data-summary-card="${c.key}">
              <h3>${b}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function ne(){const u=[{key:"reflection",type:"image",file:"reflection.webp"},{key:"refraction",type:"image",file:"refraction.webp"},{key:"tir",type:"image",file:"tir.webp"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",type:"image",file:"concave.webp"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],c=Ae();for(const b of u){const H=t.querySelector(`[data-summary-card="${b.key}"]`);if(!H)continue;const M=H.querySelector("[data-summary-body]");if(b.type==="image"){const D=await Oe("summary",b.file),_=`./summary/${b.file}`;D?M.innerHTML=`
          <img class="summary-thumb" src="${_}" alt="${l(`summary.item.${b.key}`)}" loading="lazy" />
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:M.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const I=c==="zhHant"?b.fileZh:b.fileEn,y=await Oe("summary-pdfs",I),x=`./summary-pdfs/${I}`;y?M.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${b.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:M.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const v=()=>P(),m=u=>G(u);return window.addEventListener("s3phy:lang",v),t.addEventListener("click",m),P(),()=>{window.removeEventListener("s3phy:lang",v),t.removeEventListener("click",m),q==null||q.destroy()}}const Ke="s3phy-thermometer-lab-css",Ft=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function Et(){if(document.getElementById(Ke))return;const t=document.createElement("style");t.id=Ke,t.textContent=Ft,document.head.appendChild(t)}function Pe(t,i={}){Et();const o=i.type||"liquid";let r=t("tools.thermometerLab.title"),d=t("tools.thermometerLab.subtitle");i.type==="liquid"?(r=t("tools.thermometerLab.liquid.title"),d=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="resistance"?(r=t("tools.thermometerLab.resistance.title"),d=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):i.type==="thermistor"&&(r=t("tools.thermometerLab.thermistor.title"),d=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
    <div class="tl-head">
  ...
  `;const a={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},q=460,F=340,te=80,P=800,$=560;function G(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let s=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(s=150),p>145&&(s=200);const h=s<=100?20:25;return{minT:0,maxT:s,tickStep:h}}function L(e,s,p,h,f){return h+(e-s)/(p-s)*f}function z(e,s,p,h,f){return h+f-(e-s)/(p-s)*f}function E(e,s,p,h,f,T){const{gx:g,gy:w,gw:S,gh:C,tickFont:R,axisFont:W,yLabelX:N,xLabelY:k}=s;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const O of T){const j=z(O.value,O.min,O.max,w,C);e.beginPath(),e.moveTo(g,j),e.lineTo(g+S,j),e.stroke()}for(let O=p;O<=h+.01;O+=f){const j=L(O,p,h,g,S);e.beginPath(),e.moveTo(j,w),e.lineTo(j,w+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(g,w),e.lineTo(g,w+C),e.lineTo(g+S,w+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=R,e.textAlign="right",e.textBaseline="middle";for(const O of T){const j=z(O.value,O.min,O.max,w,C);e.fillText(O.label,g-15,j)}e.textAlign="center",e.textBaseline="top";for(let O=p;O<=h+.01;O+=f){const j=L(O,p,h,g,S);e.fillText(`${Math.round(O)}`,j,w+C+10)}return{gx:g,gy:w,gw:S,gh:C,axisFont:W,yLabelX:N,xLabelY:k}}function B(e,s){const p=s-e,h=p<=8?1:p<=14?2:5,f=[],T=Math.ceil(e/h)*h;for(let g=T;g<=s+.001;g+=h)f.push({value:g,label:g%1===0?`${g.toFixed(0)}`:`${g.toFixed(1)}`,min:e,max:s});return f}function ae(){const{maxT:e}=Z(),s=X(0),p=X(e),h=p-s,f=Math.max(1,h*.1),T=Math.max(0,Math.round((s-f)*10)/10),g=Math.round((p+f)*10)/10;return{minL:T,maxL:g}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),s=V(0),p=V(e),h=p-s,f=Math.max(.2,h*.1),T=Math.max(0,s-f),g=p+f,w=h<=2?.5:h<=4?1:2,S=[],C=Math.ceil(T/w)*w;for(let R=C;R<=g+.001;R+=w)S.push({value:R,label:R.toFixed(1),min:T,max:g});return{minR:T,maxR:g,ticks:S}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:s}=e;let p=a.thermistorR25;for(let g=0;g<=s;g+=5){const w=g+273.15,S=a.thermistorR25*Math.exp(a.thermistorBeta*(1/w-1/298.15));p=Math.max(p,S)}p=Math.ceil(p*1.08*10)/10;const h=0,f=p<=12?2:4,T=[];for(let g=0;g<=p+.001;g+=f)T.push({value:g,label:g.toFixed(0),min:h,max:p});return{minR:h,maxR:p,ticks:T}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),v=window.devicePixelRatio||1;J.width=q*v,J.height=F*v,ee.scale(v,v),K.width=P*v,K.height=$*v,ne.scale(v,v);function m(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const u=200,c=11;function b(){const e=Math.pow(a.bulbVolume/u,.3333333333333333);return c*e}function H(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,s=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,h=1.35-a.capillaryBore*.45;return Math.max(.1,s*p*h*e*.15)}function M(e){a.bathTemp<=8&&a.iceCubes.forEach(s=>{s.x+=s.speedX,s.y+=s.speedY,(s.x<65||s.x>175)&&(s.speedX*=-1),(s.y<195||s.y>210)&&(s.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(s=>{s.y-=s.speedY*(1+a.bathTemp/100),s.y<185&&(s.y=265,s.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(s=>{s.y-=s.speedY*(1+(a.bathTemp-80)/40),s.phase+=s.wobbleSpeed,s.x+=Math.sin(s.phase)*.3,s.y<185&&(s.y=260+Math.random()*10,s.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(s=>{s.x+=s.vx,s.y+=s.vy,s.alpha-=.005,(s.alpha<=0||s.y<130)&&(s.x=60+Math.random()*120,s.y=175+Math.random()*5,s.alpha=.2+Math.random()*.4)})}function I(e){let g=59,w=130,S=246;if(a.bathTemp<25){const k=a.bathTemp/25;g=Math.round(180-k*121),w=Math.round(210-k*80),S=Math.round(250-k*4)}else{const k=Math.min(1,(a.bathTemp-25)/125);g=Math.round(59+k*180),w=Math.round(130-k*100),S=Math.round(246-k*190)}if(a.bathTemp>40){const k=Math.min(1,(a.bathTemp-40)/100),O=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${k*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let j=-25;j<=25;j+=6){const re=k*(12+Math.sin(j*.4+O)*5);e.lineTo(55+130/2+j,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${g}, ${w}, ${S}, 0.25)`),C.addColorStop(1,`rgba(${g}, ${w}, ${S}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const R=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let k=55;k<=185;k+=5){const O=190+Math.sin(k*.15+N)*R;e.lineTo(k,O)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(k=>{e.beginPath(),e.moveTo(k.x,k.y),e.quadraticCurveTo(k.x+Math.sin(k.y*.06)*5,k.y-k.length/2,k.x,k.y-k.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(k=>{e.save(),e.translate(k.x,k.y),e.rotate(k.angle),e.beginPath(),e.roundRect(-k.size/2,-k.size/2,k.size,k.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(k=>{e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(k=>{e.fillStyle=`rgba(255, 255, 255, ${k.alpha})`,e.beginPath(),e.arc(k.x,k.y,k.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,s,p,h,f,T,g="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(s,p),e.lineTo(h,f),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(s,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const S=e.measureText(T).width+10,C=16,R=g==="left"?h:h-S,W=f-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(R,W,S,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(T,R+S/2,W+C/2+.5)}function x(e){const h=b(),f=250+Math.max(0,h-c)*.35,T=f-h-1,g=10+a.wallThickness*8,w=120-g/2,S=120+g/2,C=e.createLinearGradient(w,20,S,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,T),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(S,20,S,25,5),e.lineTo(S,T),e.closePath(),e.fill(),e.stroke();const R=e.createRadialGradient(120-h*.2,f-h*.2,h*.1,120,f,h);R.addColorStop(0,"rgba(255, 255, 255, 0.8)"),R.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=R,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,f,h+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(g*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,T-20-8);const N=a.liquidType==="mercury",k=N?"#a1a1aa":"#ef4444",O=N?"#f4f4f5":"#fee2e2",j=210,re=220,be=(j-40)/re,fe=j-Math.min(re,a.thermometerTemp)*be;e.fillStyle=k,e.fillRect(120-W/2,fe,W,T-fe),e.beginPath(),e.ellipse(120,fe,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=O,e.fillRect(120-W/6,fe,W/3,T-fe);const oe=h*.9,ie=e.createRadialGradient(120-oe*.2,f-oe*.2,oe*.1,120,f,oe);N?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,f,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const he=j-le*be;e.beginPath(),e.moveTo(w,he),e.lineTo(w+4,he),e.stroke(),e.fillText(`${le}°C`,w-22,he+2.5)}a.showLabels&&(y(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,f,230,f+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function D(e){const g=e.createLinearGradient(115,20,125,20);g.addColorStop(0,"#71717a"),g.addColorStop(.3,"#f4f4f5"),g.addColorStop(.7,"#d4d4d8"),g.addColorStop(1,"#3f3f46"),e.fillStyle=g,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let N=0;N<8;N++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,C=40,R=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,C,R,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,C+12,R-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",S+R-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,C+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function _(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const f=20,T=225,g=12,w=120-g/2,S=e.createLinearGradient(w,f,w+g,f);S.addColorStop(0,"rgba(229, 231, 235, 0.4)"),S.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),S.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),S.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=S,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,f,g,T-f,[0,0,3,3]),e.fill(),e.stroke();const C=7,R=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);R.addColorStop(0,"#6b7280"),R.addColorStop(.7,"#1f2937"),R.addColorStop(1,"#09090b"),e.fillStyle=R,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,k=135,O=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,k,O,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,k-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+k-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,s,p,h,f,T,g,w,S){const{gx:C,gy:R,gw:W,gh:N}=s;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,h),e.lineTo(p,R+N),e.stroke(),e.beginPath(),e.moveTo(p,h),e.lineTo(C,h),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const k=`${f.toFixed(1)}${g}`,O=e.measureText(k).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(p-O/2,R+N+2,O,15,3),e.fill(),e.fillStyle="#000",e.fillText(k,p,R+N+4),e.textAlign="right",e.textBaseline="middle";const j=`${T.toFixed(2)} ${w}`,re=e.measureText(j).width+10;e.fillStyle=S,e.beginPath(),e.roundRect(C-re-2,h-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(j,C-7,h)}function A(e){const s=G(),{minL:p,maxL:h}=ae(),{minT:f,maxT:T,tickStep:g}=Z(),w=B(p,h),S=E(e,s,f,T,g,w),{gx:C,gy:R,gw:W,gh:N,axisFont:k,yLabelX:O,xLabelY:j,dotR:re}={...s,...S};e.save(),e.translate(O,R+N/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=k,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+W/2,j);const we=T,be=L(0,f,T,C,W),fe=z(X(0),p,h,R,N),oe=L(we,f,T,C,W),ie=z(X(we),p,h,R,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,he=a.currentLength;if(le>=f&&le<=T){const ve=L(le,f,T,C,W),Ce=z(he,p,h,R,N);Q(e,s,ve,Ce,le,he,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const s=G(),{minR:p,maxR:h,ticks:f}=U(),T=Z(),g=E(e,s,T.minT,T.maxT,T.tickStep,f),{gx:w,gy:S,gw:C,gh:R,axisFont:W,yLabelX:N,xLabelY:k,dotR:O}={...s,...g};e.save(),e.translate(N,S+R/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,k);const{minT:j,maxT:re}=T,we=re,be=L(0,j,re,w,C),fe=z(V(0),p,h,S,R),oe=L(we,j,re,w,C),ie=z(V(we),p,h,S,R);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,fe),e.lineTo(oe,ie),e.stroke();const le=a.thermometerTemp,he=a.currentResistance;if(le>=j&&le<=re){const ve=L(le,j,re,w,C),Ce=z(he,p,h,S,R);Q(e,s,ve,Ce,le,he,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,O,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const s=G(),p=Z(),{minR:h,maxR:f,ticks:T}=Y(p),g=E(e,s,p.minT,p.maxT,p.tickStep,T),{gx:w,gy:S,gw:C,gh:R,axisFont:W,yLabelX:N,xLabelY:k,dotR:O}={...s,...g},{minT:j,maxT:re}=p;e.save(),e.translate(N,S+R/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,k),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=j;oe<=re;oe+=1){const ie=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/ie-1/298.15)),he=L(oe,j,re,w,C),ve=z(Math.min(f,le),h,f,S,R);ve>=S&&ve<=S+R&&(we?e.lineTo(he,ve):(e.moveTo(he,ve),we=!0))}e.stroke();const be=a.thermometerTemp,fe=a.currentThermistorR;if(be>=j&&be<=re){const oe=L(be,j,re,w,C),ie=z(Math.min(f,fe),h,f,S,R);Q(e,s,oe,ie,be,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,ie,O,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function pe(){ee.clearRect(0,0,q,F),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),I(ee),a.thermometerType==="liquid"?x(ee):a.thermometerType==="resistance"?D(ee):_(ee),ee.restore(),a.thermometerType==="liquid"?A(ne):a.thermometerType==="resistance"?de(ne):se(ne)}function ge(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `}}function Se(){const e=n.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:s,cu:p,interval:h}=ze(),f=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,g=n.querySelector("#tl-pane-q10a").classList.contains("active"),w=g?(f-s)/h*100:T,S=g?f:T/100*h+s,R=(W=>130-W/100*80)(w);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Current Point -->
          <text x="65" y="${R+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${w.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${R+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${S.toFixed(1)}°C</text>
    ...
    `}function qe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const s=n.querySelector("#tl-bath-state");a.bathTemp<=0?s.textContent="Melting Ice Bath":a.bathTemp>=100?s.textContent="Boiling Water/Steam":a.bathTemp===150?s.textContent="Hot Cooking Oil":s.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",ge()}let ke=null;function _e(e){a.lastTimestamp||(a.lastTimestamp=e);const s=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(s,.1),h=H(),f=p/h*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=f,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const T=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/T-1/298.15)),M(),pe(),qe(h),ke=requestAnimationFrame(_e)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),s=parseFloat(n.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,h=Number.isFinite(s)?s:105,f=h-p;return{cf:p,cu:h,interval:f}}function He(e){const s=Math.round(e*100)/100;return s>=0?s.toFixed(1):`(${s.toFixed(1)})`}function me(){const{cf:e,cu:s,interval:p}=ze(),h=n.querySelector("#tl-val-faulty-interval"),f=n.querySelector("#tl-faulty-error-a"),T=n.querySelector("#tl-faulty-error-b"),g=Math.abs(p)<.01;h.textContent=p.toFixed(1)+" °C";const w=n.querySelector("#tl-svg-formula-faulty-a"),S=n.querySelector("#tl-svg-formula-faulty-b");if(g){f.hidden=!1,f.textContent="C_u must differ from C_f (interval cannot be zero).",T.hidden=!1,T.textContent=f.textContent,w&&(w.innerHTML=""),S&&(S.innerHTML="");return}f.hidden=!0,T.hidden=!0;const C=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,R=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(C-e)/p*100,N=R/100*p+e;w&&(w.innerHTML=`
      ...
      `),S&&(S.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${R.toFixed(1)} &times; ${p.toFixed(1)}</text>
      ...
      `),Se()}function ye(){const e=parseFloat(n.querySelector("#tl-input-q11-r").value)||0,s=(e-a.resistanceR0)/(a.resistanceR100-a.resistanceR0)*100,p=n.querySelector("#tl-svg-formula-resistance-solver");p&&(p.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      </section>`}async function L(){const v=Fe();for(const m of Re){const u=t.querySelector(`[data-note-card="${m.id}"]`);if(!u)continue;const c=u.querySelector("[data-note-body]"),b=v==="zhHant"?m.fileZh:m.fileEn,H=await Ze(b),M=`./notes/${b}`;H?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${m.id}`)}" src="${M}"></iframe>
          <p style="margin-top:8px"><a href="${M}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:c.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function z(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Xe.map(v=>`<button type="button" data-tool="${v}" class="${o===v?"active":""}">${jt(v)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function E(){const v=t.querySelector("[data-tool-list]"),m=t.querySelector("[data-tool-stage]");!v||!m||(v.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{o=u.getAttribute("data-tool"),v.querySelectorAll("button").forEach(c=>c.classList.toggle("active",c.getAttribute("data-tool")===o)),B(m)})}),B(m))}function B(v){v.innerHTML="",F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup();const m=Gt[o];m&&(F=m(l),v.appendChild(F))}function ae(){return`
      <section class="panel">
        <h2>${l("flashcards.title")}</h2>
        <p class="lead">${l("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}function X(){return ot.filter(v=>De.includes(v.topic))}function U(){const v=X();return d==="all"||d==="thermometry"?v:v.filter(m=>m.topic===d)}function V(){const v=U(),m=t.querySelector("[data-flash-progress]");if(!v.length){r=0;const I=t.querySelector("[data-flash-front]");I&&(I.textContent=""),m&&(m.hidden=!0,m.textContent="");return}r=Math.max(0,Math.min(r,v.length-1));const u=v[r],c=t.querySelector("[data-flash-front]"),b=t.querySelector("[data-flash-label]");if(!c)return;m&&(m.hidden=!1,m.textContent=l("flashcards.progress").replace("{current}",String(r+1)).replace("{total}",String(v.length)));const H=Fe(),M=u[H]||u.en;b&&(b.hidden=!1,b.textContent=l(n?"flashcards.answer":"flashcards.question")),c.textContent=n?M.a:M.q}function Y(){const v=t.querySelector("[data-flash-deck]");v.value=d,v.addEventListener("change",()=>{d=v.value,r=0,n=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{n=!n,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",m=>{m.stopPropagation(),n=!n,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const m=U();r=(r-1+m.length)%m.length,n=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const m=U();r=(r+1)%m.length,n=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const m=U();r=Math.floor(Math.random()*m.length),n=!1,V()}),V()}function J(){return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
      ...
      </section>`}async function ee(){const v=Fe();for(const m of Re){const u=t.querySelector(`[data-summary-card="${m.id}"]`);if(!u)continue;const c=u.querySelector("[data-summary-body]"),b=v==="zhHant"?m.fileZh:m.fileEn,H=await Ze(b),M=`./notes/${b}`;H?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${m.id}`)}" src="${M}"></iframe>
          <p style="margin-top:8px"><a href="${M}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const K=()=>P(),ne=v=>G(v);return window.addEventListener("s3phy:lang",K),t.addEventListener("click",ne),P(),()=>{window.removeEventListener("s3phy:lang",K),t.removeEventListener("click",ne),F!=null&&F._thermometerLabCleanup&&F._thermometerLabCleanup(),a==null||a.destroy()}}const Je={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};bt();const et="s3phy_splash_seen",dt={optics:At,heat:Qt};let Le=null,Me=null;function Nt(){const t=location.hash.match(/^#\/(\w+)/),i=t==null?void 0:t[1];return i&&Object.prototype.hasOwnProperty.call(dt,i)?i:null}function Vt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function ut(t){Le==null||Le(),Le=null,Me==null||Me(),Me=null;const i=document.getElementById("app");if(!i)return;if(i.innerHTML="",!t){location.hash&&Vt(),Me=vt(i);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Le=dt[t](i)??null}function ft(){ut(Nt())}function Yt(){return"./images/uniplus-logo.png"}function Ut(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Yt()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Kt(t,i){const o=[...Je.en,...Je.zhHant],r=()=>{if(!t.parentElement)return;const d=document.createElement("div");d.className="splash-danmaku-item",d.textContent=o[Math.floor(Math.random()*o.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,q=Math.random()*12+10;d.style.top=`${n}%`,d.style.fontSize=`${a}rem`,d.style.animationDuration=`${q}s`,i.appendChild(d),d.addEventListener("animationend",()=>d.remove()),window.setTimeout(r,1500+Math.random()*1e3)};for(let d=0;d<4;d+=1)window.setTimeout(r,d*1e3)}function Xt(t){const i=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),r=t.querySelector("#splashStartWrap");window.setTimeout(()=>i==null?void 0:i.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),r==null||r.classList.add("splash-start-wrap--in"),o&&Kt(t,o)},1600)}function tt(){ft()}function Zt(){let t=!1;try{t=sessionStorage.getItem(et)==="1"}catch{}if(t){tt();return}const i=Ut();document.body.insertBefore(i,document.body.firstChild),Xt(i);const o=i.querySelector("#splashStart"),r=()=>{i.remove(),tt()};o.addEventListener("click",()=>{try{sessionStorage.setItem(et,"1")}catch{}i.classList.add("splash--hide"),i.addEventListener("transitionend",r,{once:!0}),window.setTimeout(r,480)})}window.addEventListener("hashchange",ft);window.addEventListener("s3phy:strand",t=>{ut(t.detail??null)});Zt();
