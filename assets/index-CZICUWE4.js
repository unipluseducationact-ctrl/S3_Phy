...
`;function Pt(){if(document.getElementById(Ue))return;const t=document.createElement("style");t.id=Ue,t.textContent=It,document.head.appendChild(t)}function Wt(t){Pt();const n=document.createElement("div");n.className="rml",n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-r]"),i=n.querySelector("[data-g]"),s=n.querySelector("[data-b]"),a=n.querySelector(".rgb-mixer-canvas"),r=n.querySelector(".rgb-mixer-stage"),c=a.getContext("2d");function O(y){return y.toString(16).padStart(2,"0")}function I(y,S,E){const g=a.width/(window.devicePixelRatio||1),A=a.height/(window.devicePixelRatio||1),$=g/2,V=A/2,u=Math.min(g,A)*.34,f=u*.5,h=Math.sqrt(3)/2;c.clearRect(0,0,g,A),c.fillStyle="#000",c.fillRect(0,0,g,A);const x=[{x:$,y:V-f,rgb:[255,0,0],val:y},{x:$-f*h,y:V+f*.5,rgb:[0,255,0],val:S},{x:$+f*h,y:V+f*.5,rgb:[0,0,255],val:E}];c.globalCompositeOperation="lighter",x.forEach(G=>{if(G.val<=0)return;const j=G.val/255,[F,W,P]=G.rgb,U=c.createRadialGradient(G.x,G.y,0,G.x,G.y,u);U.addColorStop(0,`rgba(${F},${W},${P},${j})`),U.addColorStop(.65,`rgba(${F},${W},${P},${j})`),U.addColorStop(.85,`rgba(${F},${W},${P},${j*.5})`),U.addColorStop(1,`rgba(${F},${W},${P},0)`),c.fillStyle=U,c.beginPath(),c.arc(G.x,G.y,u,0,Math.PI*2),c.fill()}),c.globalCompositeOperation="source-over"}function R(){const y=r.getBoundingClientRect(),S=Math.max(200,Math.min(y.width-8,y.height-8,720)),E=window.devicePixelRatio||1;a.width=S*E,a.height=S*E,a.style.width=`${S}px`,a.style.height=`${S}px`,c.setTransform(E,0,0,E,0,0),I(+o.value,+i.value,+s.value)}function H(){const y=+o.value,S=+i.value,E=+s.value,g=`rgb(${y}, ${S}, ${E})`,A=`#${O(y)}${O(S)}${O(E)}`;n.querySelector("[data-r-val]").textContent=y,n.querySelector("[data-g-val]").textContent=S,n.querySelector("[data-b-val]").textContent=E,n.querySelector("[data-r-bar]").style.width=`${y/255*100}%`,n.querySelector("[data-g-bar]").style.width=`${S/255*100}%`,n.querySelector("[data-b-bar]").style.width=`${E/255*100}%`,o.style.setProperty("--fill",`${y/255*100}%`),i.style.setProperty("--fill",`${S/255*100}%`),s.style.setProperty("--fill",`${E/255*100}%`);const $=n.querySelector("[data-swatch]");$.style.backgroundColor=g,$.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${g}`),n.querySelector("[data-rgb-text]").textContent=g,n.querySelector("[data-hex-text]").textContent=A,I(y,S,E)}function M(y,S,E){o.value=y,i.value=S,s.value=E,H()}return[o,i,s].forEach(y=>y.addEventListener("input",H)),n.querySelectorAll(".rgb-presets button").forEach(y=>{y.addEventListener("click",()=>{M(+y.dataset.r,+y.dataset.g,+y.dataset.b)})}),new ResizeObserver(()=>R()).observe(r),requestAnimationFrame(()=>{R(),H()}),n}const Bt=["topics","notes","tools","worksheets","flashcards","summary"],Nt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function yt(t,{subtitleKey:n,activeSection:o,onSection:i,onLang:s}){t.innerHTML=`
...
${J}</body></html>`}function U(k){const _=P(k),J=new Blob(["\uFEFF",_],{type:"application/msword"}),D=document.createElement("a");D.href=URL.createObjectURL(J),D.download=k?"worksheet-answers.doc":"worksheet.doc",D.click(),URL.revokeObjectURL(D.href)}r.addEventListener("click",()=>{const k=Number(t.querySelector("[data-ws-count]").value),_=[...t.querySelectorAll("[data-ws-topic]")].filter(Z=>Z.checked).map(Z=>Z.getAttribute("data-ws-topic")),J=Qt(n,_,s.topicFilter),D=Ye(J).slice(0,Math.min(k,J.length||1));a.items=D.length?D:Ye(n).slice(0,Math.min(k,n.length)),u(),a.tab="practice",a.dateStr="",c.hidden=!1,O.hidden=!0,H==null||H.querySelectorAll("[data-ws-tab]").forEach(Z=>{Z.classList.toggle("active",Z.getAttribute("data-ws-tab")==="practice")}),M&&(M.hidden=!1),E&&(E.hidden=!1),g&&(g.hidden=!0),$.textContent="",R==null||R.classList.add("practice-mode"),j()}),H==null||H.addEventListener("click",k=>{const _=k.target.closest("[data-ws-tab]");!_||!a.items.length||x(_.getAttribute("data-ws-tab"))}),A==null||A.addEventListener("click",()=>{a.dateStr?(a.dateStr="",$.textContent=""):(a.dateStr=Vt(),$.textContent=`${o("worksheets.date")}: ${a.dateStr}`),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:"")}),(ee=t.querySelector("[data-ws-word-p]"))==null||ee.addEventListener("click",()=>U(!1)),(ne=t.querySelector("[data-ws-word-a]"))==null||ne.addEventListener("click",()=>U(!0)),(te=t.querySelector("[data-ws-print-p]"))==null||te.addEventListener("click",()=>{x("practice"),R==null||R.classList.add("ws-print-blank");const k=()=>R==null?void 0:R.classList.remove("ws-print-blank");window.addEventListener("afterprint",k,{once:!0}),window.print()}),(ae=t.querySelector("[data-ws-print-a]"))==null||ae.addEventListener("click",()=>{x("answer"),window.print()})}const Kt=1.7,Ut=.7,De=1,Yt=.1,Xt=3;function Zt(t){const n=Math.floor(t),o=t-n;return n+(Math.random()<o?1:0)}function Xe(t){for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function Jt(t){const n=new Map(t.map(a=>[a.id,a.copies])),o=[];let i=null;const s=t.reduce((a,r)=>a+r.copies,0);for(let a=0;a<s;a+=1){let r=[...n.entries()].filter(([I,R])=>R>0&&I!==i);r.length===0&&(r=[...n.entries()].filter(([,I])=>I>0)),r.sort((I,R)=>R[1]-I[1]);const[c,O]=r[0];o.push(c),n.set(c,O-1),i=c}return o}function ea(t){const n=[];return t.forEach(({id:o,copies:i})=>{for(let s=0;s<i;s+=1)n.push(o)}),n}function ta(t){let n="sequence",o=1,i=[],s=[],a=0,r=!1,c=!1,O=!1;const I=new Map;function R(){return t()}function H(){return new Map(R().map(u=>[u.id,u]))}function M(){I.clear(),R().forEach(u=>{I.set(u.id,{nextRate:De,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function B(){const u=R();return o===1?u.map(f=>({id:f.id,copies:1})):u.map(f=>{var h;return{id:f.id,copies:Zt(((h=I.get(f.id))==null?void 0:h.nextRate)??De)}}).filter(f=>f.copies>0)}function y(u){if(u.length===0)return[];if(o===1){const f=u.map(h=>h.id);return n==="random"?Xe([...f]):[...f].sort((h,x)=>h-x)}return n==="random"?Xe(ea(u)):Jt(u)}function S(){if(c=!1,O=!1,i=B(),i.reduce((f,h)=>f+h.copies,0)===0){O=!0,c=!0,s=[],a=0;return}R().forEach(f=>{const h=I.get(f.id);h&&(h.roundAgain=0,h.roundGotIt=0,h.roundNeutral=0)}),s=y(i),a=0,r=!1}function E(){o=1,M(),S()}function g(){return s[a]??null}function A(){const u=g();return u==null?null:H().get(u)??null}function $(u){const f=g();if(f==null)return;const h=I.get(f);h&&(u==="again"?(h.nextRate=Kt,h.totalGotIt=0,h.roundAgain+=1):u==="gotit"?(h.totalGotIt+=1,h.roundGotIt+=1,h.nextRate=h.totalGotIt>=Xt?Yt:Ut):u==="neutral"&&(h.roundNeutral+=1,h.nextRate=De))}function V(){return r=!1,a<s.length-1?(a+=1,!1):(c=!0,!0)}return E(),{getMode:()=>n,setMode(u){n!==u&&(n=u,s=y(i),a=0,r=!1)},resetSession:E,getRoundNumber:()=>o,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>r,flip(){r=!r},unflip(){r=!1},currentCard:A,prev(){return a>0?(a-=1,r=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,r=!1,!0):!1},rateAgain(){return r?($("again"),V()):!1},rateGotIt(){return r?($("gotit"),V()):!1},rateNeutral(){return r?($("neutral"),V()):!1},isSummary:()=>c,isSessionComplete:()=>O,getRoundStats(){let u=0,f=0,h=0;return I.forEach(x=>{u+=x.roundAgain,f+=x.roundGotIt,h+=x.roundNeutral}),{again:u,gotIt:f,neutral:h}},nextRound(){o+=1,S()},restart(){E()}}}function kt(t,{deckOptions:n,buildDeck:o,initialDeck:i="all"}){let s=i,a=null,r=null;t.innerHTML=`
    <section class="panel panel--flashcards">
      ...
      </section>`}function S(){const u=t.querySelector("[data-tool-list]"),f=t.querySelector("[data-tool-stage]");!u||!f||(u.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>{o=h.getAttribute("data-tool"),u.querySelectorAll("button").forEach(x=>x.classList.toggle("active",x.getAttribute("data-tool")===o)),E(f)})}),E(f))}function E(u){u.innerHTML="";const f=ua[o];if(!f)return;const h=o==="lens"?f(l,i):f(l);u.appendChild(h)}function g(){const u=[{key:"reflection",type:"image",fileEn:"reflection-en.webp",fileZh:"reflection-zhHant.webp"},{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"},{key:"convex",type:"image",fileEn:"convex-en.webp",fileZh:"convex-zhHant.webp"},{key:"concave",type:"image",fileEn:"concave-en.webp",fileZh:"concave-zhHant.webp"},{key:"em",type:"image",file:"em.webp"}];return`
      <section class="panel">
        ...
        <div class="grid cols-2" data-summary-grid>
          ...
          <p style="margin-top:8px"><a href="${ee}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:G.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const j=f==="zhHant"?h.fileZh:h.fileEn,F=await Be("summary-pdfs",j),W=`./summary-pdfs/${j}`;F?G.innerHTML=`
...
`;function ga(){if(document.getElementById(lt))return;const t=document.createElement("style");t.id=lt,t.textContent=ba,document.head.appendChild(t)}function va(t){const o={x:12,y:12},i=200,{container:s,panel:a,toggleBtn:r,dragHandle:c,storageKey:O,onLayoutChange:I,breakpoint:R=1024,collapsedClass:H="controls-collapsed",floatingClass:M="controls-floating"}=t;if(!s||!a||!r)return null;let B=sessionStorage.getItem(O)!=="false",y=(()=>{try{const j=localStorage.getItem(O+":pos");if(!j)return{...o};const F=JSON.parse(j);if(typeof F.x=="number"&&typeof F.y=="number")return F}catch{}return{...o}})(),S=null,E=null;const g=()=>window.innerWidth>=R,A=(j,F)=>{const W=s.getBoundingClientRect(),P=a.getBoundingClientRect(),U=Math.max(0,W.width-P.width),ee=Math.max(0,W.height-P.height);return{x:Math.min(Math.max(0,j),U),y:Math.min(Math.max(0,F),ee)}},$=()=>{a.style.left=y.x+"px",a.style.top=y.y+"px",a.style.right="auto",a.style.bottom="auto"},V=()=>{typeof I=="function"&&(clearTimeout(E),E=setTimeout(I,i))},u=()=>{r.setAttribute("aria-expanded",B?"false":"true"),t.getToggleTitle&&(r.title=t.getToggleTitle(B));const j=r.querySelector("[data-float-chevron]");j&&(j.textContent=B?"v":"^")},f=j=>{B=j,a.classList.toggle(H,B),sessionStorage.setItem(O,B?"true":"false"),u(),V()},h=()=>{s.classList.add(M),a.classList.add("lab-controls-float"),y=A(y.x,y.y),$(),c&&(c.style.display="")},x=()=>{s.classList.remove(M),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",c&&(c.style.display="none")},G=()=>{g()?(h(),y=A(y.x,y.y),$()):x(),V()};if(a.classList.toggle(H,B),u(),G(),r.addEventListener("click",j=>{j.stopPropagation(),f(!B)}),c){c.addEventListener("pointerdown",F=>{g()&&(F.preventDefault(),S={pointerId:F.pointerId,startX:F.clientX,startY:F.clientY,originX:y.x,originY:y.y},c.setPointerCapture(F.pointerId),c.classList.add("is-dragging"))}),c.addEventListener("pointermove",F=>{!S||S.pointerId!==F.pointerId||(y=A(S.originX+F.clientX-S.startX,S.originY+F.clientY-S.startY),$())});const j=F=>{if(!(!S||S.pointerId!==F.pointerId)){c.releasePointerCapture(F.pointerId),c.classList.remove("is-dragging");try{localStorage.setItem(O+":pos",JSON.stringify(y))}catch{}S=null,V()}};c.addEventListener("pointerup",j),c.addEventListener("pointercancel",j)}return window.addEventListener("resize",G),{setCollapsed:f,refreshMode:G,isCollapsed:()=>B}}function Ge(t,n={}){ga();const o=n.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");n.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
  ...
  `;const r={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},c=460,O=340,I=80,R=800,H=560;function M(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:R-e.left-e.right,gh:H-e.top-e.bottom,tickFont:`bold ${Math.round(R*.024)}px Arial`,axisFont:`bold ${Math.round(R*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:H-e.bottom+32}}function B(){let d=100;const m=Math.max(r.bathTemp,r.thermometerTemp,100);m>120&&(d=150),m>145&&(d=200);const b=d<=100?20:25;return{minT:0,maxT:d,tickStep:b}}function y(e,d,m,b,p){return b+(e-d)/(m-d)*p}function S(e,d,m,b,p){return b+p-(e-d)/(m-d)*p}function E(e,d,m,b,p,C){const{gx:v,gy:w,gw:T,gh:L,tickFont:z,axisFont:Q,yLabelX:X,xLabelY:q}=d;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const K of C){const Y=S(K.value,K.min,K.max,w,L);e.beginPath(),e.moveTo(v,Y),e.lineTo(v+T,Y),e.stroke()}for(let K=m;K<=b+.01;K+=p){const Y=y(K,m,b,v,T);e.beginPath(),e.moveTo(Y,w),e.lineTo(Y,w+L),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(v,w),e.lineTo(v,w+L),e.lineTo(v+T,w+L),e.stroke(),e.fillStyle="#e4e4e7",e.font=z,e.textAlign="right",e.textBaseline="middle";for(const K of C){const Y=S(K.value,K.min,K.max,w,L);e.fillText(K.label,v-15,Y)}e.textAlign="center",e.textBaseline="top";for(let K=m;K<=b+.01;K+=p){const Y=y(K,m,b,v,T);e.fillText(`${Math.round(K)}`,Y,w+L+10)}return{gx:v,gy:w,gw:T,gh:L,axisFont:Q,yLabelX:X,xLabelY:q}}function g(e,d){const m=d-e,b=m<=8?1:m<=14?2:5,p=[],C=Math.ceil(e/b)*b;for(let v=C;v<=d+.001;v+=b)p.push({value:v,label:v%1===0?`${v.toFixed(0)}`:`${v.toFixed(1)}`,min:e,max:d});return p}function A(){const{maxT:e}=B(),d=$(0),m=$(e),b=m-d,p=Math.max(1,b*.1),C=Math.max(0,Math.round((d-p)*10)/10),v=Math.round((m+p)*10)/10;return{minL:C,maxL:v}}function $(e){return r.liquidL0+(r.liquidL100-r.liquidL0)/100*e}function V(){const{maxT:e}=B(),d=u(0),m=u(e),b=m-d,p=Math.max(.2,b*.1),C=Math.max(0,d-p),v=m+p,w=b<=2?.5:b<=4?1:2,T=[],L=Math.ceil(C/w)*w;for(let z=L;z<=v+.001;z+=w)T.push({value:z,label:z.toFixed(1),min:C,max:v});return{minR:C,maxR:v,ticks:T}}function u(e){return r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*e}function f(e){const{maxT:d}=e;let m=r.thermistorR25;for(let v=0;v<=d;v+=5){const w=v+273.15,T=r.thermistorR25*Math.exp(r.thermistorBeta*(1/w-1/298.15));m=Math.max(m,T)}m=Math.ceil(m*1.08*10)/10;const b=0,p=m<=12?2:4,C=[];for(let v=0;v<=m+.001;v+=p)C.push({value:v,label:v.toFixed(0),min:b,max:m});return{minR:b,maxR:m,ticks:C}}const h=a.querySelector("#tl-thermometerCanvas"),x=h.getContext("2d"),G=a.querySelector("#tl-graphCanvas"),j=G.getContext("2d"),F=window.devicePixelRatio||1;h.width=c*F,h.height=O*F,x.scale(F,F),G.width=R*F,G.height=H*F,j.scale(F,F);function W(){r.iceCubes=[];for(let e=0;e<5;e++)r.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});r.bubbles=[];for(let e=0;e<20;e++)r.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});r.heatWaves=[];for(let e=0;e<8;e++)r.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});r.steamParticles=[];for(let e=0;e<12;e++)r.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const P=200,U=11;function ee(){const e=Math.pow(r.bulbVolume/P,.3333333333333333);return U*e}function ne(){if(r.thermometerType==="resistance"||r.thermometerType==="thermistor")return .35;const e=r.liquidType==="mercury"?1:8,d=.2+r.wallThickness*1.5,m=.4+r.bulbVolume*.003,b=1.35-r.capillaryBore*.45;return Math.max(.1,d*m*b*e*.15)}function te(e){r.bathTemp<=8&&r.iceCubes.forEach(d=>{d.x+=d.speedX,d.y+=d.speedY,(d.x<65||d.x>175)&&(d.speedX*=-1),(d.y<195||d.y>210)&&(d.speedY*=-1)}),r.bathTemp>35&&r.heatWaves.forEach(d=>{d.y-=d.speedY*(1+r.bathTemp/100),d.y<185&&(d.y=265,d.x=65+Math.random()*110)}),r.bathTemp>=80&&r.bubbles.forEach(d=>{d.y-=d.speedY*(1+(r.bathTemp-80)/40),d.phase+=d.wobbleSpeed,d.x+=Math.sin(d.phase)*.3,d.y<185&&(d.y=260+Math.random()*10,d.x=60+Math.random()*120)}),r.bathTemp>=95&&r.steamParticles.forEach(d=>{d.x+=d.vx,d.y+=d.vy,d.alpha-=.005,(d.alpha<=0||d.y<130)&&(d.x=60+Math.random()*120,d.y=175+Math.random()*5,d.alpha=.2+Math.random()*.4)})}function ae(e){let v=59,w=130,T=246;if(r.bathTemp<25){const q=r.bathTemp/25;v=Math.round(180-q*121),w=Math.round(210-q*80),T=Math.round(250-q*4)}else{const q=Math.min(1,(r.bathTemp-25)/125);v=Math.round(59+q*180),w=Math.round(130-q*100),T=Math.round(246-q*190)}if(r.bathTemp>40){const q=Math.min(1,(r.bathTemp-40)/100),K=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let Y=-25;Y<=25;Y+=6){const re=q*(12+Math.sin(Y*.4+K)*5);e.lineTo(55+130/2+Y,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const L=e.createLinearGradient(55,190,55,280);L.addColorStop(0,`rgba(${v}, ${w}, ${T}, 0.25)`),L.addColorStop(1,`rgba(${v}, ${w}, ${T}, 0.55)`),e.fillStyle=L,e.beginPath(),e.moveTo(55,190);const z=r.bathTemp>=80?2:.5,Q=r.bathTemp>=80?.09:.03,X=Date.now()*Q;for(let q=55;q<=185;q+=5){const K=190+Math.sin(q*.15+X)*z;e.lineTo(q,K)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),r.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(r.bathTemp-35)/120)})`,e.lineWidth=1.2,r.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),r.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,r.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),r.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,r.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),r.bathTemp>=95&&r.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function k(e,d,m,b,p,C,v="left"){if(!r.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(d,m),e.lineTo(b,p),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(d,m,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const T=e.measureText(C).width+10,L=16,z=v==="left"?b:b-T,Q=p-L/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(z,Q,T,L,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(C,z+T/2,Q+L/2+.5)}function _(e){const b=ee(),p=250+Math.max(0,b-U)*.35,C=p-b-1,v=10+r.wallThickness*8,w=120-v/2,T=120+v/2,L=e.createLinearGradient(w,20,T,20);L.addColorStop(0,"rgba(209, 213, 219, 0.85)"),L.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),L.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),L.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),L.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=L,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,C),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(T,20,T,25,5),e.lineTo(T,C),e.closePath(),e.fill(),e.stroke();const z=e.createRadialGradient(120-b*.2,p-b*.2,b*.1,120,p,b);z.addColorStop(0,"rgba(255, 255, 255, 0.8)"),z.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=z,e.strokeStyle="#6b7280",e.lineWidth=.8+r.wallThickness*.6,e.beginPath(),e.arc(120,p,b+.5+r.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const Q=Math.min(v*.72,.8+r.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-Q/2,28,Q,C-20-8);const X=r.liquidType==="mercury",q=X?"#a1a1aa":"#ef4444",K=X?"#f4f4f5":"#fee2e2",Y=210,re=220,be=(Y-40)/re,he=Y-Math.min(re,r.thermometerTemp)*be;e.fillStyle=q,e.fillRect(120-Q/2,he,Q,C-he),e.beginPath(),e.ellipse(120,he,Q/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=K,e.fillRect(120-Q/6,he,Q/3,C-he);const se=b*.9,ie=e.createRadialGradient(120-se*.2,p-se*.2,se*.1,120,p,se);X?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,p,se,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ce=0;ce<=200;ce+=50){const pe=Y-ce*be;e.beginPath(),e.moveTo(w,pe),e.lineTo(w+4,pe),e.stroke(),e.fillText(`${ce}°C`,w-22,pe+2.5)}r.showLabels&&(k(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),k(e,120,he,230,he-15,t("tools.thermometerLab.labels.meniscus"),"left"),k(e,120-Q/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),k(e,120,p,230,p+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function J(e){const v=e.createLinearGradient(115,20,125,20);v.addColorStop(0,"#71717a"),v.addColorStop(.3,"#f4f4f5"),v.addColorStop(.7,"#d4d4d8"),v.addColorStop(1,"#3f3f46"),e.fillStyle=v,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let X=0;X<8;X++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const T=245,L=40,z=135,Q=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(T,L,z,Q,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(T+10,L+12,z-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(r.currentResistance.toFixed(2)+" Ω",T+z-16,L+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",T+14,L+21),r.showLabels&&(k(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),k(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function D(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,C=225,v=12,w=120-v/2,T=e.createLinearGradient(w,p,w+v,p);T.addColorStop(0,"rgba(229, 231, 235, 0.4)"),T.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),T.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),T.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=T,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,p,v,C-p,[0,0,3,3]),e.fill(),e.stroke();const L=7,z=e.createRadialGradient(120-L*.2,245-L*.2,L*.1,120,245,L);z.addColorStop(0,"#6b7280"),z.addColorStop(.7,"#1f2937"),z.addColorStop(1,"#09090b"),e.fillStyle=z,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,L,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const Q=245,X=40,q=135,K=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(Q,X,q,K,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(Q+10,X+12,q-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(r.currentThermistorR.toFixed(2)+" kΩ",Q+q-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",Q+14,X+21),r.showLabels&&(k(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),k(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Z(e,d,m,b,p,C,v,w,T){const{gx:L,gy:z,gw:Q,gh:X}=d;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(m,b),e.lineTo(m,z+X),e.stroke(),e.beginPath(),e.moveTo(m,b),e.lineTo(L,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${p.toFixed(1)}${v}`,K=e.measureText(q).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(m-K/2,z+X+2,K,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,m,z+X+4),e.textAlign="right",e.textBaseline="middle";const Y=`${C.toFixed(2)} ${w}`,re=e.measureText(Y).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(L-re-2,b-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(Y,L-7,b)}function N(e){const d=M(),{minL:m,maxL:b}=A(),{minT:p,maxT:C,tickStep:v}=B(),w=g(m,b),T=E(e,d,p,C,v,w),{gx:L,gy:z,gw:Q,gh:X,axisFont:q,yLabelX:K,xLabelY:Y,dotR:re}={...d,...T};e.save(),e.translate(K,z+X/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",L+Q/2,Y);const we=C,be=y(0,p,C,L,Q),he=S($(0),m,b,z,X),se=y(we,p,C,L,Q),ie=S($(we),m,b,z,X);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentLength;if(ce>=p&&ce<=C){const ve=y(ce,p,C,L,Q),Ce=S(pe,m,b,z,X);Z(e,d,ve,Ce,ce,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const d=M(),{minR:m,maxR:b,ticks:p}=V(),C=B(),v=E(e,d,C.minT,C.maxT,C.tickStep,p),{gx:w,gy:T,gw:L,gh:z,axisFont:Q,yLabelX:X,xLabelY:q,dotR:K}={...d,...v};e.save(),e.translate(X,T+z/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+L/2,q);const{minT:Y,maxT:re}=C,we=re,be=y(0,Y,re,w,L),he=S(u(0),m,b,T,z),se=y(we,Y,re,w,L),ie=S(u(we),m,b,T,z);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentResistance;if(ce>=Y&&ce<=re){const ve=y(ce,Y,re,w,L),Ce=S(pe,m,b,T,z);Z(e,d,ve,Ce,ce,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function le(e){const d=M(),m=B(),{minR:b,maxR:p,ticks:C}=f(m),v=E(e,d,m.minT,m.maxT,m.tickStep,C),{gx:w,gy:T,gw:L,gh:z,axisFont:Q,yLabelX:X,xLabelY:q,dotR:K}={...d,...v},{minT:Y,maxT:re}=m;e.save(),e.translate(X,T+z/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+L/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let se=Y;se<=re;se+=1){const ie=se+273.15,ce=r.thermistorR25*Math.exp(r.thermistorBeta*(1/ie-1/298.15)),pe=y(se,Y,re,w,L),ve=S(Math.min(p,ce),b,p,T,z);ve>=T&&ve<=T+z&&(we?e.lineTo(pe,ve):(e.moveTo(pe,ve),we=!0))}e.stroke();const be=r.thermometerTemp,he=r.currentThermistorR;if(be>=Y&&be<=re){const se=y(be,Y,re,w,L),ie=S(Math.min(p,he),b,p,T,z);Z(e,d,se,ie,be,he,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(se,ie,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ue(){x.clearRect(0,0,c,O),j.clearRect(0,0,R,H),x.save(),x.translate(I,0),ae(x),r.thermometerType==="liquid"?_(x):r.thermometerType==="resistance"?J(x):D(x),x.restore(),r.thermometerType==="liquid"?N(j):r.thermometerType==="resistance"?de(j):le(j)}function ge(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `}}function qe(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:d,cu:m,interval:b}=He(),p=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,C=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,v=a.querySelector("#tl-pane-q10a").classList.contains("active"),w=v?(p-d)/b*100:C,T=v?p:C/100*b+d,z=(Q=>130-Q/100*80)(w);e.innerHTML=`
    ...
    `}function ke(e){a.querySelector("#tl-bath-temp-display").innerHTML=r.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=r.bathTemp.toFixed(1)+" °C";const d=a.querySelector("#tl-bath-state");r.bathTemp<=0?d.textContent="Melting Ice Bath":r.bathTemp>=100?d.textContent="Boiling Water/Steam":r.bathTemp===150?d.textContent="Hot Cooking Oil":d.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const m=a.querySelector("#tl-alcohol-boiling-warning");r.thermometerType==="liquid"&&r.liquidType==="alcohol"&&r.bathTemp>=78?m.style.display="block":m.style.display="none",r.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=r.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):r.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=r.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=r.currentThermistorR.toFixed(2)+" kΩ",ge()}let Se=null;function _e(e){r.lastTimestamp||(r.lastTimestamp=e);const d=(e-r.lastTimestamp)/1e3;r.lastTimestamp=e;const m=Math.min(d,.1),b=ne(),p=m/b*(r.bathTemp-r.thermometerTemp);r.thermometerTemp+=p,r.currentLength=r.liquidL0+(r.liquidL100-r.liquidL0)/100*r.thermometerTemp,r.currentResistance=r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*r.thermometerTemp;const C=r.thermometerTemp+273.15;r.currentThermistorR=r.thermistorR25*Math.exp(r.thermistorBeta*(1/C-1/298.15)),te(),ue(),ke(b),Se=requestAnimationFrame(_e)}function He(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),d=parseFloat(a.querySelector("#tl-input-faulty-cu").value),m=Number.isFinite(e)?e:-1.5,b=Number.isFinite(d)?d:105,p=b-m;return{cf:m,cu:b,interval:p}}function Ee(e){const d=Math.round(e*100)/100;return d>=0?d.toFixed(1):`(${d.toFixed(1)})`}function me(){const{cf:e,cu:d,interval:m}=He(),b=a.querySelector("#tl-val-faulty-interval"),p=a.querySelector("#tl-faulty-error-a"),C=a.querySelector("#tl-faulty-error-b"),v=Math.abs(m)<.01;b.textContent=m.toFixed(1)+" °C";const w=a.querySelector("#tl-svg-formula-faulty-a"),T=a.querySelector("#tl-svg-formula-faulty-b");if(v){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",C.hidden=!1,C.textContent=p.textContent,w&&(w.innerHTML=""),T&&(T.innerHTML="");return}p.hidden=!0,C.hidden=!0;const L=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,z=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,Q=(L-e)/m*100,X=z/100*m+e;w&&(w.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${L.toFixed(1)} - ${Ee(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${d.toFixed(1)} - ${Ee(e)}</text>
      ...
      `)}function Te(){const e=r.thermometerTemp,d=r.liquidL100-r.liquidL0,m=r.liquidL0+d/100*e,b=a.querySelector("#tl-svg-formula-t-to-l");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      </section>`}async function B(){const u=je();for(const f of Le){const h=t.querySelector(`[data-note-card="${f.id}"]`);if(!h)continue;const x=h.querySelector("[data-note-body]"),G=u==="zhHant"?f.fileZh:f.fileEn,j=await ut(G),F=`./notes/${G}`;j?x.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${f.id}`)}" src="${F}"></iframe>
          <p style="margin-top:8px"><a href="${F}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:x.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function y(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${dt.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${Ta(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function S(){const u=t.querySelector("[data-tool-list]"),f=t.querySelector("[data-tool-stage]");!u||!f||(u.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>{o=h.getAttribute("data-tool"),u.querySelectorAll("button").forEach(x=>x.classList.toggle("active",x.getAttribute("data-tool")===o)),E(f)})}),E(f))}function E(u){u.innerHTML="",a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup();const f=qa[o];f&&(a=f(l),u.appendChild(a))}function g(){return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ...
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${l("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${l("summary.missing")}</p>`;continue}const G=u==="zhHant"?f.fileZh:f.fileEn,j=await ut(G),F=`./notes/${G}`;j?x.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${f.id}`)}" src="${F}"></iframe>
          <p style="margin-top:8px"><a href="${F}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:x.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const $=()=>I(),V=u=>H(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",V),I(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",V),r==null||r(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const ft={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Ht();Ft();const ht="s3phy_splash_seen",Tt={optics:pa,heat:Ca};let ze=null,Re=null;function La(){const t=location.hash.match(/^#\/(\w+)/),n=t==null?void 0:t[1];return n&&Object.prototype.hasOwnProperty.call(Tt,n)?n:null}function za(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function Ct(t){ze==null||ze(),ze=null,Re==null||Re(),Re=null;const n=document.getElementById("app");if(!n)return;if(n.innerHTML="",!t){location.hash&&za(),Re=$t(n);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}ze=Tt[t](n)??null}function Lt(){Ct(La())}function Ra(){return"./images/uniplus-logo.png"}function Ma(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
