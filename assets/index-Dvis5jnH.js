...
`;function je(){if(document.getElementById(be))return;const n=document.createElement("style");n.id=be,n.textContent=Qe,document.head.appendChild(n)}function Ne(n){je();const a=document.createElement("div");a.className="rml",a.innerHTML=`
    <div class="rml-head">
  ...
  `;const t=a.querySelector(".rml-canvas"),r=t.getContext("2d"),c=a.querySelector("[data-rml-rot]"),o=a.querySelector("[data-rml-inc]"),b=a.querySelector('[data-rml-disp="rot"]'),v=a.querySelector('[data-rml-disp="inc"]'),O=a.querySelector('[data-rml-val="i"]'),G=a.querySelector('[data-rml-val="r"]'),E=a.querySelector('[data-rml-val="shift"]'),_=350,I=380,N=300,C="#22d3ee",F="bold 17px system-ui, sans-serif";let z=0,P=-140,V=!0,j=!0,U=!0,Z=!0;function B(H){return H*Math.PI/180}function K(H,u,l,m,x,q=2,M=!1){r.beginPath(),r.lineWidth=q,r.strokeStyle=x,r.setLineDash(M?[6,6]:[]);const e=H+Math.cos(B(l))*m,i=u+Math.sin(B(l))*m;return r.moveTo(H,u),r.lineTo(e,i),r.stroke(),r.setLineDash([]),{x:e,y:i}}function J(H,u,l,m,x,q=14){const M=l-H,e=m-u,i=Math.hypot(M,e);if(i<1e-6)return;const d=M/i,h=e/i,p=l-d*q,g=m-h*q,k=.45*q;r.beginPath(),r.fillStyle=x,r.moveTo(l,m),r.lineTo(p-h*k,g+d*k),r.lineTo(p+h*k,g-d*k),r.closePath(),r.fill()}function f(H,u,l,m,x,q=25){r.beginPath(),r.strokeStyle=m,r.lineWidth=2;const M=Math.min(H,u),e=Math.max(H,u);if(r.arc(_,I,l,B(M),B(e),!1),r.stroke(),x){const i=(M+e)/2,d=_+Math.cos(B(i))*(l+q),h=I+Math.sin(B(i))*(l+q);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillStyle=m,r.fillText(x,d,h),r.restore()}}function y(H,u,l,m,x){r.clearRect(0,0,t.width,t.height),r.beginPath(),r.setLineDash([10,6]),r.strokeStyle="rgba(255, 204, 0, 0.45)",r.lineWidth=3,r.lineCap="round",r.moveTo(_-200,I),r.lineTo(_+200,I),r.stroke(),r.setLineDash([]),r.lineCap="butt";const q=_+Math.cos(B(H))*N,M=I+Math.sin(B(H))*N;r.beginPath(),r.lineWidth=3,r.strokeStyle="#fff",r.moveTo(q,M),r.lineTo(_,I),r.stroke();const e=(q+_)*.5,i=(M+I)*.5,d=Math.hypot(_-q,I-M)||1,h=(_-q)/d,p=(I-M)/d;if(J(e-h*28,i-p*28,e,i,"#fff",16),r.save(),r.font=F,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#fff",r.fillText(n("tools.rotatingMirror.canvas.incident"),q,M-12),r.restore(),V){const g=K(_,I,-90,N-60,"#00e676",1,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(n("tools.rotatingMirror.canvas.n"),g.x+6,g.y-4),r.restore()}if(j){const g=K(_,I,m,N,"#00e676",2,!1);J(_,I,g.x,g.y,"#00e676",16),r.save(),r.font=F,r.textAlign="center",r.textBaseline="bottom",r.fillStyle="#00e676",r.fillText(n("tools.rotatingMirror.canvas.originalReflected"),g.x,g.y-14),r.restore()}r.save(),r.translate(_,I),r.rotate(B(z)),r.beginPath(),r.lineWidth=6,r.strokeStyle="#ffcc00",r.lineCap="round",r.moveTo(-200,0),r.lineTo(200,0),r.stroke(),r.beginPath(),r.lineWidth=1,r.strokeStyle="#666";for(let g=-190;g<200;g+=15)r.moveTo(g,0),r.lineTo(g-5,8);if(r.stroke(),r.restore(),U){const g=K(_,I,u,N-40,C,2,!0);r.save(),r.font="bold 14px system-ui, sans-serif",r.textAlign="left",r.textBaseline="bottom",r.fillStyle=C,r.fillText(n("tools.rotatingMirror.canvas.nPrime"),g.x+6,g.y-4),r.restore()}if(Z){const g=K(_,I,l,N,C,4);J(_,I,g.x,g.y,C,16),Math.abs(z)>.5&&(r.save(),r.font=F,r.textAlign="center",r.textBaseline="bottom",r.fillStyle=C,r.fillText(n("tools.rotatingMirror.canvas.newReflected"),g.x,g.y-14),r.restore())}if(U&&f(H,u,100,"#ffcc00",`i=${x.toFixed(0)}°`,25),U&&Z&&f(u,l,100,C,`r=${x.toFixed(0)}°`,25),V&&U&&Math.abs(z)>.5&&f(-90,u,50,"#ffcc00",`θ=${Math.abs(z)}°`,20),j&&Z&&Math.abs(z)>.5){const g=l-m;f(m,l,260,"#ff5252",`${n("tools.rotatingMirror.canvas.shift")}=${g.toFixed(0)}°`,40)}}function W(){z=parseFloat(c.value),P=parseFloat(o.value);const H=z>0?"+":"";b.textContent=`${H}${z}°`,v.textContent=`${P}°`;const u=-90,l=Math.abs(P-u),m=u+l,x=-90+z,q=Math.abs(P-x),M=x+q,e=M-m;O.textContent=`${q.toFixed(1)}°`,G.textContent=`${q.toFixed(1)}°`;const i=e>0?"+":"";E.textContent=`${i}${e.toFixed(1)}°`,y(P,x,M,m,q)}return a.querySelectorAll("[data-rml-toggle]").forEach(H=>{H.addEventListener("click",()=>{const u=H.getAttribute("data-rml-toggle");u==="orig-norm"&&(V=!V),u==="orig-ray"&&(j=!j),u==="new-norm"&&(U=!U),u==="new-ray"&&(Z=!Z),H.classList.toggle("active"),W()})}),a.querySelector("[data-rml-reset]").addEventListener("click",()=>{c.value="0",W()}),c.addEventListener("input",W),o.addEventListener("input",W),W(),a}function Be(n){const a=document.createElement("div");a.className="tool-tir-escape";const t=document.createElement("iframe"),r="./",c=r.endsWith("/")?r:`${r}/`;return t.src=`${c}tir-escape/index.html?embed=1`,t.title=n("tools.refractionTir.title"),t.setAttribute("loading","lazy"),t.referrerPolicy="strict-origin-when-cross-origin",a.appendChild(t),a}function Ve(n,a={}){const t=a.defaultKind==="concave"?"concave":"convex",r="tools.lens.title",c=document.createElement("div");c.className="tool-lens-simulator";const o=document.createElement("iframe"),b="./",v=b.endsWith("/")?b:`${b}/`;return o.src=`${v}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(t)}`,o.title=n(r),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",c.appendChild(o),c}function Ge(n){const a=document.createElement("div");a.className="tool-em-spectrum";const t=document.createElement("iframe"),r="./",c=r.endsWith("/")?r:`${r}/`;function o(){return`${c}em-spectrum/index.html?lang=${encodeURIComponent(ie())}`}t.src=o(),t.title=n("tools.em.title"),t.setAttribute("loading","lazy"),t.referrerPolicy="strict-origin-when-cross-origin";const b=()=>{var v;try{(v=t.contentWindow)==null||v.postMessage({type:"s3phy:lang",lang:ie()},"*")}catch{t.src=o()}};return window.addEventListener("s3phy:lang",b),a._emLabCleanup=()=>window.removeEventListener("s3phy:lang",b),a.appendChild(t),a}function Ye(n){const a=document.createElement("div");a.className="rgb-mixer",a.innerHTML=`
  ...
  `;const o=n.querySelector("[data-main]"),b=n.querySelector("[data-nav]"),v=n.querySelector("[data-lang]"),O=n.querySelector("[data-strand-back]");let G=t;function E(C){G=C,b.innerHTML=Ue.map(F=>`<button type="button" class="${C===F?"active":""}" data-sec="${F}">${s(Ke[F])}</button>`).join(""),b.querySelectorAll("button").forEach(F=>{F.addEventListener("click",()=>r(F.getAttribute("data-sec")))})}function _(){v.innerHTML=`
    ...
    </section>`}function Ae(n,a,t,r,c={}){var m,x,q,M;const o={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},b=n.querySelector("[data-ws-gen]"),v=n.querySelector("[data-ws-preview-area]"),O=n.querySelector("[data-ws-out]"),G=n.querySelector("[data-ws-body]"),E=n.querySelector("[data-ws-paper]"),_=n.querySelector("[data-ws-tabs]"),I=n.querySelector("[data-ws-practice-actions]"),N=n.querySelector("[data-ws-score]"),C=n.querySelector("[data-ws-score-val]"),F=n.querySelector("[data-ws-summary]"),z=n.querySelector("[data-ws-date-row]"),P=n.querySelector("[data-ws-date-print]"),V=n.querySelector("[data-ws-date-today]"),j=n.querySelector("[data-ws-date-label]");if(!b||!G)return;function U(){return r()}function Z(){o.userAnswers={},o.wrongAttempts={},o.resolved={},N.hidden=!0,F.hidden=!0}function B(){return o.items.length>0&&o.items.every((e,i)=>o.resolved[i])}function K(){let e=0;o.items.forEach((d,h)=>{if(!o.resolved[h])return;const p=d[U()]||d.en;o.userAnswers[h]===p.a&&(e+=1)}),Object.keys(o.resolved).length>0&&(C.textContent=`${e}/${o.items.length}`,N.hidden=!1)}function J(e){o.tab=e,_==null||_.querySelectorAll("[data-ws-tab]").forEach(i=>{i.classList.toggle("active",i.getAttribute("data-ws-tab")===e)}),I&&(I.hidden=e!=="practice"),z&&(z.hidden=e!=="practice"),P&&(P.hidden=!o.dateStr,P.textContent=o.dateStr?`${t("worksheets.date")}: ${o.dateStr}`:""),E==null||E.classList.toggle("practice-mode",e==="practice"),y()}function f(e,i,d){const h=e[U()]||e.en,p=fe,g=i+1,k=e.section?`<span class="q-section">${ne(e.section)}</span>`:"";if(d==="answer"){const T=h.choices.map((Q,te)=>`<li class="${te===h.a?"choice-correct":""}"><strong>${p[te]}.</strong> ${ne(Q)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${g} ${k}</h4>
        <p>${ne(h.q)}</p>
        <ol class="choice-list">${T}</ol>
        <p class="q-exp"><strong>${t("worksheets.answer")}:</strong> ${p[h.a]}</p>
        <p class="q-exp"><em>${ne(h.exp)}</em></p>
      </div>`}const S=o.userAnswers[i],A=o.wrongAttempts[i]||0,L=o.resolved[i],$=L&&S===h.a,R=L&&S!==h.a;let Y="";A===1&&!L?Y=`<p class="q-hint"><strong>${t("worksheets.hint")}:</strong> ${ne(h.hint||h.exp)}</p>`:R&&(Y=`<p class="q-exp"><strong>${t("worksheets.answer")}:</strong> ${p[h.a]}</p>
        <p class="q-exp q-summary"><em>${ne(h.exp)}</em></p>`);const w=$?"correct":R?"incorrect":"",X=h.choices.map((T,Q)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${i}" value="${Q}" data-ws-q="${i}" data-ws-choice="${Q}"${S===Q?" checked":""}${L?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${p[Q]}.</strong> ${ne(T)}
          </label>
        </li>`).join("");return`<div class="question-row ${w}" data-ws-row="${i}">
      <div class="q-header"><h4>Q${g} ${k}</h4>${$?'<span class="result-icon">✓</span>':R?'<span class="result-icon">✗</span>':""}</div>
      <p>${ne(h.q)}</p>
      <ol class="choice-list choice-list--radio">${X}</ol>
      ${Y}
    </div>`}function y(){o.items.length&&(G.innerHTML=o.items.map((e,i)=>f(e,i,o.tab)).join(""),W())}function W(){o.tab==="practice"&&G.querySelectorAll("[data-ws-choice]").forEach(e=>{e.addEventListener("change",()=>{const i=Number(e.getAttribute("data-ws-q"));if(o.resolved[i])return;const d=Number(e.getAttribute("data-ws-choice")),h=o.items[i][U()]||o.items[i].en;o.userAnswers[i]=d,d===h.a?o.resolved[i]=!0:(o.wrongAttempts[i]=(o.wrongAttempts[i]||0)+1,o.wrongAttempts[i]>=2&&(o.resolved[i]=!0)),K(),B()&&H(),y()})})}function H(){const e=o.items.length;let i=0,d=0;const h={};o.items.forEach((S,A)=>{const L=S[U()]||S.en;if(o.userAnswers[A]===L.a)i+=1,(o.wrongAttempts[A]||0)===0&&(d+=1);else if(o.resolved[A]){const R=S.section||S.topic;h[R]=(h[R]||0)+1}});const p=e?Math.round(i/e*100):0;let g=t("worksheets.revisionFair");p>=90?g=t("worksheets.revisionExcellent"):p>=70?g=t("worksheets.revisionGood"):p<50&&(g=t("worksheets.revisionLow"));const k=Object.entries(h).sort((S,A)=>A[1]-S[1]).map(([S,A])=>`<li>${ne(S)} (${A})</li>`).join("");F.innerHTML=`
      <h4>${t("worksheets.sessionSummary")}</h4>
      <p>${t("worksheets.score")}: <strong>${i}/${e}</strong> (${p}%)</p>
      <p>${t("worksheets.firstTry")}: <strong>${d}/${e}</strong></p>
      <p>${t("worksheets.revisionSuggestions")}: ${g}</p>
      ${k?`<p>${t("worksheets.weakSections")}:</p><ul>${k}</ul>`:""}`,F.hidden=!1}function u(e){const i=U(),d=o.items.map((h,p)=>{const g=h[i]||h.en,k=g.choices.map((A,L)=>`${fe[L]}. ${A}`).join("<br/>"),S=e?`<p><b>${t("worksheets.answer")}:</b> ${fe[g.a]}<br/><i>${g.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${p+1}.</b> ${g.q}<br/>${k}${S}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${d}</body></html>`}function l(e){const i=u(e),d=new Blob(["\uFEFF",i],{type:"application/msword"}),h=document.createElement("a");h.href=URL.createObjectURL(d),h.download=e?"worksheet-answers.doc":"worksheet.doc",h.click(),URL.revokeObjectURL(h.href)}b.addEventListener("click",()=>{const e=Number(n.querySelector("[data-ws-count]").value),i=[...n.querySelectorAll("[data-ws-topic]")].filter(p=>p.checked).map(p=>p.getAttribute("data-ws-topic")),d=Xe(a,i,c.topicFilter),h=ve(d).slice(0,Math.min(e,d.length||1));o.items=h.length?h:ve(a).slice(0,Math.min(e,a.length)),Z(),o.tab="practice",o.dateStr="",v.hidden=!1,O.hidden=!0,_==null||_.querySelectorAll("[data-ws-tab]").forEach(p=>{p.classList.toggle("active",p.getAttribute("data-ws-tab")==="practice")}),I&&(I.hidden=!1),z&&(z.hidden=!1),P&&(P.hidden=!0),j.textContent="",E==null||E.classList.add("practice-mode"),y()}),_==null||_.addEventListener("click",e=>{const i=e.target.closest("[data-ws-tab]");!i||!o.items.length||J(i.getAttribute("data-ws-tab"))}),V==null||V.addEventListener("click",()=>{o.dateStr?(o.dateStr="",j.textContent=""):(o.dateStr=Ze(),j.textContent=`${t("worksheets.date")}: ${o.dateStr}`),P&&(P.hidden=!o.dateStr,P.textContent=o.dateStr?`${t("worksheets.date")}: ${o.dateStr}`:"")}),(m=n.querySelector("[data-ws-word-p]"))==null||m.addEventListener("click",()=>l(!1)),(x=n.querySelector("[data-ws-word-a]"))==null||x.addEventListener("click",()=>l(!0)),(q=n.querySelector("[data-ws-print-p]"))==null||q.addEventListener("click",()=>{J("practice"),E==null||E.classList.add("ws-print-blank");const e=()=>E==null?void 0:E.classList.remove("ws-print-blank");window.addEventListener("afterprint",e,{once:!0}),window.print()}),(M=n.querySelector("[data-ws-print-a]"))==null||M.addEventListener("click",()=>{J("answer"),window.print()})}const Je=["rotatingMirror","refractionTir","lens","rgbMixer","em"],et={rotatingMirror:n=>Ne(n),refractionTir:n=>Be(n),lens:(n,a)=>Ve(n,{defaultKind:a}),rgbMixer:n=>Ye(n),em:n=>Ge(n)};function tt(n){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[n]||n)}function de(){return ie()==="zh-Hant"?"zhHant":"en"}async function Le(n,a){const t=`./${n}/${a}`;try{return(await fetch(t,{method:"HEAD"})).ok}catch{return!1}}async function at(n){return Le("notes",n)}function nt(n){let a="topics",t="rotatingMirror",r="convex",c=0,o="all",b=!1,v=null,O={main:null};function G(){O.main&&(a==="topics"?O.main.innerHTML=_():a==="notes"?O.main.innerHTML=N():a==="tools"?O.main.innerHTML=F():a==="worksheets"?O.main.innerHTML=He(s):a==="flashcards"?O.main.innerHTML=V():a==="summary"&&(O.main.innerHTML=f()),a==="notes"&&C(),a==="tools"&&z(),a==="worksheets"&&Ae(n,_e,s,de),a==="flashcards"&&J(),a==="summary"&&y())}function E(){v==null||v.destroy(),v=Re(n,{subtitleKey:"strand.optics.subtitle",activeSection:a,onSection:u=>{a=u,v.updateSection(a),G()},onLang:()=>E()}),O.main=v.main,v.updateSection(a),G()}function _(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([l,m])=>{const x=l==="convex"||l==="concave"?"lens":l==="refraction"||l==="tir"?"refractionTir":l==="em"?"em":l,q=l==="convex"?"convex":l==="concave"?"concave":"";return`
            <div class="card">
              <h3>${s(m)}</h3>
              <button class="btn primary" type="button" data-go-tool="${x}"${q?` data-lens-kind="${q}"`:""}>${s("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function I(u){const l=u.target.closest("[data-go-tool]");if(!l)return;a="tools",t=l.getAttribute("data-go-tool");const m=l.getAttribute("data-lens-kind");(m==="convex"||m==="concave")&&(r=m),v.updateSection(a),G()}function N(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${u.map(l=>{const m=s(`notes.card.${l.key}`);return`
            <div class="card" data-note-card="${l.key}">
              <h3>${m}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function C(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],l=de();for(const m of u){const x=n.querySelector(`[data-note-card="${m.key}"]`);if(!x)continue;const q=x.querySelector("[data-note-body]"),M=l==="zhHant"?m.fileZh:m.fileEn,e=await at(M),i=`./notes/${M}`;e?q.innerHTML=`
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Je.map(u=>`<button type="button" data-tool="${u}" class="${t===u?"active":""}">${tt(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function z(){const u=n.querySelector("[data-tool-list]"),l=n.querySelector("[data-tool-stage]");!u||!l||(u.querySelectorAll("button").forEach(m=>{m.addEventListener("click",()=>{t=m.getAttribute("data-tool"),u.querySelectorAll("button").forEach(x=>x.classList.toggle("active",x.getAttribute("data-tool")===t)),P(l)})}),P(l))}function P(u){u.innerHTML="";const l=et[t];if(!l)return;const m=t==="lens"?l(s,r):l(s);u.appendChild(m)}function V(){return`
      <section class="panel">
      ...
      </section>`}function j(u){return!!(u!=null&&u.front)}function U(u){return`./${String(u).replace(/^\.\//,"")}`}function Z(){return Me.slice()}function B(){const u=Oe.slice(),l=Z(),m=o==="rotatingMirror"?"reflection":o;if(m==="all")return[...u,...l];if(m==="reflection")return u;if(m==="convex"||m==="concave"){const q=l.filter(M=>M.topic==="convex"||M.topic==="concave");return q.length?q:l}if(m==="refractionTir"){const q=l.filter(M=>M.topic==="refraction"||M.topic==="tir");return q.length?q:l}const x=l.filter(q=>q.topic===m);return x.length?x:l}function K(){const u=B(),l=n.querySelector("[data-flash-progress]");if(!u.length){c=0;const d=n.querySelector("[data-flash-front]"),h=n.querySelector("[data-flip-card]");d&&(d.textContent=""),h&&h.classList.remove("flashcard-surface--image"),l&&(l.hidden=!0,l.textContent="");return}c=Math.max(0,Math.min(c,u.length-1));const m=u[c],x=n.querySelector("[data-flash-front]"),q=n.querySelector("[data-flip-card]"),M=n.querySelector("[data-flash-label]");if(!x||!q)return;if(l&&(l.hidden=!1,l.textContent=s("flashcards.progress").replace("{current}",String(c+1)).replace("{total}",String(u.length))),j(m)){const d=m.back&&m.back!==m.front;q.classList.add("flashcard-surface--image"),M&&(d?(M.hidden=!1,M.textContent=s(b?"flashcards.answer":"flashcards.question")):M.hidden=!0);const h=b&&m.back?m.back:m.front,p=m.alt||m.title||"";x.innerHTML=`<img src="${U(h)}" alt="${p.replace(/"/g,"&quot;")}" loading="lazy" />`;return}q.classList.remove("flashcard-surface--image");const e=de(),i=m[e]||m.en;M&&(M.hidden=!1,M.textContent=s(b?"flashcards.answer":"flashcards.question")),x.textContent=b?i.a:i.q}function J(){o==="rotatingMirror"&&(o="reflection");const u=n.querySelector("[data-flash-deck]");u.value=o,u.addEventListener("change",()=>{o=u.value,c=0,b=!1,K()}),n.querySelector("[data-flip-card]").addEventListener("click",()=>{b=!b,K()}),n.querySelector("[data-flash-flip]").addEventListener("click",l=>{l.stopPropagation(),b=!b,K()}),n.querySelector("[data-flash-prev]").addEventListener("click",()=>{const l=B();c=(c-1+l.length)%l.length,b=!1,K()}),n.querySelector("[data-flash-next]").addEventListener("click",()=>{const l=B();c=(c+1)%l.length,b=!1,K()}),n.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const l=B();c=Math.floor(Math.random()*l.length),b=!1,K()}),K()}function f(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${u.map(l=>{const m=s(`summary.item.${l.key}`);return`
            <div class="card" data-summary-card="${l.key}">
              <h3>${m}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function y(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],l=de();for(const m of u){const x=n.querySelector(`[data-summary-card="${m.key}"]`);if(!x)continue;const q=x.querySelector("[data-summary-body]"),M=l==="zhHant"?m.fileZh:m.fileEn,e=await Le("summary-pdfs",M),i=`./summary-pdfs/${M}`;e?q.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${m.key}`)}" src="${i}"></iframe>
          <p style="margin-top:8px"><a href="${i}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:q.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const W=()=>E(),H=u=>I(u);return window.addEventListener("s3phy:lang",W),n.addEventListener("click",H),E(),()=>{window.removeEventListener("s3phy:lang",W),n.removeEventListener("click",H),v==null||v.destroy()}}const ye="s3phy-thermometer-lab-css",it=`
.tl-wrap {
  --tl-bg: #0d0d10;
  --tl-panel: #18181b;
  --tl-border: #27272a;
...
`;function rt(){if(document.getElementById(ye))return;const n=document.createElement("style");n.id=ye,n.textContent=it,document.head.appendChild(n)}function ot(n){rt();const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
  ...
  `;const t={liquidType:"mercury",thermometerType:"liquid",bulbVolume:200,wallThickness:.5,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0},r=460,c=300,o=80,b=560,v=380;function O(){const e={left:72,top:48,right:24,bottom:52};return{gx:e.left,gy:e.top,gw:b-e.left-e.right,gh:v-e.top-e.bottom,tickFont:`${Math.round(b*.02)}px Arial`,axisFont:`bold ${Math.round(b*.022)}px Arial`,dotR:5,yLabelX:e.left-34,xLabelY:v-e.bottom+18}}const G=a.querySelector("#tl-thermometerCanvas"),E=G.getContext("2d"),_=a.querySelector("#tl-graphCanvas"),I=_.getContext("2d"),N=window.devicePixelRatio||1;G.width=r*N,G.height=c*N,E.scale(N,N),_.width=b*N,_.height=v*N,I.scale(N,N);function C(){t.iceCubes=[];for(let e=0;e<4;e++)t.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:10+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});t.bubbles=[];for(let e=0;e<15;e++)t.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3,speedY:.6+Math.random()*1.2,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});t.heatWaves=[];for(let e=0;e<6;e++)t.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:12+Math.random()*15,speedY:.4+Math.random()*.5,opacity:.1+Math.random()*.25})}function F(){if(t.thermometerType==="resistance"||t.thermometerType==="thermistor")return .35;const e=t.liquidType==="mercury"?1:8,i=.2+t.wallThickness*1.5,d=.4+t.bulbVolume*.003;return Math.max(.1,i*d*e*.15)}function z(e){t.bathTemp<=8&&t.iceCubes.forEach(i=>{i.x+=i.speedX,i.y+=i.speedY,(i.x<65||i.x>175)&&(i.speedX*=-1),(i.y<195||i.y>210)&&(i.speedY*=-1)}),t.bathTemp>35&&t.heatWaves.forEach(i=>{i.y-=i.speedY*(1+t.bathTemp/100),i.y<185&&(i.y=265,i.x=65+Math.random()*110)}),t.bathTemp>=80&&t.bubbles.forEach(i=>{i.y-=i.speedY*(1+(t.bathTemp-80)/40),i.phase+=i.wobbleSpeed,i.x+=Math.sin(i.phase)*.2,i.y<185&&(i.y=260+Math.random()*10,i.x=60+Math.random()*120)})}function P(e){let k=59,S=130,A=246;if(t.bathTemp<25){const w=t.bathTemp/25;k=Math.round(180-w*121),S=Math.round(210-w*80),A=Math.round(250-w*4)}else{const w=Math.min(1,(t.bathTemp-25)/125);k=Math.round(59+w*180),S=Math.round(130-w*100),A=Math.round(246-w*190)}if(t.bathTemp>40){const w=Math.min(1,(t.bathTemp-40)/100),X=Date.now()*.02;e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-20,284);for(let D=-20;D<=20;D+=8){const T=w*(10+Math.sin(D*.3+X)*4);e.lineTo(55+130/2+D,284-T)}e.lineTo(55+130/2+20,284),e.closePath(),e.fill()}e.strokeStyle="#9ca3af",e.lineWidth=2,e.fillStyle="#1f1f23",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const L=e.createLinearGradient(55,190,55,280);L.addColorStop(0,`rgba(${k}, ${S}, ${A}, 0.3)`),L.addColorStop(1,`rgba(${k}, ${S}, ${A}, 0.6)`),e.fillStyle=L,e.beginPath(),e.moveTo(55,190);const $=t.bathTemp>=80?1.5:.4,R=t.bathTemp>=80?.08:.03,Y=Date.now()*R;for(let w=55;w<=185;w+=5){const X=190+Math.sin(w*.15+Y)*$;e.lineTo(w,X)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),t.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.4,(t.bathTemp-35)/120)})`,e.lineWidth=1,t.heatWaves.forEach(w=>{e.beginPath(),e.moveTo(w.x,w.y),e.quadraticCurveTo(w.x+Math.sin(w.y*.06)*4,w.y-w.length/2,w.x,w.y-w.length),e.stroke()})),t.bathTemp<=8&&(e.fillStyle="rgba(255, 255, 255, 0.6)",e.strokeStyle="rgba(147, 197, 253, 0.8)",e.lineWidth=.8,t.iceCubes.forEach(w=>{e.save(),e.translate(w.x,w.y),e.rotate(w.angle),e.beginPath(),e.roundRect(-w.size/2,-w.size/2,w.size,w.size,2),e.fill(),e.stroke(),e.restore()})),t.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.5)",e.strokeStyle="rgba(255, 255, 255, 0.7)",e.lineWidth=.5,t.bubbles.forEach(w=>{e.beginPath(),e.arc(w.x,w.y,w.r,0,Math.PI*2),e.fill(),e.stroke()})),e.strokeStyle="#4b5563",e.lineWidth=3,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke()}function V(e){const k=8+t.wallThickness*8,S=120-k/2,A=120+k/2,L=e.createLinearGradient(S,20,A,20);L.addColorStop(0,"rgba(209, 213, 219, 0.85)"),L.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),L.addColorStop(.5,"rgba(243, 244, 246, 0.2)"),L.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),L.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=L,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(S,230),e.lineTo(S,25),e.arcTo(S,20,S+5,20,5),e.arcTo(A,20,A,25,5),e.lineTo(A,230),e.closePath(),e.fill(),e.stroke();const $=e.createRadialGradient(120-11*.2,250-11*.2,11*.1,120,250,11);$.addColorStop(0,"rgba(255, 255, 255, 0.7)"),$.addColorStop(1,"rgba(156, 163, 175, 0.3)"),e.fillStyle=$,e.strokeStyle="#6b7280",e.lineWidth=.8+t.wallThickness*.6,e.beginPath(),e.arc(120,250,11+.5+t.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const R=1.5;e.fillStyle="#111827",e.fillRect(120-R/2,28,R,202);const Y=t.liquidType==="mercury",w=Y?"#9ca3af":"#ef4444",X=Y?"#f3f4f6":"#fecaca",D=210,T=220,te=(D-40)/T,ee=D-Math.min(T,t.thermometerTemp)*te;e.fillStyle=w,e.fillRect(120-R/2,ee,R,230-ee),e.fillStyle=X,e.fillRect(120-R/6,ee,R/3,230-ee);const re=11*.9,ae=e.createRadialGradient(120-re*.2,250-re*.2,re*.1,120,250,re);Y?(ae.addColorStop(0,"#f3f4f6"),ae.addColorStop(.3,"#d1d5db"),ae.addColorStop(.8,"#9ca3af"),ae.addColorStop(1,"#4b5563")):(ae.addColorStop(0,"#fee2e2"),ae.addColorStop(.2,"#fca5a5"),ae.addColorStop(.7,"#ef4444"),ae.addColorStop(1,"#991b1b")),e.fillStyle=ae,e.beginPath(),e.arc(120,250,re,0,Math.PI*2),e.fill(),e.strokeStyle="#4b5563",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa";for(let ce=0;ce<=200;ce+=50){const me=D-ce*te;e.beginPath(),e.moveTo(S,me),e.lineTo(S+4,me),e.stroke(),e.fillText(`${ce}°C`,S-22,me+2.5)}}function j(e){const k=e.createLinearGradient(116,20,124,20);k.addColorStop(0,"#9ca3af"),k.addColorStop(.3,"#f3f4f6"),k.addColorStop(.7,"#d1d5db"),k.addColorStop(1,"#6b7280"),e.fillStyle=k,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(116,20,8,225,[0,0,3,3]),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,A=40,L=135,$=90;e.fillStyle="#1e1b4b",e.strokeStyle="#4f46e5",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,A,L,$,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,A+12,L-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(t.currentResistance.toFixed(2)+" Ω",S+L-16,A+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,A+21)}function U(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,g=225,k=10,S=120-k/2,A=e.createLinearGradient(S,p,S+k,p);A.addColorStop(0,"rgba(229, 231, 235, 0.4)"),A.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),A.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),A.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=A,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(S,p,k,g-p,[0,0,2,2]),e.fill(),e.stroke();const L=6,$=e.createRadialGradient(120-L*.2,245-L*.2,L*.1,120,245,L);$.addColorStop(0,"#4b5563"),$.addColorStop(.7,"#1f2937"),$.addColorStop(1,"#111827"),e.fillStyle=$,e.strokeStyle="#030712",e.lineWidth=1,e.beginPath(),e.arc(120,245,L,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const R=245,Y=40,w=135,X=90;e.fillStyle="#111827",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(R,Y,w,X,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(R+10,Y+12,w-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(t.currentThermistorR.toFixed(2)+" kΩ",R+w-16,Y+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",R+14,Y+21)}function Z(e){const{gx:i,gy:d,gw:h,gh:p,tickFont:g,axisFont:k,dotR:S,yLabelX:A,xLabelY:L}=O();e.strokeStyle="#4b5563",e.lineWidth=1.4,e.beginPath(),e.moveTo(i,d),e.lineTo(i,d+p),e.lineTo(i+h,d+p),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.6,e.fillStyle="#a1a1aa",e.font=g,e.textAlign="right",e.textBaseline="middle";const $=25,R=200;for(let T=0;T<=$;T+=5){const Q=d+p-T/$*p;e.beginPath(),e.moveTo(i,Q),e.lineTo(i+h,Q),e.stroke(),e.fillText(`${T.toFixed(1)}`,i-8,Q)}e.textAlign="center",e.textBaseline="top";for(let T=0;T<=R;T+=40){const Q=i+T/R*h;e.beginPath(),e.moveTo(Q,d),e.lineTo(Q,d+p),e.stroke(),e.fillText(`${T}`,Q,d+p+6)}e.save(),e.translate(A,d+p/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=k,e.fillText("temperature / °C",i+h/2,L);const Y=d+p-t.liquidL0/$*p,w=d+p-(t.liquidL0+(t.liquidL100-t.liquidL0)/100*R)/$*p;e.strokeStyle="#ef4444",e.lineWidth=2,e.beginPath(),e.moveTo(i,Y),e.lineTo(i+h,w),e.stroke();const X=t.thermometerTemp,D=t.currentLength;if(X>=0&&X<=R){const T=i+X/R*h,Q=d+p-D/$*p;e.fillStyle="#ef4444",e.beginPath(),e.arc(T,Q,S,0,Math.PI*2),e.fill()}}function B(e){const{gx:i,gy:d,gw:h,gh:p,tickFont:g,axisFont:k,dotR:S,yLabelX:A,xLabelY:L}=O();e.strokeStyle="#4b5563",e.lineWidth=1.4,e.beginPath(),e.moveTo(i,d),e.lineTo(i,d+p),e.lineTo(i+h,d+p),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.6,e.fillStyle="#a1a1aa",e.font=g,e.textAlign="right",e.textBaseline="middle";const $=10,R=200;for(let T=0;T<=$;T+=2){const Q=d+p-T/$*p;e.beginPath(),e.moveTo(i,Q),e.lineTo(i+h,Q),e.stroke(),e.fillText(`${T.toFixed(1)}`,i-8,Q)}e.textAlign="center",e.textBaseline="top";for(let T=0;T<=R;T+=40){const Q=i+T/R*h;e.beginPath(),e.moveTo(Q,d),e.lineTo(Q,d+p),e.stroke(),e.fillText(`${T}`,Q,d+p+6)}e.save(),e.translate(A,d+p/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=k,e.fillText("temperature / °C",i+h/2,L);const Y=d+p-t.resistanceR0/$*p,w=d+p-(t.resistanceR0+(t.resistanceR100-t.resistanceR0)/100*R)/$*p;e.strokeStyle="#4f46e5",e.lineWidth=2,e.beginPath(),e.moveTo(i,Y),e.lineTo(i+h,w),e.stroke();const X=t.thermometerTemp,D=t.currentResistance;if(X>=0&&X<=R){const T=i+X/R*h,Q=d+p-D/$*p;e.fillStyle="#4f46e5",e.beginPath(),e.arc(T,Q,S,0,Math.PI*2),e.fill()}}function K(e){const{gx:i,gy:d,gw:h,gh:p,tickFont:g,axisFont:k,dotR:S,yLabelX:A,xLabelY:L}=O();e.strokeStyle="#4b5563",e.lineWidth=1.4,e.beginPath(),e.moveTo(i,d),e.lineTo(i,d+p),e.lineTo(i+h,d+p),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.6,e.fillStyle="#a1a1aa",e.font=g,e.textAlign="right",e.textBaseline="middle";const $=20,R=200;for(let D=0;D<=$;D+=4){const T=d+p-D/$*p;e.beginPath(),e.moveTo(i,T),e.lineTo(i+h,T),e.stroke(),e.fillText(`${D.toFixed(1)}`,i-8,T)}e.textAlign="center",e.textBaseline="top";for(let D=0;D<=R;D+=40){const T=i+D/R*h;e.beginPath(),e.moveTo(T,d),e.lineTo(T,d+p),e.stroke(),e.fillText(`${D}`,T,d+p+6)}e.save(),e.translate(A,d+p/2),e.rotate(-Math.PI/2),e.font=k,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=k,e.fillText("temperature / °C",i+h/2,L),e.strokeStyle="#10b981",e.lineWidth=2,e.beginPath();let Y=!1;for(let D=0;D<=R;D+=2){const T=D+273.15,Q=t.thermistorR25*Math.exp(t.thermistorBeta*(1/T-1/298.15)),te=i+D/R*h,ee=d+p-Math.min($,Q)/$*p;ee>=d&&ee<=d+p&&(Y?e.lineTo(te,ee):(e.moveTo(te,ee),Y=!0))}e.stroke();const w=t.thermometerTemp,X=t.currentThermistorR;if(w>=0&&w<=R){const D=i+w/R*h,T=d+p-Math.min($,X)/$*p;e.fillStyle="#10b981",e.beginPath(),e.arc(D,T,S,0,Math.PI*2),e.fill()}}function J(){E.clearRect(0,0,r,c),I.clearRect(0,0,b,v),E.save(),E.translate(o,0),P(E),t.thermometerType==="liquid"?V(E):t.thermometerType==="resistance"?j(E):U(E),E.restore(),t.thermometerType==="liquid"?Z(I):t.thermometerType==="resistance"?B(I):K(I)}function f(e){a.querySelector("#tl-bath-temp-display").innerHTML=t.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=t.bathTemp.toFixed(1)+" °C";const i=a.querySelector("#tl-bath-state");t.bathTemp<=0?i.textContent="Melting Ice Bath":t.bathTemp>=100?i.textContent="Boiling Water/Steam":t.bathTemp===150?i.textContent="Hot Cooking Oil":i.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const d=a.querySelector("#tl-alcohol-boiling-warning");if(t.thermometerType==="liquid"&&t.liquidType==="alcohol"&&t.bathTemp>=78?d.style.display="block":d.style.display="none",t.thermometerType==="liquid")a.querySelector("#tl-live-liquid-lt").textContent=t.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-sub-num").textContent=`${t.currentLength.toFixed(2)} - ${t.liquidL0.toFixed(1)}`,a.querySelector("#tl-live-liquid-sub-den").textContent=`${t.liquidL100.toFixed(1)} - ${t.liquidL0.toFixed(1)}`,a.querySelector("#tl-live-liquid-ans").textContent=t.thermometerTemp.toFixed(1)+"°C";else if(t.thermometerType==="resistance")a.querySelector("#tl-live-resistance-rt").textContent=t.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-sub-num").textContent=`${t.currentResistance.toFixed(2)} - ${t.resistanceR0.toFixed(1)}`,a.querySelector("#tl-live-resistance-sub-den").textContent=`${t.resistanceR100.toFixed(1)} - ${t.resistanceR0.toFixed(1)}`,a.querySelector("#tl-live-resistance-ans").textContent=t.thermometerTemp.toFixed(1)+"°C";else{a.querySelector("#tl-live-thermistor-rt").textContent=t.currentThermistorR.toFixed(2)+" kΩ";const h=t.thermometerTemp+273.15;a.querySelector("#tl-live-thermistor-calc-tk").textContent=h.toFixed(2),a.querySelector("#tl-live-thermistor-ans").textContent=t.thermometerTemp.toFixed(1)+"°C"}}let y=null;function W(e){t.lastTimestamp||(t.lastTimestamp=e);const i=(e-t.lastTimestamp)/1e3;t.lastTimestamp=e;const d=Math.min(i,.1),h=F(),p=d/h*(t.bathTemp-t.thermometerTemp);t.thermometerTemp+=p,t.currentLength=t.liquidL0+(t.liquidL100-t.liquidL0)/100*t.thermometerTemp,t.currentResistance=t.resistanceR0+(t.resistanceR100-t.resistanceR0)/100*t.thermometerTemp;const g=t.thermometerTemp+273.15;t.currentThermistorR=t.thermistorR25*Math.exp(t.thermistorBeta*(1/g-1/298.15)),z(),J(),f(h),y=requestAnimationFrame(W)}function H(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),i=parseFloat(a.querySelector("#tl-input-faulty-cu").value),d=Number.isFinite(e)?e:-1.5,h=Number.isFinite(i)?i:105,p=h-d;return{cf:d,cu:h,interval:p}}function u(e){const i=Math.round(e*100)/100;return i>=0?i.toFixed(1):`(${i.toFixed(1)})`}function l(){const{cf:e,cu:i,interval:d}=H(),h=a.querySelector("#tl-val-faulty-interval"),p=a.querySelector("#tl-faulty-error-a"),g=a.querySelector("#tl-faulty-error-b"),k=a.querySelector("#tl-ans-q10a"),S=a.querySelector("#tl-ans-q10b"),A=Math.abs(d)<.01;if(h.textContent=d.toFixed(1)+" °C",A){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",g.hidden=!1,g.textContent=p.textContent,k.textContent="—",S.textContent="—";return}p.hidden=!0,g.hidden=!0;const L=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,$=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,R=(L-e)/d*100,Y=$/100*d+e;a.querySelector("#tl-faulty-sub-num-a").textContent=`${L.toFixed(1)} − ${u(e)}`,a.querySelector("#tl-faulty-sub-den-a").textContent=`${i.toFixed(1)} − ${u(e)}`,a.querySelector("#tl-faulty-sub-num-b").textContent=`${$.toFixed(1)} × ${d.toFixed(1)}`,a.querySelector("#tl-faulty-sub-cf-b").textContent=`+ ${u(e)}`,k.textContent=R.toFixed(1)+" °C",S.textContent=Y.toFixed(2)+" °C"}function m(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,i=(e-t.resistanceR0)/(t.resistanceR100-t.resistanceR0)*100;a.querySelector("#tl-formula-q11-rsub").textContent=e.toFixed(1),a.querySelector("#tl-ans-q11").textContent=i.toFixed(1)+" °C"}function x(){l(),m()}function q(e,i){a.querySelector("#"+e).addEventListener("click",()=>{t.bathTemp=i,a.querySelector("#tl-bath-temp-slider").value=i,x()})}function M(){a.querySelectorAll(".tl-tab-btn").forEach(i=>{i.addEventListener("click",()=>{a.querySelectorAll(".tl-tab-btn").forEach(h=>h.classList.remove("active")),a.querySelectorAll(".tl-tab-content").forEach(h=>h.classList.remove("active")),i.classList.add("active");const d=i.getAttribute("data-tl-tab");a.querySelector("#tl-tab-"+d).classList.add("active"),t.thermometerType=d,x()})}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",i=>{t.bathTemp=parseFloat(i.target.value),x()}),q("tl-btn-preset-ice",0),q("tl-btn-preset-room",25),q("tl-btn-preset-steam",100),q("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{t.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-radio-card active-mercury",a.querySelector("#tl-card-alcohol").className="tl-radio-card",x()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{t.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-radio-card",a.querySelector("#tl-card-alcohol").className="tl-radio-card active-alcohol",x()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",i=>{t.bulbVolume=parseFloat(i.target.value),a.querySelector("#tl-val-bulb-vol").textContent=t.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",i=>{t.wallThickness=parseFloat(i.target.value),a.querySelector("#tl-val-wall-thickness").textContent=t.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",i=>{t.liquidL0=parseFloat(i.target.value),a.querySelector("#tl-val-liquid-l0").textContent=t.liquidL0.toFixed(1)+" cm",x()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",i=>{t.liquidL100=parseFloat(i.target.value),a.querySelector("#tl-val-liquid-l100").textContent=t.liquidL100.toFixed(1)+" cm",x()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",i=>{t.resistanceR0=parseFloat(i.target.value),a.querySelector("#tl-val-resistance-r0").textContent=t.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=t.resistanceR0.toFixed(1)+" Ω",x()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",i=>{t.resistanceR100=parseFloat(i.target.value),a.querySelector("#tl-val-resistance-r100").textContent=t.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=t.resistanceR100.toFixed(1)+" Ω",x()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",i=>{t.thermistorR25=parseFloat(i.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=t.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=t.thermistorR25.toFixed(1)+" kΩ",x()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",i=>{t.thermistorBeta=parseFloat(i.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=t.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=t.thermistorBeta+" K",x()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active")}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active")}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",l),a.querySelector("#tl-input-faulty-cu").addEventListener("input",l),a.querySelector("#tl-input-q10a-cm").addEventListener("input",l),a.querySelector("#tl-input-q10b-t").addEventListener("input",l),a.querySelector("#tl-input-q11-r").addEventListener("input",m)}return C(),M(),x(),y=requestAnimationFrame(W),a._thermometerLabCleanup=()=>{y&&cancelAnimationFrame(y)},a}const oe=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"thermometerLab"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],ge=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],st=[["thermometer","topic.thermometer"]];function ue(){return ie()==="zh-Hant"?"zhHant":"en"}async function lt(n,a){const t=`./${n}/${a}`;try{return(await fetch(t,{method:"HEAD"})).ok}catch{return!1}}async function we(n){return lt("notes",n)}function ct(n){let a="topics",t=0,r="all",c=!1,o=null,b={main:null},v=null;function O(){if(b.main){if(a==="topics"?b.main.innerHTML=E():a==="notes"?b.main.innerHTML=I():a==="tools"?b.main.innerHTML=C():a==="worksheets"?b.main.innerHTML=He(s,{topics:st,paperTitleKey:"worksheets.paperTitleHeat"}):a==="flashcards"?b.main.innerHTML=z():a==="summary"&&(b.main.innerHTML=Z()),a==="notes"&&N(),a==="tools"&&F(),a==="worksheets"){const f=_e.filter(y=>ge.includes(y.topic));Ae(n,f,s,ue,{topicFilter:(y,W)=>W.includes("thermometer")?ge.includes(y.topic):W.includes(y.topic)})}a==="flashcards"&&U(),a==="summary"&&B()}}function G(){o==null||o.destroy(),o=Re(n,{subtitleKey:"strand.heat.subtitle",activeSection:a,onSection:f=>{a=f,o.updateSection(a),O()},onLang:()=>G()}),b.main=o.main,o.updateSection(a),O()}function E(){return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
      ...
      </section>`}async function N(){const f=ue();for(const y of oe){const W=n.querySelector(`[data-note-card="${y.id}"]`);if(!W)continue;const H=W.querySelector("[data-note-body]"),u=f==="zhHant"?y.fileZh:y.fileEn,l=await we(u),m=`./notes/${u}`;l?H.innerHTML=`
      ...
      </section>`}async function B(){const f=ue();for(const y of oe){const W=n.querySelector(`[data-summary-card="${y.id}"]`);if(!W)continue;const H=W.querySelector("[data-summary-body]"),u=f==="zhHant"?y.fileZh:y.fileEn,l=await we(u),m=`./notes/${u}`;l?H.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${y.id}`)}" src="${m}"></iframe>
          <p style="margin-top:8px"><a href="${m}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:H.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const K=()=>G(),J=f=>_(f);return window.addEventListener("s3phy:lang",K),n.addEventListener("click",J),G(),()=>{window.removeEventListener("s3phy:lang",K),n.removeEventListener("click",J),v!=null&&v._thermometerLabCleanup&&v._thermometerLabCleanup(),o==null||o.destroy()}}const xe={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};We();const qe="s3phy_splash_seen",$e={optics:nt,heat:ct};let se=null,le=null;function dt(){const n=location.hash.match(/^#\/(\w+)/),a=n==null?void 0:n[1];return a&&Object.prototype.hasOwnProperty.call($e,a)?a:null}function ut(){const n=`${location.pathname}${location.search}`;history.replaceState(null,"",n)}function Ee(n){se==null||se(),se=null,le==null||le(),le=null;const a=document.getElementById("app");if(!a)return;if(a.innerHTML="",!n){location.hash&&ut(),le=De(a);return}const t=`#/${n}`;if(location.hash!==t){location.hash=t;return}se=$e[n](a)??null}function ze(){Ee(dt())}function ht(){return"./images/uniplus-logo.png"}function pt(){const n=document.createElement("div");return n.id="splash",n.className="splash",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Uni+"),n.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${ht()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
