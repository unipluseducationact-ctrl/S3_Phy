...
`;function Nt(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=jt,document.head.appendChild(t)}function Qt(t){Nt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=r.querySelector(".rml-canvas"),i=o.getContext("2d"),s=r.querySelector("[data-rml-rot]"),a=r.querySelector("[data-rml-inc]"),n=r.querySelector('[data-rml-disp="rot"]'),l=r.querySelector('[data-rml-disp="inc"]'),P=r.querySelector('[data-rml-val="i"]'),z=r.querySelector('[data-rml-val="r"]'),$=r.querySelector('[data-rml-val="shift"]'),I=350,H=380,W=300,h="#22d3ee",k="bold 17px system-ui, sans-serif";let _=0,g=-140,u=!0,f=!0,y=!0,v=!0;function S(Q){return Q*Math.PI/180}function T(Q,Y,X,ae,ue,ne=2,ie=!1){i.beginPath(),i.lineWidth=ne,i.strokeStyle=ue,i.setLineDash(ie?[6,6]:[]);const te=Q+Math.cos(S(X))*ae,le=Y+Math.sin(S(X))*ae;return i.moveTo(Q,Y),i.lineTo(te,le),i.stroke(),i.setLineDash([]),{x:te,y:le}}function G(Q,Y,X,ae,ue,ne=14){const ie=X-Q,te=ae-Y,le=Math.hypot(ie,te);if(le<1e-6)return;const ge=ie/le,ye=te/le,xe=X-ge*ne,J=ae-ye*ne,E=.45*ne;i.beginPath(),i.fillStyle=ue,i.moveTo(X,ae),i.lineTo(xe-ye*E,J+ge*E),i.lineTo(xe+ye*E,J-ge*E),i.closePath(),i.fill()}function B(Q,Y,X,ae,ue,ne=25){i.beginPath(),i.strokeStyle=ae,i.lineWidth=2;const ie=Math.min(Q,Y),te=Math.max(Q,Y);if(i.arc(I,H,X,S(ie),S(te),!1),i.stroke(),ue){const le=(ie+te)/2,ge=I+Math.cos(S(le))*(X+ne),ye=H+Math.sin(S(le))*(X+ne);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=ae,i.fillText(ue,ge,ye),i.restore()}}function O(Q,Y,X,ae,ue){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(I-200,H),i.lineTo(I+200,H),i.stroke(),i.setLineDash([]),i.lineCap="butt";const ne=I+Math.cos(S(Q))*W,ie=H+Math.sin(S(Q))*W;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(ne,ie),i.lineTo(I,H),i.stroke();const te=(ne+I)*.5,le=(ie+H)*.5,ge=Math.hypot(I-ne,H-ie)||1,ye=(I-ne)/ge,xe=(H-ie)/ge;if(G(te-ye*28,le-xe*28,te,le,"#fff",16),i.save(),i.font=k,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),ne,ie-12),i.restore(),u){const J=T(I,H,-90,W-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),J.x+6,J.y-4),i.restore()}if(f){const J=T(I,H,ae,W,"#00e676",2,!1);G(I,H,J.x,J.y,"#00e676",16),i.save(),i.font=k,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),J.x,J.y-14),i.restore()}i.save(),i.translate(I,H),i.rotate(S(_)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let J=-190;J<200;J+=15)i.moveTo(J,0),i.lineTo(J-5,8);if(i.stroke(),i.restore(),y){const J=T(I,H,Y,W-40,h,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=h,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),J.x+6,J.y-4),i.restore()}if(v){const J=T(I,H,X,W,h,4);G(I,H,J.x,J.y,h,16),Math.abs(_)>.5&&(i.save(),i.font=k,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=h,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),J.x,J.y-14),i.restore())}if(y&&B(Q,Y,100,"#ffcc00",`i=${ue.toFixed(0)}°`,25),y&&v&&B(Y,X,100,h,`r=${ue.toFixed(0)}°`,25),u&&y&&Math.abs(_)>.5&&B(-90,Y,50,"#ffcc00",`θ=${Math.abs(_)}°`,20),f&&v&&Math.abs(_)>.5){const J=X-ae;B(ae,X,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${J.toFixed(0)}°`,40)}}function D(){_=parseFloat(s.value),g=parseFloat(a.value);const Q=_>0?"+":"";n.textContent=`${Q}${_}°`,l.textContent=`${g}°`;const Y=-90,X=Math.abs(g-Y),ae=Y+X,ue=-90+_,ne=Math.abs(g-ue),ie=ue+ne,te=ie-ae;P.textContent=`${ne.toFixed(1)}°`,z.textContent=`${ne.toFixed(1)}°`;const le=te>0?"+":"";$.textContent=`${le}${te.toFixed(1)}°`,O(g,ue,ie,ae,ne)}return r.querySelectorAll("[data-rml-toggle]").forEach(Q=>{Q.addEventListener("click",()=>{const Y=Q.getAttribute("data-rml-toggle");Y==="orig-norm"&&(u=!u),Y==="orig-ray"&&(f=!f),Y==="new-norm"&&(y=!y),Y==="new-ray"&&(v=!v),Q.classList.toggle("active"),D()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",D()}),s.addEventListener("input",D),a.addEventListener("input",D),D(),r}function Vt(t){const r=document.createElement("div");r.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;return o.src=`${s}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(o),r}function Kt(t,r={}){const o=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),n="./",l=n.endsWith("/")?n:`${n}/`;return a.src=`${l}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,a.title=t(i),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function Ut(t){const r=document.createElement("div");r.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(de())}`}o.src=a(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=o.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",n),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(o),r}function Yt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const o=r.querySelector("[data-r]"),i=r.querySelector("[data-g]"),s=r.querySelector("[data-b]"),a=r.querySelector(".rgb-mixer-canvas"),n=r.querySelector(".rgb-mixer-stage"),l=a.getContext("2d");function P(h){return h.toString(16).padStart(2,"0")}function z(h,k,_){const g=a.width/(window.devicePixelRatio||1),u=a.height/(window.devicePixelRatio||1),f=g/2,y=u/2,v=Math.min(g,u)*.34,S=v*.5,T=Math.sqrt(3)/2;l.clearRect(0,0,g,u),l.fillStyle="#000",l.fillRect(0,0,g,u);const G=[{x:f,y:y-S,rgb:[255,0,0],val:h},{x:f-S*T,y:y+S*.5,rgb:[0,255,0],val:k},{x:f+S*T,y:y+S*.5,rgb:[0,0,255],val:_}];l.globalCompositeOperation="lighter",G.forEach(B=>{if(B.val<=0)return;const O=B.val/255,[D,Q,Y]=B.rgb,X=l.createRadialGradient(B.x,B.y,0,B.x,B.y,v);X.addColorStop(0,`rgba(${D},${Q},${Y},${O})`),X.addColorStop(.65,`rgba(${D},${Q},${Y},${O})`),X.addColorStop(.85,`rgba(${D},${Q},${Y},${O*.5})`),X.addColorStop(1,`rgba(${D},${Q},${Y},0)`),l.fillStyle=X,l.beginPath(),l.arc(B.x,B.y,v,0,Math.PI*2),l.fill()}),l.globalCompositeOperation="source-over"}function $(){const h=n.getBoundingClientRect(),k=Math.max(200,Math.min(h.width-8,h.height-8,720)),_=window.devicePixelRatio||1;a.width=k*_,a.height=k*_,a.style.width=`${k}px`,a.style.height=`${k}px`,l.setTransform(_,0,0,_,0,0),z(+o.value,+i.value,+s.value)}function I(){const h=+o.value,k=+i.value,_=+s.value,g=`rgb(${h}, ${k}, ${_})`,u=`#${P(h)}${P(k)}${P(_)}`;r.querySelector("[data-r-val]").textContent=h,r.querySelector("[data-g-val]").textContent=k,r.querySelector("[data-b-val]").textContent=_,r.querySelector("[data-r-bar]").style.width=`${h/255*100}%`,r.querySelector("[data-g-bar]").style.width=`${k/255*100}%`,r.querySelector("[data-b-bar]").style.width=`${_/255*100}%`,o.style.setProperty("--fill",`${h/255*100}%`),i.style.setProperty("--fill",`${k/255*100}%`),s.style.setProperty("--fill",`${_/255*100}%`);const f=r.querySelector("[data-swatch]");f.style.backgroundColor=g,f.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${g}`),r.querySelector("[data-rgb-text]").textContent=g,r.querySelector("[data-hex-text]").textContent=u,z(h,k,_)}function H(h,k,_){o.value=h,i.value=k,s.value=_,I()}return[o,i,s].forEach(h=>h.addEventListener("input",I)),r.querySelectorAll(".rgb-presets button").forEach(h=>{h.addEventListener("click",()=>{H(+h.dataset.r,+h.dataset.g,+h.dataset.b)})}),new ResizeObserver(()=>$()).observe(n),requestAnimationFrame(()=>{$(),I()}),r}const Xt=["topics","notes","tools","worksheets","flashcards","summary"],Zt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function qt(t,{subtitleKey:r,activeSection:o,onSection:i,onLang:s}){t.innerHTML=`
  ...
  `;const a=t.querySelector("[data-main]"),n=t.querySelector("[data-nav]"),l=t.querySelector("[data-lang]"),P=t.querySelector("[data-strand-back]");let z=o;function $(h){z=h,n.innerHTML=Xt.map(k=>`<button type="button" class="${h===k?"active":""}" data-sec="${k}">${d(Zt[k])}</button>`).join(""),n.querySelectorAll("button").forEach(k=>{k.addEventListener("click",()=>i(k.getAttribute("data-sec")))})}function I(){l.innerHTML=`
      <button type="button" data-set-lang="en" class="${de()==="en"?"active":""}">${d("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${de()==="zh-Hant"?"active":""}">${d("lang.zhHant")}</button>
    `,l.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>{kt(h.getAttribute("data-set-lang")),s()})})}function H(){t.querySelector("[data-hub-subtitle]").textContent=d(r),P.textContent=d("strand.back"),t.querySelector("[data-hub-footer]").textContent=d("footer.conventions"),t.querySelector(".site-title").textContent=d("app.title")}const W=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return P.addEventListener("click",W),$(o),I(),{main:a,updateSection(h){$(h)},refreshLabels(){H(),$(z),I()},destroy(){P.removeEventListener("click",W)}}}const Xe="s3phy:tool-picker-collapsed",Jt=820;function Tt({toolOrder:t,toolId:r,getLabel:o,t:i}){const s=t.map(a=>`<button type="button" data-tool="${a}" class="${r===a?"active":""}">${o(a)}</button>`).join("");return`
      <section class="panel panel--tools" data-tools-panel>
        <div class="tools-panel-head">
          <div class="tools-panel-head__text">
            <h2>${i("tools.title")}</h2>
            <p class="tools-active-lab" data-tool-active-label hidden>${o(r)}</p>
          </div>
      ...
      </section>`}function Ct(t,{getLabel:r,t:o,onSelectTool:i,mountTool:s,getActiveToolId:a}){const n=t.querySelector("[data-tools-panel]"),l=t.querySelector("[data-tool-picker]"),P=t.querySelector("[data-tool-list]"),z=t.querySelector("[data-tool-stage]"),$=t.querySelector("[data-tool-picker-toggle]"),I=t.querySelector("[data-tool-picker-toggle-label]"),H=t.querySelector("[data-tool-picker-chevron]"),W=t.querySelector("[data-tool-active-label]");if(!n||!l||!P||!z||!$)return;let h=sessionStorage.getItem(Xe)==="true";const k=()=>{W&&(W.textContent=r(a()))},_=()=>{$.setAttribute("aria-expanded",h?"false":"true"),I&&(I.textContent=o(h?"tools.showLabList":"tools.hideLabList")),H&&(H.textContent=h?"▼":"▲"),W&&(W.hidden=!h)},g=u=>{h=u,n.classList.toggle("is-picker-collapsed",h),sessionStorage.setItem(Xe,h?"true":"false"),_()};n.classList.toggle("is-picker-collapsed",h),k(),_(),$.addEventListener("click",()=>{g(!h)}),P.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{const f=u.getAttribute("data-tool");f&&(i(f),P.querySelectorAll("button").forEach(y=>{y.classList.toggle("active",y.getAttribute("data-tool")===f)}),k(),s(z),window.innerWidth<=Jt&&g(!0))})}),s(z)}const Re=["A","B","C","D"];function Ze(t){const r=t.slice();for(let o=r.length-1;o>0;o-=1){const i=Math.floor(Math.random()*(o+1));[r[o],r[i]]=[r[i],r[o]]}return r}function Je(t,r,o){return t.filter(i=>{if(o)return o(i,r);const s=i.topic;return!!(r.includes(s)||r.includes("rotatingMirror")&&s==="reflection"||r.includes("refraction")&&s==="refraction"||r.includes("tir")&&s==="tir"||s==="convex"&&r.includes("convex")||s==="concave"&&r.includes("concave"))})}function Z(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function zt(t,r={}){const o=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
    <section class="panel panel--worksheets">
    ...
    </section>`}function Lt(t,r,o,i,s={}){var le,ge,ye,xe,J;const a={items:[],userAnswers:{},wrongAttempts:{},resolved:{},pending:{}},n=t.querySelector("#ws-layout");t.querySelector("#ws-settings-panel");const l=t.querySelector("#ws-bank-summary"),P=t.querySelector("[data-ws-gen]"),z=t.querySelector("[data-ws-body]"),$=t.querySelector("[data-ws-progress-text]"),I=t.querySelector("[data-ws-progress-bar]"),H=t.querySelector("[data-ws-hint-text]"),W=t.querySelector("[data-ws-hint-mobile]"),h=t.querySelector("[data-ws-summary]"),k=t.querySelector("[data-ws-summary-btn]"),_=t.querySelector("[data-ws-toggle-settings]"),g=t.querySelector("[data-ws-toggle-label]"),u=t.querySelector("[data-ws-toggle-icon]"),f=t.querySelector("[data-ws-strand-label]"),y=t.querySelector("[data-ws-print-sheet]");if(!P||!z)return;f&&s.paperTitleKey?f.textContent=o(s.paperTitleKey).toUpperCase():f&&(f.textContent=o("worksheets.paperTitle").toUpperCase());function v(){return i()}function S(){return[...t.querySelectorAll("[data-ws-topic]")].filter(E=>E.checked).map(E=>E.getAttribute("data-ws-topic"))}function T(E){var N,V;const L=t.querySelector(`[data-ws-topic="${E}"]`),F=(N=L==null?void 0:L.closest(".ws-check-card"))==null?void 0:N.querySelector("span");return((V=F==null?void 0:F.textContent)==null?void 0:V.trim())||E}function G(E){const L=E||o("worksheets.hintEmpty");H&&(H.textContent=L),W&&(W.textContent=L)}function B(){if(!l)return;const E=S();if(!E.length){l.innerHTML=`<p class="ws-bank-title">${Z(o("worksheets.bankTitle"))}</p>
        <p class="ws-bank-muted">${Z(o("worksheets.bankNone"))}</p>`;return}const L=Je(r,E,s.topicFilter),F=E.map(N=>{const V=L.filter(re=>s.topicFilter?s.topicFilter(re,[N]):N==="rotatingMirror"?re.topic==="reflection":N==="refraction"?re.topic==="refraction":re.topic===N).length;return`<li><span>${Z(T(N))}</span><strong>${V}</strong></li>`}).join("");l.innerHTML=`
      ...
      <ul class="ws-bank-list">${F}</ul>`}function O(){if(!a.items.length){$&&($.textContent=o("worksheets.progressNone")),I&&(I.style.width="0%");return}const E=a.items.filter((L,F)=>a.resolved[F]).length;$&&($.textContent=`${o("worksheets.progressPrefix")} ${E} / ${a.items.length}`),I&&(I.style.width=`${E/a.items.length*100}%`)}function D(){a.userAnswers={},a.wrongAttempts={},a.resolved={},a.pending={},h&&(h.hidden=!0,h.innerHTML="")}function Q(){return a.items.length>0&&a.items.every((E,L)=>a.resolved[L])}function Y(E,L){const F=E[v()]||E.en,N=L+1,V={selected:a.pending[L]??a.userAnswers[L],wrong:a.wrongAttempts[L]||0,solved:a.resolved[L]},re=E.section?Z(E.section):Z(E.topic||""),ve=F.choices.map((qe,Te)=>{const We=Re[Te],De=V.selected===Te,pe=V.solved&&Te===F.a,Le=["ws-option-btn"];De&&!V.solved&&Le.push("ws-option-btn--selected"),pe&&Le.push("ws-option-btn--correct");const Ae=V.solved?" disabled":"";return`<button type="button" class="${Le.join(" ")}" data-ws-option="${Te}" data-ws-q="${L}"${Ae}>
          <span class="ws-option-badge">${We}</span>
          <span class="ws-option-text">${Z(qe)}</span>
        </button>`}).join("");let oe="";V.wrong===1&&!V.solved?oe=`<div class="ws-feedback ws-feedback--hint" role="status">
        <strong>${Z(o("worksheets.hint"))}:</strong> ${Z(F.hint||F.exp)}
      </div>`:V.solved&&V.selected!==F.a?oe=`<div class="ws-feedback ws-feedback--model" role="status">
        <strong>${Z(o("worksheets.modelAnswer"))}:</strong> ${Z(Re[F.a])}
        <span class="ws-feedback-exp">${Z(F.exp)}</span>
      </div>`:V.solved&&V.selected===F.a&&(oe=`<div class="ws-feedback ws-feedback--correct" role="status">${Z(o("worksheets.correct"))}</div>`);const he=V.solved?" disabled":"";return`<article class="ws-q-block ${V.solved?V.selected===F.a?"ws-q-block--correct":"ws-q-block--incorrect":""}" data-ws-block="${L}" data-ws-hint="${Z(F.hint||F.exp)}">
      <div class="ws-q-meta">Q${N} · ${re.toUpperCase()} · MCQ</div>
      <p class="ws-q-stem">${Z(F.q)}</p>
      <div class="ws-options">${ve}</div>
      <button type="button" class="ws-check-btn" data-ws-check="${L}"${he}>${Z(o("worksheets.checkAnswer"))}</button>
      ${oe}
    </article>`}function X(){if(!a.items.length){z.className="ws-quiz-area ws-quiz-empty",z.innerHTML=`<p>${Z(o("worksheets.empty"))}</p>`,G(null);return}z.className="ws-quiz-area",z.innerHTML=a.items.map((L,F)=>Y(L,F)).join("");const E=a.items.findIndex((L,F)=>!a.resolved[F]);if(E>=0){const L=a.items[E][v()]||a.items[E].en;G(L.hint||L.exp)}z.querySelectorAll("[data-ws-option]").forEach(L=>{L.addEventListener("click",()=>{const F=Number(L.getAttribute("data-ws-q"));if(a.resolved[F])return;const N=Number(L.getAttribute("data-ws-option"));a.pending[F]=N,z.querySelectorAll(`[data-ws-q="${F}"][data-ws-option]`).forEach(V=>{V.classList.toggle("ws-option-btn--selected",Number(V.getAttribute("data-ws-option"))===N)})})}),z.querySelectorAll(".ws-q-block").forEach(L=>{L.addEventListener("mouseenter",()=>G(L.getAttribute("data-ws-hint"))),L.addEventListener("focusin",()=>G(L.getAttribute("data-ws-hint")))}),z.querySelectorAll("[data-ws-check]").forEach(L=>{L.addEventListener("click",()=>{const F=Number(L.getAttribute("data-ws-check"));if(a.resolved[F])return;const N=a.pending[F];if(N===void 0)return;const V=a.items[F][v()]||a.items[F].en;a.userAnswers[F]=N,N===V.a?a.resolved[F]=!0:(a.wrongAttempts[F]=(a.wrongAttempts[F]||0)+1,a.wrongAttempts[F]>=2&&(a.resolved[F]=!0)),O(),Q()&&ae(),X()})})}function ae(){const E=a.items.length;let L=0,F=0;const N={};a.items.forEach((oe,he)=>{const Se=oe[v()]||oe.en;if(a.userAnswers[he]===Se.a)L+=1,(a.wrongAttempts[he]||0)===0&&(F+=1);else if(a.resolved[he]){const Te=oe.section||oe.topic;N[Te]=(N[Te]||0)+1}});const V=E?Math.round(L/E*100):0;let re=o("worksheets.revisionFair");V>=90?re=o("worksheets.revisionExcellent"):V>=70?re=o("worksheets.revisionGood"):V<50&&(re=o("worksheets.revisionLow"));const ve=Object.entries(N).sort((oe,he)=>he[1]-oe[1]).map(([oe,he])=>`<li>${Z(oe)} (${he})</li>`).join("");h.innerHTML=`
      <h4>${Z(o("worksheets.sessionSummary"))}</h4>
      <p>${Z(o("worksheets.score"))}: <strong>${L}/${E}</strong> (${V}%)</p>
      <p>${Z(o("worksheets.firstTry"))}: <strong>${F}/${E}</strong></p>
      <p>${Z(o("worksheets.revisionSuggestions"))}: ${Z(re)}</p>
      ${ve?`<p>${Z(o("worksheets.weakSections"))}:</p><ul>${ve}</ul>`:""}`,h.hidden=!1}function ue(E){const L=s.paperTitleKey?o(s.paperTitleKey):o("worksheets.paperTitle"),F=a.items.map((N,V)=>{const re=N[v()]||N.en,ve=re.choices.map((he,Se)=>`<li>${Re[Se]}. ${Z(he)}</li>`).join(""),oe=E?`<p><strong>${Z(o("worksheets.answer"))}:</strong> ${Re[re.a]}<br/><em>${Z(re.exp)}</em></p>`:"";return`<div class="ws-print-q"><strong>Q${V+1}.</strong> ${Z(re.q)}<ol>${ve}</ol>${oe}</div>`}).join("");return`<h2>${Z(L)}</h2>${F}`}function ne(E){const L=s.paperTitleKey?o(s.paperTitleKey):o("worksheets.paperTitle"),F=a.items.map((N,V)=>{const re=N[v()]||N.en,ve=re.choices.map((he,Se)=>`${Re[Se]}. ${he}`).join("<br/>"),oe=E?`<p><b>${o("worksheets.answer")}:</b> ${Re[re.a]}<br/><i>${re.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${V+1}.</b> ${re.q}<br/>${ve}${oe}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${L}</title></head>
<body><h2>${L}</h2>${F}</body></html>`}function ie(E){if(!a.items.length)return;const L=ne(E),F=new Blob(["\uFEFF",L],{type:"application/msword"}),N=document.createElement("a");N.href=URL.createObjectURL(F),N.download=E?"worksheet-answers.doc":"worksheet.doc",N.click(),URL.revokeObjectURL(N.href)}function te(E){if(!a.items.length||!y)return;y.hidden=!1,y.innerHTML=ue(E);const L=()=>{y.hidden=!0,y.innerHTML="",document.body.classList.remove("ws-printing")};document.body.classList.add("ws-printing"),window.addEventListener("afterprint",L,{once:!0}),window.print()}P.addEventListener("click",()=>{const E=Math.min(50,Math.max(1,Number(t.querySelector("[data-ws-count]").value)||10)),L=S();if(!L.length)return;const F=Je(r,L,s.topicFilter),N=Ze(F).slice(0,Math.min(E,F.length||1));a.items=N.length?N:Ze(r).slice(0,Math.min(E,r.length)),D(),O(),X()}),(le=t.querySelector("[data-ws-topics]"))==null||le.addEventListener("change",B),_==null||_.addEventListener("click",()=>{const E=n==null?void 0:n.classList.toggle("ws-layout--collapsed");g&&(g.textContent=o(E?"worksheets.showSettings":"worksheets.hideSettings")),u&&(u.textContent=E?"›":"‹"),_.setAttribute("aria-expanded",E?"false":"true")}),k==null||k.addEventListener("click",()=>{if(a.items.length){if(!h.hidden&&h.innerHTML){h.hidden=!0;return}ae()}}),(ge=t.querySelector("[data-ws-word-p]"))==null||ge.addEventListener("click",()=>ie(!1)),(ye=t.querySelector("[data-ws-word-a]"))==null||ye.addEventListener("click",()=>ie(!0)),(xe=t.querySelector("[data-ws-print-p]"))==null||xe.addEventListener("click",()=>te(!1)),(J=t.querySelector("[data-ws-print-a]"))==null||J.addEventListener("click",()=>te(!0)),B()}const ea=1.7,ta=.7,Ge=1,aa=.1,na=3;function ra(t){const r=Math.floor(t),o=t-r;return r+(Math.random()<o?1:0)}function et(t){for(let r=t.length-1;r>0;r-=1){const o=Math.floor(Math.random()*(r+1));[t[r],t[o]]=[t[o],t[r]]}return t}function ia(t){const r=new Map(t.map(a=>[a.id,a.copies])),o=[];let i=null;const s=t.reduce((a,n)=>a+n.copies,0);for(let a=0;a<s;a+=1){let n=[...r.entries()].filter(([z,$])=>$>0&&z!==i);n.length===0&&(n=[...r.entries()].filter(([,z])=>z>0)),n.sort((z,$)=>$[1]-z[1]);const[l,P]=n[0];o.push(l),r.set(l,P-1),i=l}return o}function oa(t){const r=[];return t.forEach(({id:o,copies:i})=>{for(let s=0;s<i;s+=1)r.push(o)}),r}function sa(t){let r="sequence",o=1,i=[],s=[],a=0,n=!1,l=!1,P=!1;const z=new Map;function $(){return t()}function I(){return new Map($().map(v=>[v.id,v]))}function H(){z.clear(),$().forEach(v=>{z.set(v.id,{nextRate:Ge,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function W(){const v=$();return o===1?v.map(S=>({id:S.id,copies:1})):v.map(S=>{var T;return{id:S.id,copies:ra(((T=z.get(S.id))==null?void 0:T.nextRate)??Ge)}}).filter(S=>S.copies>0)}function h(v){if(v.length===0)return[];if(o===1){const S=v.map(T=>T.id);return r==="random"?et([...S]):[...S].sort((T,G)=>T-G)}return r==="random"?et(oa(v)):ia(v)}function k(){if(l=!1,P=!1,i=W(),i.reduce((S,T)=>S+T.copies,0)===0){P=!0,l=!0,s=[],a=0;return}$().forEach(S=>{const T=z.get(S.id);T&&(T.roundAgain=0,T.roundGotIt=0,T.roundNeutral=0)}),s=h(i),a=0,n=!1}function _(){o=1,H(),k()}function g(){return s[a]??null}function u(){const v=g();return v==null?null:I().get(v)??null}function f(v){const S=g();if(S==null)return;const T=z.get(S);T&&(v==="again"?(T.nextRate=ea,T.totalGotIt=0,T.roundAgain+=1):v==="gotit"?(T.totalGotIt+=1,T.roundGotIt+=1,T.nextRate=T.totalGotIt>=na?aa:ta):v==="neutral"&&(T.roundNeutral+=1,T.nextRate=Ge))}function y(){return n=!1,a<s.length-1?(a+=1,!1):(l=!0,!0)}return _(),{getMode:()=>r,setMode(v){r!==v&&(r=v,s=h(i),a=0,n=!1)},resetSession:_,getRoundNumber:()=>o,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>n,flip(){n=!n},unflip(){n=!1},currentCard:u,prev(){return a>0?(a-=1,n=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,n=!1,!0):!1},rateAgain(){return n?(f("again"),y()):!1},rateGotIt(){return n?(f("gotit"),y()):!1},rateNeutral(){return n?(f("neutral"),y()):!1},isSummary:()=>l,isSessionComplete:()=>P,getRoundStats(){let v=0,S=0,T=0;return z.forEach(G=>{v+=G.roundAgain,S+=G.roundGotIt,T+=G.roundNeutral}),{again:v,gotIt:S,neutral:T}},nextRound(){o+=1,k()},restart(){_()}}}function Rt(t,{deckOptions:r,buildDeck:o,initialDeck:i="all"}){let s=i,a=null,n=null;t.innerHTML=`
    <section class="panel panel--flashcards">
      ...
      <div class="flash-study-controls no-print">
        <div class="control">
          ...
          <select data-fc-deck>
            ${r.map(g=>`<option value="${g.value}">${g.label}</option>`).join("")}
          </select>
        </div>
...
`;function ka(){if(document.getElementById(ft))return;const t=document.createElement("style");t.id=ft,t.textContent=xa,document.head.appendChild(t)}function Sa(t){const o={x:12,y:12},i=200,{container:s,panel:a,toggleBtn:n,dragHandle:l,storageKey:P,onLayoutChange:z,breakpoint:$=1024,collapsedClass:I="controls-collapsed",floatingClass:H="controls-floating"}=t;if(!s||!a||!n)return null;let W=sessionStorage.getItem(P)!=="false",h=(()=>{try{const O=localStorage.getItem(P+":pos");if(!O)return{...o};const D=JSON.parse(O);if(typeof D.x=="number"&&typeof D.y=="number")return D}catch{}return{...o}})(),k=null,_=null;const g=()=>window.innerWidth>=$,u=(O,D)=>{const Q=s.getBoundingClientRect(),Y=a.getBoundingClientRect(),X=Math.max(0,Q.width-Y.width),ae=Math.max(0,Q.height-Y.height);return{x:Math.min(Math.max(0,O),X),y:Math.min(Math.max(0,D),ae)}},f=()=>{a.style.left=h.x+"px",a.style.top=h.y+"px",a.style.right="auto",a.style.bottom="auto"},y=()=>{typeof z=="function"&&(clearTimeout(_),_=setTimeout(z,i))},v=()=>{n.setAttribute("aria-expanded",W?"false":"true"),t.getToggleTitle&&(n.title=t.getToggleTitle(W));const O=n.querySelector("[data-float-chevron]");O&&(O.textContent=W?"v":"^")},S=O=>{W=O,a.classList.toggle(I,W),sessionStorage.setItem(P,W?"true":"false"),v(),y()},T=()=>{s.classList.add(H),a.classList.add("lab-controls-float"),h=u(h.x,h.y),f(),l&&(l.style.display="")},G=()=>{s.classList.remove(H),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",l&&(l.style.display="none")},B=()=>{g()?(T(),h=u(h.x,h.y),f()):G(),y()};if(a.classList.toggle(I,W),v(),B(),n.addEventListener("click",O=>{O.stopPropagation(),S(!W)}),l){l.addEventListener("pointerdown",D=>{g()&&(D.preventDefault(),k={pointerId:D.pointerId,startX:D.clientX,startY:D.clientY,originX:h.x,originY:h.y},l.setPointerCapture(D.pointerId),l.classList.add("is-dragging"))}),l.addEventListener("pointermove",D=>{!k||k.pointerId!==D.pointerId||(h=u(k.originX+D.clientX-k.startX,k.originY+D.clientY-k.startY),f())});const O=D=>{if(!(!k||k.pointerId!==D.pointerId)){l.releasePointerCapture(D.pointerId),l.classList.remove("is-dragging");try{localStorage.setItem(P+":pos",JSON.stringify(h))}catch{}k=null,y()}};l.addEventListener("pointerup",O),l.addEventListener("pointercancel",O)}return window.addEventListener("resize",B),{setCollapsed:S,refreshMode:B,isCollapsed:()=>W}}function je(t,r={}){ka();const o=r.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
  ...
  `;const n={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},l=460,P=340,z=80,$=800,I=560;function H(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:$-e.left-e.right,gh:I-e.top-e.bottom,tickFont:`bold ${Math.round($*.024)}px Arial`,axisFont:`bold ${Math.round($*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:I-e.bottom+32}}function W(){let c=100;const m=Math.max(n.bathTemp,n.thermometerTemp,100);m>120&&(c=150),m>145&&(c=200);const b=c<=100?20:25;return{minT:0,maxT:c,tickStep:b}}function h(e,c,m,b,p){return b+(e-c)/(m-c)*p}function k(e,c,m,b,p){return b+p-(e-c)/(m-c)*p}function _(e,c,m,b,p,A){const{gx:w,gy:x,gw:C,gh:R,tickFont:M,axisFont:j,yLabelX:ee,xLabelY:q}=c;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const K of A){const U=k(K.value,K.min,K.max,x,R);e.beginPath(),e.moveTo(w,U),e.lineTo(w+C,U),e.stroke()}for(let K=m;K<=b+.01;K+=p){const U=h(K,m,b,w,C);e.beginPath(),e.moveTo(U,x),e.lineTo(U,x+R),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(w,x),e.lineTo(w,x+R),e.lineTo(w+C,x+R),e.stroke(),e.fillStyle="#e4e4e7",e.font=M,e.textAlign="right",e.textBaseline="middle";for(const K of A){const U=k(K.value,K.min,K.max,x,R);e.fillText(K.label,w-15,U)}e.textAlign="center",e.textBaseline="top";for(let K=m;K<=b+.01;K+=p){const U=h(K,m,b,w,C);e.fillText(`${Math.round(K)}`,U,x+R+10)}return{gx:w,gy:x,gw:C,gh:R,axisFont:j,yLabelX:ee,xLabelY:q}}function g(e,c){const m=c-e,b=m<=8?1:m<=14?2:5,p=[],A=Math.ceil(e/b)*b;for(let w=A;w<=c+.001;w+=b)p.push({value:w,label:w%1===0?`${w.toFixed(0)}`:`${w.toFixed(1)}`,min:e,max:c});return p}function u(){const{maxT:e}=W(),c=f(0),m=f(e),b=m-c,p=Math.max(1,b*.1),A=Math.max(0,Math.round((c-p)*10)/10),w=Math.round((m+p)*10)/10;return{minL:A,maxL:w}}function f(e){return n.liquidL0+(n.liquidL100-n.liquidL0)/100*e}function y(){const{maxT:e}=W(),c=v(0),m=v(e),b=m-c,p=Math.max(.2,b*.1),A=Math.max(0,c-p),w=m+p,x=b<=2?.5:b<=4?1:2,C=[],R=Math.ceil(A/x)*x;for(let M=R;M<=w+.001;M+=x)C.push({value:M,label:M.toFixed(1),min:A,max:w});return{minR:A,maxR:w,ticks:C}}function v(e){return n.resistanceR0+(n.resistanceR100-n.resistanceR0)/100*e}function S(e){const{maxT:c}=e;let m=n.thermistorR25;for(let w=0;w<=c;w+=5){const x=w+273.15,C=n.thermistorR25*Math.exp(n.thermistorBeta*(1/x-1/298.15));m=Math.max(m,C)}m=Math.ceil(m*1.08*10)/10;const b=0,p=m<=12?2:4,A=[];for(let w=0;w<=m+.001;w+=p)A.push({value:w,label:w.toFixed(0),min:b,max:m});return{minR:b,maxR:m,ticks:A}}const T=a.querySelector("#tl-thermometerCanvas"),G=T.getContext("2d"),B=a.querySelector("#tl-graphCanvas"),O=B.getContext("2d"),D=window.devicePixelRatio||1;T.width=l*D,T.height=P*D,G.scale(D,D),B.width=$*D,B.height=I*D,O.scale(D,D);function Q(){n.iceCubes=[];for(let e=0;e<5;e++)n.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});n.bubbles=[];for(let e=0;e<20;e++)n.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});n.heatWaves=[];for(let e=0;e<8;e++)n.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});n.steamParticles=[];for(let e=0;e<12;e++)n.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const Y=200,X=11;function ae(){const e=Math.pow(n.bulbVolume/Y,.3333333333333333);return X*e}function ue(){if(n.thermometerType==="resistance"||n.thermometerType==="thermistor")return .35;const e=n.liquidType==="mercury"?1:8,c=.2+n.wallThickness*1.5,m=.4+n.bulbVolume*.003,b=1.35-n.capillaryBore*.45;return Math.max(.1,c*m*b*e*.15)}function ne(e){n.bathTemp<=8&&n.iceCubes.forEach(c=>{c.x+=c.speedX,c.y+=c.speedY,(c.x<65||c.x>175)&&(c.speedX*=-1),(c.y<195||c.y>210)&&(c.speedY*=-1)}),n.bathTemp>35&&n.heatWaves.forEach(c=>{c.y-=c.speedY*(1+n.bathTemp/100),c.y<185&&(c.y=265,c.x=65+Math.random()*110)}),n.bathTemp>=80&&n.bubbles.forEach(c=>{c.y-=c.speedY*(1+(n.bathTemp-80)/40),c.phase+=c.wobbleSpeed,c.x+=Math.sin(c.phase)*.3,c.y<185&&(c.y=260+Math.random()*10,c.x=60+Math.random()*120)}),n.bathTemp>=95&&n.steamParticles.forEach(c=>{c.x+=c.vx,c.y+=c.vy,c.alpha-=.005,(c.alpha<=0||c.y<130)&&(c.x=60+Math.random()*120,c.y=175+Math.random()*5,c.alpha=.2+Math.random()*.4)})}function ie(e){let w=59,x=130,C=246;if(n.bathTemp<25){const q=n.bathTemp/25;w=Math.round(180-q*121),x=Math.round(210-q*80),C=Math.round(250-q*4)}else{const q=Math.min(1,(n.bathTemp-25)/125);w=Math.round(59+q*180),x=Math.round(130-q*100),C=Math.round(246-q*190)}if(n.bathTemp>40){const q=Math.min(1,(n.bathTemp-40)/100),K=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let U=-25;U<=25;U+=6){const se=q*(12+Math.sin(U*.4+K)*5);e.lineTo(55+130/2+U,284-se)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const R=e.createLinearGradient(55,190,55,280);R.addColorStop(0,`rgba(${w}, ${x}, ${C}, 0.25)`),R.addColorStop(1,`rgba(${w}, ${x}, ${C}, 0.55)`),e.fillStyle=R,e.beginPath(),e.moveTo(55,190);const M=n.bathTemp>=80?2:.5,j=n.bathTemp>=80?.09:.03,ee=Date.now()*j;for(let q=55;q<=185;q+=5){const K=190+Math.sin(q*.15+ee)*M;e.lineTo(q,K)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),n.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(n.bathTemp-35)/120)})`,e.lineWidth=1.2,n.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),n.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,n.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),n.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,n.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),n.bathTemp>=95&&n.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function te(e,c,m,b,p,A,w="left"){if(!n.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(c,m),e.lineTo(b,p),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(c,m,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const C=e.measureText(A).width+10,R=16,M=w==="left"?b:b-C,j=p-R/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(M,j,C,R,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(A,M+C/2,j+R/2+.5)}function le(e){const b=ae(),p=250+Math.max(0,b-X)*.35,A=p-b-1,w=10+n.wallThickness*8,x=120-w/2,C=120+w/2,R=e.createLinearGradient(x,20,C,20);R.addColorStop(0,"rgba(209, 213, 219, 0.85)"),R.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),R.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),R.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),R.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=R,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(x,A),e.lineTo(x,25),e.arcTo(x,20,x+5,20,5),e.arcTo(C,20,C,25,5),e.lineTo(C,A),e.closePath(),e.fill(),e.stroke();const M=e.createRadialGradient(120-b*.2,p-b*.2,b*.1,120,p,b);M.addColorStop(0,"rgba(255, 255, 255, 0.8)"),M.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=M,e.strokeStyle="#6b7280",e.lineWidth=.8+n.wallThickness*.6,e.beginPath(),e.arc(120,p,b+.5+n.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const j=Math.min(w*.72,.8+n.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-j/2,28,j,A-20-8);const ee=n.liquidType==="mercury",q=ee?"#a1a1aa":"#ef4444",K=ee?"#f4f4f5":"#fee2e2",U=210,se=220,ke=(U-40)/se,be=U-Math.min(se,n.thermometerTemp)*ke;e.fillStyle=q,e.fillRect(120-j/2,be,j,A-be),e.beginPath(),e.ellipse(120,be,j/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=K,e.fillRect(120-j/6,be,j/3,A-be);const fe=b*.9,ce=e.createRadialGradient(120-fe*.2,p-fe*.2,fe*.1,120,p,fe);ee?(ce.addColorStop(0,"#f4f4f5"),ce.addColorStop(.3,"#d4d4d8"),ce.addColorStop(.8,"#71717a"),ce.addColorStop(1,"#3f3f46")):(ce.addColorStop(0,"#fee2e2"),ce.addColorStop(.2,"#fca5a5"),ce.addColorStop(.7,"#ef4444"),ce.addColorStop(1,"#991b1b")),e.fillStyle=ce,e.beginPath(),e.arc(120,p,fe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let me=0;me<=200;me+=50){const we=U-me*ke;e.beginPath(),e.moveTo(x,we),e.lineTo(x+4,we),e.stroke(),e.fillText(`${me}°C`,x-22,we+2.5)}n.showLabels&&(te(e,x+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),te(e,120,be,230,be-15,t("tools.thermometerLab.labels.meniscus"),"left"),te(e,120-j/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),te(e,120,p,230,p+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function ge(e){const w=e.createLinearGradient(115,20,125,20);w.addColorStop(0,"#71717a"),w.addColorStop(.3,"#f4f4f5"),w.addColorStop(.7,"#d4d4d8"),w.addColorStop(1,"#3f3f46"),e.fillStyle=w,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let x=205;e.moveTo(118,x);for(let ee=0;ee<8;ee++)x+=4,e.lineTo(122,x),x+=4,e.lineTo(118,x);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const C=245,R=40,M=135,j=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(C,R,M,j,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(C+10,R+12,M-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(n.currentResistance.toFixed(2)+" Ω",C+M-16,R+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",C+14,R+21),n.showLabels&&(te(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),te(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function ye(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,A=225,w=12,x=120-w/2,C=e.createLinearGradient(x,p,x+w,p);C.addColorStop(0,"rgba(229, 231, 235, 0.4)"),C.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),C.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),C.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(x,p,w,A-p,[0,0,3,3]),e.fill(),e.stroke();const R=7,M=e.createRadialGradient(120-R*.2,245-R*.2,R*.1,120,245,R);M.addColorStop(0,"#6b7280"),M.addColorStop(.7,"#1f2937"),M.addColorStop(1,"#09090b"),e.fillStyle=M,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,R,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const j=245,ee=40,q=135,K=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(j,ee,q,K,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(j+10,ee+12,q-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(n.currentThermistorR.toFixed(2)+" kΩ",j+q-16,ee+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",j+14,ee+21),n.showLabels&&(te(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),te(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function xe(e,c,m,b,p,A,w,x,C){const{gx:R,gy:M,gw:j,gh:ee}=c;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(m,b),e.lineTo(m,M+ee),e.stroke(),e.beginPath(),e.moveTo(m,b),e.lineTo(R,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${p.toFixed(1)}${w}`,K=e.measureText(q).width+10;e.fillStyle=C,e.beginPath(),e.roundRect(m-K/2,M+ee+2,K,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,m,M+ee+4),e.textAlign="right",e.textBaseline="middle";const U=`${A.toFixed(2)} ${x}`,se=e.measureText(U).width+10;e.fillStyle=C,e.beginPath(),e.roundRect(R-se-2,b-7,se,15,3),e.fill(),e.fillStyle="#000",e.fillText(U,R-7,b)}function J(e){const c=H(),{minL:m,maxL:b}=u(),{minT:p,maxT:A,tickStep:w}=W(),x=g(m,b),C=_(e,c,p,A,w,x),{gx:R,gy:M,gw:j,gh:ee,axisFont:q,yLabelX:K,xLabelY:U,dotR:se}={...c,...C};e.save(),e.translate(K,M+ee/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",R+j/2,U);const ze=A,ke=h(0,p,A,R,j),be=k(f(0),m,b,M,ee),fe=h(ze,p,A,R,j),ce=k(f(ze),m,b,M,ee);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(ke,be),e.lineTo(fe,ce),e.stroke();const me=n.thermometerTemp,we=n.currentLength;if(me>=p&&me<=A){const Ce=h(me,p,A,R,j),Me=k(we,m,b,M,ee);xe(e,c,Ce,Me,me,we,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(Ce,Me,se,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function E(e){const c=H(),{minR:m,maxR:b,ticks:p}=y(),A=W(),w=_(e,c,A.minT,A.maxT,A.tickStep,p),{gx:x,gy:C,gw:R,gh:M,axisFont:j,yLabelX:ee,xLabelY:q,dotR:K}={...c,...w};e.save(),e.translate(ee,C+M/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+R/2,q);const{minT:U,maxT:se}=A,ze=se,ke=h(0,U,se,x,R),be=k(v(0),m,b,C,M),fe=h(ze,U,se,x,R),ce=k(v(ze),m,b,C,M);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(ke,be),e.lineTo(fe,ce),e.stroke();const me=n.thermometerTemp,we=n.currentResistance;if(me>=U&&me<=se){const Ce=h(me,U,se,x,R),Me=k(we,m,b,C,M);xe(e,c,Ce,Me,me,we,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(Ce,Me,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function L(e){const c=H(),m=W(),{minR:b,maxR:p,ticks:A}=S(m),w=_(e,c,m.minT,m.maxT,m.tickStep,A),{gx:x,gy:C,gw:R,gh:M,axisFont:j,yLabelX:ee,xLabelY:q,dotR:K}={...c,...w},{minT:U,maxT:se}=m;e.save(),e.translate(ee,C+M/2),e.rotate(-Math.PI/2),e.font=j,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=j,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",x+R/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let ze=!1;for(let fe=U;fe<=se;fe+=1){const ce=fe+273.15,me=n.thermistorR25*Math.exp(n.thermistorBeta*(1/ce-1/298.15)),we=h(fe,U,se,x,R),Ce=k(Math.min(p,me),b,p,C,M);Ce>=C&&Ce<=C+M&&(ze?e.lineTo(we,Ce):(e.moveTo(we,Ce),ze=!0))}e.stroke();const ke=n.thermometerTemp,be=n.currentThermistorR;if(ke>=U&&ke<=se){const fe=h(ke,U,se,x,R),ce=k(Math.min(p,be),b,p,C,M);xe(e,c,fe,ce,ke,be,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(fe,ce,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function F(){G.clearRect(0,0,l,P),O.clearRect(0,0,$,I),G.save(),G.translate(z,0),ie(G),n.thermometerType==="liquid"?le(G):n.thermometerType==="resistance"?ge(G):ye(G),G.restore(),n.thermometerType==="liquid"?J(O):n.thermometerType==="resistance"?E(O):L(O)}function N(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const c=a.querySelector("#tl-svg-formula-liquid-sub");if(c){const w=n.liquidL100-n.liquidL0,x=n.currentLength-n.liquidL0;c.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          ...
          <text x="160" y="94" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${w.toFixed(1)}</text>
      ...
      `);const b=a.querySelector("#tl-svg-formula-resistance-sub");if(b){const w=n.resistanceR100-n.resistanceR0,x=n.currentResistance-n.resistanceR0;b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `);const A=a.querySelector("#tl-svg-formula-thermistor-sub");if(A){const w=n.thermometerTemp+273.15;A.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            T<tspan dy="3" font-size="10">K</tspan><tspan dy="-3" fill="#10b981" font-weight="bold"> = ${w.toFixed(2)} K</tspan>
      ...
      `}}function V(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:c,cu:m,interval:b}=he(),p=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,A=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,w=a.querySelector("#tl-pane-q10a").classList.contains("active"),x=w?(p-c)/b*100:A,C=w?p:A/100*b+c,M=(j=>130-j/100*80)(x);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(0, 0)">
          ...
          <!-- Liquid Core -->
          <rect x="84" y="${M}" width="4" height="${144-M}" fill="#3b82f6" />
          ...
          <!-- Current Point -->
          <text x="65" y="${M+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="end">${x.toFixed(1)}°C</text>
        ...
        <g transform="translate(130, 0)">
          ...
          <!-- Liquid Core -->
          <rect x="104" y="${M}" width="4" height="${144-M}" fill="#f59e0b" />
          ...
          <text x="125" y="${M+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${C.toFixed(1)}°C</text>
        ...
        <line x1="86" y1="${M}" x2="236" y2="${M}" stroke="#34d399" stroke-dasharray="3,3" stroke-width="1.5" />
        <circle cx="86" cy="${M}" r="3" fill="#34d399" />
        <circle cx="236" cy="${M}" r="3" fill="#34d399" />
      </svg>
    `}function re(e){a.querySelector("#tl-bath-temp-display").innerHTML=n.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=n.bathTemp.toFixed(1)+" °C";const c=a.querySelector("#tl-bath-state");n.bathTemp<=0?c.textContent="Melting Ice Bath":n.bathTemp>=100?c.textContent="Boiling Water/Steam":n.bathTemp===150?c.textContent="Hot Cooking Oil":c.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const m=a.querySelector("#tl-alcohol-boiling-warning");n.thermometerType==="liquid"&&n.liquidType==="alcohol"&&n.bathTemp>=78?m.style.display="block":m.style.display="none",n.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=n.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=n.thermometerTemp.toFixed(1)+"°C"):n.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=n.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=n.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=n.currentThermistorR.toFixed(2)+" kΩ",N()}let ve=null;function oe(e){n.lastTimestamp||(n.lastTimestamp=e);const c=(e-n.lastTimestamp)/1e3;n.lastTimestamp=e;const m=Math.min(c,.1),b=ue(),p=m/b*(n.bathTemp-n.thermometerTemp);n.thermometerTemp+=p,n.currentLength=n.liquidL0+(n.liquidL100-n.liquidL0)/100*n.thermometerTemp,n.currentResistance=n.resistanceR0+(n.resistanceR100-n.resistanceR0)/100*n.thermometerTemp;const A=n.thermometerTemp+273.15;n.currentThermistorR=n.thermistorR25*Math.exp(n.thermistorBeta*(1/A-1/298.15)),ne(),F(),re(b),ve=requestAnimationFrame(oe)}function he(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),c=parseFloat(a.querySelector("#tl-input-faulty-cu").value),m=Number.isFinite(e)?e:-1.5,b=Number.isFinite(c)?c:105,p=b-m;return{cf:m,cu:b,interval:p}}function Se(e){const c=Math.round(e*100)/100;return c>=0?c.toFixed(1):`(${c.toFixed(1)})`}function qe(){const{cf:e,cu:c,interval:m}=he(),b=a.querySelector("#tl-val-faulty-interval"),p=a.querySelector("#tl-faulty-error-a"),A=a.querySelector("#tl-faulty-error-b"),w=Math.abs(m)<.01;b.textContent=m.toFixed(1)+" °C";const x=a.querySelector("#tl-svg-formula-faulty-a"),C=a.querySelector("#tl-svg-formula-faulty-b");if(w){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",A.hidden=!1,A.textContent=p.textContent,x&&(x.innerHTML=""),C&&(C.innerHTML="");return}p.hidden=!0,A.hidden=!0;const R=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,M=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,j=(R-e)/m*100,ee=M/100*m+e;x&&(x.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${R.toFixed(1)} - ${Se(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${c.toFixed(1)} - ${Se(e)}</text>
      ...
      `),C&&(C.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${M.toFixed(1)} &times; ${m.toFixed(1)}</text>
          ...
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${Se(e)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${ee.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),V()}function Te(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,c=(e-n.resistanceR0)/(n.resistanceR100-n.resistanceR0)*100,m=a.querySelector("#tl-svg-formula-resistance-solver");m&&(m.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function We(){const e=n.thermometerTemp,c=n.liquidL100-n.liquidL0,m=n.liquidL0+c/100*e,b=a.querySelector("#tl-svg-formula-t-to-l");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `)}function De(){const e=n.thermometerTemp,c=n.resistanceR100-n.resistanceR0,m=n.resistanceR0+c/100*e,b=a.querySelector("#tl-svg-formula-t-to-r");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `)}function pe(){qe(),Te(),We(),De()}function Le(e,c){a.querySelector("#"+e).addEventListener("click",()=>{n.bathTemp=c,a.querySelector("#tl-bath-temp-slider").value=c,pe()})}function Ae(e){a.querySelectorAll(".tl-tab-btn").forEach(c=>{c.classList.toggle("active",c.getAttribute("data-tl-tab")===e)}),a.querySelectorAll(".tl-tab-content").forEach(c=>{c.classList.toggle("active",c.id==="tl-tab-"+e)}),a.querySelectorAll(".tl-live-tab").forEach(c=>{c.classList.toggle("active",c.id==="tl-live-"+e)}),n.thermometerType=e}function At(){a.querySelectorAll(".tl-tab-btn").forEach(p=>{p.addEventListener("click",()=>{Ae(p.getAttribute("data-tl-tab")),pe()})}),a.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{n.showLabels=!n.showLabels,a.querySelector("#tl-lbl-toggle-labels").textContent=n.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",p=>{n.bathTemp=parseFloat(p.target.value),pe()}),Le("tl-btn-preset-ice",0),Le("tl-btn-preset-room",25),Le("tl-btn-preset-steam",100),Le("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{n.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",pe()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{n.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",pe()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",p=>{n.bulbVolume=parseFloat(p.target.value),a.querySelector("#tl-val-bulb-vol").textContent=n.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",p=>{n.wallThickness=parseFloat(p.target.value),a.querySelector("#tl-val-wall-thickness").textContent=n.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-capillary-bore").addEventListener("input",p=>{n.capillaryBore=parseFloat(p.target.value),a.querySelector("#tl-val-capillary-bore").textContent=n.capillaryBore.toFixed(2)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",p=>{n.liquidL0=parseFloat(p.target.value),a.querySelector("#tl-val-liquid-l0").textContent=n.liquidL0.toFixed(1)+" cm",pe()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",p=>{n.liquidL100=parseFloat(p.target.value),a.querySelector("#tl-val-liquid-l100").textContent=n.liquidL100.toFixed(1)+" cm",pe()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",p=>{n.resistanceR0=parseFloat(p.target.value),a.querySelector("#tl-val-resistance-r0").textContent=n.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=n.resistanceR0.toFixed(1)+" Ω",pe()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",p=>{n.resistanceR100=parseFloat(p.target.value),a.querySelector("#tl-val-resistance-r100").textContent=n.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=n.resistanceR100.toFixed(1)+" Ω",pe()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",p=>{n.thermistorR25=parseFloat(p.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=n.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=n.thermistorR25.toFixed(1)+" kΩ",pe()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",p=>{n.thermistorBeta=parseFloat(p.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=n.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=n.thermistorBeta+" K",pe()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active"),qe()}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active"),qe()}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",qe),a.querySelector("#tl-input-faulty-cu").addEventListener("input",qe),a.querySelector("#tl-input-q10a-cm").addEventListener("input",qe),a.querySelector("#tl-input-q10b-t").addEventListener("input",qe),a.querySelector("#tl-input-q11-r").addEventListener("input",Te);const m=a.querySelector("#tl-input-t-to-l");m&&m.addEventListener("input",pe);const b=a.querySelector("#tl-input-t-to-r");b&&b.addEventListener("input",pe)}if(r.type){const e=a.querySelector(".tl-tabs-container");e&&(e.style.display="none")}Ae(o),Q(),At(),pe();const Ve=a.querySelector(".tl-dash"),Ke=a.querySelector(".tl-controls"),Ue=a.querySelector("#tl-controls-toggle"),$t=a.querySelector("#tl-controls-drag");return Ve&&Ke&&Ue&&Sa({container:Ve,panel:Ke,toggleBtn:Ue,dragHandle:$t,storageKey:`s3phy-thermo-${o}`,breakpoint:wa,getToggleTitle:e=>t(e?"tools.floatingControls.showParams":"tools.floatingControls.hideParams"),onLayoutChange:()=>F()}),ve=requestAnimationFrame(oe),a._thermometerLabCleanup=()=>{ve&&cancelAnimationFrame(ve)},a}function qa(t){const r=document.createElement("div");r.className="tool-specific-heat";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"specific-heat/index.html?lang="+encodeURIComponent(de())}o.src=a(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=o.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(o),r}function Ta(t){const r=document.createElement("div");r.className="tool-thermal-mixing";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"thermal-mixing/index.html?lang="+encodeURIComponent(de())}o.src=a(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=o.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(o),r}function Ca(t){const r=document.createElement("div");r.className="tool-change-of-state";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"change-of-state/index.html?lang="+encodeURIComponent(de())}o.src=a(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=o.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(o),r}function za(t){const r=document.createElement("div");r.className="tool-heat-transfer";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(de())}o.src=a(),o.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const n=()=>{var l;try{(l=o.contentWindow)==null||l.postMessage({type:"s3phy:lang",lang:de()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",n),r._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",n),r.appendChild(o),r}const He=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],ht=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],La=[["thermometer","topic.thermometer"]],pt=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],Ra={liquid:t=>je(t,{type:"liquid"}),resistance:t=>je(t,{type:"resistance"}),thermistor:t=>je(t,{type:"thermistor"}),specificHeat:t=>qa(t),thermalMixing:t=>Ta(t),changeOfState:t=>Ca(t),heatTransfer:t=>za(t)};function mt(t){return d({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function Ne(){return de()==="zh-Hant"?"zhHant":"en"}async function Fe(t,r){const o=`./${t}/${r}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function bt(t){return Fe("notes",t)}function Ma(t){let r="topics",o="liquid",i=null,s={main:null},a=null,n=null;const l=[{value:"all",labelKey:"flashcards.all"},{value:"thermometry",labelKey:"flashcards.deck.thermometry"},{value:"heatInternalEnergy",labelKey:"flashcards.deck.heatInternalEnergy"},{value:"changeOfState",labelKey:"flashcards.deck.changeOfState"},{value:"heatTransfer",labelKey:"flashcards.deck.heatTransfer"}];function P(){if(s.main){if(n==null||n(),n=null,r==="topics"?s.main.innerHTML=$():r==="notes"?s.main.innerHTML=H():r==="tools"?s.main.innerHTML=Tt({toolOrder:pt,toolId:o,getLabel:mt,t:d}):r==="worksheets"?s.main.innerHTML=zt(d,{topics:La}):r==="flashcards"?n=Rt(s.main,{deckOptions:l.map(u=>({value:u.value,label:d(u.labelKey)})),buildDeck:u=>ma(u,de())}):r==="summary"&&(s.main.innerHTML=h()),r==="notes"&&W(),r==="tools"&&Ct(t,{getLabel:mt,t:d,getActiveToolId:()=>o,onSelectTool:u=>{o=u},mountTool:u=>{u.innerHTML="",a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup();const f=Ra[o];f&&(a=f(d),u.appendChild(a))}}),r==="worksheets"){const u=St.filter(f=>ht.includes(f.topic));Lt(t,u,d,Ne,{topicFilter:(f,y)=>y.includes("thermometer")?ht.includes(f.topic):y.includes(f.topic)})}r==="summary"&&k()}}function z(){i==null||i.destroy(),i=qt(t,{subtitleKey:"strand.heat.subtitle",activeSection:r,onSection:u=>{r==="tools"&&u!=="tools"&&a!=null&&a._thermometerLabCleanup&&(a._thermometerLabCleanup(),a=null),r=u,i.updateSection(r),P()},onLang:()=>z()}),s.main=i.main,i.updateSection(r),P()}function $(){return`
      <section class="panel panel--topic-hub">
        <h2>${d("topics.title")}</h2>
        <p class="lead">${d("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${He.map(u=>{const f=u.tool?`<button class="btn primary" type="button" data-go-tool="${u.tool}">${d("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${d("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${d(u.titleKey)}</h3>
              ${f}
            </div>`}).join("")}
        </div>
      </section>`}function I(u){const f=u.target.closest("[data-go-tool]");if(f){const v=f.getAttribute("data-go-tool");pt.includes(v)?o=v:o="liquid",r="tools",i.updateSection(r),P();return}const y=u.target.closest("[data-go-section]");(y==null?void 0:y.getAttribute("data-go-section"))==="notes"&&(r="notes",i.updateSection(r),P())}function H(){return`
      <section class="panel">
        <h2>${d("notes.title")}</h2>
        <p class="lead">${d("notes.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
      ...
      </section>`}async function W(){const u=Ne();for(const f of He){const y=t.querySelector(`[data-note-card="${f.id}"]`);if(!y)continue;const v=y.querySelector("[data-note-body]"),S=u==="zhHant"?f.fileZh:f.fileEn,T=await bt(S),G=`./notes/${S}`;T?v.innerHTML=`
          <iframe class="notes-grid" title="${d(`notes.card.${f.id}`)}" src="${G}"></iframe>
          <p style="margin-top:8px"><a href="${G}" target="_blank" rel="noopener">${d("notes.openPdf")}</a></p>`:v.innerHTML=`<p class="lead">${d("notes.missing")}</p>`}}function h(){return`
      <section class="panel">
        <h2>${d("summary.title")}</h2>
        <p class="lead">${d("summary.intro")}</p>
        <p class="lead">${d("notes.embedHint")}</p>
      ...
      </section>`}async function k(){const u=Ne();for(const f of He){const y=t.querySelector(`[data-summary-card="${f.id}"]`);if(!y)continue;const v=y.querySelector("[data-summary-body]");if(f.id==="thermometer"){const B=await Fe("summary","thermometer.webp"),O="./summary/thermometer.webp";B?v.innerHTML=`
          <img class="summary-thumb" src="${O}" alt="${d("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${O}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="heatInternalEnergy"){const B=u==="zhHant"?"heat-internal-energy-zhHant.webp":"heat-internal-energy-en.webp",O=await Fe("summary",B),D=`./summary/${B}`;O?v.innerHTML=`
          <img class="summary-thumb" src="${D}" alt="${d("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${D}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="changeOfState"){const B=await Fe("summary","change-of-state.webp"),O="./summary/change-of-state.webp";B?v.innerHTML=`
          <img class="summary-thumb" src="${O}" alt="${d("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${O}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}if(f.id==="heatTransfer"){const B=await Fe("summary","heat-transfer.webp"),O="./summary/heat-transfer.webp";B?v.innerHTML=`
          <img class="summary-thumb" src="${O}" alt="${d("summary.item.heatTransfer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${O}" target="_blank" rel="noopener">${d("summary.viewImage")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`;continue}const S=u==="zhHant"?f.fileZh:f.fileEn,T=await bt(S),G=`./notes/${S}`;T?v.innerHTML=`
          <iframe class="notes-grid" title="${d(`summary.item.${f.id}`)}" src="${G}"></iframe>
          <p style="margin-top:8px"><a href="${G}" target="_blank" rel="noopener">${d("summary.download")}</a></p>`:v.innerHTML=`<p class="lead">${d("summary.missing")}</p>`}}const _=()=>z(),g=u=>I(u);return window.addEventListener("s3phy:lang",_),t.addEventListener("click",g),z(),()=>{window.removeEventListener("s3phy:lang",_),t.removeEventListener("click",g),n==null||n(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const gt={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Wt();Ot();const vt="s3phy_splash_seen",_t={optics:ya,heat:Ma};let _e=null,Ee=null;function Ha(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(_t,r)?r:null}function _a(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function Et(t){_e==null||_e(),_e=null,Ee==null||Ee(),Ee=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&_a(),Ee=Bt(r);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}_e=_t[t](r)??null}function Ft(){Et(Ha())}function Ea(){return"./images/uniplus-logo.png"}function Fa(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Ea()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Aa(t,r){const o=[...gt.en,...gt.zhHant],i=()=>{if(!t.parentElement)return;const s=document.createElement("div");s.className="splash-danmaku-item",s.textContent=o[Math.floor(Math.random()*o.length)];const a=Math.random()*85+5,n=Math.random()*.8+.9,l=Math.random()*12+10;s.style.top=`${a}%`,s.style.fontSize=`${n}rem`,s.style.animationDuration=`${l}s`,r.appendChild(s),s.addEventListener("animationend",()=>s.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let s=0;s<4;s+=1)window.setTimeout(i,s*1e3)}function $a(t){const r=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),o&&Aa(t,o)},1600)}function yt(){Ft()}function Ia(){let t=!1;try{t=sessionStorage.getItem(vt)==="1"}catch{}if(t){yt();return}const r=Fa();document.body.insertBefore(r,document.body.firstChild),$a(r);const o=r.querySelector("#splashStart"),i=()=>{r.remove(),yt()};o.addEventListener("click",()=>{try{sessionStorage.setItem(vt,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",Ft);window.addEventListener("s3phy:strand",t=>{Et(t.detail??null)});Ia();
