(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))i(c);new MutationObserver(c=>{for(const o of c)if(o.type==="childList")for(const x of o.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&i(x)}).observe(document,{childList:!0,subtree:!0});function t(c){const o={};return c.integrity&&(o.integrity=c.integrity),c.referrerPolicy&&(o.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?o.credentials="include":c.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(c){if(c.ep)return;c.ep=!0;const o=t(c);fetch(c.href,o)}})();const se={"app.title":"Uni+ HKDSE Physics Hub","app.subtitle":"S3 Physics — Optics & Heat","strands.title":"Choose a strand","strands.intro":"Select Optics or Heat to open that learning hub.","strand.optics.title":"Optics","strand.optics.desc":"Light and waves: reflection, refraction, lenses, and electromagnetic waves.","strand.optics.subtitle":"Optics — light and waves","strand.heat.title":"Heat","strand.heat.desc":"Temperature, heat transfer, and thermal physics (interactive labs, worksheets, flashcards).","strand.heat.subtitle":"Heat — temperature and energy transfer","strand.open":"Open strand","strand.back":"All strands","heat.section.empty":"Heat strand content.","splash.start":"Start","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"Traditional Chinese","nav.topics":"Topics","nav.notes":"Notes","nav.tools":"Interactive Tools","nav.worksheets":"Worksheets","nav.flashcards":"Flashcards","nav.summary":"Summary","topics.title":"Topic map","topics.intro":"Choose a strand to study. Each topic links to the interactive lab.","topic.reflection":"Reflection","topic.rotatingMirror":"Rotating plane mirror","topic.refraction":"Refraction","topic.refractionSnell":"Refraction and Snell’s law","topic.tir":"Total internal reflection","topic.refractionTir":"Refraction, Snell’s law & total internal reflection","topic.convex":"Convex lens","topic.concave":"Concave lens","topic.em":"Electromagnetic waves","topic.openTool":"Open lab","notes.title":"Study notes (PDF)","notes.intro":"Add PDFs under public/notes/ (see README there). Until then, use the topic list and interactive tools.","notes.card.reflection":"Reflection","notes.card.refraction":"Refraction and Snell law","notes.card.tir":"Total internal reflection","notes.card.convexLens":"Convex lens","notes.card.concaveLens":"Concave lens","notes.card.em":"Electromagnetic spectrum","notes.openPdf":"Open PDF","notes.embedHint":"If the preview is blank, open the PDF in a new tab.","notes.missing":"PDF not uploaded yet.","tools.title":"Interactive labs","tools.pick":"Select a lab","tools.rotatingMirror.title":"Rotating plane mirror","tools.rotatingMirror.subtitle":"Ray shift when the mirror turns (?θ_ray = 2θ_mirror).","tools.rotatingMirror.toggle.origNormal":"Orig. normal","tools.rotatingMirror.toggle.origRay":"Orig. reflected","tools.rotatingMirror.toggle.newNormal":"New normal","tools.rotatingMirror.toggle.newRay":"New reflected","tools.rotatingMirror.incidentAngle":"Incident direction (°)","tools.rotatingMirror.mirrorRotation":"Mirror rotation θ (°)","tools.rotatingMirror.statIncidence":"Incidence angle i","tools.rotatingMirror.statReflection":"Reflection angle r","tools.rotatingMirror.rayShift":"Ray shift","tools.rotatingMirror.logicBadge":"Rule: 2 ? θ","tools.rotatingMirror.reset":"Reset rotation","tools.rotatingMirror.canvas.incident":"Incident ray","tools.rotatingMirror.canvas.originalReflected":"Original reflected","tools.rotatingMirror.canvas.newReflected":"New reflected","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"Shift","tools.refractionTir.title":"Prison Break lab — refraction, Snell & TIR","tools.refraction.title":"Refraction — Snell law","tools.refraction.n1":"n1 incident medium","tools.refraction.n2":"n2 second medium","tools.refraction.angle":"Angle of incidence (deg)","tools.tir.title":"Total internal reflection","tools.tir.n1":"n dense inside","tools.tir.n2":"n rare outside","tools.tir.angle":"Incidence in dense medium (deg)","tools.tir.critical":"Critical angle","tools.tir.state":"State","tools.tir.partial":"Partial refraction","tools.tir.full":"Total internal reflection","tools.lens.title":"Lens ray sketch","tools.convexLens.title":"Convex lens — ray sketch","tools.concaveLens.title":"Concave lens — ray sketch","tools.lens.type":"Lens type","tools.lens.convex":"Convex converging","tools.lens.concave":"Concave diverging","tools.lens.u":"Object distance u (cm)","tools.lens.f":"Focal length magnitude f (cm)","tools.lens.h":"Object height relative","tools.lens.note":"Convention: real u and v positive; convex f positive, concave f negative. Diagram is qualitative.","tools.rgbMixer.title":"RGB colour mixer","tools.rgbMixer.intro":"Additive mixing: red, green and blue light combine on screens. Drag sliders or use presets.","tools.rgbMixer.canvas":"RGB light overlap diagram","tools.rgbMixer.controls":"Colour controls","tools.rgbMixer.red":"Red","tools.rgbMixer.green":"Green","tools.rgbMixer.blue":"Blue","tools.rgbMixer.preview":"Mixed colour preview","tools.rgbMixer.presets":"Presets","tools.rgbMixer.presetRed":"Red","tools.rgbMixer.presetGreen":"Green","tools.rgbMixer.presetBlue":"Blue","tools.rgbMixer.presetYellow":"Yellow","tools.rgbMixer.presetCyan":"Cyan","tools.rgbMixer.presetMagenta":"Magenta","tools.rgbMixer.presetWhite":"White","tools.rgbMixer.presetBlack":"Black","topic.rgbMixer":"RGB colour mixing","tools.em.title":"Electromagnetic spectrum","tools.em.pick":"Explore wavelength, frequency, and simulation labs","worksheets.title":"Worksheet generator","worksheets.intro":"Generate practice worksheets with online checking, hints, and export.","worksheets.count":"Number of questions","worksheets.topics":"Topics","worksheets.generate":"Generate worksheet","worksheets.printPractice":"Print practice","worksheets.printAnswers":"Print answer key","worksheets.empty":"Click Generate to create questions.","worksheets.tabPractice":"Practice","worksheets.tabAnswer":"Answer key","worksheets.paperTitle":"S3 Optics — Multiple choice worksheet","worksheets.score":"Score","worksheets.hint":"Hint","worksheets.answer":"Answer","worksheets.today":"Today","worksheets.date":"Date","worksheets.exportWord":"Download Word","worksheets.exportWordAnswers":"Download answers (Word)","worksheets.sessionSummary":"Session summary","worksheets.firstTry":"Correct on first try","worksheets.revisionSuggestions":"Revision suggestions","worksheets.revisionExcellent":"Excellent — keep revising with flashcards.","worksheets.revisionGood":"Good progress — review any missed sections.","worksheets.revisionFair":"Fair — revisit summary notes for weak topics.","worksheets.revisionLow":"Needs work — study summaries and try again.","worksheets.weakSections":"Sections to review","flashcards.title":"Flashcards","flashcards.intro":"Flip cards to revise key terms. Reflection uses picture cards from your flashcard set.","flashcards.progress":"Card {current} of {total}","flashcards.deck":"Deck","flashcards.question":"Question","flashcards.answer":"Answer","flashcards.flip":"Flip","flashcards.next":"Next","flashcards.prev":"Previous","flashcards.shuffle":"Shuffle","flashcards.all":"All topics","flashcards.deck.refractionTir":"Refraction & TIR","summary.title":"Topic summaries","summary.intro":"HKDSE summary sheets (PDF). Preview below or open in a new tab to download.","summary.download":"Open / download PDF","summary.missing":"Summary PDF not found.","footer.conventions":"Ray diagrams use a consistent thin-lens sign convention stated in each lab.","summary.item.reflection":"Reflection","summary.item.refraction":"Refraction and Snell’s law","summary.item.tir":"Total internal reflection","summary.item.convex":"Convex lens","summary.item.concave":"Concave lens","summary.item.em":"Electromagnetic waves","topic.thermometer":"Thermometer","topic.heatInternalEnergy":"Heat and internal energy","topic.changeOfState":"Change of state","topic.heatTransfer":"Heat transfer","topic.thermometerLab":"Thermometry & Calibration Lab","topic.viewNotes":"View notes","notes.card.thermometer":"Ch.1.1 Thermometer","notes.card.heatInternalEnergy":"Ch.1.2 Heat and internal energy","notes.card.changeOfState":"Ch.1.3 Change of state","notes.card.heatTransfer":"Ch.1.4 Heat transfer process","summary.item.thermometer":"Thermometer","summary.item.heatInternalEnergy":"Heat and internal energy","summary.item.changeOfState":"Change of state","summary.item.heatTransfer":"Heat transfer","flashcards.deck.thermometry":"Thermometry (all types)","tools.thermometerLab.title":"Thermometry & Calibration Lab","tools.thermometerLab.subtitle":"Interactive study companion for liquid-in-glass, platinum resistance, and thermistor thermometers.","worksheets.paperTitleHeat":"S3 Heat — Multiple choice worksheet"},Ee={"app.title":"Uni+ HKDSE 物理學習中心","app.subtitle":"中三物理 — 光與熱","strands.title":"選擇單元","strands.intro":"選擇光學或熱學，進入該學習中心。","strand.optics.title":"光學","strand.optics.desc":"光與波動：反射、折射、透鏡與電磁波。","strand.optics.subtitle":"光學 — 光與波動","strand.heat.title":"熱學","strand.heat.desc":"溫度、熱傳入與熱力學（互動實驗室。工作紙、閃卡）。","strand.heat.subtitle":"熱學 — 溫度與熱傳入","strand.open":"進入單元","strand.back":"全部單元","heat.section.empty":"熱學單元內容。","splash.start":"開始","splash.unitEducation":"Unit Education","lang.en":"English","lang.zhHant":"繁體中文","nav.topics":"課題","nav.notes":"筆記","nav.tools":"互動實驗室","nav.worksheets":"工作紙","nav.flashcards":"閃卡","nav.summary":"總結","topics.title":"課題地圖","topics.intro":"選擇學習主題。每個主題可連到互動實驗室。","topic.reflection":"反射","topic.rotatingMirror":"旋轉平面鏡","topic.refraction":"折射","topic.refractionSnell":"折射與司乃耳定律","topic.tir":"全反射","topic.refractionTir":"折射、司乃耳定律與全內反射","topic.convex":"凸透鏡","topic.concave":"凹透鏡","topic.em":"電磁波","topic.openTool":"開啟實驗室","notes.title":"學習筆記（PDF）","notes.intro":"請把 PDF 放到 public/notes/ (見該資料夾 README)。完成前可先使用課題列表與互動工具。","notes.card.reflection":"反射","notes.card.refraction":"折射與司乃耳定律","notes.card.tir":"全內反射","notes.card.convexLens":"凸透鏡","notes.card.concaveLens":"凹透鏡","notes.card.em":"電磁波譜","notes.openPdf":"開啟 PDF","notes.embedHint":"若預覽空白，請在新分頁開啟 PDF。","notes.missing":"尚未上載 PDF。","tools.title":"互動實驗室","tools.pick":"選擇實驗","tools.rotatingMirror.title":"旋轉平面鏡","tools.rotatingMirror.subtitle":"鏡面轉動時反射光線的偏移（光線偏角 = 2 × 鏡角）。","tools.rotatingMirror.toggle.origNormal":"原法線","tools.rotatingMirror.toggle.origRay":"原反射光","tools.rotatingMirror.toggle.newNormal":"新法線","tools.rotatingMirror.toggle.newRay":"新反射光","tools.rotatingMirror.incidentAngle":"入射方向（°）","tools.rotatingMirror.mirrorRotation":"鏡面轉角 θ（°）","tools.rotatingMirror.statIncidence":"入射觔 i","tools.rotatingMirror.statReflection":"反射觔 r","tools.rotatingMirror.rayShift":"光線偏移","tools.rotatingMirror.logicBadge":"關係：2 × θ","tools.rotatingMirror.reset":"重設轉角","tools.rotatingMirror.canvas.incident":"入射光線","tools.rotatingMirror.canvas.originalReflected":"原反射光線","tools.rotatingMirror.canvas.newReflected":"新反射光線","tools.rotatingMirror.canvas.n":"n","tools.rotatingMirror.canvas.nPrime":"n′","tools.rotatingMirror.canvas.shift":"偏移","tools.refractionTir.title":"逃獄遊戲 — 折射、司乃耳與全內反射","tools.refraction.title":"折射 — 司乃耳定律","tools.refraction.n1":"n1 入射介質","tools.refraction.n2":"n2 第二介質","tools.refraction.angle":"入射觔（度）","tools.tir.title":"全內反射","tools.tir.n1":"n 密（光密）","tools.tir.n2":"n 疏（光疏）","tools.tir.angle":"光密介質內入射觔（度）","tools.tir.critical":"臨界觔","tools.tir.state":"狀態","tools.tir.partial":"部分折射","tools.tir.full":"全內反射","tools.lens.title":"透鏡 — 光線示意","tools.convexLens.title":"凸透鏡 — 光線示意","tools.concaveLens.title":"凹透鏡 — 光線示意","tools.lens.type":"透鏡類型","tools.lens.convex":"凸透鏡（會聚）","tools.lens.concave":"凹透鏡（發散）","tools.lens.u":"物距 u（厘米）","tools.lens.f":"焦距大小 f（厘米）","tools.lens.h":"物高（相對）","tools.lens.note":"符號：實物、實像距離取正；凸透鏡 f 為正，凹透鏡 f 為負。圖示為定性示意。","tools.rgbMixer.title":"RGB 顏色混合","tools.rgbMixer.intro":"加法混色：紅、綠、藍光在蟻幕上疊加。拖動滑棒或使用預設。","tools.rgbMixer.canvas":"RGB 光線疊加示意圖","tools.rgbMixer.controls":"顏色控制","tools.rgbMixer.red":"紅","tools.rgbMixer.green":"綠","tools.rgbMixer.blue":"藍","tools.rgbMixer.preview":"混合顏色預覽","tools.rgbMixer.presets":"預設","tools.rgbMixer.presetRed":"紅","tools.rgbMixer.presetGreen":"綠","tools.rgbMixer.presetBlue":"藍","tools.rgbMixer.presetYellow":"黃","tools.rgbMixer.presetCyan":"青","tools.rgbMixer.presetMagenta":"品紅","tools.rgbMixer.presetWhite":"白","tools.rgbMixer.presetBlack":"黑","topic.rgbMixer":"RGB 顏色混合","tools.em.title":"電磁波譜","tools.em.pick":"探索波長、頻率與模擬實驗","worksheets.title":"工作紙產生器","worksheets.intro":"產生練習工作紙，支援線上核對、提示與匯出。","worksheets.count":"題數","worksheets.topics":"課題","worksheets.generate":"產生工作紙","worksheets.printPractice":"列印練習","worksheets.printAnswers":"列印答案","worksheets.empty":"按產生工作紙建立題目。","worksheets.tabPractice":"練習模式","worksheets.tabAnswer":"答案","worksheets.paperTitle":"S3 光學 — 多項選擇題工作紙","worksheets.score":"得分","worksheets.hint":"提示","worksheets.answer":"答案","worksheets.today":"今日","worksheets.date":"日期","worksheets.exportWord":"下載 Word","worksheets.exportWordAnswers":"下載答案（Word）","worksheets.sessionSummary":"本次練習摘要","worksheets.firstTry":"首次即答對","worksheets.revisionSuggestions":"複習建議","worksheets.revisionExcellent":"優秀 — 繼續用閃卡複習。","worksheets.revisionGood":"良好 — 重溫錯題所屬節。","worksheets.revisionFair":"一般 — 回顧總結針對弱項。","worksheets.revisionLow":"需努力 — 先温習總結再試。","worksheets.weakSections":"建議複習節次","flashcards.title":"閃卡","flashcards.intro":"翻卡複習重要詞彙。反射課題使用圖片閃卡。","flashcards.progress":"第 {current} 張，共 {total} 張","flashcards.deck":"卡組","flashcards.question":"問題","flashcards.answer":"答案","flashcards.flip":"翻面","flashcards.next":"下一張","flashcards.prev":"上一張","flashcards.shuffle":"洗牌","flashcards.all":"全部課題","flashcards.deck.refractionTir":"折射與全內反射","summary.title":"課題總結","summary.intro":"HKDSE 總結表（PDF）。可於下方預覽，或新分頁開啟下載。","summary.download":"開啟 / 下載 PDF","summary.missing":"找不到總結 PDF。","footer.conventions":"透鏡光線圖採用與各實驗室說明一致的薄透鏡符號規定。","summary.item.reflection":"反射","summary.item.refraction":"折射與司乃耳定律","summary.item.tir":"全內反射","summary.item.convex":"凸透鏡","summary.item.concave":"凹透鏡","summary.item.em":"電磁波","topic.thermometer":"溫度計","topic.heatInternalEnergy":"熱與內能","topic.changeOfState":"物態變化","topic.heatTransfer":"熱傳入","topic.thermometerLab":"溫度計與校準實驗室","topic.viewNotes":"查閱筆記","notes.card.thermometer":"Ch.1.1 溫度計","notes.card.heatInternalEnergy":"Ch.1.2 熱與內能","notes.card.changeOfState":"Ch.1.3 物態變化","notes.card.heatTransfer":"Ch.1.4 熱傳入","summary.item.thermometer":"溫度計","summary.item.heatInternalEnergy":"熱與內能","summary.item.changeOfState":"物態變化","summary.item.heatTransfer":"熱傳入","flashcards.deck.thermometry":"溫度計（各類）","tools.thermometerLab.title":"溫度計與校準實驗室","tools.thermometerLab.subtitle":"液體玻璃、鈐電阻及熱敏電阻溫度計的互動學習伴侶。","worksheets.paperTitleHeat":"S3 熱學 — 多項選擇題工作紙"},xe="s3phy.lang",qe={en:se,"zh-Hant":Ee};let le="en";function $e(){try{const n=localStorage.getItem(xe);if(n==="zh-Hant"||n==="en")return n}catch{}return"en"}function ze(){le=$e()}function Se(n){if(qe[n]){le=n;try{localStorage.setItem(xe,n)}catch{}document.documentElement.lang=n==="zh-Hant"?"zh-Hant":"en",window.dispatchEvent(new CustomEvent("s3phy:lang"))}}function J(){return le}function s(n){const a=qe[le]||se;return Object.prototype.hasOwnProperty.call(a,n)?a[n]:Object.prototype.hasOwnProperty.call(se,n)?se[n]:n}const Ie=[{id:"optics",titleKey:"strand.optics.title",descKey:"strand.optics.desc"},{id:"heat",titleKey:"strand.heat.title",descKey:"strand.heat.desc"}];function Fe(n){function a(){n.innerHTML=`
      ...
      <section class="panel panel--topic-hub panel--strand-hub">
        ...
        <div class="grid cols-2 topic-hub-grid strand-hub-grid">
          ${Ie.map(({id:c,titleKey:o,descKey:x})=>`
            <div class="card">
              <h3>${s(o)}</h3>
              <p>${s(x)}</p>
...
`;function De(){if(document.getElementById(me))return;const n=document.createElement("style");n.id=me,n.textContent=Pe,document.head.appendChild(n)}function Qe(n){De();const a=document.createElement("div");a.className="rml",a.innerHTML=`
    <div class="rml-head">
  ...
  `;const t=a.querySelector(".rml-canvas"),i=t.getContext("2d"),c=a.querySelector("[data-rml-rot]"),o=a.querySelector("[data-rml-inc]"),x=a.querySelector('[data-rml-disp="rot"]'),w=a.querySelector('[data-rml-disp="inc"]'),z=a.querySelector('[data-rml-val="i"]'),D=a.querySelector('[data-rml-val="r"]'),$=a.querySelector('[data-rml-val="shift"]'),C=350,I=380,N=300,_="#22d3ee",L="bold 17px system-ui, sans-serif";let A=0,F=-140,Q=!0,W=!0,O=!0,G=!0;function P(R){return R*Math.PI/180}function j(R,l,d,m,e,r=2,y=!1){i.beginPath(),i.lineWidth=r,i.strokeStyle=e,i.setLineDash(y?[6,6]:[]);const h=R+Math.cos(P(d))*m,p=l+Math.sin(P(d))*m;return i.moveTo(R,l),i.lineTo(h,p),i.stroke(),i.setLineDash([]),{x:h,y:p}}function B(R,l,d,m,e,r=14){const y=d-R,h=m-l,p=Math.hypot(y,h);if(p<1e-6)return;const v=y/p,u=h/p,S=d-v*r,f=m-u*r,M=.45*r;i.beginPath(),i.fillStyle=e,i.moveTo(d,m),i.lineTo(S-u*M,f+v*M),i.lineTo(S+u*M,f-v*M),i.closePath(),i.fill()}function g(R,l,d,m,e,r=25){i.beginPath(),i.strokeStyle=m,i.lineWidth=2;const y=Math.min(R,l),h=Math.max(R,l);if(i.arc(C,I,d,P(y),P(h),!1),i.stroke(),e){const p=(y+h)/2,v=C+Math.cos(P(p))*(d+r),u=I+Math.sin(P(p))*(d+r);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=m,i.fillText(e,v,u),i.restore()}}function q(R,l,d,m,e){i.clearRect(0,0,t.width,t.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(C-200,I),i.lineTo(C+200,I),i.stroke(),i.setLineDash([]),i.lineCap="butt";const r=C+Math.cos(P(R))*N,y=I+Math.sin(P(R))*N;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(r,y),i.lineTo(C,I),i.stroke();const h=(r+C)*.5,p=(y+I)*.5,v=Math.hypot(C-r,I-y)||1,u=(C-r)/v,S=(I-y)/v;if(B(h-u*28,p-S*28,h,p,"#fff",16),i.save(),i.font=L,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(n("tools.rotatingMirror.canvas.incident"),r,y-12),i.restore(),Q){const f=j(C,I,-90,N-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(n("tools.rotatingMirror.canvas.n"),f.x+6,f.y-4),i.restore()}if(W){const f=j(C,I,m,N,"#00e676",2,!1);B(C,I,f.x,f.y,"#00e676",16),i.save(),i.font=L,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(n("tools.rotatingMirror.canvas.originalReflected"),f.x,f.y-14),i.restore()}i.save(),i.translate(C,I),i.rotate(P(A)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let f=-190;f<200;f+=15)i.moveTo(f,0),i.lineTo(f-5,8);if(i.stroke(),i.restore(),O){const f=j(C,I,l,N-40,_,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=_,i.fillText(n("tools.rotatingMirror.canvas.nPrime"),f.x+6,f.y-4),i.restore()}if(G){const f=j(C,I,d,N,_,4);B(C,I,f.x,f.y,_,16),Math.abs(A)>.5&&(i.save(),i.font=L,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=_,i.fillText(n("tools.rotatingMirror.canvas.newReflected"),f.x,f.y-14),i.restore())}if(O&&g(R,l,100,"#ffcc00",`i=${e.toFixed(0)}°`,25),O&&G&&g(l,d,100,_,`r=${e.toFixed(0)}°`,25),Q&&O&&Math.abs(A)>.5&&g(-90,l,50,"#ffcc00",`θ=${Math.abs(A)}°`,20),W&&G&&Math.abs(A)>.5){const f=d-m;g(m,d,260,"#ff5252",`${n("tools.rotatingMirror.canvas.shift")}=${f.toFixed(0)}°`,40)}}function E(){A=parseFloat(c.value),F=parseFloat(o.value);const R=A>0?"+":"";x.textContent=`${R}${A}°`,w.textContent=`${F}°`;const l=-90,d=Math.abs(F-l),m=l+d,e=-90+A,r=Math.abs(F-e),y=e+r,h=y-m;z.textContent=`${r.toFixed(1)}°`,D.textContent=`${r.toFixed(1)}°`;const p=h>0?"+":"";$.textContent=`${p}${h.toFixed(1)}°`,q(F,e,y,m,r)}return a.querySelectorAll("[data-rml-toggle]").forEach(R=>{R.addEventListener("click",()=>{const l=R.getAttribute("data-rml-toggle");l==="orig-norm"&&(Q=!Q),l==="orig-ray"&&(W=!W),l==="new-norm"&&(O=!O),l==="new-ray"&&(G=!G),R.classList.toggle("active"),E()})}),a.querySelector("[data-rml-reset]").addEventListener("click",()=>{c.value="0",E()}),c.addEventListener("input",E),o.addEventListener("input",E),E(),a}function Oe(n){const a=document.createElement("div");a.className="tool-tir-escape";const t=document.createElement("iframe"),i="./",c=i.endsWith("/")?i:`${i}/`;return t.src=`${c}tir-escape/index.html?embed=1`,t.title=n("tools.refractionTir.title"),t.setAttribute("loading","lazy"),t.referrerPolicy="strict-origin-when-cross-origin",a.appendChild(t),a}function je(n,a={}){const t=a.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",c=document.createElement("div");c.className="tool-lens-simulator";const o=document.createElement("iframe"),x="./",w=x.endsWith("/")?x:`${x}/`;return o.src=`${w}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(t)}`,o.title=n(i),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",c.appendChild(o),c}function Ne(n){const a=document.createElement("div");a.className="tool-em-spectrum";const t=document.createElement("iframe"),i="./",c=i.endsWith("/")?i:`${i}/`;function o(){return`${c}em-spectrum/index.html?lang=${encodeURIComponent(J())}`}t.src=o(),t.title=n("tools.em.title"),t.setAttribute("loading","lazy"),t.referrerPolicy="strict-origin-when-cross-origin";const x=()=>{var w;try{(w=t.contentWindow)==null||w.postMessage({type:"s3phy:lang",lang:J()},"*")}catch{t.src=o()}};return window.addEventListener("s3phy:lang",x),a._emLabCleanup=()=>window.removeEventListener("s3phy:lang",x),a.appendChild(t),a}function Be(n){const a=document.createElement("div");a.className="rgb-mixer",a.innerHTML=`
  ...
  `;const t=a.querySelector("[data-r]"),i=a.querySelector("[data-g]"),c=a.querySelector("[data-b]"),o=a.querySelector(".rgb-mixer-canvas"),x=a.querySelector(".rgb-mixer-stage"),w=o.getContext("2d");function z(_){return _.toString(16).padStart(2,"0")}function D(_,L,A){const F=o.width/(window.devicePixelRatio||1),Q=o.height/(window.devicePixelRatio||1),W=F/2,O=Q/2,G=Math.min(F,Q)*.34,P=G*.5,j=Math.sqrt(3)/2;w.clearRect(0,0,F,Q),w.fillStyle="#000",w.fillRect(0,0,F,Q);const B=[{x:W,y:O-P,rgb:[255,0,0],val:_},{x:W-P*j,y:O+P*.5,rgb:[0,255,0],val:L},{x:W+P*j,y:O+P*.5,rgb:[0,0,255],val:A}];w.globalCompositeOperation="lighter",B.forEach(g=>{if(g.val<=0)return;const q=g.val/255,[E,R,l]=g.rgb,d=w.createRadialGradient(g.x,g.y,0,g.x,g.y,G);d.addColorStop(0,`rgba(${E},${R},${l},${q})`),d.addColorStop(.65,`rgba(${E},${R},${l},${q})`),d.addColorStop(.85,`rgba(${E},${R},${l},${q*.5})`),d.addColorStop(1,`rgba(${E},${R},${l},0)`),w.fillStyle=d,w.beginPath(),w.arc(g.x,g.y,G,0,Math.PI*2),w.fill()}),w.globalCompositeOperation="source-over"}function $(){const _=x.getBoundingClientRect(),L=Math.max(200,Math.min(_.width-8,_.height-8,720)),A=window.devicePixelRatio||1;o.width=L*A,o.height=L*A,o.style.width=`${L}px`,o.style.height=`${L}px`,w.setTransform(A,0,0,A,0,0),D(+t.value,+i.value,+c.value)}function C(){const _=+t.value,L=+i.value,A=+c.value,F=`rgb(${_}, ${L}, ${A})`,Q=`#${z(_)}${z(L)}${z(A)}`;a.querySelector("[data-r-val]").textContent=_,a.querySelector("[data-g-val]").textContent=L,a.querySelector("[data-b-val]").textContent=A,a.querySelector("[data-r-bar]").style.width=`${_/255*100}%`,a.querySelector("[data-g-bar]").style.width=`${L/255*100}%`,a.querySelector("[data-b-bar]").style.width=`${A/255*100}%`,t.style.setProperty("--fill",`${_/255*100}%`),i.style.setProperty("--fill",`${L/255*100}%`),c.style.setProperty("--fill",`${A/255*100}%`);const W=a.querySelector("[data-swatch]");W.style.backgroundColor=F,W.setAttribute("aria-label",`${n("tools.rgbMixer.preview")}: ${F}`),a.querySelector("[data-rgb-text]").textContent=F,a.querySelector("[data-hex-text]").textContent=Q,D(_,L,A)}function I(_,L,A){t.value=_,i.value=L,c.value=A,C()}return[t,i,c].forEach(_=>_.addEventListener("input",C)),a.querySelectorAll(".rgb-presets button").forEach(_=>{_.addEventListener("click",()=>{I(+_.dataset.r,+_.dataset.g,+_.dataset.b)})}),new ResizeObserver(()=>$()).observe(x),requestAnimationFrame(()=>{$(),C()}),a}const Ve=["topics","notes","tools","worksheets","flashcards","summary"],Ge={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function Ce(n,{subtitleKey:a,activeSection:t,onSection:i,onLang:c}){n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-main]"),x=n.querySelector("[data-nav]"),w=n.querySelector("[data-lang]"),z=n.querySelector("[data-strand-back]");let D=t;function $(_){D=_,x.innerHTML=Ve.map(L=>`<button type="button" class="${_===L?"active":""}" data-sec="${L}">${s(Ge[L])}</button>`).join(""),x.querySelectorAll("button").forEach(L=>{L.addEventListener("click",()=>i(L.getAttribute("data-sec")))})}function C(){w.innerHTML=`
      <button type="button" data-set-lang="en" class="${J()==="en"?"active":""}">${s("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${J()==="zh-Hant"?"active":""}">${s("lang.zhHant")}</button>
    `,w.querySelectorAll("button").forEach(_=>{_.addEventListener("click",()=>{Se(_.getAttribute("data-set-lang")),c()})})}function I(){n.querySelector("[data-hub-subtitle]").textContent=s(a),z.textContent=s("strand.back"),n.querySelector("[data-hub-footer]").textContent=s("footer.conventions"),n.querySelector(".site-title").textContent=s("app.title")}const N=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return z.addEventListener("click",N),$(t),C(),{main:o,updateSection(_){$(_)},refreshLabels(){I(),$(D),C()},destroy(){z.removeEventListener("click",N)}}}const ue=["A","B","C","D"];function fe(n){const a=n.slice();for(let t=a.length-1;t>0;t-=1){const i=Math.floor(Math.random()*(t+1));[a[t],a[i]]=[a[i],a[t]]}return a}function Ye(n,a,t){return n.filter(i=>{if(t)return t(i,a);const c=i.topic;return!!(a.includes(c)||a.includes("rotatingMirror")&&c==="reflection"||a.includes("refraction")&&c==="refraction"||a.includes("tir")&&c==="tir"||c==="convex"&&a.includes("convex")||c==="concave"&&a.includes("concave"))})}function Xe(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function K(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function _e(n,a={}){const t=a.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=a.paperTitleKey??"worksheets.paperTitle";return`
    ...
    </section>`}function Me(n,a,t,i,c={}){var m,e,r,y;const o={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},x=n.querySelector("[data-ws-gen]"),w=n.querySelector("[data-ws-preview-area]"),z=n.querySelector("[data-ws-out]"),D=n.querySelector("[data-ws-body]"),$=n.querySelector("[data-ws-paper]"),C=n.querySelector("[data-ws-tabs]"),I=n.querySelector("[data-ws-practice-actions]"),N=n.querySelector("[data-ws-score]"),_=n.querySelector("[data-ws-score-val]"),L=n.querySelector("[data-ws-summary]"),A=n.querySelector("[data-ws-date-row]"),F=n.querySelector("[data-ws-date-print]"),Q=n.querySelector("[data-ws-date-today]"),W=n.querySelector("[data-ws-date-label]");if(!x||!D)return;function O(){return i()}function G(){o.userAnswers={},o.wrongAttempts={},o.resolved={},N.hidden=!0,L.hidden=!0}function P(){return o.items.length>0&&o.items.every((h,p)=>o.resolved[p])}function j(){let h=0;o.items.forEach((v,u)=>{if(!o.resolved[u])return;const S=v[O()]||v.en;o.userAnswers[u]===S.a&&(h+=1)}),Object.keys(o.resolved).length>0&&(_.textContent=`${h}/${o.items.length}`,N.hidden=!1)}function B(h){o.tab=h,C==null||C.querySelectorAll("[data-ws-tab]").forEach(p=>{p.classList.toggle("active",p.getAttribute("data-ws-tab")===h)}),I&&(I.hidden=h!=="practice"),A&&(A.hidden=h!=="practice"),F&&(F.hidden=!o.dateStr,F.textContent=o.dateStr?`${t("worksheets.date")}: ${o.dateStr}`:""),$==null||$.classList.toggle("practice-mode",h==="practice"),q()}function g(h,p,v){const u=h[O()]||h.en,S=ue,f=p+1,M=h.section?`<span class="q-section">${K(h.section)}</span>`:"";if(v==="answer"){const Z=u.choices.map((U,Y)=>`<li class="${Y===u.a?"choice-correct":""}"><strong>${S[Y]}.</strong> ${K(U)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${f} ${M}</h4>
        <p>${K(u.q)}</p>
        <ol class="choice-list">${Z}</ol>
        <p class="q-exp"><strong>${t("worksheets.answer")}:</strong> ${S[u.a]}</p>
        <p class="q-exp"><em>${K(u.exp)}</em></p>
      </div>`}const k=o.userAnswers[p],b=o.wrongAttempts[p]||0,H=o.resolved[p],T=H&&k===u.a,V=H&&k!==u.a;let X="";b===1&&!H?X=`<p class="q-hint"><strong>${t("worksheets.hint")}:</strong> ${K(u.hint||u.exp)}</p>`:V&&(X=`<p class="q-exp"><strong>${t("worksheets.answer")}:</strong> ${S[u.a]}</p>
        <p class="q-exp q-summary"><em>${K(u.exp)}</em></p>`);const ee=T?"correct":V?"incorrect":"",pe=u.choices.map((Z,U)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${p}" value="${U}" data-ws-q="${p}" data-ws-choice="${U}"${k===U?" checked":""}${H?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${S[U]}.</strong> ${K(Z)}
          </label>
        </li>`).join("");return`<div class="question-row ${ee}" data-ws-row="${p}">
      <div class="q-header"><h4>Q${f} ${M}</h4>${T?'<span class="result-icon">✓</span>':V?'<span class="result-icon">✗</span>':""}</div>
      <p>${K(u.q)}</p>
      <ol class="choice-list choice-list--radio">${pe}</ol>
      ${X}
    </div>`}function q(){o.items.length&&(D.innerHTML=o.items.map((h,p)=>g(h,p,o.tab)).join(""),E())}function E(){o.tab==="practice"&&D.querySelectorAll("[data-ws-choice]").forEach(h=>{h.addEventListener("change",()=>{const p=Number(h.getAttribute("data-ws-q"));if(o.resolved[p])return;const v=Number(h.getAttribute("data-ws-choice")),u=o.items[p][O()]||o.items[p].en;o.userAnswers[p]=v,v===u.a?o.resolved[p]=!0:(o.wrongAttempts[p]=(o.wrongAttempts[p]||0)+1,o.wrongAttempts[p]>=2&&(o.resolved[p]=!0)),j(),P()&&R(),q()})})}function R(){const h=o.items.length;let p=0,v=0;const u={};o.items.forEach((k,b)=>{const H=k[O()]||k.en;if(o.userAnswers[b]===H.a)p+=1,(o.wrongAttempts[b]||0)===0&&(v+=1);else if(o.resolved[b]){const V=k.section||k.topic;u[V]=(u[V]||0)+1}});const S=h?Math.round(p/h*100):0;let f=t("worksheets.revisionFair");S>=90?f=t("worksheets.revisionExcellent"):S>=70?f=t("worksheets.revisionGood"):S<50&&(f=t("worksheets.revisionLow"));const M=Object.entries(u).sort((k,b)=>b[1]-k[1]).map(([k,b])=>`<li>${K(k)} (${b})</li>`).join("");L.innerHTML=`
      <h4>${t("worksheets.sessionSummary")}</h4>
      <p>${t("worksheets.score")}: <strong>${p}/${h}</strong> (${S}%)</p>
      <p>${t("worksheets.firstTry")}: <strong>${v}/${h}</strong></p>
      <p>${t("worksheets.revisionSuggestions")}: ${f}</p>
      ${M?`<p>${t("worksheets.weakSections")}:</p><ul>${M}</ul>`:""}`,L.hidden=!1}function l(h){const p=O(),v=o.items.map((u,S)=>{const f=u[p]||u.en,M=f.choices.map((b,H)=>`${ue[H]}. ${b}`).join("<br/>"),k=h?`<p><b>${t("worksheets.answer")}:</b> ${ue[f.a]}<br/><i>${f.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${S+1}.</b> ${f.q}<br/>${M}${k}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${t("worksheets.paperTitle")}</title></head>
<body><h2>${t("worksheets.paperTitle")}</h2>
${o.dateStr&&!h?`<p>${t("worksheets.date")}: ${o.dateStr}</p>`:""}
${v}</body></html>`}function d(h){const p=l(h),v=new Blob(["\uFEFF",p],{type:"application/msword"}),u=document.createElement("a");u.href=URL.createObjectURL(v),u.download=h?"worksheet-answers.doc":"worksheet.doc",u.click(),URL.revokeObjectURL(u.href)}x.addEventListener("click",()=>{const h=Number(n.querySelector("[data-ws-count]").value),p=[...n.querySelectorAll("[data-ws-topic]")].filter(S=>S.checked).map(S=>S.getAttribute("data-ws-topic")),v=Ye(a,p,c.topicFilter),u=fe(v).slice(0,Math.min(h,v.length||1));o.items=u.length?u:fe(a).slice(0,Math.min(h,a.length)),G(),o.tab="practice",o.dateStr="",w.hidden=!1,z.hidden=!0,C==null||C.querySelectorAll("[data-ws-tab]").forEach(S=>{S.classList.toggle("active",S.getAttribute("data-ws-tab")==="practice")}),I&&(I.hidden=!1),A&&(A.hidden=!1),F&&(F.hidden=!0),W.textContent="",$==null||$.classList.add("practice-mode"),q()}),C==null||C.addEventListener("click",h=>{const p=h.target.closest("[data-ws-tab]");!p||!o.items.length||B(p.getAttribute("data-ws-tab"))}),Q==null||Q.addEventListener("click",()=>{o.dateStr?(o.dateStr="",W.textContent=""):(o.dateStr=Xe(),W.textContent=`${t("worksheets.date")}: ${o.dateStr}`),F&&(F.hidden=!o.dateStr,F.textContent=o.dateStr?`${t("worksheets.date")}: ${o.dateStr}`:"")}),(m=n.querySelector("[data-ws-word-p]"))==null||m.addEventListener("click",()=>d(!1)),(e=n.querySelector("[data-ws-word-a]"))==null||e.addEventListener("click",()=>d(!0)),(r=n.querySelector("[data-ws-print-p]"))==null||r.addEventListener("click",()=>{B("practice"),$==null||$.classList.add("ws-print-blank");const h=()=>$==null?void 0:$.classList.remove("ws-print-blank");window.addEventListener("afterprint",h,{once:!0}),window.print()}),(y=n.querySelector("[data-ws-print-a]"))==null||y.addEventListener("click",()=>{B("answer"),window.print()})}const Ue=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Ke={rotatingMirror:n=>Qe(n),refractionTir:n=>Oe(n),lens:(n,a)=>je(n,{defaultKind:a}),rgbMixer:n=>Be(n),em:n=>Ne(n)};function Ze(n){return s({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[n]||n)}function re(){return J()==="zh-Hant"?"zhHant":"en"}async function Re(n,a){const t=`./${n}/${a}`;try{return(await fetch(t,{method:"HEAD"})).ok}catch{return!1}}async function Je(n){return Re("notes",n)}function et(n){let a="topics",t="rotatingMirror",i="convex",c=0,o="all",x=!1,w=null,z={main:null};function D(){z.main&&(a==="topics"?z.main.innerHTML=C():a==="notes"?z.main.innerHTML=N():a==="tools"?z.main.innerHTML=L():a==="worksheets"?z.main.innerHTML=_e(s):a==="flashcards"?z.main.innerHTML=Q():a==="summary"&&(z.main.innerHTML=g()),a==="notes"&&_(),a==="tools"&&A(),a==="worksheets"&&Me(n,Te,s,re),a==="flashcards"&&B(),a==="summary"&&q())}function $(){w==null||w.destroy(),w=Ce(n,{subtitleKey:"strand.optics.subtitle",activeSection:a,onSection:l=>{a=l,w.updateSection(a),D()},onLang:()=>$()}),z.main=w.main,w.updateSection(a),D()}function C(){const l=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${l.map(([d,m])=>{const e=d==="convex"||d==="concave"?"lens":d==="refraction"||d==="tir"?"refractionTir":d==="em"?"em":d,r=d==="convex"?"convex":d==="concave"?"concave":"";return`
            <div class="card">
              <h3>${s(m)}</h3>
              <button class="btn primary" type="button" data-go-tool="${e}"${r?` data-lens-kind="${r}"`:""}>${s("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function I(l){const d=l.target.closest("[data-go-tool]");if(!d)return;a="tools",t=d.getAttribute("data-go-tool");const m=d.getAttribute("data-lens-kind");(m==="convex"||m==="concave")&&(i=m),w.updateSection(a),D()}function N(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${l.map(d=>{const m=s(`notes.card.${d.key}`);return`
            <div class="card" data-note-card="${d.key}">
              <h3>${m}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function _(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],d=re();for(const m of l){const e=n.querySelector(`[data-note-card="${m.key}"]`);if(!e)continue;const r=e.querySelector("[data-note-body]"),y=d==="zhHant"?m.fileZh:m.fileEn,h=await Je(y),p=`./notes/${y}`;h?r.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${m.key}`)}" src="${p}"></iframe>
          <p style="margin-top:8px"><a href="${p}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:r.innerHTML=`<p class="lead">${s("notes.missing")}</p>
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ue.map(l=>`<button type="button" data-tool="${l}" class="${t===l?"active":""}">${Ze(l)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function A(){const l=n.querySelector("[data-tool-list]"),d=n.querySelector("[data-tool-stage]");!l||!d||(l.querySelectorAll("button").forEach(m=>{m.addEventListener("click",()=>{t=m.getAttribute("data-tool"),l.querySelectorAll("button").forEach(e=>e.classList.toggle("active",e.getAttribute("data-tool")===t)),F(d)})}),F(d))}function F(l){l.innerHTML="";const d=Ke[t];if(!d)return;const m=t==="lens"?d(s,i):d(s);l.appendChild(m)}function Q(){return`
      <section class="panel">
      ...
      </section>`}function W(l){return!!(l!=null&&l.front)}function O(l){return`./${String(l).replace(/^\.\//,"")}`}function G(){return ke.slice()}function P(){const l=We.slice(),d=G(),m=o==="rotatingMirror"?"reflection":o;if(m==="all")return[...l,...d];if(m==="reflection")return l;if(m==="convex"||m==="concave"){const r=d.filter(y=>y.topic==="convex"||y.topic==="concave");return r.length?r:d}if(m==="refractionTir"){const r=d.filter(y=>y.topic==="refraction"||y.topic==="tir");return r.length?r:d}const e=d.filter(r=>r.topic===m);return e.length?e:d}function j(){const l=P(),d=n.querySelector("[data-flash-progress]");if(!l.length){c=0;const v=n.querySelector("[data-flash-front]"),u=n.querySelector("[data-flip-card]");v&&(v.textContent=""),u&&u.classList.remove("flashcard-surface--image"),d&&(d.hidden=!0,d.textContent="");return}c=Math.max(0,Math.min(c,l.length-1));const m=l[c],e=n.querySelector("[data-flash-front]"),r=n.querySelector("[data-flip-card]"),y=n.querySelector("[data-flash-label]");if(!e||!r)return;if(d&&(d.hidden=!1,d.textContent=s("flashcards.progress").replace("{current}",String(c+1)).replace("{total}",String(l.length))),W(m)){const v=m.back&&m.back!==m.front;r.classList.add("flashcard-surface--image"),y&&(v?(y.hidden=!1,y.textContent=s(x?"flashcards.answer":"flashcards.question")):y.hidden=!0);const u=x&&m.back?m.back:m.front,S=m.alt||m.title||"";e.innerHTML=`<img src="${O(u)}" alt="${S.replace(/"/g,"&quot;")}" loading="lazy" />`;return}r.classList.remove("flashcard-surface--image");const h=re(),p=m[h]||m.en;y&&(y.hidden=!1,y.textContent=s(x?"flashcards.answer":"flashcards.question")),e.textContent=x?p.a:p.q}function B(){o==="rotatingMirror"&&(o="reflection");const l=n.querySelector("[data-flash-deck]");l.value=o,l.addEventListener("change",()=>{o=l.value,c=0,x=!1,j()}),n.querySelector("[data-flip-card]").addEventListener("click",()=>{x=!x,j()}),n.querySelector("[data-flash-flip]").addEventListener("click",d=>{d.stopPropagation(),x=!x,j()}),n.querySelector("[data-flash-prev]").addEventListener("click",()=>{const d=P();c=(c-1+d.length)%d.length,x=!1,j()}),n.querySelector("[data-flash-next]").addEventListener("click",()=>{const d=P();c=(c+1)%d.length,x=!1,j()}),n.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const d=P();c=Math.floor(Math.random()*d.length),x=!1,j()}),j()}function g(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${l.map(d=>{const m=s(`summary.item.${d.key}`);return`
            <div class="card" data-summary-card="${d.key}">
              <h3>${m}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function q(){const l=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",fileEn:"convex-en.pdf",fileZh:"convex-zhHant.pdf"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],d=re();for(const m of l){const e=n.querySelector(`[data-summary-card="${m.key}"]`);if(!e)continue;const r=e.querySelector("[data-summary-body]"),y=d==="zhHant"?m.fileZh:m.fileEn,h=await Re("summary-pdfs",y),p=`./summary-pdfs/${y}`;h?r.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${m.key}`)}" src="${p}"></iframe>
          <p style="margin-top:8px"><a href="${p}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:r.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const E=()=>$(),R=l=>I(l);return window.addEventListener("s3phy:lang",E),n.addEventListener("click",R),$(),()=>{window.removeEventListener("s3phy:lang",E),n.removeEventListener("click",R),w==null||w.destroy()}}const ge="s3phy-thermometer-lab-css",tt=`
.tl-wrap {
  --tl-bg: #0d0d10;
  --tl-panel: #18181b;
  --tl-border: #27272a;
...
`;function at(){if(document.getElementById(ge))return;const n=document.createElement("style");n.id=ge,n.textContent=tt,document.head.appendChild(n)}function nt(n){at();const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
  ...
  `;const t={liquidType:"mercury",thermometerType:"liquid",bulbVolume:200,wallThickness:.5,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0},i=460,c=300,o=460,x=300,w=a.querySelector("#tl-thermometerCanvas"),z=w.getContext("2d"),D=a.querySelector("#tl-graphCanvas"),$=D.getContext("2d"),C=window.devicePixelRatio||1;w.width=i*C,w.height=c*C,w.style.width=i+"px",w.style.height=c+"px",z.scale(C,C),D.width=o*C,D.height=x*C,D.style.width=o+"px",D.style.height=x+"px",$.scale(C,C);function I(){t.iceCubes=[];for(let e=0;e<4;e++)t.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:10+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});t.bubbles=[];for(let e=0;e<15;e++)t.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3,speedY:.6+Math.random()*1.2,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});t.heatWaves=[];for(let e=0;e<6;e++)t.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:12+Math.random()*15,speedY:.4+Math.random()*.5,opacity:.1+Math.random()*.25})}function N(){if(t.thermometerType==="resistance"||t.thermometerType==="thermistor")return .35;const e=t.liquidType==="mercury"?1:8,r=.2+t.wallThickness*1.5,y=.4+t.bulbVolume*.003;return Math.max(.1,r*y*e*.15)}function _(e){t.bathTemp<=8&&t.iceCubes.forEach(r=>{r.x+=r.speedX,r.y+=r.speedY,(r.x<65||r.x>175)&&(r.speedX*=-1),(r.y<195||r.y>210)&&(r.speedY*=-1)}),t.bathTemp>35&&t.heatWaves.forEach(r=>{r.y-=r.speedY*(1+t.bathTemp/100),r.y<185&&(r.y=265,r.x=65+Math.random()*110)}),t.bathTemp>=80&&t.bubbles.forEach(r=>{r.y-=r.speedY*(1+(t.bathTemp-80)/40),r.phase+=r.wobbleSpeed,r.x+=Math.sin(r.phase)*.2,r.y<185&&(r.y=260+Math.random()*10,r.x=60+Math.random()*120)})}function L(e){let u=59,S=130,f=246;if(t.bathTemp<25){const T=t.bathTemp/25;u=Math.round(180-T*121),S=Math.round(210-T*80),f=Math.round(250-T*4)}else{const T=Math.min(1,(t.bathTemp-25)/125);u=Math.round(59+T*180),S=Math.round(130-T*100),f=Math.round(246-T*190)}if(t.bathTemp>40){const T=Math.min(1,(t.bathTemp-40)/100),V=Date.now()*.02;e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-20,284);for(let X=-20;X<=20;X+=8){const ee=T*(10+Math.sin(X*.3+V)*4);e.lineTo(55+130/2+X,284-ee)}e.lineTo(55+130/2+20,284),e.closePath(),e.fill()}e.strokeStyle="#9ca3af",e.lineWidth=2,e.fillStyle="#1f1f23",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const M=e.createLinearGradient(55,190,55,280);M.addColorStop(0,`rgba(${u}, ${S}, ${f}, 0.3)`),M.addColorStop(1,`rgba(${u}, ${S}, ${f}, 0.6)`),e.fillStyle=M,e.beginPath(),e.moveTo(55,190);const k=t.bathTemp>=80?1.5:.4,b=t.bathTemp>=80?.08:.03,H=Date.now()*b;for(let T=55;T<=185;T+=5){const V=190+Math.sin(T*.15+H)*k;e.lineTo(T,V)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),t.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.4,(t.bathTemp-35)/120)})`,e.lineWidth=1,t.heatWaves.forEach(T=>{e.beginPath(),e.moveTo(T.x,T.y),e.quadraticCurveTo(T.x+Math.sin(T.y*.06)*4,T.y-T.length/2,T.x,T.y-T.length),e.stroke()})),t.bathTemp<=8&&(e.fillStyle="rgba(255, 255, 255, 0.6)",e.strokeStyle="rgba(147, 197, 253, 0.8)",e.lineWidth=.8,t.iceCubes.forEach(T=>{e.save(),e.translate(T.x,T.y),e.rotate(T.angle),e.beginPath(),e.roundRect(-T.size/2,-T.size/2,T.size,T.size,2),e.fill(),e.stroke(),e.restore()})),t.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.5)",e.strokeStyle="rgba(255, 255, 255, 0.7)",e.lineWidth=.5,t.bubbles.forEach(T=>{e.beginPath(),e.arc(T.x,T.y,T.r,0,Math.PI*2),e.fill(),e.stroke()})),e.strokeStyle="#4b5563",e.lineWidth=3,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke()}function A(e){const M=e.createLinearGradient(114,20,126,20);M.addColorStop(0,"rgba(209, 213, 219, 0.85)"),M.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),M.addColorStop(.5,"rgba(243, 244, 246, 0.2)"),M.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),M.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=M,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(114,230),e.lineTo(114,25),e.arcTo(114,20,119,20,5),e.arcTo(126,20,126,25,5),e.lineTo(126,230),e.closePath(),e.fill(),e.stroke();const k=e.createRadialGradient(120-11*.2,250-11*.2,11*.1,120,250,11);k.addColorStop(0,"rgba(255, 255, 255, 0.7)"),k.addColorStop(1,"rgba(156, 163, 175, 0.3)"),e.fillStyle=k,e.strokeStyle="#6b7280",e.lineWidth=1.2,e.beginPath(),e.arc(120,250,12,0,Math.PI*2),e.fill(),e.stroke();const b=1.5;e.fillStyle="#111827",e.fillRect(120-b/2,28,b,202);const H=t.liquidType==="mercury",T=H?"#9ca3af":"#ef4444",V=H?"#f3f4f6":"#fecaca",X=210,ee=220,ce=(X-40)/ee,Z=X-Math.min(ee,t.thermometerTemp)*ce;e.fillStyle=T,e.fillRect(120-b/2,Z,b,230-Z),e.fillStyle=V,e.fillRect(120-b/6,Z,b/3,230-Z);const U=11*.9,Y=e.createRadialGradient(120-U*.2,250-U*.2,U*.1,120,250,U);H?(Y.addColorStop(0,"#f3f4f6"),Y.addColorStop(.3,"#d1d5db"),Y.addColorStop(.8,"#9ca3af"),Y.addColorStop(1,"#4b5563")):(Y.addColorStop(0,"#fee2e2"),Y.addColorStop(.2,"#fca5a5"),Y.addColorStop(.7,"#ef4444"),Y.addColorStop(1,"#991b1b")),e.fillStyle=Y,e.beginPath(),e.arc(120,250,U,0,Math.PI*2),e.fill(),e.strokeStyle="#4b5563",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa";for(let te=0;te<=200;te+=50){const de=X-te*ce;e.beginPath(),e.moveTo(114,de),e.lineTo(118,de),e.stroke(),e.fillText(`${te}°C`,92,de+2.5)}}function F(e){const u=e.createLinearGradient(116,20,124,20);u.addColorStop(0,"#9ca3af"),u.addColorStop(.3,"#f3f4f6"),u.addColorStop(.7,"#d1d5db"),u.addColorStop(1,"#6b7280"),e.fillStyle=u,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(116,20,8,225,[0,0,3,3]),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const S=245,f=40,M=135,k=90;e.fillStyle="#1e1b4b",e.strokeStyle="#4f46e5",e.lineWidth=2.5,e.beginPath(),e.roundRect(S,f,M,k,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(S+10,f+12,M-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(t.currentResistance.toFixed(2)+" Ω",S+M-16,f+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",S+14,f+21)}function Q(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,v=225,u=10,S=120-u/2,f=e.createLinearGradient(S,p,S+u,p);f.addColorStop(0,"rgba(229, 231, 235, 0.4)"),f.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),f.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),f.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=f,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(S,p,u,v-p,[0,0,2,2]),e.fill(),e.stroke();const M=6,k=e.createRadialGradient(120-M*.2,245-M*.2,M*.1,120,245,M);k.addColorStop(0,"#4b5563"),k.addColorStop(.7,"#1f2937"),k.addColorStop(1,"#111827"),e.fillStyle=k,e.strokeStyle="#030712",e.lineWidth=1,e.beginPath(),e.arc(120,245,M,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const b=245,H=40,T=135,V=90;e.fillStyle="#111827",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(b,H,T,V,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(b+10,H+12,T-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(t.currentThermistorR.toFixed(2)+" kΩ",b+T-16,H+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",b+14,H+21)}function W(e){e.strokeStyle="#4b5563",e.lineWidth=1.2,e.beginPath(),e.moveTo(50,30),e.lineTo(50,260),e.lineTo(430,260),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.5,e.fillStyle="#a1a1aa",e.font="7px Arial",e.textAlign="right",e.textBaseline="middle";const v=25,u=200;for(let b=0;b<=v;b+=5){const H=260-b/v*230;e.beginPath(),e.moveTo(50,H),e.lineTo(430,H),e.stroke(),e.fillText(`${b.toFixed(1)}`,44,H)}e.textAlign="center",e.textBaseline="top";for(let b=0;b<=u;b+=40){const H=50+b/u*380;e.beginPath(),e.moveTo(H,30),e.lineTo(H,260),e.stroke(),e.fillText(`${b}`,H,264)}e.save(),e.translate(24,30+230/2),e.rotate(-Math.PI/2),e.font="bold 8px Arial",e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font="bold 8px Arial",e.fillText("temperature / °C",50+380/2,274);const S=260-t.liquidL0/v*230,f=260-(t.liquidL0+(t.liquidL100-t.liquidL0)/100*u)/v*230;e.strokeStyle="#ef4444",e.lineWidth=1.8,e.beginPath(),e.moveTo(50,S),e.lineTo(430,f),e.stroke();const M=t.thermometerTemp,k=t.currentLength;if(M>=0&&M<=u){const b=50+M/u*380,H=260-k/v*230;e.fillStyle="#ef4444",e.beginPath(),e.arc(b,H,4,0,Math.PI*2),e.fill()}}function O(e){e.strokeStyle="#4b5563",e.lineWidth=1.2,e.beginPath(),e.moveTo(50,30),e.lineTo(50,260),e.lineTo(430,260),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.5,e.fillStyle="#a1a1aa",e.font="7px Arial",e.textAlign="right",e.textBaseline="middle";const v=10,u=200;for(let b=0;b<=v;b+=2){const H=260-b/v*230;e.beginPath(),e.moveTo(50,H),e.lineTo(430,H),e.stroke(),e.fillText(`${b.toFixed(1)}`,44,H)}e.textAlign="center",e.textBaseline="top";for(let b=0;b<=u;b+=40){const H=50+b/u*380;e.beginPath(),e.moveTo(H,30),e.lineTo(H,260),e.stroke(),e.fillText(`${b}`,H,264)}e.save(),e.translate(24,30+230/2),e.rotate(-Math.PI/2),e.font="bold 8px Arial",e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font="bold 8px Arial",e.fillText("temperature / °C",50+380/2,274);const S=260-t.resistanceR0/v*230,f=260-(t.resistanceR0+(t.resistanceR100-t.resistanceR0)/100*u)/v*230;e.strokeStyle="#4f46e5",e.lineWidth=1.8,e.beginPath(),e.moveTo(50,S),e.lineTo(430,f),e.stroke();const M=t.thermometerTemp,k=t.currentResistance;if(M>=0&&M<=u){const b=50+M/u*380,H=260-k/v*230;e.fillStyle="#4f46e5",e.beginPath(),e.arc(b,H,4,0,Math.PI*2),e.fill()}}function G(e){e.strokeStyle="#4b5563",e.lineWidth=1.2,e.beginPath(),e.moveTo(50,30),e.lineTo(50,260),e.lineTo(430,260),e.stroke(),e.strokeStyle="#27272a",e.lineWidth=.5,e.fillStyle="#a1a1aa",e.font="7px Arial",e.textAlign="right",e.textBaseline="middle";const v=20,u=200;for(let k=0;k<=v;k+=4){const b=260-k/v*230;e.beginPath(),e.moveTo(50,b),e.lineTo(430,b),e.stroke(),e.fillText(`${k.toFixed(1)}`,44,b)}e.textAlign="center",e.textBaseline="top";for(let k=0;k<=u;k+=40){const b=50+k/u*380;e.beginPath(),e.moveTo(b,30),e.lineTo(b,260),e.stroke(),e.fillText(`${k}`,b,264)}e.save(),e.translate(24,30+230/2),e.rotate(-Math.PI/2),e.font="bold 8px Arial",e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font="bold 8px Arial",e.fillText("temperature / °C",50+380/2,274),e.strokeStyle="#10b981",e.lineWidth=1.8,e.beginPath();let S=!1;for(let k=0;k<=u;k+=2){const b=k+273.15,H=t.thermistorR25*Math.exp(t.thermistorBeta*(1/b-1/298.15)),T=50+k/u*380,V=260-Math.min(v,H)/v*230;V>=30&&V<=260&&(S?e.lineTo(T,V):(e.moveTo(T,V),S=!0))}e.stroke();const f=t.thermometerTemp,M=t.currentThermistorR;if(f>=0&&f<=u){const k=50+f/u*380,b=260-Math.min(v,M)/v*230;e.fillStyle="#10b981",e.beginPath(),e.arc(k,b,4,0,Math.PI*2),e.fill()}}function P(){z.clearRect(0,0,i,c),$.clearRect(0,0,o,x),L(z),t.thermometerType==="liquid"?(A(z),W($)):t.thermometerType==="resistance"?(F(z),O($)):(Q(z),G($))}function j(e){a.querySelector("#tl-bath-temp-display").innerHTML=t.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=t.bathTemp.toFixed(1)+" °C";const r=a.querySelector("#tl-bath-state");t.bathTemp<=0?r.textContent="Melting Ice Bath":t.bathTemp>=100?r.textContent="Boiling Water/Steam":t.bathTemp===150?r.textContent="Hot Cooking Oil":r.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const y=a.querySelector("#tl-alcohol-boiling-warning");if(t.thermometerType==="liquid"&&t.liquidType==="alcohol"&&t.bathTemp>=78?y.style.display="block":y.style.display="none",t.thermometerType==="liquid")a.querySelector("#tl-live-liquid-lt").textContent=t.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-sub-num").textContent=`${t.currentLength.toFixed(2)} - ${t.liquidL0.toFixed(1)}`,a.querySelector("#tl-live-liquid-sub-den").textContent=`${t.liquidL100.toFixed(1)} - ${t.liquidL0.toFixed(1)}`,a.querySelector("#tl-live-liquid-ans").textContent=t.thermometerTemp.toFixed(1)+"°C";else if(t.thermometerType==="resistance")a.querySelector("#tl-live-resistance-rt").textContent=t.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-sub-num").textContent=`${t.currentResistance.toFixed(2)} - ${t.resistanceR0.toFixed(1)}`,a.querySelector("#tl-live-resistance-sub-den").textContent=`${t.resistanceR100.toFixed(1)} - ${t.resistanceR0.toFixed(1)}`,a.querySelector("#tl-live-resistance-ans").textContent=t.thermometerTemp.toFixed(1)+"°C";else{a.querySelector("#tl-live-thermistor-rt").textContent=t.currentThermistorR.toFixed(2)+" kΩ";const h=t.thermometerTemp+273.15;a.querySelector("#tl-live-thermistor-calc-tk").textContent=h.toFixed(2),a.querySelector("#tl-live-thermistor-ans").textContent=t.thermometerTemp.toFixed(1)+"°C"}}let B=null;function g(e){t.lastTimestamp||(t.lastTimestamp=e);const r=(e-t.lastTimestamp)/1e3;t.lastTimestamp=e;const y=Math.min(r,.1),h=N(),p=y/h*(t.bathTemp-t.thermometerTemp);t.thermometerTemp+=p,t.currentLength=t.liquidL0+(t.liquidL100-t.liquidL0)/100*t.thermometerTemp,t.currentResistance=t.resistanceR0+(t.resistanceR100-t.resistanceR0)/100*t.thermometerTemp;const v=t.thermometerTemp+273.15;t.currentThermistorR=t.thermistorR25*Math.exp(t.thermistorBeta*(1/v-1/298.15)),_(),P(),j(h),B=requestAnimationFrame(g)}function q(){const r=((parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0)- -1.5)/106.5*100;a.querySelector("#tl-ans-q10a").textContent=r.toFixed(1)+" °C"}function E(){const r=(parseFloat(a.querySelector("#tl-input-q10b-t").value)||0)/100*106.5-1.5;a.querySelector("#tl-ans-q10b").textContent=r.toFixed(2)+" °C"}function R(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,r=(e-t.resistanceR0)/(t.resistanceR100-t.resistanceR0)*100;a.querySelector("#tl-formula-q11-rsub").textContent=e.toFixed(1),a.querySelector("#tl-ans-q11").textContent=r.toFixed(1)+" °C"}function l(){q(),E(),R()}function d(e,r){a.querySelector("#"+e).addEventListener("click",()=>{t.bathTemp=r,a.querySelector("#tl-bath-temp-slider").value=r,l()})}function m(){a.querySelectorAll(".tl-tab-btn").forEach(r=>{r.addEventListener("click",()=>{a.querySelectorAll(".tl-tab-btn").forEach(h=>h.classList.remove("active")),a.querySelectorAll(".tl-tab-content").forEach(h=>h.classList.remove("active")),r.classList.add("active");const y=r.getAttribute("data-tl-tab");a.querySelector("#tl-tab-"+y).classList.add("active"),t.thermometerType=y,l()})}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",r=>{t.bathTemp=parseFloat(r.target.value),l()}),d("tl-btn-preset-ice",0),d("tl-btn-preset-room",25),d("tl-btn-preset-steam",100),d("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{t.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-radio-card active-mercury",a.querySelector("#tl-card-alcohol").className="tl-radio-card",l()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{t.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-radio-card",a.querySelector("#tl-card-alcohol").className="tl-radio-card active-alcohol",l()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",r=>{t.bulbVolume=parseFloat(r.target.value),a.querySelector("#tl-val-bulb-vol").textContent=t.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",r=>{t.wallThickness=parseFloat(r.target.value),a.querySelector("#tl-val-wall-thickness").textContent=t.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",r=>{t.liquidL0=parseFloat(r.target.value),a.querySelector("#tl-val-liquid-l0").textContent=t.liquidL0.toFixed(1)+" cm",l()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",r=>{t.liquidL100=parseFloat(r.target.value),a.querySelector("#tl-val-liquid-l100").textContent=t.liquidL100.toFixed(1)+" cm",l()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",r=>{t.resistanceR0=parseFloat(r.target.value),a.querySelector("#tl-val-resistance-r0").textContent=t.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=t.resistanceR0.toFixed(1)+" Ω",l()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",r=>{t.resistanceR100=parseFloat(r.target.value),a.querySelector("#tl-val-resistance-r100").textContent=t.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=t.resistanceR100.toFixed(1)+" Ω",l()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",r=>{t.thermistorR25=parseFloat(r.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=t.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=t.thermistorR25.toFixed(1)+" kΩ",l()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",r=>{t.thermistorBeta=parseFloat(r.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=t.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=t.thermistorBeta+" K",l()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active")}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active")}),a.querySelector("#tl-input-q10a-cm").addEventListener("input",q),a.querySelector("#tl-input-q10b-t").addEventListener("input",E),a.querySelector("#tl-input-q11-r").addEventListener("input",R)}return I(),m(),l(),B=requestAnimationFrame(g),a._thermometerLabCleanup=()=>{B&&cancelAnimationFrame(B)},a}const ae=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"thermometerLab"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf"}],he=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],it=[["thermometer","topic.thermometer"]];function oe(){return J()==="zh-Hant"?"zhHant":"en"}async function rt(n,a){const t=`./${n}/${a}`;try{return(await fetch(t,{method:"HEAD"})).ok}catch{return!1}}async function be(n){return rt("notes",n)}function ot(n){let a="topics",t=0,i="all",c=!1,o=null,x={main:null},w=null;function z(){if(x.main){if(a==="topics"?x.main.innerHTML=$():a==="notes"?x.main.innerHTML=I():a==="tools"?x.main.innerHTML=_():a==="worksheets"?x.main.innerHTML=_e(s,{topics:it,paperTitleKey:"worksheets.paperTitleHeat"}):a==="flashcards"?x.main.innerHTML=A():a==="summary"&&(x.main.innerHTML=G()),a==="notes"&&N(),a==="tools"&&L(),a==="worksheets"){const g=Te.filter(q=>he.includes(q.topic));Me(n,g,s,oe,{topicFilter:(q,E)=>E.includes("thermometer")?he.includes(q.topic):E.includes(q.topic)})}a==="flashcards"&&O(),a==="summary"&&P()}}function D(){o==null||o.destroy(),o=Ce(n,{subtitleKey:"strand.heat.subtitle",activeSection:a,onSection:g=>{a=g,o.updateSection(a),z()},onLang:()=>D()}),x.main=o.main,o.updateSection(a),z()}function $(){return`
      <section class="panel panel--topic-hub">
        <h2>${s("topics.title")}</h2>
        <p class="lead">${s("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${ae.map(g=>{const q=g.tool?`<button class="btn primary" type="button" data-go-tool="${g.tool}">${s("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${s("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${s(g.titleKey)}</h3>
              ${q}
            </div>`}).join("")}
        </div>
      </section>`}function C(g){if(g.target.closest("[data-go-tool]")){a="tools",o.updateSection(a),z();return}const E=g.target.closest("[data-go-section]");(E==null?void 0:E.getAttribute("data-go-section"))==="notes"&&(a="notes",o.updateSection(a),z())}function I(){return`
      <section class="panel">
        <h2>${s("notes.title")}</h2>
        <p class="lead">${s("notes.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${ae.map(g=>`
            <div class="card" data-note-card="${g.id}">
              <h3>${s(`notes.card.${g.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function N(){const g=oe();for(const q of ae){const E=n.querySelector(`[data-note-card="${q.id}"]`);if(!E)continue;const R=E.querySelector("[data-note-body]"),l=g==="zhHant"?q.fileZh:q.fileEn,d=await be(l),m=`./notes/${l}`;d?R.innerHTML=`
          <iframe class="notes-grid" title="${s(`notes.card.${q.id}`)}" src="${m}"></iframe>
          <p style="margin-top:8px"><a href="${m}" target="_blank" rel="noopener">${s("notes.openPdf")}</a></p>`:R.innerHTML=`<p class="lead">${s("notes.missing")}</p>`}}function _(){return`
      <section class="panel panel--tools">
        <h2>${s("tools.title")}</h2>
      ...
      </section>`}function L(){const g=n.querySelector("[data-tool-stage]");g&&(g.innerHTML="",w!=null&&w._thermometerLabCleanup&&w._thermometerLabCleanup(),w=nt(s),g.appendChild(w))}function A(){return`
      <section class="panel">
        <h2>${s("flashcards.title")}</h2>
        <p class="lead">${s("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}function F(){return ke.filter(g=>he.includes(g.topic))}function Q(){const g=F();return i==="all"||i==="thermometry"?g:g.filter(q=>q.topic===i)}function W(){const g=Q(),q=n.querySelector("[data-flash-progress]");if(!g.length){t=0;const e=n.querySelector("[data-flash-front]");e&&(e.textContent=""),q&&(q.hidden=!0,q.textContent="");return}t=Math.max(0,Math.min(t,g.length-1));const E=g[t],R=n.querySelector("[data-flash-front]"),l=n.querySelector("[data-flash-label]");if(!R)return;q&&(q.hidden=!1,q.textContent=s("flashcards.progress").replace("{current}",String(t+1)).replace("{total}",String(g.length)));const d=oe(),m=E[d]||E.en;l&&(l.hidden=!1,l.textContent=s(c?"flashcards.answer":"flashcards.question")),R.textContent=c?m.a:m.q}function O(){const g=n.querySelector("[data-flash-deck]");g.value=i,g.addEventListener("change",()=>{i=g.value,t=0,c=!1,W()}),n.querySelector("[data-flip-card]").addEventListener("click",()=>{c=!c,W()}),n.querySelector("[data-flash-flip]").addEventListener("click",q=>{q.stopPropagation(),c=!c,W()}),n.querySelector("[data-flash-prev]").addEventListener("click",()=>{const q=Q();t=(t-1+q.length)%q.length,c=!1,W()}),n.querySelector("[data-flash-next]").addEventListener("click",()=>{const q=Q();t=(t+1)%q.length,c=!1,W()}),n.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const q=Q();t=Math.floor(Math.random()*q.length),c=!1,W()}),W()}function G(){return`
      <section class="panel">
        <h2>${s("summary.title")}</h2>
        <p class="lead">${s("summary.intro")}</p>
        <p class="lead">${s("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${ae.map(g=>`
            <div class="card" data-summary-card="${g.id}">
              <h3>${s(`summary.item.${g.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function P(){const g=oe();for(const q of ae){const E=n.querySelector(`[data-summary-card="${q.id}"]`);if(!E)continue;const R=E.querySelector("[data-summary-body]"),l=g==="zhHant"?q.fileZh:q.fileEn,d=await be(l),m=`./notes/${l}`;d?R.innerHTML=`
          <iframe class="notes-grid" title="${s(`summary.item.${q.id}`)}" src="${m}"></iframe>
          <p style="margin-top:8px"><a href="${m}" target="_blank" rel="noopener">${s("summary.download")}</a></p>`:R.innerHTML=`<p class="lead">${s("summary.missing")}</p>`}}const j=()=>D(),B=g=>C(g);return window.addEventListener("s3phy:lang",j),n.addEventListener("click",B),D(),()=>{window.removeEventListener("s3phy:lang",j),n.removeEventListener("click",B),w!=null&&w._thermometerLabCleanup&&w._thermometerLabCleanup(),o==null||o.destroy()}}const ve={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};ze();const ye="s3phy_splash_seen",He={optics:et,heat:ot};let ne=null,ie=null;function st(){const n=location.hash.match(/^#\/(\w+)/),a=n==null?void 0:n[1];return a&&Object.prototype.hasOwnProperty.call(He,a)?a:null}function lt(){const n=`${location.pathname}${location.search}`;history.replaceState(null,"",n)}function Ae(n){ne==null||ne(),ne=null,ie==null||ie(),ie=null;const a=document.getElementById("app");if(!a)return;if(a.innerHTML="",!n){location.hash&&lt(),ie=Fe(a);return}const t=`#/${n}`;if(location.hash!==t){location.hash=t;return}ne=He[n](a)??null}function Le(){Ae(st())}function ct(){return"./images/uniplus-logo.png"}function dt(){const n=document.createElement("div");return n.id="splash",n.className="splash",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Uni+"),n.innerHTML=`
  ...
  `,n}function ut(n,a){const t=[...ve.en,...ve.zhHant],i=()=>{if(!n.parentElement)return;const c=document.createElement("div");c.className="splash-danmaku-item",c.textContent=t[Math.floor(Math.random()*t.length)];const o=Math.random()*85+5,x=Math.random()*.8+.9,w=Math.random()*12+10;c.style.top=`${o}%`,c.style.fontSize=`${x}rem`,c.style.animationDuration=`${w}s`,a.appendChild(c),c.addEventListener("animationend",()=>c.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let c=0;c<4;c+=1)window.setTimeout(i,c*1e3)}function ht(n){const a=n.querySelector("#splashLogoWrap"),t=n.querySelector("#splashDanmaku"),i=n.querySelector("#splashStartWrap");window.setTimeout(()=>a==null?void 0:a.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{t==null||t.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),t&&ut(n,t)},1600)}function we(){Le()}function pt(){let n=!1;try{n=sessionStorage.getItem(ye)==="1"}catch{}if(n){we();return}const a=dt();document.body.insertBefore(a,document.body.firstChild),ht(a);const t=a.querySelector("#splashStart"),i=()=>{a.remove(),we()};t.addEventListener("click",()=>{try{sessionStorage.setItem(ye,"1")}catch{}a.classList.add("splash--hide"),a.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",Le);window.addEventListener("s3phy:strand",n=>{Ae(n.detail??null)});pt();
