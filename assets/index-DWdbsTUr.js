      ...
      <header class="site-header site-header--strand-picker">
        <div class="site-header__brand">
          ...
          <div class="brand-text-block">
            <h1 class="site-title">${c("app.title")}</h1>
            <p class="site-subtitle">${c("app.subtitle")}</p>
          </div>
        </div>
...
`;function Wt(){if(document.getElementById(Ye))return;const t=document.createElement("style");t.id=Ye,t.textContent=Pt,document.head.appendChild(t)}function Dt(t){Wt();const n=document.createElement("div");n.className="rml",n.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=n.querySelector(".rml-canvas"),i=o.getContext("2d"),s=n.querySelector("[data-rml-rot]"),a=n.querySelector("[data-rml-inc]"),r=n.querySelector('[data-rml-disp="rot"]'),d=n.querySelector('[data-rml-disp="inc"]'),O=n.querySelector('[data-rml-val="i"]'),I=n.querySelector('[data-rml-val="r"]'),z=n.querySelector('[data-rml-val="shift"]'),H=350,R=380,B=300,v="#22d3ee",S="bold 17px system-ui, sans-serif";let E=0,g=-140,A=!0,$=!0,V=!0,u=!0;function f(W){return W*Math.PI/180}function h(W,P,U,ee,ne,te=2,ae=!1){i.beginPath(),i.lineWidth=te,i.strokeStyle=ne,i.setLineDash(ae?[6,6]:[]);const k=W+Math.cos(f(U))*ee,M=P+Math.sin(f(U))*ee;return i.moveTo(W,P),i.lineTo(k,M),i.stroke(),i.setLineDash([]),{x:k,y:M}}function x(W,P,U,ee,ne,te=14){const ae=U-W,k=ee-P,M=Math.hypot(ae,k);if(M<1e-6)return;const J=ae/M,D=k/M,Z=U-J*te,N=ee-D*te,de=.45*te;i.beginPath(),i.fillStyle=ne,i.moveTo(U,ee),i.lineTo(Z-D*de,N+J*de),i.lineTo(Z+D*de,N-J*de),i.closePath(),i.fill()}function G(W,P,U,ee,ne,te=25){i.beginPath(),i.strokeStyle=ee,i.lineWidth=2;const ae=Math.min(W,P),k=Math.max(W,P);if(i.arc(H,R,U,f(ae),f(k),!1),i.stroke(),ne){const M=(ae+k)/2,J=H+Math.cos(f(M))*(U+te),D=R+Math.sin(f(M))*(U+te);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=ee,i.fillText(ne,J,D),i.restore()}}function j(W,P,U,ee,ne){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo(H-200,R),i.lineTo(H+200,R),i.stroke(),i.setLineDash([]),i.lineCap="butt";const te=H+Math.cos(f(W))*B,ae=R+Math.sin(f(W))*B;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(te,ae),i.lineTo(H,R),i.stroke();const k=(te+H)*.5,M=(ae+R)*.5,J=Math.hypot(H-te,R-ae)||1,D=(H-te)/J,Z=(R-ae)/J;if(x(k-D*28,M-Z*28,k,M,"#fff",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),te,ae-12),i.restore(),A){const N=h(H,R,-90,B-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),N.x+6,N.y-4),i.restore()}if($){const N=h(H,R,ee,B,"#00e676",2,!1);x(H,R,N.x,N.y,"#00e676",16),i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),N.x,N.y-14),i.restore()}i.save(),i.translate(H,R),i.rotate(f(E)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let N=-190;N<200;N+=15)i.moveTo(N,0),i.lineTo(N-5,8);if(i.stroke(),i.restore(),V){const N=h(H,R,P,B-40,v,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=v,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),N.x+6,N.y-4),i.restore()}if(u){const N=h(H,R,U,B,v,4);x(H,R,N.x,N.y,v,16),Math.abs(E)>.5&&(i.save(),i.font=S,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=v,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),N.x,N.y-14),i.restore())}if(V&&G(W,P,100,"#ffcc00",`i=${ne.toFixed(0)}°`,25),V&&u&&G(P,U,100,v,`r=${ne.toFixed(0)}°`,25),A&&V&&Math.abs(E)>.5&&G(-90,P,50,"#ffcc00",`θ=${Math.abs(E)}°`,20),$&&u&&Math.abs(E)>.5){const N=U-ee;G(ee,U,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${N.toFixed(0)}°`,40)}}function F(){E=parseFloat(s.value),g=parseFloat(a.value);const W=E>0?"+":"";r.textContent=`${W}${E}°`,d.textContent=`${g}°`;const P=-90,U=Math.abs(g-P),ee=P+U,ne=-90+E,te=Math.abs(g-ne),ae=ne+te,k=ae-ee;O.textContent=`${te.toFixed(1)}°`,I.textContent=`${te.toFixed(1)}°`;const M=k>0?"+":"";z.textContent=`${M}${k.toFixed(1)}°`,j(g,ne,ae,ee,te)}return n.querySelectorAll("[data-rml-toggle]").forEach(W=>{W.addEventListener("click",()=>{const P=W.getAttribute("data-rml-toggle");P==="orig-norm"&&(A=!A),P==="orig-ray"&&($=!$),P==="new-norm"&&(V=!V),P==="new-ray"&&(u=!u),W.classList.toggle("active"),F()})}),n.querySelector("[data-rml-reset]").addEventListener("click",()=>{s.value="0",F()}),s.addEventListener("input",F),a.addEventListener("input",F),F(),n}function Ot(t){const n=document.createElement("div");n.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;return o.src=`${s}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",n.appendChild(o),n}function Gt(t,n={}){const o=n.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",s=document.createElement("div");s.className="tool-lens-simulator";const a=document.createElement("iframe"),r="./",d=r.endsWith("/")?r:`${r}/`;return a.src=`${d}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,a.title=t(i),a.setAttribute("loading","lazy"),a.referrerPolicy="strict-origin-when-cross-origin",s.appendChild(a),s}function jt(t){const n=document.createElement("div");n.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:`${i}/`;function a(){return`${s}em-spectrum/index.html?lang=${encodeURIComponent(oe())}`}o.src=a(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var d;try{(d=o.contentWindow)==null||d.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._emLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function Bt(t){const n=document.createElement("div");n.className="rgb-mixer",n.innerHTML=`
  ...
  `;const o=n.querySelector("[data-r]"),i=n.querySelector("[data-g]"),s=n.querySelector("[data-b]"),a=n.querySelector(".rgb-mixer-canvas"),r=n.querySelector(".rgb-mixer-stage"),d=a.getContext("2d");function O(v){return v.toString(16).padStart(2,"0")}function I(v,S,E){const g=a.width/(window.devicePixelRatio||1),A=a.height/(window.devicePixelRatio||1),$=g/2,V=A/2,u=Math.min(g,A)*.34,f=u*.5,h=Math.sqrt(3)/2;d.clearRect(0,0,g,A),d.fillStyle="#000",d.fillRect(0,0,g,A);const x=[{x:$,y:V-f,rgb:[255,0,0],val:v},{x:$-f*h,y:V+f*.5,rgb:[0,255,0],val:S},{x:$+f*h,y:V+f*.5,rgb:[0,0,255],val:E}];d.globalCompositeOperation="lighter",x.forEach(G=>{if(G.val<=0)return;const j=G.val/255,[F,W,P]=G.rgb,U=d.createRadialGradient(G.x,G.y,0,G.x,G.y,u);U.addColorStop(0,`rgba(${F},${W},${P},${j})`),U.addColorStop(.65,`rgba(${F},${W},${P},${j})`),U.addColorStop(.85,`rgba(${F},${W},${P},${j*.5})`),U.addColorStop(1,`rgba(${F},${W},${P},0)`),d.fillStyle=U,d.beginPath(),d.arc(G.x,G.y,u,0,Math.PI*2),d.fill()}),d.globalCompositeOperation="source-over"}function z(){const v=r.getBoundingClientRect(),S=Math.max(200,Math.min(v.width-8,v.height-8,720)),E=window.devicePixelRatio||1;a.width=S*E,a.height=S*E,a.style.width=`${S}px`,a.style.height=`${S}px`,d.setTransform(E,0,0,E,0,0),I(+o.value,+i.value,+s.value)}function H(){const v=+o.value,S=+i.value,E=+s.value,g=`rgb(${v}, ${S}, ${E})`,A=`#${O(v)}${O(S)}${O(E)}`;n.querySelector("[data-r-val]").textContent=v,n.querySelector("[data-g-val]").textContent=S,n.querySelector("[data-b-val]").textContent=E,n.querySelector("[data-r-bar]").style.width=`${v/255*100}%`,n.querySelector("[data-g-bar]").style.width=`${S/255*100}%`,n.querySelector("[data-b-bar]").style.width=`${E/255*100}%`,o.style.setProperty("--fill",`${v/255*100}%`),i.style.setProperty("--fill",`${S/255*100}%`),s.style.setProperty("--fill",`${E/255*100}%`);const $=n.querySelector("[data-swatch]");$.style.backgroundColor=g,$.setAttribute("aria-label",`${t("tools.rgbMixer.preview")}: ${g}`),n.querySelector("[data-rgb-text]").textContent=g,n.querySelector("[data-hex-text]").textContent=A,I(v,S,E)}function R(v,S,E){o.value=v,i.value=S,s.value=E,H()}return[o,i,s].forEach(v=>v.addEventListener("input",H)),n.querySelectorAll(".rgb-presets button").forEach(v=>{v.addEventListener("click",()=>{R(+v.dataset.r,+v.dataset.g,+v.dataset.b)})}),new ResizeObserver(()=>z()).observe(r),requestAnimationFrame(()=>{z(),H()}),n}const Nt=["topics","notes","tools","worksheets","flashcards","summary"],Qt={topics:"nav.topics",notes:"nav.notes",tools:"nav.tools",worksheets:"nav.worksheets",flashcards:"nav.flashcards",summary:"nav.summary"};function wt(t,{subtitleKey:n,activeSection:o,onSection:i,onLang:s}){t.innerHTML=`
    <header class="site-header">
      <div class="site-header__brand">
        ...
        <div class="brand-text-block">
          <h1 class="site-title">${c("app.title")}</h1>
          <p class="site-subtitle" data-hub-subtitle>${c(n)}</p>
        </div>
      </div>
      <div class="site-header__actions">
        <button type="button" class="strand-back-btn" data-strand-back>${c("strand.back")}</button>
        <div class="lang-toggle" data-lang></div>
      </div>
    </header>
    <nav class="main-nav" data-nav></nav>
    <main data-main></main>
    <footer class="site-footer no-print" data-hub-footer>${c("footer.conventions")}</footer>
  `;const a=t.querySelector("[data-main]"),r=t.querySelector("[data-nav]"),d=t.querySelector("[data-lang]"),O=t.querySelector("[data-strand-back]");let I=o;function z(v){I=v,r.innerHTML=Nt.map(S=>`<button type="button" class="${v===S?"active":""}" data-sec="${S}">${c(Qt[S])}</button>`).join(""),r.querySelectorAll("button").forEach(S=>{S.addEventListener("click",()=>i(S.getAttribute("data-sec")))})}function H(){d.innerHTML=`
      <button type="button" data-set-lang="en" class="${oe()==="en"?"active":""}">${c("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${oe()==="zh-Hant"?"active":""}">${c("lang.zhHant")}</button>
    `,d.querySelectorAll("button").forEach(v=>{v.addEventListener("click",()=>{vt(v.getAttribute("data-set-lang")),s()})})}function R(){t.querySelector("[data-hub-subtitle]").textContent=c(n),O.textContent=c("strand.back"),t.querySelector("[data-hub-footer]").textContent=c("footer.conventions"),t.querySelector(".site-title").textContent=c("app.title")}const B=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return O.addEventListener("click",B),z(o),H(),{main:a,updateSection(v){z(v)},refreshLabels(){R(),z(I),H()},destroy(){O.removeEventListener("click",B)}}}const We=["A","B","C","D"];function Xe(t){const n=t.slice();for(let o=n.length-1;o>0;o-=1){const i=Math.floor(Math.random()*(o+1));[n[o],n[i]]=[n[i],n[o]]}return n}function Vt(t,n,o){return t.filter(i=>{if(o)return o(i,n);const s=i.topic;return!!(n.includes(s)||n.includes("rotatingMirror")&&s==="reflection"||n.includes("refraction")&&s==="refraction"||n.includes("tir")&&s==="tir"||s==="convex"&&n.includes("convex")||s==="concave"&&n.includes("concave"))})}function Kt(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function xt(t,n={}){const o=n.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=n.paperTitleKey??"worksheets.paperTitle";return`
    ...
    </section>`}function kt(t,n,o,i,s={}){var ee,ne,te,ae;const a={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},r=t.querySelector("[data-ws-gen]"),d=t.querySelector("[data-ws-preview-area]"),O=t.querySelector("[data-ws-out]"),I=t.querySelector("[data-ws-body]"),z=t.querySelector("[data-ws-paper]"),H=t.querySelector("[data-ws-tabs]"),R=t.querySelector("[data-ws-practice-actions]"),B=t.querySelector("[data-ws-score]"),v=t.querySelector("[data-ws-score-val]"),S=t.querySelector("[data-ws-summary]"),E=t.querySelector("[data-ws-date-row]"),g=t.querySelector("[data-ws-date-print]"),A=t.querySelector("[data-ws-date-today]"),$=t.querySelector("[data-ws-date-label]");if(!r||!I)return;function V(){return i()}function u(){a.userAnswers={},a.wrongAttempts={},a.resolved={},B.hidden=!0,S.hidden=!0}function f(){return a.items.length>0&&a.items.every((k,M)=>a.resolved[M])}function h(){let k=0;a.items.forEach((J,D)=>{if(!a.resolved[D])return;const Z=J[V()]||J.en;a.userAnswers[D]===Z.a&&(k+=1)}),Object.keys(a.resolved).length>0&&(v.textContent=`${k}/${a.items.length}`,B.hidden=!1)}function x(k){a.tab=k,H==null||H.querySelectorAll("[data-ws-tab]").forEach(M=>{M.classList.toggle("active",M.getAttribute("data-ws-tab")===k)}),R&&(R.hidden=k!=="practice"),E&&(E.hidden=k!=="practice"),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:""),z==null||z.classList.toggle("practice-mode",k==="practice"),j()}function G(k,M,J){const D=k[V()]||k.en,Z=We,N=M+1,de=k.section?`<span class="q-section">${xe(k.section)}</span>`:"";if(J==="answer"){const me=D.choices.map((ye,Te)=>`<li class="${Te===D.a?"choice-correct":""}"><strong>${Z[Te]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${N} ${de}</h4>
        <p>${xe(D.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Z[D.a]}</p>
        <p class="q-exp"><em>${xe(D.exp)}</em></p>
      </div>`}const le=a.userAnswers[M],ue=a.wrongAttempts[M]||0,ge=a.resolved[M],qe=ge&&le===D.a,ke=ge&&le!==D.a;let Se="";ue===1&&!ge?Se=`<p class="q-hint"><strong>${o("worksheets.hint")}:</strong> ${xe(D.hint||D.exp)}</p>`:ke&&(Se=`<p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Z[D.a]}</p>
        <p class="q-exp q-summary"><em>${xe(D.exp)}</em></p>`);const _e=qe?"correct":ke?"incorrect":"",He=D.choices.map((me,ye)=>`<li>
          <label class="choice-radio">
            <input type="radio" name="ws-q-${M}" value="${ye}" data-ws-q="${M}" data-ws-choice="${ye}"${le===ye?" checked":""}${ge?" disabled":""} />
            <span class="choice-circle choice-circle--print"></span>
            <strong>${Z[ye]}.</strong> ${xe(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${_e}" data-ws-row="${M}">
      <div class="q-header"><h4>Q${N} ${de}</h4>${qe?'<span class="result-icon">✓</span>':ke?'<span class="result-icon">✗</span>':""}</div>
      <p>${xe(D.q)}</p>
      <ol class="choice-list choice-list--radio">${He}</ol>
      ${Se}
    </div>`}function j(){a.items.length&&(I.innerHTML=a.items.map((k,M)=>G(k,M,a.tab)).join(""),F())}function F(){a.tab==="practice"&&I.querySelectorAll("[data-ws-choice]").forEach(k=>{k.addEventListener("change",()=>{const M=Number(k.getAttribute("data-ws-q"));if(a.resolved[M])return;const J=Number(k.getAttribute("data-ws-choice")),D=a.items[M][V()]||a.items[M].en;a.userAnswers[M]=J,J===D.a?a.resolved[M]=!0:(a.wrongAttempts[M]=(a.wrongAttempts[M]||0)+1,a.wrongAttempts[M]>=2&&(a.resolved[M]=!0)),h(),f()&&W(),j()})})}function W(){const k=a.items.length;let M=0,J=0;const D={};a.items.forEach((le,ue)=>{const ge=le[V()]||le.en;if(a.userAnswers[ue]===ge.a)M+=1,(a.wrongAttempts[ue]||0)===0&&(J+=1);else if(a.resolved[ue]){const ke=le.section||le.topic;D[ke]=(D[ke]||0)+1}});const Z=k?Math.round(M/k*100):0;let N=o("worksheets.revisionFair");Z>=90?N=o("worksheets.revisionExcellent"):Z>=70?N=o("worksheets.revisionGood"):Z<50&&(N=o("worksheets.revisionLow"));const de=Object.entries(D).sort((le,ue)=>ue[1]-le[1]).map(([le,ue])=>`<li>${xe(le)} (${ue})</li>`).join("");S.innerHTML=`
      <h4>${o("worksheets.sessionSummary")}</h4>
      <p>${o("worksheets.score")}: <strong>${M}/${k}</strong> (${Z}%)</p>
      <p>${o("worksheets.firstTry")}: <strong>${J}/${k}</strong></p>
      <p>${o("worksheets.revisionSuggestions")}: ${N}</p>
      ${de?`<p>${o("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,S.hidden=!1}function P(k){const M=V(),J=a.items.map((D,Z)=>{const N=D[M]||D.en,de=N.choices.map((ue,ge)=>`${We[ge]}. ${ue}`).join("<br/>"),le=k?`<p><b>${o("worksheets.answer")}:</b> ${We[N.a]}<br/><i>${N.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Z+1}.</b> ${N.q}<br/>${de}${le}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
<head><meta charset="utf-8"><title>${o("worksheets.paperTitle")}</title></head>
<body><h2>${o("worksheets.paperTitle")}</h2>
${a.dateStr&&!k?`<p>${o("worksheets.date")}: ${a.dateStr}</p>`:""}
${J}</body></html>`}function U(k){const M=P(k),J=new Blob(["\uFEFF",M],{type:"application/msword"}),D=document.createElement("a");D.href=URL.createObjectURL(J),D.download=k?"worksheet-answers.doc":"worksheet.doc",D.click(),URL.revokeObjectURL(D.href)}r.addEventListener("click",()=>{const k=Number(t.querySelector("[data-ws-count]").value),M=[...t.querySelectorAll("[data-ws-topic]")].filter(Z=>Z.checked).map(Z=>Z.getAttribute("data-ws-topic")),J=Vt(n,M,s.topicFilter),D=Xe(J).slice(0,Math.min(k,J.length||1));a.items=D.length?D:Xe(n).slice(0,Math.min(k,n.length)),u(),a.tab="practice",a.dateStr="",d.hidden=!1,O.hidden=!0,H==null||H.querySelectorAll("[data-ws-tab]").forEach(Z=>{Z.classList.toggle("active",Z.getAttribute("data-ws-tab")==="practice")}),R&&(R.hidden=!1),E&&(E.hidden=!1),g&&(g.hidden=!0),$.textContent="",z==null||z.classList.add("practice-mode"),j()}),H==null||H.addEventListener("click",k=>{const M=k.target.closest("[data-ws-tab]");!M||!a.items.length||x(M.getAttribute("data-ws-tab"))}),A==null||A.addEventListener("click",()=>{a.dateStr?(a.dateStr="",$.textContent=""):(a.dateStr=Kt(),$.textContent=`${o("worksheets.date")}: ${a.dateStr}`),g&&(g.hidden=!a.dateStr,g.textContent=a.dateStr?`${o("worksheets.date")}: ${a.dateStr}`:"")}),(ee=t.querySelector("[data-ws-word-p]"))==null||ee.addEventListener("click",()=>U(!1)),(ne=t.querySelector("[data-ws-word-a]"))==null||ne.addEventListener("click",()=>U(!0)),(te=t.querySelector("[data-ws-print-p]"))==null||te.addEventListener("click",()=>{x("practice"),z==null||z.classList.add("ws-print-blank");const k=()=>z==null?void 0:z.classList.remove("ws-print-blank");window.addEventListener("afterprint",k,{once:!0}),window.print()}),(ae=t.querySelector("[data-ws-print-a]"))==null||ae.addEventListener("click",()=>{x("answer"),window.print()})}const Ut=1.7,Yt=.7,De=1,Xt=.1,Zt=3;function Jt(t){const n=Math.floor(t),o=t-n;return n+(Math.random()<o?1:0)}function Ze(t){for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function ea(t){const n=new Map(t.map(a=>[a.id,a.copies])),o=[];let i=null;const s=t.reduce((a,r)=>a+r.copies,0);for(let a=0;a<s;a+=1){let r=[...n.entries()].filter(([I,z])=>z>0&&I!==i);r.length===0&&(r=[...n.entries()].filter(([,I])=>I>0)),r.sort((I,z)=>z[1]-I[1]);const[d,O]=r[0];o.push(d),n.set(d,O-1),i=d}return o}function ta(t){const n=[];return t.forEach(({id:o,copies:i})=>{for(let s=0;s<i;s+=1)n.push(o)}),n}function aa(t){let n="sequence",o=1,i=[],s=[],a=0,r=!1,d=!1,O=!1;const I=new Map;function z(){return t()}function H(){return new Map(z().map(u=>[u.id,u]))}function R(){I.clear(),z().forEach(u=>{I.set(u.id,{nextRate:De,totalGotIt:0,roundAgain:0,roundGotIt:0,roundNeutral:0})})}function B(){const u=z();return o===1?u.map(f=>({id:f.id,copies:1})):u.map(f=>{var h;return{id:f.id,copies:Jt(((h=I.get(f.id))==null?void 0:h.nextRate)??De)}}).filter(f=>f.copies>0)}function v(u){if(u.length===0)return[];if(o===1){const f=u.map(h=>h.id);return n==="random"?Ze([...f]):[...f].sort((h,x)=>h-x)}return n==="random"?Ze(ta(u)):ea(u)}function S(){if(d=!1,O=!1,i=B(),i.reduce((f,h)=>f+h.copies,0)===0){O=!0,d=!0,s=[],a=0;return}z().forEach(f=>{const h=I.get(f.id);h&&(h.roundAgain=0,h.roundGotIt=0,h.roundNeutral=0)}),s=v(i),a=0,r=!1}function E(){o=1,R(),S()}function g(){return s[a]??null}function A(){const u=g();return u==null?null:H().get(u)??null}function $(u){const f=g();if(f==null)return;const h=I.get(f);h&&(u==="again"?(h.nextRate=Ut,h.totalGotIt=0,h.roundAgain+=1):u==="gotit"?(h.totalGotIt+=1,h.roundGotIt+=1,h.nextRate=h.totalGotIt>=Zt?Xt:Yt):u==="neutral"&&(h.roundNeutral+=1,h.nextRate=De))}function V(){return r=!1,a<s.length-1?(a+=1,!1):(d=!0,!0)}return E(),{getMode:()=>n,setMode(u){n!==u&&(n=u,s=v(i),a=0,r=!1)},resetSession:E,getRoundNumber:()=>o,getProgress:()=>({index:s.length?a+1:0,total:s.length}),isFlipped:()=>r,flip(){r=!r},unflip(){r=!1},currentCard:A,prev(){return a>0?(a-=1,r=!1,!0):!1},nextNavigate(){return a<s.length-1?(a+=1,r=!1,!0):!1},rateAgain(){return r?($("again"),V()):!1},rateGotIt(){return r?($("gotit"),V()):!1},rateNeutral(){return r?($("neutral"),V()):!1},isSummary:()=>d,isSessionComplete:()=>O,getRoundStats(){let u=0,f=0,h=0;return I.forEach(x=>{u+=x.roundAgain,f+=x.roundGotIt,h+=x.roundNeutral}),{again:u,gotIt:f,neutral:h}},nextRound(){o+=1,S()},restart(){E()}}}function St(t,{deckOptions:n,buildDeck:o,initialDeck:i="all"}){let s=i,a=null,r=null;t.innerHTML=`
    <section class="panel panel--flashcards">
      <h2>${c("flashcards.title")}</h2>
      <p class="lead">${c("flashcards.intro")}</p>
      <div class="flash-study-controls no-print">
        <div class="control">
          <label>${c("flashcards.deck")}</label>
          <select data-fc-deck>
            ${n.map(g=>`<option value="${g.value}">${g.label}</option>`).join("")}
          </select>
        </div>
        <div class="flash-mode-toggle" data-fc-mode>
          <button type="button" data-mode="sequence" class="active">${c("flashcards.mode.sequence")}</button>
          <button type="button" data-mode="random">${c("flashcards.mode.random")}</button>
        </div>
      </div>
      ...
      <div data-fc-study-panel>
        <div class="flashcard-box">
          <div class="flashcard-surface" data-fc-card>
            <div class="label" data-fc-label>${c("flashcards.question")}</div>
          ...
          <div class="flash-toolbar flash-rating-row no-print">
            <button class="btn" type="button" data-fc-prev>${c("flashcards.prev")}</button>
            <button class="btn danger" type="button" data-fc-again>${c("flashcards.again")}</button>
            <button class="btn primary" type="button" data-fc-flip>${c("flashcards.flip")}</button>
            <button class="btn success" type="button" data-fc-gotit>${c("flashcards.gotIt")}</button>
            <button class="btn" type="button" data-fc-next>${c("flashcards.next")}</button>
          </div>
        </div>
      </div>
...
`;function va(){if(document.getElementById(ct))return;const t=document.createElement("style");t.id=ct,t.textContent=ga,document.head.appendChild(t)}function ya(t){const o={x:12,y:12},i=200,{container:s,panel:a,toggleBtn:r,dragHandle:d,storageKey:O,onLayoutChange:I,breakpoint:z=1024,collapsedClass:H="controls-collapsed",floatingClass:R="controls-floating"}=t;if(!s||!a||!r)return null;let B=sessionStorage.getItem(O)!=="false",v=(()=>{try{const j=localStorage.getItem(O+":pos");if(!j)return{...o};const F=JSON.parse(j);if(typeof F.x=="number"&&typeof F.y=="number")return F}catch{}return{...o}})(),S=null,E=null;const g=()=>window.innerWidth>=z,A=(j,F)=>{const W=s.getBoundingClientRect(),P=a.getBoundingClientRect(),U=Math.max(0,W.width-P.width),ee=Math.max(0,W.height-P.height);return{x:Math.min(Math.max(0,j),U),y:Math.min(Math.max(0,F),ee)}},$=()=>{a.style.left=v.x+"px",a.style.top=v.y+"px",a.style.right="auto",a.style.bottom="auto"},V=()=>{typeof I=="function"&&(clearTimeout(E),E=setTimeout(I,i))},u=()=>{r.setAttribute("aria-expanded",B?"false":"true"),t.getToggleTitle&&(r.title=t.getToggleTitle(B));const j=r.querySelector("[data-float-chevron]");j&&(j.textContent=B?"v":"^")},f=j=>{B=j,a.classList.toggle(H,B),sessionStorage.setItem(O,B?"true":"false"),u(),V()},h=()=>{s.classList.add(R),a.classList.add("lab-controls-float"),v=A(v.x,v.y),$(),d&&(d.style.display="")},x=()=>{s.classList.remove(R),a.classList.remove("lab-controls-float"),a.style.left="",a.style.top="",a.style.right="",a.style.bottom="",d&&(d.style.display="none")},G=()=>{g()?(h(),v=A(v.x,v.y),$()):x(),V()};if(a.classList.toggle(H,B),u(),G(),r.addEventListener("click",j=>{j.stopPropagation(),f(!B)}),d){d.addEventListener("pointerdown",F=>{g()&&(F.preventDefault(),S={pointerId:F.pointerId,startX:F.clientX,startY:F.clientY,originX:v.x,originY:v.y},d.setPointerCapture(F.pointerId),d.classList.add("is-dragging"))}),d.addEventListener("pointermove",F=>{!S||S.pointerId!==F.pointerId||(v=A(S.originX+F.clientX-S.startX,S.originY+F.clientY-S.startY),$())});const j=F=>{if(!(!S||S.pointerId!==F.pointerId)){d.releasePointerCapture(F.pointerId),d.classList.remove("is-dragging");try{localStorage.setItem(O+":pos",JSON.stringify(v))}catch{}S=null,V()}};d.addEventListener("pointerup",j),d.addEventListener("pointercancel",j)}return window.addEventListener("resize",G),{setCollapsed:f,refreshMode:G,isCollapsed:()=>B}}function Ge(t,n={}){va();const o=n.type||"liquid";let i=t("tools.thermometerLab.title"),s=t("tools.thermometerLab.subtitle");n.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),s=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),s=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):n.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),s=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const a=document.createElement("div");a.className="tl-wrap",a.innerHTML=`
    <div class="tl-head">
  ...
  `;const r={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},d=460,O=340,I=80,z=800,H=560;function R(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:z-e.left-e.right,gh:H-e.top-e.bottom,tickFont:`bold ${Math.round(z*.024)}px Arial`,axisFont:`bold ${Math.round(z*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:H-e.bottom+32}}function B(){let l=100;const m=Math.max(r.bathTemp,r.thermometerTemp,100);m>120&&(l=150),m>145&&(l=200);const b=l<=100?20:25;return{minT:0,maxT:l,tickStep:b}}function v(e,l,m,b,p){return b+(e-l)/(m-l)*p}function S(e,l,m,b,p){return b+p-(e-l)/(m-l)*p}function E(e,l,m,b,p,_){const{gx:y,gy:w,gw:T,gh:C,tickFont:L,axisFont:Q,yLabelX:X,xLabelY:q}=l;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const K of _){const Y=S(K.value,K.min,K.max,w,C);e.beginPath(),e.moveTo(y,Y),e.lineTo(y+T,Y),e.stroke()}for(let K=m;K<=b+.01;K+=p){const Y=v(K,m,b,y,T);e.beginPath(),e.moveTo(Y,w),e.lineTo(Y,w+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(y,w),e.lineTo(y,w+C),e.lineTo(y+T,w+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=L,e.textAlign="right",e.textBaseline="middle";for(const K of _){const Y=S(K.value,K.min,K.max,w,C);e.fillText(K.label,y-15,Y)}e.textAlign="center",e.textBaseline="top";for(let K=m;K<=b+.01;K+=p){const Y=v(K,m,b,y,T);e.fillText(`${Math.round(K)}`,Y,w+C+10)}return{gx:y,gy:w,gw:T,gh:C,axisFont:Q,yLabelX:X,xLabelY:q}}function g(e,l){const m=l-e,b=m<=8?1:m<=14?2:5,p=[],_=Math.ceil(e/b)*b;for(let y=_;y<=l+.001;y+=b)p.push({value:y,label:y%1===0?`${y.toFixed(0)}`:`${y.toFixed(1)}`,min:e,max:l});return p}function A(){const{maxT:e}=B(),l=$(0),m=$(e),b=m-l,p=Math.max(1,b*.1),_=Math.max(0,Math.round((l-p)*10)/10),y=Math.round((m+p)*10)/10;return{minL:_,maxL:y}}function $(e){return r.liquidL0+(r.liquidL100-r.liquidL0)/100*e}function V(){const{maxT:e}=B(),l=u(0),m=u(e),b=m-l,p=Math.max(.2,b*.1),_=Math.max(0,l-p),y=m+p,w=b<=2?.5:b<=4?1:2,T=[],C=Math.ceil(_/w)*w;for(let L=C;L<=y+.001;L+=w)T.push({value:L,label:L.toFixed(1),min:_,max:y});return{minR:_,maxR:y,ticks:T}}function u(e){return r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*e}function f(e){const{maxT:l}=e;let m=r.thermistorR25;for(let y=0;y<=l;y+=5){const w=y+273.15,T=r.thermistorR25*Math.exp(r.thermistorBeta*(1/w-1/298.15));m=Math.max(m,T)}m=Math.ceil(m*1.08*10)/10;const b=0,p=m<=12?2:4,_=[];for(let y=0;y<=m+.001;y+=p)_.push({value:y,label:y.toFixed(0),min:b,max:m});return{minR:b,maxR:m,ticks:_}}const h=a.querySelector("#tl-thermometerCanvas"),x=h.getContext("2d"),G=a.querySelector("#tl-graphCanvas"),j=G.getContext("2d"),F=window.devicePixelRatio||1;h.width=d*F,h.height=O*F,x.scale(F,F),G.width=z*F,G.height=H*F,j.scale(F,F);function W(){r.iceCubes=[];for(let e=0;e<5;e++)r.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});r.bubbles=[];for(let e=0;e<20;e++)r.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});r.heatWaves=[];for(let e=0;e<8;e++)r.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});r.steamParticles=[];for(let e=0;e<12;e++)r.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const P=200,U=11;function ee(){const e=Math.pow(r.bulbVolume/P,.3333333333333333);return U*e}function ne(){if(r.thermometerType==="resistance"||r.thermometerType==="thermistor")return .35;const e=r.liquidType==="mercury"?1:8,l=.2+r.wallThickness*1.5,m=.4+r.bulbVolume*.003,b=1.35-r.capillaryBore*.45;return Math.max(.1,l*m*b*e*.15)}function te(e){r.bathTemp<=8&&r.iceCubes.forEach(l=>{l.x+=l.speedX,l.y+=l.speedY,(l.x<65||l.x>175)&&(l.speedX*=-1),(l.y<195||l.y>210)&&(l.speedY*=-1)}),r.bathTemp>35&&r.heatWaves.forEach(l=>{l.y-=l.speedY*(1+r.bathTemp/100),l.y<185&&(l.y=265,l.x=65+Math.random()*110)}),r.bathTemp>=80&&r.bubbles.forEach(l=>{l.y-=l.speedY*(1+(r.bathTemp-80)/40),l.phase+=l.wobbleSpeed,l.x+=Math.sin(l.phase)*.3,l.y<185&&(l.y=260+Math.random()*10,l.x=60+Math.random()*120)}),r.bathTemp>=95&&r.steamParticles.forEach(l=>{l.x+=l.vx,l.y+=l.vy,l.alpha-=.005,(l.alpha<=0||l.y<130)&&(l.x=60+Math.random()*120,l.y=175+Math.random()*5,l.alpha=.2+Math.random()*.4)})}function ae(e){let y=59,w=130,T=246;if(r.bathTemp<25){const q=r.bathTemp/25;y=Math.round(180-q*121),w=Math.round(210-q*80),T=Math.round(250-q*4)}else{const q=Math.min(1,(r.bathTemp-25)/125);y=Math.round(59+q*180),w=Math.round(130-q*100),T=Math.round(246-q*190)}if(r.bathTemp>40){const q=Math.min(1,(r.bathTemp-40)/100),K=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${q*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let Y=-25;Y<=25;Y+=6){const re=q*(12+Math.sin(Y*.4+K)*5);e.lineTo(55+130/2+Y,284-re)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${y}, ${w}, ${T}, 0.25)`),C.addColorStop(1,`rgba(${y}, ${w}, ${T}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const L=r.bathTemp>=80?2:.5,Q=r.bathTemp>=80?.09:.03,X=Date.now()*Q;for(let q=55;q<=185;q+=5){const K=190+Math.sin(q*.15+X)*L;e.lineTo(q,K)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),r.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(r.bathTemp-35)/120)})`,e.lineWidth=1.2,r.heatWaves.forEach(q=>{e.beginPath(),e.moveTo(q.x,q.y),e.quadraticCurveTo(q.x+Math.sin(q.y*.06)*5,q.y-q.length/2,q.x,q.y-q.length),e.stroke()})),r.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,r.iceCubes.forEach(q=>{e.save(),e.translate(q.x,q.y),e.rotate(q.angle),e.beginPath(),e.roundRect(-q.size/2,-q.size/2,q.size,q.size,3),e.fill(),e.stroke(),e.restore()})),r.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,r.bubbles.forEach(q=>{e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill(),e.stroke()})),r.bathTemp>=95&&r.steamParticles.forEach(q=>{e.fillStyle=`rgba(255, 255, 255, ${q.alpha})`,e.beginPath(),e.arc(q.x,q.y,q.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function k(e,l,m,b,p,_,y="left"){if(!r.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(l,m),e.lineTo(b,p),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(l,m,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const T=e.measureText(_).width+10,C=16,L=y==="left"?b:b-T,Q=p-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(L,Q,T,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(_,L+T/2,Q+C/2+.5)}function M(e){const b=ee(),p=250+Math.max(0,b-U)*.35,_=p-b-1,y=10+r.wallThickness*8,w=120-y/2,T=120+y/2,C=e.createLinearGradient(w,20,T,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,_),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(T,20,T,25,5),e.lineTo(T,_),e.closePath(),e.fill(),e.stroke();const L=e.createRadialGradient(120-b*.2,p-b*.2,b*.1,120,p,b);L.addColorStop(0,"rgba(255, 255, 255, 0.8)"),L.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=L,e.strokeStyle="#6b7280",e.lineWidth=.8+r.wallThickness*.6,e.beginPath(),e.arc(120,p,b+.5+r.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const Q=Math.min(y*.72,.8+r.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-Q/2,28,Q,_-20-8);const X=r.liquidType==="mercury",q=X?"#a1a1aa":"#ef4444",K=X?"#f4f4f5":"#fee2e2",Y=210,re=220,be=(Y-40)/re,he=Y-Math.min(re,r.thermometerTemp)*be;e.fillStyle=q,e.fillRect(120-Q/2,he,Q,_-he),e.beginPath(),e.ellipse(120,he,Q/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=K,e.fillRect(120-Q/6,he,Q/3,_-he);const se=b*.9,ie=e.createRadialGradient(120-se*.2,p-se*.2,se*.1,120,p,se);X?(ie.addColorStop(0,"#f4f4f5"),ie.addColorStop(.3,"#d4d4d8"),ie.addColorStop(.8,"#71717a"),ie.addColorStop(1,"#3f3f46")):(ie.addColorStop(0,"#fee2e2"),ie.addColorStop(.2,"#fca5a5"),ie.addColorStop(.7,"#ef4444"),ie.addColorStop(1,"#991b1b")),e.fillStyle=ie,e.beginPath(),e.arc(120,p,se,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let ce=0;ce<=200;ce+=50){const pe=Y-ce*be;e.beginPath(),e.moveTo(w,pe),e.lineTo(w+4,pe),e.stroke(),e.fillText(`${ce}°C`,w-22,pe+2.5)}r.showLabels&&(k(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),k(e,120,he,230,he-15,t("tools.thermometerLab.labels.meniscus"),"left"),k(e,120-Q/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),k(e,120,p,230,p+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function J(e){const y=e.createLinearGradient(115,20,125,20);y.addColorStop(0,"#71717a"),y.addColorStop(.3,"#f4f4f5"),y.addColorStop(.7,"#d4d4d8"),y.addColorStop(1,"#3f3f46"),e.fillStyle=y,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let X=0;X<8;X++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const T=245,C=40,L=135,Q=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(T,C,L,Q,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(T+10,C+12,L-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(r.currentResistance.toFixed(2)+" Ω",T+L-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",T+14,C+21),r.showLabels&&(k(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),k(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function D(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const p=20,_=225,y=12,w=120-y/2,T=e.createLinearGradient(w,p,w+y,p);T.addColorStop(0,"rgba(229, 231, 235, 0.4)"),T.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),T.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),T.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=T,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,p,y,_-p,[0,0,3,3]),e.fill(),e.stroke();const C=7,L=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);L.addColorStop(0,"#6b7280"),L.addColorStop(.7,"#1f2937"),L.addColorStop(1,"#09090b"),e.fillStyle=L,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const Q=245,X=40,q=135,K=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(Q,X,q,K,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(Q+10,X+12,q-20,34,4),e.fill(),e.font='bold 17px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(r.currentThermistorR.toFixed(2)+" kΩ",Q+q-16,X+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",Q+14,X+21),r.showLabels&&(k(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),k(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Z(e,l,m,b,p,_,y,w,T){const{gx:C,gy:L,gw:Q,gh:X}=l;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(m,b),e.lineTo(m,L+X),e.stroke(),e.beginPath(),e.moveTo(m,b),e.lineTo(C,b),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const q=`${p.toFixed(1)}${y}`,K=e.measureText(q).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(m-K/2,L+X+2,K,15,3),e.fill(),e.fillStyle="#000",e.fillText(q,m,L+X+4),e.textAlign="right",e.textBaseline="middle";const Y=`${_.toFixed(2)} ${w}`,re=e.measureText(Y).width+10;e.fillStyle=T,e.beginPath(),e.roundRect(C-re-2,b-7,re,15,3),e.fill(),e.fillStyle="#000",e.fillText(Y,C-7,b)}function N(e){const l=R(),{minL:m,maxL:b}=A(),{minT:p,maxT:_,tickStep:y}=B(),w=g(m,b),T=E(e,l,p,_,y,w),{gx:C,gy:L,gw:Q,gh:X,axisFont:q,yLabelX:K,xLabelY:Y,dotR:re}={...l,...T};e.save(),e.translate(K,L+X/2),e.rotate(-Math.PI/2),e.font=q,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+Q/2,Y);const we=_,be=v(0,p,_,C,Q),he=S($(0),m,b,L,X),se=v(we,p,_,C,Q),ie=S($(we),m,b,L,X);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentLength;if(ce>=p&&ce<=_){const ve=v(ce,p,_,C,Q),Ce=S(pe,m,b,L,X);Z(e,l,ve,Ce,ce,pe,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,re,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const l=R(),{minR:m,maxR:b,ticks:p}=V(),_=B(),y=E(e,l,_.minT,_.maxT,_.tickStep,p),{gx:w,gy:T,gw:C,gh:L,axisFont:Q,yLabelX:X,xLabelY:q,dotR:K}={...l,...y};e.save(),e.translate(X,T+L/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,q);const{minT:Y,maxT:re}=_,we=re,be=v(0,Y,re,w,C),he=S(u(0),m,b,T,L),se=v(we,Y,re,w,C),ie=S(u(we),m,b,T,L);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(be,he),e.lineTo(se,ie),e.stroke();const ce=r.thermometerTemp,pe=r.currentResistance;if(ce>=Y&&ce<=re){const ve=v(ce,Y,re,w,C),Ce=S(pe,m,b,T,L);Z(e,l,ve,Ce,ce,pe,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function le(e){const l=R(),m=B(),{minR:b,maxR:p,ticks:_}=f(m),y=E(e,l,m.minT,m.maxT,m.tickStep,_),{gx:w,gy:T,gw:C,gh:L,axisFont:Q,yLabelX:X,xLabelY:q,dotR:K}={...l,...y},{minT:Y,maxT:re}=m;e.save(),e.translate(X,T+L/2),e.rotate(-Math.PI/2),e.font=Q,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=Q,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,q),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let se=Y;se<=re;se+=1){const ie=se+273.15,ce=r.thermistorR25*Math.exp(r.thermistorBeta*(1/ie-1/298.15)),pe=v(se,Y,re,w,C),ve=S(Math.min(p,ce),b,p,T,L);ve>=T&&ve<=T+L&&(we?e.lineTo(pe,ve):(e.moveTo(pe,ve),we=!0))}e.stroke();const be=r.thermometerTemp,he=r.currentThermistorR;if(be>=Y&&be<=re){const se=v(be,Y,re,w,C),ie=S(Math.min(p,he),b,p,T,L);Z(e,l,se,ie,be,he,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(se,ie,K,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function ue(){x.clearRect(0,0,d,O),j.clearRect(0,0,z,H),x.save(),x.translate(I,0),ae(x),r.thermometerType==="liquid"?M(x):r.thermometerType==="resistance"?J(x):D(x),x.restore(),r.thermometerType==="liquid"?N(j):r.thermometerType==="resistance"?de(j):le(j)}function ge(){const e=a.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const l=a.querySelector("#tl-svg-formula-liquid-sub");if(l){const y=r.liquidL100-r.liquidL0,w=r.currentLength-r.liquidL0;l.innerHTML=`
      ...
      `);const b=a.querySelector("#tl-svg-formula-resistance-sub");if(b){const y=r.resistanceR100-r.resistanceR0,w=r.currentResistance-r.resistanceR0;b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `);const _=a.querySelector("#tl-svg-formula-thermistor-sub");if(_){const y=r.thermometerTemp+273.15;_.innerHTML=`
      ...
      `}}function qe(){const e=a.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:l,cu:m,interval:b}=He(),p=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,_=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,y=a.querySelector("#tl-pane-q10a").classList.contains("active"),w=y?(p-l)/b*100:_,T=y?p:_/100*b+l,L=(Q=>130-Q/100*80)(w);e.innerHTML=`
      <svg width="100%" height="100%" viewBox="0 0 340 180" style="background:transparent; overflow:visible;">
        ...
        <g transform="translate(130, 0)">
          ...
          <text x="125" y="${L+3}" fill="#34d399" font-size="10" font-weight="bold" text-anchor="start">C = ${T.toFixed(1)}°C</text>
    ...
    `}function ke(e){a.querySelector("#tl-bath-temp-display").innerHTML=r.bathTemp.toFixed(1)+"°C",a.querySelector("#tl-val-bath-temp").innerHTML=r.bathTemp.toFixed(1)+" °C";const l=a.querySelector("#tl-bath-state");r.bathTemp<=0?l.textContent="Melting Ice Bath":r.bathTemp>=100?l.textContent="Boiling Water/Steam":r.bathTemp===150?l.textContent="Hot Cooking Oil":l.textContent="Liquid Water",a.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const m=a.querySelector("#tl-alcohol-boiling-warning");r.thermometerType==="liquid"&&r.liquidType==="alcohol"&&r.bathTemp>=78?m.style.display="block":m.style.display="none",r.thermometerType==="liquid"?(a.querySelector("#tl-live-liquid-lt").textContent=r.currentLength.toFixed(2)+" cm",a.querySelector("#tl-live-liquid-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):r.thermometerType==="resistance"?(a.querySelector("#tl-live-resistance-rt").textContent=r.currentResistance.toFixed(2)+" Ω",a.querySelector("#tl-live-resistance-t-sub").textContent=r.thermometerTemp.toFixed(1)+"°C"):a.querySelector("#tl-live-thermistor-rt").textContent=r.currentThermistorR.toFixed(2)+" kΩ",ge()}let Se=null;function _e(e){r.lastTimestamp||(r.lastTimestamp=e);const l=(e-r.lastTimestamp)/1e3;r.lastTimestamp=e;const m=Math.min(l,.1),b=ne(),p=m/b*(r.bathTemp-r.thermometerTemp);r.thermometerTemp+=p,r.currentLength=r.liquidL0+(r.liquidL100-r.liquidL0)/100*r.thermometerTemp,r.currentResistance=r.resistanceR0+(r.resistanceR100-r.resistanceR0)/100*r.thermometerTemp;const _=r.thermometerTemp+273.15;r.currentThermistorR=r.thermistorR25*Math.exp(r.thermistorBeta*(1/_-1/298.15)),te(),ue(),ke(b),Se=requestAnimationFrame(_e)}function He(){const e=parseFloat(a.querySelector("#tl-input-faulty-cf").value),l=parseFloat(a.querySelector("#tl-input-faulty-cu").value),m=Number.isFinite(e)?e:-1.5,b=Number.isFinite(l)?l:105,p=b-m;return{cf:m,cu:b,interval:p}}function Ee(e){const l=Math.round(e*100)/100;return l>=0?l.toFixed(1):`(${l.toFixed(1)})`}function me(){const{cf:e,cu:l,interval:m}=He(),b=a.querySelector("#tl-val-faulty-interval"),p=a.querySelector("#tl-faulty-error-a"),_=a.querySelector("#tl-faulty-error-b"),y=Math.abs(m)<.01;b.textContent=m.toFixed(1)+" °C";const w=a.querySelector("#tl-svg-formula-faulty-a"),T=a.querySelector("#tl-svg-formula-faulty-b");if(y){p.hidden=!1,p.textContent="C_u must differ from C_f (interval cannot be zero).",_.hidden=!1,_.textContent=p.textContent,w&&(w.innerHTML=""),T&&(T.innerHTML="");return}p.hidden=!0,_.hidden=!0;const C=parseFloat(a.querySelector("#tl-input-q10a-cm").value)||0,L=parseFloat(a.querySelector("#tl-input-q10b-t").value)||0,Q=(C-e)/m*100,X=L/100*m+e;w&&(w.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="100" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${C.toFixed(1)} - ${Ee(e)}</text>
          <text x="100" y="36" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="12" text-anchor="middle">${l.toFixed(1)} - ${Ee(e)}</text>
          <text x="170" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            &times; 100 = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${Q.toFixed(1)}°C</tspan>
          </text>
        </svg>
      `),T&&(T.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          ...
          <text x="95" y="15" fill="#06b6d4" font-family="Cambria, Georgia, serif" font-weight="bold" font-size="12" text-anchor="middle">${L.toFixed(1)} &times; ${m.toFixed(1)}</text>
          ...
          <text x="158" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="14">
            + ${Ee(e)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${X.toFixed(2)}°C</tspan>
          </text>
        </svg>
      `),qe()}function ye(){const e=parseFloat(a.querySelector("#tl-input-q11-r").value)||0,l=(e-r.resistanceR0)/(r.resistanceR100-r.resistanceR0)*100,m=a.querySelector("#tl-svg-formula-resistance-solver");m&&(m.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
      ...
      `)}function Te(){const e=r.thermometerTemp,l=r.liquidL100-r.liquidL0,m=r.liquidL0+l/100*e,b=a.querySelector("#tl-svg-formula-t-to-l");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">L<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${r.liquidL0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${l.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${m.toFixed(2)} cm</tspan>
          </text>
        </svg>
      `)}function Ne(){const e=r.thermometerTemp,l=r.resistanceR100-r.resistanceR0,m=r.resistanceR0+l/100*e,b=a.querySelector("#tl-svg-formula-t-to-r");b&&(b.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
          ...
          <text x="10" y="103" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">R<tspan dy="2" font-size="8">T</tspan><tspan dy="-2"> = ${r.resistanceR0.toFixed(1)} + </tspan>
            <tspan fill="#a1a1aa">(${l.toFixed(1)} / 100)</tspan> &times; ${e.toFixed(1)} = <tspan fill="#10b981" font-family="system-ui, sans-serif" font-weight="900" class="tl-final-ans">${m.toFixed(2)} Ω</tspan>
          </text>
        </svg>
      `)}function fe(){me(),ye(),Te(),Ne()}function Fe(e,l){a.querySelector("#"+e).addEventListener("click",()=>{r.bathTemp=l,a.querySelector("#tl-bath-temp-slider").value=l,fe()})}function Qe(e){a.querySelectorAll(".tl-tab-btn").forEach(l=>{l.classList.toggle("active",l.getAttribute("data-tl-tab")===e)}),a.querySelectorAll(".tl-tab-content").forEach(l=>{l.classList.toggle("active",l.id==="tl-tab-"+e)}),a.querySelectorAll(".tl-live-tab").forEach(l=>{l.classList.toggle("active",l.id==="tl-live-"+e)}),r.thermometerType=e}function Rt(){a.querySelectorAll(".tl-tab-btn").forEach(p=>{p.addEventListener("click",()=>{Qe(p.getAttribute("data-tl-tab")),fe()})}),a.querySelector("#tl-btn-toggle-labels").addEventListener("click",()=>{r.showLabels=!r.showLabels,a.querySelector("#tl-lbl-toggle-labels").textContent=r.showLabels?t("tools.thermometerLab.labels.hide"):t("tools.thermometerLab.labels.show")}),a.querySelector("#tl-bath-temp-slider").addEventListener("input",p=>{r.bathTemp=parseFloat(p.target.value),fe()}),Fe("tl-btn-preset-ice",0),Fe("tl-btn-preset-room",25),Fe("tl-btn-preset-steam",100),Fe("tl-btn-preset-oil",150),a.querySelector("#tl-card-mercury").addEventListener("click",()=>{r.liquidType="mercury",a.querySelector("#tl-card-mercury").className="tl-seg-btn active-mercury",a.querySelector("#tl-card-alcohol").className="tl-seg-btn",fe()}),a.querySelector("#tl-card-alcohol").addEventListener("click",()=>{r.liquidType="alcohol",a.querySelector("#tl-card-mercury").className="tl-seg-btn",a.querySelector("#tl-card-alcohol").className="tl-seg-btn active-alcohol",fe()}),a.querySelector("#tl-slider-bulb-vol").addEventListener("input",p=>{r.bulbVolume=parseFloat(p.target.value),a.querySelector("#tl-val-bulb-vol").textContent=r.bulbVolume+" mm³"}),a.querySelector("#tl-slider-wall-thick").addEventListener("input",p=>{r.wallThickness=parseFloat(p.target.value),a.querySelector("#tl-val-wall-thickness").textContent=r.wallThickness.toFixed(1)+" mm"}),a.querySelector("#tl-slider-capillary-bore").addEventListener("input",p=>{r.capillaryBore=parseFloat(p.target.value),a.querySelector("#tl-val-capillary-bore").textContent=r.capillaryBore.toFixed(2)+" mm"}),a.querySelector("#tl-slider-liquid-l0").addEventListener("input",p=>{r.liquidL0=parseFloat(p.target.value),a.querySelector("#tl-val-liquid-l0").textContent=r.liquidL0.toFixed(1)+" cm",fe()}),a.querySelector("#tl-slider-liquid-l100").addEventListener("input",p=>{r.liquidL100=parseFloat(p.target.value),a.querySelector("#tl-val-liquid-l100").textContent=r.liquidL100.toFixed(1)+" cm",fe()}),a.querySelector("#tl-slider-resistance-r0").addEventListener("input",p=>{r.resistanceR0=parseFloat(p.target.value),a.querySelector("#tl-val-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r0").textContent=r.resistanceR0.toFixed(1)+" Ω",fe()}),a.querySelector("#tl-slider-resistance-r100").addEventListener("input",p=>{r.resistanceR100=parseFloat(p.target.value),a.querySelector("#tl-val-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",a.querySelector("#tl-spec-resistance-r100").textContent=r.resistanceR100.toFixed(1)+" Ω",fe()}),a.querySelector("#tl-slider-thermistor-r25").addEventListener("input",p=>{r.thermistorR25=parseFloat(p.target.value),a.querySelector("#tl-val-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",a.querySelector("#tl-spec-thermistor-r25").textContent=r.thermistorR25.toFixed(1)+" kΩ",fe()}),a.querySelector("#tl-slider-thermistor-beta").addEventListener("input",p=>{r.thermistorBeta=parseFloat(p.target.value),a.querySelector("#tl-val-thermistor-beta").textContent=r.thermistorBeta+" K",a.querySelector("#tl-spec-thermistor-beta").textContent=r.thermistorBeta+" K",fe()}),a.querySelector("#tl-btn-solve-q10a").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.add("active"),a.querySelector("#tl-btn-solve-q10b").classList.remove("active"),a.querySelector("#tl-pane-q10a").classList.add("active"),a.querySelector("#tl-pane-q10b").classList.remove("active"),me()}),a.querySelector("#tl-btn-solve-q10b").addEventListener("click",()=>{a.querySelector("#tl-btn-solve-q10a").classList.remove("active"),a.querySelector("#tl-btn-solve-q10b").classList.add("active"),a.querySelector("#tl-pane-q10a").classList.remove("active"),a.querySelector("#tl-pane-q10b").classList.add("active"),me()}),a.querySelector("#tl-input-faulty-cf").addEventListener("input",me),a.querySelector("#tl-input-faulty-cu").addEventListener("input",me),a.querySelector("#tl-input-q10a-cm").addEventListener("input",me),a.querySelector("#tl-input-q10b-t").addEventListener("input",me),a.querySelector("#tl-input-q11-r").addEventListener("input",ye);const m=a.querySelector("#tl-input-t-to-l");m&&m.addEventListener("input",fe);const b=a.querySelector("#tl-input-t-to-r");b&&b.addEventListener("input",fe)}if(n.type){const e=a.querySelector(".tl-tabs-container");e&&(e.style.display="none")}Qe(o),W(),Rt(),fe();const Ve=a.querySelector(".tl-dash"),Ke=a.querySelector(".tl-controls"),Ue=a.querySelector("#tl-controls-toggle"),Mt=a.querySelector("#tl-controls-drag");return Ve&&Ke&&Ue&&ya({container:Ve,panel:Ke,toggleBtn:Ue,dragHandle:Mt,storageKey:`s3phy-thermo-${o}`,breakpoint:ba,getToggleTitle:e=>t(e?"tools.floatingControls.showParams":"tools.floatingControls.hideParams"),onLayoutChange:()=>ue()}),Se=requestAnimationFrame(_e),a._thermometerLabCleanup=()=>{Se&&cancelAnimationFrame(Se)},a}function wa(t){const n=document.createElement("div");n.className="tool-specific-heat";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"specific-heat/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.specificHeat.title")||"Specific Heat Capacity Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var d;try{(d=o.contentWindow)==null||d.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function xa(t){const n=document.createElement("div");n.className="tool-thermal-mixing";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"thermal-mixing/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.thermalMixing.title")||"Thermal Mixing Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var d;try{(d=o.contentWindow)==null||d.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function ka(t){const n=document.createElement("div");n.className="tool-change-of-state";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"change-of-state/index.html?lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.changeOfState.title")||"Change of State Lab",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var d;try{(d=o.contentWindow)==null||d.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}function Sa(t){const n=document.createElement("div");n.className="tool-heat-transfer";const o=document.createElement("iframe"),i="./",s=i.endsWith("/")?i:i+"/";function a(){return s+"heat-transfer/index.html?embed=1&lang="+encodeURIComponent(oe())}o.src=a(),o.title=t("tools.heatTransfer.title")||"Heat Transfer Laboratory",o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const r=()=>{var d;try{(d=o.contentWindow)==null||d.postMessage({type:"s3phy:lang",lang:oe()},"*")}catch{o.src=a()}};return window.addEventListener("s3phy:lang",r),n._thermometerLabCleanup=()=>window.removeEventListener("s3phy:lang",r),n.appendChild(o),n}const Le=[{id:"thermometer",titleKey:"topic.thermometer",fileEn:"thermometer-en.pdf",fileZh:"thermometer-zhHant.pdf",tool:"liquid"},{id:"heatInternalEnergy",titleKey:"topic.heatInternalEnergy",fileEn:"heat-internal-energy-en.pdf",fileZh:"heat-internal-energy-zhHant.pdf",tool:"specificHeat"},{id:"changeOfState",titleKey:"topic.changeOfState",fileEn:"change-of-state-en.pdf",fileZh:"change-of-state-zhHant.pdf",tool:"changeOfState"},{id:"heatTransfer",titleKey:"topic.heatTransfer",fileEn:"heat-transfer-en.pdf",fileZh:"heat-transfer-zhHant.pdf",tool:"heatTransfer"}],dt=["liquidThermometer","faultyThermometer","resistanceThermometer","thermistor"],qa=[["thermometer","topic.thermometer"]],ut=["liquid","resistance","thermistor","specificHeat","thermalMixing","changeOfState","heatTransfer"],Ta={liquid:t=>Ge(t,{type:"liquid"}),resistance:t=>Ge(t,{type:"resistance"}),thermistor:t=>Ge(t,{type:"thermistor"}),specificHeat:t=>wa(t),thermalMixing:t=>xa(t),changeOfState:t=>ka(t),heatTransfer:t=>Sa(t)};function Ca(t){return c({liquid:"tools.thermometerLab.liquid.title",resistance:"tools.thermometerLab.resistance.title",thermistor:"tools.thermometerLab.thermistor.title",specificHeat:"tools.specificHeat.title",thermalMixing:"tools.thermalMixing.title",changeOfState:"tools.changeOfState.title",heatTransfer:"tools.heatTransfer.title"}[t]||t)}function je(){return oe()==="zh-Hant"?"zhHant":"en"}async function Me(t,n){const o=`./${t}/${n}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function ft(t){return Me("notes",t)}function La(t){let n="topics",o="liquid",i=null,s={main:null},a=null,r=null;const d=[{value:"all",labelKey:"flashcards.all"},{value:"thermometry",labelKey:"flashcards.deck.thermometry"},{value:"heatInternalEnergy",labelKey:"flashcards.deck.heatInternalEnergy"},{value:"changeOfState",labelKey:"flashcards.deck.changeOfState"},{value:"heatTransfer",labelKey:"flashcards.deck.heatTransfer"}];function O(){if(s.main){if(r==null||r(),r=null,n==="topics"?s.main.innerHTML=z():n==="notes"?s.main.innerHTML=R():n==="tools"?s.main.innerHTML=v():n==="worksheets"?s.main.innerHTML=xt(c,{topics:qa,paperTitleKey:"worksheets.paperTitleHeat"}):n==="flashcards"?r=St(s.main,{deckOptions:d.map(u=>({value:u.value,label:c(u.labelKey)})),buildDeck:u=>da(u,oe())}):n==="summary"&&(s.main.innerHTML=g()),n==="notes"&&B(),n==="tools"&&S(),n==="worksheets"){const u=yt.filter(f=>dt.includes(f.topic));kt(t,u,c,je,{topicFilter:(f,h)=>h.includes("thermometer")?dt.includes(f.topic):h.includes(f.topic)})}n==="summary"&&A()}}function I(){i==null||i.destroy(),i=wt(t,{subtitleKey:"strand.heat.subtitle",activeSection:n,onSection:u=>{n==="tools"&&u!=="tools"&&a!=null&&a._thermometerLabCleanup&&(a._thermometerLabCleanup(),a=null),n=u,i.updateSection(n),O()},onLang:()=>I()}),s.main=i.main,i.updateSection(n),O()}function z(){return`
      <section class="panel panel--topic-hub">
        <h2>${c("topics.title")}</h2>
        <p class="lead">${c("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${Le.map(u=>{const f=u.tool?`<button class="btn primary" type="button" data-go-tool="${u.tool}">${c("topic.openTool")}</button>`:`<button class="btn primary" type="button" data-go-section="notes">${c("topic.viewNotes")}</button>`;return`
            <div class="card">
              <h3>${c(u.titleKey)}</h3>
              ${f}
            </div>`}).join("")}
        </div>
      </section>`}function H(u){const f=u.target.closest("[data-go-tool]");if(f){const x=f.getAttribute("data-go-tool");ut.includes(x)?o=x:o="liquid",n="tools",i.updateSection(n),O();return}const h=u.target.closest("[data-go-section]");(h==null?void 0:h.getAttribute("data-go-section"))==="notes"&&(n="notes",i.updateSection(n),O())}function R(){return`
      <section class="panel">
        <h2>${c("notes.title")}</h2>
        <p class="lead">${c("notes.intro")}</p>
        <p class="lead">${c("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${Le.map(u=>`
            <div class="card" data-note-card="${u.id}">
              <h3>${c(`notes.card.${u.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function B(){const u=je();for(const f of Le){const h=t.querySelector(`[data-note-card="${f.id}"]`);if(!h)continue;const x=h.querySelector("[data-note-body]"),G=u==="zhHant"?f.fileZh:f.fileEn,j=await ft(G),F=`./notes/${G}`;j?x.innerHTML=`
          <iframe class="notes-grid" title="${c(`notes.card.${f.id}`)}" src="${F}"></iframe>
          <p style="margin-top:8px"><a href="${F}" target="_blank" rel="noopener">${c("notes.openPdf")}</a></p>`:x.innerHTML=`<p class="lead">${c("notes.missing")}</p>`}}function v(){return`
      <section class="panel panel--tools">
        <h2>${c("tools.title")}</h2>
        <p class="lead">${c("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${ut.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${Ca(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function S(){const u=t.querySelector("[data-tool-list]"),f=t.querySelector("[data-tool-stage]");!u||!f||(u.querySelectorAll("button").forEach(h=>{h.addEventListener("click",()=>{o=h.getAttribute("data-tool"),u.querySelectorAll("button").forEach(x=>x.classList.toggle("active",x.getAttribute("data-tool")===o)),E(f)})}),E(f))}function E(u){u.innerHTML="",a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup();const f=Ta[o];f&&(a=f(c),u.appendChild(a))}function g(){return`
      <section class="panel">
        <h2>${c("summary.title")}</h2>
        <p class="lead">${c("summary.intro")}</p>
        <p class="lead">${c("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${Le.map(u=>`
            <div class="card" data-summary-card="${u.id}">
              <h3>${c(`summary.item.${u.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function A(){const u=je();for(const f of Le){const h=t.querySelector(`[data-summary-card="${f.id}"]`);if(!h)continue;const x=h.querySelector("[data-summary-body]");if(f.id==="thermometer"){const W=await Me("summary","thermometer.webp"),P="./summary/thermometer.webp";W?x.innerHTML=`
          <img class="summary-thumb" src="${P}" alt="${c("summary.item.thermometer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(f.id==="heatInternalEnergy"){const W=await Me("summary","heat-internal-energy.webp"),P="./summary/heat-internal-energy.webp";W?x.innerHTML=`
          <img class="summary-thumb" src="${P}" alt="${c("summary.item.heatInternalEnergy")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(f.id==="changeOfState"){const W=await Me("summary","change-of-state.webp"),P="./summary/change-of-state.webp";W?x.innerHTML=`
          <img class="summary-thumb" src="${P}" alt="${c("summary.item.changeOfState")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}if(f.id==="heatTransfer"){const W=await Me("summary","heat-transfer.webp"),P="./summary/heat-transfer.webp";W?x.innerHTML=`
          <img class="summary-thumb" src="${P}" alt="${c("summary.item.heatTransfer")}" loading="lazy" />
          <p style="margin-top:8px"><a href="${P}" target="_blank" rel="noopener">${c("summary.viewImage")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`;continue}const G=u==="zhHant"?f.fileZh:f.fileEn,j=await ft(G),F=`./notes/${G}`;j?x.innerHTML=`
          <iframe class="notes-grid" title="${c(`summary.item.${f.id}`)}" src="${F}"></iframe>
          <p style="margin-top:8px"><a href="${F}" target="_blank" rel="noopener">${c("summary.download")}</a></p>`:x.innerHTML=`<p class="lead">${c("summary.missing")}</p>`}}const $=()=>I(),V=u=>H(u);return window.addEventListener("s3phy:lang",$),t.addEventListener("click",V),I(),()=>{window.removeEventListener("s3phy:lang",$),t.removeEventListener("click",V),r==null||r(),a!=null&&a._thermometerLabCleanup&&a._thermometerLabCleanup(),i==null||i.destroy()}}const ht={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};Et();At();const pt="s3phy_splash_seen",Ct={optics:ma,heat:La};let ze=null,Re=null;function za(){const t=location.hash.match(/^#\/(\w+)/),n=t==null?void 0:t[1];return n&&Object.prototype.hasOwnProperty.call(Ct,n)?n:null}function Ra(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function Lt(t){ze==null||ze(),ze=null,Re==null||Re(),Re=null;const n=document.getElementById("app");if(!n)return;if(n.innerHTML="",!t){location.hash&&Ra(),Re=It(n);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}ze=Ct[t](n)??null}function zt(){Lt(za())}function Ma(){return"./images/uniplus-logo.png"}function _a(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Ma()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
      <div class="splash-uni-title" aria-hidden="true">Uni+</div>
      <div class="splash-start-wrap" id="splashStartWrap">
        <button type="button" class="splash-start-btn" id="splashStart">${c("splash.start")}</button>
      </div>
    </div>
  `,t}function Ha(t,n){const o=[...ht.en,...ht.zhHant],i=()=>{if(!t.parentElement)return;const s=document.createElement("div");s.className="splash-danmaku-item",s.textContent=o[Math.floor(Math.random()*o.length)];const a=Math.random()*85+5,r=Math.random()*.8+.9,d=Math.random()*12+10;s.style.top=`${a}%`,s.style.fontSize=`${r}rem`,s.style.animationDuration=`${d}s`,n.appendChild(s),s.addEventListener("animationend",()=>s.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let s=0;s<4;s+=1)window.setTimeout(i,s*1e3)}function Ea(t){const n=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>n==null?void 0:n.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),o&&Ha(t,o)},1600)}function mt(){zt()}function Fa(){let t=!1;try{t=sessionStorage.getItem(pt)==="1"}catch{}if(t){mt();return}const n=_a();document.body.insertBefore(n,document.body.firstChild),Ea(n);const o=n.querySelector("#splashStart"),i=()=>{n.remove(),mt()};o.addEventListener("click",()=>{try{sessionStorage.setItem(pt,"1")}catch{}n.classList.add("splash--hide"),n.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",zt);window.addEventListener("s3phy:strand",t=>{Lt(t.detail??null)});Fa();
