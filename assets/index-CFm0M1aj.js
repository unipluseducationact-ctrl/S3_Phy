...
`;function bt(){if(document.getElementById(Be))return;const t=document.createElement("style");t.id=Be,t.textContent=gt,document.head.appendChild(t)}function vt(t){bt();const r=document.createElement("div");r.className="rml",r.innerHTML=`
    <div class="rml-head">
  ...
  `;const o=r.querySelector(".rml-canvas"),i=o.getContext("2d"),d=r.querySelector("[data-rml-rot]"),n=r.querySelector("[data-rml-inc]"),a=r.querySelector('[data-rml-disp="rot"]'),q=r.querySelector('[data-rml-disp="inc"]'),E=r.querySelector('[data-rml-val="i"]'),te=r.querySelector('[data-rml-val="r"]'),P=r.querySelector('[data-rml-val="shift"]'),$=350,O=380,Z=300,L="#22d3ee",H="bold 17px system-ui, sans-serif";let F=0,B=-140,ae=!0,X=!0,U=!0,V=!0;function Y(m){return m*Math.PI/180}function J(m,u,c,v,R,_=2,I=!1){i.beginPath(),i.lineWidth=_,i.strokeStyle=R,i.setLineDash(I?[6,6]:[]);const y=m+Math.cos(Y(c))*v,x=u+Math.sin(Y(c))*v;return i.moveTo(m,u),i.lineTo(y,x),i.stroke(),i.setLineDash([]),{x:y,y:x}}function ee(m,u,c,v,R,_=14){const I=c-m,y=v-u,x=Math.hypot(I,y);if(x<1e-6)return;const G=I/x,z=y/x,Q=c-G*_,A=v-z*_,de=.45*_;i.beginPath(),i.fillStyle=R,i.moveTo(c,v),i.lineTo(Q-z*de,A+G*de),i.lineTo(Q+z*de,A-G*de),i.closePath(),i.fill()}function K(m,u,c,v,R,_=25){i.beginPath(),i.strokeStyle=v,i.lineWidth=2;const I=Math.min(m,u),y=Math.max(m,u);if(i.arc($,O,c,Y(I),Y(y),!1),i.stroke(),R){const x=(I+y)/2,G=$+Math.cos(Y(x))*(c+_),z=O+Math.sin(Y(x))*(c+_);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillStyle=v,i.fillText(R,G,z),i.restore()}}function ne(m,u,c,v,R){i.clearRect(0,0,o.width,o.height),i.beginPath(),i.setLineDash([10,6]),i.strokeStyle="rgba(255, 204, 0, 0.45)",i.lineWidth=3,i.lineCap="round",i.moveTo($-200,O),i.lineTo($+200,O),i.stroke(),i.setLineDash([]),i.lineCap="butt";const _=$+Math.cos(Y(m))*Z,I=O+Math.sin(Y(m))*Z;i.beginPath(),i.lineWidth=3,i.strokeStyle="#fff",i.moveTo(_,I),i.lineTo($,O),i.stroke();const y=(_+$)*.5,x=(I+O)*.5,G=Math.hypot($-_,O-I)||1,z=($-_)/G,Q=(O-I)/G;if(ee(y-z*28,x-Q*28,y,x,"#fff",16),i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#fff",i.fillText(t("tools.rotatingMirror.canvas.incident"),_,I-12),i.restore(),ae){const A=J($,O,-90,Z-60,"#00e676",1,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.n"),A.x+6,A.y-4),i.restore()}if(X){const A=J($,O,v,Z,"#00e676",2,!1);ee($,O,A.x,A.y,"#00e676",16),i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle="#00e676",i.fillText(t("tools.rotatingMirror.canvas.originalReflected"),A.x,A.y-14),i.restore()}i.save(),i.translate($,O),i.rotate(Y(F)),i.beginPath(),i.lineWidth=6,i.strokeStyle="#ffcc00",i.lineCap="round",i.moveTo(-200,0),i.lineTo(200,0),i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle="#666";for(let A=-190;A<200;A+=15)i.moveTo(A,0),i.lineTo(A-5,8);if(i.stroke(),i.restore(),U){const A=J($,O,u,Z-40,L,2,!0);i.save(),i.font="bold 14px system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",i.fillStyle=L,i.fillText(t("tools.rotatingMirror.canvas.nPrime"),A.x+6,A.y-4),i.restore()}if(V){const A=J($,O,c,Z,L,4);ee($,O,A.x,A.y,L,16),Math.abs(F)>.5&&(i.save(),i.font=H,i.textAlign="center",i.textBaseline="bottom",i.fillStyle=L,i.fillText(t("tools.rotatingMirror.canvas.newReflected"),A.x,A.y-14),i.restore())}if(U&&K(m,u,100,"#ffcc00",`i=${R.toFixed(0)}°`,25),U&&V&&K(u,c,100,L,`r=${R.toFixed(0)}°`,25),ae&&U&&Math.abs(F)>.5&&K(-90,u,50,"#ffcc00",`θ=${Math.abs(F)}°`,20),X&&V&&Math.abs(F)>.5){const A=c-v;K(v,c,260,"#ff5252",`${t("tools.rotatingMirror.canvas.shift")}=${A.toFixed(0)}°`,40)}}function b(){F=parseFloat(d.value),B=parseFloat(n.value);const m=F>0?"+":"";a.textContent=`${m}${F}°`,q.textContent=`${B}°`;const u=-90,c=Math.abs(B-u),v=u+c,R=-90+F,_=Math.abs(B-R),I=R+_,y=I-v;E.textContent=`${_.toFixed(1)}°`,te.textContent=`${_.toFixed(1)}°`;const x=y>0?"+":"";P.textContent=`${x}${y.toFixed(1)}°`,ne(B,R,I,v,_)}return r.querySelectorAll("[data-rml-toggle]").forEach(m=>{m.addEventListener("click",()=>{const u=m.getAttribute("data-rml-toggle");u==="orig-norm"&&(ae=!ae),u==="orig-ray"&&(X=!X),u==="new-norm"&&(U=!U),u==="new-ray"&&(V=!V),m.classList.toggle("active"),b()})}),r.querySelector("[data-rml-reset]").addEventListener("click",()=>{d.value="0",b()}),d.addEventListener("input",b),n.addEventListener("input",b),b(),r}function yt(t){const r=document.createElement("div");r.className="tool-tir-escape";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;return o.src=`${d}tir-escape/index.html?embed=1`,o.title=t("tools.refractionTir.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin",r.appendChild(o),r}function wt(t,r={}){const o=r.defaultKind==="concave"?"concave":"convex",i="tools.lens.title",d=document.createElement("div");d.className="tool-lens-simulator";const n=document.createElement("iframe"),a="./",q=a.endsWith("/")?a:`${a}/`;return n.src=`${q}lens-simulator/index.html?embed=1&defaultLens=${encodeURIComponent(o)}`,n.title=t(i),n.setAttribute("loading","lazy"),n.referrerPolicy="strict-origin-when-cross-origin",d.appendChild(n),d}function xt(t){const r=document.createElement("div");r.className="tool-em-spectrum";const o=document.createElement("iframe"),i="./",d=i.endsWith("/")?i:`${i}/`;function n(){return`${d}em-spectrum/index.html?lang=${encodeURIComponent(ce())}`}o.src=n(),o.title=t("tools.em.title"),o.setAttribute("loading","lazy"),o.referrerPolicy="strict-origin-when-cross-origin";const a=()=>{var q;try{(q=o.contentWindow)==null||q.postMessage({type:"s3phy:lang",lang:ce()},"*")}catch{o.src=n()}};return window.addEventListener("s3phy:lang",a),r._emLabCleanup=()=>window.removeEventListener("s3phy:lang",a),r.appendChild(o),r}function qt(t){const r=document.createElement("div");r.className="rgb-mixer",r.innerHTML=`
  ...
  `;const n=t.querySelector("[data-main]"),a=t.querySelector("[data-nav]"),q=t.querySelector("[data-lang]"),E=t.querySelector("[data-strand-back]");let te=o;function P(L){te=L,a.innerHTML=St.map(H=>`<button type="button" class="${L===H?"active":""}" data-sec="${H}">${l(kt[H])}</button>`).join(""),a.querySelectorAll("button").forEach(H=>{H.addEventListener("click",()=>i(H.getAttribute("data-sec")))})}function $(){q.innerHTML=`
      <button type="button" data-set-lang="en" class="${ce()==="en"?"active":""}">${l("lang.en")}</button>
      <button type="button" data-set-lang="zh-Hant" class="${ce()==="zh-Hant"?"active":""}">${l("lang.zhHant")}</button>
    `,q.querySelectorAll("button").forEach(L=>{L.addEventListener("click",()=>{et(L.getAttribute("data-set-lang")),d()})})}function O(){t.querySelector("[data-hub-subtitle]").textContent=l(r),E.textContent=l("strand.back"),t.querySelector("[data-hub-footer]").textContent=l("footer.conventions"),t.querySelector(".site-title").textContent=l("app.title")}const Z=()=>{window.dispatchEvent(new CustomEvent("s3phy:strand",{detail:null}))};return E.addEventListener("click",Z),P(o),$(),{main:n,updateSection(L){P(L)},refreshLabels(){O(),P(te),$()},destroy(){E.removeEventListener("click",Z)}}}const We=["A","B","C","D"];function Qe(t){const r=t.slice();for(let o=r.length-1;o>0;o-=1){const i=Math.floor(Math.random()*(o+1));[r[o],r[i]]=[r[i],r[o]]}return r}function Tt(t,r,o){return t.filter(i=>{if(o)return o(i,r);const d=i.topic;return!!(r.includes(d)||r.includes("rotatingMirror")&&d==="reflection"||r.includes("refraction")&&d==="refraction"||r.includes("tir")&&d==="tir"||d==="convex"&&r.includes("convex")||d==="concave"&&r.includes("concave"))})}function Ct(){return new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})}function xe(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function it(t,r={}){const o=r.topics??[["rotatingMirror","topic.rotatingMirror"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]],i=r.paperTitleKey??"worksheets.paperTitle";return`
    <section class="panel panel--worksheets">
    ...
    </section>`}function rt(t,r,o,i,d={}){var v,R,_,I;const n={items:[],tab:"practice",dateStr:"",userAnswers:{},wrongAttempts:{},resolved:{}},a=t.querySelector("[data-ws-gen]"),q=t.querySelector("[data-ws-preview-area]"),E=t.querySelector("[data-ws-out]"),te=t.querySelector("[data-ws-body]"),P=t.querySelector("[data-ws-paper]"),$=t.querySelector("[data-ws-tabs]"),O=t.querySelector("[data-ws-practice-actions]"),Z=t.querySelector("[data-ws-score]"),L=t.querySelector("[data-ws-score-val]"),H=t.querySelector("[data-ws-summary]"),F=t.querySelector("[data-ws-date-row]"),B=t.querySelector("[data-ws-date-print]"),ae=t.querySelector("[data-ws-date-today]"),X=t.querySelector("[data-ws-date-label]");if(!a||!te)return;function U(){return i()}function V(){n.userAnswers={},n.wrongAttempts={},n.resolved={},Z.hidden=!0,H.hidden=!0}function Y(){return n.items.length>0&&n.items.every((y,x)=>n.resolved[x])}function J(){let y=0;n.items.forEach((G,z)=>{if(!n.resolved[z])return;const Q=G[U()]||G.en;n.userAnswers[z]===Q.a&&(y+=1)}),Object.keys(n.resolved).length>0&&(L.textContent=`${y}/${n.items.length}`,Z.hidden=!1)}function ee(y){n.tab=y,$==null||$.querySelectorAll("[data-ws-tab]").forEach(x=>{x.classList.toggle("active",x.getAttribute("data-ws-tab")===y)}),O&&(O.hidden=y!=="practice"),F&&(F.hidden=y!=="practice"),B&&(B.hidden=!n.dateStr,B.textContent=n.dateStr?`${o("worksheets.date")}: ${n.dateStr}`:""),P==null||P.classList.toggle("practice-mode",y==="practice"),ne()}function K(y,x,G){const z=y[U()]||y.en,Q=We,A=x+1,de=y.section?`<span class="q-section">${xe(y.section)}</span>`:"";if(G==="answer"){const me=z.choices.map((ye,Te)=>`<li class="${Te===z.a?"choice-correct":""}"><strong>${Q[Te]}.</strong> ${xe(ye)}</li>`).join("");return`<div class="question-row question-row--answer">
        <h4>Q${A} ${de}</h4>
        <p>${xe(z.q)}</p>
        <ol class="choice-list">${me}</ol>
        <p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Q[z.a]}</p>
        <p class="q-exp"><em>${xe(z.exp)}</em></p>
      </div>`}const se=n.userAnswers[x],pe=n.wrongAttempts[x]||0,be=n.resolved[x],ke=be&&se===z.a,qe=be&&se!==z.a;let Se="";pe===1&&!be?Se=`<p class="q-hint"><strong>${o("worksheets.hint")}:</strong> ${xe(z.hint||z.exp)}</p>`:qe&&(Se=`<p class="q-exp"><strong>${o("worksheets.answer")}:</strong> ${Q[z.a]}</p>
        <p class="q-exp q-summary"><em>${xe(z.exp)}</em></p>`);const Re=ke?"correct":qe?"incorrect":"",ze=z.choices.map((me,ye)=>`<li>
          <label class="choice-radio">
            ...
            <strong>${Q[ye]}.</strong> ${xe(me)}
          </label>
        </li>`).join("");return`<div class="question-row ${Re}" data-ws-row="${x}">
      ...
      ${Se}
    </div>`}function ne(){n.items.length&&(te.innerHTML=n.items.map((y,x)=>K(y,x,n.tab)).join(""),b())}function b(){n.tab==="practice"&&te.querySelectorAll("[data-ws-choice]").forEach(y=>{y.addEventListener("change",()=>{const x=Number(y.getAttribute("data-ws-q"));if(n.resolved[x])return;const G=Number(y.getAttribute("data-ws-choice")),z=n.items[x][U()]||n.items[x].en;n.userAnswers[x]=G,G===z.a?n.resolved[x]=!0:(n.wrongAttempts[x]=(n.wrongAttempts[x]||0)+1,n.wrongAttempts[x]>=2&&(n.resolved[x]=!0)),J(),Y()&&m(),ne()})})}function m(){const y=n.items.length;let x=0,G=0;const z={};n.items.forEach((se,pe)=>{const be=se[U()]||se.en;if(n.userAnswers[pe]===be.a)x+=1,(n.wrongAttempts[pe]||0)===0&&(G+=1);else if(n.resolved[pe]){const qe=se.section||se.topic;z[qe]=(z[qe]||0)+1}});const Q=y?Math.round(x/y*100):0;let A=o("worksheets.revisionFair");Q>=90?A=o("worksheets.revisionExcellent"):Q>=70?A=o("worksheets.revisionGood"):Q<50&&(A=o("worksheets.revisionLow"));const de=Object.entries(z).sort((se,pe)=>pe[1]-se[1]).map(([se,pe])=>`<li>${xe(se)} (${pe})</li>`).join("");H.innerHTML=`
      <h4>${o("worksheets.sessionSummary")}</h4>
      <p>${o("worksheets.score")}: <strong>${x}/${y}</strong> (${Q}%)</p>
      <p>${o("worksheets.firstTry")}: <strong>${G}/${y}</strong></p>
      <p>${o("worksheets.revisionSuggestions")}: ${A}</p>
      ${de?`<p>${o("worksheets.weakSections")}:</p><ul>${de}</ul>`:""}`,H.hidden=!1}function u(y){const x=U(),G=n.items.map((z,Q)=>{const A=z[x]||z.en,de=A.choices.map((pe,be)=>`${We[be]}. ${pe}`).join("<br/>"),se=y?`<p><b>${o("worksheets.answer")}:</b> ${We[A.a]}<br/><i>${A.exp}</i></p>`:"";return`<div style="page-break-inside:avoid;margin-bottom:16px"><b>Q${Q+1}.</b> ${A.q}<br/>${de}${se}</div>`}).join("");return`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word">
...
${G}</body></html>`}function c(y){const x=u(y),G=new Blob(["\uFEFF",x],{type:"application/msword"}),z=document.createElement("a");z.href=URL.createObjectURL(G),z.download=y?"worksheet-answers.doc":"worksheet.doc",z.click(),URL.revokeObjectURL(z.href)}a.addEventListener("click",()=>{const y=Number(t.querySelector("[data-ws-count]").value),x=[...t.querySelectorAll("[data-ws-topic]")].filter(Q=>Q.checked).map(Q=>Q.getAttribute("data-ws-topic")),G=Tt(r,x,d.topicFilter),z=Qe(G).slice(0,Math.min(y,G.length||1));n.items=z.length?z:Qe(r).slice(0,Math.min(y,r.length)),V(),n.tab="practice",n.dateStr="",q.hidden=!1,E.hidden=!0,$==null||$.querySelectorAll("[data-ws-tab]").forEach(Q=>{Q.classList.toggle("active",Q.getAttribute("data-ws-tab")==="practice")}),O&&(O.hidden=!1),F&&(F.hidden=!1),B&&(B.hidden=!0),X.textContent="",P==null||P.classList.add("practice-mode"),ne()}),$==null||$.addEventListener("click",y=>{const x=y.target.closest("[data-ws-tab]");!x||!n.items.length||ee(x.getAttribute("data-ws-tab"))}),ae==null||ae.addEventListener("click",()=>{n.dateStr?(n.dateStr="",X.textContent=""):(n.dateStr=Ct(),X.textContent=`${o("worksheets.date")}: ${n.dateStr}`),B&&(B.hidden=!n.dateStr,B.textContent=n.dateStr?`${o("worksheets.date")}: ${n.dateStr}`:"")}),(v=t.querySelector("[data-ws-word-p]"))==null||v.addEventListener("click",()=>c(!1)),(R=t.querySelector("[data-ws-word-a]"))==null||R.addEventListener("click",()=>c(!0)),(_=t.querySelector("[data-ws-print-p]"))==null||_.addEventListener("click",()=>{ee("practice"),P==null||P.classList.add("ws-print-blank");const y=()=>P==null?void 0:P.classList.remove("ws-print-blank");window.addEventListener("afterprint",y,{once:!0}),window.print()}),(I=t.querySelector("[data-ws-print-a]"))==null||I.addEventListener("click",()=>{ee("answer"),window.print()})}const Mt=["rotatingMirror","refractionTir","lens","rgbMixer","em"],Lt={rotatingMirror:t=>vt(t),refractionTir:t=>yt(t),lens:(t,r)=>wt(t,{defaultKind:r}),rgbMixer:t=>qt(t),em:t=>xt(t)};function _t(t){return l({rotatingMirror:"tools.rotatingMirror.title",refractionTir:"tools.refractionTir.title",lens:"tools.lens.title",rgbMixer:"tools.rgbMixer.title",em:"tools.em.title"}[t]||t)}function Ae(){return ce()==="zh-Hant"?"zhHant":"en"}async function ot(t,r){const o=`./${t}/${r}`;try{return(await fetch(o,{method:"HEAD"})).ok}catch{return!1}}async function Rt(t){return ot("notes",t)}function zt(t){let r="topics",o="rotatingMirror",i="convex",d=0,n="all",a=!1,q=null,E={main:null};function te(){E.main&&(r==="topics"?E.main.innerHTML=$():r==="notes"?E.main.innerHTML=Z():r==="tools"?E.main.innerHTML=H():r==="worksheets"?E.main.innerHTML=it(l):r==="flashcards"?E.main.innerHTML=ae():r==="summary"&&(E.main.innerHTML=K()),r==="notes"&&L(),r==="tools"&&F(),r==="worksheets"&&rt(t,tt,l,Ae),r==="flashcards"&&ee(),r==="summary"&&ne())}function P(){q==null||q.destroy(),q=nt(t,{subtitleKey:"strand.optics.subtitle",activeSection:r,onSection:u=>{r=u,q.updateSection(r),te()},onLang:()=>P()}),E.main=q.main,q.updateSection(r),te()}function $(){const u=[["rotatingMirror","topic.reflection"],["refraction","topic.refractionSnell"],["tir","topic.tir"],["convex","topic.convex"],["concave","topic.concave"],["em","topic.em"]];return`
      <section class="panel panel--topic-hub">
        <h2>${l("topics.title")}</h2>
        <p class="lead">${l("topics.intro")}</p>
        <div class="grid cols-2 topic-hub-grid">
          ${u.map(([c,v])=>{const R=c==="convex"||c==="concave"?"lens":c==="refraction"||c==="tir"?"refractionTir":c==="em"?"em":c,_=c==="convex"?"convex":c==="concave"?"concave":"";return`
            <div class="card">
              <h3>${l(v)}</h3>
              <button class="btn primary" type="button" data-go-tool="${R}"${_?` data-lens-kind="${_}"`:""}>${l("topic.openTool")}</button>
            </div>`}).join("")}
        </div>
      </section>`}function O(u){const c=u.target.closest("[data-go-tool]");if(!c)return;r="tools",o=c.getAttribute("data-go-tool");const v=c.getAttribute("data-lens-kind");(v==="convex"||v==="concave")&&(i=v),q.updateSection(r),te()}function Z(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("notes.title")}</h2>
        <p class="lead">${l("notes.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-notes-grid>
          ${u.map(c=>{const v=l(`notes.card.${c.key}`);return`
            <div class="card" data-note-card="${c.key}">
              <h3>${v}</h3>
              <div data-note-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function L(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convexLens",fileEn:"convex-lens-en.pdf",fileZh:"convex-lens-zhHant.pdf"},{key:"concaveLens",fileEn:"concave-lens-en.pdf",fileZh:"concave-lens-zhHant.pdf"},{key:"em",fileEn:"emwaves-en.pdf",fileZh:"emwaves-zhHant.pdf"}],c=Ae();for(const v of u){const R=t.querySelector(`[data-note-card="${v.key}"]`);if(!R)continue;const _=R.querySelector("[data-note-body]"),I=c==="zhHant"?v.fileZh:v.fileEn,y=await Rt(I),x=`./notes/${I}`;y?_.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${v.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:_.innerHTML=`<p class="lead">${l("notes.missing")}</p>
      ...
      <section class="panel panel--tools">
        ...
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Mt.map(u=>`<button type="button" data-tool="${u}" class="${o===u?"active":""}">${_t(u)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function F(){const u=t.querySelector("[data-tool-list]"),c=t.querySelector("[data-tool-stage]");!u||!c||(u.querySelectorAll("button").forEach(v=>{v.addEventListener("click",()=>{o=v.getAttribute("data-tool"),u.querySelectorAll("button").forEach(R=>R.classList.toggle("active",R.getAttribute("data-tool")===o)),B(c)})}),B(c))}function B(u){u.innerHTML="";const c=Lt[o];if(!c)return;const v=o==="lens"?c(l,i):c(l);u.appendChild(v)}function ae(){return`
      <section class="panel">
      ...
      </section>`}function X(u){return!!(u!=null&&u.front)}function U(u){return`./${String(u).replace(/^\.\//,"")}`}function V(){return at.slice()}function Y(){const u=V(),c=n==="rotatingMirror"?"reflection":n;if(c==="all"){const R=u.filter(_=>_.topic!=="convex");return[...Ge,...je,...R]}if(c==="reflection")return Ge.slice();if(c==="convex")return je.slice();if(c==="concave"){const R=u.filter(_=>_.topic==="concave");return R.length?R:u}if(c==="refractionTir"){const R=u.filter(_=>_.topic==="refraction"||_.topic==="tir");return R.length?R:u}const v=u.filter(R=>R.topic===c);return v.length?v:u}function J(){const u=Y(),c=t.querySelector("[data-flash-progress]");if(!u.length){d=0;const G=t.querySelector("[data-flash-front]"),z=t.querySelector("[data-flip-card]");G&&(G.textContent=""),z&&z.classList.remove("flashcard-surface--image"),c&&(c.hidden=!0,c.textContent="");return}d=Math.max(0,Math.min(d,u.length-1));const v=u[d],R=t.querySelector("[data-flash-front]"),_=t.querySelector("[data-flip-card]"),I=t.querySelector("[data-flash-label]");if(!R||!_)return;if(c&&(c.hidden=!1,c.textContent=l("flashcards.progress").replace("{current}",String(d+1)).replace("{total}",String(u.length))),X(v)){const G=v.back&&v.back!==v.front;_.classList.add("flashcard-surface--image"),I&&(G?(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")):I.hidden=!0);const z=a&&v.back?v.back:v.front,Q=v.alt||v.title||"";R.innerHTML=`<img src="${U(z)}" alt="${Q.replace(/"/g,"&quot;")}" loading="lazy" />`;return}_.classList.remove("flashcard-surface--image");const y=Ae(),x=v[y]||v.en;I&&(I.hidden=!1,I.textContent=l(a?"flashcards.answer":"flashcards.question")),R.textContent=a?x.a:x.q}function ee(){n==="rotatingMirror"&&(n="reflection");const u=t.querySelector("[data-flash-deck]");u.value=n,u.addEventListener("change",()=>{n=u.value,d=0,a=!1,J()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{a=!a,J()}),t.querySelector("[data-flash-flip]").addEventListener("click",c=>{c.stopPropagation(),a=!a,J()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const c=Y();d=(d-1+c.length)%c.length,a=!1,J()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const c=Y();d=(d+1)%c.length,a=!1,J()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const c=Y();d=Math.floor(Math.random()*c.length),a=!1,J()}),J()}function K(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}];return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${u.map(c=>{const v=l(`summary.item.${c.key}`);return`
            <div class="card" data-summary-card="${c.key}">
              <h3>${v}</h3>
              <div data-summary-body></div>
            </div>`}).join("")}
        </div>
      </section>`}async function ne(){const u=[{key:"reflection",fileEn:"reflection-en.pdf",fileZh:"reflection-zhHant.pdf"},{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"},{key:"convex",type:"image",file:"convex.webp"},{key:"concave",fileEn:"concave-en.pdf",fileZh:"concave-zhHant.pdf"},{key:"em",fileEn:"em-en.pdf",fileZh:"em-zhHant.pdf"}],c=Ae();for(const v of u){const R=t.querySelector(`[data-summary-card="${v.key}"]`);if(!R)continue;const _=R.querySelector("[data-summary-body]"),I=c==="zhHant"?v.fileZh:v.fileEn,y=await ot("summary-pdfs",I),x=`./summary-pdfs/${I}`;y?_.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${v.key}`)}" src="${x}"></iframe>
          <p style="margin-top:8px"><a href="${x}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:_.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const b=()=>P(),m=u=>O(u);return window.addEventListener("s3phy:lang",b),t.addEventListener("click",m),P(),()=>{window.removeEventListener("s3phy:lang",b),t.removeEventListener("click",m),q==null||q.destroy()}}const Ne="s3phy-thermometer-lab-css",Ht=`
.tl-wrap {
  --tl-bg: #09090b;
  --tl-panel: #151518;
  --tl-border: #27272a;
...
`;function $t(){if(document.getElementById(Ne))return;const t=document.createElement("style");t.id=Ne,t.textContent=Ht,document.head.appendChild(t)}function Pe(t,r={}){$t();const o=r.type||"liquid";let i=t("tools.thermometerLab.title"),d=t("tools.thermometerLab.subtitle");r.type==="liquid"?(i=t("tools.thermometerLab.liquid.title"),d=t("tools.thermometerLab.liquid.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="resistance"?(i=t("tools.thermometerLab.resistance.title"),d=t("tools.thermometerLab.resistance.subtitle")||t("tools.thermometerLab.subtitle")):r.type==="thermistor"&&(i=t("tools.thermometerLab.thermistor.title"),d=t("tools.thermometerLab.thermistor.subtitle")||t("tools.thermometerLab.subtitle"));const n=document.createElement("div");n.className="tl-wrap",n.innerHTML=`
  ...
  `;const a={liquidType:"mercury",thermometerType:o,bulbVolume:200,wallThickness:.5,capillaryBore:.3,liquidL0:3,liquidL100:13,resistanceR0:5,resistanceR100:6.2,thermistorR25:10,thermistorBeta:3500,bathTemp:25,thermometerTemp:25,bubbles:[],iceCubes:[],heatWaves:[],steamParticles:[],currentLength:5.5,currentResistance:5.3,currentThermistorR:10,lastTimestamp:0,showLabels:!0},q=460,E=340,te=80,P=800,$=560;function O(){const e={left:110,top:48,right:30,bottom:65};return{gx:e.left,gy:e.top,gw:P-e.left-e.right,gh:$-e.top-e.bottom,tickFont:`bold ${Math.round(P*.024)}px Arial`,axisFont:`bold ${Math.round(P*.026)}px Arial`,dotR:8,yLabelX:e.left-75,xLabelY:$-e.bottom+32}}function Z(){let s=100;const p=Math.max(a.bathTemp,a.thermometerTemp,100);p>120&&(s=150),p>145&&(s=200);const h=s<=100?20:25;return{minT:0,maxT:s,tickStep:h}}function L(e,s,p,h,f){return h+(e-s)/(p-s)*f}function H(e,s,p,h,f){return h+f-(e-s)/(p-s)*f}function F(e,s,p,h,f,T){const{gx:g,gy:w,gw:k,gh:C,tickFont:M,axisFont:W,yLabelX:N,xLabelY:S}=s;e.strokeStyle="#1e1e24",e.lineWidth=1;for(const D of T){const j=H(D.value,D.min,D.max,w,C);e.beginPath(),e.moveTo(g,j),e.lineTo(g+k,j),e.stroke()}for(let D=p;D<=h+.01;D+=f){const j=L(D,p,h,g,k);e.beginPath(),e.moveTo(j,w),e.lineTo(j,w+C),e.stroke()}e.strokeStyle="#4b5563",e.lineWidth=2.5,e.beginPath(),e.moveTo(g,w),e.lineTo(g,w+C),e.lineTo(g+k,w+C),e.stroke(),e.fillStyle="#e4e4e7",e.font=M,e.textAlign="right",e.textBaseline="middle";for(const D of T){const j=H(D.value,D.min,D.max,w,C);e.fillText(D.label,g-15,j)}e.textAlign="center",e.textBaseline="top";for(let D=p;D<=h+.01;D+=f){const j=L(D,p,h,g,k);e.fillText(`${Math.round(D)}`,j,w+C+10)}return{gx:g,gy:w,gw:k,gh:C,axisFont:W,yLabelX:N,xLabelY:S}}function B(e,s){const p=s-e,h=p<=8?1:p<=14?2:5,f=[],T=Math.ceil(e/h)*h;for(let g=T;g<=s+.001;g+=h)f.push({value:g,label:g%1===0?`${g.toFixed(0)}`:`${g.toFixed(1)}`,min:e,max:s});return f}function ae(){const{maxT:e}=Z(),s=X(0),p=X(e),h=p-s,f=Math.max(1,h*.1),T=Math.max(0,Math.round((s-f)*10)/10),g=Math.round((p+f)*10)/10;return{minL:T,maxL:g}}function X(e){return a.liquidL0+(a.liquidL100-a.liquidL0)/100*e}function U(){const{maxT:e}=Z(),s=V(0),p=V(e),h=p-s,f=Math.max(.2,h*.1),T=Math.max(0,s-f),g=p+f,w=h<=2?.5:h<=4?1:2,k=[],C=Math.ceil(T/w)*w;for(let M=C;M<=g+.001;M+=w)k.push({value:M,label:M.toFixed(1),min:T,max:g});return{minR:T,maxR:g,ticks:k}}function V(e){return a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*e}function Y(e){const{maxT:s}=e;let p=a.thermistorR25;for(let g=0;g<=s;g+=5){const w=g+273.15,k=a.thermistorR25*Math.exp(a.thermistorBeta*(1/w-1/298.15));p=Math.max(p,k)}p=Math.ceil(p*1.08*10)/10;const h=0,f=p<=12?2:4,T=[];for(let g=0;g<=p+.001;g+=f)T.push({value:g,label:g.toFixed(0),min:h,max:p});return{minR:h,maxR:p,ticks:T}}const J=n.querySelector("#tl-thermometerCanvas"),ee=J.getContext("2d"),K=n.querySelector("#tl-graphCanvas"),ne=K.getContext("2d"),b=window.devicePixelRatio||1;J.width=q*b,J.height=E*b,ee.scale(b,b),K.width=P*b,K.height=$*b,ne.scale(b,b);function m(){a.iceCubes=[];for(let e=0;e<5;e++)a.iceCubes.push({x:60+Math.random()*120,y:200+Math.random()*15,size:12+Math.random()*8,angle:Math.random()*Math.PI,speedX:(Math.random()-.5)*.15,speedY:(Math.random()-.5)*.15});a.bubbles=[];for(let e=0;e<20;e++)a.bubbles.push({x:60+Math.random()*120,y:190+Math.random()*70,r:1+Math.random()*3.5,speedY:.8+Math.random()*1.5,phase:Math.random()*Math.PI*2,wobbleSpeed:.08+Math.random()*.08});a.heatWaves=[];for(let e=0;e<8;e++)a.heatWaves.push({x:65+Math.random()*110,y:190+Math.random()*60,length:15+Math.random()*15,speedY:.5+Math.random()*.6,opacity:.15+Math.random()*.25});a.steamParticles=[];for(let e=0;e<12;e++)a.steamParticles.push({x:60+Math.random()*120,y:175+Math.random()*10,r:2+Math.random()*4,vx:(Math.random()-.5)*.3,vy:-.4-Math.random()*.6,alpha:.2+Math.random()*.4})}const u=200,c=11;function v(){const e=Math.pow(a.bulbVolume/u,.3333333333333333);return c*e}function R(){if(a.thermometerType==="resistance"||a.thermometerType==="thermistor")return .35;const e=a.liquidType==="mercury"?1:8,s=.2+a.wallThickness*1.5,p=.4+a.bulbVolume*.003,h=1.35-a.capillaryBore*.45;return Math.max(.1,s*p*h*e*.15)}function _(e){a.bathTemp<=8&&a.iceCubes.forEach(s=>{s.x+=s.speedX,s.y+=s.speedY,(s.x<65||s.x>175)&&(s.speedX*=-1),(s.y<195||s.y>210)&&(s.speedY*=-1)}),a.bathTemp>35&&a.heatWaves.forEach(s=>{s.y-=s.speedY*(1+a.bathTemp/100),s.y<185&&(s.y=265,s.x=65+Math.random()*110)}),a.bathTemp>=80&&a.bubbles.forEach(s=>{s.y-=s.speedY*(1+(a.bathTemp-80)/40),s.phase+=s.wobbleSpeed,s.x+=Math.sin(s.phase)*.3,s.y<185&&(s.y=260+Math.random()*10,s.x=60+Math.random()*120)}),a.bathTemp>=95&&a.steamParticles.forEach(s=>{s.x+=s.vx,s.y+=s.vy,s.alpha-=.005,(s.alpha<=0||s.y<130)&&(s.x=60+Math.random()*120,s.y=175+Math.random()*5,s.alpha=.2+Math.random()*.4)})}function I(e){let g=59,w=130,k=246;if(a.bathTemp<25){const S=a.bathTemp/25;g=Math.round(180-S*121),w=Math.round(210-S*80),k=Math.round(250-S*4)}else{const S=Math.min(1,(a.bathTemp-25)/125);g=Math.round(59+S*180),w=Math.round(130-S*100),k=Math.round(246-S*190)}if(a.bathTemp>40){const S=Math.min(1,(a.bathTemp-40)/100),D=Date.now()*.02;e.fillStyle=`rgba(239, 68, 68, ${S*.25})`,e.beginPath(),e.roundRect(45,284,150,10,4),e.fill(),e.fillStyle="rgba(249, 115, 22, 0.85)",e.beginPath(),e.moveTo(55+130/2-25,284);for(let j=-25;j<=25;j+=6){const ie=S*(12+Math.sin(j*.4+D)*5);e.lineTo(55+130/2+j,284-ie)}e.lineTo(55+130/2+25,284),e.closePath(),e.fill()}e.strokeStyle="#4b5563",e.lineWidth=2,e.fillStyle="#121214",e.beginPath(),e.roundRect(55,180,130,100,[0,0,10,10]),e.fill();const C=e.createLinearGradient(55,190,55,280);C.addColorStop(0,`rgba(${g}, ${w}, ${k}, 0.25)`),C.addColorStop(1,`rgba(${g}, ${w}, ${k}, 0.55)`),e.fillStyle=C,e.beginPath(),e.moveTo(55,190);const M=a.bathTemp>=80?2:.5,W=a.bathTemp>=80?.09:.03,N=Date.now()*W;for(let S=55;S<=185;S+=5){const D=190+Math.sin(S*.15+N)*M;e.lineTo(S,D)}e.lineTo(185,280),e.lineTo(55,280),e.closePath(),e.fill(),a.bathTemp>35&&(e.strokeStyle=`rgba(239, 68, 68, ${Math.min(.5,(a.bathTemp-35)/120)})`,e.lineWidth=1.2,a.heatWaves.forEach(S=>{e.beginPath(),e.moveTo(S.x,S.y),e.quadraticCurveTo(S.x+Math.sin(S.y*.06)*5,S.y-S.length/2,S.x,S.y-S.length),e.stroke()})),a.bathTemp<=8&&(e.fillStyle="rgba(224, 242, 254, 0.55)",e.strokeStyle="rgba(186, 230, 253, 0.8)",e.lineWidth=1,a.iceCubes.forEach(S=>{e.save(),e.translate(S.x,S.y),e.rotate(S.angle),e.beginPath(),e.roundRect(-S.size/2,-S.size/2,S.size,S.size,3),e.fill(),e.stroke(),e.restore()})),a.bathTemp>=80&&(e.fillStyle="rgba(255, 255, 255, 0.4)",e.strokeStyle="rgba(255, 255, 255, 0.65)",e.lineWidth=.6,a.bubbles.forEach(S=>{e.beginPath(),e.arc(S.x,S.y,S.r,0,Math.PI*2),e.fill(),e.stroke()})),a.bathTemp>=95&&a.steamParticles.forEach(S=>{e.fillStyle=`rgba(255, 255, 255, ${S.alpha})`,e.beginPath(),e.arc(S.x,S.y,S.r,0,Math.PI*2),e.fill()}),e.strokeStyle="#9ca3af",e.lineWidth=3.5,e.beginPath(),e.moveTo(54,180),e.lineTo(54,272),e.arcTo(54,281,65,281,8),e.lineTo(175,281),e.arcTo(186,281,186,272,8),e.lineTo(186,180),e.stroke(),e.strokeStyle="rgba(255, 255, 255, 0.4)",e.lineWidth=1.5,e.beginPath(),e.moveTo(59,190),e.lineTo(59,270),e.stroke()}function y(e,s,p,h,f,T,g="left"){if(!a.showLabels)return;e.strokeStyle="rgba(6, 182, 212, 0.7)",e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(s,p),e.lineTo(h,f),e.stroke(),e.setLineDash([]),e.fillStyle="#06b6d4",e.beginPath(),e.arc(s,p,3,0,Math.PI*2),e.fill(),e.font="bold 9px system-ui, sans-serif";const k=e.measureText(T).width+10,C=16,M=g==="left"?h:h-k,W=f-C/2;e.fillStyle="rgba(21, 21, 24, 0.9)",e.strokeStyle="#06b6d4",e.lineWidth=1,e.beginPath(),e.roundRect(M,W,k,C,4),e.fill(),e.stroke(),e.fillStyle="#f4f4f5",e.textAlign="center",e.textBaseline="middle",e.fillText(T,M+k/2,W+C/2+.5)}function x(e){const h=v(),f=250+Math.max(0,h-c)*.35,T=f-h-1,g=10+a.wallThickness*8,w=120-g/2,k=120+g/2,C=e.createLinearGradient(w,20,k,20);C.addColorStop(0,"rgba(209, 213, 219, 0.85)"),C.addColorStop(.2,"rgba(255, 255, 255, 0.95)"),C.addColorStop(.5,"rgba(243, 244, 246, 0.15)"),C.addColorStop(.8,"rgba(255, 255, 255, 0.95)"),C.addColorStop(1,"rgba(156, 163, 175, 0.9)"),e.fillStyle=C,e.strokeStyle="rgba(156, 163, 175, 0.8)",e.lineWidth=1,e.beginPath(),e.moveTo(w,T),e.lineTo(w,25),e.arcTo(w,20,w+5,20,5),e.arcTo(k,20,k,25,5),e.lineTo(k,T),e.closePath(),e.fill(),e.stroke();const M=e.createRadialGradient(120-h*.2,f-h*.2,h*.1,120,f,h);M.addColorStop(0,"rgba(255, 255, 255, 0.8)"),M.addColorStop(1,"rgba(156, 163, 175, 0.35)"),e.fillStyle=M,e.strokeStyle="#6b7280",e.lineWidth=.8+a.wallThickness*.6,e.beginPath(),e.arc(120,f,h+.5+a.wallThickness*.5,0,Math.PI*2),e.fill(),e.stroke();const W=Math.min(g*.72,.8+a.capillaryBore*4.5);e.fillStyle="#0a0a0c",e.fillRect(120-W/2,28,W,T-20-8);const N=a.liquidType==="mercury",S=N?"#a1a1aa":"#ef4444",D=N?"#f4f4f5":"#fee2e2",j=210,ie=220,ge=(j-40)/ie,fe=j-Math.min(ie,a.thermometerTemp)*ge;e.fillStyle=S,e.fillRect(120-W/2,fe,W,T-fe),e.beginPath(),e.ellipse(120,fe,W/2,1.5,0,0,Math.PI*2),e.fill(),e.fillStyle=D,e.fillRect(120-W/6,fe,W/3,T-fe);const oe=h*.9,re=e.createRadialGradient(120-oe*.2,f-oe*.2,oe*.1,120,f,oe);N?(re.addColorStop(0,"#f4f4f5"),re.addColorStop(.3,"#d4d4d8"),re.addColorStop(.8,"#71717a"),re.addColorStop(1,"#3f3f46")):(re.addColorStop(0,"#fee2e2"),re.addColorStop(.2,"#fca5a5"),re.addColorStop(.7,"#ef4444"),re.addColorStop(1,"#991b1b")),e.fillStyle=re,e.beginPath(),e.arc(120,f,oe,0,Math.PI*2),e.fill(),e.strokeStyle="rgba(161, 161, 170, 0.6)",e.lineWidth=.5,e.font="6.5px Arial",e.fillStyle="#a1a1aa",e.textAlign="right",e.textBaseline="middle";for(let le=0;le<=200;le+=50){const he=j-le*ge;e.beginPath(),e.moveTo(w,he),e.lineTo(w+4,he),e.stroke(),e.fillText(`${le}°C`,w-22,he+2.5)}a.showLabels&&(y(e,w+1,80,10,50,t("tools.thermometerLab.labels.thinWall"),"left"),y(e,120,fe,230,fe-15,t("tools.thermometerLab.labels.meniscus"),"left"),y(e,120-W/2,130,10,130,t("tools.thermometerLab.labels.narrowBore"),"left"),y(e,120,f,230,f+15,t("tools.thermometerLab.labels.largeBulb"),"left"))}function G(e){const g=e.createLinearGradient(115,20,125,20);g.addColorStop(0,"#71717a"),g.addColorStop(.3,"#f4f4f5"),g.addColorStop(.7,"#d4d4d8"),g.addColorStop(1,"#3f3f46"),e.fillStyle=g,e.strokeStyle="#4b5563",e.lineWidth=1,e.beginPath(),e.roundRect(115,20,10,225,[0,0,4,4]),e.fill(),e.stroke(),e.fillStyle="rgba(21, 21, 24, 0.8)",e.fillRect(117,200,6,40),e.strokeStyle="#e2e8f0",e.lineWidth=1.2,e.beginPath();let w=205;e.moveTo(118,w);for(let N=0;N<8;N++)w+=4,e.lineTo(122,w),w+=4,e.lineTo(118,w);e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const k=245,C=40,M=135,W=90;e.fillStyle="#18181b",e.strokeStyle="#6366f1",e.lineWidth=2.5,e.beginPath(),e.roundRect(k,C,M,W,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(k+10,C+12,M-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#10b981",e.textAlign="right",e.fillText(a.currentResistance.toFixed(2)+" Ω",k+M-16,C+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("PLATINUM RTD METER",k+14,C+21),a.showLabels&&(y(e,116,100,10,70,t("tools.thermometerLab.labels.metalSheath"),"left"),y(e,120,225,230,205,t("tools.thermometerLab.labels.platinumCoil"),"left"))}function z(e){e.strokeStyle="#111827",e.lineWidth=1.2,e.beginPath(),e.moveTo(118,20),e.lineTo(118,245),e.stroke(),e.beginPath(),e.moveTo(122,20),e.lineTo(122,245),e.stroke();const f=20,T=225,g=12,w=120-g/2,k=e.createLinearGradient(w,f,w+g,f);k.addColorStop(0,"rgba(229, 231, 235, 0.4)"),k.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),k.addColorStop(.7,"rgba(243, 244, 246, 0.5)"),k.addColorStop(1,"rgba(209, 213, 219, 0.6)"),e.fillStyle=k,e.strokeStyle="rgba(156, 163, 175, 0.6)",e.lineWidth=.8,e.beginPath(),e.roundRect(w,f,g,T-f,[0,0,3,3]),e.fill(),e.stroke();const C=7,M=e.createRadialGradient(120-C*.2,245-C*.2,C*.1,120,245,C);M.addColorStop(0,"#6b7280"),M.addColorStop(.7,"#1f2937"),M.addColorStop(1,"#09090b"),e.fillStyle=M,e.strokeStyle="#030712",e.lineWidth=1.2,e.beginPath(),e.arc(120,245,C,0,Math.PI*2),e.fill(),e.stroke(),e.lineWidth=1.5,e.strokeStyle="#ef4444",e.beginPath(),e.moveTo(118,20),e.bezierCurveTo(110,5,200,30,245,60),e.stroke(),e.strokeStyle="#111827",e.beginPath(),e.moveTo(122,20),e.bezierCurveTo(130,8,210,45,245,75),e.stroke();const W=245,N=40,S=135,D=90;e.fillStyle="#18181b",e.strokeStyle="#10b981",e.lineWidth=2.5,e.beginPath(),e.roundRect(W,N,S,D,10),e.fill(),e.stroke(),e.fillStyle="#022c22",e.beginPath(),e.roundRect(W+10,N+12,S-20,34,4),e.fill(),e.font='bold 14px "Courier New"',e.fillStyle="#34d399",e.textAlign="right",e.fillText(a.currentThermistorR.toFixed(2)+" kΩ",W+S-16,N+34),e.font="6px Arial",e.fillStyle="#a7f3d0",e.textAlign="left",e.fillText("NTC THERMISTOR METER",W+14,N+21),a.showLabels&&(y(e,118,120,10,90,t("tools.thermometerLab.labels.leads"),"left"),y(e,120,245,230,225,t("tools.thermometerLab.labels.semiconductorBead"),"left"))}function Q(e,s,p,h,f,T,g,w,k){const{gx:C,gy:M,gw:W,gh:N}=s;e.strokeStyle="rgba(255, 255, 255, 0.2)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(p,h),e.lineTo(p,M+N),e.stroke(),e.beginPath(),e.moveTo(p,h),e.lineTo(C,h),e.stroke(),e.setLineDash([]),e.font="bold 11px Arial",e.textAlign="center",e.textBaseline="top";const S=`${f.toFixed(1)}${g}`,D=e.measureText(S).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(p-D/2,M+N+2,D,15,3),e.fill(),e.fillStyle="#000",e.fillText(S,p,M+N+4),e.textAlign="right",e.textBaseline="middle";const j=`${T.toFixed(2)} ${w}`,ie=e.measureText(j).width+10;e.fillStyle=k,e.beginPath(),e.roundRect(C-ie-2,h-7,ie,15,3),e.fill(),e.fillStyle="#000",e.fillText(j,C-7,h)}function A(e){const s=O(),{minL:p,maxL:h}=ae(),{minT:f,maxT:T,tickStep:g}=Z(),w=B(p,h),k=F(e,s,f,T,g,w),{gx:C,gy:M,gw:W,gh:N,axisFont:S,yLabelX:D,xLabelY:j,dotR:ie}={...s,...k};e.save(),e.translate(D,M+N/2),e.rotate(-Math.PI/2),e.font=S,e.fillStyle="#e4e4e7",e.fillText("Length of liquid column / cm",0,0),e.restore(),e.font=S,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",C+W/2,j);const we=T,ge=L(0,f,T,C,W),fe=H(X(0),p,h,M,N),oe=L(we,f,T,C,W),re=H(X(we),p,h,M,N);e.strokeStyle="#ef4444",e.lineWidth=3,e.beginPath(),e.moveTo(ge,fe),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,he=a.currentLength;if(le>=f&&le<=T){const ve=L(le,f,T,C,W),Ce=H(he,p,h,M,N);Q(e,s,ve,Ce,le,he,"°C","cm","#ef4444"),e.shadowColor="#ef4444",e.shadowBlur=10,e.fillStyle="#ef4444",e.beginPath(),e.arc(ve,Ce,ie,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function de(e){const s=O(),{minR:p,maxR:h,ticks:f}=U(),T=Z(),g=F(e,s,T.minT,T.maxT,T.tickStep,f),{gx:w,gy:k,gw:C,gh:M,axisFont:W,yLabelX:N,xLabelY:S,dotR:D}={...s,...g};e.save(),e.translate(N,k+M/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of platinum / Ω",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,S);const{minT:j,maxT:ie}=T,we=ie,ge=L(0,j,ie,w,C),fe=H(V(0),p,h,k,M),oe=L(we,j,ie,w,C),re=H(V(we),p,h,k,M);e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(ge,fe),e.lineTo(oe,re),e.stroke();const le=a.thermometerTemp,he=a.currentResistance;if(le>=j&&le<=ie){const ve=L(le,j,ie,w,C),Ce=H(he,p,h,k,M);Q(e,s,ve,Ce,le,he,"°C","Ω","#6366f1"),e.shadowColor="#6366f1",e.shadowBlur=10,e.fillStyle="#6366f1",e.beginPath(),e.arc(ve,Ce,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function se(e){const s=O(),p=Z(),{minR:h,maxR:f,ticks:T}=Y(p),g=F(e,s,p.minT,p.maxT,p.tickStep,T),{gx:w,gy:k,gw:C,gh:M,axisFont:W,yLabelX:N,xLabelY:S,dotR:D}={...s,...g},{minT:j,maxT:ie}=p;e.save(),e.translate(N,k+M/2),e.rotate(-Math.PI/2),e.font=W,e.fillStyle="#e4e4e7",e.fillText("Resistance of thermistor / kΩ",0,0),e.restore(),e.font=W,e.fillStyle="#e4e4e7",e.textAlign="center",e.fillText("temperature / °C",w+C/2,S),e.strokeStyle="#10b981",e.lineWidth=3,e.beginPath();let we=!1;for(let oe=j;oe<=ie;oe+=1){const re=oe+273.15,le=a.thermistorR25*Math.exp(a.thermistorBeta*(1/re-1/298.15)),he=L(oe,j,ie,w,C),ve=H(Math.min(f,le),h,f,k,M);ve>=k&&ve<=k+M&&(we?e.lineTo(he,ve):(e.moveTo(he,ve),we=!0))}e.stroke();const ge=a.thermometerTemp,fe=a.currentThermistorR;if(ge>=j&&ge<=ie){const oe=L(ge,j,ie,w,C),re=H(Math.min(f,fe),h,f,k,M);Q(e,s,oe,re,ge,fe,"°C","kΩ","#10b981"),e.shadowColor="#10b981",e.shadowBlur=10,e.fillStyle="#10b981",e.beginPath(),e.arc(oe,re,D,0,Math.PI*2),e.fill(),e.shadowBlur=0}}function pe(){ee.clearRect(0,0,q,E),ne.clearRect(0,0,P,$),ee.save(),ee.translate(te,0),I(ee),a.thermometerType==="liquid"?x(ee):a.thermometerType==="resistance"?G(ee):z(ee),ee.restore(),a.thermometerType==="liquid"?A(ne):a.thermometerType==="resistance"?de(ne):se(ne)}function be(){const e=n.querySelector("#tl-svg-formula-liquid");e&&(e.innerHTML=`
      ...
      `);const s=n.querySelector("#tl-svg-formula-liquid-sub");if(s){const g=a.liquidL100-a.liquidL0,w=a.currentLength-a.liquidL0;s.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          ...
          <text x="160" y="94" fill="#a1a1aa" font-family="Cambria, Georgia, serif" font-size="11" text-anchor="middle">${g.toFixed(1)}</text>
      ...
      `);const h=n.querySelector("#tl-svg-formula-resistance-sub");if(h){const g=a.resistanceR100-a.resistanceR0,w=a.currentResistance-a.resistanceR0;h.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `);const T=n.querySelector("#tl-svg-formula-thermistor-sub");if(T){const g=a.thermometerTemp+273.15;T.innerHTML=`
        <svg height="45" width="280" style="background:transparent; overflow:visible;">
          <text x="10" y="26" fill="#fff" font-family="Cambria, Georgia, serif" font-size="15">
            T<tspan dy="3" font-size="10">K</tspan><tspan dy="-3" fill="#10b981" font-weight="bold"> = ${g.toFixed(2)} K</tspan>
      ...
      `}}function ke(){const e=n.querySelector("#tl-faulty-svg-container");if(!e)return;const{cf:s,cu:p,interval:h}=ze(),f=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,T=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,g=n.querySelector("#tl-pane-q10a").classList.contains("active"),w=g?(f-s)/h*100:T,k=g?f:T/100*h+s,M=(W=>130-W/100*80)(w);e.innerHTML=`
    ...
    `}function qe(e){n.querySelector("#tl-bath-temp-display").innerHTML=a.bathTemp.toFixed(1)+"°C",n.querySelector("#tl-val-bath-temp").innerHTML=a.bathTemp.toFixed(1)+" °C";const s=n.querySelector("#tl-bath-state");a.bathTemp<=0?s.textContent="Melting Ice Bath":a.bathTemp>=100?s.textContent="Boiling Water/Steam":a.bathTemp===150?s.textContent="Hot Cooking Oil":s.textContent="Liquid Water",n.querySelector("#tl-val-response-time").textContent=e.toFixed(2)+" s";const p=n.querySelector("#tl-alcohol-boiling-warning");a.thermometerType==="liquid"&&a.liquidType==="alcohol"&&a.bathTemp>=78?p.style.display="block":p.style.display="none",a.thermometerType==="liquid"?(n.querySelector("#tl-live-liquid-lt").textContent=a.currentLength.toFixed(2)+" cm",n.querySelector("#tl-live-liquid-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):a.thermometerType==="resistance"?(n.querySelector("#tl-live-resistance-rt").textContent=a.currentResistance.toFixed(2)+" Ω",n.querySelector("#tl-live-resistance-t-sub").textContent=a.thermometerTemp.toFixed(1)+"°C"):n.querySelector("#tl-live-thermistor-rt").textContent=a.currentThermistorR.toFixed(2)+" kΩ",be()}let Se=null;function Re(e){a.lastTimestamp||(a.lastTimestamp=e);const s=(e-a.lastTimestamp)/1e3;a.lastTimestamp=e;const p=Math.min(s,.1),h=R(),f=p/h*(a.bathTemp-a.thermometerTemp);a.thermometerTemp+=f,a.currentLength=a.liquidL0+(a.liquidL100-a.liquidL0)/100*a.thermometerTemp,a.currentResistance=a.resistanceR0+(a.resistanceR100-a.resistanceR0)/100*a.thermometerTemp;const T=a.thermometerTemp+273.15;a.currentThermistorR=a.thermistorR25*Math.exp(a.thermistorBeta*(1/T-1/298.15)),_(),pe(),qe(h),Se=requestAnimationFrame(Re)}function ze(){const e=parseFloat(n.querySelector("#tl-input-faulty-cf").value),s=parseFloat(n.querySelector("#tl-input-faulty-cu").value),p=Number.isFinite(e)?e:-1.5,h=Number.isFinite(s)?s:105,f=h-p;return{cf:p,cu:h,interval:f}}function He(e){const s=Math.round(e*100)/100;return s>=0?s.toFixed(1):`(${s.toFixed(1)})`}function me(){const{cf:e,cu:s,interval:p}=ze(),h=n.querySelector("#tl-val-faulty-interval"),f=n.querySelector("#tl-faulty-error-a"),T=n.querySelector("#tl-faulty-error-b"),g=Math.abs(p)<.01;h.textContent=p.toFixed(1)+" °C";const w=n.querySelector("#tl-svg-formula-faulty-a"),k=n.querySelector("#tl-svg-formula-faulty-b");if(g){f.hidden=!1,f.textContent="C_u must differ from C_f (interval cannot be zero).",T.hidden=!1,T.textContent=f.textContent,w&&(w.innerHTML=""),k&&(k.innerHTML="");return}f.hidden=!0,T.hidden=!0;const C=parseFloat(n.querySelector("#tl-input-q10a-cm").value)||0,M=parseFloat(n.querySelector("#tl-input-q10b-t").value)||0,W=(C-e)/p*100,N=M/100*p+e;w&&(w.innerHTML=`
      ...
      `)}function Te(){const e=a.thermometerTemp,s=a.liquidL100-a.liquidL0,p=a.liquidL0+s/100*e,h=n.querySelector("#tl-svg-formula-t-to-l");h&&(h.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      `)}function Oe(){const e=a.thermometerTemp,s=a.resistanceR100-a.resistanceR0,p=a.resistanceR0+s/100*e,h=n.querySelector("#tl-svg-formula-t-to-r");h&&(h.innerHTML=`
        <svg height="110" width="340" style="background:transparent; overflow:visible;">
          <!-- Step 1: Slope Equivalence -->
          <text x="10" y="22" fill="#fff" font-family="Cambria, Georgia, serif" font-size="13">Step 1: Equate Slopes</text>
          <line x1="10" y1="47" x2="100" y2="47" stroke="#fff" stroke-width="1.2" />
      ...
      <section class="panel">
        ...
        <div class="grid cols-2" data-notes-grid>
          ${Me.map(b=>`
            <div class="card" data-note-card="${b.id}">
              <h3>${l(`notes.card.${b.id}`)}</h3>
              <div data-note-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function L(){const b=Ee();for(const m of Me){const u=t.querySelector(`[data-note-card="${m.id}"]`);if(!u)continue;const c=u.querySelector("[data-note-body]"),v=b==="zhHant"?m.fileZh:m.fileEn,R=await Ye(v),_=`./notes/${v}`;R?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`notes.card.${m.id}`)}" src="${_}"></iframe>
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${l("notes.openPdf")}</a></p>`:c.innerHTML=`<p class="lead">${l("notes.missing")}</p>`}}function H(){return`
      <section class="panel panel--tools">
        <h2>${l("tools.title")}</h2>
        <p class="lead">${l("tools.pick")}</p>
        <div class="tools-layout">
          <div class="tool-list" data-tool-list>
            ${Ve.map(b=>`<button type="button" data-tool="${b}" class="${o===b?"active":""}">${Dt(b)}</button>`).join("")}
          </div>
          <div class="tool-stage" data-tool-stage></div>
        </div>
      </section>`}function F(){const b=t.querySelector("[data-tool-list]"),m=t.querySelector("[data-tool-stage]");!b||!m||(b.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{o=u.getAttribute("data-tool"),b.querySelectorAll("button").forEach(c=>c.classList.toggle("active",c.getAttribute("data-tool")===o)),B(m)})}),B(m))}function B(b){b.innerHTML="",E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup();const m=Pt[o];m&&(E=m(l),b.appendChild(E))}function ae(){return`
      <section class="panel">
        <h2>${l("flashcards.title")}</h2>
        <p class="lead">${l("flashcards.intro")}</p>
        <div class="control" style="margin-bottom:10px">
      ...
      </section>`}function X(){return at.filter(b=>De.includes(b.topic))}function U(){const b=X();return d==="all"||d==="thermometry"?b:b.filter(m=>m.topic===d)}function V(){const b=U(),m=t.querySelector("[data-flash-progress]");if(!b.length){i=0;const I=t.querySelector("[data-flash-front]");I&&(I.textContent=""),m&&(m.hidden=!0,m.textContent="");return}i=Math.max(0,Math.min(i,b.length-1));const u=b[i],c=t.querySelector("[data-flash-front]"),v=t.querySelector("[data-flash-label]");if(!c)return;m&&(m.hidden=!1,m.textContent=l("flashcards.progress").replace("{current}",String(i+1)).replace("{total}",String(b.length)));const R=Ee(),_=u[R]||u.en;v&&(v.hidden=!1,v.textContent=l(n?"flashcards.answer":"flashcards.question")),c.textContent=n?_.a:_.q}function Y(){const b=t.querySelector("[data-flash-deck]");b.value=d,b.addEventListener("change",()=>{d=b.value,i=0,n=!1,V()}),t.querySelector("[data-flip-card]").addEventListener("click",()=>{n=!n,V()}),t.querySelector("[data-flash-flip]").addEventListener("click",m=>{m.stopPropagation(),n=!n,V()}),t.querySelector("[data-flash-prev]").addEventListener("click",()=>{const m=U();i=(i-1+m.length)%m.length,n=!1,V()}),t.querySelector("[data-flash-next]").addEventListener("click",()=>{const m=U();i=(i+1)%m.length,n=!1,V()}),t.querySelector("[data-flash-shuf]").addEventListener("click",()=>{const m=U();i=Math.floor(Math.random()*m.length),n=!1,V()}),V()}function J(){return`
      <section class="panel">
        <h2>${l("summary.title")}</h2>
        <p class="lead">${l("summary.intro")}</p>
        <p class="lead">${l("notes.embedHint")}</p>
        <div class="grid cols-2" data-summary-grid>
          ${Me.map(b=>`
            <div class="card" data-summary-card="${b.id}">
              <h3>${l(`summary.item.${b.id}`)}</h3>
              <div data-summary-body></div>
            </div>`).join("")}
        </div>
      </section>`}async function ee(){const b=Ee();for(const m of Me){const u=t.querySelector(`[data-summary-card="${m.id}"]`);if(!u)continue;const c=u.querySelector("[data-summary-body]"),v=b==="zhHant"?m.fileZh:m.fileEn,R=await Ye(v),_=`./notes/${v}`;R?c.innerHTML=`
          <iframe class="notes-grid" title="${l(`summary.item.${m.id}`)}" src="${_}"></iframe>
          <p style="margin-top:8px"><a href="${_}" target="_blank" rel="noopener">${l("summary.download")}</a></p>`:c.innerHTML=`<p class="lead">${l("summary.missing")}</p>`}}const K=()=>P(),ne=b=>O(b);return window.addEventListener("s3phy:lang",K),t.addEventListener("click",ne),P(),()=>{window.removeEventListener("s3phy:lang",K),t.removeEventListener("click",ne),E!=null&&E._thermometerLabCleanup&&E._thermometerLabCleanup(),a==null||a.destroy()}}const Ue={en:["F = ma","E = mc²","p = mv","v = u + at","s = ut + ½at²","v² = u² + 2as","W = Fs cos θ","P = W / t","Eₖ = ½mv²","Eₚ = mgh","P = Fv","λ = h / p","E = hf","c = fλ","v = fλ","n₁ sin θ₁ = n₂ sin θ₂","η = sin i / sin r","1/f = 1/u + 1/v","m = v/u","V = IR","P = IV","ρ = m/V","Reflection","Refraction","Total internal reflection","Convex lens","Electromagnetic waves"],zhHant:["F = ma","E = mc²","p = mv","v = u + at","W = Fs cos θ","Eₖ = ½mv²","Eₚ = mgh","λ = h / p","E = hf","c = fλ","n₁ sin θ₁ = n₂ sin θ₂","1/f = 1/u + 1/v","V = IR","ρ = m/V","反射","折射","全內反射","凸透鏡","凹透鏡","電磁波"]};pt();const Ke="s3phy_splash_seen",st={optics:zt,heat:Gt};let Le=null,_e=null;function jt(){const t=location.hash.match(/^#\/(\w+)/),r=t==null?void 0:t[1];return r&&Object.prototype.hasOwnProperty.call(st,r)?r:null}function Bt(){const t=`${location.pathname}${location.search}`;history.replaceState(null,"",t)}function lt(t){Le==null||Le(),Le=null,_e==null||_e(),_e=null;const r=document.getElementById("app");if(!r)return;if(r.innerHTML="",!t){location.hash&&Bt(),_e=mt(r);return}const o=`#/${t}`;if(location.hash!==o){location.hash=o;return}Le=st[t](r)??null}function ct(){lt(jt())}function Qt(){return"./images/uniplus-logo.png"}function Nt(){const t=document.createElement("div");return t.id="splash",t.className="splash",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Uni+"),t.innerHTML=`
    <div class="splash-danmaku" id="splashDanmaku" aria-hidden="true"></div>
    <div class="splash-stage">
      <div class="splash-logo-wrap" id="splashLogoWrap">
        <img class="splash-logo-img" src="${Qt()}" alt="Uni+ logo" decoding="async" width="520" height="120" />
      </div>
  ...
  `,t}function Vt(t,r){const o=[...Ue.en,...Ue.zhHant],i=()=>{if(!t.parentElement)return;const d=document.createElement("div");d.className="splash-danmaku-item",d.textContent=o[Math.floor(Math.random()*o.length)];const n=Math.random()*85+5,a=Math.random()*.8+.9,q=Math.random()*12+10;d.style.top=`${n}%`,d.style.fontSize=`${a}rem`,d.style.animationDuration=`${q}s`,r.appendChild(d),d.addEventListener("animationend",()=>d.remove()),window.setTimeout(i,1500+Math.random()*1e3)};for(let d=0;d<4;d+=1)window.setTimeout(i,d*1e3)}function Yt(t){const r=t.querySelector("#splashLogoWrap"),o=t.querySelector("#splashDanmaku"),i=t.querySelector("#splashStartWrap");window.setTimeout(()=>r==null?void 0:r.classList.add("splash-logo-wrap--in"),800),window.setTimeout(()=>{o==null||o.classList.add("splash-danmaku--visible"),i==null||i.classList.add("splash-start-wrap--in"),o&&Vt(t,o)},1600)}function Xe(){ct()}function Ut(){let t=!1;try{t=sessionStorage.getItem(Ke)==="1"}catch{}if(t){Xe();return}const r=Nt();document.body.insertBefore(r,document.body.firstChild),Yt(r);const o=r.querySelector("#splashStart"),i=()=>{r.remove(),Xe()};o.addEventListener("click",()=>{try{sessionStorage.setItem(Ke,"1")}catch{}r.classList.add("splash--hide"),r.addEventListener("transitionend",i,{once:!0}),window.setTimeout(i,480)})}window.addEventListener("hashchange",ct);window.addEventListener("s3phy:strand",t=>{lt(t.detail??null)});Ut();
